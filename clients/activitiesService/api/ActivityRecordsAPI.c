...
ActivityRecordsAPI_getActivityRecordsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ActivitiesService/ActivityRecords/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ActivitiesService/ActivityRecords/Count");
    ...
    cJSON *ActivityRecordsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ActivityRecordsAPIlocalVarJSON);
    cJSON_Delete(ActivityRecordsAPIlocalVarJSON);
