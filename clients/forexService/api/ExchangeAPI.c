...
ExchangeAPI_exchangeAmountAsync(apiClient_t *apiClient, double amount, char *sourceCurrencyId, char *targetCurrencyId)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ForexService/Exchange/Latest")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ForexService/Exchange/Latest");
    ...
    cJSON *ExchangeAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    money_envelope_t *elementToReturn = money_envelope_parseFromJSON(ExchangeAPIlocalVarJSON);
    cJSON_Delete(ExchangeAPIlocalVarJSON);
...
ExchangeAPI_exchangeAmountHistoricalAsync(apiClient_t *apiClient, double amount, char *sourceCurrencyId, char *targetCurrencyId, char date)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ForexService/Exchange/History")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ForexService/Exchange/History");
