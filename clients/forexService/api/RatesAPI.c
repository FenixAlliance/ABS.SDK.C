...
RatesAPI_getHistoricalCurrencyRateAsync(apiClient_t *apiClient, char *currencyId, char date, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ForexService/Rates/History/{currencyId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ForexService/Rates/History/{currencyId}");
    ...
    cJSON *RatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    exchange_rate_envelope_t *elementToReturn = exchange_rate_envelope_parseFromJSON(RatesAPIlocalVarJSON);
    cJSON_Delete(RatesAPIlocalVarJSON);
...
RatesAPI_getHistoricalCurrencyRatesAsync(apiClient_t *apiClient, char date, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ForexService/Rates/History")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ForexService/Rates/History");
    ...
    //nonprimitive not container
    cJSON *RatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    forex_rates_dto_envelope_t *elementToReturn = forex_rates_dto_envelope_parseFromJSON(RatesAPIlocalVarJSON);
    cJSON_Delete(RatesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RatesAPI_getLatestCurrencyRateAsync(apiClient_t *apiClient, char *currencyId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ForexService/Rates/Latest/{currencyId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ForexService/Rates/Latest/{currencyId}");
...
RatesAPI_getLatestCurrencyRatesModelAsync(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ForexService/Rates/Latest")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ForexService/Rates/Latest");
