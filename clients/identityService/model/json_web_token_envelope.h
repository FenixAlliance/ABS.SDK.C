/*
 * json_web_token_envelope.h
 *
 * 
 */

#ifndef _json_web_token_envelope_H_
#define _json_web_token_envelope_H_
...
typedef struct json_web_token_envelope_t json_web_token_envelope_t;

#include "json_web_token.h"



typedef struct json_web_token_envelope_t {
    int is_success; //boolean
    char *error_message; // string
    char *correlation_id; // string
    char *timestamp; //date time
    char *activity_id; // string
    struct json_web_token_t *result; //model
...
#endif /* _json_web_token_envelope_H_ */
