...
OAuthAPI_checkPasswordSignInAsync(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/OAuth/SignIn")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/OAuth/SignIn");
    ...
    user_create_dto_envelope_t *elementToReturn = user_create_dto_envelope_parseFromJSON(OAuthAPIlocalVarJSON);
...
OAuthAPI_get(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/OAuth/WhoAmI")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/OAuth/WhoAmI");
...
OAuthAPI_getJwKs(apiClient_t *apiClient, char *applicationId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/OAuth/{applicationId}/Keys")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/OAuth/{applicationId}/Keys");
    ...
    //nonprimitive not container
    cJSON *OAuthAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    json_web_key_set_envelope_t *elementToReturn = json_web_key_set_envelope_parseFromJSON(OAuthAPIlocalVarJSON);
    cJSON_Delete(OAuthAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
OAuthAPI_getOpenIdConfiguration(apiClient_t *apiClient, char *tenantId, char *applicationId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/OAuth/{tenantId}/{applicationId}/.Well-Known/OpenId-Configuration")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/OAuth/{tenantId}/{applicationId}/.Well-Known/OpenId-Configuration");


    // Path Params
    long sizeOfPathParams_tenantId = strlen(tenantId)+3 + strlen(applicationId)+3 + strlen("{ tenantId }");
    if(tenantId == NULL) {
        goto end;
    }
    ...
    // Path Params
    long sizeOfPathParams_applicationId = strlen(tenantId)+3 + strlen(applicationId)+3 + strlen("{ applicationId }");
    if(applicationId == NULL) {
        goto end;
    }
    char* localVarToReplace_applicationId = malloc(sizeOfPathParams_applicationId);
    ...
    //nonprimitive not container
    cJSON *OAuthAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    open_id_configuration_envelope_t *elementToReturn = open_id_configuration_envelope_parseFromJSON(OAuthAPIlocalVarJSON);
    cJSON_Delete(OAuthAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
OAuthAPI_getPermissions(apiClient_t *apiClient, char *tenantId, char *userId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/OAuth/Permissions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/OAuth/Permissions");
    ...
    //nonprimitive not container
    cJSON *OAuthAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    string_list_envelope_t *elementToReturn = string_list_envelope_parseFromJSON(OAuthAPIlocalVarJSON);
    cJSON_Delete(OAuthAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
OAuthAPI_passwordSignInAsync(apiClient_t *apiClient, char *api_version, char *x_api_version, signin_model_t *signin_model)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_signin_model = NULL;
    if (signin_model != NULL)
    {
        //string
        localVarSingleItemJSON_signin_model = signin_model_convertToJSON(signin_model);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_signin_model);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    ...
    //nonprimitive not container
    cJSON *OAuthAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    json_web_token_envelope_t *elementToReturn = json_web_token_envelope_parseFromJSON(OAuthAPIlocalVarJSON);
    cJSON_Delete(OAuthAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_signin_model) {
        cJSON_Delete(localVarSingleItemJSON_signin_model);
        localVarSingleItemJSON_signin_model = NULL;
    }
...
OAuthAPI_token(apiClient_t *apiClient, char *api_version, char *x_api_version, o_auth_token_request_t *o_auth_token_request)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/OAuth/Token")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/OAuth/Token");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_o_auth_token_request = NULL;
    if (o_auth_token_request != NULL)
    {
        //string
        localVarSingleItemJSON_o_auth_token_request = o_auth_token_request_convertToJSON(o_auth_token_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_o_auth_token_request);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_o_auth_token_request) {
        cJSON_Delete(localVarSingleItemJSON_o_auth_token_request);
        localVarSingleItemJSON_o_auth_token_request = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_api_version){
        free(keyQuery_api_version);
