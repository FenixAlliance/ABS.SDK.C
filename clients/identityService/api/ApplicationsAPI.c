...
ApplicationsAPI_getApplication(apiClient_t *apiClient, char *appId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Applications/{appId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Applications/{appId}");
...
ApplicationsAPI_getGrantedEnrollmentPermissions(apiClient_t *apiClient, char *appId, char *securityRoleId, char *enrollmentId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Applications/{appId}/GrantedRoles/{securityRoleId}/GrantedPermissions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Applications/{appId}/GrantedRoles/{securityRoleId}/GrantedPermissions");


    // Path Params
    long sizeOfPathParams_appId = strlen(appId)+3 + strlen(securityRoleId)+3 + strlen("{ appId }");
    if(appId == NULL) {
        goto end;
    }
    char* localVarToReplace_appId = malloc(sizeOfPathParams_appId);
    ...
    // Path Params
    long sizeOfPathParams_securityRoleId = strlen(appId)+3 + strlen(securityRoleId)+3 + strlen("{ securityRoleId }");
    ...
    // query parameters
    char *keyQuery_enrollmentId = NULL;
    char * valueQuery_enrollmentId = NULL;
    keyValuePair_t *keyPairQuery_enrollmentId = 0;
    if (enrollmentId)
    {
        keyQuery_enrollmentId = strdup("enrollmentId");
        valueQuery_enrollmentId = strdup((enrollmentId));
        keyPairQuery_enrollmentId = keyValuePair_create(keyQuery_enrollmentId, valueQuery_enrollmentId);
        list_addElement(localVarQueryParameters,keyPairQuery_enrollmentId);
    }
    ...
    free(keyPairHeader_x_api_version);
    if(keyQuery_enrollmentId){
        free(keyQuery_enrollmentId);
        keyQuery_enrollmentId = NULL;
    }
    if(valueQuery_enrollmentId){
        free(valueQuery_enrollmentId);
        valueQuery_enrollmentId = NULL;
    }
    if(keyPairQuery_enrollmentId){
        keyValuePair_free(keyPairQuery_enrollmentId);
        keyPairQuery_enrollmentId = NULL;
    }
    if(keyQuery_enrollmentId){
        free(keyQuery_enrollmentId);
        keyQuery_enrollmentId = NULL;
...
ApplicationsAPI_getGrantedTenantPermissions(apiClient_t *apiClient, char *appId, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Applications/{appId}/GrantedPermissions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Applications/{appId}/GrantedPermissions");
...
ApplicationsAPI_getGrantedTenantRoles(apiClient_t *apiClient, char *appId, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Applications/{appId}/GrantedRoles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Applications/{appId}/GrantedRoles");
...
ApplicationsAPI_getRequiredPermissions(apiClient_t *apiClient, char *appId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Applications/{appId}/RequiredPermissions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Applications/{appId}/RequiredPermissions");
