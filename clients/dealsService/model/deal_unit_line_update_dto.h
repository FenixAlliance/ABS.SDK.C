/*
 * deal_unit_line_update_dto.h
 *
 * 
 */

#ifndef _deal_unit_line_update_dto_H_
#define _deal_unit_line_update_dto_H_
...
typedef struct deal_unit_line_update_dto_t deal_unit_line_update_dto_t;


// Enum TAXCALCULATIONMETHOD for deal_unit_line_update_dto

typedef enum  { dealsservice_deal_unit_line_update_dto_TAXCALCULATIONMETHOD_NULL = 0, dealsservice_deal_unit_line_update_dto_TAXCALCULATIONMETHOD_Included, dealsservice_deal_unit_line_update_dto_TAXCALCULATIONMETHOD_Excluded } dealsservice_deal_unit_line_update_dto_TAXCALCULATIONMETHOD_e;
...
// Enum COSTCALCULATIONMETHOD for deal_unit_line_update_dto

typedef enum  { dealsservice_deal_unit_line_update_dto_COSTCALCULATIONMETHOD_NULL = 0, dealsservice_deal_unit_line_update_dto_COSTCALCULATIONMETHOD_Automatic, dealsservice_deal_unit_line_update_dto_COSTCALCULATIONMETHOD_Custom } dealsservice_deal_unit_line_update_dto_COSTCALCULATIONMETHOD_e;
...
typedef struct deal_unit_line_update_dto_t {
    int closed; //boolean
    char *item_id; // string
    ...
    dealsservice_deal_unit_line_update_dto_TAXCALCULATIONMETHOD_e tax_calculation_method; //enum
    dealsservice_deal_unit_line_update_dto_COSTCALCULATIONMETHOD_e cost_calculation_method; //enum
...
#endif /* _deal_unit_line_update_dto_H_ */
