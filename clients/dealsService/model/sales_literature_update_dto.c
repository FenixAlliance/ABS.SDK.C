...
#include <string.h>
#include <stdio.h>
#include "sales_literature_update_dto.h"
...
sales_literature_update_dto_t *sales_literature_update_dto_create(
    ...
    if (!sales_literature_update_dto_local_var) {
        return NULL;
    }
    sales_literature_update_dto_local_var->title = title;
    sales_literature_update_dto_local_var->content = content;
...
void sales_literature_update_dto_free(sales_literature_update_dto_t *sales_literature_update_dto) {
    if(NULL == sales_literature_update_dto){
        return ;
    }
    listEntry_t *listEntry;
    if (sales_literature_update_dto->title) {
        free(sales_literature_update_dto->title);
        sales_literature_update_dto->title = NULL;
    }
    if (sales_literature_update_dto->content) {
        free(sales_literature_update_dto->content);
        sales_literature_update_dto->content = NULL;
    }
    if (sales_literature_update_dto->description) {
        free(sales_literature_update_dto->description);
        sales_literature_update_dto->description = NULL;
    }
    if (sales_literature_update_dto->modified_date) {
        free(sales_literature_update_dto->modified_date);
        sales_literature_update_dto->modified_date = NULL;
    }
    ...
    if (sales_literature_update_dto->sales_literature_type_id) {
        ...
        sales_literature_update_dto->sales_literature_type_id = NULL;
    }
    free(sales_literature_update_dto);
}

cJSON *sales_literature_update_dto_convertToJSON(sales_literature_update_dto_t *sales_literature_update_dto) {
    cJSON *item = cJSON_CreateObject();

    // sales_literature_update_dto->title
    if(sales_literature_update_dto->title) {
    if(cJSON_AddStringToObject(item, "title", sales_literature_update_dto->title) == NULL) {
    goto fail; //String
    }
    }


    // sales_literature_update_dto->content
    if(sales_literature_update_dto->content) {
    if(cJSON_AddStringToObject(item, "content", sales_literature_update_dto->content) == NULL) {
    goto fail; //String
    }
    }


    // sales_literature_update_dto->description
    if(sales_literature_update_dto->description) {
    if(cJSON_AddStringToObject(item, "description", sales_literature_update_dto->description) == NULL) {
    goto fail; //String
    }
    }


    // sales_literature_update_dto->modified_date
    if(sales_literature_update_dto->modified_date) {
    if(cJSON_AddStringToObject(item, "modifiedDate", sales_literature_update_dto->modified_date) == NULL) {
    goto fail; //Date-Time
    }
    }


    // sales_literature_update_dto->expiration_date
    if(sales_literature_update_dto->expiration_date) {
    ...
    if(sales_literature_update_dto->sales_literature_type_id) {
    if(cJSON_AddStringToObject(item, "salesLiteratureTypeId", sales_literature_update_dto->sales_literature_type_id) == NULL) {
    goto fail; //String
    }
    }
...
sales_literature_update_dto_t *sales_literature_update_dto_parseFromJSON(cJSON *sales_literature_update_dtoJSON){
    ...
    sales_literature_update_dto_t *sales_literature_update_dto_local_var = NULL;

    // sales_literature_update_dto->title
    cJSON *title = cJSON_GetObjectItemCaseSensitive(sales_literature_update_dtoJSON, "title");
    if (title) { 
    ...
    // sales_literature_update_dto->content
    cJSON *content = cJSON_GetObjectItemCaseSensitive(sales_literature_update_dtoJSON, "content");
    if (content) { 
    ...
    // sales_literature_update_dto->description
    cJSON *description = cJSON_GetObjectItemCaseSensitive(sales_literature_update_dtoJSON, "description");
    if (description) { 
    ...
    // sales_literature_update_dto->modified_date
    cJSON *modified_date = cJSON_GetObjectItemCaseSensitive(sales_literature_update_dtoJSON, "modifiedDate");
    if (modified_date) { 
    ...
    // sales_literature_update_dto->expiration_date
    cJSON *expiration_date = cJSON_GetObjectItemCaseSensitive(sales_literature_update_dtoJSON, "expirationDate");
    if (expiration_date) { 
    ...
    sales_literature_update_dto_local_var = sales_literature_update_dto_create (
