...
deal_unit_line_update_dto_t *deal_unit_line_update_dto_create(
    ...
    deal_unit_line_update_dto_local_var->title = title;
    deal_unit_line_update_dto_local_var->user_id = user_id;
    deal_unit_line_update_dto_local_var->price_list_id = price_list_id;
    deal_unit_line_update_dto_local_var->description = description;
    deal_unit_line_update_dto_local_var->individual_id = individual_id;
    deal_unit_line_update_dto_local_var->payment_term_id = payment_term_id;
    deal_unit_line_update_dto_local_var->organization_id = organization_id;
    deal_unit_line_update_dto_local_var->receiver_tenant_id = receiver_tenant_id;
    deal_unit_line_update_dto_local_var->first_name = first_name;
    deal_unit_line_update_dto_local_var->last_name = last_name;
    deal_unit_line_update_dto_local_var->company_name = company_name;
    deal_unit_line_update_dto_local_var->billing_email = billing_email;
    deal_unit_line_update_dto_local_var->address_line1 = address_line1;
    deal_unit_line_update_dto_local_var->address_line2 = address_line2;
    deal_unit_line_update_dto_local_var->postal_code = postal_code;
    deal_unit_line_update_dto_local_var->country_id = country_id;
    deal_unit_line_update_dto_local_var->state_id = state_id;
    deal_unit_line_update_dto_local_var->city_id = city_id;
    deal_unit_line_update_dto_local_var->billing_location_id = billing_location_id;
    deal_unit_line_update_dto_local_var->shipping_location_id = shipping_location_id;
    deal_unit_line_update_dto_local_var->shipping_method_id = shipping_method_id;
...
void deal_unit_line_update_dto_free(deal_unit_line_update_dto_t *deal_unit_line_update_dto) {
    ...
    if (deal_unit_line_update_dto->title) {
        free(deal_unit_line_update_dto->title);
        deal_unit_line_update_dto->title = NULL;
    }
    if (deal_unit_line_update_dto->user_id) {
        free(deal_unit_line_update_dto->user_id);
        deal_unit_line_update_dto->user_id = NULL;
    }
    if (deal_unit_line_update_dto->price_list_id) {
        free(deal_unit_line_update_dto->price_list_id);
        deal_unit_line_update_dto->price_list_id = NULL;
    }
    ...
    if (deal_unit_line_update_dto->individual_id) {
        free(deal_unit_line_update_dto->individual_id);
        deal_unit_line_update_dto->individual_id = NULL;
    }
    if (deal_unit_line_update_dto->payment_term_id) {
        free(deal_unit_line_update_dto->payment_term_id);
        deal_unit_line_update_dto->payment_term_id = NULL;
    }
    if (deal_unit_line_update_dto->organization_id) {
        free(deal_unit_line_update_dto->organization_id);
        deal_unit_line_update_dto->organization_id = NULL;
    }
    if (deal_unit_line_update_dto->receiver_tenant_id) {
        free(deal_unit_line_update_dto->receiver_tenant_id);
        deal_unit_line_update_dto->receiver_tenant_id = NULL;
    }
    if (deal_unit_line_update_dto->first_name) {
        free(deal_unit_line_update_dto->first_name);
        deal_unit_line_update_dto->first_name = NULL;
    }
    if (deal_unit_line_update_dto->last_name) {
        free(deal_unit_line_update_dto->last_name);
        deal_unit_line_update_dto->last_name = NULL;
    }
    if (deal_unit_line_update_dto->company_name) {
        free(deal_unit_line_update_dto->company_name);
        deal_unit_line_update_dto->company_name = NULL;
    }
    if (deal_unit_line_update_dto->billing_email) {
        free(deal_unit_line_update_dto->billing_email);
        deal_unit_line_update_dto->billing_email = NULL;
    }
    if (deal_unit_line_update_dto->address_line1) {
        free(deal_unit_line_update_dto->address_line1);
        deal_unit_line_update_dto->address_line1 = NULL;
    }
    if (deal_unit_line_update_dto->address_line2) {
        free(deal_unit_line_update_dto->address_line2);
        deal_unit_line_update_dto->address_line2 = NULL;
    }
    if (deal_unit_line_update_dto->postal_code) {
        free(deal_unit_line_update_dto->postal_code);
        deal_unit_line_update_dto->postal_code = NULL;
    }
    if (deal_unit_line_update_dto->country_id) {
        free(deal_unit_line_update_dto->country_id);
        deal_unit_line_update_dto->country_id = NULL;
    }
    if (deal_unit_line_update_dto->state_id) {
        free(deal_unit_line_update_dto->state_id);
        deal_unit_line_update_dto->state_id = NULL;
    }
    if (deal_unit_line_update_dto->city_id) {
        free(deal_unit_line_update_dto->city_id);
        deal_unit_line_update_dto->city_id = NULL;
    }
    if (deal_unit_line_update_dto->billing_location_id) {
        free(deal_unit_line_update_dto->billing_location_id);
        deal_unit_line_update_dto->billing_location_id = NULL;
    }
    ...
    if (deal_unit_line_update_dto->shipping_method_id) {
        free(deal_unit_line_update_dto->shipping_method_id);
        deal_unit_line_update_dto->shipping_method_id = NULL;
    }
...
cJSON *deal_unit_line_update_dto_convertToJSON(deal_unit_line_update_dto_t *deal_unit_line_update_dto) {
    ...
    // deal_unit_line_update_dto->title
    if(deal_unit_line_update_dto->title) {
    if(cJSON_AddStringToObject(item, "title", deal_unit_line_update_dto->title) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_update_dto->user_id
    if(deal_unit_line_update_dto->user_id) {
    if(cJSON_AddStringToObject(item, "userId", deal_unit_line_update_dto->user_id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_update_dto->price_list_id
    if(deal_unit_line_update_dto->price_list_id) {
    if(cJSON_AddStringToObject(item, "priceListId", deal_unit_line_update_dto->price_list_id) == NULL) {
    goto fail; //String
    }
    }
    ...
    // deal_unit_line_update_dto->individual_id
    if(deal_unit_line_update_dto->individual_id) {
    if(cJSON_AddStringToObject(item, "individualId", deal_unit_line_update_dto->individual_id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_update_dto->payment_term_id
    if(deal_unit_line_update_dto->payment_term_id) {
    if(cJSON_AddStringToObject(item, "paymentTermId", deal_unit_line_update_dto->payment_term_id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_update_dto->organization_id
    if(deal_unit_line_update_dto->organization_id) {
    if(cJSON_AddStringToObject(item, "organizationId", deal_unit_line_update_dto->organization_id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_update_dto->receiver_tenant_id
    if(deal_unit_line_update_dto->receiver_tenant_id) {
    if(cJSON_AddStringToObject(item, "receiverTenantId", deal_unit_line_update_dto->receiver_tenant_id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_update_dto->first_name
    if(deal_unit_line_update_dto->first_name) {
    if(cJSON_AddStringToObject(item, "firstName", deal_unit_line_update_dto->first_name) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_update_dto->last_name
    if(deal_unit_line_update_dto->last_name) {
    if(cJSON_AddStringToObject(item, "lastName", deal_unit_line_update_dto->last_name) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_update_dto->company_name
    if(deal_unit_line_update_dto->company_name) {
    if(cJSON_AddStringToObject(item, "companyName", deal_unit_line_update_dto->company_name) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_update_dto->billing_email
    if(deal_unit_line_update_dto->billing_email) {
    if(cJSON_AddStringToObject(item, "billingEmail", deal_unit_line_update_dto->billing_email) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_update_dto->address_line1
    if(deal_unit_line_update_dto->address_line1) {
    if(cJSON_AddStringToObject(item, "addressLine1", deal_unit_line_update_dto->address_line1) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_update_dto->address_line2
    if(deal_unit_line_update_dto->address_line2) {
    if(cJSON_AddStringToObject(item, "addressLine2", deal_unit_line_update_dto->address_line2) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_update_dto->postal_code
    if(deal_unit_line_update_dto->postal_code) {
    if(cJSON_AddStringToObject(item, "postalCode", deal_unit_line_update_dto->postal_code) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_update_dto->country_id
    if(deal_unit_line_update_dto->country_id) {
    if(cJSON_AddStringToObject(item, "countryId", deal_unit_line_update_dto->country_id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_update_dto->state_id
    if(deal_unit_line_update_dto->state_id) {
    if(cJSON_AddStringToObject(item, "stateId", deal_unit_line_update_dto->state_id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_update_dto->city_id
    if(deal_unit_line_update_dto->city_id) {
    if(cJSON_AddStringToObject(item, "cityId", deal_unit_line_update_dto->city_id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_update_dto->billing_location_id
    if(deal_unit_line_update_dto->billing_location_id) {
    if(cJSON_AddStringToObject(item, "billingLocationId", deal_unit_line_update_dto->billing_location_id) == NULL) {
    goto fail; //String
    }
    }
    ...
    // deal_unit_line_update_dto->shipping_method_id
    if(deal_unit_line_update_dto->shipping_method_id) {
    if(cJSON_AddStringToObject(item, "shippingMethodId", deal_unit_line_update_dto->shipping_method_id) == NULL) {
    goto fail; //String
    }
    }
...
deal_unit_line_update_dto_t *deal_unit_line_update_dto_parseFromJSON(cJSON *deal_unit_line_update_dtoJSON){
    ...
    // deal_unit_line_update_dto->title
    cJSON *title = cJSON_GetObjectItemCaseSensitive(deal_unit_line_update_dtoJSON, "title");
    if (title) { 
    ...
    // deal_unit_line_update_dto->user_id
    cJSON *user_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_update_dtoJSON, "userId");
    if (user_id) { 
    ...
    // deal_unit_line_update_dto->price_list_id
    cJSON *price_list_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_update_dtoJSON, "priceListId");
    if (price_list_id) { 
    ...
    // deal_unit_line_update_dto->individual_id
    cJSON *individual_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_update_dtoJSON, "individualId");
    if (individual_id) { 
    ...
    // deal_unit_line_update_dto->payment_term_id
    cJSON *payment_term_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_update_dtoJSON, "paymentTermId");
    if (payment_term_id) { 
    ...
    // deal_unit_line_update_dto->organization_id
    cJSON *organization_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_update_dtoJSON, "organizationId");
    if (organization_id) { 
    ...
    // deal_unit_line_update_dto->receiver_tenant_id
    cJSON *receiver_tenant_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_update_dtoJSON, "receiverTenantId");
    ...
    // deal_unit_line_update_dto->first_name
    cJSON *first_name = cJSON_GetObjectItemCaseSensitive(deal_unit_line_update_dtoJSON, "firstName");
    if (first_name) { 
    ...
    // deal_unit_line_update_dto->last_name
    cJSON *last_name = cJSON_GetObjectItemCaseSensitive(deal_unit_line_update_dtoJSON, "lastName");
    if (last_name) { 
    ...
    // deal_unit_line_update_dto->company_name
    cJSON *company_name = cJSON_GetObjectItemCaseSensitive(deal_unit_line_update_dtoJSON, "companyName");
    if (company_name) { 
    ...
    // deal_unit_line_update_dto->billing_email
    cJSON *billing_email = cJSON_GetObjectItemCaseSensitive(deal_unit_line_update_dtoJSON, "billingEmail");
    if (billing_email) { 
    ...
    // deal_unit_line_update_dto->address_line1
    cJSON *address_line1 = cJSON_GetObjectItemCaseSensitive(deal_unit_line_update_dtoJSON, "addressLine1");
    if (address_line1) { 
    ...
    // deal_unit_line_update_dto->address_line2
    cJSON *address_line2 = cJSON_GetObjectItemCaseSensitive(deal_unit_line_update_dtoJSON, "addressLine2");
    if (address_line2) { 
    ...
    // deal_unit_line_update_dto->postal_code
    cJSON *postal_code = cJSON_GetObjectItemCaseSensitive(deal_unit_line_update_dtoJSON, "postalCode");
    if (postal_code) { 
    ...
    // deal_unit_line_update_dto->country_id
    cJSON *country_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_update_dtoJSON, "countryId");
    if (country_id) { 
    ...
    // deal_unit_line_update_dto->state_id
    cJSON *state_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_update_dtoJSON, "stateId");
    if (state_id) { 
    ...
    // deal_unit_line_update_dto->city_id
    cJSON *city_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_update_dtoJSON, "cityId");
    if (city_id) { 
    ...
    // deal_unit_line_update_dto->billing_location_id
    cJSON *billing_location_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_update_dtoJSON, "billingLocationId");
    ...
    // deal_unit_line_update_dto->shipping_method_id
    cJSON *shipping_method_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_update_dtoJSON, "shippingMethodId");
