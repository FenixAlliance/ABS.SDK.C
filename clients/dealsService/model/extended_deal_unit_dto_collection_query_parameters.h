/*
 * extended_deal_unit_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _extended_deal_unit_dto_collection_query_parameters_H_
#define _extended_deal_unit_dto_collection_query_parameters_H_
...
typedef struct extended_deal_unit_dto_collection_query_parameters_t extended_deal_unit_dto_collection_query_parameters_t;




typedef struct extended_deal_unit_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} extended_deal_unit_dto_collection_query_parameters_t;
...
#endif /* _extended_deal_unit_dto_collection_query_parameters_H_ */
