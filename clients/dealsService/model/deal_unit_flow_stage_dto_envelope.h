/*
 * deal_unit_flow_stage_dto_envelope.h
 *
 * 
 */

#ifndef _deal_unit_flow_stage_dto_envelope_H_
#define _deal_unit_flow_stage_dto_envelope_H_
...
typedef struct deal_unit_flow_stage_dto_envelope_t deal_unit_flow_stage_dto_envelope_t;

#include "deal_unit_flow_stage_dto.h"



typedef struct deal_unit_flow_stage_dto_envelope_t {
    int is_success; //boolean
    char *error_message; // string
    char *correlation_id; // string
    char *timestamp; //date time
    char *activity_id; // string
    struct deal_unit_flow_stage_dto_t *result; //model
...
#endif /* _deal_unit_flow_stage_dto_envelope_H_ */
