...
typedef enum  { dealsservice_contact_dto_TYPE_NULL = 0, dealsservice_contact_dto_TYPE_Individual, dealsservice_contact_dto_TYPE_Organization } dealsservice_contact_dto_TYPE_e;
...
typedef struct contact_dto_t {
    ...
    dealsservice_contact_dto_TYPE_e type; //enum
    char *email; // string
    char *phone; // string
