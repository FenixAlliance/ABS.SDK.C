/*
 * deal_unit_update_dto.h
 *
 * 
 */

#ifndef _deal_unit_update_dto_H_
#define _deal_unit_update_dto_H_
...
typedef struct deal_unit_update_dto_t deal_unit_update_dto_t;


// Enum COSTCALCULATIONMETHOD for deal_unit_update_dto

typedef enum  { dealsservice_deal_unit_update_dto_COSTCALCULATIONMETHOD_NULL = 0, dealsservice_deal_unit_update_dto_COSTCALCULATIONMETHOD_Automatic, dealsservice_deal_unit_update_dto_COSTCALCULATIONMETHOD_Custom } dealsservice_deal_unit_update_dto_COSTCALCULATIONMETHOD_e;
...
// Enum TAXCALCULATIONMETHOD for deal_unit_update_dto

typedef enum  { dealsservice_deal_unit_update_dto_TAXCALCULATIONMETHOD_NULL = 0, dealsservice_deal_unit_update_dto_TAXCALCULATIONMETHOD_Included, dealsservice_deal_unit_update_dto_TAXCALCULATIONMETHOD_Excluded } dealsservice_deal_unit_update_dto_TAXCALCULATIONMETHOD_e;
...
// Enum DEALUNITSTATUS for deal_unit_update_dto

typedef enum  { dealsservice_deal_unit_update_dto_DEALUNITSTATUS_NULL = 0, dealsservice_deal_unit_update_dto_DEALUNITSTATUS_Open, dealsservice_deal_unit_update_dto_DEALUNITSTATUS_Won, dealsservice_deal_unit_update_dto_DEALUNITSTATUS_Lost, dealsservice_deal_unit_update_dto_DEALUNITSTATUS_Frozen } dealsservice_deal_unit_update_dto_DEALUNITSTATUS_e;
...
// Enum DEALUNITPURCHASEPROCESS for deal_unit_update_dto

typedef enum  { dealsservice_deal_unit_update_dto_DEALUNITPURCHASEPROCESS_NULL = 0, dealsservice_deal_unit_update_dto_DEALUNITPURCHASEPROCESS_None, dealsservice_deal_unit_update_dto_DEALUNITPURCHASEPROCESS_Individual, dealsservice_deal_unit_update_dto_DEALUNITPURCHASEPROCESS_Commitee, dealsservice_deal_unit_update_dto_DEALUNITPURCHASEPROCESS_Unknown } dealsservice_deal_unit_update_dto_DEALUNITPURCHASEPROCESS_e;
...
// Enum DEALUNITFORECASTCATEGORY for deal_unit_update_dto

typedef enum  { dealsservice_deal_unit_update_dto_DEALUNITFORECASTCATEGORY_NULL = 0, dealsservice_deal_unit_update_dto_DEALUNITFORECASTCATEGORY_None, dealsservice_deal_unit_update_dto_DEALUNITFORECASTCATEGORY_Pipeline, dealsservice_deal_unit_update_dto_DEALUNITFORECASTCATEGORY_BestCase, dealsservice_deal_unit_update_dto_DEALUNITFORECASTCATEGORY_Commited, dealsservice_deal_unit_update_dto_DEALUNITFORECASTCATEGORY_Ommited, dealsservice_deal_unit_update_dto_DEALUNITFORECASTCATEGORY_Won, dealsservice_deal_unit_update_dto_DEALUNITFORECASTCATEGORY_Lost } dealsservice_deal_unit_update_dto_DEALUNITFORECASTCATEGORY_e;
...
// Enum DEALUNITAMOUNTSCALCULATION for deal_unit_update_dto

typedef enum  { dealsservice_deal_unit_update_dto_DEALUNITAMOUNTSCALCULATION_NULL = 0, dealsservice_deal_unit_update_dto_DEALUNITAMOUNTSCALCULATION_UserProvided, dealsservice_deal_unit_update_dto_DEALUNITAMOUNTSCALCULATION_SystemCalculated } dealsservice_deal_unit_update_dto_DEALUNITAMOUNTSCALCULATION_e;
...
typedef struct deal_unit_update_dto_t {
    int closed; //boolean
    char *title; // string
    char *user_id; // string
    ...
    dealsservice_deal_unit_update_dto_COSTCALCULATIONMETHOD_e cost_calculation_method; //enum
    dealsservice_deal_unit_update_dto_TAXCALCULATIONMETHOD_e tax_calculation_method; //enum
    int ordered; //boolean
    char *cart_id; // string
    ...
    dealsservice_deal_unit_update_dto_DEALUNITSTATUS_e deal_unit_status; //enum
    dealsservice_deal_unit_update_dto_DEALUNITPURCHASEPROCESS_e deal_unit_purchase_process; //enum
    dealsservice_deal_unit_update_dto_DEALUNITFORECASTCATEGORY_e deal_unit_forecast_category; //enum
    dealsservice_deal_unit_update_dto_DEALUNITAMOUNTSCALCULATION_e deal_unit_amounts_calculation; //enum

} deal_unit_update_dto_t;
...
#endif /* _deal_unit_update_dto_H_ */
