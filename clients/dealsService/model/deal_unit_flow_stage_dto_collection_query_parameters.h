/*
 * deal_unit_flow_stage_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _deal_unit_flow_stage_dto_collection_query_parameters_H_
#define _deal_unit_flow_stage_dto_collection_query_parameters_H_
...
typedef struct deal_unit_flow_stage_dto_collection_query_parameters_t deal_unit_flow_stage_dto_collection_query_parameters_t;




typedef struct deal_unit_flow_stage_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} deal_unit_flow_stage_dto_collection_query_parameters_t;
...
#endif /* _deal_unit_flow_stage_dto_collection_query_parameters_H_ */
