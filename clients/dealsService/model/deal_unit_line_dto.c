...
#include <string.h>
#include <stdio.h>
#include "deal_unit_line_dto.h"


char* deal_unit_line_dto_tax_calculation_method_ToString(dealsservice_deal_unit_line_dto_TAXCALCULATIONMETHOD_e tax_calculation_method) {
    char* tax_calculation_methodArray[] =  { "NULL", "Included", "Excluded" };
    return tax_calculation_methodArray[tax_calculation_method];
}

dealsservice_deal_unit_line_dto_TAXCALCULATIONMETHOD_e deal_unit_line_dto_tax_calculation_method_FromString(char* tax_calculation_method){
...
char* deal_unit_line_dto_cost_calculation_method_ToString(dealsservice_deal_unit_line_dto_COSTCALCULATIONMETHOD_e cost_calculation_method) {
    char* cost_calculation_methodArray[] =  { "NULL", "Automatic", "Custom" };
    return cost_calculation_methodArray[cost_calculation_method];
}

dealsservice_deal_unit_line_dto_COSTCALCULATIONMETHOD_e deal_unit_line_dto_cost_calculation_method_FromString(char* cost_calculation_method){
    int stringToReturn = 0;
    char *cost_calculation_methodArray[] =  { "NULL", "Automatic", "Custom" };
...
deal_unit_line_dto_t *deal_unit_line_dto_create(
    char *id,
    char *timestamp,
    int closed,
    char *item_id,
    ...
    if (!deal_unit_line_dto_local_var) {
        return NULL;
    }
    ...
    deal_unit_line_dto_local_var->free_reason_code = free_reason_code;
    deal_unit_line_dto_local_var->data = data;
    deal_unit_line_dto_local_var->data_label = data_label;
    deal_unit_line_dto_local_var->data1 = data1;
    deal_unit_line_dto_local_var->data1_label = data1_label;
    deal_unit_line_dto_local_var->data2 = data2;
    deal_unit_line_dto_local_var->data2_label = data2_label;
    deal_unit_line_dto_local_var->data3 = data3;
    deal_unit_line_dto_local_var->data3_label = data3_label;
    deal_unit_line_dto_local_var->data4 = data4;
    deal_unit_line_dto_local_var->data4_label = data4_label;
    deal_unit_line_dto_local_var->data5 = data5;
    deal_unit_line_dto_local_var->data5_label = data5_label;
    deal_unit_line_dto_local_var->data6 = data6;
    deal_unit_line_dto_local_var->data6_label = data6_label;
    deal_unit_line_dto_local_var->data7 = data7;
    deal_unit_line_dto_local_var->data7_label = data7_label;
    deal_unit_line_dto_local_var->data8 = data8;
    deal_unit_line_dto_local_var->data8_label = data8_label;
    deal_unit_line_dto_local_var->data9 = data9;
    deal_unit_line_dto_local_var->data9_label = data9_label;
    deal_unit_line_dto_local_var->item_price_id = item_price_id;
    ...
    deal_unit_line_dto_local_var->refund_policy_id = refund_policy_id;
    deal_unit_line_dto_local_var->warranty_policy_id = warranty_policy_id;
    deal_unit_line_dto_local_var->shipment_policy_id = shipment_policy_id;
    deal_unit_line_dto_local_var->shipping_location_id = shipping_location_id;
    deal_unit_line_dto_local_var->location_id = location_id;
...
void deal_unit_line_dto_free(deal_unit_line_dto_t *deal_unit_line_dto) {
    if(NULL == deal_unit_line_dto){
        return ;
    }
    listEntry_t *listEntry;
    if (deal_unit_line_dto->id) {
        free(deal_unit_line_dto->id);
        deal_unit_line_dto->id = NULL;
    }
    ...
    if (deal_unit_line_dto->item_id) {
        ...
        deal_unit_line_dto->item_id = NULL;
    }
    if (deal_unit_line_dto->item_title) {
        free(deal_unit_line_dto->item_title);
        deal_unit_line_dto->item_title = NULL;
    }
    if (deal_unit_line_dto->item_short_description) {
        free(deal_unit_line_dto->item_short_description);
        deal_unit_line_dto->item_short_description = NULL;
    }
    if (deal_unit_line_dto->item_primary_image_url) {
        free(deal_unit_line_dto->item_primary_image_url);
        deal_unit_line_dto->item_primary_image_url = NULL;
    }
    ...
    if (deal_unit_line_dto->free_reason) {
        ...
        deal_unit_line_dto->free_reason = NULL;
    }
    if (deal_unit_line_dto->free_reason_code) {
        free(deal_unit_line_dto->free_reason_code);
        deal_unit_line_dto->free_reason_code = NULL;
    }
    if (deal_unit_line_dto->data) {
        free(deal_unit_line_dto->data);
        deal_unit_line_dto->data = NULL;
    }
    if (deal_unit_line_dto->data_label) {
        free(deal_unit_line_dto->data_label);
        deal_unit_line_dto->data_label = NULL;
    }
    if (deal_unit_line_dto->data1) {
        free(deal_unit_line_dto->data1);
        deal_unit_line_dto->data1 = NULL;
    }
    if (deal_unit_line_dto->data1_label) {
        free(deal_unit_line_dto->data1_label);
        deal_unit_line_dto->data1_label = NULL;
    }
    if (deal_unit_line_dto->data2) {
        free(deal_unit_line_dto->data2);
        deal_unit_line_dto->data2 = NULL;
    }
    if (deal_unit_line_dto->data2_label) {
        free(deal_unit_line_dto->data2_label);
        deal_unit_line_dto->data2_label = NULL;
    }
    if (deal_unit_line_dto->data3) {
        free(deal_unit_line_dto->data3);
        deal_unit_line_dto->data3 = NULL;
    }
    if (deal_unit_line_dto->data3_label) {
        free(deal_unit_line_dto->data3_label);
        deal_unit_line_dto->data3_label = NULL;
    }
    if (deal_unit_line_dto->data4) {
        free(deal_unit_line_dto->data4);
        deal_unit_line_dto->data4 = NULL;
    }
    if (deal_unit_line_dto->data4_label) {
        free(deal_unit_line_dto->data4_label);
        deal_unit_line_dto->data4_label = NULL;
    }
    if (deal_unit_line_dto->data5) {
        free(deal_unit_line_dto->data5);
        deal_unit_line_dto->data5 = NULL;
    }
    if (deal_unit_line_dto->data5_label) {
        free(deal_unit_line_dto->data5_label);
        deal_unit_line_dto->data5_label = NULL;
    }
    if (deal_unit_line_dto->data6) {
        free(deal_unit_line_dto->data6);
        deal_unit_line_dto->data6 = NULL;
    }
    if (deal_unit_line_dto->data6_label) {
        free(deal_unit_line_dto->data6_label);
        deal_unit_line_dto->data6_label = NULL;
    }
    if (deal_unit_line_dto->data7) {
        free(deal_unit_line_dto->data7);
        deal_unit_line_dto->data7 = NULL;
    }
    if (deal_unit_line_dto->data7_label) {
        free(deal_unit_line_dto->data7_label);
        deal_unit_line_dto->data7_label = NULL;
    }
    if (deal_unit_line_dto->data8) {
        free(deal_unit_line_dto->data8);
        deal_unit_line_dto->data8 = NULL;
    }
    if (deal_unit_line_dto->data8_label) {
        free(deal_unit_line_dto->data8_label);
        deal_unit_line_dto->data8_label = NULL;
    }
    if (deal_unit_line_dto->data9) {
        free(deal_unit_line_dto->data9);
        deal_unit_line_dto->data9 = NULL;
    }
    if (deal_unit_line_dto->data9_label) {
        free(deal_unit_line_dto->data9_label);
        deal_unit_line_dto->data9_label = NULL;
    }
    if (deal_unit_line_dto->item_price_id) {
        free(deal_unit_line_dto->item_price_id);
        deal_unit_line_dto->item_price_id = NULL;
    }
    if (deal_unit_line_dto->price_list_item_id) {
        free(deal_unit_line_dto->price_list_item_id);
        deal_unit_line_dto->price_list_item_id = NULL;
    }
    if (deal_unit_line_dto->unit_id) {
        free(deal_unit_line_dto->unit_id);
        deal_unit_line_dto->unit_id = NULL;
    }
    if (deal_unit_line_dto->unit_group_id) {
    ...
    if (deal_unit_line_dto->refund_policy_id) {
        free(deal_unit_line_dto->refund_policy_id);
        deal_unit_line_dto->refund_policy_id = NULL;
    }
    if (deal_unit_line_dto->warranty_policy_id) {
        free(deal_unit_line_dto->warranty_policy_id);
        deal_unit_line_dto->warranty_policy_id = NULL;
    }
    if (deal_unit_line_dto->shipment_policy_id) {
        free(deal_unit_line_dto->shipment_policy_id);
        deal_unit_line_dto->shipment_policy_id = NULL;
    }
    if (deal_unit_line_dto->shipping_location_id) {
        free(deal_unit_line_dto->shipping_location_id);
        deal_unit_line_dto->shipping_location_id = NULL;
    }
    if (deal_unit_line_dto->location_id) {
        free(deal_unit_line_dto->location_id);
        deal_unit_line_dto->location_id = NULL;
    }
    if (deal_unit_line_dto->quote_item_record_id) {
        free(deal_unit_line_dto->quote_item_record_id);
        deal_unit_line_dto->quote_item_record_id = NULL;
    }
    if (deal_unit_line_dto->business_profile_record_id) {
        free(deal_unit_line_dto->business_profile_record_id);
        deal_unit_line_dto->business_profile_record_id = NULL;
    }
    if (deal_unit_line_dto->parent_billing_item_record_id) {
    ...
    free(deal_unit_line_dto);
}

cJSON *deal_unit_line_dto_convertToJSON(deal_unit_line_dto_t *deal_unit_line_dto) {
    cJSON *item = cJSON_CreateObject();

    // deal_unit_line_dto->id
    if(deal_unit_line_dto->id) {
    if(cJSON_AddStringToObject(item, "id", deal_unit_line_dto->id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->timestamp
    if(deal_unit_line_dto->timestamp) {
    if(cJSON_AddStringToObject(item, "timestamp", deal_unit_line_dto->timestamp) == NULL) {
    goto fail; //Date-Time
    }
    }


    // deal_unit_line_dto->closed
    ...
    // deal_unit_line_dto->item_id
    if(deal_unit_line_dto->item_id) {
    if(cJSON_AddStringToObject(item, "itemId", deal_unit_line_dto->item_id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->item_title
    if(deal_unit_line_dto->item_title) {
    if(cJSON_AddStringToObject(item, "itemTitle", deal_unit_line_dto->item_title) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->item_short_description
    if(deal_unit_line_dto->item_short_description) {
    if(cJSON_AddStringToObject(item, "itemShortDescription", deal_unit_line_dto->item_short_description) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->item_primary_image_url
    if(deal_unit_line_dto->item_primary_image_url) {
    if(cJSON_AddStringToObject(item, "itemPrimaryImageUrl", deal_unit_line_dto->item_primary_image_url) == NULL) {
    goto fail; //String
    }
    }
    ...
    // deal_unit_line_dto->quantity
    if(deal_unit_line_dto->quantity) {
    if(cJSON_AddNumberToObject(item, "quantity", deal_unit_line_dto->quantity) == NULL) {
    goto fail; //Numeric
    }
    }


    // deal_unit_line_dto->free
    if(deal_unit_line_dto->free) {
    if(cJSON_AddBoolToObject(item, "free", deal_unit_line_dto->free) == NULL) {
    goto fail; //Bool
    }
    }


    // deal_unit_line_dto->free_reason
    if(deal_unit_line_dto->free_reason) {
    if(cJSON_AddStringToObject(item, "freeReason", deal_unit_line_dto->free_reason) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->free_reason_code
    if(deal_unit_line_dto->free_reason_code) {
    if(cJSON_AddStringToObject(item, "freeReasonCode", deal_unit_line_dto->free_reason_code) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->data
    if(deal_unit_line_dto->data) {
    if(cJSON_AddStringToObject(item, "data", deal_unit_line_dto->data) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->data_label
    if(deal_unit_line_dto->data_label) {
    if(cJSON_AddStringToObject(item, "dataLabel", deal_unit_line_dto->data_label) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->data1
    if(deal_unit_line_dto->data1) {
    if(cJSON_AddStringToObject(item, "data1", deal_unit_line_dto->data1) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->data1_label
    if(deal_unit_line_dto->data1_label) {
    if(cJSON_AddStringToObject(item, "data1Label", deal_unit_line_dto->data1_label) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->data2
    if(deal_unit_line_dto->data2) {
    if(cJSON_AddStringToObject(item, "data2", deal_unit_line_dto->data2) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->data2_label
    if(deal_unit_line_dto->data2_label) {
    if(cJSON_AddStringToObject(item, "data2Label", deal_unit_line_dto->data2_label) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->data3
    if(deal_unit_line_dto->data3) {
    if(cJSON_AddStringToObject(item, "data3", deal_unit_line_dto->data3) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->data3_label
    if(deal_unit_line_dto->data3_label) {
    if(cJSON_AddStringToObject(item, "data3Label", deal_unit_line_dto->data3_label) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->data4
    if(deal_unit_line_dto->data4) {
    if(cJSON_AddStringToObject(item, "data4", deal_unit_line_dto->data4) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->data4_label
    if(deal_unit_line_dto->data4_label) {
    if(cJSON_AddStringToObject(item, "data4Label", deal_unit_line_dto->data4_label) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->data5
    if(deal_unit_line_dto->data5) {
    if(cJSON_AddStringToObject(item, "data5", deal_unit_line_dto->data5) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->data5_label
    if(deal_unit_line_dto->data5_label) {
    if(cJSON_AddStringToObject(item, "data5Label", deal_unit_line_dto->data5_label) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->data6
    if(deal_unit_line_dto->data6) {
    if(cJSON_AddStringToObject(item, "data6", deal_unit_line_dto->data6) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->data6_label
    if(deal_unit_line_dto->data6_label) {
    if(cJSON_AddStringToObject(item, "data6Label", deal_unit_line_dto->data6_label) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->data7
    if(deal_unit_line_dto->data7) {
    if(cJSON_AddStringToObject(item, "data7", deal_unit_line_dto->data7) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->data7_label
    if(deal_unit_line_dto->data7_label) {
    if(cJSON_AddStringToObject(item, "data7Label", deal_unit_line_dto->data7_label) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->data8
    if(deal_unit_line_dto->data8) {
    if(cJSON_AddStringToObject(item, "data8", deal_unit_line_dto->data8) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->data8_label
    if(deal_unit_line_dto->data8_label) {
    if(cJSON_AddStringToObject(item, "data8Label", deal_unit_line_dto->data8_label) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->data9
    if(deal_unit_line_dto->data9) {
    if(cJSON_AddStringToObject(item, "data9", deal_unit_line_dto->data9) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->data9_label
    if(deal_unit_line_dto->data9_label) {
    if(cJSON_AddStringToObject(item, "data9Label", deal_unit_line_dto->data9_label) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->item_price_id
    if(deal_unit_line_dto->item_price_id) {
    if(cJSON_AddStringToObject(item, "itemPriceId", deal_unit_line_dto->item_price_id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->price_list_item_id
    if(deal_unit_line_dto->price_list_item_id) {
    if(cJSON_AddStringToObject(item, "priceListItemId", deal_unit_line_dto->price_list_item_id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->unit_id
    if(deal_unit_line_dto->unit_id) {
    if(cJSON_AddStringToObject(item, "unitId", deal_unit_line_dto->unit_id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->unit_group_id
    if(deal_unit_line_dto->unit_group_id) {
    if(cJSON_AddStringToObject(item, "unitGroupId", deal_unit_line_dto->unit_group_id) == NULL) {
    goto fail; //String
    }
    }
    ...
    // deal_unit_line_dto->total_return_cost_in_usd
    if(deal_unit_line_dto->total_return_cost_in_usd) {
    if(cJSON_AddNumberToObject(item, "totalReturnCostInUsd", deal_unit_line_dto->total_return_cost_in_usd) == NULL) {
    goto fail; //Numeric
    }
    }
    ...
    // deal_unit_line_dto->custom_global_surcharges_amount
    if(deal_unit_line_dto->custom_global_surcharges_amount) {
    if(cJSON_AddNumberToObject(item, "customGlobalSurchargesAmount", deal_unit_line_dto->custom_global_surcharges_amount) == NULL) {
    goto fail; //Numeric
    }
    }


    // deal_unit_line_dto->custom_global_discounts_amount
    if(deal_unit_line_dto->custom_global_discounts_amount) {
    if(cJSON_AddNumberToObject(item, "customGlobalDiscountsAmount", deal_unit_line_dto->custom_global_discounts_amount) == NULL) {
    goto fail; //Numeric
    }
    }


    // deal_unit_line_dto->return_policy_id
    if(deal_unit_line_dto->return_policy_id) {
    if(cJSON_AddStringToObject(item, "returnPolicyId", deal_unit_line_dto->return_policy_id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->refund_policy_id
    if(deal_unit_line_dto->refund_policy_id) {
    if(cJSON_AddStringToObject(item, "refundPolicyId", deal_unit_line_dto->refund_policy_id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->warranty_policy_id
    if(deal_unit_line_dto->warranty_policy_id) {
    if(cJSON_AddStringToObject(item, "warrantyPolicyId", deal_unit_line_dto->warranty_policy_id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->shipment_policy_id
    if(deal_unit_line_dto->shipment_policy_id) {
    if(cJSON_AddStringToObject(item, "shipmentPolicyId", deal_unit_line_dto->shipment_policy_id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->shipping_location_id
    if(deal_unit_line_dto->shipping_location_id) {
    if(cJSON_AddStringToObject(item, "shippingLocationId", deal_unit_line_dto->shipping_location_id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->location_id
    if(deal_unit_line_dto->location_id) {
    if(cJSON_AddStringToObject(item, "locationId", deal_unit_line_dto->location_id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->quote_item_record_id
    if(deal_unit_line_dto->quote_item_record_id) {
    if(cJSON_AddStringToObject(item, "quoteItemRecordId", deal_unit_line_dto->quote_item_record_id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->business_profile_record_id
    if(deal_unit_line_dto->business_profile_record_id) {
    if(cJSON_AddStringToObject(item, "businessProfileRecordId", deal_unit_line_dto->business_profile_record_id) == NULL) {
    goto fail; //String
    }
    }


    // deal_unit_line_dto->parent_billing_item_record_id
    if(deal_unit_line_dto->parent_billing_item_record_id) {
    if(cJSON_AddStringToObject(item, "parentBillingItemRecordId", deal_unit_line_dto->parent_billing_item_record_id) == NULL) {
    goto fail; //String
    }
    }
...
deal_unit_line_dto_t *deal_unit_line_dto_parseFromJSON(cJSON *deal_unit_line_dtoJSON){
    ...
    // deal_unit_line_dto->timestamp
    cJSON *timestamp = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "timestamp");
    if (timestamp) { 
    ...
    // deal_unit_line_dto->closed
    cJSON *closed = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "closed");
    if (closed) { 
    ...
    // deal_unit_line_dto->item_id
    cJSON *item_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "itemId");
    if (item_id) { 
    ...
    // deal_unit_line_dto->item_title
    cJSON *item_title = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "itemTitle");
    if (item_title) { 
    ...
    // deal_unit_line_dto->item_short_description
    cJSON *item_short_description = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "itemShortDescription");
    ...
    // deal_unit_line_dto->item_primary_image_url
    cJSON *item_primary_image_url = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "itemPrimaryImageUrl");
    ...
    // deal_unit_line_dto->quantity
    cJSON *quantity = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "quantity");
    if (quantity) { 
    ...
    // deal_unit_line_dto->free
    cJSON *free = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "free");
    if (free) { 
    ...
    // deal_unit_line_dto->free_reason
    cJSON *free_reason = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "freeReason");
    if (free_reason) { 
    ...
    // deal_unit_line_dto->free_reason_code
    cJSON *free_reason_code = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "freeReasonCode");
    if (free_reason_code) { 
    ...
    // deal_unit_line_dto->data
    cJSON *data = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "data");
    if (data) { 
    ...
    // deal_unit_line_dto->data_label
    cJSON *data_label = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "dataLabel");
    if (data_label) { 
    ...
    // deal_unit_line_dto->data1
    cJSON *data1 = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "data1");
    if (data1) { 
    ...
    // deal_unit_line_dto->data1_label
    cJSON *data1_label = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "data1Label");
    if (data1_label) { 
    ...
    // deal_unit_line_dto->data2
    cJSON *data2 = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "data2");
    if (data2) { 
    ...
    // deal_unit_line_dto->data2_label
    cJSON *data2_label = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "data2Label");
    if (data2_label) { 
    ...
    // deal_unit_line_dto->data3
    cJSON *data3 = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "data3");
    if (data3) { 
    ...
    // deal_unit_line_dto->data3_label
    cJSON *data3_label = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "data3Label");
    if (data3_label) { 
    ...
    // deal_unit_line_dto->data4
    cJSON *data4 = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "data4");
    if (data4) { 
    ...
    // deal_unit_line_dto->data4_label
    cJSON *data4_label = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "data4Label");
    if (data4_label) { 
    ...
    // deal_unit_line_dto->data5
    cJSON *data5 = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "data5");
    if (data5) { 
    ...
    // deal_unit_line_dto->data5_label
    cJSON *data5_label = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "data5Label");
    if (data5_label) { 
    ...
    // deal_unit_line_dto->data6
    cJSON *data6 = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "data6");
    if (data6) { 
    ...
    // deal_unit_line_dto->data6_label
    cJSON *data6_label = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "data6Label");
    if (data6_label) { 
    ...
    // deal_unit_line_dto->data7
    cJSON *data7 = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "data7");
    if (data7) { 
    ...
    // deal_unit_line_dto->data7_label
    cJSON *data7_label = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "data7Label");
    if (data7_label) { 
    ...
    // deal_unit_line_dto->data8
    cJSON *data8 = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "data8");
    if (data8) { 
    ...
    // deal_unit_line_dto->data8_label
    cJSON *data8_label = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "data8Label");
    if (data8_label) { 
    ...
    // deal_unit_line_dto->data9
    cJSON *data9 = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "data9");
    if (data9) { 
    ...
    // deal_unit_line_dto->data9_label
    cJSON *data9_label = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "data9Label");
    if (data9_label) { 
    ...
    // deal_unit_line_dto->item_price_id
    cJSON *item_price_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "itemPriceId");
    if (item_price_id) { 
    ...
    // deal_unit_line_dto->price_list_item_id
    cJSON *price_list_item_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "priceListItemId");
    ...
    // deal_unit_line_dto->unit_id
    cJSON *unit_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "unitId");
    if (unit_id) { 
    ...
    // deal_unit_line_dto->unit_group_id
    cJSON *unit_group_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "unitGroupId");
    if (unit_group_id) { 
    ...
    // deal_unit_line_dto->total_return_cost_in_usd
    cJSON *total_return_cost_in_usd = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "totalReturnCostInUsd");
    ...
    // deal_unit_line_dto->custom_global_surcharges_amount
    cJSON *custom_global_surcharges_amount = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "customGlobalSurchargesAmount");
    ...
    // deal_unit_line_dto->custom_global_discounts_amount
    cJSON *custom_global_discounts_amount = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "customGlobalDiscountsAmount");
    ...
    // deal_unit_line_dto->return_policy_id
    cJSON *return_policy_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "returnPolicyId");
    if (return_policy_id) { 
    ...
    // deal_unit_line_dto->refund_policy_id
    cJSON *refund_policy_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "refundPolicyId");
    if (refund_policy_id) { 
    ...
    // deal_unit_line_dto->warranty_policy_id
    cJSON *warranty_policy_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "warrantyPolicyId");
    ...
    // deal_unit_line_dto->shipment_policy_id
    cJSON *shipment_policy_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "shipmentPolicyId");
    ...
    // deal_unit_line_dto->shipping_location_id
    cJSON *shipping_location_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "shippingLocationId");
    ...
    // deal_unit_line_dto->location_id
    cJSON *location_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "locationId");
    if (location_id) { 
    ...
    // deal_unit_line_dto->quote_item_record_id
    cJSON *quote_item_record_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "quoteItemRecordId");
    ...
    // deal_unit_line_dto->business_profile_record_id
    cJSON *business_profile_record_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "businessProfileRecordId");
    ...
    // deal_unit_line_dto->parent_billing_item_record_id
    cJSON *parent_billing_item_record_id = cJSON_GetObjectItemCaseSensitive(deal_unit_line_dtoJSON, "parentBillingItemRecordId");
    ...
    deal_unit_line_dto_local_var = deal_unit_line_dto_create (
