...
UsersAPI_countCurrentUserFollowersAsync(apiClient_t *apiClient, char *api_version, char *x_api_version, follow_record_dto_collection_query_parameters_t *follow_record_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me/Followers/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me/Followers/Count");
...
UsersAPI_countCurrentUserFollowsAsync(apiClient_t *apiClient, char *api_version, char *x_api_version, follow_record_dto_collection_query_parameters_t *follow_record_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me/Follows/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me/Follows/Count");
...
UsersAPI_countCurrentUserNotificationsAsync(apiClient_t *apiClient, char *api_version, char *x_api_version, notification_dto_collection_query_parameters_t *notification_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me/Notifications/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me/Notifications/Count");
...
UsersAPI_countCurrentUserTenantsAsync(apiClient_t *apiClient, char *api_version, char *x_api_version, tenant_dto_collection_query_parameters_t *tenant_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me/Tenants/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me/Tenants/Count");
...
UsersAPI_getCurrentUserAddressesAsync(apiClient_t *apiClient, char *api_version, char *x_api_version, address_dto_collection_query_parameters_t *address_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me/Addresses")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me/Addresses");
    ...
    //nonprimitive not container
    cJSON *UsersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    address_dto_list_envelope_t *elementToReturn = address_dto_list_envelope_parseFromJSON(UsersAPIlocalVarJSON);
    cJSON_Delete(UsersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
UsersAPI_getCurrentUserAsync(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me");
...
UsersAPI_getCurrentUserAvatarAsync(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me/Avatar")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me/Avatar");
...
UsersAPI_getCurrentUserCartAsync(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me/Cart")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me/Cart");
    ...
    //nonprimitive not container
    cJSON *UsersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    cart_dto_envelope_t *elementToReturn = cart_dto_envelope_parseFromJSON(UsersAPIlocalVarJSON);
    cJSON_Delete(UsersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
UsersAPI_getCurrentUserEnrollmentsAsync(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me/Enrollments")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me/Enrollments");
    ...
    //nonprimitive not container
    cJSON *UsersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_enrollment_dto_list_envelope_t *elementToReturn = tenant_enrollment_dto_list_envelope_parseFromJSON(UsersAPIlocalVarJSON);
    cJSON_Delete(UsersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
UsersAPI_getCurrentUserEnrollmentsExtendedAsync(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me/Enrollments/Extended")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me/Enrollments/Extended");
    ...
    //nonprimitive not container
    cJSON *UsersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    extended_tenant_enrollment_dto_list_envelope_t *elementToReturn = extended_tenant_enrollment_dto_list_envelope_parseFromJSON(UsersAPIlocalVarJSON);
    cJSON_Delete(UsersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
UsersAPI_getCurrentUserFollowersAsync(apiClient_t *apiClient, char *api_version, char *x_api_version, follow_record_dto_collection_query_parameters_t *follow_record_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me/Followers")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me/Followers");
    ...
    //nonprimitive not container
    cJSON *UsersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    follow_record_dto_list_envelope_t *elementToReturn = follow_record_dto_list_envelope_parseFromJSON(UsersAPIlocalVarJSON);
    cJSON_Delete(UsersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
UsersAPI_getCurrentUserFollowsAsync(apiClient_t *apiClient, char *api_version, char *x_api_version, follow_record_dto_collection_query_parameters_t *follow_record_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me/Follows")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me/Follows");
...
UsersAPI_getCurrentUserInvitationAsync(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me/Invitations")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me/Invitations");
    ...
    //nonprimitive not container
    cJSON *UsersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_invitation_dto_list_envelope_t *elementToReturn = tenant_invitation_dto_list_envelope_parseFromJSON(UsersAPIlocalVarJSON);
    cJSON_Delete(UsersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
UsersAPI_getCurrentUserNotificationsAsync(apiClient_t *apiClient, char *api_version, char *x_api_version, notification_dto_collection_query_parameters_t *notification_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me/Notifications")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me/Notifications");
    ...
    //nonprimitive not container
    cJSON *UsersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    notification_dto_list_envelope_t *elementToReturn = notification_dto_list_envelope_parseFromJSON(UsersAPIlocalVarJSON);
    cJSON_Delete(UsersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
UsersAPI_getCurrentUserSettingsAsync(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me/Settings")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me/Settings");
    ...
    //nonprimitive not container
    cJSON *UsersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    user_settings_dto_envelope_t *elementToReturn = user_settings_dto_envelope_parseFromJSON(UsersAPIlocalVarJSON);
    cJSON_Delete(UsersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
UsersAPI_getCurrentUserSocialProfileAsync(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me/SocialProfile")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me/SocialProfile");
    ...
    //nonprimitive not container
    cJSON *UsersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    social_profile_dto_envelope_t *elementToReturn = social_profile_dto_envelope_parseFromJSON(UsersAPIlocalVarJSON);
    cJSON_Delete(UsersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
UsersAPI_getCurrentUserTenantsAsync(apiClient_t *apiClient, char *api_version, char *x_api_version, tenant_dto_collection_query_parameters_t *tenant_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me/Tenants")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me/Tenants");
    ...
    //nonprimitive not container
    cJSON *UsersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_dto_list_envelope_t *elementToReturn = tenant_dto_list_envelope_parseFromJSON(UsersAPIlocalVarJSON);
    cJSON_Delete(UsersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
UsersAPI_getCurrentUserTenantsExtendedAsync(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me/Tenants/Extended")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me/Tenants/Extended");
    ...
    //nonprimitive not container
    cJSON *UsersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    extended_tenant_dto_list_envelope_t *elementToReturn = extended_tenant_dto_list_envelope_parseFromJSON(UsersAPIlocalVarJSON);
    cJSON_Delete(UsersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
UsersAPI_getCurrentUserWalletAsync(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me/Wallet")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me/Wallet");
    ...
    //nonprimitive not container
    cJSON *UsersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    wallet_dto_envelope_t *elementToReturn = wallet_dto_envelope_parseFromJSON(UsersAPIlocalVarJSON);
    cJSON_Delete(UsersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
UsersAPI_getEnrollmentAsync(apiClient_t *apiClient, char *enrollmentId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me/Enrollments/{enrollmentId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me/Enrollments/{enrollmentId}");
    ...
    //nonprimitive not container
    cJSON *UsersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_enrollment_dto_envelope_t *elementToReturn = tenant_enrollment_dto_envelope_parseFromJSON(UsersAPIlocalVarJSON);
    cJSON_Delete(UsersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
UsersAPI_getExtendedCurrentUserAsync(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Me/Extended")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Me/Extended");
...
UsersAPI_updateCurrentUserSettingsAsync(apiClient_t *apiClient, char *api_version, char *x_api_version, user_settings_update_dto_t *user_settings_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_user_settings_update_dto = NULL;
    if (user_settings_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_user_settings_update_dto = user_settings_update_dto_convertToJSON(user_settings_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_user_settings_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarHeaderType,"multipart/form-data"); //produces
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_user_settings_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_user_settings_update_dto);
        localVarSingleItemJSON_user_settings_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_api_version){
        free(keyQuery_api_version);
