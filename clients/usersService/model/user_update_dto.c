...
cJSON *user_update_dto_convertToJSON(user_update_dto_t *user_update_dto) {
    ...
    if(user_update_dto->gender != usersservice_user_update_dto_GENDER_NULL) {
    ...
    if(user_update_dto->availability != usersservice_user_update_dto_AVAILABILITY_NULL) {
...
user_update_dto_t *user_update_dto_parseFromJSON(cJSON *user_update_dtoJSON){
    ...
    usersservice_user_update_dto_GENDER_e genderVariable;
    if (gender) { 
    ...
    usersservice_user_update_dto_AVAILABILITY_e availabilityVariable;
    if (availability) { 
    ...
    user_update_dto_local_var = user_update_dto_create (
        ...
        gender ? genderVariable : usersservice_user_update_dto_GENDER_NULL,
        ...
        availability ? availabilityVariable : usersservice_user_update_dto_AVAILABILITY_NULL
        );
