...
typedef enum  { usersservice_user_dto_GENDER_NULL = 0, usersservice_user_dto_GENDER_Unknown, usersservice_user_dto_GENDER_Male, usersservice_user_dto_GENDER_Female, usersservice_user_dto_GENDER_PreferNotToSay } usersservice_user_dto_GENDER_e;
...
typedef enum  { usersservice_user_dto_AVAILABILITY_NULL = 0, usersservice_user_dto_AVAILABILITY_DND, usersservice_user_dto_AVAILABILITY_Busy, usersservice_user_dto_AVAILABILITY_Away, usersservice_user_dto_AVAILABILITY_Offline, usersservice_user_dto_AVAILABILITY_Available } usersservice_user_dto_AVAILABILITY_e;
...
typedef enum  { usersservice_user_dto_SITETHEME_NULL = 0, usersservice_user_dto_SITETHEME_System, usersservice_user_dto_SITETHEME_Light, usersservice_user_dto_SITETHEME_Dark } usersservice_user_dto_SITETHEME_e;
...
typedef struct user_dto_t {
    ...
    usersservice_user_dto_GENDER_e gender; //enum
    char *city_id; // string
    ...
    usersservice_user_dto_AVAILABILITY_e availability; //enum
    int lockout_enabled; //boolean
    char *lockout_end; //date time
    int enrollments_count; //numeric
    usersservice_user_dto_SITETHEME_e site_theme; //enum
