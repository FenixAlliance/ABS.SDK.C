...
typedef enum  { usersservice_user_settings_dto_SITETHEME_NULL = 0, usersservice_user_settings_dto_SITETHEME_System, usersservice_user_settings_dto_SITETHEME_Light, usersservice_user_settings_dto_SITETHEME_Dark } usersservice_user_settings_dto_SITETHEME_e;

char* user_settings_dto_site_theme_ToString(usersservice_user_settings_dto_SITETHEME_e site_theme);

usersservice_user_settings_dto_SITETHEME_e user_settings_dto_site_theme_FromString(char* site_theme);
...
typedef struct user_settings_dto_t {
    ...
    usersservice_user_settings_dto_SITETHEME_e site_theme; //enum
...
user_settings_dto_t *user_settings_dto_create(
    ...
    usersservice_user_settings_dto_SITETHEME_e site_theme
);
