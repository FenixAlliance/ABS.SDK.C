/*
 * address_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _address_dto_collection_query_parameters_H_
#define _address_dto_collection_query_parameters_H_
...
typedef struct address_dto_collection_query_parameters_t address_dto_collection_query_parameters_t;




typedef struct address_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} address_dto_collection_query_parameters_t;
...
#endif /* _address_dto_collection_query_parameters_H_ */
