/*
 * option_dto_envelope.h
 *
 * 
 */

#ifndef _option_dto_envelope_H_
#define _option_dto_envelope_H_
...
typedef struct option_dto_envelope_t option_dto_envelope_t;

#include "option_dto.h"



typedef struct option_dto_envelope_t {
    int is_success; //boolean
    char *error_message; // string
    char *correlation_id; // string
    char *timestamp; //date time
    char *activity_id; // string
    struct option_dto_t *result; //model
