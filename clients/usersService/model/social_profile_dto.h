...
typedef enum  { usersservice_social_profile_dto_TYPE_NULL = 0, usersservice_social_profile_dto_TYPE_User, usersservice_social_profile_dto_TYPE_Tenant, usersservice_social_profile_dto_TYPE_Contact } usersservice_social_profile_dto_TYPE_e;

char* social_profile_dto_type_ToString(usersservice_social_profile_dto_TYPE_e type);

usersservice_social_profile_dto_TYPE_e social_profile_dto_type_FromString(char* type);
...
typedef struct social_profile_dto_t {
    ...
    usersservice_social_profile_dto_TYPE_e type; //enum
...
social_profile_dto_t *social_profile_dto_create(
    ...
    usersservice_social_profile_dto_TYPE_e type,
    char *social_feed_id,
    char *twitter_url,
    char *facebook_url,
    char *linked_in_url,
