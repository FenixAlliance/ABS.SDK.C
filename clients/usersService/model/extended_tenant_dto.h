...
typedef enum  { usersservice_extended_tenant_dto_KIND_NULL = 0, usersservice_extended_tenant_dto_KIND_Organization, usersservice_extended_tenant_dto_KIND_Individual } usersservice_extended_tenant_dto_KIND_e;
...
typedef struct extended_tenant_dto_t {
    ...
    usersservice_extended_tenant_dto_KIND_e kind; //enum
    char *tax_id; // string
    char *about; // string
