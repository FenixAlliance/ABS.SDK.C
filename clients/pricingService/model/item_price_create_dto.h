/*
 * item_price_create_dto.h
 *
 * 
 */

#ifndef _item_price_create_dto_H_
#define _item_price_create_dto_H_
...
typedef struct item_price_create_dto_t item_price_create_dto_t;




typedef struct item_price_create_dto_t {
    char *id; // string
...
#endif /* _item_price_create_dto_H_ */
