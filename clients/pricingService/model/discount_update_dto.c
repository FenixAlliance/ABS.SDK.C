...
discount_update_dto_t *discount_update_dto_create(
    ...
    discount_update_dto_local_var->item_id = item_id;
...
void discount_update_dto_free(discount_update_dto_t *discount_update_dto) {
    ...
    if (discount_update_dto->item_id) {
        free(discount_update_dto->item_id);
        discount_update_dto->item_id = NULL;
    }
...
cJSON *discount_update_dto_convertToJSON(discount_update_dto_t *discount_update_dto) {
    ...
    // discount_update_dto->item_id
    if(discount_update_dto->item_id) {
    if(cJSON_AddStringToObject(item, "itemId", discount_update_dto->item_id) == NULL) {
    goto fail; //String
    }
    }
...
discount_update_dto_t *discount_update_dto_parseFromJSON(cJSON *discount_update_dtoJSON){
    ...
    // discount_update_dto->item_id
    cJSON *item_id = cJSON_GetObjectItemCaseSensitive(discount_update_dtoJSON, "itemId");
    if (item_id) { 
