/*
 * discount_list_dto_envelope.h
 *
 * 
 */

#ifndef _discount_list_dto_envelope_H_
#define _discount_list_dto_envelope_H_
...
typedef struct discount_list_dto_envelope_t discount_list_dto_envelope_t;

#include "discount_list_dto.h"



typedef struct discount_list_dto_envelope_t {
    int is_success; //boolean
    char *error_message; // string
    char *correlation_id; // string
    char *timestamp; //date time
    char *activity_id; // string
    struct discount_list_dto_t *result; //model
...
#endif /* _discount_list_dto_envelope_H_ */
