/*
 * rounding_policy_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _rounding_policy_dto_collection_query_parameters_H_
#define _rounding_policy_dto_collection_query_parameters_H_
...
typedef struct rounding_policy_dto_collection_query_parameters_t rounding_policy_dto_collection_query_parameters_t;




typedef struct rounding_policy_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} rounding_policy_dto_collection_query_parameters_t;
...
#endif /* _rounding_policy_dto_collection_query_parameters_H_ */
