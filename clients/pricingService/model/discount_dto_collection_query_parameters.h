/*
 * discount_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _discount_dto_collection_query_parameters_H_
#define _discount_dto_collection_query_parameters_H_
...
typedef struct discount_dto_collection_query_parameters_t discount_dto_collection_query_parameters_t;




typedef struct discount_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} discount_dto_collection_query_parameters_t;
...
#endif /* _discount_dto_collection_query_parameters_H_ */
