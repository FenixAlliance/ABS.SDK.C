...
// Enum CONTEXT for price_list_update_dto

typedef enum  { pricingservice_price_list_update_dto_CONTEXT_NULL = 0, pricingservice_price_list_update_dto_CONTEXT_Sales, pricingservice_price_list_update_dto_CONTEXT_Purchase, pricingservice_price_list_update_dto_CONTEXT_Cost } pricingservice_price_list_update_dto_CONTEXT_e;
...
typedef struct price_list_update_dto_t {
    ...
    pricingservice_price_list_update_dto_CONTEXT_e context; //enum
