...
RoundingPoliciesAPI_createRoundingPolicyAsync(apiClient_t *apiClient, char *tenantId, rounding_policy_create_dto_t *rounding_policy_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/PricingService/RoundingPolicies")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/PricingService/RoundingPolicies");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_rounding_policy_create_dto = NULL;
    if (rounding_policy_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_rounding_policy_create_dto = rounding_policy_create_dto_convertToJSON(rounding_policy_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_rounding_policy_create_dto);
    }
    ...
    cJSON *RoundingPoliciesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(RoundingPoliciesAPIlocalVarJSON);
    cJSON_Delete(RoundingPoliciesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_rounding_policy_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_rounding_policy_create_dto);
        localVarSingleItemJSON_rounding_policy_create_dto = NULL;
    }
...
RoundingPoliciesAPI_deleteRoundingPolicyAsync(apiClient_t *apiClient, char *tenantId, char *roundingPolicyId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/PricingService/RoundingPolicies/{roundingPolicyId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/PricingService/RoundingPolicies/{roundingPolicyId}");


    // Path Params
    long sizeOfPathParams_roundingPolicyId = strlen(roundingPolicyId)+3 + strlen("{ roundingPolicyId }");
    if(roundingPolicyId == NULL) {
        goto end;
    }
    char* localVarToReplace_roundingPolicyId = malloc(sizeOfPathParams_roundingPolicyId);
    sprintf(localVarToReplace_roundingPolicyId, "{%s}", "roundingPolicyId");

    localVarPath = strReplace(localVarPath, localVarToReplace_roundingPolicyId, roundingPolicyId);
    if(roundingPolicyId == NULL) {
        goto end;
    }
    char* localVarToReplace_roundingPolicyId = malloc(sizeOfPathParams_roundingPolicyId);
    ...
    free(localVarPath);
    free(localVarToReplace_roundingPolicyId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
RoundingPoliciesAPI_getRoundingPoliciesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, rounding_policy_dto_collection_query_parameters_t *rounding_policy_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_rounding_policy_dto_collection_query_parameters = NULL;
    if (rounding_policy_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_rounding_policy_dto_collection_query_parameters = rounding_policy_dto_collection_query_parameters_convertToJSON(rounding_policy_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_rounding_policy_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *RoundingPoliciesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    rounding_policy_dto_list_envelope_t *elementToReturn = rounding_policy_dto_list_envelope_parseFromJSON(RoundingPoliciesAPIlocalVarJSON);
    cJSON_Delete(RoundingPoliciesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_rounding_policy_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_rounding_policy_dto_collection_query_parameters);
        localVarSingleItemJSON_rounding_policy_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
RoundingPoliciesAPI_getRoundingPoliciesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, rounding_policy_dto_collection_query_parameters_t *rounding_policy_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/PricingService/RoundingPolicies/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/PricingService/RoundingPolicies/Count");
    ...
    //nonprimitive not container
    cJSON *RoundingPoliciesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(RoundingPoliciesAPIlocalVarJSON);
    cJSON_Delete(RoundingPoliciesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RoundingPoliciesAPI_getRoundingPolicyByIdAsync(apiClient_t *apiClient, char *tenantId, char *roundingPolicyId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *RoundingPoliciesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    rounding_policy_dto_envelope_t *elementToReturn = rounding_policy_dto_envelope_parseFromJSON(RoundingPoliciesAPIlocalVarJSON);
    cJSON_Delete(RoundingPoliciesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RoundingPoliciesAPI_updateRoundingPolicyAsync(apiClient_t *apiClient, char *tenantId, char *roundingPolicyId, rounding_policy_update_dto_t *rounding_policy_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_rounding_policy_update_dto = NULL;
    if (rounding_policy_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_rounding_policy_update_dto = rounding_policy_update_dto_convertToJSON(rounding_policy_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_rounding_policy_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_rounding_policy_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_rounding_policy_update_dto);
        localVarSingleItemJSON_rounding_policy_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
