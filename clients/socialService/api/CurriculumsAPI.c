...
CurriculumsAPI_createCurriculumAsync(apiClient_t *apiClient, char *socialProfileId, char *tenantId, char *api_version, char *x_api_version, curriculum_create_dto_t *curriculum_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SocialService/Curriculums")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SocialService/Curriculums");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_curriculum_create_dto = NULL;
    if (curriculum_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_curriculum_create_dto = curriculum_create_dto_convertToJSON(curriculum_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_curriculum_create_dto);
    }
    ...
    cJSON *CurriculumsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(CurriculumsAPIlocalVarJSON);
    cJSON_Delete(CurriculumsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_curriculum_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_curriculum_create_dto);
        localVarSingleItemJSON_curriculum_create_dto = NULL;
    }
...
CurriculumsAPI_deleteCurriculumAsync(apiClient_t *apiClient, char *socialProfileId, char *curriculumId, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SocialService/Curriculums/{curriculumId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SocialService/Curriculums/{curriculumId}");
...
CurriculumsAPI_getCurriculumAsync(apiClient_t *apiClient, char *socialProfileId, char *curriculumId, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *CurriculumsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    curriculum_dto_envelope_t *elementToReturn = curriculum_dto_envelope_parseFromJSON(CurriculumsAPIlocalVarJSON);
    cJSON_Delete(CurriculumsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CurriculumsAPI_getCurriculumsAsync(apiClient_t *apiClient, char *socialProfileId, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *CurriculumsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    curriculum_dto_list_envelope_t *elementToReturn = curriculum_dto_list_envelope_parseFromJSON(CurriculumsAPIlocalVarJSON);
    cJSON_Delete(CurriculumsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CurriculumsAPI_getCurriculumsCountAsync(apiClient_t *apiClient, char *socialProfileId, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SocialService/Curriculums/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SocialService/Curriculums/Count");
    ...
    //nonprimitive not container
    cJSON *CurriculumsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(CurriculumsAPIlocalVarJSON);
    cJSON_Delete(CurriculumsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CurriculumsAPI_updateCurriculumAsync(apiClient_t *apiClient, char *socialProfileId, char *curriculumId, char *tenantId, char *api_version, char *x_api_version, curriculum_update_dto_t *curriculum_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_curriculum_update_dto = NULL;
    if (curriculum_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_curriculum_update_dto = curriculum_update_dto_convertToJSON(curriculum_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_curriculum_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_curriculum_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_curriculum_update_dto);
        localVarSingleItemJSON_curriculum_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_socialProfileId){
        free(keyQuery_socialProfileId);
