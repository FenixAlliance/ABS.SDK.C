...
SkillsAPI_createSkillAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, skill_create_dto_t *skill_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SocialService/Skills")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SocialService/Skills");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_skill_create_dto = NULL;
    if (skill_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_skill_create_dto = skill_create_dto_convertToJSON(skill_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_skill_create_dto);
    }
    ...
    cJSON *SkillsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SkillsAPIlocalVarJSON);
    cJSON_Delete(SkillsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_skill_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_skill_create_dto);
        localVarSingleItemJSON_skill_create_dto = NULL;
    }
...
SkillsAPI_deleteSkillAsync(apiClient_t *apiClient, char *tenantId, char *skillId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SocialService/Skills/{skillId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SocialService/Skills/{skillId}");


    // Path Params
    long sizeOfPathParams_skillId = strlen(skillId)+3 + strlen("{ skillId }");
    if(skillId == NULL) {
        goto end;
    }
    char* localVarToReplace_skillId = malloc(sizeOfPathParams_skillId);
    sprintf(localVarToReplace_skillId, "{%s}", "skillId");

    localVarPath = strReplace(localVarPath, localVarToReplace_skillId, skillId);
    if(skillId == NULL) {
        goto end;
    }
    char* localVarToReplace_skillId = malloc(sizeOfPathParams_skillId);
    ...
    free(localVarPath);
    free(localVarToReplace_skillId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
SkillsAPI_getSkillByIdAsync(apiClient_t *apiClient, char *tenantId, char *skillId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SkillsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    skill_dto_envelope_t *elementToReturn = skill_dto_envelope_parseFromJSON(SkillsAPIlocalVarJSON);
    cJSON_Delete(SkillsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SkillsAPI_getSkillsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, skill_dto_collection_query_parameters_t *skill_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_skill_dto_collection_query_parameters = NULL;
    if (skill_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_skill_dto_collection_query_parameters = skill_dto_collection_query_parameters_convertToJSON(skill_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_skill_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *SkillsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    skill_dto_list_envelope_t *elementToReturn = skill_dto_list_envelope_parseFromJSON(SkillsAPIlocalVarJSON);
    cJSON_Delete(SkillsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_skill_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_skill_dto_collection_query_parameters);
        localVarSingleItemJSON_skill_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SkillsAPI_getSkillsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, skill_dto_collection_query_parameters_t *skill_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SocialService/Skills/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SocialService/Skills/Count");
    ...
    //nonprimitive not container
    cJSON *SkillsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SkillsAPIlocalVarJSON);
    cJSON_Delete(SkillsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SkillsAPI_updateSkillAsync(apiClient_t *apiClient, char *tenantId, char *skillId, char *api_version, char *x_api_version, skill_update_dto_t *skill_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_skill_update_dto = NULL;
    if (skill_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_skill_update_dto = skill_update_dto_convertToJSON(skill_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_skill_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_skill_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_skill_update_dto);
        localVarSingleItemJSON_skill_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
