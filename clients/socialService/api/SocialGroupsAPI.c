...
SocialGroupsAPI_countSocialGroupsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, social_group_dto_collection_query_parameters_t *social_group_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SocialService/SocialGroups/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SocialService/SocialGroups/Count");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_social_group_dto_collection_query_parameters = NULL;
    if (social_group_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_social_group_dto_collection_query_parameters = social_group_dto_collection_query_parameters_convertToJSON(social_group_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_social_group_dto_collection_query_parameters);
    }
    ...
    cJSON *SocialGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SocialGroupsAPIlocalVarJSON);
    cJSON_Delete(SocialGroupsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_social_group_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_social_group_dto_collection_query_parameters);
        localVarSingleItemJSON_social_group_dto_collection_query_parameters = NULL;
    }
...
SocialGroupsAPI_createSocialGroupAsync(apiClient_t *apiClient, char *tenantId, char *socialProfileId, char *api_version, char *x_api_version, social_group_create_dto_t *social_group_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SocialService/SocialGroups")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SocialService/SocialGroups");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_social_group_create_dto = NULL;
    if (social_group_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_social_group_create_dto = social_group_create_dto_convertToJSON(social_group_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_social_group_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *SocialGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SocialGroupsAPIlocalVarJSON);
    cJSON_Delete(SocialGroupsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_social_group_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_social_group_create_dto);
        localVarSingleItemJSON_social_group_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SocialGroupsAPI_deleteSocialGroupAsync(apiClient_t *apiClient, char *tenantId, char *socialProfileId, char *socialGroupId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SocialService/SocialGroups/{socialGroupId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SocialService/SocialGroups/{socialGroupId}");


    // Path Params
    long sizeOfPathParams_socialGroupId = strlen(socialGroupId)+3 + strlen("{ socialGroupId }");
    if(socialGroupId == NULL) {
        goto end;
    }
    char* localVarToReplace_socialGroupId = malloc(sizeOfPathParams_socialGroupId);
    sprintf(localVarToReplace_socialGroupId, "{%s}", "socialGroupId");

    localVarPath = strReplace(localVarPath, localVarToReplace_socialGroupId, socialGroupId);
    if(socialGroupId == NULL) {
        goto end;
    }
    char* localVarToReplace_socialGroupId = malloc(sizeOfPathParams_socialGroupId);
    ...
    free(localVarPath);
    free(localVarToReplace_socialGroupId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
SocialGroupsAPI_getSocialGroupByIdAsync(apiClient_t *apiClient, char *tenantId, char *socialGroupId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SocialGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    social_group_dto_envelope_t *elementToReturn = social_group_dto_envelope_parseFromJSON(SocialGroupsAPIlocalVarJSON);
    cJSON_Delete(SocialGroupsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SocialGroupsAPI_getSocialGroupsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, social_group_dto_collection_query_parameters_t *social_group_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *SocialGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    social_group_dto_list_envelope_t *elementToReturn = social_group_dto_list_envelope_parseFromJSON(SocialGroupsAPIlocalVarJSON);
    cJSON_Delete(SocialGroupsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SocialGroupsAPI_updateSocialGroupAsync(apiClient_t *apiClient, char *tenantId, char *socialProfileId, char *socialGroupId, char *api_version, char *x_api_version, social_group_update_dto_t *social_group_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_social_group_update_dto = NULL;
    if (social_group_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_social_group_update_dto = social_group_update_dto_convertToJSON(social_group_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_social_group_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_social_group_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_social_group_update_dto);
        localVarSingleItemJSON_social_group_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
