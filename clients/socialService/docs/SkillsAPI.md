...
//
skill_dto_list_envelope_t* SkillsAPI_getSkillsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
//
int32_envelope_t* SkillsAPI_getSkillsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
//
empty_envelope_t* SkillsAPI_patchSkillAsync(apiClient_t *apiClient, char *tenantId, char *skillId, char *api_version, char *x_api_version, list_t *operation);
```
