/*
 * curriculum_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _curriculum_dto_collection_query_parameters_H_
#define _curriculum_dto_collection_query_parameters_H_
...
typedef struct curriculum_dto_collection_query_parameters_t curriculum_dto_collection_query_parameters_t;




typedef struct curriculum_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} curriculum_dto_collection_query_parameters_t;
...
#endif /* _curriculum_dto_collection_query_parameters_H_ */
