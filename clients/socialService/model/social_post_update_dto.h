/*
 * social_post_update_dto.h
 *
 * 
 */

#ifndef _social_post_update_dto_H_
#define _social_post_update_dto_H_
...
typedef struct social_post_update_dto_t social_post_update_dto_t;




typedef struct social_post_update_dto_t {
    char *title; // string
    char *message; // string

} social_post_update_dto_t;
...
#endif /* _social_post_update_dto_H_ */
