/*
 * follow_record_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _follow_record_dto_collection_query_parameters_H_
#define _follow_record_dto_collection_query_parameters_H_
...
typedef struct follow_record_dto_collection_query_parameters_t follow_record_dto_collection_query_parameters_t;




typedef struct follow_record_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} follow_record_dto_collection_query_parameters_t;
...
#endif /* _follow_record_dto_collection_query_parameters_H_ */
