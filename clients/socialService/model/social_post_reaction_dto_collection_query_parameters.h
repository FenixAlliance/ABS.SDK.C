/*
 * social_post_reaction_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _social_post_reaction_dto_collection_query_parameters_H_
#define _social_post_reaction_dto_collection_query_parameters_H_
...
typedef struct social_post_reaction_dto_collection_query_parameters_t social_post_reaction_dto_collection_query_parameters_t;




typedef struct social_post_reaction_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} social_post_reaction_dto_collection_query_parameters_t;
...
#endif /* _social_post_reaction_dto_collection_query_parameters_H_ */
