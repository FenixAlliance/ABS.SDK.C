...
typedef enum  { socialservice_social_profile_dto_TYPE_NULL = 0, socialservice_social_profile_dto_TYPE_User, socialservice_social_profile_dto_TYPE_Tenant, socialservice_social_profile_dto_TYPE_Contact } socialservice_social_profile_dto_TYPE_e;
...
typedef struct social_profile_dto_t {
    ...
    socialservice_social_profile_dto_TYPE_e type; //enum
