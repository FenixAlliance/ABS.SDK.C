/*
 * social_post_dto_envelope.h
 *
 * 
 */

#ifndef _social_post_dto_envelope_H_
#define _social_post_dto_envelope_H_
...
typedef struct social_post_dto_envelope_t social_post_dto_envelope_t;

#include "social_post_dto.h"



typedef struct social_post_dto_envelope_t {
    int is_success; //boolean
    char *error_message; // string
    char *correlation_id; // string
    char *timestamp; //date time
    char *activity_id; // string
    struct social_post_dto_t *result; //model
...
#endif /* _social_post_dto_envelope_H_ */
