...
quote_dto_t* instantiate_quote_dto(int include_optional) {
  ...
  if (include_optional) {
    quote_dto = quote_dto_create(
      ...
      "0",
      "0",
      walletsservice_quote_dto_TAXCALCULATIONMETHOD_Included,
      walletsservice_quote_dto_COSTCALCULATIONMETHOD_Automatic,
      1.337,
      "0",
      "0",
      1.337,
      ...
      "2013-10-20T19:20:30+01:00",
      "2013-10-20T19:20:30+01:00",
      walletsservice_quote_dto_QUOTESTATUS_Draft,
      walletsservice_quote_dto_FREIGHTTERMS_FOB,
      1.337
    );
  } else {
    quote_dto = quote_dto_create(
