...
payment_create_dto_t* instantiate_payment_create_dto(int include_optional) {
  ...
  if (include_optional) {
    payment_create_dto = payment_create_dto_create(
      ...
      "0",
      "2013-10-20T19:20:30+01:00",
      walletsservice_payment_create_dto_ONBEHALFOF_Self,
      walletsservice_payment_create_dto_PAYMENTTYPE_Paid,
      walletsservice_payment_create_dto_PAYMENTSTATUS_Unset,
      1.337,
      "0",
      1,
      1,
