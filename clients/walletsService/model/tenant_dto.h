...
typedef enum  { walletsservice_tenant_dto_KIND_NULL = 0, walletsservice_tenant_dto_KIND_Organization, walletsservice_tenant_dto_KIND_Individual } walletsservice_tenant_dto_KIND_e;
...
typedef struct tenant_dto_t {
    ...
    walletsservice_tenant_dto_KIND_e kind; //enum
    char *tax_id; // string
    char *about; // string
