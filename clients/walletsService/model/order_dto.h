...
typedef enum  { walletsservice_order_dto_TAXCALCULATIONMETHOD_NULL = 0, walletsservice_order_dto_TAXCALCULATIONMETHOD_Included, walletsservice_order_dto_TAXCALCULATIONMETHOD_Excluded } walletsservice_order_dto_TAXCALCULATIONMETHOD_e;
...
typedef enum  { walletsservice_order_dto_COSTCALCULATIONMETHOD_NULL = 0, walletsservice_order_dto_COSTCALCULATIONMETHOD_Automatic, walletsservice_order_dto_COSTCALCULATIONMETHOD_Custom } walletsservice_order_dto_COSTCALCULATIONMETHOD_e;
...
typedef enum  { walletsservice_order_dto_FREIGHTTERMS_NULL = 0, walletsservice_order_dto_FREIGHTTERMS_FOB, walletsservice_order_dto_FREIGHTTERMS_NoCharge } walletsservice_order_dto_FREIGHTTERMS_e;
...
typedef enum  { walletsservice_order_dto_ORDERSTATUS_NULL = 0, walletsservice_order_dto_ORDERSTATUS__New, walletsservice_order_dto_ORDERSTATUS_Processing, walletsservice_order_dto_ORDERSTATUS_Accepted, walletsservice_order_dto_ORDERSTATUS_Declined, walletsservice_order_dto_ORDERSTATUS_Shipped, walletsservice_order_dto_ORDERSTATUS_Delivered, walletsservice_order_dto_ORDERSTATUS_OnHold, walletsservice_order_dto_ORDERSTATUS_Failed, walletsservice_order_dto_ORDERSTATUS_Fulfilled, walletsservice_order_dto_ORDERSTATUS_Cancelled } walletsservice_order_dto_ORDERSTATUS_e;
