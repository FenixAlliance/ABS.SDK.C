...
cJSON *quote_dto_convertToJSON(quote_dto_t *quote_dto) {
    ...
    if(quote_dto->tax_calculation_method != walletsservice_quote_dto_TAXCALCULATIONMETHOD_NULL) {
    ...
    if(quote_dto->cost_calculation_method != walletsservice_quote_dto_COSTCALCULATIONMETHOD_NULL) {
    ...
    if(quote_dto->quote_status != walletsservice_quote_dto_QUOTESTATUS_NULL) {
    ...
    if(quote_dto->freight_terms != walletsservice_quote_dto_FREIGHTTERMS_NULL) {
...
quote_dto_t *quote_dto_parseFromJSON(cJSON *quote_dtoJSON){
    ...
    walletsservice_quote_dto_TAXCALCULATIONMETHOD_e tax_calculation_methodVariable;
    ...
    walletsservice_quote_dto_COSTCALCULATIONMETHOD_e cost_calculation_methodVariable;
    ...
    walletsservice_quote_dto_QUOTESTATUS_e quote_statusVariable;
    if (quote_status) { 
    ...
    walletsservice_quote_dto_FREIGHTTERMS_e freight_termsVariable;
    if (freight_terms) { 
    ...
    quote_dto_local_var = quote_dto_create (
        ...
        tax_calculation_method ? tax_calculation_methodVariable : walletsservice_quote_dto_TAXCALCULATIONMETHOD_NULL,
        cost_calculation_method ? cost_calculation_methodVariable : walletsservice_quote_dto_COSTCALCULATIONMETHOD_NULL,
        ...
        quote_status ? quote_statusVariable : walletsservice_quote_dto_QUOTESTATUS_NULL,
        freight_terms ? freight_termsVariable : walletsservice_quote_dto_FREIGHTTERMS_NULL,
