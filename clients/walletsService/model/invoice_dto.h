...
typedef enum  { walletsservice_invoice_dto_TAXCALCULATIONMETHOD_NULL = 0, walletsservice_invoice_dto_TAXCALCULATIONMETHOD_Included, walletsservice_invoice_dto_TAXCALCULATIONMETHOD_Excluded } walletsservice_invoice_dto_TAXCALCULATIONMETHOD_e;

char* invoice_dto_tax_calculation_method_ToString(walletsservice_invoice_dto_TAXCALCULATIONMETHOD_e tax_calculation_method);

walletsservice_invoice_dto_TAXCALCULATIONMETHOD_e invoice_dto_tax_calculation_method_FromString(char* tax_calculation_method);

// Enum COSTCALCULATIONMETHOD for invoice_dto

typedef enum  { walletsservice_invoice_dto_COSTCALCULATIONMETHOD_NULL = 0, walletsservice_invoice_dto_COSTCALCULATIONMETHOD_Automatic, walletsservice_invoice_dto_COSTCALCULATIONMETHOD_Custom } walletsservice_invoice_dto_COSTCALCULATIONMETHOD_e;

char* invoice_dto_cost_calculation_method_ToString(walletsservice_invoice_dto_COSTCALCULATIONMETHOD_e cost_calculation_method);

walletsservice_invoice_dto_COSTCALCULATIONMETHOD_e invoice_dto_cost_calculation_method_FromString(char* cost_calculation_method);

// Enum INVOICETYPE for invoice_dto

typedef enum  { walletsservice_invoice_dto_INVOICETYPE_NULL = 0, walletsservice_invoice_dto_INVOICETYPE_PurchaseInvoice, walletsservice_invoice_dto_INVOICETYPE_SalesInvoice, walletsservice_invoice_dto_INVOICETYPE_CreditNote, walletsservice_invoice_dto_INVOICETYPE_DebitNote } walletsservice_invoice_dto_INVOICETYPE_e;

char* invoice_dto_invoice_type_ToString(walletsservice_invoice_dto_INVOICETYPE_e invoice_type);

walletsservice_invoice_dto_INVOICETYPE_e invoice_dto_invoice_type_FromString(char* invoice_type);

// Enum DOCUMENTTYPE for invoice_dto

typedef enum  { walletsservice_invoice_dto_DOCUMENTTYPE_NULL = 0, walletsservice_invoice_dto_DOCUMENTTYPE_Standard, walletsservice_invoice_dto_DOCUMENTTYPE_DebitNote, walletsservice_invoice_dto_DOCUMENTTYPE_CreditNote } walletsservice_invoice_dto_DOCUMENTTYPE_e;

char* invoice_dto_document_type_ToString(walletsservice_invoice_dto_DOCUMENTTYPE_e document_type);

walletsservice_invoice_dto_DOCUMENTTYPE_e invoice_dto_document_type_FromString(char* document_type);

// Enum INVOICESTATUS for invoice_dto

typedef enum  { walletsservice_invoice_dto_INVOICESTATUS_NULL = 0, walletsservice_invoice_dto_INVOICESTATUS_Draft, walletsservice_invoice_dto_INVOICESTATUS_Closed, walletsservice_invoice_dto_INVOICESTATUS__Signed, walletsservice_invoice_dto_INVOICESTATUS_Expired, walletsservice_invoice_dto_INVOICESTATUS_Paid } walletsservice_invoice_dto_INVOICESTATUS_e;

char* invoice_dto_invoice_status_ToString(walletsservice_invoice_dto_INVOICESTATUS_e invoice_status);

walletsservice_invoice_dto_INVOICESTATUS_e invoice_dto_invoice_status_FromString(char* invoice_status);
...
typedef struct invoice_dto_t {
    ...
    walletsservice_invoice_dto_INVOICETYPE_e invoice_type; //enum
    walletsservice_invoice_dto_DOCUMENTTYPE_e document_type; //enum
    walletsservice_invoice_dto_INVOICESTATUS_e invoice_status; //enum
...
invoice_dto_t *invoice_dto_create(
    ...
    char *payment_due,
    walletsservice_invoice_dto_INVOICETYPE_e invoice_type,
    walletsservice_invoice_dto_DOCUMENTTYPE_e document_type,
    walletsservice_invoice_dto_INVOICESTATUS_e invoice_status
);
