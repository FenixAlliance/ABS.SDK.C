...
cJSON *payment_create_dto_convertToJSON(payment_create_dto_t *payment_create_dto) {
    ...
    if(payment_create_dto->on_behalf_of != walletsservice_payment_create_dto_ONBEHALFOF_NULL) {
    ...
    if(payment_create_dto->payment_type != walletsservice_payment_create_dto_PAYMENTTYPE_NULL) {
    ...
    if(payment_create_dto->payment_status != walletsservice_payment_create_dto_PAYMENTSTATUS_NULL) {
...
payment_create_dto_t *payment_create_dto_parseFromJSON(cJSON *payment_create_dtoJSON){
    ...
    walletsservice_payment_create_dto_ONBEHALFOF_e on_behalf_ofVariable;
    if (on_behalf_of) { 
    ...
    walletsservice_payment_create_dto_PAYMENTTYPE_e payment_typeVariable;
    if (payment_type) { 
    ...
    walletsservice_payment_create_dto_PAYMENTSTATUS_e payment_statusVariable;
    if (payment_status) { 
    ...
    payment_create_dto_local_var = payment_create_dto_create (
        ...
        on_behalf_of ? on_behalf_ofVariable : walletsservice_payment_create_dto_ONBEHALFOF_NULL,
        payment_type ? payment_typeVariable : walletsservice_payment_create_dto_PAYMENTTYPE_NULL,
        payment_status ? payment_statusVariable : walletsservice_payment_create_dto_PAYMENTSTATUS_NULL,
