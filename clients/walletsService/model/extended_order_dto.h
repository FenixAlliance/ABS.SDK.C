...
typedef enum  { walletsservice_extended_order_dto_TAXCALCULATIONMETHOD_NULL = 0, walletsservice_extended_order_dto_TAXCALCULATIONMETHOD_Included, walletsservice_extended_order_dto_TAXCALCULATIONMETHOD_Excluded } walletsservice_extended_order_dto_TAXCALCULATIONMETHOD_e;
...
typedef enum  { walletsservice_extended_order_dto_COSTCALCULATIONMETHOD_NULL = 0, walletsservice_extended_order_dto_COSTCALCULATIONMETHOD_Automatic, walletsservice_extended_order_dto_COSTCALCULATIONMETHOD_Custom } walletsservice_extended_order_dto_COSTCALCULATIONMETHOD_e;
...
typedef enum  { walletsservice_extended_order_dto_FREIGHTTERMS_NULL = 0, walletsservice_extended_order_dto_FREIGHTTERMS_FOB, walletsservice_extended_order_dto_FREIGHTTERMS_NoCharge } walletsservice_extended_order_dto_FREIGHTTERMS_e;
...
typedef enum  { walletsservice_extended_order_dto_ORDERSTATUS_NULL = 0, walletsservice_extended_order_dto_ORDERSTATUS__New, walletsservice_extended_order_dto_ORDERSTATUS_Processing, walletsservice_extended_order_dto_ORDERSTATUS_Accepted, walletsservice_extended_order_dto_ORDERSTATUS_Declined, walletsservice_extended_order_dto_ORDERSTATUS_Shipped, walletsservice_extended_order_dto_ORDERSTATUS_Delivered, walletsservice_extended_order_dto_ORDERSTATUS_OnHold, walletsservice_extended_order_dto_ORDERSTATUS_Failed, walletsservice_extended_order_dto_ORDERSTATUS_Fulfilled, walletsservice_extended_order_dto_ORDERSTATUS_Cancelled } walletsservice_extended_order_dto_ORDERSTATUS_e;
...
typedef struct extended_order_dto_t {
    ...
    walletsservice_extended_order_dto_TAXCALCULATIONMETHOD_e tax_calculation_method; //enum
    ...
    walletsservice_extended_order_dto_COSTCALCULATIONMETHOD_e cost_calculation_method; //enum
    walletsservice_extended_order_dto_FREIGHTTERMS_e freight_terms; //enum
    walletsservice_extended_order_dto_ORDERSTATUS_e order_status; //enum
