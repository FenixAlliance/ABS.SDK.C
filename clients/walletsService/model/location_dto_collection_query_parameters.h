/*
 * location_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _location_dto_collection_query_parameters_H_
#define _location_dto_collection_query_parameters_H_
...
typedef struct location_dto_collection_query_parameters_t location_dto_collection_query_parameters_t;




typedef struct location_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} location_dto_collection_query_parameters_t;
...
#endif /* _location_dto_collection_query_parameters_H_ */
