...
typedef enum  { walletsservice_quote_dto_TAXCALCULATIONMETHOD_NULL = 0, walletsservice_quote_dto_TAXCALCULATIONMETHOD_Included, walletsservice_quote_dto_TAXCALCULATIONMETHOD_Excluded } walletsservice_quote_dto_TAXCALCULATIONMETHOD_e;

char* quote_dto_tax_calculation_method_ToString(walletsservice_quote_dto_TAXCALCULATIONMETHOD_e tax_calculation_method);

walletsservice_quote_dto_TAXCALCULATIONMETHOD_e quote_dto_tax_calculation_method_FromString(char* tax_calculation_method);

// Enum COSTCALCULATIONMETHOD for quote_dto

typedef enum  { walletsservice_quote_dto_COSTCALCULATIONMETHOD_NULL = 0, walletsservice_quote_dto_COSTCALCULATIONMETHOD_Automatic, walletsservice_quote_dto_COSTCALCULATIONMETHOD_Custom } walletsservice_quote_dto_COSTCALCULATIONMETHOD_e;

char* quote_dto_cost_calculation_method_ToString(walletsservice_quote_dto_COSTCALCULATIONMETHOD_e cost_calculation_method);

walletsservice_quote_dto_COSTCALCULATIONMETHOD_e quote_dto_cost_calculation_method_FromString(char* cost_calculation_method);

// Enum QUOTESTATUS for quote_dto

typedef enum  { walletsservice_quote_dto_QUOTESTATUS_NULL = 0, walletsservice_quote_dto_QUOTESTATUS_Draft, walletsservice_quote_dto_QUOTESTATUS__New, walletsservice_quote_dto_QUOTESTATUS_Accepted, walletsservice_quote_dto_QUOTESTATUS_Declined, walletsservice_quote_dto_QUOTESTATUS_Expired } walletsservice_quote_dto_QUOTESTATUS_e;

char* quote_dto_quote_status_ToString(walletsservice_quote_dto_QUOTESTATUS_e quote_status);

walletsservice_quote_dto_QUOTESTATUS_e quote_dto_quote_status_FromString(char* quote_status);

// Enum FREIGHTTERMS for quote_dto

typedef enum  { walletsservice_quote_dto_FREIGHTTERMS_NULL = 0, walletsservice_quote_dto_FREIGHTTERMS_FOB, walletsservice_quote_dto_FREIGHTTERMS_NoCharge } walletsservice_quote_dto_FREIGHTTERMS_e;

char* quote_dto_freight_terms_ToString(walletsservice_quote_dto_FREIGHTTERMS_e freight_terms);

walletsservice_quote_dto_FREIGHTTERMS_e quote_dto_freight_terms_FromString(char* freight_terms);
...
typedef struct quote_dto_t {
    ...
    walletsservice_quote_dto_TAXCALCULATIONMETHOD_e tax_calculation_method; //enum
    walletsservice_quote_dto_COSTCALCULATIONMETHOD_e cost_calculation_method; //enum
    ...
    walletsservice_quote_dto_QUOTESTATUS_e quote_status; //enum
    walletsservice_quote_dto_FREIGHTTERMS_e freight_terms; //enum
...
quote_dto_t *quote_dto_create(
    ...
    char *city_id,
    char *customer_notes,
    walletsservice_quote_dto_TAXCALCULATIONMETHOD_e tax_calculation_method,
    walletsservice_quote_dto_COSTCALCULATIONMETHOD_e cost_calculation_method,
    double forex_rate,
    ...
    char *effective_to,
    char *effective_from,
    walletsservice_quote_dto_QUOTESTATUS_e quote_status,
    walletsservice_quote_dto_FREIGHTTERMS_e freight_terms,
