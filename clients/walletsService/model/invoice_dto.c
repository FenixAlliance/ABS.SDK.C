...
cJSON *invoice_dto_convertToJSON(invoice_dto_t *invoice_dto) {
    ...
    if(invoice_dto->tax_calculation_method != walletsservice_invoice_dto_TAXCALCULATIONMETHOD_NULL) {
    ...
    if(invoice_dto->cost_calculation_method != walletsservice_invoice_dto_COSTCALCULATIONMETHOD_NULL) {
    ...
    if(invoice_dto->invoice_type != walletsservice_invoice_dto_INVOICETYPE_NULL) {
    ...
    if(invoice_dto->document_type != walletsservice_invoice_dto_DOCUMENTTYPE_NULL) {
    ...
    if(invoice_dto->invoice_status != walletsservice_invoice_dto_INVOICESTATUS_NULL) {
...
invoice_dto_t *invoice_dto_parseFromJSON(cJSON *invoice_dtoJSON){
    ...
    walletsservice_invoice_dto_TAXCALCULATIONMETHOD_e tax_calculation_methodVariable;
    ...
    walletsservice_invoice_dto_COSTCALCULATIONMETHOD_e cost_calculation_methodVariable;
    ...
    walletsservice_invoice_dto_INVOICETYPE_e invoice_typeVariable;
    if (invoice_type) { 
    ...
    walletsservice_invoice_dto_DOCUMENTTYPE_e document_typeVariable;
    if (document_type) { 
    ...
    walletsservice_invoice_dto_INVOICESTATUS_e invoice_statusVariable;
    if (invoice_status) { 
    ...
    invoice_dto_local_var = invoice_dto_create (
        ...
        invoice_type ? invoice_typeVariable : walletsservice_invoice_dto_INVOICETYPE_NULL,
        document_type ? document_typeVariable : walletsservice_invoice_dto_DOCUMENTTYPE_NULL,
        invoice_status ? invoice_statusVariable : walletsservice_invoice_dto_INVOICESTATUS_NULL
        );
