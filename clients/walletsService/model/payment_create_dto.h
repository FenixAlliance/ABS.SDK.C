...
typedef enum  { walletsservice_payment_create_dto_ONBEHALFOF_NULL = 0, walletsservice_payment_create_dto_ONBEHALFOF_Self, walletsservice_payment_create_dto_ONBEHALFOF_Tenant, walletsservice_payment_create_dto_ONBEHALFOF_Individual, walletsservice_payment_create_dto_ONBEHALFOF_Organization } walletsservice_payment_create_dto_ONBEHALFOF_e;

char* payment_create_dto_on_behalf_of_ToString(walletsservice_payment_create_dto_ONBEHALFOF_e on_behalf_of);

walletsservice_payment_create_dto_ONBEHALFOF_e payment_create_dto_on_behalf_of_FromString(char* on_behalf_of);

// Enum PAYMENTTYPE for payment_create_dto

typedef enum  { walletsservice_payment_create_dto_PAYMENTTYPE_NULL = 0, walletsservice_payment_create_dto_PAYMENTTYPE_Paid, walletsservice_payment_create_dto_PAYMENTTYPE_Received, walletsservice_payment_create_dto_PAYMENTTYPE_Internal } walletsservice_payment_create_dto_PAYMENTTYPE_e;

char* payment_create_dto_payment_type_ToString(walletsservice_payment_create_dto_PAYMENTTYPE_e payment_type);

walletsservice_payment_create_dto_PAYMENTTYPE_e payment_create_dto_payment_type_FromString(char* payment_type);

// Enum PAYMENTSTATUS for payment_create_dto

typedef enum  { walletsservice_payment_create_dto_PAYMENTSTATUS_NULL = 0, walletsservice_payment_create_dto_PAYMENTSTATUS_Unset, walletsservice_payment_create_dto_PAYMENTSTATUS_Accepted, walletsservice_payment_create_dto_PAYMENTSTATUS_Rejected, walletsservice_payment_create_dto_PAYMENTSTATUS_OnHold, walletsservice_payment_create_dto_PAYMENTSTATUS_Failed, walletsservice_payment_create_dto_PAYMENTSTATUS_Reversed, walletsservice_payment_create_dto_PAYMENTSTATUS_Retained, walletsservice_payment_create_dto_PAYMENTSTATUS_Initialized, walletsservice_payment_create_dto_PAYMENTSTATUS_Expired, walletsservice_payment_create_dto_PAYMENTSTATUS_Abandoned, walletsservice_payment_create_dto_PAYMENTSTATUS_Cancelled, walletsservice_payment_create_dto_PAYMENTSTATUS_AcceptedRetained } walletsservice_payment_create_dto_PAYMENTSTATUS_e;

char* payment_create_dto_payment_status_ToString(walletsservice_payment_create_dto_PAYMENTSTATUS_e payment_status);

walletsservice_payment_create_dto_PAYMENTSTATUS_e payment_create_dto_payment_status_FromString(char* payment_status);
...
typedef struct payment_create_dto_t {
    ...
    walletsservice_payment_create_dto_ONBEHALFOF_e on_behalf_of; //enum
    walletsservice_payment_create_dto_PAYMENTTYPE_e payment_type; //enum
    walletsservice_payment_create_dto_PAYMENTSTATUS_e payment_status; //enum
...
payment_create_dto_t *payment_create_dto_create(
    ...
    char *last_updated,
    walletsservice_payment_create_dto_ONBEHALFOF_e on_behalf_of,
    walletsservice_payment_create_dto_PAYMENTTYPE_e payment_type,
    walletsservice_payment_create_dto_PAYMENTSTATUS_e payment_status,
    double base_cost,
    char *signature,
