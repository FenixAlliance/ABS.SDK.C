...
cJSON *user_dto_convertToJSON(user_dto_t *user_dto) {
    ...
    // user_dto->gender
    if(user_dto->gender != walletsservice_user_dto_GENDER_NULL) {
    ...
    if(user_dto->availability != walletsservice_user_dto_AVAILABILITY_NULL) {
    ...
    // user_dto->site_theme
    if(user_dto->site_theme != walletsservice_user_dto_SITETHEME_NULL) {
...
user_dto_t *user_dto_parseFromJSON(cJSON *user_dtoJSON){
    ...
    walletsservice_user_dto_GENDER_e genderVariable;
    if (gender) { 
    ...
    walletsservice_user_dto_AVAILABILITY_e availabilityVariable;
    if (availability) { 
    ...
    walletsservice_user_dto_SITETHEME_e site_themeVariable;
    if (site_theme) { 
    ...
    user_dto_local_var = user_dto_create (
        ...
        gender ? genderVariable : walletsservice_user_dto_GENDER_NULL,
        ...
        availability ? availabilityVariable : walletsservice_user_dto_AVAILABILITY_NULL,
        ...
        site_theme ? site_themeVariable : walletsservice_user_dto_SITETHEME_NULL
        );
