...
cJSON *order_dto_convertToJSON(order_dto_t *order_dto) {
    ...
    if(order_dto->tax_calculation_method != ordersservice_order_dto_TAXCALCULATIONMETHOD_NULL) {
    ...
    if(order_dto->order_status != ordersservice_order_dto_ORDERSTATUS_NULL) {
...
order_dto_t *order_dto_parseFromJSON(cJSON *order_dtoJSON){
    ...
    ordersservice_order_dto_TAXCALCULATIONMETHOD_e tax_calculation_methodVariable;
    ...
    ordersservice_order_dto_ORDERSTATUS_e order_statusVariable;
    if (order_status) { 
