...
#ifndef _order_line_dto_H_
#define _order_line_dto_H_
...
typedef struct order_line_dto_t order_line_dto_t;

#include "currency_id.h"
#include "forex_rates.h"
#include "money.h"

// Enum TAXCALCULATIONMETHOD for order_line_dto

typedef enum  { ordersservice_order_line_dto_TAXCALCULATIONMETHOD_NULL = 0, ordersservice_order_line_dto_TAXCALCULATIONMETHOD_Included, ordersservice_order_line_dto_TAXCALCULATIONMETHOD_Excluded } ordersservice_order_line_dto_TAXCALCULATIONMETHOD_e;
...
// Enum COSTCALCULATIONMETHOD for order_line_dto

typedef enum  { ordersservice_order_line_dto_COSTCALCULATIONMETHOD_NULL = 0, ordersservice_order_line_dto_COSTCALCULATIONMETHOD_Automatic, ordersservice_order_line_dto_COSTCALCULATIONMETHOD_Custom } ordersservice_order_line_dto_COSTCALCULATIONMETHOD_e;
...
typedef struct order_line_dto_t {
    char *id; // string
    ...
    ordersservice_order_line_dto_TAXCALCULATIONMETHOD_e tax_calculation_method; //enum
    ordersservice_order_line_dto_COSTCALCULATIONMETHOD_e cost_calculation_method; //enum
