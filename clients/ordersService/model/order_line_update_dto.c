...
order_line_update_dto_t *order_line_update_dto_create(
    ...
    order_line_update_dto_local_var->tenant_id = tenant_id;
    order_line_update_dto_local_var->enrollment_id = enrollment_id;
    ...
    order_line_update_dto_local_var->business_profile_record_id = business_profile_record_id;
...
void order_line_update_dto_free(order_line_update_dto_t *order_line_update_dto) {
    ...
    if (order_line_update_dto->tenant_id) {
        free(order_line_update_dto->tenant_id);
        order_line_update_dto->tenant_id = NULL;
    }
    if (order_line_update_dto->enrollment_id) {
        free(order_line_update_dto->enrollment_id);
        order_line_update_dto->enrollment_id = NULL;
    }
    ...
    if (order_line_update_dto->business_profile_record_id) {
        free(order_line_update_dto->business_profile_record_id);
        order_line_update_dto->business_profile_record_id = NULL;
    }
...
cJSON *order_line_update_dto_convertToJSON(order_line_update_dto_t *order_line_update_dto) {
    ...
    // order_line_update_dto->tenant_id
    if(order_line_update_dto->tenant_id) {
    if(cJSON_AddStringToObject(item, "tenantId", order_line_update_dto->tenant_id) == NULL) {
    goto fail; //String
    }
    }


    // order_line_update_dto->enrollment_id
    if(order_line_update_dto->enrollment_id) {
    if(cJSON_AddStringToObject(item, "enrollmentId", order_line_update_dto->enrollment_id) == NULL) {
    goto fail; //String
    }
    }
    ...
    // order_line_update_dto->business_profile_record_id
    if(order_line_update_dto->business_profile_record_id) {
    if(cJSON_AddStringToObject(item, "businessProfileRecordId", order_line_update_dto->business_profile_record_id) == NULL) {
    goto fail; //String
    }
    }
...
order_line_update_dto_t *order_line_update_dto_parseFromJSON(cJSON *order_line_update_dtoJSON){
    ...
    // order_line_update_dto->tenant_id
    cJSON *tenant_id = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "tenantId");
    if (tenant_id) { 
    ...
    // order_line_update_dto->enrollment_id
    cJSON *enrollment_id = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "enrollmentId");
    if (enrollment_id) { 
    ...
    // order_line_update_dto->business_profile_record_id
    cJSON *business_profile_record_id = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "businessProfileRecordId");
