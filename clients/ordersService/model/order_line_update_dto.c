...
order_line_update_dto_t *order_line_update_dto_create(
    ...
    order_line_update_dto_local_var->title = title;
    order_line_update_dto_local_var->user_id = user_id;
    order_line_update_dto_local_var->price_list_id = price_list_id;
    order_line_update_dto_local_var->description = description;
    order_line_update_dto_local_var->individual_id = individual_id;
    order_line_update_dto_local_var->payment_term_id = payment_term_id;
    order_line_update_dto_local_var->organization_id = organization_id;
    order_line_update_dto_local_var->receiver_tenant_id = receiver_tenant_id;
    order_line_update_dto_local_var->first_name = first_name;
    order_line_update_dto_local_var->last_name = last_name;
    order_line_update_dto_local_var->company_name = company_name;
    order_line_update_dto_local_var->billing_email = billing_email;
    order_line_update_dto_local_var->address_line1 = address_line1;
    order_line_update_dto_local_var->address_line2 = address_line2;
    order_line_update_dto_local_var->postal_code = postal_code;
    order_line_update_dto_local_var->country_id = country_id;
    order_line_update_dto_local_var->state_id = state_id;
    order_line_update_dto_local_var->city_id = city_id;
    order_line_update_dto_local_var->billing_location_id = billing_location_id;
    order_line_update_dto_local_var->shipping_location_id = shipping_location_id;
    order_line_update_dto_local_var->shipping_method_id = shipping_method_id;
...
void order_line_update_dto_free(order_line_update_dto_t *order_line_update_dto) {
    ...
    if (order_line_update_dto->title) {
        free(order_line_update_dto->title);
        order_line_update_dto->title = NULL;
    }
    if (order_line_update_dto->user_id) {
        free(order_line_update_dto->user_id);
        order_line_update_dto->user_id = NULL;
    }
    if (order_line_update_dto->price_list_id) {
        free(order_line_update_dto->price_list_id);
        order_line_update_dto->price_list_id = NULL;
    }
    if (order_line_update_dto->description) {
        free(order_line_update_dto->description);
        order_line_update_dto->description = NULL;
    }
    if (order_line_update_dto->individual_id) {
        free(order_line_update_dto->individual_id);
        order_line_update_dto->individual_id = NULL;
    }
    if (order_line_update_dto->payment_term_id) {
        free(order_line_update_dto->payment_term_id);
        order_line_update_dto->payment_term_id = NULL;
    }
    if (order_line_update_dto->organization_id) {
        free(order_line_update_dto->organization_id);
        order_line_update_dto->organization_id = NULL;
    }
    if (order_line_update_dto->receiver_tenant_id) {
        free(order_line_update_dto->receiver_tenant_id);
        order_line_update_dto->receiver_tenant_id = NULL;
    }
    if (order_line_update_dto->first_name) {
        free(order_line_update_dto->first_name);
        order_line_update_dto->first_name = NULL;
    }
    if (order_line_update_dto->last_name) {
        free(order_line_update_dto->last_name);
        order_line_update_dto->last_name = NULL;
    }
    if (order_line_update_dto->company_name) {
        free(order_line_update_dto->company_name);
        order_line_update_dto->company_name = NULL;
    }
    if (order_line_update_dto->billing_email) {
        free(order_line_update_dto->billing_email);
        order_line_update_dto->billing_email = NULL;
    }
    if (order_line_update_dto->address_line1) {
        free(order_line_update_dto->address_line1);
        order_line_update_dto->address_line1 = NULL;
    }
    if (order_line_update_dto->address_line2) {
        free(order_line_update_dto->address_line2);
        order_line_update_dto->address_line2 = NULL;
    }
    if (order_line_update_dto->postal_code) {
        free(order_line_update_dto->postal_code);
        order_line_update_dto->postal_code = NULL;
    }
    if (order_line_update_dto->country_id) {
        free(order_line_update_dto->country_id);
        order_line_update_dto->country_id = NULL;
    }
    if (order_line_update_dto->state_id) {
        free(order_line_update_dto->state_id);
        order_line_update_dto->state_id = NULL;
    }
    if (order_line_update_dto->city_id) {
        free(order_line_update_dto->city_id);
        order_line_update_dto->city_id = NULL;
    }
    if (order_line_update_dto->billing_location_id) {
        free(order_line_update_dto->billing_location_id);
        order_line_update_dto->billing_location_id = NULL;
    }
    ...
    if (order_line_update_dto->shipping_method_id) {
        free(order_line_update_dto->shipping_method_id);
        order_line_update_dto->shipping_method_id = NULL;
    }
...
cJSON *order_line_update_dto_convertToJSON(order_line_update_dto_t *order_line_update_dto) {
    ...
    // order_line_update_dto->title
    if(order_line_update_dto->title) {
    if(cJSON_AddStringToObject(item, "title", order_line_update_dto->title) == NULL) {
    goto fail; //String
    }
    }


    // order_line_update_dto->user_id
    if(order_line_update_dto->user_id) {
    if(cJSON_AddStringToObject(item, "userId", order_line_update_dto->user_id) == NULL) {
    goto fail; //String
    }
    }


    // order_line_update_dto->price_list_id
    if(order_line_update_dto->price_list_id) {
    if(cJSON_AddStringToObject(item, "priceListId", order_line_update_dto->price_list_id) == NULL) {
    goto fail; //String
    }
    }
    ...
    // order_line_update_dto->individual_id
    if(order_line_update_dto->individual_id) {
    if(cJSON_AddStringToObject(item, "individualId", order_line_update_dto->individual_id) == NULL) {
    goto fail; //String
    }
    }


    // order_line_update_dto->payment_term_id
    if(order_line_update_dto->payment_term_id) {
    if(cJSON_AddStringToObject(item, "paymentTermId", order_line_update_dto->payment_term_id) == NULL) {
    goto fail; //String
    }
    }


    // order_line_update_dto->organization_id
    if(order_line_update_dto->organization_id) {
    if(cJSON_AddStringToObject(item, "organizationId", order_line_update_dto->organization_id) == NULL) {
    goto fail; //String
    }
    }


    // order_line_update_dto->receiver_tenant_id
    if(order_line_update_dto->receiver_tenant_id) {
    if(cJSON_AddStringToObject(item, "receiverTenantId", order_line_update_dto->receiver_tenant_id) == NULL) {
    goto fail; //String
    }
    }


    // order_line_update_dto->first_name
    if(order_line_update_dto->first_name) {
    if(cJSON_AddStringToObject(item, "firstName", order_line_update_dto->first_name) == NULL) {
    goto fail; //String
    }
    }


    // order_line_update_dto->last_name
    if(order_line_update_dto->last_name) {
    if(cJSON_AddStringToObject(item, "lastName", order_line_update_dto->last_name) == NULL) {
    goto fail; //String
    }
    }


    // order_line_update_dto->company_name
    if(order_line_update_dto->company_name) {
    if(cJSON_AddStringToObject(item, "companyName", order_line_update_dto->company_name) == NULL) {
    goto fail; //String
    }
    }


    // order_line_update_dto->billing_email
    if(order_line_update_dto->billing_email) {
    if(cJSON_AddStringToObject(item, "billingEmail", order_line_update_dto->billing_email) == NULL) {
    goto fail; //String
    }
    }


    // order_line_update_dto->address_line1
    if(order_line_update_dto->address_line1) {
    if(cJSON_AddStringToObject(item, "addressLine1", order_line_update_dto->address_line1) == NULL) {
    goto fail; //String
    }
    }


    // order_line_update_dto->address_line2
    if(order_line_update_dto->address_line2) {
    if(cJSON_AddStringToObject(item, "addressLine2", order_line_update_dto->address_line2) == NULL) {
    goto fail; //String
    }
    }


    // order_line_update_dto->postal_code
    if(order_line_update_dto->postal_code) {
    if(cJSON_AddStringToObject(item, "postalCode", order_line_update_dto->postal_code) == NULL) {
    goto fail; //String
    }
    }


    // order_line_update_dto->country_id
    if(order_line_update_dto->country_id) {
    if(cJSON_AddStringToObject(item, "countryId", order_line_update_dto->country_id) == NULL) {
    goto fail; //String
    }
    }


    // order_line_update_dto->state_id
    if(order_line_update_dto->state_id) {
    if(cJSON_AddStringToObject(item, "stateId", order_line_update_dto->state_id) == NULL) {
    goto fail; //String
    }
    }


    // order_line_update_dto->city_id
    if(order_line_update_dto->city_id) {
    if(cJSON_AddStringToObject(item, "cityId", order_line_update_dto->city_id) == NULL) {
    goto fail; //String
    }
    }


    // order_line_update_dto->billing_location_id
    if(order_line_update_dto->billing_location_id) {
    if(cJSON_AddStringToObject(item, "billingLocationId", order_line_update_dto->billing_location_id) == NULL) {
    goto fail; //String
    }
    }
    ...
    // order_line_update_dto->shipping_method_id
    if(order_line_update_dto->shipping_method_id) {
    if(cJSON_AddStringToObject(item, "shippingMethodId", order_line_update_dto->shipping_method_id) == NULL) {
    goto fail; //String
    }
    }
...
order_line_update_dto_t *order_line_update_dto_parseFromJSON(cJSON *order_line_update_dtoJSON){
    ...
    // order_line_update_dto->title
    cJSON *title = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "title");
    if (title) { 
    ...
    // order_line_update_dto->user_id
    cJSON *user_id = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "userId");
    if (user_id) { 
    ...
    // order_line_update_dto->price_list_id
    cJSON *price_list_id = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "priceListId");
    if (price_list_id) { 
    ...
    // order_line_update_dto->individual_id
    cJSON *individual_id = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "individualId");
    if (individual_id) { 
    ...
    // order_line_update_dto->payment_term_id
    cJSON *payment_term_id = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "paymentTermId");
    if (payment_term_id) { 
    ...
    // order_line_update_dto->organization_id
    cJSON *organization_id = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "organizationId");
    if (organization_id) { 
    ...
    // order_line_update_dto->receiver_tenant_id
    cJSON *receiver_tenant_id = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "receiverTenantId");
    ...
    // order_line_update_dto->first_name
    cJSON *first_name = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "firstName");
    if (first_name) { 
    ...
    // order_line_update_dto->last_name
    cJSON *last_name = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "lastName");
    if (last_name) { 
    ...
    // order_line_update_dto->company_name
    cJSON *company_name = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "companyName");
    if (company_name) { 
    ...
    // order_line_update_dto->billing_email
    cJSON *billing_email = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "billingEmail");
    if (billing_email) { 
    ...
    // order_line_update_dto->address_line1
    cJSON *address_line1 = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "addressLine1");
    if (address_line1) { 
    ...
    // order_line_update_dto->address_line2
    cJSON *address_line2 = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "addressLine2");
    if (address_line2) { 
    ...
    // order_line_update_dto->postal_code
    cJSON *postal_code = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "postalCode");
    if (postal_code) { 
    ...
    // order_line_update_dto->country_id
    cJSON *country_id = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "countryId");
    if (country_id) { 
    ...
    // order_line_update_dto->state_id
    cJSON *state_id = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "stateId");
    if (state_id) { 
    ...
    // order_line_update_dto->city_id
    cJSON *city_id = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "cityId");
    if (city_id) { 
    ...
    // order_line_update_dto->billing_location_id
    cJSON *billing_location_id = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "billingLocationId");
    ...
    // order_line_update_dto->shipping_method_id
    cJSON *shipping_method_id = cJSON_GetObjectItemCaseSensitive(order_line_update_dtoJSON, "shippingMethodId");
