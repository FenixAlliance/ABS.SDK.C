...
cJSON *extended_order_dto_convertToJSON(extended_order_dto_t *extended_order_dto) {
    ...
    if(extended_order_dto->tax_calculation_method != ordersservice_extended_order_dto_TAXCALCULATIONMETHOD_NULL) {
    ...
    if(extended_order_dto->cost_calculation_method != ordersservice_extended_order_dto_COSTCALCULATIONMETHOD_NULL) {
    ...
    if(extended_order_dto->freight_terms != ordersservice_extended_order_dto_FREIGHTTERMS_NULL) {
    ...
    if(extended_order_dto->order_status != ordersservice_extended_order_dto_ORDERSTATUS_NULL) {
...
extended_order_dto_t *extended_order_dto_parseFromJSON(cJSON *extended_order_dtoJSON){
    ...
    ordersservice_extended_order_dto_TAXCALCULATIONMETHOD_e tax_calculation_methodVariable;
    ...
    ordersservice_extended_order_dto_FREIGHTTERMS_e freight_termsVariable;
    if (freight_terms) { 
    ...
    ordersservice_extended_order_dto_ORDERSTATUS_e order_statusVariable;
    if (order_status) { 
    ...
    extended_order_dto_local_var = extended_order_dto_create (
        ...
        tax_calculation_method ? tax_calculation_methodVariable : ordersservice_extended_order_dto_TAXCALCULATIONMETHOD_NULL,
