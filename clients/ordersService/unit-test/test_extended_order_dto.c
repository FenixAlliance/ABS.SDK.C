...
extended_order_dto_t* instantiate_extended_order_dto(int include_optional) {
  ...
  if (include_optional) {
    extended_order_dto = extended_order_dto_create(
      ...
      "0",
      "0",
      ordersservice_extended_order_dto_TAXCALCULATIONMETHOD_Included,
      1.337,
      "0",
      1.337,
      "0",
      ...
      "0",
      "0",
      ordersservice_extended_order_dto_COSTCALCULATIONMETHOD_Automatic,
      ordersservice_extended_order_dto_FREIGHTTERMS_FOB,
      ordersservice_extended_order_dto_ORDERSTATUS_New,
      "2013-10-20T19:20:30+01:00",
      1.337,
      1.337,
      1.337,
