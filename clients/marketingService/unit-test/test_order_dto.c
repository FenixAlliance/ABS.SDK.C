...
order_dto_t* instantiate_order_dto(int include_optional) {
  ...
  if (include_optional) {
    order_dto = order_dto_create(
      ...
      "0",
      "0",
      marketingservice_order_dto_TAXCALCULATIONMETHOD_Included,
      1.337,
      "0",
      1.337,
      "0",
      ...
      "0",
      "0",
      marketingservice_order_dto_COSTCALCULATIONMETHOD_Automatic,
      marketingservice_order_dto_FREIGHTTERMS_FOB,
      marketingservice_order_dto_ORDERSTATUS_New,
      "2013-10-20T19:20:30+01:00",
      1.337,
      1.337,
      1.337,
