...
//
void NewslettersAPI_getNewsletterODataAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, newsletter_dto_collection_query_parameters_t *newsletter_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**newsletter_dto_collection_query_parameters** | **[newsletter_dto_collection_query_parameters_t](newsletter_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* NewslettersAPI_getNewslettersCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, newsletter_dto_collection_query_parameters_t *newsletter_dto_collection_query_parameters);
```
...
//
empty_envelope_t* NewslettersAPI_patchNewsletterAsync(apiClient_t *apiClient, char *tenantId, char *newsletterId, char *api_version, char *x_api_version, list_t *patch_operation);
```
