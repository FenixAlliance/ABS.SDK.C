...
//
int32_envelope_t* SocialMediaPostsAPI_getSocialMediaPostsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, social_media_post_dto_collection_query_parameters_t *social_media_post_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**social_media_post_dto_collection_query_parameters** | **[social_media_post_dto_collection_query_parameters_t](social_media_post_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
social_media_post_dto_list_envelope_t* SocialMediaPostsAPI_getSocialMediaPostsODataAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, social_media_post_dto_collection_query_parameters_t *social_media_post_dto_collection_query_parameters);
```
...
//
empty_envelope_t* SocialMediaPostsAPI_patchSocialMediaPostAsync(apiClient_t *apiClient, char *tenantId, char *socialmediapostId, char *api_version, char *x_api_version, list_t *patch_operation);
```
