...
//
marketing_area_dto_list_envelope_t* MarketingAreasAPI_getMarketingAreasAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, marketing_area_dto_collection_query_parameters_t *marketing_area_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**marketing_area_dto_collection_query_parameters** | **[marketing_area_dto_collection_query_parameters_t](marketing_area_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* MarketingAreasAPI_getMarketingAreasCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, marketing_area_dto_collection_query_parameters_t *marketing_area_dto_collection_query_parameters);
```
...
//
empty_envelope_t* MarketingAreasAPI_patchMarketingAreaAsync(apiClient_t *apiClient, char *tenantId, char *marketingAreaId, char *api_version, char *x_api_version, list_t *patch_operation);
```
