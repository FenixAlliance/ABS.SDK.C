...
//
empty_envelope_t* MarketingCampaignsAPI_patchMarketingCampaignAsync(apiClient_t *apiClient, char *tenantId, char *marketingcampaignId, char *api_version, char *x_api_version, list_t *operation);
```
