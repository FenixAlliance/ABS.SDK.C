...
[**MarketingCampaignsAPI_patchMarketingCampaignAsync**](MarketingCampaignsAPI.md#MarketingCampaignsAPI_patchMarketingCampaignAsync) | **PATCH** /api/v2/MarketingService/MarketingCampaigns/{marketingcampaignId} | Patch a marketing campaign
...
//
void MarketingCampaignsAPI_getMarketingCampaignODataAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, marketing_campaign_dto_collection_query_parameters_t *marketing_campaign_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**marketing_campaign_dto_collection_query_parameters** | **[marketing_campaign_dto_collection_query_parameters_t](marketing_campaign_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* MarketingCampaignsAPI_getMarketingCampaignsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, marketing_campaign_dto_collection_query_parameters_t *marketing_campaign_dto_collection_query_parameters);
```
...
# **MarketingCampaignsAPI_patchMarketingCampaignAsync**
```c
// Patch a marketing campaign
//
// Partially updates a marketing campaign by its ID using JSON Patch.
//
empty_envelope_t* MarketingCampaignsAPI_patchMarketingCampaignAsync(apiClient_t *apiClient, char *tenantId, char *marketingcampaignId, char *api_version, char *x_api_version, list_t *patch_operation);
```
