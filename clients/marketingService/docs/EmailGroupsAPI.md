...
[**EmailGroupsAPI_patchEmailGroupAsync**](EmailGroupsAPI.md#EmailGroupsAPI_patchEmailGroupAsync) | **PATCH** /api/v2/MarketingService/EmailGroups/{emailgroupId} | Patch an email group
...
//
int32_envelope_t* EmailGroupsAPI_getEmailGroupsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, email_group_dto_collection_query_parameters_t *email_group_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**email_group_dto_collection_query_parameters** | **[email_group_dto_collection_query_parameters_t](email_group_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
email_group_dto_list_envelope_t* EmailGroupsAPI_getEmailGroupsODataAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, email_group_dto_collection_query_parameters_t *email_group_dto_collection_query_parameters);
```
...
# **EmailGroupsAPI_patchEmailGroupAsync**
```c
// Patch an email group
//
// Partially updates an email group by its ID using JSON Patch.
//
empty_envelope_t* EmailGroupsAPI_patchEmailGroupAsync(apiClient_t *apiClient, char *tenantId, char *emailgroupId, char *api_version, char *x_api_version, list_t *patch_operation);
```
