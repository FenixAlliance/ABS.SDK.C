...
#include <stdio.h>
#include <ctype.h>
#include "SocialPostBucketsAPI.h"
...
SocialPostBucketsAPI_createSocialPostBucketAsync(apiClient_t *apiClient, char *tenantId, social_post_bucket_create_dto_t *social_post_bucket_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/SocialPostBuckets")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/SocialPostBuckets");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_social_post_bucket_create_dto = NULL;
    if (social_post_bucket_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_social_post_bucket_create_dto = social_post_bucket_create_dto_convertToJSON(social_post_bucket_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_social_post_bucket_create_dto);
    }
    ...
    cJSON *SocialPostBucketsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SocialPostBucketsAPIlocalVarJSON);
    cJSON_Delete(SocialPostBucketsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_social_post_bucket_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_social_post_bucket_create_dto);
        localVarSingleItemJSON_social_post_bucket_create_dto = NULL;
    }
...
SocialPostBucketsAPI_deleteSocialPostBucketAsync(apiClient_t *apiClient, char *tenantId, char *socialpostbucketId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/SocialPostBuckets/{socialpostbucketId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/SocialPostBuckets/{socialpostbucketId}");


    // Path Params
    long sizeOfPathParams_socialpostbucketId = strlen(socialpostbucketId)+3 + strlen("{ socialpostbucketId }");
    if(socialpostbucketId == NULL) {
        goto end;
    }
    char* localVarToReplace_socialpostbucketId = malloc(sizeOfPathParams_socialpostbucketId);
    sprintf(localVarToReplace_socialpostbucketId, "{%s}", "socialpostbucketId");

    localVarPath = strReplace(localVarPath, localVarToReplace_socialpostbucketId, socialpostbucketId);
    if(socialpostbucketId == NULL) {
        goto end;
    }
    char* localVarToReplace_socialpostbucketId = malloc(sizeOfPathParams_socialpostbucketId);
    ...
    free(localVarPath);
    free(localVarToReplace_socialpostbucketId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
SocialPostBucketsAPI_getSocialPostBucketDetailsAsync(apiClient_t *apiClient, char *tenantId, char *socialpostbucketId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SocialPostBucketsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    social_post_bucket_dto_envelope_t *elementToReturn = social_post_bucket_dto_envelope_parseFromJSON(SocialPostBucketsAPIlocalVarJSON);
    cJSON_Delete(SocialPostBucketsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SocialPostBucketsAPI_getSocialPostBucketsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, social_post_bucket_dto_collection_query_parameters_t *social_post_bucket_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/SocialPostBuckets/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/SocialPostBuckets/Count");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_social_post_bucket_dto_collection_query_parameters = NULL;
    if (social_post_bucket_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_social_post_bucket_dto_collection_query_parameters = social_post_bucket_dto_collection_query_parameters_convertToJSON(social_post_bucket_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_social_post_bucket_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *SocialPostBucketsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SocialPostBucketsAPIlocalVarJSON);
    cJSON_Delete(SocialPostBucketsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_social_post_bucket_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_social_post_bucket_dto_collection_query_parameters);
        localVarSingleItemJSON_social_post_bucket_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SocialPostBucketsAPI_getSocialPostBucketsODataAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, social_post_bucket_dto_collection_query_parameters_t *social_post_bucket_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *SocialPostBucketsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    social_post_bucket_dto_list_envelope_t *elementToReturn = social_post_bucket_dto_list_envelope_parseFromJSON(SocialPostBucketsAPIlocalVarJSON);
    cJSON_Delete(SocialPostBucketsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SocialPostBucketsAPI_updateSocialPostBucketAsync(apiClient_t *apiClient, char *tenantId, char *socialpostbucketId, social_post_bucket_update_dto_t *social_post_bucket_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_social_post_bucket_update_dto = NULL;
    if (social_post_bucket_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_social_post_bucket_update_dto = social_post_bucket_update_dto_convertToJSON(social_post_bucket_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_social_post_bucket_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_social_post_bucket_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_social_post_bucket_update_dto);
        localVarSingleItemJSON_social_post_bucket_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
