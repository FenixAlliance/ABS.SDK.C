...
SocialMediaPostsAPI_createSocialMediaPostAsync(apiClient_t *apiClient, char *tenantId, social_media_post_create_dto_t *social_media_post_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/SocialMediaPosts")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/SocialMediaPosts");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_social_media_post_create_dto = NULL;
    if (social_media_post_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_social_media_post_create_dto = social_media_post_create_dto_convertToJSON(social_media_post_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_social_media_post_create_dto);
    }
    ...
    cJSON *SocialMediaPostsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SocialMediaPostsAPIlocalVarJSON);
    cJSON_Delete(SocialMediaPostsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_social_media_post_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_social_media_post_create_dto);
        localVarSingleItemJSON_social_media_post_create_dto = NULL;
    }
...
SocialMediaPostsAPI_deleteSocialMediaPostAsync(apiClient_t *apiClient, char *tenantId, char *socialmediapostId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/SocialMediaPosts/{socialmediapostId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/SocialMediaPosts/{socialmediapostId}");


    // Path Params
    long sizeOfPathParams_socialmediapostId = strlen(socialmediapostId)+3 + strlen("{ socialmediapostId }");
    if(socialmediapostId == NULL) {
        goto end;
    }
    char* localVarToReplace_socialmediapostId = malloc(sizeOfPathParams_socialmediapostId);
    sprintf(localVarToReplace_socialmediapostId, "{%s}", "socialmediapostId");

    localVarPath = strReplace(localVarPath, localVarToReplace_socialmediapostId, socialmediapostId);
    if(socialmediapostId == NULL) {
        goto end;
    }
    char* localVarToReplace_socialmediapostId = malloc(sizeOfPathParams_socialmediapostId);
    ...
    free(localVarPath);
    free(localVarToReplace_socialmediapostId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
SocialMediaPostsAPI_getSocialMediaPostDetailsAsync(apiClient_t *apiClient, char *tenantId, char *socialmediapostId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SocialMediaPostsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    social_media_post_dto_envelope_t *elementToReturn = social_media_post_dto_envelope_parseFromJSON(SocialMediaPostsAPIlocalVarJSON);
    cJSON_Delete(SocialMediaPostsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SocialMediaPostsAPI_getSocialMediaPostsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, social_media_post_dto_collection_query_parameters_t *social_media_post_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/SocialMediaPosts/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/SocialMediaPosts/Count");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_social_media_post_dto_collection_query_parameters = NULL;
    if (social_media_post_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_social_media_post_dto_collection_query_parameters = social_media_post_dto_collection_query_parameters_convertToJSON(social_media_post_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_social_media_post_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *SocialMediaPostsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SocialMediaPostsAPIlocalVarJSON);
    cJSON_Delete(SocialMediaPostsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_social_media_post_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_social_media_post_dto_collection_query_parameters);
        localVarSingleItemJSON_social_media_post_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SocialMediaPostsAPI_getSocialMediaPostsODataAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, social_media_post_dto_collection_query_parameters_t *social_media_post_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *SocialMediaPostsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    social_media_post_dto_list_envelope_t *elementToReturn = social_media_post_dto_list_envelope_parseFromJSON(SocialMediaPostsAPIlocalVarJSON);
    cJSON_Delete(SocialMediaPostsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SocialMediaPostsAPI_updateSocialMediaPostAsync(apiClient_t *apiClient, char *tenantId, char *socialmediapostId, social_media_post_update_dto_t *social_media_post_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_social_media_post_update_dto = NULL;
    if (social_media_post_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_social_media_post_update_dto = social_media_post_update_dto_convertToJSON(social_media_post_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_social_media_post_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_social_media_post_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_social_media_post_update_dto);
        localVarSingleItemJSON_social_media_post_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
