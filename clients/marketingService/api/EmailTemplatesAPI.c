...
EmailTemplatesAPI_createEmailTemplateAsync(apiClient_t *apiClient, char *tenantId, email_template_create_dto_t *email_template_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/EmailTemplates")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/EmailTemplates");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_email_template_create_dto = NULL;
    if (email_template_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_email_template_create_dto = email_template_create_dto_convertToJSON(email_template_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_email_template_create_dto);
    }
    ...
    cJSON *EmailTemplatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(EmailTemplatesAPIlocalVarJSON);
    cJSON_Delete(EmailTemplatesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_email_template_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_email_template_create_dto);
        localVarSingleItemJSON_email_template_create_dto = NULL;
    }
...
EmailTemplatesAPI_deleteEmailTemplateAsync(apiClient_t *apiClient, char *tenantId, char *emailTemplateId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/EmailTemplates/{emailTemplateId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/EmailTemplates/{emailTemplateId}");


    // Path Params
    long sizeOfPathParams_emailTemplateId = strlen(emailTemplateId)+3 + strlen("{ emailTemplateId }");
    if(emailTemplateId == NULL) {
        goto end;
    }
    char* localVarToReplace_emailTemplateId = malloc(sizeOfPathParams_emailTemplateId);
    sprintf(localVarToReplace_emailTemplateId, "{%s}", "emailTemplateId");

    localVarPath = strReplace(localVarPath, localVarToReplace_emailTemplateId, emailTemplateId);
    if(emailTemplateId == NULL) {
        goto end;
    }
    char* localVarToReplace_emailTemplateId = malloc(sizeOfPathParams_emailTemplateId);
    ...
    free(localVarPath);
    free(localVarToReplace_emailTemplateId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
EmailTemplatesAPI_getEmailTemplateDetailsAsync(apiClient_t *apiClient, char *tenantId, char *emailTemplateId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *EmailTemplatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    email_template_dto_envelope_t *elementToReturn = email_template_dto_envelope_parseFromJSON(EmailTemplatesAPIlocalVarJSON);
    cJSON_Delete(EmailTemplatesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
EmailTemplatesAPI_getEmailTemplatesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, email_template_dto_collection_query_parameters_t *email_template_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/EmailTemplates/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/EmailTemplates/Count");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_email_template_dto_collection_query_parameters = NULL;
    if (email_template_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_email_template_dto_collection_query_parameters = email_template_dto_collection_query_parameters_convertToJSON(email_template_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_email_template_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *EmailTemplatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(EmailTemplatesAPIlocalVarJSON);
    cJSON_Delete(EmailTemplatesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_email_template_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_email_template_dto_collection_query_parameters);
        localVarSingleItemJSON_email_template_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
EmailTemplatesAPI_getEmailTemplatesODataAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, email_template_dto_collection_query_parameters_t *email_template_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *EmailTemplatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    email_template_dto_list_envelope_t *elementToReturn = email_template_dto_list_envelope_parseFromJSON(EmailTemplatesAPIlocalVarJSON);
    cJSON_Delete(EmailTemplatesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
EmailTemplatesAPI_updateEmailTemplateAsync(apiClient_t *apiClient, char *tenantId, char *emailTemplateId, email_template_update_dto_t *email_template_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_email_template_update_dto = NULL;
    if (email_template_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_email_template_update_dto = email_template_update_dto_convertToJSON(email_template_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_email_template_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_email_template_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_email_template_update_dto);
        localVarSingleItemJSON_email_template_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
