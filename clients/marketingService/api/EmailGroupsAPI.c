...
EmailGroupsAPI_createEmailGroupAsync(apiClient_t *apiClient, char *tenantId, email_group_create_dto_t *email_group_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/EmailGroups")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/EmailGroups");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_email_group_create_dto = NULL;
    if (email_group_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_email_group_create_dto = email_group_create_dto_convertToJSON(email_group_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_email_group_create_dto);
    }
    ...
    cJSON *EmailGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(EmailGroupsAPIlocalVarJSON);
    cJSON_Delete(EmailGroupsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_email_group_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_email_group_create_dto);
        localVarSingleItemJSON_email_group_create_dto = NULL;
    }
...
EmailGroupsAPI_deleteEmailGroupAsync(apiClient_t *apiClient, char *tenantId, char *emailgroupId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/EmailGroups/{emailgroupId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/EmailGroups/{emailgroupId}");


    // Path Params
    long sizeOfPathParams_emailgroupId = strlen(emailgroupId)+3 + strlen("{ emailgroupId }");
    if(emailgroupId == NULL) {
        goto end;
    }
    char* localVarToReplace_emailgroupId = malloc(sizeOfPathParams_emailgroupId);
    sprintf(localVarToReplace_emailgroupId, "{%s}", "emailgroupId");

    localVarPath = strReplace(localVarPath, localVarToReplace_emailgroupId, emailgroupId);
    if(emailgroupId == NULL) {
        goto end;
    }
    char* localVarToReplace_emailgroupId = malloc(sizeOfPathParams_emailgroupId);
    ...
    free(localVarPath);
    free(localVarToReplace_emailgroupId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
EmailGroupsAPI_getEmailGroupDetailsAsync(apiClient_t *apiClient, char *tenantId, char *emailgroupId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *EmailGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    email_group_dto_envelope_t *elementToReturn = email_group_dto_envelope_parseFromJSON(EmailGroupsAPIlocalVarJSON);
    cJSON_Delete(EmailGroupsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
EmailGroupsAPI_getEmailGroupsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, email_group_dto_collection_query_parameters_t *email_group_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/EmailGroups/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/EmailGroups/Count");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_email_group_dto_collection_query_parameters = NULL;
    if (email_group_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_email_group_dto_collection_query_parameters = email_group_dto_collection_query_parameters_convertToJSON(email_group_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_email_group_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *EmailGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(EmailGroupsAPIlocalVarJSON);
    cJSON_Delete(EmailGroupsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_email_group_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_email_group_dto_collection_query_parameters);
        localVarSingleItemJSON_email_group_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
EmailGroupsAPI_getEmailGroupsODataAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, email_group_dto_collection_query_parameters_t *email_group_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *EmailGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    email_group_dto_list_envelope_t *elementToReturn = email_group_dto_list_envelope_parseFromJSON(EmailGroupsAPIlocalVarJSON);
    cJSON_Delete(EmailGroupsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
EmailGroupsAPI_updateEmailGroupAsync(apiClient_t *apiClient, char *tenantId, char *emailgroupId, email_group_update_dto_t *email_group_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_email_group_update_dto = NULL;
    if (email_group_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_email_group_update_dto = email_group_update_dto_convertToJSON(email_group_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_email_group_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_email_group_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_email_group_update_dto);
        localVarSingleItemJSON_email_group_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
