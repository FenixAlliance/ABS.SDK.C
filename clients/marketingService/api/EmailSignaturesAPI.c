...
EmailSignaturesAPI_createEmailSignatureAsync(apiClient_t *apiClient, char *tenantId, email_signature_create_dto_t *email_signature_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/EmailSignatures")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/EmailSignatures");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_email_signature_create_dto = NULL;
    if (email_signature_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_email_signature_create_dto = email_signature_create_dto_convertToJSON(email_signature_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_email_signature_create_dto);
    }
    ...
    cJSON *EmailSignaturesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(EmailSignaturesAPIlocalVarJSON);
    cJSON_Delete(EmailSignaturesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_email_signature_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_email_signature_create_dto);
        localVarSingleItemJSON_email_signature_create_dto = NULL;
    }
...
EmailSignaturesAPI_deleteEmailSignatureAsync(apiClient_t *apiClient, char *tenantId, char *emailsignatureId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/EmailSignatures/{emailsignatureId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/EmailSignatures/{emailsignatureId}");


    // Path Params
    long sizeOfPathParams_emailsignatureId = strlen(emailsignatureId)+3 + strlen("{ emailsignatureId }");
    if(emailsignatureId == NULL) {
        goto end;
    }
    char* localVarToReplace_emailsignatureId = malloc(sizeOfPathParams_emailsignatureId);
    sprintf(localVarToReplace_emailsignatureId, "{%s}", "emailsignatureId");

    localVarPath = strReplace(localVarPath, localVarToReplace_emailsignatureId, emailsignatureId);
    if(emailsignatureId == NULL) {
        goto end;
    }
    char* localVarToReplace_emailsignatureId = malloc(sizeOfPathParams_emailsignatureId);
    ...
    free(localVarPath);
    free(localVarToReplace_emailsignatureId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
EmailSignaturesAPI_getEmailSignatureDetailsAsync(apiClient_t *apiClient, char *tenantId, char *emailsignatureId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *EmailSignaturesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    email_signature_dto_envelope_t *elementToReturn = email_signature_dto_envelope_parseFromJSON(EmailSignaturesAPIlocalVarJSON);
    cJSON_Delete(EmailSignaturesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
EmailSignaturesAPI_getEmailSignaturesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, email_signature_dto_collection_query_parameters_t *email_signature_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/EmailSignatures/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/EmailSignatures/Count");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_email_signature_dto_collection_query_parameters = NULL;
    if (email_signature_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_email_signature_dto_collection_query_parameters = email_signature_dto_collection_query_parameters_convertToJSON(email_signature_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_email_signature_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *EmailSignaturesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(EmailSignaturesAPIlocalVarJSON);
    cJSON_Delete(EmailSignaturesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_email_signature_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_email_signature_dto_collection_query_parameters);
        localVarSingleItemJSON_email_signature_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
EmailSignaturesAPI_getEmailSignaturesODataAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, email_signature_dto_collection_query_parameters_t *email_signature_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *EmailSignaturesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    email_signature_dto_list_envelope_t *elementToReturn = email_signature_dto_list_envelope_parseFromJSON(EmailSignaturesAPIlocalVarJSON);
    cJSON_Delete(EmailSignaturesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
EmailSignaturesAPI_updateEmailSignatureAsync(apiClient_t *apiClient, char *tenantId, char *emailsignatureId, email_signature_update_dto_t *email_signature_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_email_signature_update_dto = NULL;
    if (email_signature_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_email_signature_update_dto = email_signature_update_dto_convertToJSON(email_signature_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_email_signature_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_email_signature_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_email_signature_update_dto);
        localVarSingleItemJSON_email_signature_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
