...
MarketingListsAPI_createMarketingListAsync(apiClient_t *apiClient, char *tenantId, marketing_list_create_dto_t *marketing_list_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/MarketingLists")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/MarketingLists");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_marketing_list_create_dto = NULL;
    if (marketing_list_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_marketing_list_create_dto = marketing_list_create_dto_convertToJSON(marketing_list_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_marketing_list_create_dto);
    }
    ...
    cJSON *MarketingListsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(MarketingListsAPIlocalVarJSON);
    cJSON_Delete(MarketingListsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_marketing_list_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_marketing_list_create_dto);
        localVarSingleItemJSON_marketing_list_create_dto = NULL;
    }
...
MarketingListsAPI_deleteMarketingListAsync(apiClient_t *apiClient, char *tenantId, char *marketinglistId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/MarketingLists/{marketinglistId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/MarketingLists/{marketinglistId}");


    // Path Params
    long sizeOfPathParams_marketinglistId = strlen(marketinglistId)+3 + strlen("{ marketinglistId }");
    if(marketinglistId == NULL) {
        goto end;
    }
    char* localVarToReplace_marketinglistId = malloc(sizeOfPathParams_marketinglistId);
    sprintf(localVarToReplace_marketinglistId, "{%s}", "marketinglistId");

    localVarPath = strReplace(localVarPath, localVarToReplace_marketinglistId, marketinglistId);
    if(marketinglistId == NULL) {
        goto end;
    }
    char* localVarToReplace_marketinglistId = malloc(sizeOfPathParams_marketinglistId);
    ...
    free(localVarPath);
    free(localVarToReplace_marketinglistId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
MarketingListsAPI_getMarketingListDetailsAsync(apiClient_t *apiClient, char *tenantId, char *marketinglistId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *MarketingListsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    marketing_list_dto_envelope_t *elementToReturn = marketing_list_dto_envelope_parseFromJSON(MarketingListsAPIlocalVarJSON);
    cJSON_Delete(MarketingListsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
MarketingListsAPI_getMarketingListODataAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, marketing_list_dto_collection_query_parameters_t *marketing_list_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_marketing_list_dto_collection_query_parameters = NULL;
    if (marketing_list_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_marketing_list_dto_collection_query_parameters = marketing_list_dto_collection_query_parameters_convertToJSON(marketing_list_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_marketing_list_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *MarketingListsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    marketing_list_dto_list_envelope_t *elementToReturn = marketing_list_dto_list_envelope_parseFromJSON(MarketingListsAPIlocalVarJSON);
    cJSON_Delete(MarketingListsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_marketing_list_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_marketing_list_dto_collection_query_parameters);
        localVarSingleItemJSON_marketing_list_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
MarketingListsAPI_getMarketingListsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, marketing_list_dto_collection_query_parameters_t *marketing_list_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/MarketingLists/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/MarketingLists/Count");
    ...
    //nonprimitive not container
    cJSON *MarketingListsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(MarketingListsAPIlocalVarJSON);
    cJSON_Delete(MarketingListsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
MarketingListsAPI_updateMarketingListAsync(apiClient_t *apiClient, char *tenantId, char *marketinglistId, marketing_list_update_dto_t *marketing_list_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_marketing_list_update_dto = NULL;
    if (marketing_list_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_marketing_list_update_dto = marketing_list_update_dto_convertToJSON(marketing_list_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_marketing_list_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_marketing_list_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_marketing_list_update_dto);
        localVarSingleItemJSON_marketing_list_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
