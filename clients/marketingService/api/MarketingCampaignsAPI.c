...
#include <stdio.h>
#include <ctype.h>
#include "MarketingCampaignsAPI.h"
...
MarketingCampaignsAPI_createMarketingCampaignAsync(apiClient_t *apiClient, char *tenantId, marketing_campaign_create_dto_t *marketing_campaign_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/MarketingCampaigns")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/MarketingCampaigns");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_marketing_campaign_create_dto = NULL;
    if (marketing_campaign_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_marketing_campaign_create_dto = marketing_campaign_create_dto_convertToJSON(marketing_campaign_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_marketing_campaign_create_dto);
    }
    ...
    cJSON *MarketingCampaignsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(MarketingCampaignsAPIlocalVarJSON);
    cJSON_Delete(MarketingCampaignsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_marketing_campaign_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_marketing_campaign_create_dto);
        localVarSingleItemJSON_marketing_campaign_create_dto = NULL;
    }
...
MarketingCampaignsAPI_deleteMarketingCampaignAsync(apiClient_t *apiClient, char *tenantId, char *marketingcampaignId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/MarketingCampaigns/{marketingcampaignId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/MarketingCampaigns/{marketingcampaignId}");


    // Path Params
    long sizeOfPathParams_marketingcampaignId = strlen(marketingcampaignId)+3 + strlen("{ marketingcampaignId }");
    if(marketingcampaignId == NULL) {
        goto end;
    }
    char* localVarToReplace_marketingcampaignId = malloc(sizeOfPathParams_marketingcampaignId);
    sprintf(localVarToReplace_marketingcampaignId, "{%s}", "marketingcampaignId");

    localVarPath = strReplace(localVarPath, localVarToReplace_marketingcampaignId, marketingcampaignId);
    if(marketingcampaignId == NULL) {
        goto end;
    }
    char* localVarToReplace_marketingcampaignId = malloc(sizeOfPathParams_marketingcampaignId);
    ...
    free(localVarPath);
    free(localVarToReplace_marketingcampaignId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
MarketingCampaignsAPI_getMarketingCampaignDetailsAsync(apiClient_t *apiClient, char *tenantId, char *marketingcampaignId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *MarketingCampaignsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    marketing_campaign_dto_envelope_t *elementToReturn = marketing_campaign_dto_envelope_parseFromJSON(MarketingCampaignsAPIlocalVarJSON);
    cJSON_Delete(MarketingCampaignsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
MarketingCampaignsAPI_getMarketingCampaignODataAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, marketing_campaign_dto_collection_query_parameters_t *marketing_campaign_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_marketing_campaign_dto_collection_query_parameters = NULL;
    if (marketing_campaign_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_marketing_campaign_dto_collection_query_parameters = marketing_campaign_dto_collection_query_parameters_convertToJSON(marketing_campaign_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_marketing_campaign_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_marketing_campaign_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_marketing_campaign_dto_collection_query_parameters);
        localVarSingleItemJSON_marketing_campaign_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
MarketingCampaignsAPI_getMarketingCampaignsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, marketing_campaign_dto_collection_query_parameters_t *marketing_campaign_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/MarketingCampaigns/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/MarketingCampaigns/Count");
    ...
    //nonprimitive not container
    cJSON *MarketingCampaignsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(MarketingCampaignsAPIlocalVarJSON);
    cJSON_Delete(MarketingCampaignsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
MarketingCampaignsAPI_updateMarketingCampaignAsync(apiClient_t *apiClient, char *tenantId, char *marketingcampaignId, marketing_campaign_update_dto_t *marketing_campaign_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_marketing_campaign_update_dto = NULL;
    if (marketing_campaign_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_marketing_campaign_update_dto = marketing_campaign_update_dto_convertToJSON(marketing_campaign_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_marketing_campaign_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_marketing_campaign_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_marketing_campaign_update_dto);
        localVarSingleItemJSON_marketing_campaign_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
