...
NewslettersAPI_createNewsletterAsync(apiClient_t *apiClient, char *tenantId, newsletter_create_dto_t *newsletter_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/Newsletters")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/Newsletters");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_newsletter_create_dto = NULL;
    if (newsletter_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_newsletter_create_dto = newsletter_create_dto_convertToJSON(newsletter_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_newsletter_create_dto);
    }
    ...
    cJSON *NewslettersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(NewslettersAPIlocalVarJSON);
    cJSON_Delete(NewslettersAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_newsletter_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_newsletter_create_dto);
        localVarSingleItemJSON_newsletter_create_dto = NULL;
    }
...
NewslettersAPI_deleteNewsletterAsync(apiClient_t *apiClient, char *tenantId, char *newsletterId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/Newsletters/{newsletterId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/Newsletters/{newsletterId}");


    // Path Params
    long sizeOfPathParams_newsletterId = strlen(newsletterId)+3 + strlen("{ newsletterId }");
    if(newsletterId == NULL) {
        goto end;
    }
    char* localVarToReplace_newsletterId = malloc(sizeOfPathParams_newsletterId);
    sprintf(localVarToReplace_newsletterId, "{%s}", "newsletterId");

    localVarPath = strReplace(localVarPath, localVarToReplace_newsletterId, newsletterId);
    if(newsletterId == NULL) {
        goto end;
    }
    char* localVarToReplace_newsletterId = malloc(sizeOfPathParams_newsletterId);
    ...
    free(localVarPath);
    free(localVarToReplace_newsletterId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
NewslettersAPI_getNewsletterDetailsAsync(apiClient_t *apiClient, char *tenantId, char *newsletterId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *NewslettersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    newsletter_dto_envelope_t *elementToReturn = newsletter_dto_envelope_parseFromJSON(NewslettersAPIlocalVarJSON);
    cJSON_Delete(NewslettersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
NewslettersAPI_getNewsletterODataAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, newsletter_dto_collection_query_parameters_t *newsletter_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_newsletter_dto_collection_query_parameters = NULL;
    if (newsletter_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_newsletter_dto_collection_query_parameters = newsletter_dto_collection_query_parameters_convertToJSON(newsletter_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_newsletter_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_newsletter_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_newsletter_dto_collection_query_parameters);
        localVarSingleItemJSON_newsletter_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
NewslettersAPI_getNewslettersCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, newsletter_dto_collection_query_parameters_t *newsletter_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/Newsletters/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/Newsletters/Count");
    ...
    //nonprimitive not container
    cJSON *NewslettersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(NewslettersAPIlocalVarJSON);
    cJSON_Delete(NewslettersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
NewslettersAPI_updateNewsletterAsync(apiClient_t *apiClient, char *tenantId, char *newsletterId, newsletter_update_dto_t *newsletter_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_newsletter_update_dto = NULL;
    if (newsletter_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_newsletter_update_dto = newsletter_update_dto_convertToJSON(newsletter_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_newsletter_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_newsletter_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_newsletter_update_dto);
        localVarSingleItemJSON_newsletter_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
