...
MarketingAreasAPI_createMarketingAreaAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, marketing_area_create_dto_t *marketing_area_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/MarketingAreas")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/MarketingAreas");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_marketing_area_create_dto = NULL;
    if (marketing_area_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_marketing_area_create_dto = marketing_area_create_dto_convertToJSON(marketing_area_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_marketing_area_create_dto);
    }
    ...
    cJSON *MarketingAreasAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(MarketingAreasAPIlocalVarJSON);
    cJSON_Delete(MarketingAreasAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_marketing_area_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_marketing_area_create_dto);
        localVarSingleItemJSON_marketing_area_create_dto = NULL;
    }
...
MarketingAreasAPI_deleteMarketingAreaAsync(apiClient_t *apiClient, char *tenantId, char *marketingAreaId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/MarketingAreas/{marketingAreaId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/MarketingAreas/{marketingAreaId}");


    // Path Params
    long sizeOfPathParams_marketingAreaId = strlen(marketingAreaId)+3 + strlen("{ marketingAreaId }");
    if(marketingAreaId == NULL) {
        goto end;
    }
    char* localVarToReplace_marketingAreaId = malloc(sizeOfPathParams_marketingAreaId);
    sprintf(localVarToReplace_marketingAreaId, "{%s}", "marketingAreaId");

    localVarPath = strReplace(localVarPath, localVarToReplace_marketingAreaId, marketingAreaId);
    if(marketingAreaId == NULL) {
        goto end;
    }
    char* localVarToReplace_marketingAreaId = malloc(sizeOfPathParams_marketingAreaId);
    ...
    free(localVarPath);
    free(localVarToReplace_marketingAreaId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
MarketingAreasAPI_getMarketingAreaByIdAsync(apiClient_t *apiClient, char *tenantId, char *marketingAreaId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *MarketingAreasAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    marketing_area_dto_envelope_t *elementToReturn = marketing_area_dto_envelope_parseFromJSON(MarketingAreasAPIlocalVarJSON);
    cJSON_Delete(MarketingAreasAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
MarketingAreasAPI_getMarketingAreasAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, marketing_area_dto_collection_query_parameters_t *marketing_area_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_marketing_area_dto_collection_query_parameters = NULL;
    if (marketing_area_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_marketing_area_dto_collection_query_parameters = marketing_area_dto_collection_query_parameters_convertToJSON(marketing_area_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_marketing_area_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *MarketingAreasAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    marketing_area_dto_list_envelope_t *elementToReturn = marketing_area_dto_list_envelope_parseFromJSON(MarketingAreasAPIlocalVarJSON);
    cJSON_Delete(MarketingAreasAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_marketing_area_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_marketing_area_dto_collection_query_parameters);
        localVarSingleItemJSON_marketing_area_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
MarketingAreasAPI_getMarketingAreasCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, marketing_area_dto_collection_query_parameters_t *marketing_area_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/MarketingService/MarketingAreas/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/MarketingService/MarketingAreas/Count");
    ...
    //nonprimitive not container
    cJSON *MarketingAreasAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(MarketingAreasAPIlocalVarJSON);
    cJSON_Delete(MarketingAreasAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
MarketingAreasAPI_updateMarketingAreaAsync(apiClient_t *apiClient, char *tenantId, char *marketingAreaId, char *api_version, char *x_api_version, marketing_area_update_dto_t *marketing_area_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_marketing_area_update_dto = NULL;
    if (marketing_area_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_marketing_area_update_dto = marketing_area_update_dto_convertToJSON(marketing_area_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_marketing_area_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_marketing_area_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_marketing_area_update_dto);
        localVarSingleItemJSON_marketing_area_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
