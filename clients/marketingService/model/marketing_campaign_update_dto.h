/*
 * marketing_campaign_update_dto.h
 *
 * 
 */

#ifndef _marketing_campaign_update_dto_H_
#define _marketing_campaign_update_dto_H_
...
typedef struct marketing_campaign_update_dto_t marketing_campaign_update_dto_t;




typedef struct marketing_campaign_update_dto_t {
    char *name; // string
    char *offer; // string
    int active; //boolean
...
} marketing_campaign_update_dto_t;
...
#endif /* _marketing_campaign_update_dto_H_ */
