/*
 * email_signature_dto.h
 *
 * 
 */

#ifndef _email_signature_dto_H_
#define _email_signature_dto_H_
...
typedef struct email_signature_dto_t email_signature_dto_t;

#include "any_type.h"

// Enum CODETYPE for email_signature_dto

typedef enum  { marketingservice_email_signature_dto_CODETYPE_NULL = 0, marketingservice_email_signature_dto_CODETYPE_Razor, marketingservice_email_signature_dto_CODETYPE_CSharp, marketingservice_email_signature_dto_CODETYPE_CSHtml, marketingservice_email_signature_dto_CODETYPE_Liquid, marketingservice_email_signature_dto_CODETYPE_Html5, marketingservice_email_signature_dto_CODETYPE_Markdown, marketingservice_email_signature_dto_CODETYPE_Markup } marketingservice_email_signature_dto_CODETYPE_e;
...
typedef struct email_signature_dto_t {
    char *id; // string
    char *timestamp; //date time
    marketingservice_email_signature_dto_CODETYPE_e code_type; //enum
    int order; //numeric
    char *slug; // string
    char *name; // string
    char *title; // string
