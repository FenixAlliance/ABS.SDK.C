...
char* order_dto_tax_calculation_method_ToString(marketingservice_order_dto_TAXCALCULATIONMETHOD_e tax_calculation_method) {
    char* tax_calculation_methodArray[] =  { "NULL", "Included", "Excluded" };
    return tax_calculation_methodArray[tax_calculation_method];
}

marketingservice_order_dto_TAXCALCULATIONMETHOD_e order_dto_tax_calculation_method_FromString(char* tax_calculation_method){
...
char* order_dto_cost_calculation_method_ToString(marketingservice_order_dto_COSTCALCULATIONMETHOD_e cost_calculation_method) {
    char* cost_calculation_methodArray[] =  { "NULL", "Automatic", "Custom" };
    return cost_calculation_methodArray[cost_calculation_method];
}

marketingservice_order_dto_COSTCALCULATIONMETHOD_e order_dto_cost_calculation_method_FromString(char* cost_calculation_method){
    int stringToReturn = 0;
    char *cost_calculation_methodArray[] =  { "NULL", "Automatic", "Custom" };
...
char* order_dto_freight_terms_ToString(marketingservice_order_dto_FREIGHTTERMS_e freight_terms) {
    char* freight_termsArray[] =  { "NULL", "FOB", "NoCharge" };
    return freight_termsArray[freight_terms];
}

marketingservice_order_dto_FREIGHTTERMS_e order_dto_freight_terms_FromString(char* freight_terms){
    int stringToReturn = 0;
    char *freight_termsArray[] =  { "NULL", "FOB", "NoCharge" };
...
char* order_dto_order_status_ToString(marketingservice_order_dto_ORDERSTATUS_e order_status) {
...
marketingservice_order_dto_ORDERSTATUS_e order_dto_order_status_FromString(char* order_status){
    int stringToReturn = 0;
    char *order_statusArray[] =  { "NULL", "New", "Processing", "Accepted", "Declined", "Shipped", "Delivered", "OnHold", "Failed", "Fulfilled", "Cancelled" };
...
order_dto_t *order_dto_create(
    ...
    char *city_id,
    char *customer_notes,
    marketingservice_order_dto_TAXCALCULATIONMETHOD_e tax_calculation_method,
    marketingservice_order_dto_COSTCALCULATIONMETHOD_e cost_calculation_method,
    double forex_rate,
    ...
    marketingservice_order_dto_FREIGHTTERMS_e freight_terms,
    marketingservice_order_dto_ORDERSTATUS_e order_status,
...
void order_dto_free(order_dto_t *order_dto) {
    ...
    if (order_dto->seller_billing_profile_id) {
        free(order_dto->seller_billing_profile_id);
        order_dto->seller_billing_profile_id = NULL;
    }
    if (order_dto->buyer_billing_profile_id) {
        free(order_dto->buyer_billing_profile_id);
        order_dto->buyer_billing_profile_id = NULL;
    }
...
cJSON *order_dto_convertToJSON(order_dto_t *order_dto) {
    ...
    if(order_dto->tax_calculation_method != marketingservice_order_dto_TAXCALCULATIONMETHOD_NULL) {
    ...
    if(order_dto->cost_calculation_method != marketingservice_order_dto_COSTCALCULATIONMETHOD_NULL) {
    ...
    // order_dto->seller_billing_profile_id
    if(order_dto->seller_billing_profile_id) {
    if(cJSON_AddStringToObject(item, "sellerBillingProfileId", order_dto->seller_billing_profile_id) == NULL) {
    goto fail; //String
    }
    }


    // order_dto->buyer_billing_profile_id
    if(order_dto->buyer_billing_profile_id) {
    if(cJSON_AddStringToObject(item, "buyerBillingProfileId", order_dto->buyer_billing_profile_id) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(order_dto->freight_terms != marketingservice_order_dto_FREIGHTTERMS_NULL) {
    ...
    if(order_dto->order_status != marketingservice_order_dto_ORDERSTATUS_NULL) {
...
order_dto_t *order_dto_parseFromJSON(cJSON *order_dtoJSON){
    ...
    marketingservice_order_dto_TAXCALCULATIONMETHOD_e tax_calculation_methodVariable;
    ...
    marketingservice_order_dto_COSTCALCULATIONMETHOD_e cost_calculation_methodVariable;
    ...
    // order_dto->seller_billing_profile_id
    cJSON *seller_billing_profile_id = cJSON_GetObjectItemCaseSensitive(order_dtoJSON, "sellerBillingProfileId");
    ...
    // order_dto->buyer_billing_profile_id
    cJSON *buyer_billing_profile_id = cJSON_GetObjectItemCaseSensitive(order_dtoJSON, "buyerBillingProfileId");
    ...
    marketingservice_order_dto_FREIGHTTERMS_e freight_termsVariable;
    if (freight_terms) { 
    ...
    marketingservice_order_dto_ORDERSTATUS_e order_statusVariable;
    if (order_status) { 
    ...
    order_dto_local_var = order_dto_create (
        ...
        tax_calculation_method ? tax_calculation_methodVariable : marketingservice_order_dto_TAXCALCULATIONMETHOD_NULL,
        cost_calculation_method ? cost_calculation_methodVariable : marketingservice_order_dto_COSTCALCULATIONMETHOD_NULL,
        ...
        freight_terms ? freight_termsVariable : marketingservice_order_dto_FREIGHTTERMS_NULL,
        order_status ? order_statusVariable : marketingservice_order_dto_ORDERSTATUS_NULL,
