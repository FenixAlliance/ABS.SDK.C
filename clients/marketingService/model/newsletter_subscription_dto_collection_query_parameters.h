/*
 * newsletter_subscription_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _newsletter_subscription_dto_collection_query_parameters_H_
#define _newsletter_subscription_dto_collection_query_parameters_H_
...
typedef struct newsletter_subscription_dto_collection_query_parameters_t newsletter_subscription_dto_collection_query_parameters_t;




typedef struct newsletter_subscription_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} newsletter_subscription_dto_collection_query_parameters_t;
...
#endif /* _newsletter_subscription_dto_collection_query_parameters_H_ */
