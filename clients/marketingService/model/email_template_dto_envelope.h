/*
 * email_template_dto_envelope.h
 *
 * 
 */

#ifndef _email_template_dto_envelope_H_
#define _email_template_dto_envelope_H_
...
typedef struct email_template_dto_envelope_t email_template_dto_envelope_t;

#include "email_template_dto.h"



typedef struct email_template_dto_envelope_t {
    int is_success; //boolean
    char *error_message; // string
    char *correlation_id; // string
    char *timestamp; //date time
    char *activity_id; // string
    struct email_template_dto_t *result; //model
...
#endif /* _email_template_dto_envelope_H_ */
