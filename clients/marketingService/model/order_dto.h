...
typedef enum  { marketingservice_order_dto_TAXCALCULATIONMETHOD_NULL = 0, marketingservice_order_dto_TAXCALCULATIONMETHOD_Included, marketingservice_order_dto_TAXCALCULATIONMETHOD_Excluded } marketingservice_order_dto_TAXCALCULATIONMETHOD_e;
...
typedef enum  { marketingservice_order_dto_COSTCALCULATIONMETHOD_NULL = 0, marketingservice_order_dto_COSTCALCULATIONMETHOD_Automatic, marketingservice_order_dto_COSTCALCULATIONMETHOD_Custom } marketingservice_order_dto_COSTCALCULATIONMETHOD_e;
...
typedef enum  { marketingservice_order_dto_FREIGHTTERMS_NULL = 0, marketingservice_order_dto_FREIGHTTERMS_FOB, marketingservice_order_dto_FREIGHTTERMS_NoCharge } marketingservice_order_dto_FREIGHTTERMS_e;
...
typedef enum  { marketingservice_order_dto_ORDERSTATUS_NULL = 0, marketingservice_order_dto_ORDERSTATUS__New, marketingservice_order_dto_ORDERSTATUS_Processing, marketingservice_order_dto_ORDERSTATUS_Accepted, marketingservice_order_dto_ORDERSTATUS_Declined, marketingservice_order_dto_ORDERSTATUS_Shipped, marketingservice_order_dto_ORDERSTATUS_Delivered, marketingservice_order_dto_ORDERSTATUS_OnHold, marketingservice_order_dto_ORDERSTATUS_Failed, marketingservice_order_dto_ORDERSTATUS_Fulfilled, marketingservice_order_dto_ORDERSTATUS_Cancelled } marketingservice_order_dto_ORDERSTATUS_e;
...
typedef struct order_dto_t {
    ...
    marketingservice_order_dto_TAXCALCULATIONMETHOD_e tax_calculation_method; //enum
    ...
    marketingservice_order_dto_COSTCALCULATIONMETHOD_e cost_calculation_method; //enum
    marketingservice_order_dto_FREIGHTTERMS_e freight_terms; //enum
    marketingservice_order_dto_ORDERSTATUS_e order_status; //enum
