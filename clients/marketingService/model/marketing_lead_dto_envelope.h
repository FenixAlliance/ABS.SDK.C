/*
 * marketing_lead_dto_envelope.h
 *
 * 
 */

#ifndef _marketing_lead_dto_envelope_H_
#define _marketing_lead_dto_envelope_H_
...
typedef struct marketing_lead_dto_envelope_t marketing_lead_dto_envelope_t;

#include "marketing_lead_dto.h"



typedef struct marketing_lead_dto_envelope_t {
    ...
    struct marketing_lead_dto_t *result; //model
...
#endif /* _marketing_lead_dto_envelope_H_ */
