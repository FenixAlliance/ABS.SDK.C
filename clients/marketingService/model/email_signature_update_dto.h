/*
 * email_signature_update_dto.h
 *
 * 
 */

#ifndef _email_signature_update_dto_H_
#define _email_signature_update_dto_H_
...
typedef struct email_signature_update_dto_t email_signature_update_dto_t;


// Enum CODETYPE for email_signature_update_dto

typedef enum  { marketingservice_email_signature_update_dto_CODETYPE_NULL = 0, marketingservice_email_signature_update_dto_CODETYPE_Razor, marketingservice_email_signature_update_dto_CODETYPE_CSharp, marketingservice_email_signature_update_dto_CODETYPE_CSHtml, marketingservice_email_signature_update_dto_CODETYPE_Liquid, marketingservice_email_signature_update_dto_CODETYPE_Html5, marketingservice_email_signature_update_dto_CODETYPE_Markdown, marketingservice_email_signature_update_dto_CODETYPE_Markup } marketingservice_email_signature_update_dto_CODETYPE_e;
...
typedef struct email_signature_update_dto_t {
    int order; //numeric
    char *slug; // string
    char *name; // string
    char *title; // string
    ...
    marketingservice_email_signature_update_dto_CODETYPE_e code_type; //enum
...
#endif /* _email_signature_update_dto_H_ */
