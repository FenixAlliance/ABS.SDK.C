...
#include <stdio.h>
#include <ctype.h>
#include "SupportTicketTypesAPI.h"
...
SupportTicketTypesAPI_createSupportTicketTypeAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, support_ticket_type_create_dto_t *support_ticket_type_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportTicketTypes")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportTicketTypes");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_support_ticket_type_create_dto = NULL;
    if (support_ticket_type_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_support_ticket_type_create_dto = support_ticket_type_create_dto_convertToJSON(support_ticket_type_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_support_ticket_type_create_dto);
    }
    ...
    cJSON *SupportTicketTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SupportTicketTypesAPIlocalVarJSON);
    cJSON_Delete(SupportTicketTypesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_support_ticket_type_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_support_ticket_type_create_dto);
        localVarSingleItemJSON_support_ticket_type_create_dto = NULL;
    }
...
SupportTicketTypesAPI_deleteSupportTicketTypeAsync(apiClient_t *apiClient, char *tenantId, char *supportTicketTypeId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportTicketTypes/{supportTicketTypeId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportTicketTypes/{supportTicketTypeId}");


    // Path Params
    long sizeOfPathParams_supportTicketTypeId = strlen(supportTicketTypeId)+3 + strlen("{ supportTicketTypeId }");
    if(supportTicketTypeId == NULL) {
        goto end;
    }
    char* localVarToReplace_supportTicketTypeId = malloc(sizeOfPathParams_supportTicketTypeId);
    sprintf(localVarToReplace_supportTicketTypeId, "{%s}", "supportTicketTypeId");

    localVarPath = strReplace(localVarPath, localVarToReplace_supportTicketTypeId, supportTicketTypeId);
    if(supportTicketTypeId == NULL) {
        goto end;
    }
    char* localVarToReplace_supportTicketTypeId = malloc(sizeOfPathParams_supportTicketTypeId);
    ...
    free(localVarPath);
    free(localVarToReplace_supportTicketTypeId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
SupportTicketTypesAPI_getSupportTicketTypeAsync(apiClient_t *apiClient, char *tenantId, char *supportTicketTypeId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SupportTicketTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    support_ticket_type_dto_envelope_t *elementToReturn = support_ticket_type_dto_envelope_parseFromJSON(SupportTicketTypesAPIlocalVarJSON);
    cJSON_Delete(SupportTicketTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SupportTicketTypesAPI_getSupportTicketTypesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, support_ticket_type_dto_collection_query_parameters_t *support_ticket_type_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_support_ticket_type_dto_collection_query_parameters = NULL;
    if (support_ticket_type_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_support_ticket_type_dto_collection_query_parameters = support_ticket_type_dto_collection_query_parameters_convertToJSON(support_ticket_type_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_support_ticket_type_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *SupportTicketTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    support_ticket_type_dto_list_envelope_t *elementToReturn = support_ticket_type_dto_list_envelope_parseFromJSON(SupportTicketTypesAPIlocalVarJSON);
    cJSON_Delete(SupportTicketTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_support_ticket_type_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_support_ticket_type_dto_collection_query_parameters);
        localVarSingleItemJSON_support_ticket_type_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SupportTicketTypesAPI_getSupportTicketTypesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, support_ticket_type_dto_collection_query_parameters_t *support_ticket_type_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportTicketTypes/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportTicketTypes/Count");
    ...
    //nonprimitive not container
    cJSON *SupportTicketTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SupportTicketTypesAPIlocalVarJSON);
    cJSON_Delete(SupportTicketTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SupportTicketTypesAPI_updateSupportTicketTypeAsync(apiClient_t *apiClient, char *tenantId, char *supportTicketTypeId, char *api_version, char *x_api_version, support_ticket_type_update_dto_t *support_ticket_type_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_support_ticket_type_update_dto = NULL;
    if (support_ticket_type_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_support_ticket_type_update_dto = support_ticket_type_update_dto_convertToJSON(support_ticket_type_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_support_ticket_type_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_support_ticket_type_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_support_ticket_type_update_dto);
        localVarSingleItemJSON_support_ticket_type_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
