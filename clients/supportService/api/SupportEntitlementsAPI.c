...
#include <stdio.h>
#include <ctype.h>
#include "SupportEntitlementsAPI.h"
...
SupportEntitlementsAPI_createSupportEntitlementAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, support_entitlement_create_dto_t *support_entitlement_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportEntitlements")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportEntitlements");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_support_entitlement_create_dto = NULL;
    if (support_entitlement_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_support_entitlement_create_dto = support_entitlement_create_dto_convertToJSON(support_entitlement_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_support_entitlement_create_dto);
    }
    ...
    cJSON *SupportEntitlementsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SupportEntitlementsAPIlocalVarJSON);
    cJSON_Delete(SupportEntitlementsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_support_entitlement_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_support_entitlement_create_dto);
        localVarSingleItemJSON_support_entitlement_create_dto = NULL;
    }
...
SupportEntitlementsAPI_deleteSupportEntitlementAsync(apiClient_t *apiClient, char *tenantId, char *supportEntitlementId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportEntitlements/{supportEntitlementId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportEntitlements/{supportEntitlementId}");


    // Path Params
    long sizeOfPathParams_supportEntitlementId = strlen(supportEntitlementId)+3 + strlen("{ supportEntitlementId }");
    if(supportEntitlementId == NULL) {
        goto end;
    }
    char* localVarToReplace_supportEntitlementId = malloc(sizeOfPathParams_supportEntitlementId);
    sprintf(localVarToReplace_supportEntitlementId, "{%s}", "supportEntitlementId");

    localVarPath = strReplace(localVarPath, localVarToReplace_supportEntitlementId, supportEntitlementId);
    if(supportEntitlementId == NULL) {
        goto end;
    }
    char* localVarToReplace_supportEntitlementId = malloc(sizeOfPathParams_supportEntitlementId);
    ...
    free(localVarPath);
    free(localVarToReplace_supportEntitlementId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
SupportEntitlementsAPI_getSupportEntitlementAsync(apiClient_t *apiClient, char *tenantId, char *supportEntitlementId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SupportEntitlementsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    support_entitlement_dto_envelope_t *elementToReturn = support_entitlement_dto_envelope_parseFromJSON(SupportEntitlementsAPIlocalVarJSON);
    cJSON_Delete(SupportEntitlementsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SupportEntitlementsAPI_getSupportEntitlementsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, support_entitlement_dto_collection_query_parameters_t *support_entitlement_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_support_entitlement_dto_collection_query_parameters = NULL;
    if (support_entitlement_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_support_entitlement_dto_collection_query_parameters = support_entitlement_dto_collection_query_parameters_convertToJSON(support_entitlement_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_support_entitlement_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *SupportEntitlementsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    support_entitlement_dto_list_envelope_t *elementToReturn = support_entitlement_dto_list_envelope_parseFromJSON(SupportEntitlementsAPIlocalVarJSON);
    cJSON_Delete(SupportEntitlementsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_support_entitlement_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_support_entitlement_dto_collection_query_parameters);
        localVarSingleItemJSON_support_entitlement_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SupportEntitlementsAPI_getSupportEntitlementsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, support_entitlement_dto_collection_query_parameters_t *support_entitlement_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportEntitlements/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportEntitlements/Count");
    ...
    //nonprimitive not container
    cJSON *SupportEntitlementsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SupportEntitlementsAPIlocalVarJSON);
    cJSON_Delete(SupportEntitlementsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SupportEntitlementsAPI_updateSupportEntitlementAsync(apiClient_t *apiClient, char *tenantId, char *supportEntitlementId, char *api_version, char *x_api_version, support_entitlement_update_dto_t *support_entitlement_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_support_entitlement_update_dto = NULL;
    if (support_entitlement_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_support_entitlement_update_dto = support_entitlement_update_dto_convertToJSON(support_entitlement_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_support_entitlement_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_support_entitlement_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_support_entitlement_update_dto);
        localVarSingleItemJSON_support_entitlement_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
