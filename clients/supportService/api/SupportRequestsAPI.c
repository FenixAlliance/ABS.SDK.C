...
SupportRequestsAPI_createSupportRequestAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, support_request_create_dto_t *support_request_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportRequests")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportRequests");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_support_request_create_dto = NULL;
    if (support_request_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_support_request_create_dto = support_request_create_dto_convertToJSON(support_request_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_support_request_create_dto);
    }
    ...
    cJSON *SupportRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SupportRequestsAPIlocalVarJSON);
    cJSON_Delete(SupportRequestsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_support_request_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_support_request_create_dto);
        localVarSingleItemJSON_support_request_create_dto = NULL;
    }
...
SupportRequestsAPI_deleteSupportRequestAsync(apiClient_t *apiClient, char *tenantId, char *supportRequestId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportRequests/{supportRequestId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportRequests/{supportRequestId}");


    // Path Params
    long sizeOfPathParams_supportRequestId = strlen(supportRequestId)+3 + strlen("{ supportRequestId }");
    if(supportRequestId == NULL) {
        goto end;
    }
    char* localVarToReplace_supportRequestId = malloc(sizeOfPathParams_supportRequestId);
    sprintf(localVarToReplace_supportRequestId, "{%s}", "supportRequestId");

    localVarPath = strReplace(localVarPath, localVarToReplace_supportRequestId, supportRequestId);
    if(supportRequestId == NULL) {
        goto end;
    }
    char* localVarToReplace_supportRequestId = malloc(sizeOfPathParams_supportRequestId);
    ...
    free(localVarPath);
    free(localVarToReplace_supportRequestId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
SupportRequestsAPI_getSupportRequestAsync(apiClient_t *apiClient, char *tenantId, char *supportRequestId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SupportRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    support_request_dto_envelope_t *elementToReturn = support_request_dto_envelope_parseFromJSON(SupportRequestsAPIlocalVarJSON);
    cJSON_Delete(SupportRequestsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SupportRequestsAPI_getSupportRequestAttachmentByRequest(apiClient_t *apiClient, char *tenantId, char *supportRequestId, char *attachmentId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportRequests/{supportRequestId}/Attachments/{attachmentId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportRequests/{supportRequestId}/Attachments/{attachmentId}");


    // Path Params
    long sizeOfPathParams_supportRequestId = strlen(supportRequestId)+3 + strlen(attachmentId)+3 + strlen("{ supportRequestId }");
    if(supportRequestId == NULL) {
        goto end;
    }
    char* localVarToReplace_supportRequestId = malloc(sizeOfPathParams_supportRequestId);
    ...
    // Path Params
    long sizeOfPathParams_attachmentId = strlen(supportRequestId)+3 + strlen(attachmentId)+3 + strlen("{ attachmentId }");
    ...
    //nonprimitive not container
    cJSON *SupportRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    support_request_attachment_dto_envelope_t *elementToReturn = support_request_attachment_dto_envelope_parseFromJSON(SupportRequestsAPIlocalVarJSON);
    cJSON_Delete(SupportRequestsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SupportRequestsAPI_getSupportRequestAttachmentsByRequest(apiClient_t *apiClient, char *tenantId, char *supportRequestId, char *api_version, char *x_api_version, support_request_attachment_dto_collection_query_parameters_t *support_request_attachment_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportRequests/{supportRequestId}/Attachments")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportRequests/{supportRequestId}/Attachments");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_support_request_attachment_dto_collection_query_parameters = NULL;
    if (support_request_attachment_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_support_request_attachment_dto_collection_query_parameters = support_request_attachment_dto_collection_query_parameters_convertToJSON(support_request_attachment_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_support_request_attachment_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *SupportRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    support_request_attachment_dto_list_envelope_t *elementToReturn = support_request_attachment_dto_list_envelope_parseFromJSON(SupportRequestsAPIlocalVarJSON);
    cJSON_Delete(SupportRequestsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_support_request_attachment_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_support_request_attachment_dto_collection_query_parameters);
        localVarSingleItemJSON_support_request_attachment_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SupportRequestsAPI_getSupportRequestAttachmentsCountByRequest(apiClient_t *apiClient, char *tenantId, char *supportRequestId, char *api_version, char *x_api_version, support_request_attachment_dto_collection_query_parameters_t *support_request_attachment_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportRequests/{supportRequestId}/Attachments/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportRequests/{supportRequestId}/Attachments/Count");
    ...
    //nonprimitive not container
    cJSON *SupportRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SupportRequestsAPIlocalVarJSON);
    cJSON_Delete(SupportRequestsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SupportRequestsAPI_getSupportRequestTicketsAsync(apiClient_t *apiClient, char *tenantId, char *supportRequestId, char *api_version, char *x_api_version, support_ticket_dto_collection_query_parameters_t *support_ticket_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportRequests/{supportRequestId}/Tickets")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportRequests/{supportRequestId}/Tickets");
    ...
    //nonprimitive not container
    cJSON *SupportRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    support_ticket_dto_list_envelope_t *elementToReturn = support_ticket_dto_list_envelope_parseFromJSON(SupportRequestsAPIlocalVarJSON);
    cJSON_Delete(SupportRequestsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SupportRequestsAPI_getSupportRequestsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, support_request_dto_collection_query_parameters_t *support_request_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_support_request_dto_collection_query_parameters = NULL;
    if (support_request_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_support_request_dto_collection_query_parameters = support_request_dto_collection_query_parameters_convertToJSON(support_request_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_support_request_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *SupportRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    support_request_dto_list_envelope_t *elementToReturn = support_request_dto_list_envelope_parseFromJSON(SupportRequestsAPIlocalVarJSON);
    cJSON_Delete(SupportRequestsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_support_request_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_support_request_dto_collection_query_parameters);
        localVarSingleItemJSON_support_request_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SupportRequestsAPI_getSupportRequestsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, support_request_dto_collection_query_parameters_t *support_request_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportRequests/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportRequests/Count");
...
SupportRequestsAPI_relateSupportRequestToAttachmentAsync(apiClient_t *apiClient, char *tenantId, char *supportRequestId, char *api_version, char *x_api_version, support_request_attachment_create_dto_t *support_request_attachment_create_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_support_request_attachment_create_dto = NULL;
    if (support_request_attachment_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_support_request_attachment_create_dto = support_request_attachment_create_dto_convertToJSON(support_request_attachment_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_support_request_attachment_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_support_request_attachment_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_support_request_attachment_create_dto);
        localVarSingleItemJSON_support_request_attachment_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SupportRequestsAPI_updateSupportRequestAsync(apiClient_t *apiClient, char *tenantId, char *supportRequestId, char *api_version, char *x_api_version, support_request_update_dto_t *support_request_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_support_request_update_dto = NULL;
    if (support_request_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_support_request_update_dto = support_request_update_dto_convertToJSON(support_request_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_support_request_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_support_request_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_support_request_update_dto);
        localVarSingleItemJSON_support_request_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
