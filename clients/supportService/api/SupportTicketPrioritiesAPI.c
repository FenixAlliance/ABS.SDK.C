...
#include <stdio.h>
#include <ctype.h>
#include "SupportTicketPrioritiesAPI.h"
...
SupportTicketPrioritiesAPI_createSupportTicketPriorityAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, support_ticket_priority_create_dto_t *support_ticket_priority_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportTicketPriorities")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportTicketPriorities");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_support_ticket_priority_create_dto = NULL;
    if (support_ticket_priority_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_support_ticket_priority_create_dto = support_ticket_priority_create_dto_convertToJSON(support_ticket_priority_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_support_ticket_priority_create_dto);
    }
    ...
    cJSON *SupportTicketPrioritiesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SupportTicketPrioritiesAPIlocalVarJSON);
    cJSON_Delete(SupportTicketPrioritiesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_support_ticket_priority_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_support_ticket_priority_create_dto);
        localVarSingleItemJSON_support_ticket_priority_create_dto = NULL;
    }
...
SupportTicketPrioritiesAPI_deleteSupportTicketPriorityAsync(apiClient_t *apiClient, char *tenantId, char *supportTicketPriorityId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportTicketPriorities/{supportTicketPriorityId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportTicketPriorities/{supportTicketPriorityId}");


    // Path Params
    long sizeOfPathParams_supportTicketPriorityId = strlen(supportTicketPriorityId)+3 + strlen("{ supportTicketPriorityId }");
    if(supportTicketPriorityId == NULL) {
        goto end;
    }
    char* localVarToReplace_supportTicketPriorityId = malloc(sizeOfPathParams_supportTicketPriorityId);
    sprintf(localVarToReplace_supportTicketPriorityId, "{%s}", "supportTicketPriorityId");

    localVarPath = strReplace(localVarPath, localVarToReplace_supportTicketPriorityId, supportTicketPriorityId);
    if(supportTicketPriorityId == NULL) {
        goto end;
    }
    char* localVarToReplace_supportTicketPriorityId = malloc(sizeOfPathParams_supportTicketPriorityId);
    ...
    free(localVarPath);
    free(localVarToReplace_supportTicketPriorityId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
SupportTicketPrioritiesAPI_getSupportTicketPrioritiesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, support_ticket_priority_dto_collection_query_parameters_t *support_ticket_priority_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_support_ticket_priority_dto_collection_query_parameters = NULL;
    if (support_ticket_priority_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_support_ticket_priority_dto_collection_query_parameters = support_ticket_priority_dto_collection_query_parameters_convertToJSON(support_ticket_priority_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_support_ticket_priority_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *SupportTicketPrioritiesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    support_ticket_priority_dto_list_envelope_t *elementToReturn = support_ticket_priority_dto_list_envelope_parseFromJSON(SupportTicketPrioritiesAPIlocalVarJSON);
    cJSON_Delete(SupportTicketPrioritiesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_support_ticket_priority_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_support_ticket_priority_dto_collection_query_parameters);
        localVarSingleItemJSON_support_ticket_priority_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SupportTicketPrioritiesAPI_getSupportTicketPrioritiesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, support_ticket_priority_dto_collection_query_parameters_t *support_ticket_priority_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportTicketPriorities/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportTicketPriorities/Count");
    ...
    //nonprimitive not container
    cJSON *SupportTicketPrioritiesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SupportTicketPrioritiesAPIlocalVarJSON);
    cJSON_Delete(SupportTicketPrioritiesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SupportTicketPrioritiesAPI_getSupportTicketPriorityAsync(apiClient_t *apiClient, char *tenantId, char *supportTicketPriorityId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SupportTicketPrioritiesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    support_ticket_priority_dto_envelope_t *elementToReturn = support_ticket_priority_dto_envelope_parseFromJSON(SupportTicketPrioritiesAPIlocalVarJSON);
    cJSON_Delete(SupportTicketPrioritiesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SupportTicketPrioritiesAPI_updateSupportTicketPriorityAsync(apiClient_t *apiClient, char *tenantId, char *supportTicketPriorityId, char *api_version, char *x_api_version, support_ticket_priority_update_dto_t *support_ticket_priority_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_support_ticket_priority_update_dto = NULL;
    if (support_ticket_priority_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_support_ticket_priority_update_dto = support_ticket_priority_update_dto_convertToJSON(support_ticket_priority_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_support_ticket_priority_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_support_ticket_priority_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_support_ticket_priority_update_dto);
        localVarSingleItemJSON_support_ticket_priority_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
