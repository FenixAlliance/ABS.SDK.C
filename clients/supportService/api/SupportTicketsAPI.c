...
SupportTicketsAPI_createSupportTicketAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, support_ticket_create_dto_t *support_ticket_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportTickets")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportTickets");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_support_ticket_create_dto = NULL;
    if (support_ticket_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_support_ticket_create_dto = support_ticket_create_dto_convertToJSON(support_ticket_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_support_ticket_create_dto);
    }
    ...
    cJSON *SupportTicketsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SupportTicketsAPIlocalVarJSON);
    cJSON_Delete(SupportTicketsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_support_ticket_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_support_ticket_create_dto);
        localVarSingleItemJSON_support_ticket_create_dto = NULL;
    }
...
SupportTicketsAPI_deleteSupportTicketAsync(apiClient_t *apiClient, char *tenantId, char *supportTicketId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportTickets/{supportTicketId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportTickets/{supportTicketId}");


    // Path Params
    long sizeOfPathParams_supportTicketId = strlen(supportTicketId)+3 + strlen("{ supportTicketId }");
    if(supportTicketId == NULL) {
        goto end;
    }
    char* localVarToReplace_supportTicketId = malloc(sizeOfPathParams_supportTicketId);
    sprintf(localVarToReplace_supportTicketId, "{%s}", "supportTicketId");

    localVarPath = strReplace(localVarPath, localVarToReplace_supportTicketId, supportTicketId);
    if(supportTicketId == NULL) {
        goto end;
    }
    char* localVarToReplace_supportTicketId = malloc(sizeOfPathParams_supportTicketId);
...
SupportTicketsAPI_deleteSupportTicketConversationAsync(apiClient_t *apiClient, char *tenantId, char *supportTicketId, char *supportTicketConversationId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportTickets/{supportTicketId}/Conversations/{supportTicketConversationId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportTickets/{supportTicketId}/Conversations/{supportTicketConversationId}");


    // Path Params
    long sizeOfPathParams_supportTicketId = strlen(supportTicketId)+3 + strlen(supportTicketConversationId)+3 + strlen("{ supportTicketId }");
    if(supportTicketId == NULL) {
        goto end;
    }
    char* localVarToReplace_supportTicketId = malloc(sizeOfPathParams_supportTicketId);
    ...
    // Path Params
    long sizeOfPathParams_supportTicketConversationId = strlen(supportTicketId)+3 + strlen(supportTicketConversationId)+3 + strlen("{ supportTicketConversationId }");
    if(supportTicketConversationId == NULL) {
        goto end;
    }
    char* localVarToReplace_supportTicketConversationId = malloc(sizeOfPathParams_supportTicketConversationId);
    sprintf(localVarToReplace_supportTicketConversationId, "{%s}", "supportTicketConversationId");

    localVarPath = strReplace(localVarPath, localVarToReplace_supportTicketConversationId, supportTicketConversationId);
    if(supportTicketConversationId == NULL) {
        goto end;
    }
    char* localVarToReplace_supportTicketConversationId = malloc(sizeOfPathParams_supportTicketConversationId);
    ...
    free(localVarPath);
    free(localVarToReplace_supportTicketId);
    free(localVarToReplace_supportTicketConversationId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
SupportTicketsAPI_getSupportTicketAsync(apiClient_t *apiClient, char *tenantId, char *supportTicketId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SupportTicketsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    support_ticket_dto_envelope_t *elementToReturn = support_ticket_dto_envelope_parseFromJSON(SupportTicketsAPIlocalVarJSON);
    cJSON_Delete(SupportTicketsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SupportTicketsAPI_getSupportTicketConversationAsync(apiClient_t *apiClient, char *tenantId, char *supportTicketId, char *supportTicketConversationId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SupportTicketsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    support_ticket_conversation_dto_envelope_t *elementToReturn = support_ticket_conversation_dto_envelope_parseFromJSON(SupportTicketsAPIlocalVarJSON);
    cJSON_Delete(SupportTicketsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SupportTicketsAPI_getSupportTicketConversationMessagesAsync(apiClient_t *apiClient, char *tenantId, char *supportTicketId, char *supportTicketConversationId, int *pageNumber, int *pageSize, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportTickets/{supportTicketId}/Conversations/{supportTicketConversationId}/Messages")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportTickets/{supportTicketId}/Conversations/{supportTicketConversationId}/Messages");
    ...
    //nonprimitive not container
    cJSON *SupportTicketsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    private_message_dto_list_envelope_t *elementToReturn = private_message_dto_list_envelope_parseFromJSON(SupportTicketsAPIlocalVarJSON);
    cJSON_Delete(SupportTicketsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SupportTicketsAPI_getSupportTicketConversationsAsync(apiClient_t *apiClient, char *tenantId, char *supportTicketId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportTickets/{supportTicketId}/Conversations")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportTickets/{supportTicketId}/Conversations");
    ...
    //nonprimitive not container
    cJSON *SupportTicketsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    support_ticket_conversation_dto_list_envelope_t *elementToReturn = support_ticket_conversation_dto_list_envelope_parseFromJSON(SupportTicketsAPIlocalVarJSON);
    cJSON_Delete(SupportTicketsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SupportTicketsAPI_getSupportTicketsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SupportTicketsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    support_ticket_dto_list_envelope_t *elementToReturn = support_ticket_dto_list_envelope_parseFromJSON(SupportTicketsAPIlocalVarJSON);
    cJSON_Delete(SupportTicketsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SupportTicketsAPI_getSupportTicketsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/SupportTickets/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/SupportTickets/Count");
    ...
    //nonprimitive not container
    cJSON *SupportTicketsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SupportTicketsAPIlocalVarJSON);
    cJSON_Delete(SupportTicketsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SupportTicketsAPI_relateSupportTicketToConversationAsync(apiClient_t *apiClient, char *tenantId, char *supportTicketId, char *api_version, char *x_api_version, support_ticket_conversation_create_dto_t *support_ticket_conversation_create_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_support_ticket_conversation_create_dto = NULL;
    if (support_ticket_conversation_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_support_ticket_conversation_create_dto = support_ticket_conversation_create_dto_convertToJSON(support_ticket_conversation_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_support_ticket_conversation_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_support_ticket_conversation_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_support_ticket_conversation_create_dto);
        localVarSingleItemJSON_support_ticket_conversation_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SupportTicketsAPI_updateSupportTicketAsync(apiClient_t *apiClient, char *tenantId, char *supportTicketId, char *api_version, char *x_api_version, support_ticket_update_dto_t *support_ticket_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_support_ticket_update_dto = NULL;
    if (support_ticket_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_support_ticket_update_dto = support_ticket_update_dto_convertToJSON(support_ticket_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_support_ticket_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_support_ticket_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_support_ticket_update_dto);
        localVarSingleItemJSON_support_ticket_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
