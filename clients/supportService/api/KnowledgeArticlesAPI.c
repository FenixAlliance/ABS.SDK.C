...
#include <stdio.h>
#include <ctype.h>
#include "KnowledgeArticlesAPI.h"
...
KnowledgeArticlesAPI_createKnowledgeArticleAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, knowledge_article_create_dto_t *knowledge_article_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/KnowledgeArticles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/KnowledgeArticles");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_knowledge_article_create_dto = NULL;
    if (knowledge_article_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_knowledge_article_create_dto = knowledge_article_create_dto_convertToJSON(knowledge_article_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_knowledge_article_create_dto);
    }
    ...
    cJSON *KnowledgeArticlesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(KnowledgeArticlesAPIlocalVarJSON);
    cJSON_Delete(KnowledgeArticlesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_knowledge_article_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_knowledge_article_create_dto);
        localVarSingleItemJSON_knowledge_article_create_dto = NULL;
    }
...
KnowledgeArticlesAPI_deleteKnowledgeArticleAsync(apiClient_t *apiClient, char *tenantId, char *knowledgeArticleId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/KnowledgeArticles/{knowledgeArticleId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/KnowledgeArticles/{knowledgeArticleId}");


    // Path Params
    long sizeOfPathParams_knowledgeArticleId = strlen(knowledgeArticleId)+3 + strlen("{ knowledgeArticleId }");
    if(knowledgeArticleId == NULL) {
        goto end;
    }
    char* localVarToReplace_knowledgeArticleId = malloc(sizeOfPathParams_knowledgeArticleId);
    sprintf(localVarToReplace_knowledgeArticleId, "{%s}", "knowledgeArticleId");

    localVarPath = strReplace(localVarPath, localVarToReplace_knowledgeArticleId, knowledgeArticleId);
    if(knowledgeArticleId == NULL) {
        goto end;
    }
    char* localVarToReplace_knowledgeArticleId = malloc(sizeOfPathParams_knowledgeArticleId);
    ...
    free(localVarPath);
    free(localVarToReplace_knowledgeArticleId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
KnowledgeArticlesAPI_getKnowledgeArticleAsync(apiClient_t *apiClient, char *tenantId, char *knowledgeArticleId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *KnowledgeArticlesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    knowledge_article_dto_envelope_t *elementToReturn = knowledge_article_dto_envelope_parseFromJSON(KnowledgeArticlesAPIlocalVarJSON);
    cJSON_Delete(KnowledgeArticlesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
KnowledgeArticlesAPI_getKnowledgeArticlesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, knowledge_article_dto_collection_query_parameters_t *knowledge_article_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_knowledge_article_dto_collection_query_parameters = NULL;
    if (knowledge_article_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_knowledge_article_dto_collection_query_parameters = knowledge_article_dto_collection_query_parameters_convertToJSON(knowledge_article_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_knowledge_article_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *KnowledgeArticlesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    knowledge_article_dto_list_envelope_t *elementToReturn = knowledge_article_dto_list_envelope_parseFromJSON(KnowledgeArticlesAPIlocalVarJSON);
    cJSON_Delete(KnowledgeArticlesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_knowledge_article_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_knowledge_article_dto_collection_query_parameters);
        localVarSingleItemJSON_knowledge_article_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
KnowledgeArticlesAPI_getKnowledgeArticlesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, knowledge_article_dto_collection_query_parameters_t *knowledge_article_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/KnowledgeArticles/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/KnowledgeArticles/Count");
    ...
    //nonprimitive not container
    cJSON *KnowledgeArticlesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(KnowledgeArticlesAPIlocalVarJSON);
    cJSON_Delete(KnowledgeArticlesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
KnowledgeArticlesAPI_updateKnowledgeArticleAsync(apiClient_t *apiClient, char *tenantId, char *knowledgeArticleId, char *api_version, char *x_api_version, knowledge_article_update_dto_t *knowledge_article_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_knowledge_article_update_dto = NULL;
    if (knowledge_article_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_knowledge_article_update_dto = knowledge_article_update_dto_convertToJSON(knowledge_article_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_knowledge_article_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_knowledge_article_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_knowledge_article_update_dto);
        localVarSingleItemJSON_knowledge_article_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
