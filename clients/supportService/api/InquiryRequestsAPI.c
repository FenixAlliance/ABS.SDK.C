...
InquiryRequestsAPI_createInquiryRequestAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, inquiry_request_create_dto_t *inquiry_request_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/InquiryRequests")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/InquiryRequests");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_inquiry_request_create_dto = NULL;
    if (inquiry_request_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_inquiry_request_create_dto = inquiry_request_create_dto_convertToJSON(inquiry_request_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_inquiry_request_create_dto);
    }
    ...
    cJSON *InquiryRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(InquiryRequestsAPIlocalVarJSON);
    cJSON_Delete(InquiryRequestsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_inquiry_request_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_inquiry_request_create_dto);
        localVarSingleItemJSON_inquiry_request_create_dto = NULL;
    }
...
InquiryRequestsAPI_deleteInquiryRequestAsync(apiClient_t *apiClient, char *tenantId, char *inquiryRequestId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/InquiryRequests/{inquiryRequestId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/InquiryRequests/{inquiryRequestId}");


    // Path Params
    long sizeOfPathParams_inquiryRequestId = strlen(inquiryRequestId)+3 + strlen("{ inquiryRequestId }");
    if(inquiryRequestId == NULL) {
        goto end;
    }
    char* localVarToReplace_inquiryRequestId = malloc(sizeOfPathParams_inquiryRequestId);
    sprintf(localVarToReplace_inquiryRequestId, "{%s}", "inquiryRequestId");

    localVarPath = strReplace(localVarPath, localVarToReplace_inquiryRequestId, inquiryRequestId);
    if(inquiryRequestId == NULL) {
        goto end;
    }
    char* localVarToReplace_inquiryRequestId = malloc(sizeOfPathParams_inquiryRequestId);
    ...
    free(localVarPath);
    free(localVarToReplace_inquiryRequestId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
InquiryRequestsAPI_getInquiryRequestAsync(apiClient_t *apiClient, char *tenantId, char *inquiryRequestId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *InquiryRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    inquiry_request_dto_envelope_t *elementToReturn = inquiry_request_dto_envelope_parseFromJSON(InquiryRequestsAPIlocalVarJSON);
    cJSON_Delete(InquiryRequestsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
InquiryRequestsAPI_getInquiryRequestsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, inquiry_request_dto_collection_query_parameters_t *inquiry_request_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_inquiry_request_dto_collection_query_parameters = NULL;
    if (inquiry_request_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_inquiry_request_dto_collection_query_parameters = inquiry_request_dto_collection_query_parameters_convertToJSON(inquiry_request_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_inquiry_request_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *InquiryRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    inquiry_request_dto_list_envelope_t *elementToReturn = inquiry_request_dto_list_envelope_parseFromJSON(InquiryRequestsAPIlocalVarJSON);
    cJSON_Delete(InquiryRequestsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_inquiry_request_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_inquiry_request_dto_collection_query_parameters);
        localVarSingleItemJSON_inquiry_request_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
InquiryRequestsAPI_getInquiryRequestsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, inquiry_request_dto_collection_query_parameters_t *inquiry_request_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/InquiryRequests/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/InquiryRequests/Count");
    ...
    //nonprimitive not container
    cJSON *InquiryRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(InquiryRequestsAPIlocalVarJSON);
    cJSON_Delete(InquiryRequestsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
InquiryRequestsAPI_updateInquiryRequestAsync(apiClient_t *apiClient, char *tenantId, char *inquiryRequestId, char *api_version, char *x_api_version, inquiry_request_update_dto_t *inquiry_request_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_inquiry_request_update_dto = NULL;
    if (inquiry_request_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_inquiry_request_update_dto = inquiry_request_update_dto_convertToJSON(inquiry_request_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_inquiry_request_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_inquiry_request_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_inquiry_request_update_dto);
        localVarSingleItemJSON_inquiry_request_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
