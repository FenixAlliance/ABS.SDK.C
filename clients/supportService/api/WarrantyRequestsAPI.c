...
WarrantyRequestsAPI_createWarrantyRequestAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, warranty_request_create_dto_t *warranty_request_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/WarrantyRequests")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/WarrantyRequests");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_warranty_request_create_dto = NULL;
    if (warranty_request_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_warranty_request_create_dto = warranty_request_create_dto_convertToJSON(warranty_request_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_warranty_request_create_dto);
    }
    ...
    cJSON *WarrantyRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(WarrantyRequestsAPIlocalVarJSON);
    cJSON_Delete(WarrantyRequestsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_warranty_request_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_warranty_request_create_dto);
        localVarSingleItemJSON_warranty_request_create_dto = NULL;
    }
...
WarrantyRequestsAPI_deleteWarrantyRequestAsync(apiClient_t *apiClient, char *tenantId, char *warrantyRequestId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/WarrantyRequests/{warrantyRequestId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/WarrantyRequests/{warrantyRequestId}");


    // Path Params
    long sizeOfPathParams_warrantyRequestId = strlen(warrantyRequestId)+3 + strlen("{ warrantyRequestId }");
    if(warrantyRequestId == NULL) {
        goto end;
    }
    char* localVarToReplace_warrantyRequestId = malloc(sizeOfPathParams_warrantyRequestId);
    sprintf(localVarToReplace_warrantyRequestId, "{%s}", "warrantyRequestId");

    localVarPath = strReplace(localVarPath, localVarToReplace_warrantyRequestId, warrantyRequestId);
    if(warrantyRequestId == NULL) {
        goto end;
    }
    char* localVarToReplace_warrantyRequestId = malloc(sizeOfPathParams_warrantyRequestId);
    ...
    free(localVarPath);
    free(localVarToReplace_warrantyRequestId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
WarrantyRequestsAPI_getWarrantyRequestAsync(apiClient_t *apiClient, char *tenantId, char *warrantyRequestId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *WarrantyRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    warranty_request_dto_envelope_t *elementToReturn = warranty_request_dto_envelope_parseFromJSON(WarrantyRequestsAPIlocalVarJSON);
    cJSON_Delete(WarrantyRequestsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
WarrantyRequestsAPI_getWarrantyRequestsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, warranty_request_dto_collection_query_parameters_t *warranty_request_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_warranty_request_dto_collection_query_parameters = NULL;
    if (warranty_request_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_warranty_request_dto_collection_query_parameters = warranty_request_dto_collection_query_parameters_convertToJSON(warranty_request_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_warranty_request_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *WarrantyRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    warranty_request_dto_list_envelope_t *elementToReturn = warranty_request_dto_list_envelope_parseFromJSON(WarrantyRequestsAPIlocalVarJSON);
    cJSON_Delete(WarrantyRequestsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_warranty_request_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_warranty_request_dto_collection_query_parameters);
        localVarSingleItemJSON_warranty_request_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
WarrantyRequestsAPI_getWarrantyRequestsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, warranty_request_dto_collection_query_parameters_t *warranty_request_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/WarrantyRequests/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/WarrantyRequests/Count");
    ...
    //nonprimitive not container
    cJSON *WarrantyRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(WarrantyRequestsAPIlocalVarJSON);
    cJSON_Delete(WarrantyRequestsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
WarrantyRequestsAPI_updateWarrantyRequestAsync(apiClient_t *apiClient, char *tenantId, char *warrantyRequestId, char *api_version, char *x_api_version, warranty_request_update_dto_t *warranty_request_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_warranty_request_update_dto = NULL;
    if (warranty_request_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_warranty_request_update_dto = warranty_request_update_dto_convertToJSON(warranty_request_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_warranty_request_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_warranty_request_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_warranty_request_update_dto);
        localVarSingleItemJSON_warranty_request_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
