...
ReturnRequestsAPI_createReturnRequestAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, return_request_create_dto_t *return_request_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/ReturnRequests")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/ReturnRequests");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_return_request_create_dto = NULL;
    if (return_request_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_return_request_create_dto = return_request_create_dto_convertToJSON(return_request_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_return_request_create_dto);
    }
    ...
    cJSON *ReturnRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ReturnRequestsAPIlocalVarJSON);
    cJSON_Delete(ReturnRequestsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_return_request_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_return_request_create_dto);
        localVarSingleItemJSON_return_request_create_dto = NULL;
    }
...
ReturnRequestsAPI_deleteReturnRequestAsync(apiClient_t *apiClient, char *tenantId, char *returnRequestId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/ReturnRequests/{returnRequestId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/ReturnRequests/{returnRequestId}");


    // Path Params
    long sizeOfPathParams_returnRequestId = strlen(returnRequestId)+3 + strlen("{ returnRequestId }");
    if(returnRequestId == NULL) {
        goto end;
    }
    char* localVarToReplace_returnRequestId = malloc(sizeOfPathParams_returnRequestId);
    sprintf(localVarToReplace_returnRequestId, "{%s}", "returnRequestId");

    localVarPath = strReplace(localVarPath, localVarToReplace_returnRequestId, returnRequestId);
    if(returnRequestId == NULL) {
        goto end;
    }
    char* localVarToReplace_returnRequestId = malloc(sizeOfPathParams_returnRequestId);
    ...
    free(localVarPath);
    free(localVarToReplace_returnRequestId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
ReturnRequestsAPI_getReturnRequestAsync(apiClient_t *apiClient, char *tenantId, char *returnRequestId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ReturnRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    return_request_dto_envelope_t *elementToReturn = return_request_dto_envelope_parseFromJSON(ReturnRequestsAPIlocalVarJSON);
    cJSON_Delete(ReturnRequestsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ReturnRequestsAPI_getReturnRequestsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, return_request_dto_collection_query_parameters_t *return_request_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_return_request_dto_collection_query_parameters = NULL;
    if (return_request_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_return_request_dto_collection_query_parameters = return_request_dto_collection_query_parameters_convertToJSON(return_request_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_return_request_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ReturnRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    return_request_dto_list_envelope_t *elementToReturn = return_request_dto_list_envelope_parseFromJSON(ReturnRequestsAPIlocalVarJSON);
    cJSON_Delete(ReturnRequestsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_return_request_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_return_request_dto_collection_query_parameters);
        localVarSingleItemJSON_return_request_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ReturnRequestsAPI_getReturnRequestsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, return_request_dto_collection_query_parameters_t *return_request_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/ReturnRequests/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/ReturnRequests/Count");
    ...
    //nonprimitive not container
    cJSON *ReturnRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ReturnRequestsAPIlocalVarJSON);
    cJSON_Delete(ReturnRequestsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ReturnRequestsAPI_updateReturnRequestAsync(apiClient_t *apiClient, char *tenantId, char *returnRequestId, char *api_version, char *x_api_version, return_request_update_dto_t *return_request_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_return_request_update_dto = NULL;
    if (return_request_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_return_request_update_dto = return_request_update_dto_convertToJSON(return_request_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_return_request_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_return_request_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_return_request_update_dto);
        localVarSingleItemJSON_return_request_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
