...
RefundRequestsAPI_createRefundRequestAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, refund_request_create_dto_t *refund_request_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/RefundRequests")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/RefundRequests");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_refund_request_create_dto = NULL;
    if (refund_request_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_refund_request_create_dto = refund_request_create_dto_convertToJSON(refund_request_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_refund_request_create_dto);
    }
    ...
    cJSON *RefundRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(RefundRequestsAPIlocalVarJSON);
    cJSON_Delete(RefundRequestsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_refund_request_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_refund_request_create_dto);
        localVarSingleItemJSON_refund_request_create_dto = NULL;
    }
...
RefundRequestsAPI_deleteRefundRequestAsync(apiClient_t *apiClient, char *tenantId, char *refundRequestId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/RefundRequests/{refundRequestId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/RefundRequests/{refundRequestId}");


    // Path Params
    long sizeOfPathParams_refundRequestId = strlen(refundRequestId)+3 + strlen("{ refundRequestId }");
    if(refundRequestId == NULL) {
        goto end;
    }
    char* localVarToReplace_refundRequestId = malloc(sizeOfPathParams_refundRequestId);
    sprintf(localVarToReplace_refundRequestId, "{%s}", "refundRequestId");

    localVarPath = strReplace(localVarPath, localVarToReplace_refundRequestId, refundRequestId);
    if(refundRequestId == NULL) {
        goto end;
    }
    char* localVarToReplace_refundRequestId = malloc(sizeOfPathParams_refundRequestId);
    ...
    free(localVarPath);
    free(localVarToReplace_refundRequestId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
RefundRequestsAPI_getRefundRequestAsync(apiClient_t *apiClient, char *tenantId, char *refundRequestId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *RefundRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    refund_request_dto_envelope_t *elementToReturn = refund_request_dto_envelope_parseFromJSON(RefundRequestsAPIlocalVarJSON);
    cJSON_Delete(RefundRequestsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RefundRequestsAPI_getRefundRequestsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, refund_request_dto_collection_query_parameters_t *refund_request_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_refund_request_dto_collection_query_parameters = NULL;
    if (refund_request_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_refund_request_dto_collection_query_parameters = refund_request_dto_collection_query_parameters_convertToJSON(refund_request_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_refund_request_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *RefundRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    refund_request_dto_list_envelope_t *elementToReturn = refund_request_dto_list_envelope_parseFromJSON(RefundRequestsAPIlocalVarJSON);
    cJSON_Delete(RefundRequestsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_refund_request_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_refund_request_dto_collection_query_parameters);
        localVarSingleItemJSON_refund_request_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
RefundRequestsAPI_getRefundRequestsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, refund_request_dto_collection_query_parameters_t *refund_request_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SupportService/RefundRequests/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SupportService/RefundRequests/Count");
    ...
    //nonprimitive not container
    cJSON *RefundRequestsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(RefundRequestsAPIlocalVarJSON);
    cJSON_Delete(RefundRequestsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RefundRequestsAPI_updateRefundRequestAsync(apiClient_t *apiClient, char *tenantId, char *refundRequestId, char *api_version, char *x_api_version, refund_request_update_dto_t *refund_request_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_refund_request_update_dto = NULL;
    if (refund_request_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_refund_request_update_dto = refund_request_update_dto_convertToJSON(refund_request_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_refund_request_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_refund_request_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_refund_request_update_dto);
        localVarSingleItemJSON_refund_request_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
