...
//
item_warranty_policy_dto_list_envelope_t* WarrantyPoliciesAPI_getWarrantyPoliciesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_warranty_policy_dto_collection_query_parameters_t *item_warranty_policy_dto_collection_query_parameters);
```
...
//
int32_envelope_t* WarrantyPoliciesAPI_getWarrantyPoliciesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_warranty_policy_dto_collection_query_parameters_t *item_warranty_policy_dto_collection_query_parameters);
```
...
//
empty_envelope_t* WarrantyPoliciesAPI_patchWarrantyPolicyAsync(apiClient_t *apiClient, char *tenantId, char *warrantyPolicyId, char *api_version, char *x_api_version, list_t *patch_operation);
```
