...
//
knowledge_article_dto_list_envelope_t* KnowledgeArticlesAPI_getKnowledgeArticlesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
//
int32_envelope_t* KnowledgeArticlesAPI_getKnowledgeArticlesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
