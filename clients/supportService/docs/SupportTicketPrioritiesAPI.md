...
//
empty_envelope_t* SupportTicketPrioritiesAPI_patchSupportTicketPriorityAsync(apiClient_t *apiClient, char *tenantId, char *supportTicketPriorityId, char *api_version, char *x_api_version, list_t *operation);
```
