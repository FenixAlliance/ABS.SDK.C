...
//
empty_envelope_t* ReturnRequestsAPI_patchReturnRequestAsync(apiClient_t *apiClient, char *tenantId, char *returnRequestId, char *api_version, char *x_api_version, list_t *operation);
```
