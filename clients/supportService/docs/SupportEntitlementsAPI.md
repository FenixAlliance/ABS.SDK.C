...
//
support_entitlement_dto_list_envelope_t* SupportEntitlementsAPI_getSupportEntitlementsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, support_entitlement_dto_collection_query_parameters_t *support_entitlement_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**support_entitlement_dto_collection_query_parameters** | **[support_entitlement_dto_collection_query_parameters_t](support_entitlement_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* SupportEntitlementsAPI_getSupportEntitlementsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, support_entitlement_dto_collection_query_parameters_t *support_entitlement_dto_collection_query_parameters);
```
...
//
empty_envelope_t* SupportEntitlementsAPI_patchSupportEntitlementAsync(apiClient_t *apiClient, char *tenantId, char *supportEntitlementId, char *api_version, char *x_api_version, list_t *patch_operation);
```
