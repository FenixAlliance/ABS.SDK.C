...
//
item_refund_policy_dto_list_envelope_t* RefundPoliciesAPI_getRefundPoliciesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
//
int32_envelope_t* RefundPoliciesAPI_getRefundPoliciesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
//
empty_envelope_t* RefundPoliciesAPI_patchRefundPolicyAsync(apiClient_t *apiClient, char *tenantId, char *refundPolicyId, char *api_version, char *x_api_version, list_t *operation);
```
