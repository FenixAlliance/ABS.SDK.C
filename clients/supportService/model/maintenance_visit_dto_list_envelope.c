...
maintenance_visit_dto_list_envelope_t *maintenance_visit_dto_list_envelope_create(
    ...
    maintenance_visit_dto_list_envelope_local_var->http_status = http_status;
    maintenance_visit_dto_list_envelope_local_var->error_code = error_code;
    maintenance_visit_dto_list_envelope_local_var->validation_details = validation_details;
...
void maintenance_visit_dto_list_envelope_free(maintenance_visit_dto_list_envelope_t *maintenance_visit_dto_list_envelope) {
    ...
    if (maintenance_visit_dto_list_envelope->error_code) {
        free(maintenance_visit_dto_list_envelope->error_code);
        maintenance_visit_dto_list_envelope->error_code = NULL;
    }
    if (maintenance_visit_dto_list_envelope->validation_details) {
        list_ForEach(listEntry, maintenance_visit_dto_list_envelope->validation_details) {
            keyValuePair_t *localKeyValue = (keyValuePair_t*) listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_freeList(maintenance_visit_dto_list_envelope->validation_details);
        maintenance_visit_dto_list_envelope->validation_details = NULL;
    }
...
cJSON *maintenance_visit_dto_list_envelope_convertToJSON(maintenance_visit_dto_list_envelope_t *maintenance_visit_dto_list_envelope) {
    ...
    // maintenance_visit_dto_list_envelope->http_status
    if(maintenance_visit_dto_list_envelope->http_status) {
    if(cJSON_AddNumberToObject(item, "httpStatus", maintenance_visit_dto_list_envelope->http_status) == NULL) {
    goto fail; //Numeric
    }
    }


    // maintenance_visit_dto_list_envelope->error_code
    if(maintenance_visit_dto_list_envelope->error_code) {
    if(cJSON_AddStringToObject(item, "errorCode", maintenance_visit_dto_list_envelope->error_code) == NULL) {
    goto fail; //String
    }
    }


    // maintenance_visit_dto_list_envelope->validation_details
    if(maintenance_visit_dto_list_envelope->validation_details) {
    ...
    if (maintenance_visit_dto_list_envelope->validation_details) {
    list_ForEach(validation_detailsListEntry, maintenance_visit_dto_list_envelope->validation_details) {
...
maintenance_visit_dto_list_envelope_t *maintenance_visit_dto_list_envelope_parseFromJSON(cJSON *maintenance_visit_dto_list_envelopeJSON){
    ...
    // define the local map for maintenance_visit_dto_list_envelope->validation_details
    ...
    // maintenance_visit_dto_list_envelope->http_status
    cJSON *http_status = cJSON_GetObjectItemCaseSensitive(maintenance_visit_dto_list_envelopeJSON, "httpStatus");
    if (http_status) { 
    ...
    // maintenance_visit_dto_list_envelope->error_code
    cJSON *error_code = cJSON_GetObjectItemCaseSensitive(maintenance_visit_dto_list_envelopeJSON, "errorCode");
    if (error_code) { 
    ...
    // maintenance_visit_dto_list_envelope->validation_details
    cJSON *validation_details = cJSON_GetObjectItemCaseSensitive(maintenance_visit_dto_list_envelopeJSON, "validationDetails");
