/*
 * inquiry_request_create_dto.h
 *
 * 
 */

#ifndef _inquiry_request_create_dto_H_
#define _inquiry_request_create_dto_H_
...
typedef struct inquiry_request_create_dto_t inquiry_request_create_dto_t;




typedef struct inquiry_request_create_dto_t {
    char *id; // string
...
#endif /* _inquiry_request_create_dto_H_ */
