...
#include <string.h>
#include <stdio.h>
#include "support_ticket_type_create_dto.h"
...
support_ticket_type_create_dto_t *support_ticket_type_create_dto_create(
    ...
    support_ticket_type_create_dto_local_var->id = id;
...
void support_ticket_type_create_dto_free(support_ticket_type_create_dto_t *support_ticket_type_create_dto) {
    if(NULL == support_ticket_type_create_dto){
        return ;
    }
    listEntry_t *listEntry;
    if (support_ticket_type_create_dto->id) {
        free(support_ticket_type_create_dto->id);
        support_ticket_type_create_dto->id = NULL;
    }
    if (support_ticket_type_create_dto->timestamp) {
        free(support_ticket_type_create_dto->timestamp);
        support_ticket_type_create_dto->timestamp = NULL;
    }
    if (support_ticket_type_create_dto->title) {
        free(support_ticket_type_create_dto->title);
        support_ticket_type_create_dto->title = NULL;
    }
...
cJSON *support_ticket_type_create_dto_convertToJSON(support_ticket_type_create_dto_t *support_ticket_type_create_dto) {
    ...
    // support_ticket_type_create_dto->id
    if(support_ticket_type_create_dto->id) {
    if(cJSON_AddStringToObject(item, "id", support_ticket_type_create_dto->id) == NULL) {
    goto fail; //String
    }
    }


    // support_ticket_type_create_dto->timestamp
    if(support_ticket_type_create_dto->timestamp) {
    if(cJSON_AddStringToObject(item, "timestamp", support_ticket_type_create_dto->timestamp) == NULL) {
    goto fail; //Date-Time
    }
    }


    // support_ticket_type_create_dto->title
    if(support_ticket_type_create_dto->title) {
    if(cJSON_AddStringToObject(item, "title", support_ticket_type_create_dto->title) == NULL) {
    goto fail; //String
    }
    }
...
support_ticket_type_create_dto_t *support_ticket_type_create_dto_parseFromJSON(cJSON *support_ticket_type_create_dtoJSON){
    ...
    support_ticket_type_create_dto_t *support_ticket_type_create_dto_local_var = NULL;

    // support_ticket_type_create_dto->id
    cJSON *id = cJSON_GetObjectItemCaseSensitive(support_ticket_type_create_dtoJSON, "id");
    if (id) { 
    ...
    // support_ticket_type_create_dto->timestamp
    cJSON *timestamp = cJSON_GetObjectItemCaseSensitive(support_ticket_type_create_dtoJSON, "timestamp");
    if (timestamp) { 
    ...
    // support_ticket_type_create_dto->title
    cJSON *title = cJSON_GetObjectItemCaseSensitive(support_ticket_type_create_dtoJSON, "title");
    if (title) { 
    ...
    // support_ticket_type_create_dto->description
    cJSON *description = cJSON_GetObjectItemCaseSensitive(support_ticket_type_create_dtoJSON, "description");
    if (description) { 
