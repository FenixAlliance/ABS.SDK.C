...
support_entitlement_update_dto_t *support_entitlement_update_dto_create(
    ...
    support_entitlement_update_dto_local_var->receiver_tenant_id = receiver_tenant_id;
...
void support_entitlement_update_dto_free(support_entitlement_update_dto_t *support_entitlement_update_dto) {
    ...
    if (support_entitlement_update_dto->receiver_tenant_id) {
        free(support_entitlement_update_dto->receiver_tenant_id);
        support_entitlement_update_dto->receiver_tenant_id = NULL;
    }
...
cJSON *support_entitlement_update_dto_convertToJSON(support_entitlement_update_dto_t *support_entitlement_update_dto) {
    ...
    // support_entitlement_update_dto->receiver_tenant_id
    if(support_entitlement_update_dto->receiver_tenant_id) {
    if(cJSON_AddStringToObject(item, "receiverTenantId", support_entitlement_update_dto->receiver_tenant_id) == NULL) {
    goto fail; //String
    }
    }
...
support_entitlement_update_dto_t *support_entitlement_update_dto_parseFromJSON(cJSON *support_entitlement_update_dtoJSON){
    ...
    // support_entitlement_update_dto->receiver_tenant_id
    cJSON *receiver_tenant_id = cJSON_GetObjectItemCaseSensitive(support_entitlement_update_dtoJSON, "receiverTenantId");
