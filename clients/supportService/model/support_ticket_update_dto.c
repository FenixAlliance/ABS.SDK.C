...
support_ticket_update_dto_t *support_ticket_update_dto_create(
    ...
    support_ticket_update_dto_local_var->account_holder_id = account_holder_id;
    support_ticket_update_dto_local_var->contact_id = contact_id;
    support_ticket_update_dto_local_var->business_profile_record_id = business_profile_record_id;
...
void support_ticket_update_dto_free(support_ticket_update_dto_t *support_ticket_update_dto) {
    ...
    if (support_ticket_update_dto->account_holder_id) {
        free(support_ticket_update_dto->account_holder_id);
        support_ticket_update_dto->account_holder_id = NULL;
    }
    ...
    if (support_ticket_update_dto->business_profile_record_id) {
        free(support_ticket_update_dto->business_profile_record_id);
        support_ticket_update_dto->business_profile_record_id = NULL;
    }
...
cJSON *support_ticket_update_dto_convertToJSON(support_ticket_update_dto_t *support_ticket_update_dto) {
    ...
    // support_ticket_update_dto->account_holder_id
    if(support_ticket_update_dto->account_holder_id) {
    if(cJSON_AddStringToObject(item, "accountHolderID", support_ticket_update_dto->account_holder_id) == NULL) {
    goto fail; //String
    }
    }
    ...
    // support_ticket_update_dto->business_profile_record_id
    if(support_ticket_update_dto->business_profile_record_id) {
    if(cJSON_AddStringToObject(item, "businessProfileRecordID", support_ticket_update_dto->business_profile_record_id) == NULL) {
    goto fail; //String
    }
    }
...
support_ticket_update_dto_t *support_ticket_update_dto_parseFromJSON(cJSON *support_ticket_update_dtoJSON){
    ...
    // support_ticket_update_dto->account_holder_id
    cJSON *account_holder_id = cJSON_GetObjectItemCaseSensitive(support_ticket_update_dtoJSON, "accountHolderID");
    ...
    // support_ticket_update_dto->business_profile_record_id
    cJSON *business_profile_record_id = cJSON_GetObjectItemCaseSensitive(support_ticket_update_dtoJSON, "businessProfileRecordID");
