/*
 * knowledge_article_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _knowledge_article_dto_collection_query_parameters_H_
#define _knowledge_article_dto_collection_query_parameters_H_
...
typedef struct knowledge_article_dto_collection_query_parameters_t knowledge_article_dto_collection_query_parameters_t;




typedef struct knowledge_article_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} knowledge_article_dto_collection_query_parameters_t;
...
#endif /* _knowledge_article_dto_collection_query_parameters_H_ */
