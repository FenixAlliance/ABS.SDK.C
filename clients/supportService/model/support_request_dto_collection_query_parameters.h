/*
 * support_request_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _support_request_dto_collection_query_parameters_H_
#define _support_request_dto_collection_query_parameters_H_
...
typedef struct support_request_dto_collection_query_parameters_t support_request_dto_collection_query_parameters_t;




typedef struct support_request_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} support_request_dto_collection_query_parameters_t;
...
#endif /* _support_request_dto_collection_query_parameters_H_ */
