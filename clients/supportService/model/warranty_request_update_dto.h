/*
 * warranty_request_update_dto.h
 *
 * 
 */

#ifndef _warranty_request_update_dto_H_
#define _warranty_request_update_dto_H_
...
typedef struct warranty_request_update_dto_t warranty_request_update_dto_t;




typedef struct warranty_request_update_dto_t {
    char *title; // string
...
#endif /* _warranty_request_update_dto_H_ */
