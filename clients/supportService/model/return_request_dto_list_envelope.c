...
return_request_dto_list_envelope_t *return_request_dto_list_envelope_create(
    ...
    return_request_dto_list_envelope_local_var->http_status = http_status;
    return_request_dto_list_envelope_local_var->error_code = error_code;
    return_request_dto_list_envelope_local_var->validation_details = validation_details;
...
void return_request_dto_list_envelope_free(return_request_dto_list_envelope_t *return_request_dto_list_envelope) {
    ...
    if (return_request_dto_list_envelope->error_code) {
        free(return_request_dto_list_envelope->error_code);
        return_request_dto_list_envelope->error_code = NULL;
    }
    if (return_request_dto_list_envelope->validation_details) {
        list_ForEach(listEntry, return_request_dto_list_envelope->validation_details) {
            keyValuePair_t *localKeyValue = (keyValuePair_t*) listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_freeList(return_request_dto_list_envelope->validation_details);
        return_request_dto_list_envelope->validation_details = NULL;
    }
...
cJSON *return_request_dto_list_envelope_convertToJSON(return_request_dto_list_envelope_t *return_request_dto_list_envelope) {
    ...
    // return_request_dto_list_envelope->http_status
    if(return_request_dto_list_envelope->http_status) {
    if(cJSON_AddNumberToObject(item, "httpStatus", return_request_dto_list_envelope->http_status) == NULL) {
    goto fail; //Numeric
    }
    }


    // return_request_dto_list_envelope->error_code
    if(return_request_dto_list_envelope->error_code) {
    if(cJSON_AddStringToObject(item, "errorCode", return_request_dto_list_envelope->error_code) == NULL) {
    goto fail; //String
    }
    }


    // return_request_dto_list_envelope->validation_details
    if(return_request_dto_list_envelope->validation_details) {
    ...
    if (return_request_dto_list_envelope->validation_details) {
    list_ForEach(validation_detailsListEntry, return_request_dto_list_envelope->validation_details) {
...
return_request_dto_list_envelope_t *return_request_dto_list_envelope_parseFromJSON(cJSON *return_request_dto_list_envelopeJSON){
    ...
    // define the local map for return_request_dto_list_envelope->validation_details
    ...
    // return_request_dto_list_envelope->http_status
    cJSON *http_status = cJSON_GetObjectItemCaseSensitive(return_request_dto_list_envelopeJSON, "httpStatus");
    if (http_status) { 
    ...
    // return_request_dto_list_envelope->error_code
    cJSON *error_code = cJSON_GetObjectItemCaseSensitive(return_request_dto_list_envelopeJSON, "errorCode");
    if (error_code) { 
    ...
    // return_request_dto_list_envelope->validation_details
    cJSON *validation_details = cJSON_GetObjectItemCaseSensitive(return_request_dto_list_envelopeJSON, "validationDetails");
