/*
 * support_request_attachment_dto_envelope.h
 *
 * 
 */

#ifndef _support_request_attachment_dto_envelope_H_
#define _support_request_attachment_dto_envelope_H_
...
typedef struct support_request_attachment_dto_envelope_t support_request_attachment_dto_envelope_t;

#include "support_request_attachment_dto.h"



typedef struct support_request_attachment_dto_envelope_t {
    int is_success; //boolean
    char *error_message; // string
    char *correlation_id; // string
    char *timestamp; //date time
    char *activity_id; // string
    struct support_request_attachment_dto_t *result; //model
...
#endif /* _support_request_attachment_dto_envelope_H_ */
