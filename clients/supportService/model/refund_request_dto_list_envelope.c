...
refund_request_dto_list_envelope_t *refund_request_dto_list_envelope_create(
    ...
    refund_request_dto_list_envelope_local_var->http_status = http_status;
    refund_request_dto_list_envelope_local_var->error_code = error_code;
    refund_request_dto_list_envelope_local_var->validation_details = validation_details;
...
void refund_request_dto_list_envelope_free(refund_request_dto_list_envelope_t *refund_request_dto_list_envelope) {
    ...
    if (refund_request_dto_list_envelope->error_code) {
        free(refund_request_dto_list_envelope->error_code);
        refund_request_dto_list_envelope->error_code = NULL;
    }
    if (refund_request_dto_list_envelope->validation_details) {
        list_ForEach(listEntry, refund_request_dto_list_envelope->validation_details) {
            keyValuePair_t *localKeyValue = (keyValuePair_t*) listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_freeList(refund_request_dto_list_envelope->validation_details);
        refund_request_dto_list_envelope->validation_details = NULL;
    }
...
cJSON *refund_request_dto_list_envelope_convertToJSON(refund_request_dto_list_envelope_t *refund_request_dto_list_envelope) {
    ...
    // refund_request_dto_list_envelope->http_status
    if(refund_request_dto_list_envelope->http_status) {
    if(cJSON_AddNumberToObject(item, "httpStatus", refund_request_dto_list_envelope->http_status) == NULL) {
    goto fail; //Numeric
    }
    }


    // refund_request_dto_list_envelope->error_code
    if(refund_request_dto_list_envelope->error_code) {
    if(cJSON_AddStringToObject(item, "errorCode", refund_request_dto_list_envelope->error_code) == NULL) {
    goto fail; //String
    }
    }


    // refund_request_dto_list_envelope->validation_details
    if(refund_request_dto_list_envelope->validation_details) {
    ...
    if (refund_request_dto_list_envelope->validation_details) {
    list_ForEach(validation_detailsListEntry, refund_request_dto_list_envelope->validation_details) {
...
refund_request_dto_list_envelope_t *refund_request_dto_list_envelope_parseFromJSON(cJSON *refund_request_dto_list_envelopeJSON){
    ...
    // define the local map for refund_request_dto_list_envelope->validation_details
    ...
    // refund_request_dto_list_envelope->http_status
    cJSON *http_status = cJSON_GetObjectItemCaseSensitive(refund_request_dto_list_envelopeJSON, "httpStatus");
    if (http_status) { 
    ...
    // refund_request_dto_list_envelope->error_code
    cJSON *error_code = cJSON_GetObjectItemCaseSensitive(refund_request_dto_list_envelopeJSON, "errorCode");
    if (error_code) { 
    ...
    // refund_request_dto_list_envelope->validation_details
    cJSON *validation_details = cJSON_GetObjectItemCaseSensitive(refund_request_dto_list_envelopeJSON, "validationDetails");
