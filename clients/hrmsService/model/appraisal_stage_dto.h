/*
 * appraisal_stage_dto.h
 *
 * 
 */

#ifndef _appraisal_stage_dto_H_
#define _appraisal_stage_dto_H_
...
typedef struct appraisal_stage_dto_t appraisal_stage_dto_t;




typedef struct appraisal_stage_dto_t {
    char *id; // string
