/*
 * training_program_update_dto.h
 *
 * 
 */

#ifndef _training_program_update_dto_H_
#define _training_program_update_dto_H_
...
typedef struct training_program_update_dto_t training_program_update_dto_t;




typedef struct training_program_update_dto_t {
    char *title; // string
    char *description; // string

} training_program_update_dto_t;
...
#endif /* _training_program_update_dto_H_ */
