/*
 * schedule_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _schedule_dto_collection_query_parameters_H_
#define _schedule_dto_collection_query_parameters_H_
...
typedef struct schedule_dto_collection_query_parameters_t schedule_dto_collection_query_parameters_t;




typedef struct schedule_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} schedule_dto_collection_query_parameters_t;
...
#endif /* _schedule_dto_collection_query_parameters_H_ */
