/*
 * gig_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _gig_dto_collection_query_parameters_H_
#define _gig_dto_collection_query_parameters_H_
...
typedef struct gig_dto_collection_query_parameters_t gig_dto_collection_query_parameters_t;




typedef struct gig_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} gig_dto_collection_query_parameters_t;
...
#endif /* _gig_dto_collection_query_parameters_H_ */
