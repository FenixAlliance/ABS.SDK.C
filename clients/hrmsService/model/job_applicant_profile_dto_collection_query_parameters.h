/*
 * job_applicant_profile_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _job_applicant_profile_dto_collection_query_parameters_H_
#define _job_applicant_profile_dto_collection_query_parameters_H_
...
typedef struct job_applicant_profile_dto_collection_query_parameters_t job_applicant_profile_dto_collection_query_parameters_t;




typedef struct job_applicant_profile_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} job_applicant_profile_dto_collection_query_parameters_t;
...
#endif /* _job_applicant_profile_dto_collection_query_parameters_H_ */
