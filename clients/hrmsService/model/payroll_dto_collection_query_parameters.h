/*
 * payroll_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _payroll_dto_collection_query_parameters_H_
#define _payroll_dto_collection_query_parameters_H_
...
typedef struct payroll_dto_collection_query_parameters_t payroll_dto_collection_query_parameters_t;




typedef struct payroll_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} payroll_dto_collection_query_parameters_t;
...
#endif /* _payroll_dto_collection_query_parameters_H_ */
