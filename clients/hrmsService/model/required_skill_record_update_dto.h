/*
 * required_skill_record_update_dto.h
 *
 * 
 */

#ifndef _required_skill_record_update_dto_H_
#define _required_skill_record_update_dto_H_
...
typedef struct required_skill_record_update_dto_t required_skill_record_update_dto_t;


// Enum REQUIREDSKILLRECORDTYPE for required_skill_record_update_dto

typedef enum  { hrmsservice_required_skill_record_update_dto_REQUIREDSKILLRECORDTYPE_NULL = 0, hrmsservice_required_skill_record_update_dto_REQUIREDSKILLRECORDTYPE_MustHave, hrmsservice_required_skill_record_update_dto_REQUIREDSKILLRECORDTYPE_Optional } hrmsservice_required_skill_record_update_dto_REQUIREDSKILLRECORDTYPE_e;
...
typedef struct required_skill_record_update_dto_t {
    ...
    hrmsservice_required_skill_record_update_dto_REQUIREDSKILLRECORDTYPE_e required_skill_record_type; //enum

} required_skill_record_update_dto_t;
...
#endif /* _required_skill_record_update_dto_H_ */
