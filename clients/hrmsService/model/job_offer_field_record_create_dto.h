/*
 * job_offer_field_record_create_dto.h
 *
 * 
 */

#ifndef _job_offer_field_record_create_dto_H_
#define _job_offer_field_record_create_dto_H_
...
typedef struct job_offer_field_record_create_dto_t job_offer_field_record_create_dto_t;




typedef struct job_offer_field_record_create_dto_t {
    char *id; // string
    char *timestamp; //date time
    char *job_field_id; // string
    char *job_offer_id; // string

} job_offer_field_record_create_dto_t;
...
#endif /* _job_offer_field_record_create_dto_H_ */
