...
#include <string.h>
#include <stdio.h>
#include "employee_appraisal_session_dto_envelope.h"
...
employee_appraisal_session_dto_envelope_t *employee_appraisal_session_dto_envelope_create(
    ...
    employee_appraisal_session_dto_envelope_t *employee_appraisal_session_dto_envelope_local_var = malloc(sizeof(employee_appraisal_session_dto_envelope_t));
    if (!employee_appraisal_session_dto_envelope_local_var) {
        return NULL;
    }
    employee_appraisal_session_dto_envelope_local_var->is_success = is_success;
...
void employee_appraisal_session_dto_envelope_free(employee_appraisal_session_dto_envelope_t *employee_appraisal_session_dto_envelope) {
    if(NULL == employee_appraisal_session_dto_envelope){
        return ;
    }
    listEntry_t *listEntry;
    if (employee_appraisal_session_dto_envelope->error_message) {
        free(employee_appraisal_session_dto_envelope->error_message);
        employee_appraisal_session_dto_envelope->error_message = NULL;
    }
    if (employee_appraisal_session_dto_envelope->correlation_id) {
        free(employee_appraisal_session_dto_envelope->correlation_id);
        employee_appraisal_session_dto_envelope->correlation_id = NULL;
    }
    ...
    if (employee_appraisal_session_dto_envelope->activity_id) {
        ...
        employee_appraisal_session_dto_envelope->activity_id = NULL;
    }
    if (employee_appraisal_session_dto_envelope->result) {
        employee_appraisal_session_dto_free(employee_appraisal_session_dto_envelope->result);
        employee_appraisal_session_dto_envelope->result = NULL;
    }
    free(employee_appraisal_session_dto_envelope);
}
...
cJSON *employee_appraisal_session_dto_envelope_convertToJSON(employee_appraisal_session_dto_envelope_t *employee_appraisal_session_dto_envelope) {
    ...
    // employee_appraisal_session_dto_envelope->is_success
    if(employee_appraisal_session_dto_envelope->is_success) {
    if(cJSON_AddBoolToObject(item, "isSuccess", employee_appraisal_session_dto_envelope->is_success) == NULL) {
    goto fail; //Bool
    }
    }


    // employee_appraisal_session_dto_envelope->error_message
    if(employee_appraisal_session_dto_envelope->error_message) {
    if(cJSON_AddStringToObject(item, "errorMessage", employee_appraisal_session_dto_envelope->error_message) == NULL) {
    goto fail; //String
    }
    }


    // employee_appraisal_session_dto_envelope->correlation_id
    if(employee_appraisal_session_dto_envelope->correlation_id) {
    if(cJSON_AddStringToObject(item, "correlationId", employee_appraisal_session_dto_envelope->correlation_id) == NULL) {
    goto fail; //String
    }
    }


    // employee_appraisal_session_dto_envelope->timestamp
    if(employee_appraisal_session_dto_envelope->timestamp) {
    if(cJSON_AddStringToObject(item, "timestamp", employee_appraisal_session_dto_envelope->timestamp) == NULL) {
    goto fail; //Date-Time
    }
    }
    ...
    // employee_appraisal_session_dto_envelope->result
    if(employee_appraisal_session_dto_envelope->result) {
    cJSON *result_local_JSON = employee_appraisal_session_dto_convertToJSON(employee_appraisal_session_dto_envelope->result);
...
employee_appraisal_session_dto_envelope_t *employee_appraisal_session_dto_envelope_parseFromJSON(cJSON *employee_appraisal_session_dto_envelopeJSON){
    ...
    // employee_appraisal_session_dto_envelope->is_success
    cJSON *is_success = cJSON_GetObjectItemCaseSensitive(employee_appraisal_session_dto_envelopeJSON, "isSuccess");
    if (is_success) { 
    ...
    // employee_appraisal_session_dto_envelope->error_message
    cJSON *error_message = cJSON_GetObjectItemCaseSensitive(employee_appraisal_session_dto_envelopeJSON, "errorMessage");
    if (error_message) { 
    ...
    // employee_appraisal_session_dto_envelope->correlation_id
    cJSON *correlation_id = cJSON_GetObjectItemCaseSensitive(employee_appraisal_session_dto_envelopeJSON, "correlationId");
    if (correlation_id) { 
    ...
    // employee_appraisal_session_dto_envelope->timestamp
    cJSON *timestamp = cJSON_GetObjectItemCaseSensitive(employee_appraisal_session_dto_envelopeJSON, "timestamp");
    if (timestamp) { 
    ...
    // employee_appraisal_session_dto_envelope->result
    cJSON *result = cJSON_GetObjectItemCaseSensitive(employee_appraisal_session_dto_envelopeJSON, "result");
    if (result) { 
    result_local_nonprim = employee_appraisal_session_dto_parseFromJSON(result); //nonprimitive
    }


    employee_appraisal_session_dto_envelope_local_var = employee_appraisal_session_dto_envelope_create (
