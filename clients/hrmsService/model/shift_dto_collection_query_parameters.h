/*
 * shift_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _shift_dto_collection_query_parameters_H_
#define _shift_dto_collection_query_parameters_H_
...
typedef struct shift_dto_collection_query_parameters_t shift_dto_collection_query_parameters_t;




typedef struct shift_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} shift_dto_collection_query_parameters_t;
...
#endif /* _shift_dto_collection_query_parameters_H_ */
