/*
 * employer_profile_dto.h
 *
 * 
 */

#ifndef _employer_profile_dto_H_
#define _employer_profile_dto_H_
...
typedef struct employer_profile_dto_t employer_profile_dto_t;




typedef struct employer_profile_dto_t {
    char *id; // string
...
#endif /* _employer_profile_dto_H_ */
