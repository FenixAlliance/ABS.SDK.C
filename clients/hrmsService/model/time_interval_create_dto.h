/*
 * time_interval_create_dto.h
 *
 * 
 */

#ifndef _time_interval_create_dto_H_
#define _time_interval_create_dto_H_
...
typedef struct time_interval_create_dto_t time_interval_create_dto_t;




typedef struct time_interval_create_dto_t {
    char *id; // string
...
#endif /* _time_interval_create_dto_H_ */
