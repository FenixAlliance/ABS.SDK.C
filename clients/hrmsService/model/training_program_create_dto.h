/*
 * training_program_create_dto.h
 *
 * 
 */

#ifndef _training_program_create_dto_H_
#define _training_program_create_dto_H_
...
typedef struct training_program_create_dto_t training_program_create_dto_t;




typedef struct training_program_create_dto_t {
    char *id; // string
    char *timestamp; //date time
    char *title; // string
    char *description; // string

} training_program_create_dto_t;
...
#endif /* _training_program_create_dto_H_ */
