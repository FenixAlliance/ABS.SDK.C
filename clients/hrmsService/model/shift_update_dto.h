...
#ifndef _shift_update_dto_H_
#define _shift_update_dto_H_
...
typedef struct shift_update_dto_t shift_update_dto_t;


// Enum REPETITIONCRITERIA for shift_update_dto

typedef enum  { hrmsservice_shift_update_dto_REPETITIONCRITERIA_NULL = 0, hrmsservice_shift_update_dto_REPETITIONCRITERIA_NotRepeat, hrmsservice_shift_update_dto_REPETITIONCRITERIA_WorkWeek, hrmsservice_shift_update_dto_REPETITIONCRITERIA_Day, hrmsservice_shift_update_dto_REPETITIONCRITERIA_Month, hrmsservice_shift_update_dto_REPETITIONCRITERIA_Year } hrmsservice_shift_update_dto_REPETITIONCRITERIA_e;
...
// Enum DAYOFTHEWEEK for shift_update_dto

typedef enum  { hrmsservice_shift_update_dto_DAYOFTHEWEEK_NULL = 0, hrmsservice_shift_update_dto_DAYOFTHEWEEK_All, hrmsservice_shift_update_dto_DAYOFTHEWEEK_Sunday, hrmsservice_shift_update_dto_DAYOFTHEWEEK_Monday, hrmsservice_shift_update_dto_DAYOFTHEWEEK_Tuesday, hrmsservice_shift_update_dto_DAYOFTHEWEEK_Wednesday, hrmsservice_shift_update_dto_DAYOFTHEWEEK_Thursday, hrmsservice_shift_update_dto_DAYOFTHEWEEK_Friday, hrmsservice_shift_update_dto_DAYOFTHEWEEK_Saturday } hrmsservice_shift_update_dto_DAYOFTHEWEEK_e;
...
typedef struct shift_update_dto_t {
    char *title; // string
    ...
    hrmsservice_shift_update_dto_REPETITIONCRITERIA_e repetition_criteria; //enum
    char *recurrence_start; //date time
    char *recurrence_end; //date time
    hrmsservice_shift_update_dto_DAYOFTHEWEEK_e day_of_the_week; //enum
