...
//
time_interval_dto_list_envelope_t* TimeIntervalsAPI_getTimeIntervalsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
//
int32_envelope_t* TimeIntervalsAPI_getTimeIntervalsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
