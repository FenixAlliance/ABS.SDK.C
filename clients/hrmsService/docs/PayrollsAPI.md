...
//
payroll_dto_list_envelope_t* PayrollsAPI_getPayrollsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, payroll_dto_collection_query_parameters_t *payroll_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**payroll_dto_collection_query_parameters** | **[payroll_dto_collection_query_parameters_t](payroll_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* PayrollsAPI_getPayrollsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, payroll_dto_collection_query_parameters_t *payroll_dto_collection_query_parameters);
```
...
//
empty_envelope_t* PayrollsAPI_patchPayrollAsync(apiClient_t *apiClient, char *tenantId, char *payrollId, char *api_version, char *x_api_version, list_t *patch_operation);
```
