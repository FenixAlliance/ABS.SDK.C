...
//
job_title_dto_list_envelope_t* JobTitlesAPI_getJobTitlesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, job_title_dto_collection_query_parameters_t *job_title_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**job_title_dto_collection_query_parameters** | **[job_title_dto_collection_query_parameters_t](job_title_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* JobTitlesAPI_getJobTitlesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, job_title_dto_collection_query_parameters_t *job_title_dto_collection_query_parameters);
```
...
//
empty_envelope_t* JobTitlesAPI_patchJobTitleAsync(apiClient_t *apiClient, char *tenantId, char *jobTitleId, char *api_version, char *x_api_version, list_t *patch_operation);
```
