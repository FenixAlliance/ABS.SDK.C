...
//
employee_profile_dto_list_envelope_t* EmployeesAPI_getEmployeesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, employee_profile_dto_collection_query_parameters_t *employee_profile_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**employee_profile_dto_collection_query_parameters** | **[employee_profile_dto_collection_query_parameters_t](employee_profile_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* EmployeesAPI_getEmployeesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, employee_profile_dto_collection_query_parameters_t *employee_profile_dto_collection_query_parameters);
```
...
//
empty_envelope_t* EmployeesAPI_patchEmployeeAsync(apiClient_t *apiClient, char *tenantId, char *employeeId, char *api_version, char *x_api_version, list_t *patch_operation);
```
...
//
empty_envelope_t* EmployeesAPI_updateEmployeeAsync(apiClient_t *apiClient, char *tenantId, char *employeeId, char *api_version, char *x_api_version, employee_profile_update_dto_t *employee_profile_update_dto);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**employee_profile_update_dto** | **[employee_profile_update_dto_t](employee_profile_update_dto.md) \*** |  | [optional] 
