...
//
job_field_dto_list_envelope_t* JobFieldsAPI_getJobFieldsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
//
int32_envelope_t* JobFieldsAPI_getJobFieldsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
//
empty_envelope_t* JobFieldsAPI_patchJobFieldAsync(apiClient_t *apiClient, char *tenantId, char *jobFieldId, char *api_version, char *x_api_version, list_t *operation);
```
