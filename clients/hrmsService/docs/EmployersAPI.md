...
//
employer_profile_dto_list_envelope_t* EmployersAPI_getEmployersAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, employer_profile_dto_collection_query_parameters_t *employer_profile_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**employer_profile_dto_collection_query_parameters** | **[employer_profile_dto_collection_query_parameters_t](employer_profile_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* EmployersAPI_getEmployersCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, employer_profile_dto_collection_query_parameters_t *employer_profile_dto_collection_query_parameters);
```
...
//
empty_envelope_t* EmployersAPI_patchEmployerAsync(apiClient_t *apiClient, char *tenantId, char *employerId, char *api_version, char *x_api_version, list_t *patch_operation);
```
