...
//
employee_appraisal_session_dto_list_envelope_t* EmployeeAppraisalSessionsAPI_getEmployeeAppraisalSessionsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, employee_appraisal_session_dto_collection_query_parameters_t *employee_appraisal_session_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**employee_appraisal_session_dto_collection_query_parameters** | **[employee_appraisal_session_dto_collection_query_parameters_t](employee_appraisal_session_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* EmployeeAppraisalSessionsAPI_getEmployeeAppraisalSessionsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, employee_appraisal_session_dto_collection_query_parameters_t *employee_appraisal_session_dto_collection_query_parameters);
```
...
//
empty_envelope_t* EmployeeAppraisalSessionsAPI_patchEmployeeAppraisalSessionAsync(apiClient_t *apiClient, char *tenantId, char *sessionId, char *api_version, char *x_api_version, list_t *patch_operation);
```
