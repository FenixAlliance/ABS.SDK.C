...
//
leave_application_dto_list_envelope_t* LeaveApplicationsAPI_getLeaveApplicationsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, leave_application_dto_collection_query_parameters_t *leave_application_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**leave_application_dto_collection_query_parameters** | **[leave_application_dto_collection_query_parameters_t](leave_application_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* LeaveApplicationsAPI_getLeaveApplicationsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, leave_application_dto_collection_query_parameters_t *leave_application_dto_collection_query_parameters);
```
...
//
empty_envelope_t* LeaveApplicationsAPI_patchLeaveApplicationAsync(apiClient_t *apiClient, char *tenantId, char *leaveApplicationId, char *api_version, char *x_api_version, list_t *patch_operation);
```
