...
EmployersAPI_createEmployerAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, employer_profile_create_dto_t *employer_profile_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/Employers")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/Employers");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_employer_profile_create_dto = NULL;
    if (employer_profile_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_employer_profile_create_dto = employer_profile_create_dto_convertToJSON(employer_profile_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_employer_profile_create_dto);
    }
    ...
    cJSON *EmployersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(EmployersAPIlocalVarJSON);
    cJSON_Delete(EmployersAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_employer_profile_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_employer_profile_create_dto);
        localVarSingleItemJSON_employer_profile_create_dto = NULL;
    }
...
EmployersAPI_deleteEmployerAsync(apiClient_t *apiClient, char *tenantId, char *employerId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/Employers/{employerId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/Employers/{employerId}");


    // Path Params
    long sizeOfPathParams_employerId = strlen(employerId)+3 + strlen("{ employerId }");
    if(employerId == NULL) {
        goto end;
    }
    char* localVarToReplace_employerId = malloc(sizeOfPathParams_employerId);
    sprintf(localVarToReplace_employerId, "{%s}", "employerId");

    localVarPath = strReplace(localVarPath, localVarToReplace_employerId, employerId);
    if(employerId == NULL) {
        goto end;
    }
    char* localVarToReplace_employerId = malloc(sizeOfPathParams_employerId);
    ...
    free(localVarPath);
    free(localVarToReplace_employerId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
EmployersAPI_getEmployerByIdAsync(apiClient_t *apiClient, char *tenantId, char *employerId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *EmployersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    employer_profile_dto_envelope_t *elementToReturn = employer_profile_dto_envelope_parseFromJSON(EmployersAPIlocalVarJSON);
    cJSON_Delete(EmployersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
EmployersAPI_getEmployersAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, employer_profile_dto_collection_query_parameters_t *employer_profile_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_employer_profile_dto_collection_query_parameters = NULL;
    if (employer_profile_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_employer_profile_dto_collection_query_parameters = employer_profile_dto_collection_query_parameters_convertToJSON(employer_profile_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_employer_profile_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *EmployersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    employer_profile_dto_list_envelope_t *elementToReturn = employer_profile_dto_list_envelope_parseFromJSON(EmployersAPIlocalVarJSON);
    cJSON_Delete(EmployersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_employer_profile_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_employer_profile_dto_collection_query_parameters);
        localVarSingleItemJSON_employer_profile_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
EmployersAPI_getEmployersCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, employer_profile_dto_collection_query_parameters_t *employer_profile_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/Employers/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/Employers/Count");
    ...
    //nonprimitive not container
    cJSON *EmployersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(EmployersAPIlocalVarJSON);
    cJSON_Delete(EmployersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
EmployersAPI_updateEmployerAsync(apiClient_t *apiClient, char *tenantId, char *employerId, char *api_version, char *x_api_version, employer_profile_update_dto_t *employer_profile_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_employer_profile_update_dto = NULL;
    if (employer_profile_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_employer_profile_update_dto = employer_profile_update_dto_convertToJSON(employer_profile_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_employer_profile_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_employer_profile_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_employer_profile_update_dto);
        localVarSingleItemJSON_employer_profile_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
