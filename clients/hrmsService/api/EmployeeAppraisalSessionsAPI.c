...
#include <stdio.h>
#include <ctype.h>
#include "EmployeeAppraisalSessionsAPI.h"
...
EmployeeAppraisalSessionsAPI_createEmployeeAppraisalSessionAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, employee_appraisal_session_create_dto_t *employee_appraisal_session_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/EmployeeAppraisalSessions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/EmployeeAppraisalSessions");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_employee_appraisal_session_create_dto = NULL;
    if (employee_appraisal_session_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_employee_appraisal_session_create_dto = employee_appraisal_session_create_dto_convertToJSON(employee_appraisal_session_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_employee_appraisal_session_create_dto);
    }
    ...
    cJSON *EmployeeAppraisalSessionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(EmployeeAppraisalSessionsAPIlocalVarJSON);
    cJSON_Delete(EmployeeAppraisalSessionsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_employee_appraisal_session_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_employee_appraisal_session_create_dto);
        localVarSingleItemJSON_employee_appraisal_session_create_dto = NULL;
    }
...
EmployeeAppraisalSessionsAPI_deleteEmployeeAppraisalSessionAsync(apiClient_t *apiClient, char *tenantId, char *sessionId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/EmployeeAppraisalSessions/{sessionId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/EmployeeAppraisalSessions/{sessionId}");
...
EmployeeAppraisalSessionsAPI_getEmployeeAppraisalSessionByIdAsync(apiClient_t *apiClient, char *tenantId, char *sessionId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *EmployeeAppraisalSessionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    employee_appraisal_session_dto_envelope_t *elementToReturn = employee_appraisal_session_dto_envelope_parseFromJSON(EmployeeAppraisalSessionsAPIlocalVarJSON);
    cJSON_Delete(EmployeeAppraisalSessionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
EmployeeAppraisalSessionsAPI_getEmployeeAppraisalSessionsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, employee_appraisal_session_dto_collection_query_parameters_t *employee_appraisal_session_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_employee_appraisal_session_dto_collection_query_parameters = NULL;
    if (employee_appraisal_session_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_employee_appraisal_session_dto_collection_query_parameters = employee_appraisal_session_dto_collection_query_parameters_convertToJSON(employee_appraisal_session_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_employee_appraisal_session_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *EmployeeAppraisalSessionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    employee_appraisal_session_dto_list_envelope_t *elementToReturn = employee_appraisal_session_dto_list_envelope_parseFromJSON(EmployeeAppraisalSessionsAPIlocalVarJSON);
    cJSON_Delete(EmployeeAppraisalSessionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_employee_appraisal_session_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_employee_appraisal_session_dto_collection_query_parameters);
        localVarSingleItemJSON_employee_appraisal_session_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
EmployeeAppraisalSessionsAPI_getEmployeeAppraisalSessionsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, employee_appraisal_session_dto_collection_query_parameters_t *employee_appraisal_session_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/EmployeeAppraisalSessions/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/EmployeeAppraisalSessions/Count");
    ...
    //nonprimitive not container
    cJSON *EmployeeAppraisalSessionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(EmployeeAppraisalSessionsAPIlocalVarJSON);
    cJSON_Delete(EmployeeAppraisalSessionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
EmployeeAppraisalSessionsAPI_updateEmployeeAppraisalSessionAsync(apiClient_t *apiClient, char *tenantId, char *sessionId, char *api_version, char *x_api_version, employee_appraisal_session_update_dto_t *employee_appraisal_session_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_employee_appraisal_session_update_dto = NULL;
    if (employee_appraisal_session_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_employee_appraisal_session_update_dto = employee_appraisal_session_update_dto_convertToJSON(employee_appraisal_session_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_employee_appraisal_session_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_employee_appraisal_session_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_employee_appraisal_session_update_dto);
        localVarSingleItemJSON_employee_appraisal_session_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
