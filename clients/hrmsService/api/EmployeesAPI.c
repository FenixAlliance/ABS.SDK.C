...
EmployeesAPI_createEmployeeAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, employee_profile_create_dto_t *employee_profile_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/Employees")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/Employees");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_employee_profile_create_dto = NULL;
    if (employee_profile_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_employee_profile_create_dto = employee_profile_create_dto_convertToJSON(employee_profile_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_employee_profile_create_dto);
    }
    ...
    cJSON *EmployeesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(EmployeesAPIlocalVarJSON);
    cJSON_Delete(EmployeesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_employee_profile_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_employee_profile_create_dto);
        localVarSingleItemJSON_employee_profile_create_dto = NULL;
    }
...
EmployeesAPI_deleteEmployeeAsync(apiClient_t *apiClient, char *tenantId, char *employeeId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/Employees/{employeeId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/Employees/{employeeId}");


    // Path Params
    long sizeOfPathParams_employeeId = strlen(employeeId)+3 + strlen("{ employeeId }");
    if(employeeId == NULL) {
        goto end;
    }
    char* localVarToReplace_employeeId = malloc(sizeOfPathParams_employeeId);
    sprintf(localVarToReplace_employeeId, "{%s}", "employeeId");

    localVarPath = strReplace(localVarPath, localVarToReplace_employeeId, employeeId);
    if(employeeId == NULL) {
        goto end;
    }
    char* localVarToReplace_employeeId = malloc(sizeOfPathParams_employeeId);
    ...
    free(localVarPath);
    free(localVarToReplace_employeeId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
EmployeesAPI_getEmployeeByIdAsync(apiClient_t *apiClient, char *tenantId, char *employeeId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *EmployeesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    employee_profile_dto_envelope_t *elementToReturn = employee_profile_dto_envelope_parseFromJSON(EmployeesAPIlocalVarJSON);
    cJSON_Delete(EmployeesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
EmployeesAPI_getEmployeesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, employee_profile_dto_collection_query_parameters_t *employee_profile_dto_collection_query_parameters)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = list_createList();
    list_t    *localVarFormParameters = NULL;
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_employee_profile_dto_collection_query_parameters = NULL;
    if (employee_profile_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_employee_profile_dto_collection_query_parameters = employee_profile_dto_collection_query_parameters_convertToJSON(employee_profile_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_employee_profile_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *EmployeesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    employee_profile_dto_list_envelope_t *elementToReturn = employee_profile_dto_list_envelope_parseFromJSON(EmployeesAPIlocalVarJSON);
    cJSON_Delete(EmployeesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_employee_profile_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_employee_profile_dto_collection_query_parameters);
        localVarSingleItemJSON_employee_profile_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
//
int32_envelope_t*
EmployeesAPI_getEmployeesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, employee_profile_dto_collection_query_parameters_t *employee_profile_dto_collection_query_parameters)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = list_createList();
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/Employees/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/Employees/Count");
    ...
    //nonprimitive not container
    cJSON *EmployeesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(EmployeesAPIlocalVarJSON);
    cJSON_Delete(EmployeesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
empty_envelope_t*
EmployeesAPI_patchEmployeeAsync(apiClient_t *apiClient, char *tenantId, char *employeeId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = list_createList();
    list_t    *localVarFormParameters = NULL;
