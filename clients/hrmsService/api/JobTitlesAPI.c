...
JobTitlesAPI_createJobTitleAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, job_title_create_dto_t *job_title_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/JobTitles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/JobTitles");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_job_title_create_dto = NULL;
    if (job_title_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_job_title_create_dto = job_title_create_dto_convertToJSON(job_title_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_job_title_create_dto);
    }
    ...
    cJSON *JobTitlesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(JobTitlesAPIlocalVarJSON);
    cJSON_Delete(JobTitlesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_job_title_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_job_title_create_dto);
        localVarSingleItemJSON_job_title_create_dto = NULL;
    }
...
JobTitlesAPI_deleteJobTitleAsync(apiClient_t *apiClient, char *tenantId, char *jobTitleId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/JobTitles/{jobTitleId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/JobTitles/{jobTitleId}");


    // Path Params
    long sizeOfPathParams_jobTitleId = strlen(jobTitleId)+3 + strlen("{ jobTitleId }");
    if(jobTitleId == NULL) {
        goto end;
    }
    char* localVarToReplace_jobTitleId = malloc(sizeOfPathParams_jobTitleId);
    sprintf(localVarToReplace_jobTitleId, "{%s}", "jobTitleId");

    localVarPath = strReplace(localVarPath, localVarToReplace_jobTitleId, jobTitleId);
    if(jobTitleId == NULL) {
        goto end;
    }
    char* localVarToReplace_jobTitleId = malloc(sizeOfPathParams_jobTitleId);
    ...
    free(localVarPath);
    free(localVarToReplace_jobTitleId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
JobTitlesAPI_getJobTitleByIdAsync(apiClient_t *apiClient, char *tenantId, char *jobTitleId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *JobTitlesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    job_title_dto_envelope_t *elementToReturn = job_title_dto_envelope_parseFromJSON(JobTitlesAPIlocalVarJSON);
    cJSON_Delete(JobTitlesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
JobTitlesAPI_getJobTitlesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, job_title_dto_collection_query_parameters_t *job_title_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_job_title_dto_collection_query_parameters = NULL;
    if (job_title_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_job_title_dto_collection_query_parameters = job_title_dto_collection_query_parameters_convertToJSON(job_title_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_job_title_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *JobTitlesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    job_title_dto_list_envelope_t *elementToReturn = job_title_dto_list_envelope_parseFromJSON(JobTitlesAPIlocalVarJSON);
    cJSON_Delete(JobTitlesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_job_title_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_job_title_dto_collection_query_parameters);
        localVarSingleItemJSON_job_title_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
JobTitlesAPI_getJobTitlesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, job_title_dto_collection_query_parameters_t *job_title_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/JobTitles/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/JobTitles/Count");
    ...
    //nonprimitive not container
    cJSON *JobTitlesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(JobTitlesAPIlocalVarJSON);
    cJSON_Delete(JobTitlesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
JobTitlesAPI_updateJobTitleAsync(apiClient_t *apiClient, char *tenantId, char *jobTitleId, char *api_version, char *x_api_version, job_title_update_dto_t *job_title_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_job_title_update_dto = NULL;
    if (job_title_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_job_title_update_dto = job_title_update_dto_convertToJSON(job_title_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_job_title_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_job_title_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_job_title_update_dto);
        localVarSingleItemJSON_job_title_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
