...
JobFieldsAPI_createJobFieldAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, job_field_create_dto_t *job_field_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/JobFields")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/JobFields");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_job_field_create_dto = NULL;
    if (job_field_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_job_field_create_dto = job_field_create_dto_convertToJSON(job_field_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_job_field_create_dto);
    }
    ...
    cJSON *JobFieldsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(JobFieldsAPIlocalVarJSON);
    cJSON_Delete(JobFieldsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_job_field_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_job_field_create_dto);
        localVarSingleItemJSON_job_field_create_dto = NULL;
    }
...
JobFieldsAPI_deleteJobFieldAsync(apiClient_t *apiClient, char *tenantId, char *jobFieldId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/JobFields/{jobFieldId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/JobFields/{jobFieldId}");


    // Path Params
    long sizeOfPathParams_jobFieldId = strlen(jobFieldId)+3 + strlen("{ jobFieldId }");
    if(jobFieldId == NULL) {
        goto end;
    }
    char* localVarToReplace_jobFieldId = malloc(sizeOfPathParams_jobFieldId);
    sprintf(localVarToReplace_jobFieldId, "{%s}", "jobFieldId");

    localVarPath = strReplace(localVarPath, localVarToReplace_jobFieldId, jobFieldId);
    if(jobFieldId == NULL) {
        goto end;
    }
    char* localVarToReplace_jobFieldId = malloc(sizeOfPathParams_jobFieldId);
    ...
    free(localVarPath);
    free(localVarToReplace_jobFieldId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
JobFieldsAPI_getJobFieldByIdAsync(apiClient_t *apiClient, char *tenantId, char *jobFieldId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *JobFieldsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    job_field_dto_envelope_t *elementToReturn = job_field_dto_envelope_parseFromJSON(JobFieldsAPIlocalVarJSON);
    cJSON_Delete(JobFieldsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
JobFieldsAPI_getJobFieldsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, job_field_dto_collection_query_parameters_t *job_field_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_job_field_dto_collection_query_parameters = NULL;
    if (job_field_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_job_field_dto_collection_query_parameters = job_field_dto_collection_query_parameters_convertToJSON(job_field_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_job_field_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *JobFieldsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    job_field_dto_list_envelope_t *elementToReturn = job_field_dto_list_envelope_parseFromJSON(JobFieldsAPIlocalVarJSON);
    cJSON_Delete(JobFieldsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_job_field_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_job_field_dto_collection_query_parameters);
        localVarSingleItemJSON_job_field_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
JobFieldsAPI_getJobFieldsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, job_field_dto_collection_query_parameters_t *job_field_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/JobFields/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/JobFields/Count");
    ...
    //nonprimitive not container
    cJSON *JobFieldsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(JobFieldsAPIlocalVarJSON);
    cJSON_Delete(JobFieldsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
JobFieldsAPI_updateJobFieldAsync(apiClient_t *apiClient, char *tenantId, char *jobFieldId, char *api_version, char *x_api_version, job_field_update_dto_t *job_field_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_job_field_update_dto = NULL;
    if (job_field_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_job_field_update_dto = job_field_update_dto_convertToJSON(job_field_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_job_field_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_job_field_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_job_field_update_dto);
        localVarSingleItemJSON_job_field_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
