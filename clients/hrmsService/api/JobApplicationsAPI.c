...
// Functions for enum STATUS for JobApplicationsAPI_changeJobApplicationStatusAsync

static char* changeJobApplicationStatusAsync_STATUS_ToString(hrmsservice_changeJobApplicationStatusAsync_status_e STATUS){
    char *STATUSArray[] =  { "NULL", "Submitted", "UnderReview", "Interviewing", "Offered", "Hired", "Rejected", "Withdrawn" };
    return STATUSArray[STATUS];
}

static hrmsservice_changeJobApplicationStatusAsync_status_e changeJobApplicationStatusAsync_STATUS_FromString(char* STATUS){
...
/*
// Function changeJobApplicationStatusAsync_STATUS_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *changeJobApplicationStatusAsync_STATUS_convertToJSON(hrmsservice_changeJobApplicationStatusAsync_status_e STATUS) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "status", changeJobApplicationStatusAsync_STATUS_ToString(STATUS)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function changeJobApplicationStatusAsync_STATUS_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static hrmsservice_changeJobApplicationStatusAsync_status_e changeJobApplicationStatusAsync_STATUS_parseFromJSON(cJSON* STATUSJSON) {
    hrmsservice_changeJobApplicationStatusAsync_status_e STATUSVariable = 0;
    cJSON *STATUSVar = cJSON_GetObjectItemCaseSensitive(STATUSJSON, "status");
    if(!cJSON_IsString(STATUSVar) || (STATUSVar->valuestring == NULL))
    {
        goto end;
    }
    STATUSVariable = changeJobApplicationStatusAsync_STATUS_FromString(STATUSVar->valuestring);
...
JobApplicationsAPI_changeJobApplicationStatusAsync(apiClient_t *apiClient, char *tenantId, char *jobApplicationId, hrmsservice_changeJobApplicationStatusAsync_status_e status, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/JobApplications/{jobApplicationId}/Status")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/JobApplications/{jobApplicationId}/Status");


    // Path Params
    long sizeOfPathParams_jobApplicationId = strlen(jobApplicationId)+3 + strlen("{ jobApplicationId }");
    if(jobApplicationId == NULL) {
        goto end;
    }
    char* localVarToReplace_jobApplicationId = malloc(sizeOfPathParams_jobApplicationId);
    sprintf(localVarToReplace_jobApplicationId, "{%s}", "jobApplicationId");

    localVarPath = strReplace(localVarPath, localVarToReplace_jobApplicationId, jobApplicationId);
    if(jobApplicationId == NULL) {
        goto end;
    }
    char* localVarToReplace_jobApplicationId = malloc(sizeOfPathParams_jobApplicationId);
    ...
    hrmsservice_changeJobApplicationStatusAsync_status_e valueQuery_status ;
    keyValuePair_t *keyPairQuery_status = 0;
    if (status)
    {
        keyQuery_status = strdup("status");
        valueQuery_status = (status);
        keyPairQuery_status = keyValuePair_create(keyQuery_status, (void *)strdup(changeJobApplicationStatusAsync_STATUS_ToString(
        valueQuery_status)));
    ...
    cJSON *JobApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(JobApplicationsAPIlocalVarJSON);
    cJSON_Delete(JobApplicationsAPIlocalVarJSON);
    ...
    free(localVarPath);
    free(localVarToReplace_jobApplicationId);
...
JobApplicationsAPI_createJobApplicationAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, job_offer_application_create_dto_t *job_offer_application_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/JobApplications")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/JobApplications");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_job_offer_application_create_dto = NULL;
    if (job_offer_application_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_job_offer_application_create_dto = job_offer_application_create_dto_convertToJSON(job_offer_application_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_job_offer_application_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_job_offer_application_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_job_offer_application_create_dto);
        localVarSingleItemJSON_job_offer_application_create_dto = NULL;
    }
...
JobApplicationsAPI_deleteJobApplicationAsync(apiClient_t *apiClient, char *tenantId, char *jobApplicationId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/JobApplications/{jobApplicationId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/JobApplications/{jobApplicationId}");
...
JobApplicationsAPI_getJobApplicationByIdAsync(apiClient_t *apiClient, char *tenantId, char *jobApplicationId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *JobApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    job_offer_application_dto_envelope_t *elementToReturn = job_offer_application_dto_envelope_parseFromJSON(JobApplicationsAPIlocalVarJSON);
    cJSON_Delete(JobApplicationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
JobApplicationsAPI_getJobApplicationsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *JobApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    job_offer_application_dto_list_envelope_t *elementToReturn = job_offer_application_dto_list_envelope_parseFromJSON(JobApplicationsAPIlocalVarJSON);
    cJSON_Delete(JobApplicationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
JobApplicationsAPI_getJobApplicationsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/JobApplications/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/JobApplications/Count");
    ...
    //nonprimitive not container
    cJSON *JobApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(JobApplicationsAPIlocalVarJSON);
    cJSON_Delete(JobApplicationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
JobApplicationsAPI_updateJobApplicationAsync(apiClient_t *apiClient, char *tenantId, char *jobApplicationId, char *api_version, char *x_api_version, job_offer_application_update_dto_t *job_offer_application_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_job_offer_application_update_dto = NULL;
    if (job_offer_application_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_job_offer_application_update_dto = job_offer_application_update_dto_convertToJSON(job_offer_application_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_job_offer_application_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_job_offer_application_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_job_offer_application_update_dto);
        localVarSingleItemJSON_job_offer_application_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
