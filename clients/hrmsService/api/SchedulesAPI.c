...
SchedulesAPI_createScheduleAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, schedule_create_dto_t *schedule_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/Schedules")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/Schedules");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_schedule_create_dto = NULL;
    if (schedule_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_schedule_create_dto = schedule_create_dto_convertToJSON(schedule_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_schedule_create_dto);
    }
    ...
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SchedulesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_schedule_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_schedule_create_dto);
        localVarSingleItemJSON_schedule_create_dto = NULL;
    }
...
SchedulesAPI_deleteScheduleAsync(apiClient_t *apiClient, char *tenantId, char *scheduleId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/Schedules/{scheduleId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/Schedules/{scheduleId}");


    // Path Params
    long sizeOfPathParams_scheduleId = strlen(scheduleId)+3 + strlen("{ scheduleId }");
    if(scheduleId == NULL) {
        goto end;
    }
    char* localVarToReplace_scheduleId = malloc(sizeOfPathParams_scheduleId);
    sprintf(localVarToReplace_scheduleId, "{%s}", "scheduleId");

    localVarPath = strReplace(localVarPath, localVarToReplace_scheduleId, scheduleId);
    if(scheduleId == NULL) {
        goto end;
    }
    char* localVarToReplace_scheduleId = malloc(sizeOfPathParams_scheduleId);
    ...
    free(localVarPath);
    free(localVarToReplace_scheduleId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
SchedulesAPI_getScheduleByIdAsync(apiClient_t *apiClient, char *tenantId, char *scheduleId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SchedulesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    schedule_dto_envelope_t *elementToReturn = schedule_dto_envelope_parseFromJSON(SchedulesAPIlocalVarJSON);
    cJSON_Delete(SchedulesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SchedulesAPI_getSchedulesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, schedule_dto_collection_query_parameters_t *schedule_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_schedule_dto_collection_query_parameters = NULL;
    if (schedule_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_schedule_dto_collection_query_parameters = schedule_dto_collection_query_parameters_convertToJSON(schedule_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_schedule_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *SchedulesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    schedule_dto_list_envelope_t *elementToReturn = schedule_dto_list_envelope_parseFromJSON(SchedulesAPIlocalVarJSON);
    cJSON_Delete(SchedulesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_schedule_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_schedule_dto_collection_query_parameters);
        localVarSingleItemJSON_schedule_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SchedulesAPI_getSchedulesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, schedule_dto_collection_query_parameters_t *schedule_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/Schedules/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/Schedules/Count");
    ...
    //nonprimitive not container
    cJSON *SchedulesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SchedulesAPIlocalVarJSON);
    cJSON_Delete(SchedulesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SchedulesAPI_updateScheduleAsync(apiClient_t *apiClient, char *tenantId, char *scheduleId, char *api_version, char *x_api_version, schedule_update_dto_t *schedule_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_schedule_update_dto = NULL;
    if (schedule_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_schedule_update_dto = schedule_update_dto_convertToJSON(schedule_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_schedule_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_schedule_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_schedule_update_dto);
        localVarSingleItemJSON_schedule_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
