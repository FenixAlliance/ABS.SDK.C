...
RequiredSkillsAPI_createRequiredSkillAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, required_skill_record_create_dto_t *required_skill_record_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/RequiredSkills")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/RequiredSkills");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_required_skill_record_create_dto = NULL;
    if (required_skill_record_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_required_skill_record_create_dto = required_skill_record_create_dto_convertToJSON(required_skill_record_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_required_skill_record_create_dto);
    }
    ...
    cJSON *RequiredSkillsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(RequiredSkillsAPIlocalVarJSON);
    cJSON_Delete(RequiredSkillsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_required_skill_record_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_required_skill_record_create_dto);
        localVarSingleItemJSON_required_skill_record_create_dto = NULL;
    }
...
RequiredSkillsAPI_deleteRequiredSkillAsync(apiClient_t *apiClient, char *tenantId, char *requiredSkillId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/RequiredSkills/{requiredSkillId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/RequiredSkills/{requiredSkillId}");


    // Path Params
    long sizeOfPathParams_requiredSkillId = strlen(requiredSkillId)+3 + strlen("{ requiredSkillId }");
    if(requiredSkillId == NULL) {
        goto end;
    }
    char* localVarToReplace_requiredSkillId = malloc(sizeOfPathParams_requiredSkillId);
    sprintf(localVarToReplace_requiredSkillId, "{%s}", "requiredSkillId");

    localVarPath = strReplace(localVarPath, localVarToReplace_requiredSkillId, requiredSkillId);
    if(requiredSkillId == NULL) {
        goto end;
    }
    char* localVarToReplace_requiredSkillId = malloc(sizeOfPathParams_requiredSkillId);
    ...
    free(localVarPath);
    free(localVarToReplace_requiredSkillId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
RequiredSkillsAPI_getRequiredSkillByIdAsync(apiClient_t *apiClient, char *tenantId, char *requiredSkillId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *RequiredSkillsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    required_skill_record_dto_envelope_t *elementToReturn = required_skill_record_dto_envelope_parseFromJSON(RequiredSkillsAPIlocalVarJSON);
    cJSON_Delete(RequiredSkillsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RequiredSkillsAPI_getRequiredSkillsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, required_skill_record_dto_collection_query_parameters_t *required_skill_record_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_required_skill_record_dto_collection_query_parameters = NULL;
    if (required_skill_record_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_required_skill_record_dto_collection_query_parameters = required_skill_record_dto_collection_query_parameters_convertToJSON(required_skill_record_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_required_skill_record_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *RequiredSkillsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    required_skill_record_dto_list_envelope_t *elementToReturn = required_skill_record_dto_list_envelope_parseFromJSON(RequiredSkillsAPIlocalVarJSON);
    cJSON_Delete(RequiredSkillsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_required_skill_record_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_required_skill_record_dto_collection_query_parameters);
        localVarSingleItemJSON_required_skill_record_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
RequiredSkillsAPI_getRequiredSkillsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, required_skill_record_dto_collection_query_parameters_t *required_skill_record_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/RequiredSkills/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/RequiredSkills/Count");
    ...
    //nonprimitive not container
    cJSON *RequiredSkillsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(RequiredSkillsAPIlocalVarJSON);
    cJSON_Delete(RequiredSkillsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RequiredSkillsAPI_updateRequiredSkillAsync(apiClient_t *apiClient, char *tenantId, char *requiredSkillId, char *api_version, char *x_api_version, required_skill_record_update_dto_t *required_skill_record_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_required_skill_record_update_dto = NULL;
    if (required_skill_record_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_required_skill_record_update_dto = required_skill_record_update_dto_convertToJSON(required_skill_record_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_required_skill_record_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_required_skill_record_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_required_skill_record_update_dto);
        localVarSingleItemJSON_required_skill_record_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
