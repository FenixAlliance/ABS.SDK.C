...
SalariesAPI_createSalaryAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, salary_create_dto_t *salary_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/Salaries")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/Salaries");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_salary_create_dto = NULL;
    if (salary_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_salary_create_dto = salary_create_dto_convertToJSON(salary_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_salary_create_dto);
    }
    ...
    cJSON *SalariesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SalariesAPIlocalVarJSON);
    cJSON_Delete(SalariesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_salary_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_salary_create_dto);
        localVarSingleItemJSON_salary_create_dto = NULL;
    }
...
SalariesAPI_deleteSalaryAsync(apiClient_t *apiClient, char *tenantId, char *salaryId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/Salaries/{salaryId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/Salaries/{salaryId}");


    // Path Params
    long sizeOfPathParams_salaryId = strlen(salaryId)+3 + strlen("{ salaryId }");
    if(salaryId == NULL) {
        goto end;
    }
    char* localVarToReplace_salaryId = malloc(sizeOfPathParams_salaryId);
    sprintf(localVarToReplace_salaryId, "{%s}", "salaryId");

    localVarPath = strReplace(localVarPath, localVarToReplace_salaryId, salaryId);
    if(salaryId == NULL) {
        goto end;
    }
    char* localVarToReplace_salaryId = malloc(sizeOfPathParams_salaryId);
    ...
    free(localVarPath);
    free(localVarToReplace_salaryId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
SalariesAPI_getSalariesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, salary_dto_collection_query_parameters_t *salary_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_salary_dto_collection_query_parameters = NULL;
    if (salary_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_salary_dto_collection_query_parameters = salary_dto_collection_query_parameters_convertToJSON(salary_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_salary_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *SalariesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    salary_dto_list_envelope_t *elementToReturn = salary_dto_list_envelope_parseFromJSON(SalariesAPIlocalVarJSON);
    cJSON_Delete(SalariesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_salary_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_salary_dto_collection_query_parameters);
        localVarSingleItemJSON_salary_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SalariesAPI_getSalariesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, salary_dto_collection_query_parameters_t *salary_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/Salaries/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/Salaries/Count");
    ...
    //nonprimitive not container
    cJSON *SalariesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SalariesAPIlocalVarJSON);
    cJSON_Delete(SalariesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SalariesAPI_getSalaryByIdAsync(apiClient_t *apiClient, char *tenantId, char *salaryId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SalariesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    salary_dto_envelope_t *elementToReturn = salary_dto_envelope_parseFromJSON(SalariesAPIlocalVarJSON);
    cJSON_Delete(SalariesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SalariesAPI_updateSalaryAsync(apiClient_t *apiClient, char *tenantId, char *salaryId, char *api_version, char *x_api_version, salary_update_dto_t *salary_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_salary_update_dto = NULL;
    if (salary_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_salary_update_dto = salary_update_dto_convertToJSON(salary_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_salary_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_salary_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_salary_update_dto);
        localVarSingleItemJSON_salary_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
