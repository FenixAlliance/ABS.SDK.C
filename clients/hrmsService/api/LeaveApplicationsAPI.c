...
#include <stdio.h>
#include <ctype.h>
#include "LeaveApplicationsAPI.h"
...
LeaveApplicationsAPI_createLeaveApplicationAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, leave_application_create_dto_t *leave_application_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/LeaveApplications")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/LeaveApplications");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_leave_application_create_dto = NULL;
    if (leave_application_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_leave_application_create_dto = leave_application_create_dto_convertToJSON(leave_application_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_leave_application_create_dto);
    }
    ...
    cJSON *LeaveApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(LeaveApplicationsAPIlocalVarJSON);
    cJSON_Delete(LeaveApplicationsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_leave_application_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_leave_application_create_dto);
        localVarSingleItemJSON_leave_application_create_dto = NULL;
    }
...
LeaveApplicationsAPI_deleteLeaveApplicationAsync(apiClient_t *apiClient, char *tenantId, char *leaveApplicationId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/LeaveApplications/{leaveApplicationId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/LeaveApplications/{leaveApplicationId}");


    // Path Params
    long sizeOfPathParams_leaveApplicationId = strlen(leaveApplicationId)+3 + strlen("{ leaveApplicationId }");
    if(leaveApplicationId == NULL) {
        goto end;
    }
    char* localVarToReplace_leaveApplicationId = malloc(sizeOfPathParams_leaveApplicationId);
    sprintf(localVarToReplace_leaveApplicationId, "{%s}", "leaveApplicationId");

    localVarPath = strReplace(localVarPath, localVarToReplace_leaveApplicationId, leaveApplicationId);
    if(leaveApplicationId == NULL) {
        goto end;
    }
    char* localVarToReplace_leaveApplicationId = malloc(sizeOfPathParams_leaveApplicationId);
    ...
    free(localVarPath);
    free(localVarToReplace_leaveApplicationId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
LeaveApplicationsAPI_getLeaveApplicationByIdAsync(apiClient_t *apiClient, char *tenantId, char *leaveApplicationId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *LeaveApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    leave_application_dto_envelope_t *elementToReturn = leave_application_dto_envelope_parseFromJSON(LeaveApplicationsAPIlocalVarJSON);
    cJSON_Delete(LeaveApplicationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
LeaveApplicationsAPI_getLeaveApplicationsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, leave_application_dto_collection_query_parameters_t *leave_application_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_leave_application_dto_collection_query_parameters = NULL;
    if (leave_application_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_leave_application_dto_collection_query_parameters = leave_application_dto_collection_query_parameters_convertToJSON(leave_application_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_leave_application_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *LeaveApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    leave_application_dto_list_envelope_t *elementToReturn = leave_application_dto_list_envelope_parseFromJSON(LeaveApplicationsAPIlocalVarJSON);
    cJSON_Delete(LeaveApplicationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_leave_application_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_leave_application_dto_collection_query_parameters);
        localVarSingleItemJSON_leave_application_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
LeaveApplicationsAPI_getLeaveApplicationsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, leave_application_dto_collection_query_parameters_t *leave_application_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/LeaveApplications/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/LeaveApplications/Count");
    ...
    //nonprimitive not container
    cJSON *LeaveApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(LeaveApplicationsAPIlocalVarJSON);
    cJSON_Delete(LeaveApplicationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
LeaveApplicationsAPI_updateLeaveApplicationAsync(apiClient_t *apiClient, char *tenantId, char *leaveApplicationId, char *api_version, char *x_api_version, leave_application_update_dto_t *leave_application_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_leave_application_update_dto = NULL;
    if (leave_application_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_leave_application_update_dto = leave_application_update_dto_convertToJSON(leave_application_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_leave_application_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_leave_application_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_leave_application_update_dto);
        localVarSingleItemJSON_leave_application_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
