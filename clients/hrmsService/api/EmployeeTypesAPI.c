...
EmployeeTypesAPI_createEmployeeTypeAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, employee_type_create_dto_t *employee_type_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/EmployeeTypes")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/EmployeeTypes");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_employee_type_create_dto = NULL;
    if (employee_type_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_employee_type_create_dto = employee_type_create_dto_convertToJSON(employee_type_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_employee_type_create_dto);
    }
    ...
    cJSON *EmployeeTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(EmployeeTypesAPIlocalVarJSON);
    cJSON_Delete(EmployeeTypesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_employee_type_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_employee_type_create_dto);
        localVarSingleItemJSON_employee_type_create_dto = NULL;
    }
...
EmployeeTypesAPI_deleteEmployeeTypeAsync(apiClient_t *apiClient, char *tenantId, char *employeeTypeId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/EmployeeTypes/{employeeTypeId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/EmployeeTypes/{employeeTypeId}");


    // Path Params
    long sizeOfPathParams_employeeTypeId = strlen(employeeTypeId)+3 + strlen("{ employeeTypeId }");
    if(employeeTypeId == NULL) {
        goto end;
    }
    char* localVarToReplace_employeeTypeId = malloc(sizeOfPathParams_employeeTypeId);
    sprintf(localVarToReplace_employeeTypeId, "{%s}", "employeeTypeId");

    localVarPath = strReplace(localVarPath, localVarToReplace_employeeTypeId, employeeTypeId);
    if(employeeTypeId == NULL) {
        goto end;
    }
    char* localVarToReplace_employeeTypeId = malloc(sizeOfPathParams_employeeTypeId);
    ...
    free(localVarPath);
    free(localVarToReplace_employeeTypeId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
EmployeeTypesAPI_getEmployeeTypeByIdAsync(apiClient_t *apiClient, char *tenantId, char *employeeTypeId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *EmployeeTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    employee_type_dto_envelope_t *elementToReturn = employee_type_dto_envelope_parseFromJSON(EmployeeTypesAPIlocalVarJSON);
    cJSON_Delete(EmployeeTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
EmployeeTypesAPI_getEmployeeTypesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, employee_type_dto_collection_query_parameters_t *employee_type_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_employee_type_dto_collection_query_parameters = NULL;
    if (employee_type_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_employee_type_dto_collection_query_parameters = employee_type_dto_collection_query_parameters_convertToJSON(employee_type_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_employee_type_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *EmployeeTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    employee_type_dto_list_envelope_t *elementToReturn = employee_type_dto_list_envelope_parseFromJSON(EmployeeTypesAPIlocalVarJSON);
    cJSON_Delete(EmployeeTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_employee_type_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_employee_type_dto_collection_query_parameters);
        localVarSingleItemJSON_employee_type_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
EmployeeTypesAPI_getEmployeeTypesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, employee_type_dto_collection_query_parameters_t *employee_type_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/EmployeeTypes/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/EmployeeTypes/Count");
    ...
    //nonprimitive not container
    cJSON *EmployeeTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(EmployeeTypesAPIlocalVarJSON);
    cJSON_Delete(EmployeeTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
EmployeeTypesAPI_updateEmployeeTypeAsync(apiClient_t *apiClient, char *tenantId, char *employeeTypeId, char *api_version, char *x_api_version, employee_type_update_dto_t *employee_type_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_employee_type_update_dto = NULL;
    if (employee_type_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_employee_type_update_dto = employee_type_update_dto_convertToJSON(employee_type_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_employee_type_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_employee_type_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_employee_type_update_dto);
        localVarSingleItemJSON_employee_type_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
