...
#include <stdio.h>
#include <ctype.h>
#include "TrainingProgramEventsAPI.h"
...
TrainingProgramEventsAPI_createTrainingProgramEventAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, training_program_event_create_dto_t *training_program_event_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/TrainingProgramEvents")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/TrainingProgramEvents");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_training_program_event_create_dto = NULL;
    if (training_program_event_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_training_program_event_create_dto = training_program_event_create_dto_convertToJSON(training_program_event_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_training_program_event_create_dto);
    }
    ...
    cJSON *TrainingProgramEventsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(TrainingProgramEventsAPIlocalVarJSON);
    cJSON_Delete(TrainingProgramEventsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_training_program_event_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_training_program_event_create_dto);
        localVarSingleItemJSON_training_program_event_create_dto = NULL;
    }
...
TrainingProgramEventsAPI_deleteTrainingProgramEventAsync(apiClient_t *apiClient, char *tenantId, char *eventId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/TrainingProgramEvents/{eventId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/TrainingProgramEvents/{eventId}");


    // Path Params
    long sizeOfPathParams_eventId = strlen(eventId)+3 + strlen("{ eventId }");
    if(eventId == NULL) {
        goto end;
    }
    char* localVarToReplace_eventId = malloc(sizeOfPathParams_eventId);
    sprintf(localVarToReplace_eventId, "{%s}", "eventId");

    localVarPath = strReplace(localVarPath, localVarToReplace_eventId, eventId);
    if(eventId == NULL) {
        goto end;
    }
    char* localVarToReplace_eventId = malloc(sizeOfPathParams_eventId);
    ...
    free(localVarPath);
    free(localVarToReplace_eventId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
TrainingProgramEventsAPI_getTrainingProgramEventByIdAsync(apiClient_t *apiClient, char *tenantId, char *eventId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *TrainingProgramEventsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    training_program_event_dto_envelope_t *elementToReturn = training_program_event_dto_envelope_parseFromJSON(TrainingProgramEventsAPIlocalVarJSON);
    cJSON_Delete(TrainingProgramEventsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TrainingProgramEventsAPI_getTrainingProgramEventsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, training_program_event_dto_collection_query_parameters_t *training_program_event_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_training_program_event_dto_collection_query_parameters = NULL;
    if (training_program_event_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_training_program_event_dto_collection_query_parameters = training_program_event_dto_collection_query_parameters_convertToJSON(training_program_event_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_training_program_event_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *TrainingProgramEventsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    training_program_event_dto_list_envelope_t *elementToReturn = training_program_event_dto_list_envelope_parseFromJSON(TrainingProgramEventsAPIlocalVarJSON);
    cJSON_Delete(TrainingProgramEventsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_training_program_event_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_training_program_event_dto_collection_query_parameters);
        localVarSingleItemJSON_training_program_event_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
TrainingProgramEventsAPI_getTrainingProgramEventsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, training_program_event_dto_collection_query_parameters_t *training_program_event_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/TrainingProgramEvents/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/TrainingProgramEvents/Count");
    ...
    //nonprimitive not container
    cJSON *TrainingProgramEventsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(TrainingProgramEventsAPIlocalVarJSON);
    cJSON_Delete(TrainingProgramEventsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TrainingProgramEventsAPI_updateTrainingProgramEventAsync(apiClient_t *apiClient, char *tenantId, char *eventId, char *api_version, char *x_api_version, training_program_event_update_dto_t *training_program_event_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_training_program_event_update_dto = NULL;
    if (training_program_event_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_training_program_event_update_dto = training_program_event_update_dto_convertToJSON(training_program_event_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_training_program_event_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_training_program_event_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_training_program_event_update_dto);
        localVarSingleItemJSON_training_program_event_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
