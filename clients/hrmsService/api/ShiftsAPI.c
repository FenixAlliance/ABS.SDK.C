...
ShiftsAPI_createShiftAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shift_create_dto_t *shift_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/Shifts")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/Shifts");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shift_create_dto = NULL;
    if (shift_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_shift_create_dto = shift_create_dto_convertToJSON(shift_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shift_create_dto);
    }
    ...
    cJSON *ShiftsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ShiftsAPIlocalVarJSON);
    cJSON_Delete(ShiftsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_shift_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_shift_create_dto);
        localVarSingleItemJSON_shift_create_dto = NULL;
    }
...
ShiftsAPI_deleteShiftAsync(apiClient_t *apiClient, char *tenantId, char *shiftId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/Shifts/{shiftId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/Shifts/{shiftId}");


    // Path Params
    long sizeOfPathParams_shiftId = strlen(shiftId)+3 + strlen("{ shiftId }");
    if(shiftId == NULL) {
        goto end;
    }
    char* localVarToReplace_shiftId = malloc(sizeOfPathParams_shiftId);
    sprintf(localVarToReplace_shiftId, "{%s}", "shiftId");

    localVarPath = strReplace(localVarPath, localVarToReplace_shiftId, shiftId);
    if(shiftId == NULL) {
        goto end;
    }
    char* localVarToReplace_shiftId = malloc(sizeOfPathParams_shiftId);
    ...
    free(localVarPath);
    free(localVarToReplace_shiftId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
ShiftsAPI_getShiftByIdAsync(apiClient_t *apiClient, char *tenantId, char *shiftId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ShiftsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    shift_dto_envelope_t *elementToReturn = shift_dto_envelope_parseFromJSON(ShiftsAPIlocalVarJSON);
    cJSON_Delete(ShiftsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ShiftsAPI_getShiftsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shift_dto_collection_query_parameters_t *shift_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shift_dto_collection_query_parameters = NULL;
    if (shift_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_shift_dto_collection_query_parameters = shift_dto_collection_query_parameters_convertToJSON(shift_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shift_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ShiftsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    shift_dto_list_envelope_t *elementToReturn = shift_dto_list_envelope_parseFromJSON(ShiftsAPIlocalVarJSON);
    cJSON_Delete(ShiftsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_shift_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_shift_dto_collection_query_parameters);
        localVarSingleItemJSON_shift_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ShiftsAPI_getShiftsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shift_dto_collection_query_parameters_t *shift_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/Shifts/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/Shifts/Count");
    ...
    //nonprimitive not container
    cJSON *ShiftsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ShiftsAPIlocalVarJSON);
    cJSON_Delete(ShiftsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ShiftsAPI_updateShiftAsync(apiClient_t *apiClient, char *tenantId, char *shiftId, char *api_version, char *x_api_version, shift_update_dto_t *shift_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shift_update_dto = NULL;
    if (shift_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_shift_update_dto = shift_update_dto_convertToJSON(shift_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shift_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_shift_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_shift_update_dto);
        localVarSingleItemJSON_shift_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
