...
JobApplicantsAPI_createJobApplicantAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, job_applicant_profile_create_dto_t *job_applicant_profile_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/JobApplicants")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/JobApplicants");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_job_applicant_profile_create_dto = NULL;
    if (job_applicant_profile_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_job_applicant_profile_create_dto = job_applicant_profile_create_dto_convertToJSON(job_applicant_profile_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_job_applicant_profile_create_dto);
    }
    ...
    cJSON *JobApplicantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(JobApplicantsAPIlocalVarJSON);
    cJSON_Delete(JobApplicantsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_job_applicant_profile_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_job_applicant_profile_create_dto);
        localVarSingleItemJSON_job_applicant_profile_create_dto = NULL;
    }
...
JobApplicantsAPI_deleteJobApplicantAsync(apiClient_t *apiClient, char *tenantId, char *jobApplicantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/JobApplicants/{jobApplicantId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/JobApplicants/{jobApplicantId}");


    // Path Params
    long sizeOfPathParams_jobApplicantId = strlen(jobApplicantId)+3 + strlen("{ jobApplicantId }");
    if(jobApplicantId == NULL) {
        goto end;
    }
    char* localVarToReplace_jobApplicantId = malloc(sizeOfPathParams_jobApplicantId);
    sprintf(localVarToReplace_jobApplicantId, "{%s}", "jobApplicantId");

    localVarPath = strReplace(localVarPath, localVarToReplace_jobApplicantId, jobApplicantId);
    if(jobApplicantId == NULL) {
        goto end;
    }
    char* localVarToReplace_jobApplicantId = malloc(sizeOfPathParams_jobApplicantId);
    ...
    free(localVarPath);
    free(localVarToReplace_jobApplicantId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
JobApplicantsAPI_getJobApplicantByIdAsync(apiClient_t *apiClient, char *tenantId, char *jobApplicantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *JobApplicantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    job_applicant_profile_dto_envelope_t *elementToReturn = job_applicant_profile_dto_envelope_parseFromJSON(JobApplicantsAPIlocalVarJSON);
    cJSON_Delete(JobApplicantsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
JobApplicantsAPI_getJobApplicantsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *JobApplicantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    job_applicant_profile_dto_list_envelope_t *elementToReturn = job_applicant_profile_dto_list_envelope_parseFromJSON(JobApplicantsAPIlocalVarJSON);
    cJSON_Delete(JobApplicantsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
JobApplicantsAPI_getJobApplicantsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/JobApplicants/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/JobApplicants/Count");
    ...
    //nonprimitive not container
    cJSON *JobApplicantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(JobApplicantsAPIlocalVarJSON);
    cJSON_Delete(JobApplicantsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
JobApplicantsAPI_updateJobApplicantAsync(apiClient_t *apiClient, char *tenantId, char *jobApplicantId, char *api_version, char *x_api_version, job_applicant_profile_update_dto_t *job_applicant_profile_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_job_applicant_profile_update_dto = NULL;
    if (job_applicant_profile_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_job_applicant_profile_update_dto = job_applicant_profile_update_dto_convertToJSON(job_applicant_profile_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_job_applicant_profile_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_job_applicant_profile_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_job_applicant_profile_update_dto);
        localVarSingleItemJSON_job_applicant_profile_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
