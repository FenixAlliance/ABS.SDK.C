...
JobApplicantsAPI_getJobApplicantsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, job_applicant_profile_dto_collection_query_parameters_t *job_applicant_profile_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_job_applicant_profile_dto_collection_query_parameters = NULL;
    if (job_applicant_profile_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_job_applicant_profile_dto_collection_query_parameters = job_applicant_profile_dto_collection_query_parameters_convertToJSON(job_applicant_profile_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_job_applicant_profile_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_job_applicant_profile_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_job_applicant_profile_dto_collection_query_parameters);
        localVarSingleItemJSON_job_applicant_profile_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
