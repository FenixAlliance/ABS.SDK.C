...
GigApplicationsAPI_getGigApplicationsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, gig_application_dto_collection_query_parameters_t *gig_application_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_gig_application_dto_collection_query_parameters = NULL;
    if (gig_application_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_gig_application_dto_collection_query_parameters = gig_application_dto_collection_query_parameters_convertToJSON(gig_application_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_gig_application_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_gig_application_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_gig_application_dto_collection_query_parameters);
        localVarSingleItemJSON_gig_application_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
