...
GigApplicationsAPI_acceptGigApplicationAsync(apiClient_t *apiClient, char *tenantId, char *gigApplicationId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/GigApplications/{gigApplicationId}/Accept")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/GigApplications/{gigApplicationId}/Accept");


    // Path Params
    long sizeOfPathParams_gigApplicationId = strlen(gigApplicationId)+3 + strlen("{ gigApplicationId }");
    if(gigApplicationId == NULL) {
        goto end;
    }
    char* localVarToReplace_gigApplicationId = malloc(sizeOfPathParams_gigApplicationId);
    sprintf(localVarToReplace_gigApplicationId, "{%s}", "gigApplicationId");

    localVarPath = strReplace(localVarPath, localVarToReplace_gigApplicationId, gigApplicationId);
    if(gigApplicationId == NULL) {
        goto end;
    }
    char* localVarToReplace_gigApplicationId = malloc(sizeOfPathParams_gigApplicationId);
    ...
    cJSON *GigApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(GigApplicationsAPIlocalVarJSON);
    cJSON_Delete(GigApplicationsAPIlocalVarJSON);
    ...
    free(localVarPath);
    free(localVarToReplace_gigApplicationId);
...
GigApplicationsAPI_createGigApplicationAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, gig_application_create_dto_t *gig_application_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/GigApplications")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/GigApplications");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_gig_application_create_dto = NULL;
    if (gig_application_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_gig_application_create_dto = gig_application_create_dto_convertToJSON(gig_application_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_gig_application_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_gig_application_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_gig_application_create_dto);
        localVarSingleItemJSON_gig_application_create_dto = NULL;
    }
...
GigApplicationsAPI_deleteGigApplicationAsync(apiClient_t *apiClient, char *tenantId, char *gigApplicationId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/GigApplications/{gigApplicationId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/GigApplications/{gigApplicationId}");
...
GigApplicationsAPI_getGigApplicationByIdAsync(apiClient_t *apiClient, char *tenantId, char *gigApplicationId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *GigApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    gig_application_dto_envelope_t *elementToReturn = gig_application_dto_envelope_parseFromJSON(GigApplicationsAPIlocalVarJSON);
    cJSON_Delete(GigApplicationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
GigApplicationsAPI_getGigApplicationsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *GigApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    gig_application_dto_list_envelope_t *elementToReturn = gig_application_dto_list_envelope_parseFromJSON(GigApplicationsAPIlocalVarJSON);
    cJSON_Delete(GigApplicationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
GigApplicationsAPI_getGigApplicationsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/GigApplications/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/GigApplications/Count");
    ...
    //nonprimitive not container
    cJSON *GigApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(GigApplicationsAPIlocalVarJSON);
    cJSON_Delete(GigApplicationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
GigApplicationsAPI_updateGigApplicationAsync(apiClient_t *apiClient, char *tenantId, char *gigApplicationId, char *api_version, char *x_api_version, gig_application_update_dto_t *gig_application_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_gig_application_update_dto = NULL;
    if (gig_application_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_gig_application_update_dto = gig_application_update_dto_convertToJSON(gig_application_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_gig_application_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_gig_application_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_gig_application_update_dto);
        localVarSingleItemJSON_gig_application_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
