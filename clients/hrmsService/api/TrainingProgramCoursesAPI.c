...
#include <stdio.h>
#include <ctype.h>
#include "TrainingProgramCoursesAPI.h"
...
TrainingProgramCoursesAPI_createTrainingProgramCourseAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, training_program_course_create_dto_t *training_program_course_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/TrainingProgramCourses")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/TrainingProgramCourses");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_training_program_course_create_dto = NULL;
    if (training_program_course_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_training_program_course_create_dto = training_program_course_create_dto_convertToJSON(training_program_course_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_training_program_course_create_dto);
    }
    ...
    cJSON *TrainingProgramCoursesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(TrainingProgramCoursesAPIlocalVarJSON);
    cJSON_Delete(TrainingProgramCoursesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_training_program_course_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_training_program_course_create_dto);
        localVarSingleItemJSON_training_program_course_create_dto = NULL;
    }
...
TrainingProgramCoursesAPI_deleteTrainingProgramCourseAsync(apiClient_t *apiClient, char *tenantId, char *courseId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/TrainingProgramCourses/{courseId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/TrainingProgramCourses/{courseId}");
...
TrainingProgramCoursesAPI_getTrainingProgramCourseByIdAsync(apiClient_t *apiClient, char *tenantId, char *courseId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *TrainingProgramCoursesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    training_program_course_dto_envelope_t *elementToReturn = training_program_course_dto_envelope_parseFromJSON(TrainingProgramCoursesAPIlocalVarJSON);
    cJSON_Delete(TrainingProgramCoursesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TrainingProgramCoursesAPI_getTrainingProgramCoursesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, training_program_course_dto_collection_query_parameters_t *training_program_course_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_training_program_course_dto_collection_query_parameters = NULL;
    if (training_program_course_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_training_program_course_dto_collection_query_parameters = training_program_course_dto_collection_query_parameters_convertToJSON(training_program_course_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_training_program_course_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *TrainingProgramCoursesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    training_program_course_dto_list_envelope_t *elementToReturn = training_program_course_dto_list_envelope_parseFromJSON(TrainingProgramCoursesAPIlocalVarJSON);
    cJSON_Delete(TrainingProgramCoursesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_training_program_course_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_training_program_course_dto_collection_query_parameters);
        localVarSingleItemJSON_training_program_course_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
TrainingProgramCoursesAPI_getTrainingProgramCoursesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, training_program_course_dto_collection_query_parameters_t *training_program_course_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/TrainingProgramCourses/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/TrainingProgramCourses/Count");
    ...
    //nonprimitive not container
    cJSON *TrainingProgramCoursesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(TrainingProgramCoursesAPIlocalVarJSON);
    cJSON_Delete(TrainingProgramCoursesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TrainingProgramCoursesAPI_updateTrainingProgramCourseAsync(apiClient_t *apiClient, char *tenantId, char *courseId, char *api_version, char *x_api_version, training_program_course_update_dto_t *training_program_course_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_training_program_course_update_dto = NULL;
    if (training_program_course_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_training_program_course_update_dto = training_program_course_update_dto_convertToJSON(training_program_course_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_training_program_course_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_training_program_course_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_training_program_course_update_dto);
        localVarSingleItemJSON_training_program_course_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
