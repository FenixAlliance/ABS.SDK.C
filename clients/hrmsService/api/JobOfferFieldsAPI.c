...
JobOfferFieldsAPI_createJobOfferFieldAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, job_offer_field_record_create_dto_t *job_offer_field_record_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/JobOfferFields")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/JobOfferFields");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_job_offer_field_record_create_dto = NULL;
    if (job_offer_field_record_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_job_offer_field_record_create_dto = job_offer_field_record_create_dto_convertToJSON(job_offer_field_record_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_job_offer_field_record_create_dto);
    }
    ...
    cJSON *JobOfferFieldsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(JobOfferFieldsAPIlocalVarJSON);
    cJSON_Delete(JobOfferFieldsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_job_offer_field_record_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_job_offer_field_record_create_dto);
        localVarSingleItemJSON_job_offer_field_record_create_dto = NULL;
    }
...
JobOfferFieldsAPI_deleteJobOfferFieldAsync(apiClient_t *apiClient, char *tenantId, char *jobOfferFieldId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/JobOfferFields/{jobOfferFieldId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/JobOfferFields/{jobOfferFieldId}");


    // Path Params
    long sizeOfPathParams_jobOfferFieldId = strlen(jobOfferFieldId)+3 + strlen("{ jobOfferFieldId }");
    if(jobOfferFieldId == NULL) {
        goto end;
    }
    char* localVarToReplace_jobOfferFieldId = malloc(sizeOfPathParams_jobOfferFieldId);
    sprintf(localVarToReplace_jobOfferFieldId, "{%s}", "jobOfferFieldId");

    localVarPath = strReplace(localVarPath, localVarToReplace_jobOfferFieldId, jobOfferFieldId);
    if(jobOfferFieldId == NULL) {
        goto end;
    }
    char* localVarToReplace_jobOfferFieldId = malloc(sizeOfPathParams_jobOfferFieldId);
    ...
    free(localVarPath);
    free(localVarToReplace_jobOfferFieldId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
JobOfferFieldsAPI_getJobOfferFieldByIdAsync(apiClient_t *apiClient, char *tenantId, char *jobOfferFieldId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *JobOfferFieldsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    job_offer_field_record_dto_envelope_t *elementToReturn = job_offer_field_record_dto_envelope_parseFromJSON(JobOfferFieldsAPIlocalVarJSON);
    cJSON_Delete(JobOfferFieldsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
JobOfferFieldsAPI_getJobOfferFieldsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, job_offer_field_record_dto_collection_query_parameters_t *job_offer_field_record_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_job_offer_field_record_dto_collection_query_parameters = NULL;
    if (job_offer_field_record_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_job_offer_field_record_dto_collection_query_parameters = job_offer_field_record_dto_collection_query_parameters_convertToJSON(job_offer_field_record_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_job_offer_field_record_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *JobOfferFieldsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    job_offer_field_record_dto_list_envelope_t *elementToReturn = job_offer_field_record_dto_list_envelope_parseFromJSON(JobOfferFieldsAPIlocalVarJSON);
    cJSON_Delete(JobOfferFieldsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_job_offer_field_record_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_job_offer_field_record_dto_collection_query_parameters);
        localVarSingleItemJSON_job_offer_field_record_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
JobOfferFieldsAPI_getJobOfferFieldsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, job_offer_field_record_dto_collection_query_parameters_t *job_offer_field_record_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/JobOfferFields/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/JobOfferFields/Count");
    ...
    //nonprimitive not container
    cJSON *JobOfferFieldsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(JobOfferFieldsAPIlocalVarJSON);
    cJSON_Delete(JobOfferFieldsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
JobOfferFieldsAPI_updateJobOfferFieldAsync(apiClient_t *apiClient, char *tenantId, char *jobOfferFieldId, char *api_version, char *x_api_version, job_offer_field_record_update_dto_t *job_offer_field_record_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_job_offer_field_record_update_dto = NULL;
    if (job_offer_field_record_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_job_offer_field_record_update_dto = job_offer_field_record_update_dto_convertToJSON(job_offer_field_record_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_job_offer_field_record_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_job_offer_field_record_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_job_offer_field_record_update_dto);
        localVarSingleItemJSON_job_offer_field_record_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
