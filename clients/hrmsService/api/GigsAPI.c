...
GigsAPI_createGigAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, gig_create_dto_t *gig_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/Gigs")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/Gigs");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_gig_create_dto = NULL;
    if (gig_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_gig_create_dto = gig_create_dto_convertToJSON(gig_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_gig_create_dto);
    }
    ...
    cJSON *GigsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(GigsAPIlocalVarJSON);
    cJSON_Delete(GigsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_gig_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_gig_create_dto);
        localVarSingleItemJSON_gig_create_dto = NULL;
    }
...
GigsAPI_deleteGigAsync(apiClient_t *apiClient, char *tenantId, char *gigId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/Gigs/{gigId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/Gigs/{gigId}");


    // Path Params
    long sizeOfPathParams_gigId = strlen(gigId)+3 + strlen("{ gigId }");
    if(gigId == NULL) {
        goto end;
    }
    char* localVarToReplace_gigId = malloc(sizeOfPathParams_gigId);
    sprintf(localVarToReplace_gigId, "{%s}", "gigId");

    localVarPath = strReplace(localVarPath, localVarToReplace_gigId, gigId);
    if(gigId == NULL) {
        goto end;
    }
    char* localVarToReplace_gigId = malloc(sizeOfPathParams_gigId);
...
GigsAPI_getGigByIdAsync(apiClient_t *apiClient, char *tenantId, char *gigId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *GigsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    gig_dto_envelope_t *elementToReturn = gig_dto_envelope_parseFromJSON(GigsAPIlocalVarJSON);
    cJSON_Delete(GigsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
GigsAPI_getGigsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, gig_dto_collection_query_parameters_t *gig_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_gig_dto_collection_query_parameters = NULL;
    if (gig_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_gig_dto_collection_query_parameters = gig_dto_collection_query_parameters_convertToJSON(gig_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_gig_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *GigsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    gig_dto_list_envelope_t *elementToReturn = gig_dto_list_envelope_parseFromJSON(GigsAPIlocalVarJSON);
    cJSON_Delete(GigsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_gig_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_gig_dto_collection_query_parameters);
        localVarSingleItemJSON_gig_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
GigsAPI_getGigsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, gig_dto_collection_query_parameters_t *gig_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/Gigs/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/Gigs/Count");
    ...
    //nonprimitive not container
    cJSON *GigsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(GigsAPIlocalVarJSON);
    cJSON_Delete(GigsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
GigsAPI_updateGigAsync(apiClient_t *apiClient, char *tenantId, char *gigId, char *api_version, char *x_api_version, gig_update_dto_t *gig_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_gig_update_dto = NULL;
    if (gig_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_gig_update_dto = gig_update_dto_convertToJSON(gig_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_gig_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_gig_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_gig_update_dto);
        localVarSingleItemJSON_gig_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
