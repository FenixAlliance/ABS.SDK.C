...
JobOffersAPI_createJobOfferAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, job_offer_create_dto_t *job_offer_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/JobOffers")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/JobOffers");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_job_offer_create_dto = NULL;
    if (job_offer_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_job_offer_create_dto = job_offer_create_dto_convertToJSON(job_offer_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_job_offer_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_job_offer_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_job_offer_create_dto);
        localVarSingleItemJSON_job_offer_create_dto = NULL;
    }
...
JobOffersAPI_deleteJobOfferAsync(apiClient_t *apiClient, char *tenantId, char *jobOfferId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/JobOffers/{jobOfferId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/JobOffers/{jobOfferId}");
...
JobOffersAPI_getJobOffersAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, job_offer_dto_collection_query_parameters_t *job_offer_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_job_offer_dto_collection_query_parameters = NULL;
    if (job_offer_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_job_offer_dto_collection_query_parameters = job_offer_dto_collection_query_parameters_convertToJSON(job_offer_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_job_offer_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_job_offer_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_job_offer_dto_collection_query_parameters);
        localVarSingleItemJSON_job_offer_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
JobOffersAPI_getJobOffersCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, job_offer_dto_collection_query_parameters_t *job_offer_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/HrmsService/JobOffers/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/HrmsService/JobOffers/Count");
...
JobOffersAPI_updateJobOfferAsync(apiClient_t *apiClient, char *tenantId, char *jobOfferId, char *api_version, char *x_api_version, job_offer_update_dto_t *job_offer_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_job_offer_update_dto = NULL;
    if (job_offer_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_job_offer_update_dto = job_offer_update_dto_convertToJSON(job_offer_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_job_offer_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_job_offer_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_job_offer_update_dto);
        localVarSingleItemJSON_job_offer_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
