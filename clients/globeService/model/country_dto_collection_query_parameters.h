/*
 * country_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _country_dto_collection_query_parameters_H_
#define _country_dto_collection_query_parameters_H_
...
typedef struct country_dto_collection_query_parameters_t country_dto_collection_query_parameters_t;




typedef struct country_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} country_dto_collection_query_parameters_t;
...
#endif /* _country_dto_collection_query_parameters_H_ */
