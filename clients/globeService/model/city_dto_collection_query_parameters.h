/*
 * city_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _city_dto_collection_query_parameters_H_
#define _city_dto_collection_query_parameters_H_
...
typedef struct city_dto_collection_query_parameters_t city_dto_collection_query_parameters_t;




typedef struct city_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} city_dto_collection_query_parameters_t;
...
#endif /* _city_dto_collection_query_parameters_H_ */
