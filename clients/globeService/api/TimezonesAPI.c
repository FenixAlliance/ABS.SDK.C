...
TimezonesAPI_countTimezonesAsync(apiClient_t *apiClient, char *api_version, char *x_api_version, timezone_dto_collection_query_parameters_t *timezone_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/GlobeService/Timezones/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/GlobeService/Timezones/Count");
    ...
    cJSON *TimezonesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(TimezonesAPIlocalVarJSON);
    cJSON_Delete(TimezonesAPIlocalVarJSON);
...
TimezonesAPI_getTimeZoneByIdAsync(apiClient_t *apiClient, char *timeZoneId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/GlobeService/Timezones/{timeZoneId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/GlobeService/Timezones/{timeZoneId}");


    // Path Params
    long sizeOfPathParams_timeZoneId = strlen(timeZoneId)+3 + strlen("{ timeZoneId }");
    if(timeZoneId == NULL) {
        goto end;
    }
    char* localVarToReplace_timeZoneId = malloc(sizeOfPathParams_timeZoneId);
    sprintf(localVarToReplace_timeZoneId, "{%s}", "timeZoneId");

    localVarPath = strReplace(localVarPath, localVarToReplace_timeZoneId, timeZoneId);
    ...
    //nonprimitive not container
    cJSON *TimezonesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    timezone_dto_envelope_t *elementToReturn = timezone_dto_envelope_parseFromJSON(TimezonesAPIlocalVarJSON);
    cJSON_Delete(TimezonesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(localVarPath);
    free(localVarToReplace_timeZoneId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
TimezonesAPI_getTimeZonesAsync(apiClient_t *apiClient, char *api_version, char *x_api_version, timezone_dto_collection_query_parameters_t *timezone_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/GlobeService/Timezones")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/GlobeService/Timezones");
    ...
    //nonprimitive not container
    cJSON *TimezonesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    timezone_dto_list_envelope_t *elementToReturn = timezone_dto_list_envelope_parseFromJSON(TimezonesAPIlocalVarJSON);
    cJSON_Delete(TimezonesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
