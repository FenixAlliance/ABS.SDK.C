...
MigrationsAPI_apiV2GlobalSystemMigratePost(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/Global/System/Migrate")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/Global/System/Migrate");
    ...
    cJSON *MigrationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    payment_response_t *elementToReturn = payment_response_parseFromJSON(MigrationsAPIlocalVarJSON);
    cJSON_Delete(MigrationsAPIlocalVarJSON);
