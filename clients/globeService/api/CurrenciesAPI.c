...
//
int32_envelope_t*
CurrenciesAPI_countCurrenciesAsync(apiClient_t *apiClient, char *api_version, char *x_api_version, currency_dto_collection_query_parameters_t *currency_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/GlobeService/Currencies/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/GlobeService/Currencies/Count");
    ...
    cJSON *CurrenciesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(CurrenciesAPIlocalVarJSON);
    cJSON_Delete(CurrenciesAPIlocalVarJSON);
...
CurrenciesAPI_getCurrencyByIdAsync(apiClient_t *apiClient, char *currencyId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/GlobeService/Currencies/{currencyId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/GlobeService/Currencies/{currencyId}");


    // Path Params
    long sizeOfPathParams_currencyId = strlen(currencyId)+3 + strlen("{ currencyId }");
    if(currencyId == NULL) {
        goto end;
    }
    char* localVarToReplace_currencyId = malloc(sizeOfPathParams_currencyId);
    sprintf(localVarToReplace_currencyId, "{%s}", "currencyId");

    localVarPath = strReplace(localVarPath, localVarToReplace_currencyId, currencyId);
    ...
    //nonprimitive not container
    cJSON *CurrenciesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    currency_dto_envelope_t *elementToReturn = currency_dto_envelope_parseFromJSON(CurrenciesAPIlocalVarJSON);
    cJSON_Delete(CurrenciesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(localVarPath);
    free(localVarToReplace_currencyId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
CurrenciesAPI_getEnabledCurrenciesAsync(apiClient_t *apiClient, char *api_version, char *x_api_version, currency_dto_collection_query_parameters_t *currency_dto_collection_query_parameters)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = list_createList();
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/GlobeService/Currencies")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/GlobeService/Currencies");
    ...
    //nonprimitive not container
    cJSON *CurrenciesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    currency_dto_list_envelope_t *elementToReturn = currency_dto_list_envelope_parseFromJSON(CurrenciesAPIlocalVarJSON);
    cJSON_Delete(CurrenciesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
