...
LanguagesAPI_countLanguagesAsync(apiClient_t *apiClient, char *api_version, char *x_api_version, country_language_dto_collection_query_parameters_t *country_language_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/GlobeService/Languages/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/GlobeService/Languages/Count");
    ...
    cJSON *LanguagesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(LanguagesAPIlocalVarJSON);
    cJSON_Delete(LanguagesAPIlocalVarJSON);
...
LanguagesAPI_getLanguageByIdAsync(apiClient_t *apiClient, char *languageId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/GlobeService/Languages/{languageId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/GlobeService/Languages/{languageId}");


    // Path Params
    long sizeOfPathParams_languageId = strlen(languageId)+3 + strlen("{ languageId }");
    if(languageId == NULL) {
        goto end;
    }
    char* localVarToReplace_languageId = malloc(sizeOfPathParams_languageId);
    sprintf(localVarToReplace_languageId, "{%s}", "languageId");

    localVarPath = strReplace(localVarPath, localVarToReplace_languageId, languageId);
    ...
    //nonprimitive not container
    cJSON *LanguagesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    country_language_dto_envelope_t *elementToReturn = country_language_dto_envelope_parseFromJSON(LanguagesAPIlocalVarJSON);
    cJSON_Delete(LanguagesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(localVarPath);
    free(localVarToReplace_languageId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
LanguagesAPI_getLanguagesAsync(apiClient_t *apiClient, char *api_version, char *x_api_version, country_language_dto_collection_query_parameters_t *country_language_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/GlobeService/Languages")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/GlobeService/Languages");
    ...
    //nonprimitive not container
    cJSON *LanguagesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    country_language_dto_list_envelope_t *elementToReturn = country_language_dto_list_envelope_parseFromJSON(LanguagesAPIlocalVarJSON);
    cJSON_Delete(LanguagesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
