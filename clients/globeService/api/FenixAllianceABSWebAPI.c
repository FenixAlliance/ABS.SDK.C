...
#include <stdio.h>
#include <ctype.h>
#include "FenixAllianceABSWebAPI.h"
...
FenixAllianceABSWebAPI_loginPost(apiClient_t *apiClient, login_request_t *login_request, int *useCookies, int *useSessionCookies)
{
    ...
    cJSON *FenixAllianceABSWebAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    access_token_response_t *elementToReturn = access_token_response_parseFromJSON(FenixAllianceABSWebAPIlocalVarJSON);
    cJSON_Delete(FenixAllianceABSWebAPIlocalVarJSON);
...
FenixAllianceABSWebAPI_manage2faPost(apiClient_t *apiClient, two_factor_request_t *two_factor_request)
{
    ...
    //nonprimitive not container
    cJSON *FenixAllianceABSWebAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    two_factor_response_t *elementToReturn = two_factor_response_parseFromJSON(FenixAllianceABSWebAPIlocalVarJSON);
    cJSON_Delete(FenixAllianceABSWebAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FenixAllianceABSWebAPI_manageInfoGet(apiClient_t *apiClient)
{
    ...
    //nonprimitive not container
    cJSON *FenixAllianceABSWebAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    info_response_t *elementToReturn = info_response_parseFromJSON(FenixAllianceABSWebAPIlocalVarJSON);
    cJSON_Delete(FenixAllianceABSWebAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
