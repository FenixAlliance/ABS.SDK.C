...
#include <string.h>
#include <stdio.h>
#include "bill_of_lading_line_dto_envelope.h"
...
bill_of_lading_line_dto_envelope_t *bill_of_lading_line_dto_envelope_create(
    ...
    bill_of_lading_line_dto_envelope_t *bill_of_lading_line_dto_envelope_local_var = malloc(sizeof(bill_of_lading_line_dto_envelope_t));
    if (!bill_of_lading_line_dto_envelope_local_var) {
        return NULL;
    }
    bill_of_lading_line_dto_envelope_local_var->is_success = is_success;
...
void bill_of_lading_line_dto_envelope_free(bill_of_lading_line_dto_envelope_t *bill_of_lading_line_dto_envelope) {
    if(NULL == bill_of_lading_line_dto_envelope){
        return ;
    }
    listEntry_t *listEntry;
    if (bill_of_lading_line_dto_envelope->error_message) {
        free(bill_of_lading_line_dto_envelope->error_message);
        bill_of_lading_line_dto_envelope->error_message = NULL;
    }
    if (bill_of_lading_line_dto_envelope->correlation_id) {
        free(bill_of_lading_line_dto_envelope->correlation_id);
        bill_of_lading_line_dto_envelope->correlation_id = NULL;
    }
    ...
    if (bill_of_lading_line_dto_envelope->activity_id) {
        ...
        bill_of_lading_line_dto_envelope->activity_id = NULL;
    }
    if (bill_of_lading_line_dto_envelope->result) {
        bill_of_lading_line_dto_free(bill_of_lading_line_dto_envelope->result);
        bill_of_lading_line_dto_envelope->result = NULL;
    }
    free(bill_of_lading_line_dto_envelope);
}
...
cJSON *bill_of_lading_line_dto_envelope_convertToJSON(bill_of_lading_line_dto_envelope_t *bill_of_lading_line_dto_envelope) {
    ...
    // bill_of_lading_line_dto_envelope->is_success
    if(bill_of_lading_line_dto_envelope->is_success) {
    if(cJSON_AddBoolToObject(item, "isSuccess", bill_of_lading_line_dto_envelope->is_success) == NULL) {
    goto fail; //Bool
    }
    }


    // bill_of_lading_line_dto_envelope->error_message
    if(bill_of_lading_line_dto_envelope->error_message) {
    if(cJSON_AddStringToObject(item, "errorMessage", bill_of_lading_line_dto_envelope->error_message) == NULL) {
    goto fail; //String
    }
    }


    // bill_of_lading_line_dto_envelope->correlation_id
    if(bill_of_lading_line_dto_envelope->correlation_id) {
    if(cJSON_AddStringToObject(item, "correlationId", bill_of_lading_line_dto_envelope->correlation_id) == NULL) {
    goto fail; //String
    }
    }


    // bill_of_lading_line_dto_envelope->timestamp
    if(bill_of_lading_line_dto_envelope->timestamp) {
    if(cJSON_AddStringToObject(item, "timestamp", bill_of_lading_line_dto_envelope->timestamp) == NULL) {
    goto fail; //Date-Time
    }
    }
    ...
    // bill_of_lading_line_dto_envelope->result
    if(bill_of_lading_line_dto_envelope->result) {
    cJSON *result_local_JSON = bill_of_lading_line_dto_convertToJSON(bill_of_lading_line_dto_envelope->result);
...
bill_of_lading_line_dto_envelope_t *bill_of_lading_line_dto_envelope_parseFromJSON(cJSON *bill_of_lading_line_dto_envelopeJSON){
    ...
    // bill_of_lading_line_dto_envelope->is_success
    cJSON *is_success = cJSON_GetObjectItemCaseSensitive(bill_of_lading_line_dto_envelopeJSON, "isSuccess");
    if (is_success) { 
    ...
    // bill_of_lading_line_dto_envelope->error_message
    cJSON *error_message = cJSON_GetObjectItemCaseSensitive(bill_of_lading_line_dto_envelopeJSON, "errorMessage");
    if (error_message) { 
    ...
    // bill_of_lading_line_dto_envelope->correlation_id
    cJSON *correlation_id = cJSON_GetObjectItemCaseSensitive(bill_of_lading_line_dto_envelopeJSON, "correlationId");
    if (correlation_id) { 
    ...
    // bill_of_lading_line_dto_envelope->timestamp
    cJSON *timestamp = cJSON_GetObjectItemCaseSensitive(bill_of_lading_line_dto_envelopeJSON, "timestamp");
    if (timestamp) { 
    ...
    // bill_of_lading_line_dto_envelope->result
    cJSON *result = cJSON_GetObjectItemCaseSensitive(bill_of_lading_line_dto_envelopeJSON, "result");
    if (result) { 
    result_local_nonprim = bill_of_lading_line_dto_parseFromJSON(result); //nonprimitive
    }


    bill_of_lading_line_dto_envelope_local_var = bill_of_lading_line_dto_envelope_create (
