/*
 * shipping_courier_dto.h
 *
 * 
 */

#ifndef _shipping_courier_dto_H_
#define _shipping_courier_dto_H_
...
typedef struct shipping_courier_dto_t shipping_courier_dto_t;




typedef struct shipping_courier_dto_t {
    char *id; // string
...
#endif /* _shipping_courier_dto_H_ */
