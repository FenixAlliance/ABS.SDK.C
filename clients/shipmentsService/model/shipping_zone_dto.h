...
#ifndef _shipping_zone_dto_H_
#define _shipping_zone_dto_H_
...
typedef struct shipping_zone_dto_t shipping_zone_dto_t;




typedef struct shipping_zone_dto_t {
    char *id; // string
