/*
 * bill_of_lading_dto_envelope.h
 *
 * 
 */

#ifndef _bill_of_lading_dto_envelope_H_
#define _bill_of_lading_dto_envelope_H_
...
typedef struct bill_of_lading_dto_envelope_t bill_of_lading_dto_envelope_t;

#include "bill_of_lading_dto.h"



typedef struct bill_of_lading_dto_envelope_t {
    int is_success; //boolean
    char *error_message; // string
    char *correlation_id; // string
    char *timestamp; //date time
    char *activity_id; // string
    struct bill_of_lading_dto_t *result; //model
...
#endif /* _bill_of_lading_dto_envelope_H_ */
