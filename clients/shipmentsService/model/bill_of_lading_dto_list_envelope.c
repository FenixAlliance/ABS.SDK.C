...
bill_of_lading_dto_list_envelope_t *bill_of_lading_dto_list_envelope_create(
    ...
    bill_of_lading_dto_list_envelope_local_var->http_status = http_status;
    bill_of_lading_dto_list_envelope_local_var->error_code = error_code;
    bill_of_lading_dto_list_envelope_local_var->validation_details = validation_details;
...
void bill_of_lading_dto_list_envelope_free(bill_of_lading_dto_list_envelope_t *bill_of_lading_dto_list_envelope) {
    ...
    if (bill_of_lading_dto_list_envelope->error_code) {
        free(bill_of_lading_dto_list_envelope->error_code);
        bill_of_lading_dto_list_envelope->error_code = NULL;
    }
    if (bill_of_lading_dto_list_envelope->validation_details) {
        list_ForEach(listEntry, bill_of_lading_dto_list_envelope->validation_details) {
            keyValuePair_t *localKeyValue = (keyValuePair_t*) listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_freeList(bill_of_lading_dto_list_envelope->validation_details);
        bill_of_lading_dto_list_envelope->validation_details = NULL;
    }
...
cJSON *bill_of_lading_dto_list_envelope_convertToJSON(bill_of_lading_dto_list_envelope_t *bill_of_lading_dto_list_envelope) {
    ...
    // bill_of_lading_dto_list_envelope->http_status
    if(bill_of_lading_dto_list_envelope->http_status) {
    if(cJSON_AddNumberToObject(item, "httpStatus", bill_of_lading_dto_list_envelope->http_status) == NULL) {
    goto fail; //Numeric
    }
    }


    // bill_of_lading_dto_list_envelope->error_code
    if(bill_of_lading_dto_list_envelope->error_code) {
    if(cJSON_AddStringToObject(item, "errorCode", bill_of_lading_dto_list_envelope->error_code) == NULL) {
    goto fail; //String
    }
    }


    // bill_of_lading_dto_list_envelope->validation_details
    if(bill_of_lading_dto_list_envelope->validation_details) {
    ...
    if (bill_of_lading_dto_list_envelope->validation_details) {
    list_ForEach(validation_detailsListEntry, bill_of_lading_dto_list_envelope->validation_details) {
...
bill_of_lading_dto_list_envelope_t *bill_of_lading_dto_list_envelope_parseFromJSON(cJSON *bill_of_lading_dto_list_envelopeJSON){
    ...
    // define the local map for bill_of_lading_dto_list_envelope->validation_details
    ...
    // bill_of_lading_dto_list_envelope->http_status
    cJSON *http_status = cJSON_GetObjectItemCaseSensitive(bill_of_lading_dto_list_envelopeJSON, "httpStatus");
    if (http_status) { 
    ...
    // bill_of_lading_dto_list_envelope->error_code
    cJSON *error_code = cJSON_GetObjectItemCaseSensitive(bill_of_lading_dto_list_envelopeJSON, "errorCode");
    if (error_code) { 
    ...
    // bill_of_lading_dto_list_envelope->validation_details
    cJSON *validation_details = cJSON_GetObjectItemCaseSensitive(bill_of_lading_dto_list_envelopeJSON, "validationDetails");
