/*
 * shipping_method_dto.h
 *
 * 
 */

#ifndef _shipping_method_dto_H_
#define _shipping_method_dto_H_
...
typedef struct shipping_method_dto_t shipping_method_dto_t;


// Enum SHIPPINGCLASSCALCULATIONTYPE for shipping_method_dto

typedef enum  { shipmentsservice_shipping_method_dto_SHIPPINGCLASSCALCULATIONTYPE_NULL = 0, shipmentsservice_shipping_method_dto_SHIPPINGCLASSCALCULATIONTYPE_PerClass, shipmentsservice_shipping_method_dto_SHIPPINGCLASSCALCULATIONTYPE_PerOrder } shipmentsservice_shipping_method_dto_SHIPPINGCLASSCALCULATIONTYPE_e;
...
typedef struct shipping_method_dto_t {
    char *id; // string
