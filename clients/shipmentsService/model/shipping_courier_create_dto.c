...
shipping_courier_create_dto_t *shipping_courier_create_dto_create(
    ...
    shipping_courier_create_dto_local_var->business_profile_record_id = business_profile_record_id;
...
void shipping_courier_create_dto_free(shipping_courier_create_dto_t *shipping_courier_create_dto) {
    ...
    if (shipping_courier_create_dto->business_profile_record_id) {
        free(shipping_courier_create_dto->business_profile_record_id);
        shipping_courier_create_dto->business_profile_record_id = NULL;
    }
...
cJSON *shipping_courier_create_dto_convertToJSON(shipping_courier_create_dto_t *shipping_courier_create_dto) {
    ...
    // shipping_courier_create_dto->business_profile_record_id
    if(shipping_courier_create_dto->business_profile_record_id) {
    if(cJSON_AddStringToObject(item, "businessProfileRecordID", shipping_courier_create_dto->business_profile_record_id) == NULL) {
    goto fail; //String
    }
    }
...
shipping_courier_create_dto_t *shipping_courier_create_dto_parseFromJSON(cJSON *shipping_courier_create_dtoJSON){
    ...
    // shipping_courier_create_dto->business_profile_record_id
    cJSON *business_profile_record_id = cJSON_GetObjectItemCaseSensitive(shipping_courier_create_dtoJSON, "businessProfileRecordID");
