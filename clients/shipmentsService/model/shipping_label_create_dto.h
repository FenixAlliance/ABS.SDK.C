/*
 * shipping_label_create_dto.h
 *
 * 
 */

#ifndef _shipping_label_create_dto_H_
#define _shipping_label_create_dto_H_
...
typedef struct shipping_label_create_dto_t shipping_label_create_dto_t;




typedef struct shipping_label_create_dto_t {
    char *id; // string
...
#endif /* _shipping_label_create_dto_H_ */
