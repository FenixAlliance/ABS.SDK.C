/*
 * shipping_method_dto_envelope.h
 *
 * 
 */

#ifndef _shipping_method_dto_envelope_H_
#define _shipping_method_dto_envelope_H_
...
typedef struct shipping_method_dto_envelope_t shipping_method_dto_envelope_t;

#include "shipping_method_dto.h"



typedef struct shipping_method_dto_envelope_t {
    ...
    struct shipping_method_dto_t *result; //model
...
#endif /* _shipping_method_dto_envelope_H_ */
