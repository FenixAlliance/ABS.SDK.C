...
*ShipmentsAPI* | [**ShipmentsAPI_getShipmentsAsync**](docs/ShipmentsAPI.md#ShipmentsAPI_getShipmentsAsync) | **GET** /api/v2/ShipmentsService/Shipments | Retrieve a list of shipments
