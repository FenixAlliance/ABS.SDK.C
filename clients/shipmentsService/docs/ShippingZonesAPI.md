...
//
shipping_zone_dto_list_envelope_t* ShippingZonesAPI_getShippingZonesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipping_zone_dto_collection_query_parameters_t *shipping_zone_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**shipping_zone_dto_collection_query_parameters** | **[shipping_zone_dto_collection_query_parameters_t](shipping_zone_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* ShippingZonesAPI_getShippingZonesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipping_zone_dto_collection_query_parameters_t *shipping_zone_dto_collection_query_parameters);
```
...
//
empty_envelope_t* ShippingZonesAPI_patchShippingZoneAsync(apiClient_t *apiClient, char *tenantId, char *zoneId, char *api_version, char *x_api_version, list_t *patch_operation);
```
