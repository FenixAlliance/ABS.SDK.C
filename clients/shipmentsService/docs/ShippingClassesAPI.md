...
[**ShippingClassesAPI_patchShippingClassAsync**](ShippingClassesAPI.md#ShippingClassesAPI_patchShippingClassAsync) | **PATCH** /api/v2/ShipmentsService/ShippingClasses/{classId} | Patch a shipping class
...
//
shipping_class_dto_list_envelope_t* ShippingClassesAPI_getShippingClassesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipping_class_dto_collection_query_parameters_t *shipping_class_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**shipping_class_dto_collection_query_parameters** | **[shipping_class_dto_collection_query_parameters_t](shipping_class_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* ShippingClassesAPI_getShippingClassesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipping_class_dto_collection_query_parameters_t *shipping_class_dto_collection_query_parameters);
```
...
# **ShippingClassesAPI_patchShippingClassAsync**
```c
// Patch a shipping class
//
// Partially updates an existing shipping class using JSON Patch.
//
empty_envelope_t* ShippingClassesAPI_patchShippingClassAsync(apiClient_t *apiClient, char *tenantId, char *classId, char *api_version, char *x_api_version, list_t *patch_operation);
```
