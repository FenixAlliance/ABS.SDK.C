...
BillsOfLadingAPI_createBillOfLadingAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, bill_of_lading_create_dto_t *bill_of_lading_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/BillsOfLading")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/BillsOfLading");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_bill_of_lading_create_dto = NULL;
    if (bill_of_lading_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_bill_of_lading_create_dto = bill_of_lading_create_dto_convertToJSON(bill_of_lading_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_bill_of_lading_create_dto);
    }
    ...
    cJSON *BillsOfLadingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(BillsOfLadingAPIlocalVarJSON);
    cJSON_Delete(BillsOfLadingAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_bill_of_lading_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_bill_of_lading_create_dto);
        localVarSingleItemJSON_bill_of_lading_create_dto = NULL;
    }
...
BillsOfLadingAPI_createBillOfLadingLineAsync(apiClient_t *apiClient, char *tenantId, char *billOfLadingId, char *api_version, char *x_api_version, bill_of_lading_line_create_dto_t *bill_of_lading_line_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/BillsOfLading/{billOfLadingId}/Lines")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/BillsOfLading/{billOfLadingId}/Lines");


    // Path Params
    long sizeOfPathParams_billOfLadingId = strlen(billOfLadingId)+3 + strlen("{ billOfLadingId }");
    if(billOfLadingId == NULL) {
        goto end;
    }
    char* localVarToReplace_billOfLadingId = malloc(sizeOfPathParams_billOfLadingId);
    sprintf(localVarToReplace_billOfLadingId, "{%s}", "billOfLadingId");

    localVarPath = strReplace(localVarPath, localVarToReplace_billOfLadingId, billOfLadingId);
    if(billOfLadingId == NULL) {
        goto end;
    }
    char* localVarToReplace_billOfLadingId = malloc(sizeOfPathParams_billOfLadingId);
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_bill_of_lading_line_create_dto = NULL;
    if (bill_of_lading_line_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_bill_of_lading_line_create_dto = bill_of_lading_line_create_dto_convertToJSON(bill_of_lading_line_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_bill_of_lading_line_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    list_freeList(localVarContentType);
    free(localVarPath);
    free(localVarToReplace_billOfLadingId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_bill_of_lading_line_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_bill_of_lading_line_create_dto);
        localVarSingleItemJSON_bill_of_lading_line_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
BillsOfLadingAPI_deleteBillOfLadingAsync(apiClient_t *apiClient, char *tenantId, char *billOfLadingId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/BillsOfLading/{billOfLadingId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/BillsOfLading/{billOfLadingId}");
...
BillsOfLadingAPI_deleteBillOfLadingLineAsync(apiClient_t *apiClient, char *tenantId, char *billOfLadingId, char *lineId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/BillsOfLading/{billOfLadingId}/Lines/{lineId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/BillsOfLading/{billOfLadingId}/Lines/{lineId}");


    // Path Params
    long sizeOfPathParams_billOfLadingId = strlen(billOfLadingId)+3 + strlen(lineId)+3 + strlen("{ billOfLadingId }");
    if(billOfLadingId == NULL) {
        goto end;
    }
    char* localVarToReplace_billOfLadingId = malloc(sizeOfPathParams_billOfLadingId);
    ...
    // Path Params
    long sizeOfPathParams_lineId = strlen(billOfLadingId)+3 + strlen(lineId)+3 + strlen("{ lineId }");
    if(lineId == NULL) {
        goto end;
    }
...
BillsOfLadingAPI_getBillOfLadingByIdAsync(apiClient_t *apiClient, char *tenantId, char *billOfLadingId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *BillsOfLadingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    bill_of_lading_dto_envelope_t *elementToReturn = bill_of_lading_dto_envelope_parseFromJSON(BillsOfLadingAPIlocalVarJSON);
    cJSON_Delete(BillsOfLadingAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BillsOfLadingAPI_getBillOfLadingLineByIdAsync(apiClient_t *apiClient, char *tenantId, char *billOfLadingId, char *lineId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *BillsOfLadingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    bill_of_lading_line_dto_envelope_t *elementToReturn = bill_of_lading_line_dto_envelope_parseFromJSON(BillsOfLadingAPIlocalVarJSON);
    cJSON_Delete(BillsOfLadingAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BillsOfLadingAPI_getBillOfLadingLinesAsync(apiClient_t *apiClient, char *tenantId, char *billOfLadingId, char *api_version, char *x_api_version, bill_of_lading_line_dto_collection_query_parameters_t *bill_of_lading_line_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_bill_of_lading_line_dto_collection_query_parameters = NULL;
    if (bill_of_lading_line_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_bill_of_lading_line_dto_collection_query_parameters = bill_of_lading_line_dto_collection_query_parameters_convertToJSON(bill_of_lading_line_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_bill_of_lading_line_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *BillsOfLadingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    bill_of_lading_line_dto_list_envelope_t *elementToReturn = bill_of_lading_line_dto_list_envelope_parseFromJSON(BillsOfLadingAPIlocalVarJSON);
    cJSON_Delete(BillsOfLadingAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_bill_of_lading_line_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_bill_of_lading_line_dto_collection_query_parameters);
        localVarSingleItemJSON_bill_of_lading_line_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
BillsOfLadingAPI_getBillOfLadingLinesCountAsync(apiClient_t *apiClient, char *tenantId, char *billOfLadingId, char *api_version, char *x_api_version, bill_of_lading_line_dto_collection_query_parameters_t *bill_of_lading_line_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/BillsOfLading/{billOfLadingId}/Lines/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/BillsOfLading/{billOfLadingId}/Lines/Count");
    ...
    //nonprimitive not container
    cJSON *BillsOfLadingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(BillsOfLadingAPIlocalVarJSON);
    cJSON_Delete(BillsOfLadingAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BillsOfLadingAPI_getBillsOfLadingAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, bill_of_lading_dto_collection_query_parameters_t *bill_of_lading_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_bill_of_lading_dto_collection_query_parameters = NULL;
    if (bill_of_lading_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_bill_of_lading_dto_collection_query_parameters = bill_of_lading_dto_collection_query_parameters_convertToJSON(bill_of_lading_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_bill_of_lading_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *BillsOfLadingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    bill_of_lading_dto_list_envelope_t *elementToReturn = bill_of_lading_dto_list_envelope_parseFromJSON(BillsOfLadingAPIlocalVarJSON);
    cJSON_Delete(BillsOfLadingAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_bill_of_lading_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_bill_of_lading_dto_collection_query_parameters);
        localVarSingleItemJSON_bill_of_lading_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
BillsOfLadingAPI_getBillsOfLadingCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, bill_of_lading_dto_collection_query_parameters_t *bill_of_lading_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/BillsOfLading/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/BillsOfLading/Count");
...
BillsOfLadingAPI_updateBillOfLadingAsync(apiClient_t *apiClient, char *tenantId, char *billOfLadingId, char *api_version, char *x_api_version, bill_of_lading_update_dto_t *bill_of_lading_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_bill_of_lading_update_dto = NULL;
    if (bill_of_lading_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_bill_of_lading_update_dto = bill_of_lading_update_dto_convertToJSON(bill_of_lading_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_bill_of_lading_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_bill_of_lading_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_bill_of_lading_update_dto);
        localVarSingleItemJSON_bill_of_lading_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
BillsOfLadingAPI_updateBillOfLadingLineAsync(apiClient_t *apiClient, char *tenantId, char *billOfLadingId, char *lineId, char *api_version, char *x_api_version, bill_of_lading_line_update_dto_t *bill_of_lading_line_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_bill_of_lading_line_update_dto = NULL;
    if (bill_of_lading_line_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_bill_of_lading_line_update_dto = bill_of_lading_line_update_dto_convertToJSON(bill_of_lading_line_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_bill_of_lading_line_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_bill_of_lading_line_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_bill_of_lading_line_update_dto);
        localVarSingleItemJSON_bill_of_lading_line_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
