...
ShippingCouriersAPI_createShippingCourierAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipping_courier_create_dto_t *shipping_courier_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ShippingCouriers")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ShippingCouriers");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shipping_courier_create_dto = NULL;
    if (shipping_courier_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_shipping_courier_create_dto = shipping_courier_create_dto_convertToJSON(shipping_courier_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shipping_courier_create_dto);
    }
    ...
    if (localVarSingleItemJSON_shipping_courier_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_shipping_courier_create_dto);
        localVarSingleItemJSON_shipping_courier_create_dto = NULL;
    }
...
ShippingCouriersAPI_deleteShippingCourierAsync(apiClient_t *apiClient, char *tenantId, char *courierId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ShippingCouriers/{courierId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ShippingCouriers/{courierId}");


    // Path Params
    long sizeOfPathParams_courierId = strlen(courierId)+3 + strlen("{ courierId }");
    if(courierId == NULL) {
        goto end;
    }
    char* localVarToReplace_courierId = malloc(sizeOfPathParams_courierId);
    sprintf(localVarToReplace_courierId, "{%s}", "courierId");

    localVarPath = strReplace(localVarPath, localVarToReplace_courierId, courierId);
    if(courierId == NULL) {
        goto end;
    }
    char* localVarToReplace_courierId = malloc(sizeOfPathParams_courierId);
    ...
    free(localVarPath);
    free(localVarToReplace_courierId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
ShippingCouriersAPI_getShippingCourierByIdAsync(apiClient_t *apiClient, char *tenantId, char *courierId, char *api_version, char *x_api_version)
{
    ...
    cJSON *ShippingCouriersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    shipping_courier_dto_envelope_t *elementToReturn = shipping_courier_dto_envelope_parseFromJSON(ShippingCouriersAPIlocalVarJSON);
    cJSON_Delete(ShippingCouriersAPIlocalVarJSON);
...
ShippingCouriersAPI_getShippingCouriersAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipping_courier_dto_collection_query_parameters_t *shipping_courier_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shipping_courier_dto_collection_query_parameters = NULL;
    if (shipping_courier_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_shipping_courier_dto_collection_query_parameters = shipping_courier_dto_collection_query_parameters_convertToJSON(shipping_courier_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shipping_courier_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ShippingCouriersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    shipping_courier_dto_list_envelope_t *elementToReturn = shipping_courier_dto_list_envelope_parseFromJSON(ShippingCouriersAPIlocalVarJSON);
    cJSON_Delete(ShippingCouriersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_shipping_courier_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_shipping_courier_dto_collection_query_parameters);
        localVarSingleItemJSON_shipping_courier_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ShippingCouriersAPI_getShippingCouriersCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipping_courier_dto_collection_query_parameters_t *shipping_courier_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ShippingCouriers/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ShippingCouriers/Count");
    ...
    //nonprimitive not container
    cJSON *ShippingCouriersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ShippingCouriersAPIlocalVarJSON);
    cJSON_Delete(ShippingCouriersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ShippingCouriersAPI_patchShippingCourierAsync(apiClient_t *apiClient, char *tenantId, char *courierId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *ShippingCouriersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ShippingCouriersAPIlocalVarJSON);
    cJSON_Delete(ShippingCouriersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ShippingCouriersAPI_updateShippingCourierAsync(apiClient_t *apiClient, char *tenantId, char *courierId, char *api_version, char *x_api_version, shipping_courier_update_dto_t *shipping_courier_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shipping_courier_update_dto = NULL;
    if (shipping_courier_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_shipping_courier_update_dto = shipping_courier_update_dto_convertToJSON(shipping_courier_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shipping_courier_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_shipping_courier_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_shipping_courier_update_dto);
        localVarSingleItemJSON_shipping_courier_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
