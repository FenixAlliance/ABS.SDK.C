...
ShippingZonesAPI_createShippingZoneAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipping_zone_create_dto_t *shipping_zone_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ShippingZones")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ShippingZones");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shipping_zone_create_dto = NULL;
    if (shipping_zone_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_shipping_zone_create_dto = shipping_zone_create_dto_convertToJSON(shipping_zone_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shipping_zone_create_dto);
    }
    ...
    if (localVarSingleItemJSON_shipping_zone_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_shipping_zone_create_dto);
        localVarSingleItemJSON_shipping_zone_create_dto = NULL;
    }
...
ShippingZonesAPI_deleteShippingZoneAsync(apiClient_t *apiClient, char *tenantId, char *zoneId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ShippingZones/{zoneId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ShippingZones/{zoneId}");


    // Path Params
    long sizeOfPathParams_zoneId = strlen(zoneId)+3 + strlen("{ zoneId }");
    if(zoneId == NULL) {
        goto end;
    }
    char* localVarToReplace_zoneId = malloc(sizeOfPathParams_zoneId);
    sprintf(localVarToReplace_zoneId, "{%s}", "zoneId");

    localVarPath = strReplace(localVarPath, localVarToReplace_zoneId, zoneId);
    if(zoneId == NULL) {
        goto end;
    }
    char* localVarToReplace_zoneId = malloc(sizeOfPathParams_zoneId);
...
ShippingZonesAPI_getShippingZoneByIdAsync(apiClient_t *apiClient, char *tenantId, char *zoneId, char *api_version, char *x_api_version)
{
    ...
    cJSON *ShippingZonesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    shipping_zone_dto_envelope_t *elementToReturn = shipping_zone_dto_envelope_parseFromJSON(ShippingZonesAPIlocalVarJSON);
    cJSON_Delete(ShippingZonesAPIlocalVarJSON);
...
ShippingZonesAPI_getShippingZonesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ShippingZonesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    shipping_zone_dto_list_envelope_t *elementToReturn = shipping_zone_dto_list_envelope_parseFromJSON(ShippingZonesAPIlocalVarJSON);
    cJSON_Delete(ShippingZonesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ShippingZonesAPI_getShippingZonesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ShippingZones/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ShippingZones/Count");
    ...
    //nonprimitive not container
    cJSON *ShippingZonesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ShippingZonesAPIlocalVarJSON);
    cJSON_Delete(ShippingZonesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ShippingZonesAPI_patchShippingZoneAsync(apiClient_t *apiClient, char *tenantId, char *zoneId, char *api_version, char *x_api_version, list_t *operation)
{
    ...
    //nonprimitive not container
    cJSON *ShippingZonesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ShippingZonesAPIlocalVarJSON);
    cJSON_Delete(ShippingZonesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ShippingZonesAPI_updateShippingZoneAsync(apiClient_t *apiClient, char *tenantId, char *zoneId, char *api_version, char *x_api_version, shipping_zone_update_dto_t *shipping_zone_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shipping_zone_update_dto = NULL;
    if (shipping_zone_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_shipping_zone_update_dto = shipping_zone_update_dto_convertToJSON(shipping_zone_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shipping_zone_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_shipping_zone_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_shipping_zone_update_dto);
        localVarSingleItemJSON_shipping_zone_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
