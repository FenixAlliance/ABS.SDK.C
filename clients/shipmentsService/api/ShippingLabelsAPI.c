...
ShippingLabelsAPI_createShippingLabelAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipping_label_create_dto_t *shipping_label_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ShippingLabels")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ShippingLabels");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shipping_label_create_dto = NULL;
    if (shipping_label_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_shipping_label_create_dto = shipping_label_create_dto_convertToJSON(shipping_label_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shipping_label_create_dto);
    }
    ...
    if (localVarSingleItemJSON_shipping_label_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_shipping_label_create_dto);
        localVarSingleItemJSON_shipping_label_create_dto = NULL;
    }
...
ShippingLabelsAPI_deleteShippingLabelAsync(apiClient_t *apiClient, char *tenantId, char *labelId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ShippingLabels/{labelId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ShippingLabels/{labelId}");


    // Path Params
    long sizeOfPathParams_labelId = strlen(labelId)+3 + strlen("{ labelId }");
    if(labelId == NULL) {
        goto end;
    }
    char* localVarToReplace_labelId = malloc(sizeOfPathParams_labelId);
    sprintf(localVarToReplace_labelId, "{%s}", "labelId");

    localVarPath = strReplace(localVarPath, localVarToReplace_labelId, labelId);
    if(labelId == NULL) {
        goto end;
    }
    char* localVarToReplace_labelId = malloc(sizeOfPathParams_labelId);
    ...
    free(localVarPath);
    free(localVarToReplace_labelId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
ShippingLabelsAPI_getShippingLabelByIdAsync(apiClient_t *apiClient, char *tenantId, char *labelId, char *api_version, char *x_api_version)
{
    ...
    cJSON *ShippingLabelsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    shipping_label_dto_envelope_t *elementToReturn = shipping_label_dto_envelope_parseFromJSON(ShippingLabelsAPIlocalVarJSON);
    cJSON_Delete(ShippingLabelsAPIlocalVarJSON);
...
ShippingLabelsAPI_getShippingLabelsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipping_label_dto_collection_query_parameters_t *shipping_label_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shipping_label_dto_collection_query_parameters = NULL;
    if (shipping_label_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_shipping_label_dto_collection_query_parameters = shipping_label_dto_collection_query_parameters_convertToJSON(shipping_label_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shipping_label_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ShippingLabelsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    shipping_label_dto_list_envelope_t *elementToReturn = shipping_label_dto_list_envelope_parseFromJSON(ShippingLabelsAPIlocalVarJSON);
    cJSON_Delete(ShippingLabelsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_shipping_label_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_shipping_label_dto_collection_query_parameters);
        localVarSingleItemJSON_shipping_label_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ShippingLabelsAPI_getShippingLabelsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipping_label_dto_collection_query_parameters_t *shipping_label_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ShippingLabels/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ShippingLabels/Count");
    ...
    //nonprimitive not container
    cJSON *ShippingLabelsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ShippingLabelsAPIlocalVarJSON);
    cJSON_Delete(ShippingLabelsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ShippingLabelsAPI_patchShippingLabelAsync(apiClient_t *apiClient, char *tenantId, char *labelId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *ShippingLabelsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ShippingLabelsAPIlocalVarJSON);
    cJSON_Delete(ShippingLabelsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ShippingLabelsAPI_updateShippingLabelAsync(apiClient_t *apiClient, char *tenantId, char *labelId, char *api_version, char *x_api_version, shipping_label_update_dto_t *shipping_label_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shipping_label_update_dto = NULL;
    if (shipping_label_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_shipping_label_update_dto = shipping_label_update_dto_convertToJSON(shipping_label_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shipping_label_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_shipping_label_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_shipping_label_update_dto);
        localVarSingleItemJSON_shipping_label_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
