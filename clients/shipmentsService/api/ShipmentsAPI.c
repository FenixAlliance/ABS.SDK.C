...
ShipmentsAPI_getShipmentsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipment_dto_collection_query_parameters_t *shipment_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shipment_dto_collection_query_parameters = NULL;
    if (shipment_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_shipment_dto_collection_query_parameters = shipment_dto_collection_query_parameters_convertToJSON(shipment_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shipment_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ShipmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    shipment_dto_list_envelope_t *elementToReturn = shipment_dto_list_envelope_parseFromJSON(ShipmentsAPIlocalVarJSON);
    cJSON_Delete(ShipmentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_shipment_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_shipment_dto_collection_query_parameters);
        localVarSingleItemJSON_shipment_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ShipmentsAPI_patchShipmentAsync(apiClient_t *apiClient, char *tenantId, char *shipmentId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *ShipmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ShipmentsAPIlocalVarJSON);
    cJSON_Delete(ShipmentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
