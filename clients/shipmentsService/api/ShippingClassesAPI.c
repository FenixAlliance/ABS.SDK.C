...
ShippingClassesAPI_createShippingClassAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipping_class_create_dto_t *shipping_class_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ShippingClasses")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ShippingClasses");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shipping_class_create_dto = NULL;
    if (shipping_class_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_shipping_class_create_dto = shipping_class_create_dto_convertToJSON(shipping_class_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shipping_class_create_dto);
    }
    ...
    if (localVarSingleItemJSON_shipping_class_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_shipping_class_create_dto);
        localVarSingleItemJSON_shipping_class_create_dto = NULL;
    }
...
ShippingClassesAPI_deleteShippingClassAsync(apiClient_t *apiClient, char *tenantId, char *classId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ShippingClasses/{classId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ShippingClasses/{classId}");


    // Path Params
    long sizeOfPathParams_classId = strlen(classId)+3 + strlen("{ classId }");
    if(classId == NULL) {
        goto end;
    }
    char* localVarToReplace_classId = malloc(sizeOfPathParams_classId);
    sprintf(localVarToReplace_classId, "{%s}", "classId");

    localVarPath = strReplace(localVarPath, localVarToReplace_classId, classId);
    if(classId == NULL) {
        goto end;
    }
    char* localVarToReplace_classId = malloc(sizeOfPathParams_classId);
    ...
    free(localVarPath);
    free(localVarToReplace_classId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
ShippingClassesAPI_getShippingClassByIdAsync(apiClient_t *apiClient, char *tenantId, char *classId, char *api_version, char *x_api_version)
{
    ...
    cJSON *ShippingClassesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    shipping_class_dto_envelope_t *elementToReturn = shipping_class_dto_envelope_parseFromJSON(ShippingClassesAPIlocalVarJSON);
    cJSON_Delete(ShippingClassesAPIlocalVarJSON);
...
ShippingClassesAPI_getShippingClassesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipping_class_dto_collection_query_parameters_t *shipping_class_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shipping_class_dto_collection_query_parameters = NULL;
    if (shipping_class_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_shipping_class_dto_collection_query_parameters = shipping_class_dto_collection_query_parameters_convertToJSON(shipping_class_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shipping_class_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ShippingClassesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    shipping_class_dto_list_envelope_t *elementToReturn = shipping_class_dto_list_envelope_parseFromJSON(ShippingClassesAPIlocalVarJSON);
    cJSON_Delete(ShippingClassesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_shipping_class_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_shipping_class_dto_collection_query_parameters);
        localVarSingleItemJSON_shipping_class_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ShippingClassesAPI_getShippingClassesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipping_class_dto_collection_query_parameters_t *shipping_class_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ShippingClasses/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ShippingClasses/Count");
    ...
    //nonprimitive not container
    cJSON *ShippingClassesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ShippingClassesAPIlocalVarJSON);
    cJSON_Delete(ShippingClassesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ShippingClassesAPI_patchShippingClassAsync(apiClient_t *apiClient, char *tenantId, char *classId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *ShippingClassesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ShippingClassesAPIlocalVarJSON);
    cJSON_Delete(ShippingClassesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ShippingClassesAPI_updateShippingClassAsync(apiClient_t *apiClient, char *tenantId, char *classId, char *api_version, char *x_api_version, shipping_class_update_dto_t *shipping_class_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shipping_class_update_dto = NULL;
    if (shipping_class_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_shipping_class_update_dto = shipping_class_update_dto_convertToJSON(shipping_class_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shipping_class_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_shipping_class_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_shipping_class_update_dto);
        localVarSingleItemJSON_shipping_class_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
