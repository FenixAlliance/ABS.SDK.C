...
ShippingMethodsAPI_createShippingMethodAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipping_method_create_dto_t *shipping_method_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ShippingMethods")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ShippingMethods");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shipping_method_create_dto = NULL;
    if (shipping_method_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_shipping_method_create_dto = shipping_method_create_dto_convertToJSON(shipping_method_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shipping_method_create_dto);
    }
    ...
    if (localVarSingleItemJSON_shipping_method_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_shipping_method_create_dto);
        localVarSingleItemJSON_shipping_method_create_dto = NULL;
    }
...
ShippingMethodsAPI_deleteShippingMethodAsync(apiClient_t *apiClient, char *tenantId, char *methodId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ShippingMethods/{methodId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ShippingMethods/{methodId}");


    // Path Params
    long sizeOfPathParams_methodId = strlen(methodId)+3 + strlen("{ methodId }");
    if(methodId == NULL) {
        goto end;
    }
    char* localVarToReplace_methodId = malloc(sizeOfPathParams_methodId);
    sprintf(localVarToReplace_methodId, "{%s}", "methodId");

    localVarPath = strReplace(localVarPath, localVarToReplace_methodId, methodId);
    if(methodId == NULL) {
        goto end;
    }
    char* localVarToReplace_methodId = malloc(sizeOfPathParams_methodId);
    ...
    free(localVarPath);
    free(localVarToReplace_methodId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
ShippingMethodsAPI_getShippingMethodByIdAsync(apiClient_t *apiClient, char *tenantId, char *methodId, char *api_version, char *x_api_version)
{
    ...
    cJSON *ShippingMethodsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    shipping_method_dto_envelope_t *elementToReturn = shipping_method_dto_envelope_parseFromJSON(ShippingMethodsAPIlocalVarJSON);
    cJSON_Delete(ShippingMethodsAPIlocalVarJSON);
...
ShippingMethodsAPI_getShippingMethodsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipping_method_dto_collection_query_parameters_t *shipping_method_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shipping_method_dto_collection_query_parameters = NULL;
    if (shipping_method_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_shipping_method_dto_collection_query_parameters = shipping_method_dto_collection_query_parameters_convertToJSON(shipping_method_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shipping_method_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ShippingMethodsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    shipping_method_dto_list_envelope_t *elementToReturn = shipping_method_dto_list_envelope_parseFromJSON(ShippingMethodsAPIlocalVarJSON);
    cJSON_Delete(ShippingMethodsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_shipping_method_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_shipping_method_dto_collection_query_parameters);
        localVarSingleItemJSON_shipping_method_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ShippingMethodsAPI_getShippingMethodsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipping_method_dto_collection_query_parameters_t *shipping_method_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ShippingMethods/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ShippingMethods/Count");
    ...
    //nonprimitive not container
    cJSON *ShippingMethodsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ShippingMethodsAPIlocalVarJSON);
    cJSON_Delete(ShippingMethodsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ShippingMethodsAPI_patchShippingMethodAsync(apiClient_t *apiClient, char *tenantId, char *methodId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *ShippingMethodsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ShippingMethodsAPIlocalVarJSON);
    cJSON_Delete(ShippingMethodsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ShippingMethodsAPI_updateShippingMethodAsync(apiClient_t *apiClient, char *tenantId, char *methodId, char *api_version, char *x_api_version, shipping_method_update_dto_t *shipping_method_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shipping_method_update_dto = NULL;
    if (shipping_method_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_shipping_method_update_dto = shipping_method_update_dto_convertToJSON(shipping_method_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shipping_method_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_shipping_method_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_shipping_method_update_dto);
        localVarSingleItemJSON_shipping_method_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
