...
ShippingRegionsAPI_createShippingRegionAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipping_region_create_dto_t *shipping_region_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ShippingRegions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ShippingRegions");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shipping_region_create_dto = NULL;
    if (shipping_region_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_shipping_region_create_dto = shipping_region_create_dto_convertToJSON(shipping_region_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shipping_region_create_dto);
    }
    ...
    if (localVarSingleItemJSON_shipping_region_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_shipping_region_create_dto);
        localVarSingleItemJSON_shipping_region_create_dto = NULL;
    }
...
ShippingRegionsAPI_deleteShippingRegionAsync(apiClient_t *apiClient, char *tenantId, char *regionId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ShippingRegions/{regionId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ShippingRegions/{regionId}");


    // Path Params
    long sizeOfPathParams_regionId = strlen(regionId)+3 + strlen("{ regionId }");
    if(regionId == NULL) {
        goto end;
    }
    char* localVarToReplace_regionId = malloc(sizeOfPathParams_regionId);
    sprintf(localVarToReplace_regionId, "{%s}", "regionId");

    localVarPath = strReplace(localVarPath, localVarToReplace_regionId, regionId);
    if(regionId == NULL) {
        goto end;
    }
    char* localVarToReplace_regionId = malloc(sizeOfPathParams_regionId);
...
ShippingRegionsAPI_getShippingRegionByIdAsync(apiClient_t *apiClient, char *tenantId, char *regionId, char *api_version, char *x_api_version)
{
    ...
    cJSON *ShippingRegionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    shipping_region_dto_envelope_t *elementToReturn = shipping_region_dto_envelope_parseFromJSON(ShippingRegionsAPIlocalVarJSON);
    cJSON_Delete(ShippingRegionsAPIlocalVarJSON);
...
ShippingRegionsAPI_getShippingRegionsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipping_region_dto_collection_query_parameters_t *shipping_region_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shipping_region_dto_collection_query_parameters = NULL;
    if (shipping_region_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_shipping_region_dto_collection_query_parameters = shipping_region_dto_collection_query_parameters_convertToJSON(shipping_region_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shipping_region_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ShippingRegionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    shipping_region_dto_list_envelope_t *elementToReturn = shipping_region_dto_list_envelope_parseFromJSON(ShippingRegionsAPIlocalVarJSON);
    cJSON_Delete(ShippingRegionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_shipping_region_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_shipping_region_dto_collection_query_parameters);
        localVarSingleItemJSON_shipping_region_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ShippingRegionsAPI_getShippingRegionsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, shipping_region_dto_collection_query_parameters_t *shipping_region_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ShippingRegions/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ShippingRegions/Count");
    ...
    //nonprimitive not container
    cJSON *ShippingRegionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ShippingRegionsAPIlocalVarJSON);
    cJSON_Delete(ShippingRegionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ShippingRegionsAPI_patchShippingRegionAsync(apiClient_t *apiClient, char *tenantId, char *regionId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *ShippingRegionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ShippingRegionsAPIlocalVarJSON);
    cJSON_Delete(ShippingRegionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ShippingRegionsAPI_updateShippingRegionAsync(apiClient_t *apiClient, char *tenantId, char *regionId, char *api_version, char *x_api_version, shipping_region_update_dto_t *shipping_region_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_shipping_region_update_dto = NULL;
    if (shipping_region_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_shipping_region_update_dto = shipping_region_update_dto_convertToJSON(shipping_region_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_shipping_region_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_shipping_region_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_shipping_region_update_dto);
        localVarSingleItemJSON_shipping_region_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
