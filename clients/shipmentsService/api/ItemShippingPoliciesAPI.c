...
ItemShippingPoliciesAPI_createItemShippingPolicyAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_shipping_policy_create_dto_t *item_shipping_policy_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ItemShippingPolicies")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ItemShippingPolicies");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_shipping_policy_create_dto = NULL;
    if (item_shipping_policy_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_shipping_policy_create_dto = item_shipping_policy_create_dto_convertToJSON(item_shipping_policy_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_shipping_policy_create_dto);
    }
    ...
    if (localVarSingleItemJSON_item_shipping_policy_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_shipping_policy_create_dto);
        localVarSingleItemJSON_item_shipping_policy_create_dto = NULL;
    }
...
ItemShippingPoliciesAPI_deleteItemShippingPolicyAsync(apiClient_t *apiClient, char *tenantId, char *policyId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ItemShippingPolicies/{policyId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ItemShippingPolicies/{policyId}");


    // Path Params
    long sizeOfPathParams_policyId = strlen(policyId)+3 + strlen("{ policyId }");
    if(policyId == NULL) {
        goto end;
    }
    char* localVarToReplace_policyId = malloc(sizeOfPathParams_policyId);
    sprintf(localVarToReplace_policyId, "{%s}", "policyId");

    localVarPath = strReplace(localVarPath, localVarToReplace_policyId, policyId);
    if(policyId == NULL) {
        goto end;
    }
    char* localVarToReplace_policyId = malloc(sizeOfPathParams_policyId);
    ...
    free(localVarPath);
    free(localVarToReplace_policyId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
ItemShippingPoliciesAPI_getItemShippingPoliciesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ShipmentsService/ItemShippingPolicies/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ShipmentsService/ItemShippingPolicies/Count");
...
ItemShippingPoliciesAPI_patchItemShippingPolicyAsync(apiClient_t *apiClient, char *tenantId, char *policyId, char *api_version, char *x_api_version, list_t *operation)
{
    ...
    //nonprimitive not container
    cJSON *ItemShippingPoliciesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ItemShippingPoliciesAPIlocalVarJSON);
    cJSON_Delete(ItemShippingPoliciesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemShippingPoliciesAPI_updateItemShippingPolicyAsync(apiClient_t *apiClient, char *tenantId, char *policyId, char *api_version, char *x_api_version, item_shipping_policy_update_dto_t *item_shipping_policy_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_shipping_policy_update_dto = NULL;
    if (item_shipping_policy_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_shipping_policy_update_dto = item_shipping_policy_update_dto_convertToJSON(item_shipping_policy_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_shipping_policy_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_item_shipping_policy_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_shipping_policy_update_dto);
        localVarSingleItemJSON_item_shipping_policy_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
