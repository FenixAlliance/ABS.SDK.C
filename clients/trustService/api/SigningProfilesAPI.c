...
SigningProfilesAPI_createSigningProfileAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, signing_profile_create_dto_t *signing_profile_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TrustService/SigningProfiles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TrustService/SigningProfiles");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_signing_profile_create_dto = NULL;
    if (signing_profile_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_signing_profile_create_dto = signing_profile_create_dto_convertToJSON(signing_profile_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_signing_profile_create_dto);
    }
    ...
    if (localVarSingleItemJSON_signing_profile_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_signing_profile_create_dto);
        localVarSingleItemJSON_signing_profile_create_dto = NULL;
    }
...
SigningProfilesAPI_deleteSigningProfileAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TrustService/SigningProfiles/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TrustService/SigningProfiles/{id}");
...
SigningProfilesAPI_getSigningProfileByIdAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    cJSON *SigningProfilesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    signing_profile_dto_t *elementToReturn = signing_profile_dto_parseFromJSON(SigningProfilesAPIlocalVarJSON);
    cJSON_Delete(SigningProfilesAPIlocalVarJSON);
...
SigningProfilesAPI_getSigningProfilesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, signing_profile_dto_collection_query_parameters_t *signing_profile_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_signing_profile_dto_collection_query_parameters = NULL;
    if (signing_profile_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_signing_profile_dto_collection_query_parameters = signing_profile_dto_collection_query_parameters_convertToJSON(signing_profile_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_signing_profile_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *SigningProfilesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    signing_profile_dto_list_envelope_t *elementToReturn = signing_profile_dto_list_envelope_parseFromJSON(SigningProfilesAPIlocalVarJSON);
    cJSON_Delete(SigningProfilesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_signing_profile_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_signing_profile_dto_collection_query_parameters);
        localVarSingleItemJSON_signing_profile_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SigningProfilesAPI_getSigningProfilesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, signing_profile_dto_collection_query_parameters_t *signing_profile_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TrustService/SigningProfiles/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TrustService/SigningProfiles/Count");
    ...
    //nonprimitive not container
    cJSON *SigningProfilesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SigningProfilesAPIlocalVarJSON);
    cJSON_Delete(SigningProfilesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SigningProfilesAPI_patchSigningProfileAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *SigningProfilesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SigningProfilesAPIlocalVarJSON);
    cJSON_Delete(SigningProfilesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SigningProfilesAPI_updateSigningProfileAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, signing_profile_update_dto_t *signing_profile_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_signing_profile_update_dto = NULL;
    if (signing_profile_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_signing_profile_update_dto = signing_profile_update_dto_convertToJSON(signing_profile_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_signing_profile_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_signing_profile_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_signing_profile_update_dto);
        localVarSingleItemJSON_signing_profile_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
