...
SigningLogsAPI_getSigningLogByIdAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TrustService/SigningLogs/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TrustService/SigningLogs/{id}");
    ...
    cJSON *SigningLogsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    signing_log_dto_t *elementToReturn = signing_log_dto_parseFromJSON(SigningLogsAPIlocalVarJSON);
    cJSON_Delete(SigningLogsAPIlocalVarJSON);
...
SigningLogsAPI_getSigningLogsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, signing_log_dto_collection_query_parameters_t *signing_log_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TrustService/SigningLogs")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TrustService/SigningLogs");
    ...
    //nonprimitive not container
    cJSON *SigningLogsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    signing_log_dto_list_envelope_t *elementToReturn = signing_log_dto_list_envelope_parseFromJSON(SigningLogsAPIlocalVarJSON);
    cJSON_Delete(SigningLogsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SigningLogsAPI_getSigningLogsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, signing_log_dto_collection_query_parameters_t *signing_log_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TrustService/SigningLogs/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TrustService/SigningLogs/Count");
    ...
    //nonprimitive not container
    cJSON *SigningLogsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SigningLogsAPIlocalVarJSON);
    cJSON_Delete(SigningLogsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
