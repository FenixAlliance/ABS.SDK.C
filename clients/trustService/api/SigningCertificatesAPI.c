...
#include <stdio.h>
#include <ctype.h>
#include "SigningCertificatesAPI.h"
...
SigningCertificatesAPI_createSigningCertificateAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, signing_certificate_create_dto_t *signing_certificate_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TrustService/SigningCertificates")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TrustService/SigningCertificates");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_signing_certificate_create_dto = NULL;
    if (signing_certificate_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_signing_certificate_create_dto = signing_certificate_create_dto_convertToJSON(signing_certificate_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_signing_certificate_create_dto);
    }
    ...
    if (localVarSingleItemJSON_signing_certificate_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_signing_certificate_create_dto);
        localVarSingleItemJSON_signing_certificate_create_dto = NULL;
    }
...
SigningCertificatesAPI_deleteSigningCertificateAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TrustService/SigningCertificates/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TrustService/SigningCertificates/{id}");
...
SigningCertificatesAPI_getSigningCertificateByIdAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    cJSON *SigningCertificatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    signing_certificate_dto_t *elementToReturn = signing_certificate_dto_parseFromJSON(SigningCertificatesAPIlocalVarJSON);
    cJSON_Delete(SigningCertificatesAPIlocalVarJSON);
...
SigningCertificatesAPI_getSigningCertificatesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SigningCertificatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    signing_certificate_dto_list_envelope_t *elementToReturn = signing_certificate_dto_list_envelope_parseFromJSON(SigningCertificatesAPIlocalVarJSON);
    cJSON_Delete(SigningCertificatesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SigningCertificatesAPI_getSigningCertificatesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TrustService/SigningCertificates/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TrustService/SigningCertificates/Count");
    ...
    //nonprimitive not container
    cJSON *SigningCertificatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SigningCertificatesAPIlocalVarJSON);
    cJSON_Delete(SigningCertificatesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SigningCertificatesAPI_importSigningCertificateAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, char *id, binary_t* file, char *password, char *title, char *contactId)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TrustService/SigningCertificates/Import")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TrustService/SigningCertificates/Import");
    ...
    keyValuePair_free(keyPairForm_id);
    if (keyForm_file) {
        free(keyForm_file);
        keyForm_file = NULL;
    }
...
//    free(fileVar_file);
    ...
    keyValuePair_free(keyPairForm_password);
    if (keyForm_title) {
        free(keyForm_title);
        keyForm_title = NULL;
    }
    ...
    keyValuePair_free(keyPairForm_title);
    ...
    keyValuePair_free(keyPairForm_contactId);
...
SigningCertificatesAPI_patchSigningCertificateAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *operation)
{
    ...
    //nonprimitive not container
    cJSON *SigningCertificatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SigningCertificatesAPIlocalVarJSON);
    cJSON_Delete(SigningCertificatesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SigningCertificatesAPI_updateSigningCertificateAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, signing_certificate_update_dto_t *signing_certificate_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_signing_certificate_update_dto = NULL;
    if (signing_certificate_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_signing_certificate_update_dto = signing_certificate_update_dto_convertToJSON(signing_certificate_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_signing_certificate_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_signing_certificate_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_signing_certificate_update_dto);
        localVarSingleItemJSON_signing_certificate_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
