...
#include <stdio.h>
#include <ctype.h>
#include "SignedDocumentAttachmentsAPI.h"
...
SignedDocumentAttachmentsAPI_createSignedDocumentAttachmentAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, signed_document_attachment_create_dto_t *signed_document_attachment_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TrustService/SignedDocumentAttachments")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TrustService/SignedDocumentAttachments");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_signed_document_attachment_create_dto = NULL;
    if (signed_document_attachment_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_signed_document_attachment_create_dto = signed_document_attachment_create_dto_convertToJSON(signed_document_attachment_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_signed_document_attachment_create_dto);
    }
    ...
    if (localVarSingleItemJSON_signed_document_attachment_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_signed_document_attachment_create_dto);
        localVarSingleItemJSON_signed_document_attachment_create_dto = NULL;
    }
...
SignedDocumentAttachmentsAPI_deleteSignedDocumentAttachmentAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TrustService/SignedDocumentAttachments/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TrustService/SignedDocumentAttachments/{id}");
...
SignedDocumentAttachmentsAPI_getSignedDocumentAttachmentByIdAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    cJSON *SignedDocumentAttachmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    signed_document_attachment_dto_t *elementToReturn = signed_document_attachment_dto_parseFromJSON(SignedDocumentAttachmentsAPIlocalVarJSON);
    cJSON_Delete(SignedDocumentAttachmentsAPIlocalVarJSON);
...
SignedDocumentAttachmentsAPI_getSignedDocumentAttachmentsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, signed_document_attachment_dto_collection_query_parameters_t *signed_document_attachment_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_signed_document_attachment_dto_collection_query_parameters = NULL;
    if (signed_document_attachment_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_signed_document_attachment_dto_collection_query_parameters = signed_document_attachment_dto_collection_query_parameters_convertToJSON(signed_document_attachment_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_signed_document_attachment_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *SignedDocumentAttachmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    signed_document_attachment_dto_list_envelope_t *elementToReturn = signed_document_attachment_dto_list_envelope_parseFromJSON(SignedDocumentAttachmentsAPIlocalVarJSON);
    cJSON_Delete(SignedDocumentAttachmentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_signed_document_attachment_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_signed_document_attachment_dto_collection_query_parameters);
        localVarSingleItemJSON_signed_document_attachment_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SignedDocumentAttachmentsAPI_getSignedDocumentAttachmentsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, signed_document_attachment_dto_collection_query_parameters_t *signed_document_attachment_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TrustService/SignedDocumentAttachments/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TrustService/SignedDocumentAttachments/Count");
    ...
    //nonprimitive not container
    cJSON *SignedDocumentAttachmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SignedDocumentAttachmentsAPIlocalVarJSON);
    cJSON_Delete(SignedDocumentAttachmentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SignedDocumentAttachmentsAPI_patchSignedDocumentAttachmentAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *SignedDocumentAttachmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SignedDocumentAttachmentsAPIlocalVarJSON);
    cJSON_Delete(SignedDocumentAttachmentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SignedDocumentAttachmentsAPI_updateSignedDocumentAttachmentAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, signed_document_attachment_update_dto_t *signed_document_attachment_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_signed_document_attachment_update_dto = NULL;
    if (signed_document_attachment_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_signed_document_attachment_update_dto = signed_document_attachment_update_dto_convertToJSON(signed_document_attachment_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_signed_document_attachment_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_signed_document_attachment_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_signed_document_attachment_update_dto);
        localVarSingleItemJSON_signed_document_attachment_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
