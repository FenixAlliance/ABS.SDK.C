/*
 * signing_profile_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _signing_profile_dto_collection_query_parameters_H_
#define _signing_profile_dto_collection_query_parameters_H_
...
typedef struct signing_profile_dto_collection_query_parameters_t signing_profile_dto_collection_query_parameters_t;




typedef struct signing_profile_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} signing_profile_dto_collection_query_parameters_t;
...
#endif /* _signing_profile_dto_collection_query_parameters_H_ */
