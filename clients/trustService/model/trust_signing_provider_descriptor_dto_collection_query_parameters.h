/*
 * trust_signing_provider_descriptor_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _trust_signing_provider_descriptor_dto_collection_query_parameters_H_
#define _trust_signing_provider_descriptor_dto_collection_query_parameters_H_
...
typedef struct trust_signing_provider_descriptor_dto_collection_query_parameters_t trust_signing_provider_descriptor_dto_collection_query_parameters_t;




typedef struct trust_signing_provider_descriptor_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} trust_signing_provider_descriptor_dto_collection_query_parameters_t;
...
#endif /* _trust_signing_provider_descriptor_dto_collection_query_parameters_H_ */
