/*
 * trust_signing_readiness_dto_envelope.h
 *
 * 
 */

#ifndef _trust_signing_readiness_dto_envelope_H_
#define _trust_signing_readiness_dto_envelope_H_
...
typedef struct trust_signing_readiness_dto_envelope_t trust_signing_readiness_dto_envelope_t;

#include "trust_signing_readiness_dto.h"



typedef struct trust_signing_readiness_dto_envelope_t {
    int is_success; //boolean
    char *error_message; // string
    char *correlation_id; // string
    char *timestamp; //date time
    char *activity_id; // string
    struct trust_signing_readiness_dto_t *result; //model
...
#endif /* _trust_signing_readiness_dto_envelope_H_ */
