/*
 * signing_profile_graphical_representation_dto.h
 *
 * 
 */

#ifndef _signing_profile_graphical_representation_dto_H_
#define _signing_profile_graphical_representation_dto_H_
...
typedef struct signing_profile_graphical_representation_dto_t signing_profile_graphical_representation_dto_t;


// Enum KIND for signing_profile_graphical_representation_dto

typedef enum  { trustservice_signing_profile_graphical_representation_dto_KIND_NULL = 0, trustservice_signing_profile_graphical_representation_dto_KIND_Drawn, trustservice_signing_profile_graphical_representation_dto_KIND_UploadedImage, trustservice_signing_profile_graphical_representation_dto_KIND_Typed, trustservice_signing_profile_graphical_representation_dto_KIND_Initials, trustservice_signing_profile_graphical_representation_dto_KIND_Seal, trustservice_signing_profile_graphical_representation_dto_KIND_Stamp } trustservice_signing_profile_graphical_representation_dto_KIND_e;
...
typedef struct signing_profile_graphical_representation_dto_t {
    char *id; // string
    char *timestamp; //date time
    char *signing_profile_id; // string
    trustservice_signing_profile_graphical_representation_dto_KIND_e kind; //enum
    ...
    char *created_by_id; // string
    char *created_at_utc; //date time
    char *signing_profile_name; // string
...
#endif /* _signing_profile_graphical_representation_dto_H_ */
