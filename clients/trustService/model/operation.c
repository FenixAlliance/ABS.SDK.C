...
cJSON *operation_convertToJSON(operation_t *operation) {
    ...
    if(operation->operation_type != trustservice_operation_OPERATIONTYPE_NULL) {
...
operation_t *operation_parseFromJSON(cJSON *operationJSON){
    ...
    trustservice_operation_OPERATIONTYPE_e operation_typeVariable;
    if (operation_type) { 
    ...
    operation_local_var = operation_create (
        operation_type ? operation_typeVariable : trustservice_operation_OPERATIONTYPE_NULL,
