...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**signing_profile_graphical_representation_dto_collection_query_parameters** | **[signing_profile_graphical_representation_dto_collection_query_parameters_t](signing_profile_graphical_representation_dto_collection_query_parameters.md) \*** |  | [optional] 
...
// Patch a signature representation
//
empty_envelope_t* SigningProfileGraphicalRepresentationsAPI_patchSigningProfileGraphicalRepresentationAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *patch_operation);
```
