...
//
signing_profile_dto_list_envelope_t* SigningProfilesAPI_getSigningProfilesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, signing_profile_dto_collection_query_parameters_t *signing_profile_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**signing_profile_dto_collection_query_parameters** | **[signing_profile_dto_collection_query_parameters_t](signing_profile_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* SigningProfilesAPI_getSigningProfilesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, signing_profile_dto_collection_query_parameters_t *signing_profile_dto_collection_query_parameters);
```
...
// Patch a signing profile
//
empty_envelope_t* SigningProfilesAPI_patchSigningProfileAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *patch_operation);
```
