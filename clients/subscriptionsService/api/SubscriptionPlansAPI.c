...
#include <stdio.h>
#include <ctype.h>
#include "SubscriptionPlansAPI.h"
...
SubscriptionPlansAPI_createSubscriptionPlanAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, subscription_plan_create_dto_t *subscription_plan_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SubscriptionsService/SubscriptionPlans")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SubscriptionsService/SubscriptionPlans");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_subscription_plan_create_dto = NULL;
    if (subscription_plan_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_subscription_plan_create_dto = subscription_plan_create_dto_convertToJSON(subscription_plan_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_subscription_plan_create_dto);
    }
    ...
    cJSON *SubscriptionPlansAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    envelope_t *elementToReturn = envelope_parseFromJSON(SubscriptionPlansAPIlocalVarJSON);
    cJSON_Delete(SubscriptionPlansAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_subscription_plan_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_subscription_plan_create_dto);
        localVarSingleItemJSON_subscription_plan_create_dto = NULL;
    }
...
SubscriptionPlansAPI_deleteSubscriptionPlanAsync(apiClient_t *apiClient, char *tenantId, char *planId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SubscriptionsService/SubscriptionPlans/{planId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SubscriptionsService/SubscriptionPlans/{planId}");


    // Path Params
    long sizeOfPathParams_planId = strlen(planId)+3 + strlen("{ planId }");
    if(planId == NULL) {
        goto end;
    }
    char* localVarToReplace_planId = malloc(sizeOfPathParams_planId);
    sprintf(localVarToReplace_planId, "{%s}", "planId");

    localVarPath = strReplace(localVarPath, localVarToReplace_planId, planId);
    if(planId == NULL) {
        goto end;
    }
    char* localVarToReplace_planId = malloc(sizeOfPathParams_planId);
...
SubscriptionPlansAPI_getSubscriptionPlanByIdAsync(apiClient_t *apiClient, char *tenantId, char *planId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SubscriptionPlansAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    subscription_plan_dto_envelope_t *elementToReturn = subscription_plan_dto_envelope_parseFromJSON(SubscriptionPlansAPIlocalVarJSON);
    cJSON_Delete(SubscriptionPlansAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SubscriptionPlansAPI_getSubscriptionPlansAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, subscription_dto_collection_query_parameters_t *subscription_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_subscription_dto_collection_query_parameters = NULL;
    if (subscription_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_subscription_dto_collection_query_parameters = subscription_dto_collection_query_parameters_convertToJSON(subscription_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_subscription_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *SubscriptionPlansAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    subscription_plan_dto_i_read_only_list_envelope_t *elementToReturn = subscription_plan_dto_i_read_only_list_envelope_parseFromJSON(SubscriptionPlansAPIlocalVarJSON);
    cJSON_Delete(SubscriptionPlansAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_subscription_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_subscription_dto_collection_query_parameters);
        localVarSingleItemJSON_subscription_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SubscriptionPlansAPI_getSubscriptionPlansCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, subscription_dto_collection_query_parameters_t *subscription_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SubscriptionsService/SubscriptionPlans/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SubscriptionsService/SubscriptionPlans/Count");
    ...
    //nonprimitive not container
    cJSON *SubscriptionPlansAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SubscriptionPlansAPIlocalVarJSON);
    cJSON_Delete(SubscriptionPlansAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SubscriptionPlansAPI_patchSubscriptionPlanAsync(apiClient_t *apiClient, char *tenantId, char *planId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *SubscriptionPlansAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SubscriptionPlansAPIlocalVarJSON);
    cJSON_Delete(SubscriptionPlansAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SubscriptionPlansAPI_updateSubscriptionPlanAsync(apiClient_t *apiClient, char *tenantId, char *planId, char *api_version, char *x_api_version, subscription_plan_update_dto_t *subscription_plan_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_subscription_plan_update_dto = NULL;
    if (subscription_plan_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_subscription_plan_update_dto = subscription_plan_update_dto_convertToJSON(subscription_plan_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_subscription_plan_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_subscription_plan_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_subscription_plan_update_dto);
        localVarSingleItemJSON_subscription_plan_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
