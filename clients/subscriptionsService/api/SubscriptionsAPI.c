...
SubscriptionsAPI_createSubscriptionAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, subscription_create_dto_t *subscription_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SubscriptionsService/Subscriptions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SubscriptionsService/Subscriptions");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_subscription_create_dto = NULL;
    if (subscription_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_subscription_create_dto = subscription_create_dto_convertToJSON(subscription_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_subscription_create_dto);
    }
    ...
    cJSON *SubscriptionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    envelope_t *elementToReturn = envelope_parseFromJSON(SubscriptionsAPIlocalVarJSON);
    cJSON_Delete(SubscriptionsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_subscription_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_subscription_create_dto);
        localVarSingleItemJSON_subscription_create_dto = NULL;
    }
...
SubscriptionsAPI_deleteSubscriptionAsync(apiClient_t *apiClient, char *tenantId, char *subscriptionId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SubscriptionsService/Subscriptions/{subscriptionId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SubscriptionsService/Subscriptions/{subscriptionId}");
...
SubscriptionsAPI_getSubscriptionByIdAsync(apiClient_t *apiClient, char *tenantId, char *subscriptionId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SubscriptionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    subscription_dto_envelope_t *elementToReturn = subscription_dto_envelope_parseFromJSON(SubscriptionsAPIlocalVarJSON);
    cJSON_Delete(SubscriptionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SubscriptionsAPI_getSubscriptionsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, subscription_dto_collection_query_parameters_t *subscription_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *SubscriptionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    subscription_dto_i_read_only_list_envelope_t *elementToReturn = subscription_dto_i_read_only_list_envelope_parseFromJSON(SubscriptionsAPIlocalVarJSON);
    cJSON_Delete(SubscriptionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SubscriptionsAPI_getSubscriptionsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, subscription_dto_collection_query_parameters_t *subscription_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SubscriptionsService/Subscriptions/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SubscriptionsService/Subscriptions/Count");
    ...
    //nonprimitive not container
    cJSON *SubscriptionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SubscriptionsAPIlocalVarJSON);
    cJSON_Delete(SubscriptionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SubscriptionsAPI_patchSubscriptionAsync(apiClient_t *apiClient, char *tenantId, char *subscriptionId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *SubscriptionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SubscriptionsAPIlocalVarJSON);
    cJSON_Delete(SubscriptionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SubscriptionsAPI_updateSubscriptionAsync(apiClient_t *apiClient, char *tenantId, char *subscriptionId, char *api_version, char *x_api_version, subscription_update_dto_t *subscription_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_subscription_update_dto = NULL;
    if (subscription_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_subscription_update_dto = subscription_update_dto_convertToJSON(subscription_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_subscription_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_subscription_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_subscription_update_dto);
        localVarSingleItemJSON_subscription_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
