/*
 * subscription_plan_dto.h
 *
 * 
 */

#ifndef _subscription_plan_dto_H_
#define _subscription_plan_dto_H_
...
typedef struct subscription_plan_dto_t subscription_plan_dto_t;




typedef struct subscription_plan_dto_t {
    char *id; // string
...
#endif /* _subscription_plan_dto_H_ */
