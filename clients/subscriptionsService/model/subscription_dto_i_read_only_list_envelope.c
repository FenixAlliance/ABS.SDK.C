...
subscription_dto_i_read_only_list_envelope_t *subscription_dto_i_read_only_list_envelope_create(
    ...
    subscription_dto_i_read_only_list_envelope_local_var->http_status = http_status;
    subscription_dto_i_read_only_list_envelope_local_var->error_code = error_code;
    subscription_dto_i_read_only_list_envelope_local_var->validation_details = validation_details;
...
void subscription_dto_i_read_only_list_envelope_free(subscription_dto_i_read_only_list_envelope_t *subscription_dto_i_read_only_list_envelope) {
    ...
    if (subscription_dto_i_read_only_list_envelope->error_code) {
        free(subscription_dto_i_read_only_list_envelope->error_code);
        subscription_dto_i_read_only_list_envelope->error_code = NULL;
    }
    if (subscription_dto_i_read_only_list_envelope->validation_details) {
        list_ForEach(listEntry, subscription_dto_i_read_only_list_envelope->validation_details) {
            keyValuePair_t *localKeyValue = (keyValuePair_t*) listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_freeList(subscription_dto_i_read_only_list_envelope->validation_details);
        subscription_dto_i_read_only_list_envelope->validation_details = NULL;
    }
...
cJSON *subscription_dto_i_read_only_list_envelope_convertToJSON(subscription_dto_i_read_only_list_envelope_t *subscription_dto_i_read_only_list_envelope) {
    ...
    // subscription_dto_i_read_only_list_envelope->http_status
    if(subscription_dto_i_read_only_list_envelope->http_status) {
    if(cJSON_AddNumberToObject(item, "httpStatus", subscription_dto_i_read_only_list_envelope->http_status) == NULL) {
    goto fail; //Numeric
    }
    }


    // subscription_dto_i_read_only_list_envelope->error_code
    if(subscription_dto_i_read_only_list_envelope->error_code) {
    if(cJSON_AddStringToObject(item, "errorCode", subscription_dto_i_read_only_list_envelope->error_code) == NULL) {
    goto fail; //String
    }
    }


    // subscription_dto_i_read_only_list_envelope->validation_details
    if(subscription_dto_i_read_only_list_envelope->validation_details) {
    ...
    if (subscription_dto_i_read_only_list_envelope->validation_details) {
    list_ForEach(validation_detailsListEntry, subscription_dto_i_read_only_list_envelope->validation_details) {
...
subscription_dto_i_read_only_list_envelope_t *subscription_dto_i_read_only_list_envelope_parseFromJSON(cJSON *subscription_dto_i_read_only_list_envelopeJSON){
    ...
    // define the local map for subscription_dto_i_read_only_list_envelope->validation_details
    ...
    // subscription_dto_i_read_only_list_envelope->http_status
    cJSON *http_status = cJSON_GetObjectItemCaseSensitive(subscription_dto_i_read_only_list_envelopeJSON, "httpStatus");
    if (http_status) { 
    ...
    // subscription_dto_i_read_only_list_envelope->error_code
    cJSON *error_code = cJSON_GetObjectItemCaseSensitive(subscription_dto_i_read_only_list_envelopeJSON, "errorCode");
    if (error_code) { 
    ...
    // subscription_dto_i_read_only_list_envelope->validation_details
    cJSON *validation_details = cJSON_GetObjectItemCaseSensitive(subscription_dto_i_read_only_list_envelopeJSON, "validationDetails");
