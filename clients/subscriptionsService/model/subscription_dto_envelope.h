/*
 * subscription_dto_envelope.h
 *
 * 
 */

#ifndef _subscription_dto_envelope_H_
#define _subscription_dto_envelope_H_
...
typedef struct subscription_dto_envelope_t subscription_dto_envelope_t;

#include "subscription_dto.h"



typedef struct subscription_dto_envelope_t {
    int is_success; //boolean
    char *error_message; // string
    char *correlation_id; // string
    char *timestamp; //date time
    char *activity_id; // string
    struct subscription_dto_t *result; //model
...
#endif /* _subscription_dto_envelope_H_ */
