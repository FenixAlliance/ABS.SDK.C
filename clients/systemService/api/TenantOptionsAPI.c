...
TenantOptionsAPI_createSystemTenantOption(apiClient_t *apiClient, char *tenantId, char *key, char *portalId, char *api_version, char *x_api_version, option_create_dto_t *option_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Tenants/{tenantId}/Options")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Tenants/{tenantId}/Options");
    ...
    cJSON *TenantOptionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(TenantOptionsAPIlocalVarJSON);
    cJSON_Delete(TenantOptionsAPIlocalVarJSON);
...
TenantOptionsAPI_deleteSystemTenantOption(apiClient_t *apiClient, char *tenantId, char *optionId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Tenants/{tenantId}/Options/{optionId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Tenants/{tenantId}/Options/{optionId}");


    // Path Params
    long sizeOfPathParams_tenantId = strlen(tenantId)+3 + strlen(optionId)+3 + strlen("{ tenantId }");
    if(tenantId == NULL) {
        goto end;
    }
    char* localVarToReplace_tenantId = malloc(sizeOfPathParams_tenantId);
    ...
    // Path Params
    long sizeOfPathParams_optionId = strlen(tenantId)+3 + strlen(optionId)+3 + strlen("{ optionId }");
    if(optionId == NULL) {
        goto end;
    }
...
TenantOptionsAPI_getSystemTenantOptionById(apiClient_t *apiClient, char *tenantId, char *optionId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *TenantOptionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    option_dto_envelope_t *elementToReturn = option_dto_envelope_parseFromJSON(TenantOptionsAPIlocalVarJSON);
    cJSON_Delete(TenantOptionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TenantOptionsAPI_getSystemTenantOptions(apiClient_t *apiClient, char *tenantId, char *portalId, char *api_version, char *x_api_version, option_dto_collection_query_parameters_t *option_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *TenantOptionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    option_dto_list_envelope_t *elementToReturn = option_dto_list_envelope_parseFromJSON(TenantOptionsAPIlocalVarJSON);
    cJSON_Delete(TenantOptionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TenantOptionsAPI_getSystemTenantOptionsCount(apiClient_t *apiClient, char *tenantId, char *portalId, char *api_version, char *x_api_version, option_dto_collection_query_parameters_t *option_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Tenants/{tenantId}/Options/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Tenants/{tenantId}/Options/Count");
    ...
    //nonprimitive not container
    cJSON *TenantOptionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(TenantOptionsAPIlocalVarJSON);
    cJSON_Delete(TenantOptionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
