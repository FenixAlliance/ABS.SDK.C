...
OptionsAPI_createSystemOption(apiClient_t *apiClient, char *key, char *portalId, char *api_version, char *x_api_version, option_create_dto_t *option_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Options")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Options");
...
OptionsAPI_deleteSystemOption(apiClient_t *apiClient, char *optionId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Options/{optionId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Options/{optionId}");
...
OptionsAPI_getSystemOptionByKey(apiClient_t *apiClient, char *portalId, char *key, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Options/Key/{key}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Options/Key/{key}");
...
OptionsAPI_getSystemOptionsCount(apiClient_t *apiClient, char *portalId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Options/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Options/Count");
...
OptionsAPI_upsertSystemOption(apiClient_t *apiClient, char *key, char *portalId, char *api_version, char *x_api_version, option_update_dto_t *option_update_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Options/Upsert/{key}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Options/Upsert/{key}");
