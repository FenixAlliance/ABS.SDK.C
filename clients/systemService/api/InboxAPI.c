...
InboxAPI_cancelInboxMessageRetry(apiClient_t *apiClient, char *id, char *api_version, char *x_api_version, inbox_admin_reason_dto_t *inbox_admin_reason_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Inbox/Messages/{id}/CancelRetry")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Inbox/Messages/{id}/CancelRetry");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_inbox_admin_reason_dto = NULL;
    if (inbox_admin_reason_dto != NULL)
    {
        //string
        localVarSingleItemJSON_inbox_admin_reason_dto = inbox_admin_reason_dto_convertToJSON(inbox_admin_reason_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_inbox_admin_reason_dto);
    }
    ...
    cJSON *InboxAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(InboxAPIlocalVarJSON);
    cJSON_Delete(InboxAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_inbox_admin_reason_dto) {
        cJSON_Delete(localVarSingleItemJSON_inbox_admin_reason_dto);
        localVarSingleItemJSON_inbox_admin_reason_dto = NULL;
    }
...
InboxAPI_deadLetterInboxMessage(apiClient_t *apiClient, char *id, char *api_version, char *x_api_version, inbox_admin_reason_dto_t *inbox_admin_reason_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Inbox/Messages/{id}/DeadLetter")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Inbox/Messages/{id}/DeadLetter");
...
InboxAPI_expediteInboxMessage(apiClient_t *apiClient, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Inbox/Messages/{id}/Expedite")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Inbox/Messages/{id}/Expedite");
...
InboxAPI_getDuplicateInboxMessages(apiClient_t *apiClient, char *api_version, char *x_api_version, inbox_message_dto_collection_query_parameters_t *inbox_message_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Inbox/Duplicates")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Inbox/Duplicates");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_inbox_message_dto_collection_query_parameters = NULL;
    if (inbox_message_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_inbox_message_dto_collection_query_parameters = inbox_message_dto_collection_query_parameters_convertToJSON(inbox_message_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_inbox_message_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *InboxAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    inbox_message_dto_i_read_only_list_envelope_t *elementToReturn = inbox_message_dto_i_read_only_list_envelope_parseFromJSON(InboxAPIlocalVarJSON);
    cJSON_Delete(InboxAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_inbox_message_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_inbox_message_dto_collection_query_parameters);
        localVarSingleItemJSON_inbox_message_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_api_version){
        free(keyQuery_api_version);
...
InboxAPI_getDuplicateInboxMessagesCount(apiClient_t *apiClient, char *api_version, char *x_api_version, inbox_message_dto_collection_query_parameters_t *inbox_message_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Inbox/Duplicates/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Inbox/Duplicates/Count");
    ...
    //nonprimitive not container
    cJSON *InboxAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(InboxAPIlocalVarJSON);
    cJSON_Delete(InboxAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
InboxAPI_getInboxCorrelationChain(apiClient_t *apiClient, char *correlationId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Inbox/Correlations/{correlationId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Inbox/Correlations/{correlationId}");


    // Path Params
    long sizeOfPathParams_correlationId = strlen(correlationId)+3 + strlen("{ correlationId }");
    if(correlationId == NULL) {
        goto end;
    }
    char* localVarToReplace_correlationId = malloc(sizeOfPathParams_correlationId);
    sprintf(localVarToReplace_correlationId, "{%s}", "correlationId");

    localVarPath = strReplace(localVarPath, localVarToReplace_correlationId, correlationId);
    ...
    free(localVarPath);
    free(localVarToReplace_correlationId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
InboxAPI_getInboxHealth(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Inbox/Health")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Inbox/Health");
    ...
    //nonprimitive not container
    cJSON *InboxAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    inbox_health_dto_envelope_t *elementToReturn = inbox_health_dto_envelope_parseFromJSON(InboxAPIlocalVarJSON);
    cJSON_Delete(InboxAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
InboxAPI_getInboxMessage(apiClient_t *apiClient, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Inbox/Messages/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Inbox/Messages/{id}");
    ...
    //nonprimitive not container
    cJSON *InboxAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    inbox_message_dto_envelope_t *elementToReturn = inbox_message_dto_envelope_parseFromJSON(InboxAPIlocalVarJSON);
    cJSON_Delete(InboxAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
InboxAPI_getInboxMessages(apiClient_t *apiClient, char *api_version, char *x_api_version, inbox_message_dto_collection_query_parameters_t *inbox_message_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Inbox/Messages")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Inbox/Messages");
...
InboxAPI_getInboxMessagesCount(apiClient_t *apiClient, char *api_version, char *x_api_version, inbox_message_dto_collection_query_parameters_t *inbox_message_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Inbox/Messages/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Inbox/Messages/Count");
...
InboxAPI_quarantineInboxMessage(apiClient_t *apiClient, char *id, char *api_version, char *x_api_version, inbox_admin_reason_dto_t *inbox_admin_reason_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Inbox/Messages/{id}/Quarantine")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Inbox/Messages/{id}/Quarantine");
...
InboxAPI_releaseInboxMessageLease(apiClient_t *apiClient, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Inbox/Messages/{id}/ReleaseLease")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Inbox/Messages/{id}/ReleaseLease");
...
InboxAPI_replayInboxMessage(apiClient_t *apiClient, char *id, char *api_version, char *x_api_version, inbox_admin_reason_dto_t *inbox_admin_reason_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Inbox/Messages/{id}/Replay")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Inbox/Messages/{id}/Replay");
    ...
    //nonprimitive not container
    cJSON *InboxAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    inbox_replay_result_dto_envelope_t *elementToReturn = inbox_replay_result_dto_envelope_parseFromJSON(InboxAPIlocalVarJSON);
    cJSON_Delete(InboxAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
