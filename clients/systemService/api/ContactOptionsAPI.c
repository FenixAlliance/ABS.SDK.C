...
ContactOptionsAPI_createSystemContactOption(apiClient_t *apiClient, char *contactId, char *key, char *portalId, char *api_version, char *x_api_version, option_create_dto_t *option_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Contacts/{contactId}/Options")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Contacts/{contactId}/Options");
    ...
    cJSON *ContactOptionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ContactOptionsAPIlocalVarJSON);
    cJSON_Delete(ContactOptionsAPIlocalVarJSON);
...
ContactOptionsAPI_deleteSystemContactOption(apiClient_t *apiClient, char *contactId, char *optionId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Contacts/{contactId}/Options/{optionId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Contacts/{contactId}/Options/{optionId}");
...
ContactOptionsAPI_getSystemContactOptionById(apiClient_t *apiClient, char *contactId, char *optionId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ContactOptionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    option_dto_envelope_t *elementToReturn = option_dto_envelope_parseFromJSON(ContactOptionsAPIlocalVarJSON);
    cJSON_Delete(ContactOptionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ContactOptionsAPI_getSystemContactOptions(apiClient_t *apiClient, char *contactId, char *portalId, char *api_version, char *x_api_version, option_dto_collection_query_parameters_t *option_dto_collection_query_parameters)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = list_createList();
    list_t    *localVarFormParameters = NULL;
    ...
    //nonprimitive not container
    cJSON *ContactOptionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    option_dto_list_envelope_t *elementToReturn = option_dto_list_envelope_parseFromJSON(ContactOptionsAPIlocalVarJSON);
    cJSON_Delete(ContactOptionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
int32_envelope_t*
ContactOptionsAPI_getSystemContactOptionsCount(apiClient_t *apiClient, char *contactId, char *portalId, char *api_version, char *x_api_version, option_dto_collection_query_parameters_t *option_dto_collection_query_parameters)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = list_createList();
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Contacts/{contactId}/Options/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Contacts/{contactId}/Options/Count");
    ...
    //nonprimitive not container
    cJSON *ContactOptionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ContactOptionsAPIlocalVarJSON);
    cJSON_Delete(ContactOptionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
empty_envelope_t*
ContactOptionsAPI_patchSystemContactOption(apiClient_t *apiClient, char *contactId, char *optionId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = list_createList();
    list_t    *localVarFormParameters = NULL;
