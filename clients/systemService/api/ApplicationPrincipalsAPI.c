...
#include <stdio.h>
#include <ctype.h>
#include "ApplicationPrincipalsAPI.h"
...
ApplicationPrincipalsAPI_disableGlobalApplicationPrincipal(apiClient_t *apiClient, char *principalId, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/ApplicationPrincipals/{principalId}/Disable")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/ApplicationPrincipals/{principalId}/Disable");


    // Path Params
    long sizeOfPathParams_principalId = strlen(principalId)+3 + strlen("{ principalId }");
    if(principalId == NULL) {
        goto end;
    }
    char* localVarToReplace_principalId = malloc(sizeOfPathParams_principalId);
    sprintf(localVarToReplace_principalId, "{%s}", "principalId");

    localVarPath = strReplace(localVarPath, localVarToReplace_principalId, principalId);
    if(principalId == NULL) {
        goto end;
    }
    char* localVarToReplace_principalId = malloc(sizeOfPathParams_principalId);
    ...
    cJSON *ApplicationPrincipalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ApplicationPrincipalsAPIlocalVarJSON);
    cJSON_Delete(ApplicationPrincipalsAPIlocalVarJSON);
    ...
    free(localVarPath);
    free(localVarToReplace_principalId);
...
ApplicationPrincipalsAPI_enableGlobalApplicationPrincipal(apiClient_t *apiClient, char *principalId, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/ApplicationPrincipals/{principalId}/Enable")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/ApplicationPrincipals/{principalId}/Enable");
...
ApplicationPrincipalsAPI_getGlobalApplicationPrincipal(apiClient_t *apiClient, char *principalId, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/ApplicationPrincipals/{principalId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/ApplicationPrincipals/{principalId}");
    ...
    //nonprimitive not container
    cJSON *ApplicationPrincipalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    application_principal_detail_dto_envelope_t *elementToReturn = application_principal_detail_dto_envelope_parseFromJSON(ApplicationPrincipalsAPIlocalVarJSON);
    cJSON_Delete(ApplicationPrincipalsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ApplicationPrincipalsAPI_getGlobalApplicationPrincipals(apiClient_t *apiClient, char *api_version, char *x_api_version, application_principal_dto_collection_query_parameters_t *application_principal_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/ApplicationPrincipals")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/ApplicationPrincipals");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_application_principal_dto_collection_query_parameters = NULL;
    if (application_principal_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_application_principal_dto_collection_query_parameters = application_principal_dto_collection_query_parameters_convertToJSON(application_principal_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_application_principal_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    ...
    //nonprimitive not container
    cJSON *ApplicationPrincipalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    application_principal_dto_i_read_only_list_envelope_t *elementToReturn = application_principal_dto_i_read_only_list_envelope_parseFromJSON(ApplicationPrincipalsAPIlocalVarJSON);
    cJSON_Delete(ApplicationPrincipalsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_application_principal_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_application_principal_dto_collection_query_parameters);
        localVarSingleItemJSON_application_principal_dto_collection_query_parameters = NULL;
    }
...
ApplicationPrincipalsAPI_getGlobalApplicationPrincipalsCount(apiClient_t *apiClient, char *api_version, char *x_api_version, application_principal_dto_collection_query_parameters_t *application_principal_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/ApplicationPrincipals/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/ApplicationPrincipals/Count");
    ...
    //nonprimitive not container
    cJSON *ApplicationPrincipalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ApplicationPrincipalsAPIlocalVarJSON);
    cJSON_Delete(ApplicationPrincipalsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ApplicationPrincipalsAPI_grantGlobalApplicationPrincipalPermission(apiClient_t *apiClient, char *principalId, char *tenantId, application_principal_permission_request_dto_t *application_principal_permission_request_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/ApplicationPrincipals/{principalId}/Permissions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/ApplicationPrincipals/{principalId}/Permissions");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_application_principal_permission_request_dto = NULL;
    if (application_principal_permission_request_dto != NULL)
    {
        //string
        localVarSingleItemJSON_application_principal_permission_request_dto = application_principal_permission_request_dto_convertToJSON(application_principal_permission_request_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_application_principal_permission_request_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_application_principal_permission_request_dto) {
        cJSON_Delete(localVarSingleItemJSON_application_principal_permission_request_dto);
        localVarSingleItemJSON_application_principal_permission_request_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ApplicationPrincipalsAPI_provisionGlobalApplicationPrincipal(apiClient_t *apiClient, application_principal_provision_request_dto_t *application_principal_provision_request_dto, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/ApplicationPrincipals/Provision")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/ApplicationPrincipals/Provision");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_application_principal_provision_request_dto = NULL;
    if (application_principal_provision_request_dto != NULL)
    {
        //string
        localVarSingleItemJSON_application_principal_provision_request_dto = application_principal_provision_request_dto_convertToJSON(application_principal_provision_request_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_application_principal_provision_request_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ApplicationPrincipalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    application_principal_provisioning_result_dto_envelope_t *elementToReturn = application_principal_provisioning_result_dto_envelope_parseFromJSON(ApplicationPrincipalsAPIlocalVarJSON);
    cJSON_Delete(ApplicationPrincipalsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_application_principal_provision_request_dto) {
        cJSON_Delete(localVarSingleItemJSON_application_principal_provision_request_dto);
        localVarSingleItemJSON_application_principal_provision_request_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ApplicationPrincipalsAPI_provisionPaymentsConnector(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/ApplicationPrincipals/PaymentsConnector")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/ApplicationPrincipals/PaymentsConnector");
...
ApplicationPrincipalsAPI_revokeGlobalApplicationPrincipalPermission(apiClient_t *apiClient, char *principalId, char *permission, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/ApplicationPrincipals/{principalId}/Permissions/{permission}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/ApplicationPrincipals/{principalId}/Permissions/{permission}");


    // Path Params
    long sizeOfPathParams_principalId = strlen(principalId)+3 + strlen(permission)+3 + strlen("{ principalId }");
    if(principalId == NULL) {
        goto end;
    }
    char* localVarToReplace_principalId = malloc(sizeOfPathParams_principalId);
    ...
    // Path Params
    long sizeOfPathParams_permission = strlen(principalId)+3 + strlen(permission)+3 + strlen("{ permission }");
    if(permission == NULL) {
        goto end;
    }
    char* localVarToReplace_permission = malloc(sizeOfPathParams_permission);
    sprintf(localVarToReplace_permission, "{%s}", "permission");

    localVarPath = strReplace(localVarPath, localVarToReplace_permission, permission);
    ...
    free(localVarPath);
    free(localVarToReplace_principalId);
    free(localVarToReplace_permission);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
ApplicationPrincipalsAPI_suspendGlobalApplicationPrincipal(apiClient_t *apiClient, char *principalId, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/ApplicationPrincipals/{principalId}/Suspend")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/ApplicationPrincipals/{principalId}/Suspend");
