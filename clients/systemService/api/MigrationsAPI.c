...
MigrationsAPI_migrate(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Migrations/Migrate")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Migrations/Migrate");
    ...
    string_list_envelope_t *elementToReturn = string_list_envelope_parseFromJSON(MigrationsAPIlocalVarJSON);
...
MigrationsAPI_migrations(apiClient_t *apiClient, int *pending, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Migrations")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Migrations");
