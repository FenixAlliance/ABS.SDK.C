...
OutboxAPI_cancelOutboxMessage(apiClient_t *apiClient, char *id, char *api_version, char *x_api_version, outbox_admin_reason_dto_t *outbox_admin_reason_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Outbox/Messages/{id}/Cancel")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Outbox/Messages/{id}/Cancel");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_outbox_admin_reason_dto = NULL;
    if (outbox_admin_reason_dto != NULL)
    {
        //string
        localVarSingleItemJSON_outbox_admin_reason_dto = outbox_admin_reason_dto_convertToJSON(outbox_admin_reason_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_outbox_admin_reason_dto);
    }
    ...
    cJSON *OutboxAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(OutboxAPIlocalVarJSON);
    cJSON_Delete(OutboxAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_outbox_admin_reason_dto) {
        cJSON_Delete(localVarSingleItemJSON_outbox_admin_reason_dto);
        localVarSingleItemJSON_outbox_admin_reason_dto = NULL;
    }
...
OutboxAPI_deadLetterOutboxMessage(apiClient_t *apiClient, char *id, char *api_version, char *x_api_version, outbox_admin_reason_dto_t *outbox_admin_reason_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Outbox/Messages/{id}/DeadLetter")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Outbox/Messages/{id}/DeadLetter");
...
OutboxAPI_expediteOutboxMessage(apiClient_t *apiClient, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Outbox/Messages/{id}/Expedite")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Outbox/Messages/{id}/Expedite");
...
OutboxAPI_getOutboxCorrelationChain(apiClient_t *apiClient, char *correlationId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Outbox/Correlations/{correlationId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Outbox/Correlations/{correlationId}");
    ...
    //nonprimitive not container
    cJSON *OutboxAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    outbox_message_dto_i_read_only_list_envelope_t *elementToReturn = outbox_message_dto_i_read_only_list_envelope_parseFromJSON(OutboxAPIlocalVarJSON);
    cJSON_Delete(OutboxAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
OutboxAPI_getOutboxHealth(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Outbox/Health")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Outbox/Health");
    ...
    //nonprimitive not container
    cJSON *OutboxAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    outbox_health_dto_envelope_t *elementToReturn = outbox_health_dto_envelope_parseFromJSON(OutboxAPIlocalVarJSON);
    cJSON_Delete(OutboxAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
OutboxAPI_getOutboxMessage(apiClient_t *apiClient, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Outbox/Messages/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Outbox/Messages/{id}");
    ...
    //nonprimitive not container
    cJSON *OutboxAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    outbox_message_dto_envelope_t *elementToReturn = outbox_message_dto_envelope_parseFromJSON(OutboxAPIlocalVarJSON);
    cJSON_Delete(OutboxAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
OutboxAPI_getOutboxMessages(apiClient_t *apiClient, char *api_version, char *x_api_version, outbox_message_dto_collection_query_parameters_t *outbox_message_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Outbox/Messages")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Outbox/Messages");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_outbox_message_dto_collection_query_parameters = NULL;
    if (outbox_message_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_outbox_message_dto_collection_query_parameters = outbox_message_dto_collection_query_parameters_convertToJSON(outbox_message_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_outbox_message_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_outbox_message_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_outbox_message_dto_collection_query_parameters);
        localVarSingleItemJSON_outbox_message_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_api_version){
        free(keyQuery_api_version);
...
OutboxAPI_getOutboxMessagesCount(apiClient_t *apiClient, char *api_version, char *x_api_version, outbox_message_dto_collection_query_parameters_t *outbox_message_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Outbox/Messages/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Outbox/Messages/Count");
    ...
    //nonprimitive not container
    cJSON *OutboxAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(OutboxAPIlocalVarJSON);
    cJSON_Delete(OutboxAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
OutboxAPI_releaseOutboxMessageLease(apiClient_t *apiClient, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Outbox/Messages/{id}/ReleaseLease")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Outbox/Messages/{id}/ReleaseLease");
...
OutboxAPI_replayOutboxMessage(apiClient_t *apiClient, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Outbox/Messages/{id}/Replay")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Outbox/Messages/{id}/Replay");
