...
IPLookupsAPI_deleteSystemIPLookup(apiClient_t *apiClient, char *ipLookupId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/IPLookups/{ipLookupId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/IPLookups/{ipLookupId}");


    // Path Params
    long sizeOfPathParams_ipLookupId = strlen(ipLookupId)+3 + strlen("{ ipLookupId }");
    if(ipLookupId == NULL) {
        goto end;
    }
    char* localVarToReplace_ipLookupId = malloc(sizeOfPathParams_ipLookupId);
    sprintf(localVarToReplace_ipLookupId, "{%s}", "ipLookupId");

    localVarPath = strReplace(localVarPath, localVarToReplace_ipLookupId, ipLookupId);
    if(ipLookupId == NULL) {
        goto end;
    }
    char* localVarToReplace_ipLookupId = malloc(sizeOfPathParams_ipLookupId);
    ...
    cJSON *IPLookupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(IPLookupsAPIlocalVarJSON);
    cJSON_Delete(IPLookupsAPIlocalVarJSON);
    ...
    free(localVarPath);
    free(localVarToReplace_ipLookupId);
...
IPLookupsAPI_getSystemIPLookupById(apiClient_t *apiClient, char *ipLookupId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *IPLookupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ip_lookup_dto_envelope_t *elementToReturn = ip_lookup_dto_envelope_parseFromJSON(IPLookupsAPIlocalVarJSON);
    cJSON_Delete(IPLookupsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
IPLookupsAPI_getSystemIPLookups(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/IPLookups")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/IPLookups");
    ...
    //nonprimitive not container
    cJSON *IPLookupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ip_lookup_dto_list_envelope_t *elementToReturn = ip_lookup_dto_list_envelope_parseFromJSON(IPLookupsAPIlocalVarJSON);
    cJSON_Delete(IPLookupsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
IPLookupsAPI_getSystemIPLookupsCount(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/IPLookups/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/IPLookups/Count");
    ...
    //nonprimitive not container
    cJSON *IPLookupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(IPLookupsAPIlocalVarJSON);
    cJSON_Delete(IPLookupsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
