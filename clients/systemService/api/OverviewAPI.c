...
OverviewAPI_getSystemOverview(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Overview")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Overview");
    ...
    system_overview_dto_envelope_t *elementToReturn = system_overview_dto_envelope_parseFromJSON(OverviewAPIlocalVarJSON);
