...
ModulesAPI_getAllModules(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/StudioService/Modules")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/StudioService/Modules");
    ...
    studio_module_list_envelope_t *elementToReturn = studio_module_list_envelope_parseFromJSON(ModulesAPIlocalVarJSON);
...
ModulesAPI_getAvailableModules(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/StudioService/Modules/Data")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/StudioService/Modules/Data");
