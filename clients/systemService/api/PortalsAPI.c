...
PortalsAPI_createSystemPortal(apiClient_t *apiClient, char *api_version, char *x_api_version, web_portal_create_dto_t *web_portal_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Portals")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Portals");
...
PortalsAPI_deleteSystemPortal(apiClient_t *apiClient, char *portalId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Portals/{portalId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Portals/{portalId}");
...
PortalsAPI_getSystemPortalsCount(apiClient_t *apiClient, char *api_version, char *x_api_version, web_portal_dto_collection_query_parameters_t *web_portal_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Portals/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Portals/Count");
