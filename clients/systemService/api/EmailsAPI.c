...
EmailsAPI_adminPreviewBasicEmailTemplate(apiClient_t *apiClient, char *api_version, char *x_api_version, object_email_dispatch_request_t *object_email_dispatch_request)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Emails/Preview")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Emails/Preview");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_object_email_dispatch_request = NULL;
    if (object_email_dispatch_request != NULL)
    {
        //string
        localVarSingleItemJSON_object_email_dispatch_request = object_email_dispatch_request_convertToJSON(object_email_dispatch_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_object_email_dispatch_request);
    }
    ...
    if (localVarSingleItemJSON_object_email_dispatch_request) {
        cJSON_Delete(localVarSingleItemJSON_object_email_dispatch_request);
        localVarSingleItemJSON_object_email_dispatch_request = NULL;
    }
...
EmailsAPI_adminSendBasicEmail(apiClient_t *apiClient, char *api_version, char *x_api_version, object_email_dispatch_request_t *object_email_dispatch_request)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SystemService/Emails/SendBasic")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SystemService/Emails/SendBasic");
