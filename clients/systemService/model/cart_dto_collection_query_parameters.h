/*
 * cart_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _cart_dto_collection_query_parameters_H_
#define _cart_dto_collection_query_parameters_H_
...
typedef struct cart_dto_collection_query_parameters_t cart_dto_collection_query_parameters_t;




typedef struct cart_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} cart_dto_collection_query_parameters_t;
...
#endif /* _cart_dto_collection_query_parameters_H_ */
