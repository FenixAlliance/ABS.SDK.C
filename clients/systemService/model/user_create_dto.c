...
cJSON *user_create_dto_convertToJSON(user_create_dto_t *user_create_dto) {
    ...
    if(user_create_dto->gender != systemservice_user_create_dto_GENDER_NULL) {
...
user_create_dto_t *user_create_dto_parseFromJSON(cJSON *user_create_dtoJSON){
    ...
    systemservice_user_create_dto_GENDER_e genderVariable;
    if (gender) { 
    ...
    user_create_dto_local_var = user_create_dto_create (
        ...
        gender ? genderVariable : systemservice_user_create_dto_GENDER_NULL,
