/*
 * ip_lookup_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _ip_lookup_dto_collection_query_parameters_H_
#define _ip_lookup_dto_collection_query_parameters_H_
...
typedef struct ip_lookup_dto_collection_query_parameters_t ip_lookup_dto_collection_query_parameters_t;




typedef struct ip_lookup_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} ip_lookup_dto_collection_query_parameters_t;
...
#endif /* _ip_lookup_dto_collection_query_parameters_H_ */
