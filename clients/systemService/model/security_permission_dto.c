...
security_permission_dto_t *security_permission_dto_create(
    ...
    security_permission_dto_local_var->category = category;
...
void security_permission_dto_free(security_permission_dto_t *security_permission_dto) {
    ...
    if (security_permission_dto->category) {
        free(security_permission_dto->category);
        security_permission_dto->category = NULL;
    }
...
cJSON *security_permission_dto_convertToJSON(security_permission_dto_t *security_permission_dto) {
    ...
    // security_permission_dto->category
    if(security_permission_dto->category) {
    if(cJSON_AddStringToObject(item, "category", security_permission_dto->category) == NULL) {
    goto fail; //String
    }
    }
...
security_permission_dto_t *security_permission_dto_parseFromJSON(cJSON *security_permission_dtoJSON){
    ...
    // security_permission_dto->category
    cJSON *category = cJSON_GetObjectItemCaseSensitive(security_permission_dtoJSON, "category");
    if (category) { 
