...
cJSON *application_principal_dto_convertToJSON(application_principal_dto_t *application_principal_dto) {
    ...
    if(application_principal_dto->principal_kind != systemservice_application_principal_dto_PRINCIPALKIND_NULL) {
    ...
    if(application_principal_dto->principal_status != systemservice_application_principal_dto_PRINCIPALSTATUS_NULL) {
...
application_principal_dto_t *application_principal_dto_parseFromJSON(cJSON *application_principal_dtoJSON){
    ...
    systemservice_application_principal_dto_PRINCIPALKIND_e principal_kindVariable;
    if (principal_kind) { 
    ...
    systemservice_application_principal_dto_PRINCIPALSTATUS_e principal_statusVariable;
    if (principal_status) { 
    ...
    application_principal_dto_local_var = application_principal_dto_create (
        ...
        principal_kind ? principal_kindVariable : systemservice_application_principal_dto_PRINCIPALKIND_NULL,
        principal_status ? principal_statusVariable : systemservice_application_principal_dto_PRINCIPALSTATUS_NULL,
