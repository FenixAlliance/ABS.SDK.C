...
typedef enum  { systemservice_email_dispatch_request_ALERTTYPE_NULL = 0, systemservice_email_dispatch_request_ALERTTYPE_None, systemservice_email_dispatch_request_ALERTTYPE_Info, systemservice_email_dispatch_request_ALERTTYPE_Error, systemservice_email_dispatch_request_ALERTTYPE_Warning, systemservice_email_dispatch_request_ALERTTYPE_Success, systemservice_email_dispatch_request_ALERTTYPE_Action, systemservice_email_dispatch_request_ALERTTYPE_Alert } systemservice_email_dispatch_request_ALERTTYPE_e;

char* email_dispatch_request_alert_type_ToString(systemservice_email_dispatch_request_ALERTTYPE_e alert_type);

systemservice_email_dispatch_request_ALERTTYPE_e email_dispatch_request_alert_type_FromString(char* alert_type);
...
typedef struct email_dispatch_request_t {
    ...
    systemservice_email_dispatch_request_ALERTTYPE_e alert_type; //enum
    char *culture; // string
...
email_dispatch_request_t *email_dispatch_request_create(
    ...
    char *button_text,
    char *alert_message,
    systemservice_email_dispatch_request_ALERTTYPE_e alert_type,
    char *culture,
    char *ui_culture,
    list_t *recipients,
    list_t *contact_ids,
