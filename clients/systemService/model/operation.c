...
cJSON *operation_convertToJSON(operation_t *operation) {
    ...
    if(operation->operation_type != systemservice_operation_OPERATIONTYPE_NULL) {
...
operation_t *operation_parseFromJSON(cJSON *operationJSON){
    ...
    systemservice_operation_OPERATIONTYPE_e operation_typeVariable;
    if (operation_type) { 
    ...
    operation_local_var = operation_create (
        operation_type ? operation_typeVariable : systemservice_operation_OPERATIONTYPE_NULL,
