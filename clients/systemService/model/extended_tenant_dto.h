...
typedef enum  { systemservice_extended_tenant_dto_KIND_NULL = 0, systemservice_extended_tenant_dto_KIND_Organization, systemservice_extended_tenant_dto_KIND_Individual } systemservice_extended_tenant_dto_KIND_e;

char* extended_tenant_dto_kind_ToString(systemservice_extended_tenant_dto_KIND_e kind);

systemservice_extended_tenant_dto_KIND_e extended_tenant_dto_kind_FromString(char* kind);
...
typedef struct extended_tenant_dto_t {
    ...
    systemservice_extended_tenant_dto_KIND_e kind; //enum
    char *tax_id; // string
    char *about; // string
...
extended_tenant_dto_t *extended_tenant_dto_create(
    ...
    char *timestamp,
    char *qualified_name,
    systemservice_extended_tenant_dto_KIND_e kind,
    char *tax_id,
    char *about,
    char *wallet_id,
    char *social_feed_id,
