/*
 * inbox_message_dto_i_read_only_list_envelope.h
 *
 * 
 */

#ifndef _inbox_message_dto_i_read_only_list_envelope_H_
#define _inbox_message_dto_i_read_only_list_envelope_H_
...
typedef struct inbox_message_dto_i_read_only_list_envelope_t inbox_message_dto_i_read_only_list_envelope_t;

#include "inbox_message_dto.h"



typedef struct inbox_message_dto_i_read_only_list_envelope_t {
...
#endif /* _inbox_message_dto_i_read_only_list_envelope_H_ */
