...
//
option_dto_list_envelope_t* TenantOptionsAPI_getSystemTenantOptions(apiClient_t *apiClient, char *tenantId, char *portalId, char *api_version, char *x_api_version);
```
...
//
int32_envelope_t* TenantOptionsAPI_getSystemTenantOptionsCount(apiClient_t *apiClient, char *tenantId, char *portalId, char *api_version, char *x_api_version);
```
