...
//
option_dto_list_envelope_t* ContactOptionsAPI_getSystemContactOptions(apiClient_t *apiClient, char *contactId, char *portalId, char *api_version, char *x_api_version);
```
...
//
int32_envelope_t* ContactOptionsAPI_getSystemContactOptionsCount(apiClient_t *apiClient, char *contactId, char *portalId, char *api_version, char *x_api_version);
```
