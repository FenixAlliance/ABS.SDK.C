...
// Patch a non-fungible token
//
empty_envelope_t* NonFungibleTokensAPI_patchNonFungibleTokenAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *operation);
```
