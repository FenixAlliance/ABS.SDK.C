...
------------ | ------------- | ------------- | -------------
**member_type** | **blockchainsservice_method_base_MEMBERTYPE_e** |  | [optional] [readonly] 
...
**attributes** | **blockchainsservice_method_base_ATTRIBUTES_e** |  | [optional] [readonly] 
**method_implementation_flags** | **blockchainsservice_method_base_METHODIMPLEMENTATIONFLAGS_e** |  | [optional] [readonly] 
**calling_convention** | **blockchainsservice_method_base_CALLINGCONVENTION_e** |  | [optional] [readonly] 
