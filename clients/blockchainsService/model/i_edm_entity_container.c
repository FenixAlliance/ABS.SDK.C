...
cJSON *i_edm_entity_container_convertToJSON(i_edm_entity_container_t *i_edm_entity_container) {
    ...
    if(i_edm_entity_container->schema_element_kind != blockchainsservice_i_edm_entity_container_SCHEMAELEMENTKIND_NULL) {
...
i_edm_entity_container_t *i_edm_entity_container_parseFromJSON(cJSON *i_edm_entity_containerJSON){
    ...
    blockchainsservice_i_edm_entity_container_SCHEMAELEMENTKIND_e schema_element_kindVariable;
    ...
    i_edm_entity_container_local_var = i_edm_entity_container_create (
        ...
        schema_element_kind ? schema_element_kindVariable : blockchainsservice_i_edm_entity_container_SCHEMAELEMENTKIND_NULL,
