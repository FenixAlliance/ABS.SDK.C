...
cJSON *i_edm_schema_element_convertToJSON(i_edm_schema_element_t *i_edm_schema_element) {
    ...
    if(i_edm_schema_element->schema_element_kind != blockchainsservice_i_edm_schema_element_SCHEMAELEMENTKIND_NULL) {
...
i_edm_schema_element_t *i_edm_schema_element_parseFromJSON(cJSON *i_edm_schema_elementJSON){
    ...
    blockchainsservice_i_edm_schema_element_SCHEMAELEMENTKIND_e schema_element_kindVariable;
    ...
    i_edm_schema_element_local_var = i_edm_schema_element_create (
        ...
        schema_element_kind ? schema_element_kindVariable : blockchainsservice_i_edm_schema_element_SCHEMAELEMENTKIND_NULL,
