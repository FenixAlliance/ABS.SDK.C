...
typedef enum  { blockchainsservice_assembly_SECURITYRULESET_NULL = 0, blockchainsservice_assembly_SECURITYRULESET_None, blockchainsservice_assembly_SECURITYRULESET_Level1, blockchainsservice_assembly_SECURITYRULESET_Level2 } blockchainsservice_assembly_SECURITYRULESET_e;

char* assembly_security_rule_set_ToString(blockchainsservice_assembly_SECURITYRULESET_e security_rule_set);

blockchainsservice_assembly_SECURITYRULESET_e assembly_security_rule_set_FromString(char* security_rule_set);
...
typedef struct assembly_t {
    ...
    blockchainsservice_assembly_SECURITYRULESET_e security_rule_set; //enum
...
assembly_t *assembly_create(
    ...
    long host_context,
    blockchainsservice_assembly_SECURITYRULESET_e security_rule_set
);
