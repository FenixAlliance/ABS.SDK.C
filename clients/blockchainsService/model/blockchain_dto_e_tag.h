/*
 * blockchain_dto_e_tag.h
 *
 * 
 */

#ifndef _blockchain_dto_e_tag_H_
#define _blockchain_dto_e_tag_H_
...
typedef struct blockchain_dto_e_tag_t blockchain_dto_e_tag_t;

#include "type.h"



typedef struct blockchain_dto_e_tag_t {
    int is_well_formed; //boolean
    struct type_t *entity_type; //model
    int is_any; //boolean
    int is_if_none_match; //boolean

} blockchain_dto_e_tag_t;
...
#endif /* _blockchain_dto_e_tag_H_ */
