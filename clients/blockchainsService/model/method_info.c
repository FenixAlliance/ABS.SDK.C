...
cJSON *method_info_convertToJSON(method_info_t *method_info) {
    ...
    if(method_info->attributes != blockchainsservice_method_info_ATTRIBUTES_NULL) {
    ...
    if(method_info->method_implementation_flags != blockchainsservice_method_info_METHODIMPLEMENTATIONFLAGS_NULL) {
    ...
    if(method_info->calling_convention != blockchainsservice_method_info_CALLINGCONVENTION_NULL) {
    ...
    if(method_info->member_type != blockchainsservice_method_info_MEMBERTYPE_NULL) {
...
method_info_t *method_info_parseFromJSON(cJSON *method_infoJSON){
    ...
    blockchainsservice_method_info_ATTRIBUTES_e attributesVariable;
    if (attributes) { 
    ...
    blockchainsservice_method_info_METHODIMPLEMENTATIONFLAGS_e method_implementation_flagsVariable;
    ...
    blockchainsservice_method_info_CALLINGCONVENTION_e calling_conventionVariable;
    ...
    blockchainsservice_method_info_MEMBERTYPE_e member_typeVariable;
    if (member_type) { 
    ...
    method_info_local_var = method_info_create (
        ...
        attributes ? attributesVariable : blockchainsservice_method_info_ATTRIBUTES_NULL,
        method_implementation_flags ? method_implementation_flagsVariable : blockchainsservice_method_info_METHODIMPLEMENTATIONFLAGS_NULL,
        calling_convention ? calling_conventionVariable : blockchainsservice_method_info_CALLINGCONVENTION_NULL,
        ...
        member_type ? member_typeVariable : blockchainsservice_method_info_MEMBERTYPE_NULL,
