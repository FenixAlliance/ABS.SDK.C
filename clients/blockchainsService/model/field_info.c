...
cJSON *field_info_convertToJSON(field_info_t *field_info) {
    ...
    if(field_info->member_type != blockchainsservice_field_info_MEMBERTYPE_NULL) {
    ...
    if(field_info->attributes != blockchainsservice_field_info_ATTRIBUTES_NULL) {
...
field_info_t *field_info_parseFromJSON(cJSON *field_infoJSON){
    ...
    blockchainsservice_field_info_MEMBERTYPE_e member_typeVariable;
    if (member_type) { 
    ...
    blockchainsservice_field_info_ATTRIBUTES_e attributesVariable;
    if (attributes) { 
    ...
    field_info_local_var = field_info_create (
        ...
        member_type ? member_typeVariable : blockchainsservice_field_info_MEMBERTYPE_NULL,
        attributes ? attributesVariable : blockchainsservice_field_info_ATTRIBUTES_NULL,
