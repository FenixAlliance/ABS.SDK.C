...
cJSON *type_info_convertToJSON(type_info_t *type_info) {
    ...
    if(type_info->member_type != blockchainsservice_type_info_MEMBERTYPE_NULL) {
    ...
    if(type_info->generic_parameter_attributes != blockchainsservice_type_info_GENERICPARAMETERATTRIBUTES_NULL) {
    ...
    if(type_info->attributes != blockchainsservice_type_info_ATTRIBUTES_NULL) {
...
type_info_t *type_info_parseFromJSON(cJSON *type_infoJSON){
    ...
    blockchainsservice_type_info_MEMBERTYPE_e member_typeVariable;
    if (member_type) { 
    ...
    blockchainsservice_type_info_GENERICPARAMETERATTRIBUTES_e generic_parameter_attributesVariable;
    ...
    blockchainsservice_type_info_ATTRIBUTES_e attributesVariable;
    if (attributes) { 
    ...
    type_info_local_var = type_info_create (
        ...
        member_type ? member_typeVariable : blockchainsservice_type_info_MEMBERTYPE_NULL,
        ...
        generic_parameter_attributes ? generic_parameter_attributesVariable : blockchainsservice_type_info_GENERICPARAMETERATTRIBUTES_NULL,
        attributes ? attributesVariable : blockchainsservice_type_info_ATTRIBUTES_NULL,
