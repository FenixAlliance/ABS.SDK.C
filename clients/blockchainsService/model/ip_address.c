...
cJSON *ip_address_convertToJSON(ip_address_t *ip_address) {
    ...
    if(ip_address->address_family != blockchainsservice_ip_address_ADDRESSFAMILY_NULL) {
...
ip_address_t *ip_address_parseFromJSON(cJSON *ip_addressJSON){
    ...
    blockchainsservice_ip_address_ADDRESSFAMILY_e address_familyVariable;
    if (address_family) { 
    ...
    ip_address_local_var = ip_address_create (
        address_family ? address_familyVariable : blockchainsservice_ip_address_ADDRESSFAMILY_NULL,
