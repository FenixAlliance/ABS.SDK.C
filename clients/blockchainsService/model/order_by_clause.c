...
cJSON *order_by_clause_convertToJSON(order_by_clause_t *order_by_clause) {
    ...
    if(order_by_clause->direction != blockchainsservice_order_by_clause_DIRECTION_NULL) {
...
order_by_clause_t *order_by_clause_parseFromJSON(cJSON *order_by_clauseJSON){
    ...
    blockchainsservice_order_by_clause_DIRECTION_e directionVariable;
    if (direction) { 
    ...
    order_by_clause_local_var = order_by_clause_create (
        ...
        direction ? directionVariable : blockchainsservice_order_by_clause_DIRECTION_NULL,
