...
cJSON *i_edm_entity_type_convertToJSON(i_edm_entity_type_t *i_edm_entity_type) {
    ...
    if(i_edm_entity_type->type_kind != blockchainsservice_i_edm_entity_type_TYPEKIND_NULL) {
    ...
    if(i_edm_entity_type->schema_element_kind != blockchainsservice_i_edm_entity_type_SCHEMAELEMENTKIND_NULL) {
...
i_edm_entity_type_t *i_edm_entity_type_parseFromJSON(cJSON *i_edm_entity_typeJSON){
    ...
    blockchainsservice_i_edm_entity_type_TYPEKIND_e type_kindVariable;
    if (type_kind) { 
    ...
    blockchainsservice_i_edm_entity_type_SCHEMAELEMENTKIND_e schema_element_kindVariable;
    ...
    i_edm_entity_type_local_var = i_edm_entity_type_create (
        type_kind ? type_kindVariable : blockchainsservice_i_edm_entity_type_TYPEKIND_NULL,
        ...
        schema_element_kind ? schema_element_kindVariable : blockchainsservice_i_edm_entity_type_SCHEMAELEMENTKIND_NULL,
