...
cJSON *type_convertToJSON(type_t *type) {
    ...
    // type->member_type
    if(type->member_type != blockchainsservice_type_MEMBERTYPE_NULL) {
    ...
    if(type->generic_parameter_attributes != blockchainsservice_type_GENERICPARAMETERATTRIBUTES_NULL) {
    ...
    // type->attributes
    if(type->attributes != blockchainsservice_type_ATTRIBUTES_NULL) {
...
type_t *type_parseFromJSON(cJSON *typeJSON){
    ...
    blockchainsservice_type_MEMBERTYPE_e member_typeVariable;
    if (member_type) { 
    ...
    blockchainsservice_type_GENERICPARAMETERATTRIBUTES_e generic_parameter_attributesVariable;
    ...
    blockchainsservice_type_ATTRIBUTES_e attributesVariable;
    if (attributes) { 
    ...
    type_local_var = type_create (
        ...
        member_type ? member_typeVariable : blockchainsservice_type_MEMBERTYPE_NULL,
        ...
        generic_parameter_attributes ? generic_parameter_attributesVariable : blockchainsservice_type_GENERICPARAMETERATTRIBUTES_NULL,
        attributes ? attributesVariable : blockchainsservice_type_ATTRIBUTES_NULL,
