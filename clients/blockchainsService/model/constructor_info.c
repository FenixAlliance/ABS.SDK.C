...
cJSON *constructor_info_convertToJSON(constructor_info_t *constructor_info) {
    ...
    if(constructor_info->attributes != blockchainsservice_constructor_info_ATTRIBUTES_NULL) {
    ...
    if(constructor_info->method_implementation_flags != blockchainsservice_constructor_info_METHODIMPLEMENTATIONFLAGS_NULL) {
    ...
    if(constructor_info->calling_convention != blockchainsservice_constructor_info_CALLINGCONVENTION_NULL) {
    ...
    if(constructor_info->member_type != blockchainsservice_constructor_info_MEMBERTYPE_NULL) {
...
constructor_info_t *constructor_info_parseFromJSON(cJSON *constructor_infoJSON){
    ...
    blockchainsservice_constructor_info_ATTRIBUTES_e attributesVariable;
    if (attributes) { 
    ...
    blockchainsservice_constructor_info_METHODIMPLEMENTATIONFLAGS_e method_implementation_flagsVariable;
    ...
    blockchainsservice_constructor_info_CALLINGCONVENTION_e calling_conventionVariable;
    ...
    blockchainsservice_constructor_info_MEMBERTYPE_e member_typeVariable;
    if (member_type) { 
    ...
    constructor_info_local_var = constructor_info_create (
        ...
        attributes ? attributesVariable : blockchainsservice_constructor_info_ATTRIBUTES_NULL,
        method_implementation_flags ? method_implementation_flagsVariable : blockchainsservice_constructor_info_METHODIMPLEMENTATIONFLAGS_NULL,
        calling_convention ? calling_conventionVariable : blockchainsservice_constructor_info_CALLINGCONVENTION_NULL,
        ...
        member_type ? member_typeVariable : blockchainsservice_constructor_info_MEMBERTYPE_NULL
        );
