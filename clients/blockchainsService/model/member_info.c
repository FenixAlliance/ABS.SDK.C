...
cJSON *member_info_convertToJSON(member_info_t *member_info) {
    ...
    if(member_info->member_type != blockchainsservice_member_info_MEMBERTYPE_NULL) {
...
member_info_t *member_info_parseFromJSON(cJSON *member_infoJSON){
    ...
    blockchainsservice_member_info_MEMBERTYPE_e member_typeVariable;
    if (member_type) { 
    ...
    member_info_local_var = member_info_create (
        member_type ? member_typeVariable : blockchainsservice_member_info_MEMBERTYPE_NULL,
