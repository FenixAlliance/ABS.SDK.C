...
cJSON *i_edm_type_convertToJSON(i_edm_type_t *i_edm_type) {
    ...
    if(i_edm_type->type_kind != blockchainsservice_i_edm_type_TYPEKIND_NULL) {
...
i_edm_type_t *i_edm_type_parseFromJSON(cJSON *i_edm_typeJSON){
    ...
    blockchainsservice_i_edm_type_TYPEKIND_e type_kindVariable;
    if (type_kind) { 
    ...
    i_edm_type_local_var = i_edm_type_create (
        type_kind ? type_kindVariable : blockchainsservice_i_edm_type_TYPEKIND_NULL
        );
