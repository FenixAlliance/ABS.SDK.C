...
cJSON *assembly_convertToJSON(assembly_t *assembly) {
    ...
    if(assembly->security_rule_set != blockchainsservice_assembly_SECURITYRULESET_NULL) {
...
assembly_t *assembly_parseFromJSON(cJSON *assemblyJSON){
    ...
    blockchainsservice_assembly_SECURITYRULESET_e security_rule_setVariable;
    ...
    assembly_local_var = assembly_create (
        ...
        security_rule_set ? security_rule_setVariable : blockchainsservice_assembly_SECURITYRULESET_NULL
        );
