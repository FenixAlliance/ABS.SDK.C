...
typedef enum  { blockchainsservice_order_by_clause_DIRECTION_NULL = 0, blockchainsservice_order_by_clause_DIRECTION_Ascending, blockchainsservice_order_by_clause_DIRECTION_Descending } blockchainsservice_order_by_clause_DIRECTION_e;

char* order_by_clause_direction_ToString(blockchainsservice_order_by_clause_DIRECTION_e direction);

blockchainsservice_order_by_clause_DIRECTION_e order_by_clause_direction_FromString(char* direction);
...
typedef struct order_by_clause_t {
    ...
    blockchainsservice_order_by_clause_DIRECTION_e direction; //enum
...
order_by_clause_t *order_by_clause_create(
    ...
    blockchainsservice_order_by_clause_DIRECTION_e direction,
