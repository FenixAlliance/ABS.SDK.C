...
typedef enum  { blockchainsservice_i_edm_property_PROPERTYKIND_NULL = 0, blockchainsservice_i_edm_property_PROPERTYKIND_None, blockchainsservice_i_edm_property_PROPERTYKIND_Structural, blockchainsservice_i_edm_property_PROPERTYKIND_Navigation } blockchainsservice_i_edm_property_PROPERTYKIND_e;
...
typedef struct i_edm_property_t {
    char *name; // string
    blockchainsservice_i_edm_property_PROPERTYKIND_e property_kind; //enum
