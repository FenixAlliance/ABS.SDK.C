...
cJSON *i_edm_path_expression_convertToJSON(i_edm_path_expression_t *i_edm_path_expression) {
    ...
    if(i_edm_path_expression->expression_kind != blockchainsservice_i_edm_path_expression_EXPRESSIONKIND_NULL) {
...
i_edm_path_expression_t *i_edm_path_expression_parseFromJSON(cJSON *i_edm_path_expressionJSON){
    ...
    blockchainsservice_i_edm_path_expression_EXPRESSIONKIND_e expression_kindVariable;
    if (expression_kind) { 
    ...
    i_edm_path_expression_local_var = i_edm_path_expression_create (
        expression_kind ? expression_kindVariable : blockchainsservice_i_edm_path_expression_EXPRESSIONKIND_NULL,
