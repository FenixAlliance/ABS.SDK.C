/*
 * blockchain_block_dto_o_data_query_options.h
 *
 * 
 */

#ifndef _blockchain_block_dto_o_data_query_options_H_
#define _blockchain_block_dto_o_data_query_options_H_
...
typedef struct blockchain_block_dto_o_data_query_options_t blockchain_block_dto_o_data_query_options_t;
...
typedef struct blockchain_block_dto_o_data_query_options_t {
    ...
    struct blockchain_block_dto_e_tag_t *if_match; //model
    struct blockchain_block_dto_e_tag_t *if_none_match; //model

} blockchain_block_dto_o_data_query_options_t;
...
#endif /* _blockchain_block_dto_o_data_query_options_H_ */
