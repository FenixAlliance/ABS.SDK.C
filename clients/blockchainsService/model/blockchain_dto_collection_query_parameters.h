/*
 * blockchain_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _blockchain_dto_collection_query_parameters_H_
#define _blockchain_dto_collection_query_parameters_H_
...
typedef struct blockchain_dto_collection_query_parameters_t blockchain_dto_collection_query_parameters_t;




typedef struct blockchain_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} blockchain_dto_collection_query_parameters_t;
...
#endif /* _blockchain_dto_collection_query_parameters_H_ */
