...
cJSON *parameter_info_convertToJSON(parameter_info_t *parameter_info) {
    ...
    if(parameter_info->attributes != blockchainsservice_parameter_info_ATTRIBUTES_NULL) {
...
parameter_info_t *parameter_info_parseFromJSON(cJSON *parameter_infoJSON){
    ...
    blockchainsservice_parameter_info_ATTRIBUTES_e attributesVariable;
    if (attributes) { 
    ...
    parameter_info_local_var = parameter_info_create (
        attributes ? attributesVariable : blockchainsservice_parameter_info_ATTRIBUTES_NULL,
