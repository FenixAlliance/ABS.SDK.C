...
method_base_t* instantiate_method_base(int include_optional) {
  ...
  if (include_optional) {
    method_base = method_base_create(
      blockchainsservice_method_base_MEMBERTYPE_Constructor,
      "0",
      ...
      1,
      56,
      blockchainsservice_method_base_ATTRIBUTES_PrivateScope,
      blockchainsservice_method_base_METHODIMPLEMENTATIONFLAGS_IL,
      blockchainsservice_method_base_CALLINGCONVENTION_Standard,
      1,
      1,
      1,
      1,
