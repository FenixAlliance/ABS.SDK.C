...
type_info_t* instantiate_type_info(int include_optional) {
  ...
  if (include_optional) {
    type_info = type_info_create(
      ...
      1,
      56,
      blockchainsservice_type_info_MEMBERTYPE_Constructor,
      "0",
      "0",
      "0",
      ...
      list_createList(),
      56,
      blockchainsservice_type_info_GENERICPARAMETERATTRIBUTES_None,
      blockchainsservice_type_info_ATTRIBUTES_NotPublic,
      1,
      1,
      1,
      1,
