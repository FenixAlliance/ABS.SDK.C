...
#include <stdio.h>
#include <ctype.h>
#include "NonFungibleTokensAPI.h"
...
NonFungibleTokensAPI_createNonFungibleTokenAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, non_fungible_token_create_dto_t *non_fungible_token_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/BlockchainsService/NonFungibleTokens")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/BlockchainsService/NonFungibleTokens");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_non_fungible_token_create_dto = NULL;
    if (non_fungible_token_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_non_fungible_token_create_dto = non_fungible_token_create_dto_convertToJSON(non_fungible_token_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_non_fungible_token_create_dto);
    }
    ...
    if (localVarSingleItemJSON_non_fungible_token_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_non_fungible_token_create_dto);
        localVarSingleItemJSON_non_fungible_token_create_dto = NULL;
    }
...
NonFungibleTokensAPI_deleteNonFungibleTokenAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/BlockchainsService/NonFungibleTokens/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/BlockchainsService/NonFungibleTokens/{id}");
...
NonFungibleTokensAPI_getNonFungibleTokenByIdAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    cJSON *NonFungibleTokensAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    non_fungible_token_dto_t *elementToReturn = non_fungible_token_dto_parseFromJSON(NonFungibleTokensAPIlocalVarJSON);
    cJSON_Delete(NonFungibleTokensAPIlocalVarJSON);
...
NonFungibleTokensAPI_getNonFungibleTokensAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, non_fungible_token_dto_collection_query_parameters_t *non_fungible_token_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_non_fungible_token_dto_collection_query_parameters = NULL;
    if (non_fungible_token_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_non_fungible_token_dto_collection_query_parameters = non_fungible_token_dto_collection_query_parameters_convertToJSON(non_fungible_token_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_non_fungible_token_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *NonFungibleTokensAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    non_fungible_token_dto_list_envelope_t *elementToReturn = non_fungible_token_dto_list_envelope_parseFromJSON(NonFungibleTokensAPIlocalVarJSON);
    cJSON_Delete(NonFungibleTokensAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_non_fungible_token_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_non_fungible_token_dto_collection_query_parameters);
        localVarSingleItemJSON_non_fungible_token_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
NonFungibleTokensAPI_getNonFungibleTokensCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, non_fungible_token_dto_collection_query_parameters_t *non_fungible_token_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/BlockchainsService/NonFungibleTokens/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/BlockchainsService/NonFungibleTokens/Count");
    ...
    //nonprimitive not container
    cJSON *NonFungibleTokensAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(NonFungibleTokensAPIlocalVarJSON);
    cJSON_Delete(NonFungibleTokensAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
NonFungibleTokensAPI_patchNonFungibleTokenAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *NonFungibleTokensAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(NonFungibleTokensAPIlocalVarJSON);
    cJSON_Delete(NonFungibleTokensAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
NonFungibleTokensAPI_updateNonFungibleTokenAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, non_fungible_token_update_dto_t *non_fungible_token_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_non_fungible_token_update_dto = NULL;
    if (non_fungible_token_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_non_fungible_token_update_dto = non_fungible_token_update_dto_convertToJSON(non_fungible_token_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_non_fungible_token_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_non_fungible_token_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_non_fungible_token_update_dto);
        localVarSingleItemJSON_non_fungible_token_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
