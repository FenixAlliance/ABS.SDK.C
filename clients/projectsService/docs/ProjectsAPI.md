...
[**ProjectsAPI_createTaskForProjectAsync**](ProjectsAPI.md#ProjectsAPI_createTaskForProjectAsync) | **POST** /api/v2/ProjectsService/Projects/{projectId}/Tasks | Creates a project task
...
[**ProjectsAPI_deleteTaskForProjectAsync**](ProjectsAPI.md#ProjectsAPI_deleteTaskForProjectAsync) | **DELETE** /api/v2/ProjectsService/Projects/{projectId}/Tasks/{projectTaskId} | Deletes a project task
...
[**ProjectsAPI_getTasksForProjectAsync**](ProjectsAPI.md#ProjectsAPI_getTasksForProjectAsync) | **GET** /api/v2/ProjectsService/Projects/{projectId}/Tasks | Retrieves project tasks
[**ProjectsAPI_getTasksForProjectCountAsync**](ProjectsAPI.md#ProjectsAPI_getTasksForProjectCountAsync) | **GET** /api/v2/ProjectsService/Projects/{projectId}/Tasks/Count | Counts project tasks
[**ProjectsAPI_getTimeLogsForProjectAsync**](ProjectsAPI.md#ProjectsAPI_getTimeLogsForProjectAsync) | **GET** /api/v2/ProjectsService/Projects/{projectId}/TimeLogs | Retrieves project time logs
[**ProjectsAPI_patchProjectAsync**](ProjectsAPI.md#ProjectsAPI_patchProjectAsync) | **PATCH** /api/v2/ProjectsService/Projects/{projectId} | Patches a project
[**ProjectsAPI_patchProjectPeriodAsync**](ProjectsAPI.md#ProjectsAPI_patchProjectPeriodAsync) | **PATCH** /api/v2/ProjectsService/Projects/{projectId}/Periods/{projectPeriodId} | Patches a project period
[**ProjectsAPI_patchTaskForProjectAsync**](ProjectsAPI.md#ProjectsAPI_patchTaskForProjectAsync) | **PATCH** /api/v2/ProjectsService/Projects/{projectId}/Tasks/{projectTaskId} | Patches a project task
...
[**ProjectsAPI_updateTaskForProjectAsync**](ProjectsAPI.md#ProjectsAPI_updateTaskForProjectAsync) | **PUT** /api/v2/ProjectsService/Projects/{projectId}/Tasks/{projectTaskId} | Updates a project task
...
# **ProjectsAPI_createTaskForProjectAsync**
```c
// Creates a project task
//
// Creates a new task for the specified project.
//
empty_envelope_t* ProjectsAPI_createTaskForProjectAsync(apiClient_t *apiClient, char *projectId, char *tenantId, project_task_create_dto_t *project_task_create_dto);
```
...
# **ProjectsAPI_deleteTaskForProjectAsync**
```c
// Deletes a project task
//
// Deletes the specified task from a project.
//
empty_envelope_t* ProjectsAPI_deleteTaskForProjectAsync(apiClient_t *apiClient, char *tenantId, char *projectId, char *projectTaskId);
```
...
# **ProjectsAPI_getTasksForProjectAsync**
```c
...
# **ProjectsAPI_getTasksForProjectCountAsync**
```c
...
# **ProjectsAPI_getTimeLogsForProjectAsync**
```c
...
# **ProjectsAPI_patchProjectPeriodAsync**
```c
...
# **ProjectsAPI_patchTaskForProjectAsync**
```c
...
# **ProjectsAPI_updateTaskForProjectAsync**
```c
// Updates a project task
//
// Updates the specified task in a project.
//
empty_envelope_t* ProjectsAPI_updateTaskForProjectAsync(apiClient_t *apiClient, char *projectId, char *projectTaskId, char *tenantId, project_task_update_dto_t *project_task_update_dto);
```
