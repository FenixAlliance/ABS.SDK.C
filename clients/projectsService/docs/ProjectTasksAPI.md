...
//
project_task_dto_list_envelope_t* ProjectTasksAPI_getProjectTasksAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, project_task_dto_collection_query_parameters_t *project_task_dto_collection_query_parameters);
```
...
//
int32_envelope_t* ProjectTasksAPI_getProjectTasksCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, project_task_dto_collection_query_parameters_t *project_task_dto_collection_query_parameters);
```
...
//
empty_envelope_t* ProjectTasksAPI_patchProjectTaskAsync(apiClient_t *apiClient, char *tenantId, char *projectTaskId, char *api_version, char *x_api_version, list_t *patch_operation);
```
