...
ProjectTasksAPI_createProjectTaskAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, project_task_create_dto_t *project_task_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ProjectsService/ProjectTasks")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ProjectsService/ProjectTasks");
    ...
    cJSON *ProjectTasksAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ProjectTasksAPIlocalVarJSON);
    cJSON_Delete(ProjectTasksAPIlocalVarJSON);
...
ProjectTasksAPI_deleteProjectTaskAsync(apiClient_t *apiClient, char *tenantId, char *projectTaskId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ProjectsService/ProjectTasks/{projectTaskId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ProjectsService/ProjectTasks/{projectTaskId}");


    // Path Params
    long sizeOfPathParams_projectTaskId = strlen(projectTaskId)+3 + strlen("{ projectTaskId }");
...
ProjectTasksAPI_getProjectTaskByIdAsync(apiClient_t *apiClient, char *tenantId, char *projectTaskId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ProjectTasksAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    project_task_dto_envelope_t *elementToReturn = project_task_dto_envelope_parseFromJSON(ProjectTasksAPIlocalVarJSON);
    cJSON_Delete(ProjectTasksAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ProjectTasksAPI_getProjectTasksAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, project_task_dto_collection_query_parameters_t *project_task_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *ProjectTasksAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    project_task_dto_list_envelope_t *elementToReturn = project_task_dto_list_envelope_parseFromJSON(ProjectTasksAPIlocalVarJSON);
    cJSON_Delete(ProjectTasksAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ProjectTasksAPI_getProjectTasksCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, project_task_dto_collection_query_parameters_t *project_task_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ProjectsService/ProjectTasks/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ProjectsService/ProjectTasks/Count");
    ...
    //nonprimitive not container
    cJSON *ProjectTasksAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ProjectTasksAPIlocalVarJSON);
    cJSON_Delete(ProjectTasksAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
