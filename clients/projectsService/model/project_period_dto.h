/*
 * project_period_dto.h
 *
 * 
 */

#ifndef _project_period_dto_H_
#define _project_period_dto_H_
...
typedef struct project_period_dto_t project_period_dto_t;




typedef struct project_period_dto_t {
    char *id; // string
