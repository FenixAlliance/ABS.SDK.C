...
typedef enum  { projectsservice_project_time_log_dto_RECORDTYPE_NULL = 0, projectsservice_project_time_log_dto_RECORDTYPE_RegularHours, projectsservice_project_time_log_dto_RECORDTYPE_OvertimeToPay, projectsservice_project_time_log_dto_RECORDTYPE_OvertimeToCompensate } projectsservice_project_time_log_dto_RECORDTYPE_e;
...
typedef struct project_time_log_dto_t {
    ...
    projectsservice_project_time_log_dto_RECORDTYPE_e record_type; //enum
