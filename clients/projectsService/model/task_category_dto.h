...
#ifndef _task_category_dto_H_
#define _task_category_dto_H_
...
typedef struct task_category_dto_t task_category_dto_t;




typedef struct task_category_dto_t {
    char *id; // string
