...
cJSON *project_time_log_create_dto_convertToJSON(project_time_log_create_dto_t *project_time_log_create_dto) {
    ...
    if(project_time_log_create_dto->project_time_log_record_type != projectsservice_project_time_log_create_dto_PROJECTTIMELOGRECORDTYPE_NULL) {
...
project_time_log_create_dto_t *project_time_log_create_dto_parseFromJSON(cJSON *project_time_log_create_dtoJSON){
    ...
    projectsservice_project_time_log_create_dto_PROJECTTIMELOGRECORDTYPE_e project_time_log_record_typeVariable;
    ...
    project_time_log_create_dto_local_var = project_time_log_create_dto_create (
        ...
        project_time_log_record_type ? project_time_log_record_typeVariable : projectsservice_project_time_log_create_dto_PROJECTTIMELOGRECORDTYPE_NULL,
