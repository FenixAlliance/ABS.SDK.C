...
MenuContextsAPI_countMenuContextsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, menu_context_dto_collection_query_parameters_t *menu_context_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/MenuContexts/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/MenuContexts/Count");
    ...
    cJSON *MenuContextsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(MenuContextsAPIlocalVarJSON);
    cJSON_Delete(MenuContextsAPIlocalVarJSON);
...
MenuContextsAPI_createMenuContextAsync(apiClient_t *apiClient, char *tenantId, menu_context_create_dto_t *menu_context_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/MenuContexts")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/MenuContexts");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_menu_context_create_dto = NULL;
    if (menu_context_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_menu_context_create_dto = menu_context_create_dto_convertToJSON(menu_context_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_menu_context_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *MenuContextsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(MenuContextsAPIlocalVarJSON);
    cJSON_Delete(MenuContextsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_menu_context_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_menu_context_create_dto);
        localVarSingleItemJSON_menu_context_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
MenuContextsAPI_deleteMenuContextAsync(apiClient_t *apiClient, char *tenantId, char *menuContextId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/MenuContexts/{menuContextId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/MenuContexts/{menuContextId}");


    // Path Params
    long sizeOfPathParams_menuContextId = strlen(menuContextId)+3 + strlen("{ menuContextId }");
    if(menuContextId == NULL) {
        goto end;
    }
    char* localVarToReplace_menuContextId = malloc(sizeOfPathParams_menuContextId);
    sprintf(localVarToReplace_menuContextId, "{%s}", "menuContextId");

    localVarPath = strReplace(localVarPath, localVarToReplace_menuContextId, menuContextId);
    if(menuContextId == NULL) {
        goto end;
    }
    char* localVarToReplace_menuContextId = malloc(sizeOfPathParams_menuContextId);
    ...
    free(localVarPath);
    free(localVarToReplace_menuContextId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
MenuContextsAPI_getMenuContextByIdAsync(apiClient_t *apiClient, char *tenantId, char *menuContextId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *MenuContextsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    menu_context_dto_envelope_t *elementToReturn = menu_context_dto_envelope_parseFromJSON(MenuContextsAPIlocalVarJSON);
    cJSON_Delete(MenuContextsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
MenuContextsAPI_getMenuContextsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, menu_context_dto_collection_query_parameters_t *menu_context_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *MenuContextsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    menu_context_dto_list_envelope_t *elementToReturn = menu_context_dto_list_envelope_parseFromJSON(MenuContextsAPIlocalVarJSON);
    cJSON_Delete(MenuContextsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
MenuContextsAPI_updateMenuContextAsync(apiClient_t *apiClient, char *tenantId, char *menuContextId, menu_context_update_dto_t *menu_context_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_menu_context_update_dto = NULL;
    if (menu_context_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_menu_context_update_dto = menu_context_update_dto_convertToJSON(menu_context_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_menu_context_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_menu_context_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_menu_context_update_dto);
        localVarSingleItemJSON_menu_context_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
