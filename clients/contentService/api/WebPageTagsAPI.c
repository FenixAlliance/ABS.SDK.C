...
WebPageTagsAPI_countWebPageTagsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/WebPageTags/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/WebPageTags/Count");
    ...
    cJSON *WebPageTagsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(WebPageTagsAPIlocalVarJSON);
    cJSON_Delete(WebPageTagsAPIlocalVarJSON);
...
WebPageTagsAPI_createWebPageTagAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, web_page_tag_create_dto_t *web_page_tag_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/WebPageTags")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/WebPageTags");
    ...
    //nonprimitive not container
    cJSON *WebPageTagsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(WebPageTagsAPIlocalVarJSON);
    cJSON_Delete(WebPageTagsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
WebPageTagsAPI_deleteWebPageTagAsync(apiClient_t *apiClient, char *tenantId, char *webPageTagId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/WebPageTags/{webPageTagId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/WebPageTags/{webPageTagId}");


    // Path Params
    long sizeOfPathParams_webPageTagId = strlen(webPageTagId)+3 + strlen("{ webPageTagId }");
    if(webPageTagId == NULL) {
        goto end;
    }
    char* localVarToReplace_webPageTagId = malloc(sizeOfPathParams_webPageTagId);
    sprintf(localVarToReplace_webPageTagId, "{%s}", "webPageTagId");

    localVarPath = strReplace(localVarPath, localVarToReplace_webPageTagId, webPageTagId);
    if(webPageTagId == NULL) {
        goto end;
    }
    char* localVarToReplace_webPageTagId = malloc(sizeOfPathParams_webPageTagId);
    ...
    free(localVarPath);
    free(localVarToReplace_webPageTagId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
WebPageTagsAPI_getWebPageTagByIdAsync(apiClient_t *apiClient, char *tenantId, char *webPageTagId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *WebPageTagsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    web_page_tag_dto_envelope_t *elementToReturn = web_page_tag_dto_envelope_parseFromJSON(WebPageTagsAPIlocalVarJSON);
    cJSON_Delete(WebPageTagsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
WebPageTagsAPI_getWebPageTagsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *WebPageTagsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    web_page_tag_dto_list_envelope_t *elementToReturn = web_page_tag_dto_list_envelope_parseFromJSON(WebPageTagsAPIlocalVarJSON);
    cJSON_Delete(WebPageTagsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
WebPageTagsAPI_updateWebPageTagAsync(apiClient_t *apiClient, char *tenantId, char *webPageTagId, char *api_version, char *x_api_version, web_page_tag_update_dto_t *web_page_tag_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_web_page_tag_update_dto = NULL;
    if (web_page_tag_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_web_page_tag_update_dto = web_page_tag_update_dto_convertToJSON(web_page_tag_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_web_page_tag_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_web_page_tag_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_web_page_tag_update_dto);
        localVarSingleItemJSON_web_page_tag_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
