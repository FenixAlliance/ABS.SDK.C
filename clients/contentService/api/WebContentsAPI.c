...
WebContentsAPI_countWebContentsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, web_content_dto_collection_query_parameters_t *web_content_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/WebContents/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/WebContents/Count");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_web_content_dto_collection_query_parameters = NULL;
    if (web_content_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_web_content_dto_collection_query_parameters = web_content_dto_collection_query_parameters_convertToJSON(web_content_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_web_content_dto_collection_query_parameters);
    }
    ...
    cJSON *WebContentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(WebContentsAPIlocalVarJSON);
    cJSON_Delete(WebContentsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_web_content_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_web_content_dto_collection_query_parameters);
        localVarSingleItemJSON_web_content_dto_collection_query_parameters = NULL;
    }
...
WebContentsAPI_createWebContentAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, web_content_create_dto_t *web_content_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/WebContents")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/WebContents");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_web_content_create_dto = NULL;
    if (web_content_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_web_content_create_dto = web_content_create_dto_convertToJSON(web_content_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_web_content_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *WebContentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(WebContentsAPIlocalVarJSON);
    cJSON_Delete(WebContentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_web_content_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_web_content_create_dto);
        localVarSingleItemJSON_web_content_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
WebContentsAPI_deleteWebContentAsync(apiClient_t *apiClient, char *tenantId, char *webContentId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/WebContents/{webContentId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/WebContents/{webContentId}");


    // Path Params
    long sizeOfPathParams_webContentId = strlen(webContentId)+3 + strlen("{ webContentId }");
    if(webContentId == NULL) {
        goto end;
    }
    char* localVarToReplace_webContentId = malloc(sizeOfPathParams_webContentId);
    sprintf(localVarToReplace_webContentId, "{%s}", "webContentId");

    localVarPath = strReplace(localVarPath, localVarToReplace_webContentId, webContentId);
    if(webContentId == NULL) {
        goto end;
    }
    char* localVarToReplace_webContentId = malloc(sizeOfPathParams_webContentId);
    ...
    free(localVarPath);
    free(localVarToReplace_webContentId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
WebContentsAPI_getWebContentByIdAsync(apiClient_t *apiClient, char *tenantId, char *webContentId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *WebContentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    web_content_dto_envelope_t *elementToReturn = web_content_dto_envelope_parseFromJSON(WebContentsAPIlocalVarJSON);
    cJSON_Delete(WebContentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
WebContentsAPI_getWebContentsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, web_content_dto_collection_query_parameters_t *web_content_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *WebContentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    web_content_dto_list_envelope_t *elementToReturn = web_content_dto_list_envelope_parseFromJSON(WebContentsAPIlocalVarJSON);
    cJSON_Delete(WebContentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
WebContentsAPI_updateWebContentAsync(apiClient_t *apiClient, char *tenantId, char *webContentId, char *api_version, char *x_api_version, web_content_update_dto_t *web_content_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_web_content_update_dto = NULL;
    if (web_content_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_web_content_update_dto = web_content_update_dto_convertToJSON(web_content_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_web_content_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_web_content_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_web_content_update_dto);
        localVarSingleItemJSON_web_content_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
