...
WebsiteThemesAPI_createWebsiteThemeAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, website_theme_create_dto_t *website_theme_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/WebsiteThemes")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/WebsiteThemes");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_website_theme_create_dto = NULL;
    if (website_theme_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_website_theme_create_dto = website_theme_create_dto_convertToJSON(website_theme_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_website_theme_create_dto);
    }
    ...
    if (localVarSingleItemJSON_website_theme_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_website_theme_create_dto);
        localVarSingleItemJSON_website_theme_create_dto = NULL;
    }
...
WebsiteThemesAPI_deleteWebsiteThemeAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/WebsiteThemes/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/WebsiteThemes/{id}");
...
WebsiteThemesAPI_getWebsiteThemeByIdAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    cJSON *WebsiteThemesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    website_theme_dto_t *elementToReturn = website_theme_dto_parseFromJSON(WebsiteThemesAPIlocalVarJSON);
    cJSON_Delete(WebsiteThemesAPIlocalVarJSON);
...
WebsiteThemesAPI_getWebsiteThemesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, website_theme_dto_collection_query_parameters_t *website_theme_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_website_theme_dto_collection_query_parameters = NULL;
    if (website_theme_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_website_theme_dto_collection_query_parameters = website_theme_dto_collection_query_parameters_convertToJSON(website_theme_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_website_theme_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *WebsiteThemesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    website_theme_dto_list_envelope_t *elementToReturn = website_theme_dto_list_envelope_parseFromJSON(WebsiteThemesAPIlocalVarJSON);
    cJSON_Delete(WebsiteThemesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_website_theme_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_website_theme_dto_collection_query_parameters);
        localVarSingleItemJSON_website_theme_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
WebsiteThemesAPI_getWebsiteThemesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, website_theme_dto_collection_query_parameters_t *website_theme_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/WebsiteThemes/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/WebsiteThemes/Count");
    ...
    //nonprimitive not container
    cJSON *WebsiteThemesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(WebsiteThemesAPIlocalVarJSON);
    cJSON_Delete(WebsiteThemesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
WebsiteThemesAPI_updateWebsiteThemeAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, website_theme_update_dto_t *website_theme_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_website_theme_update_dto = NULL;
    if (website_theme_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_website_theme_update_dto = website_theme_update_dto_convertToJSON(website_theme_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_website_theme_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_website_theme_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_website_theme_update_dto);
        localVarSingleItemJSON_website_theme_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
