...
BlogPostAuthorsAPI_countBlogPostsByAuthorAsync(apiClient_t *apiClient, char *authorId, char *api_version, char *x_api_version, blog_post_dto_collection_query_parameters_t *blog_post_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/BlogPostAuthors/{authorId}/BlogPosts/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/BlogPostAuthors/{authorId}/BlogPosts/Count");


    // Path Params
    long sizeOfPathParams_authorId = strlen(authorId)+3 + strlen("{ authorId }");
    if(authorId == NULL) {
        goto end;
    }
    char* localVarToReplace_authorId = malloc(sizeOfPathParams_authorId);
    sprintf(localVarToReplace_authorId, "{%s}", "authorId");

    localVarPath = strReplace(localVarPath, localVarToReplace_authorId, authorId);
    if(authorId == NULL) {
        goto end;
    }
    char* localVarToReplace_authorId = malloc(sizeOfPathParams_authorId);
    ...
    cJSON *BlogPostAuthorsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(BlogPostAuthorsAPIlocalVarJSON);
    cJSON_Delete(BlogPostAuthorsAPIlocalVarJSON);
    ...
    free(localVarPath);
    free(localVarToReplace_authorId);
...
BlogPostAuthorsAPI_getBlogAuthorByIdAsync(apiClient_t *apiClient, char *authorId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/BlogPostAuthors/{authorId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/BlogPostAuthors/{authorId}");
    ...
    //nonprimitive not container
    cJSON *BlogPostAuthorsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    blog_author_dto_envelope_t *elementToReturn = blog_author_dto_envelope_parseFromJSON(BlogPostAuthorsAPIlocalVarJSON);
    cJSON_Delete(BlogPostAuthorsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BlogPostAuthorsAPI_getBlogAuthorsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, blog_author_dto_collection_query_parameters_t *blog_author_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/BlogPostAuthors")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/BlogPostAuthors");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_blog_author_dto_collection_query_parameters = NULL;
    if (blog_author_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_blog_author_dto_collection_query_parameters = blog_author_dto_collection_query_parameters_convertToJSON(blog_author_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_blog_author_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *BlogPostAuthorsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    blog_author_dto_list_envelope_t *elementToReturn = blog_author_dto_list_envelope_parseFromJSON(BlogPostAuthorsAPIlocalVarJSON);
    cJSON_Delete(BlogPostAuthorsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_blog_author_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_blog_author_dto_collection_query_parameters);
        localVarSingleItemJSON_blog_author_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
...
BlogPostAuthorsAPI_getBlogPostsByAuthorAsync(apiClient_t *apiClient, char *authorId, char *api_version, char *x_api_version, blog_post_dto_collection_query_parameters_t *blog_post_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/BlogPostAuthors/{authorId}/BlogPosts")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/BlogPostAuthors/{authorId}/BlogPosts");
    ...
    //nonprimitive not container
    cJSON *BlogPostAuthorsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    blog_post_dto_list_envelope_t *elementToReturn = blog_post_dto_list_envelope_parseFromJSON(BlogPostAuthorsAPIlocalVarJSON);
    cJSON_Delete(BlogPostAuthorsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
