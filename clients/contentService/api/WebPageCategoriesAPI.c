...
#include <stdio.h>
#include <ctype.h>
#include "WebPageCategoriesAPI.h"
...
WebPageCategoriesAPI_countWebPageCategoriesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, web_page_category_dto_collection_query_parameters_t *web_page_category_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/WebPageCategories/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/WebPageCategories/Count");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_web_page_category_dto_collection_query_parameters = NULL;
    if (web_page_category_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_web_page_category_dto_collection_query_parameters = web_page_category_dto_collection_query_parameters_convertToJSON(web_page_category_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_web_page_category_dto_collection_query_parameters);
    }
    ...
    cJSON *WebPageCategoriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(WebPageCategoriesAPIlocalVarJSON);
    cJSON_Delete(WebPageCategoriesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_web_page_category_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_web_page_category_dto_collection_query_parameters);
        localVarSingleItemJSON_web_page_category_dto_collection_query_parameters = NULL;
    }
...
WebPageCategoriesAPI_createWebPageCategoryAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, web_page_category_create_dto_t *web_page_category_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/WebPageCategories")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/WebPageCategories");
    ...
    //nonprimitive not container
    cJSON *WebPageCategoriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(WebPageCategoriesAPIlocalVarJSON);
    cJSON_Delete(WebPageCategoriesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
WebPageCategoriesAPI_deleteWebPageCategoryAsync(apiClient_t *apiClient, char *tenantId, char *webPageCategoryId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/WebPageCategories/{webPageCategoryId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/WebPageCategories/{webPageCategoryId}");


    // Path Params
    long sizeOfPathParams_webPageCategoryId = strlen(webPageCategoryId)+3 + strlen("{ webPageCategoryId }");
    if(webPageCategoryId == NULL) {
        goto end;
    }
    char* localVarToReplace_webPageCategoryId = malloc(sizeOfPathParams_webPageCategoryId);
    sprintf(localVarToReplace_webPageCategoryId, "{%s}", "webPageCategoryId");

    localVarPath = strReplace(localVarPath, localVarToReplace_webPageCategoryId, webPageCategoryId);
    if(webPageCategoryId == NULL) {
        goto end;
    }
    char* localVarToReplace_webPageCategoryId = malloc(sizeOfPathParams_webPageCategoryId);
    ...
    free(localVarPath);
    free(localVarToReplace_webPageCategoryId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
WebPageCategoriesAPI_getWebPageCategoriesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, web_page_category_dto_collection_query_parameters_t *web_page_category_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *WebPageCategoriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    web_page_category_dto_list_envelope_t *elementToReturn = web_page_category_dto_list_envelope_parseFromJSON(WebPageCategoriesAPIlocalVarJSON);
    cJSON_Delete(WebPageCategoriesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
WebPageCategoriesAPI_getWebPageCategoryByIdAsync(apiClient_t *apiClient, char *tenantId, char *webPageCategoryId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *WebPageCategoriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    web_page_category_dto_envelope_t *elementToReturn = web_page_category_dto_envelope_parseFromJSON(WebPageCategoriesAPIlocalVarJSON);
    cJSON_Delete(WebPageCategoriesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
WebPageCategoriesAPI_updateWebPageCategoryAsync(apiClient_t *apiClient, char *tenantId, char *webPageCategoryId, char *api_version, char *x_api_version, web_page_category_update_dto_t *web_page_category_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_web_page_category_update_dto = NULL;
    if (web_page_category_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_web_page_category_update_dto = web_page_category_update_dto_convertToJSON(web_page_category_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_web_page_category_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_web_page_category_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_web_page_category_update_dto);
        localVarSingleItemJSON_web_page_category_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
