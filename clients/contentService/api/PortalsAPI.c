...
PortalsAPI_bindWebPortalDomainAsync(apiClient_t *apiClient, char *tenantId, char *portalId, char *businessDomainId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/Portals/{portalId}/DomainBindings/{businessDomainId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/Portals/{portalId}/DomainBindings/{businessDomainId}");


    // Path Params
    long sizeOfPathParams_portalId = strlen(portalId)+3 + strlen(businessDomainId)+3 + strlen("{ portalId }");
    if(portalId == NULL) {
        goto end;
    }
    char* localVarToReplace_portalId = malloc(sizeOfPathParams_portalId);
    sprintf(localVarToReplace_portalId, "{%s}", "portalId");

    localVarPath = strReplace(localVarPath, localVarToReplace_portalId, portalId);
    if(portalId == NULL) {
        goto end;
    }
    char* localVarToReplace_portalId = malloc(sizeOfPathParams_portalId);
    ...
    // Path Params
    long sizeOfPathParams_businessDomainId = strlen(portalId)+3 + strlen(businessDomainId)+3 + strlen("{ businessDomainId }");
    if(businessDomainId == NULL) {
        goto end;
    }
    char* localVarToReplace_businessDomainId = malloc(sizeOfPathParams_businessDomainId);
    sprintf(localVarToReplace_businessDomainId, "{%s}", "businessDomainId");

    localVarPath = strReplace(localVarPath, localVarToReplace_businessDomainId, businessDomainId);
    if(businessDomainId == NULL) {
        goto end;
    }
    char* localVarToReplace_businessDomainId = malloc(sizeOfPathParams_businessDomainId);
    ...
    cJSON *PortalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(PortalsAPIlocalVarJSON);
    cJSON_Delete(PortalsAPIlocalVarJSON);
    ...
    free(localVarPath);
    free(localVarToReplace_portalId);
    free(localVarToReplace_businessDomainId);
...
PortalsAPI_countPortalsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, web_portal_dto_collection_query_parameters_t *web_portal_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/Portals/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/Portals/Count");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_web_portal_dto_collection_query_parameters = NULL;
    if (web_portal_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_web_portal_dto_collection_query_parameters = web_portal_dto_collection_query_parameters_convertToJSON(web_portal_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_web_portal_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    ...
    //nonprimitive not container
    cJSON *PortalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(PortalsAPIlocalVarJSON);
    cJSON_Delete(PortalsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_web_portal_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_web_portal_dto_collection_query_parameters);
        localVarSingleItemJSON_web_portal_dto_collection_query_parameters = NULL;
    }
...
PortalsAPI_createWebPortalAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, web_portal_create_dto_t *web_portal_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/Portals")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/Portals");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_web_portal_create_dto = NULL;
    if (web_portal_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_web_portal_create_dto = web_portal_create_dto_convertToJSON(web_portal_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_web_portal_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_web_portal_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_web_portal_create_dto);
        localVarSingleItemJSON_web_portal_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
PortalsAPI_deleteWebPortalAsync(apiClient_t *apiClient, char *tenantId, char *portalId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/Portals/{portalId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/Portals/{portalId}");


    // Path Params
    long sizeOfPathParams_portalId = strlen(portalId)+3 + strlen("{ portalId }");
    if(portalId == NULL) {
        goto end;
    }
    char* localVarToReplace_portalId = malloc(sizeOfPathParams_portalId);
...
PortalsAPI_getCurrentWebPortalAsync(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/Portals/Current")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/Portals/Current");
    ...
    //nonprimitive not container
    cJSON *PortalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    web_portal_dto_envelope_t *elementToReturn = web_portal_dto_envelope_parseFromJSON(PortalsAPIlocalVarJSON);
    cJSON_Delete(PortalsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
PortalsAPI_getCurrentWebPortalOptionsAsync(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/Portals/Current/Options")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/Portals/Current/Options");
    ...
    //nonprimitive not container
    cJSON *PortalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    portal_options_envelope_t *elementToReturn = portal_options_envelope_parseFromJSON(PortalsAPIlocalVarJSON);
    cJSON_Delete(PortalsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
PortalsAPI_getPortalsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, web_portal_dto_collection_query_parameters_t *web_portal_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *PortalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    web_portal_dto_list_envelope_t *elementToReturn = web_portal_dto_list_envelope_parseFromJSON(PortalsAPIlocalVarJSON);
    cJSON_Delete(PortalsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
PortalsAPI_getRootWebPortalAsync(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/Portals/Root")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/Portals/Root");
...
PortalsAPI_getWebPortalDomainBindingsAsync(apiClient_t *apiClient, char *tenantId, char *portalId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/Portals/{portalId}/DomainBindings")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/Portals/{portalId}/DomainBindings");
    ...
    //nonprimitive not container
    cJSON *PortalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    business_domain_dto_list_envelope_t *elementToReturn = business_domain_dto_list_envelope_parseFromJSON(PortalsAPIlocalVarJSON);
    cJSON_Delete(PortalsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
PortalsAPI_getWebPortalOptionsAsync(apiClient_t *apiClient, char *portalId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/Portals/{portalId}/Options")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/Portals/{portalId}/Options");
...
PortalsAPI_getWebPortalSettingsAsync(apiClient_t *apiClient, char *portalId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/Portals/{portalId}/Settings")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/Portals/{portalId}/Settings");
    ...
    //nonprimitive not container
    cJSON *PortalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    portal_settings_envelope_t *elementToReturn = portal_settings_envelope_parseFromJSON(PortalsAPIlocalVarJSON);
    cJSON_Delete(PortalsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
PortalsAPI_initializeCurrentWebPortalAsync(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/Portals/Initialize")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/Portals/Initialize");
    ...
    //nonprimitive not container
    cJSON *PortalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    execution_context_envelope_t *elementToReturn = execution_context_envelope_parseFromJSON(PortalsAPIlocalVarJSON);
    cJSON_Delete(PortalsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
PortalsAPI_searchWebPortalAsync(apiClient_t *apiClient, char *domain, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/Portals/Search")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/Portals/Search");
...
PortalsAPI_updateWebPortalAsync(apiClient_t *apiClient, char *tenantId, char *portalId, char *api_version, char *x_api_version, web_portal_update_dto_t *web_portal_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_web_portal_update_dto = NULL;
    if (web_portal_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_web_portal_update_dto = web_portal_update_dto_convertToJSON(web_portal_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_web_portal_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_web_portal_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_web_portal_update_dto);
        localVarSingleItemJSON_web_portal_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
PortalsAPI_updateWebPortalSettingsAsync(apiClient_t *apiClient, char *tenantId, char *portalId, char *api_version, char *x_api_version, portal_settings_t *portal_settings)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_portal_settings = NULL;
    if (portal_settings != NULL)
    {
        //string
        localVarSingleItemJSON_portal_settings = portal_settings_convertToJSON(portal_settings);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_portal_settings);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_portal_settings) {
        cJSON_Delete(localVarSingleItemJSON_portal_settings);
        localVarSingleItemJSON_portal_settings = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
