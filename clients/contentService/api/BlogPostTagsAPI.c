...
BlogPostTagsAPI_countBlogPostTagsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, blog_post_tag_dto_collection_query_parameters_t *blog_post_tag_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/BlogPostTags/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/BlogPostTags/Count");
    ...
    cJSON *BlogPostTagsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(BlogPostTagsAPIlocalVarJSON);
    cJSON_Delete(BlogPostTagsAPIlocalVarJSON);
...
BlogPostTagsAPI_createBlogPostTagAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, blog_post_tag_create_dto_t *blog_post_tag_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/BlogPostTags")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/BlogPostTags");
    ...
    //nonprimitive not container
    cJSON *BlogPostTagsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(BlogPostTagsAPIlocalVarJSON);
    cJSON_Delete(BlogPostTagsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BlogPostTagsAPI_deleteBlogPostTagAsync(apiClient_t *apiClient, char *tenantId, char *blogPostTagId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/BlogPostTags/{blogPostTagId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/BlogPostTags/{blogPostTagId}");


    // Path Params
    long sizeOfPathParams_blogPostTagId = strlen(blogPostTagId)+3 + strlen("{ blogPostTagId }");
    if(blogPostTagId == NULL) {
        goto end;
    }
    char* localVarToReplace_blogPostTagId = malloc(sizeOfPathParams_blogPostTagId);
    sprintf(localVarToReplace_blogPostTagId, "{%s}", "blogPostTagId");

    localVarPath = strReplace(localVarPath, localVarToReplace_blogPostTagId, blogPostTagId);
    if(blogPostTagId == NULL) {
        goto end;
    }
    char* localVarToReplace_blogPostTagId = malloc(sizeOfPathParams_blogPostTagId);
    ...
    free(localVarPath);
    free(localVarToReplace_blogPostTagId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
BlogPostTagsAPI_getBlogPostTagByIdAsync(apiClient_t *apiClient, char *tenantId, char *blogPostTagId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *BlogPostTagsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    blog_post_tag_dto_envelope_t *elementToReturn = blog_post_tag_dto_envelope_parseFromJSON(BlogPostTagsAPIlocalVarJSON);
    cJSON_Delete(BlogPostTagsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BlogPostTagsAPI_getBlogPostTagsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, blog_post_tag_dto_collection_query_parameters_t *blog_post_tag_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *BlogPostTagsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    blog_post_tag_dto_list_envelope_t *elementToReturn = blog_post_tag_dto_list_envelope_parseFromJSON(BlogPostTagsAPIlocalVarJSON);
    cJSON_Delete(BlogPostTagsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BlogPostTagsAPI_updateBlogPostTagAsync(apiClient_t *apiClient, char *tenantId, char *blogPostTagId, char *api_version, char *x_api_version, blog_post_tag_update_dto_t *blog_post_tag_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_blog_post_tag_update_dto = NULL;
    if (blog_post_tag_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_blog_post_tag_update_dto = blog_post_tag_update_dto_convertToJSON(blog_post_tag_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_blog_post_tag_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_blog_post_tag_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_blog_post_tag_update_dto);
        localVarSingleItemJSON_blog_post_tag_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
