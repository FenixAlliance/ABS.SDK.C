...
BusinessDomainsAPI_createBusinessDomainAsync(apiClient_t *apiClient, char *tenantId, business_domain_create_dto_t *business_domain_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/BusinessDomains")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/BusinessDomains");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_business_domain_create_dto = NULL;
    if (business_domain_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_business_domain_create_dto = business_domain_create_dto_convertToJSON(business_domain_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_business_domain_create_dto);
    }
    ...
    cJSON *BusinessDomainsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(BusinessDomainsAPIlocalVarJSON);
    cJSON_Delete(BusinessDomainsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_business_domain_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_business_domain_create_dto);
        localVarSingleItemJSON_business_domain_create_dto = NULL;
    }
...
BusinessDomainsAPI_deleteBusinessDomainAsync(apiClient_t *apiClient, char *tenantId, char *businessDomainId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/BusinessDomains/{businessDomainId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/BusinessDomains/{businessDomainId}");


    // Path Params
    long sizeOfPathParams_businessDomainId = strlen(businessDomainId)+3 + strlen("{ businessDomainId }");
...
BusinessDomainsAPI_getBusinessDomainByIdAsync(apiClient_t *apiClient, char *tenantId, char *businessDomainId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *BusinessDomainsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    business_domain_dto_envelope_t *elementToReturn = business_domain_dto_envelope_parseFromJSON(BusinessDomainsAPIlocalVarJSON);
    cJSON_Delete(BusinessDomainsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BusinessDomainsAPI_getBusinessDomainsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, business_domain_dto_collection_query_parameters_t *business_domain_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *BusinessDomainsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    business_domain_dto_list_envelope_t *elementToReturn = business_domain_dto_list_envelope_parseFromJSON(BusinessDomainsAPIlocalVarJSON);
    cJSON_Delete(BusinessDomainsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BusinessDomainsAPI_getBusinessDomainsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, business_domain_dto_collection_query_parameters_t *business_domain_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/BusinessDomains/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/BusinessDomains/Count");
    ...
    //nonprimitive not container
    cJSON *BusinessDomainsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(BusinessDomainsAPIlocalVarJSON);
    cJSON_Delete(BusinessDomainsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BusinessDomainsAPI_updateBusinessDomainAsync(apiClient_t *apiClient, char *tenantId, char *businessDomainId, business_domain_update_dto_t *business_domain_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_business_domain_update_dto = NULL;
    if (business_domain_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_business_domain_update_dto = business_domain_update_dto_convertToJSON(business_domain_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_business_domain_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_business_domain_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_business_domain_update_dto);
        localVarSingleItemJSON_business_domain_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
BusinessDomainsAPI_verifyBusinessDomainAsync(apiClient_t *apiClient, char *tenantId, char *businessDomainId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/BusinessDomains/{businessDomainId}/Verify")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/BusinessDomains/{businessDomainId}/Verify");
