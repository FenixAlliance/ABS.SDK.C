...
#include <stdio.h>
#include <ctype.h>
#include "BlogPostCategoriesAPI.h"
...
BlogPostCategoriesAPI_countBlogPostCategoriesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/BlogPostCategories/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/BlogPostCategories/Count");
    ...
    cJSON *BlogPostCategoriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(BlogPostCategoriesAPIlocalVarJSON);
    cJSON_Delete(BlogPostCategoriesAPIlocalVarJSON);
...
BlogPostCategoriesAPI_createBlogPostCategoryAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, blog_post_category_create_dto_t *blog_post_category_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/BlogPostCategories")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/BlogPostCategories");
    ...
    //nonprimitive not container
    cJSON *BlogPostCategoriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(BlogPostCategoriesAPIlocalVarJSON);
    cJSON_Delete(BlogPostCategoriesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BlogPostCategoriesAPI_deleteBlogPostCategoryAsync(apiClient_t *apiClient, char *tenantId, char *blogPostCategoryId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/BlogPostCategories/{blogPostCategoryId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/BlogPostCategories/{blogPostCategoryId}");


    // Path Params
    long sizeOfPathParams_blogPostCategoryId = strlen(blogPostCategoryId)+3 + strlen("{ blogPostCategoryId }");
    if(blogPostCategoryId == NULL) {
        goto end;
    }
    char* localVarToReplace_blogPostCategoryId = malloc(sizeOfPathParams_blogPostCategoryId);
    sprintf(localVarToReplace_blogPostCategoryId, "{%s}", "blogPostCategoryId");

    localVarPath = strReplace(localVarPath, localVarToReplace_blogPostCategoryId, blogPostCategoryId);
    if(blogPostCategoryId == NULL) {
        goto end;
    }
    char* localVarToReplace_blogPostCategoryId = malloc(sizeOfPathParams_blogPostCategoryId);
    ...
    free(localVarPath);
    free(localVarToReplace_blogPostCategoryId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
BlogPostCategoriesAPI_getBlogPostCategoriesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *BlogPostCategoriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    blog_post_category_dto_list_envelope_t *elementToReturn = blog_post_category_dto_list_envelope_parseFromJSON(BlogPostCategoriesAPIlocalVarJSON);
    cJSON_Delete(BlogPostCategoriesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BlogPostCategoriesAPI_getBlogPostCategoryByIdAsync(apiClient_t *apiClient, char *tenantId, char *blogPostCategoryId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *BlogPostCategoriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    blog_post_category_dto_envelope_t *elementToReturn = blog_post_category_dto_envelope_parseFromJSON(BlogPostCategoriesAPIlocalVarJSON);
    cJSON_Delete(BlogPostCategoriesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BlogPostCategoriesAPI_updateBlogPostCategoryAsync(apiClient_t *apiClient, char *tenantId, char *blogPostCategoryId, char *api_version, char *x_api_version, blog_post_category_update_dto_t *blog_post_category_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_blog_post_category_update_dto = NULL;
    if (blog_post_category_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_blog_post_category_update_dto = blog_post_category_update_dto_convertToJSON(blog_post_category_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_blog_post_category_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_blog_post_category_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_blog_post_category_update_dto);
        localVarSingleItemJSON_blog_post_category_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
