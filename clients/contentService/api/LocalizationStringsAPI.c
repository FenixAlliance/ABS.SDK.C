...
#include <stdio.h>
#include <ctype.h>
#include "LocalizationStringsAPI.h"
...
LocalizationStringsAPI_countLocalizationStringsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, localization_string_dto_collection_query_parameters_t *localization_string_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/LocalizationStrings/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/LocalizationStrings/Count");
    ...
    cJSON *LocalizationStringsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(LocalizationStringsAPIlocalVarJSON);
    cJSON_Delete(LocalizationStringsAPIlocalVarJSON);
...
LocalizationStringsAPI_createLocalizationStringAsync(apiClient_t *apiClient, char *tenantId, localization_string_create_dto_t *localization_string_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/LocalizationStrings")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/LocalizationStrings");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_localization_string_create_dto = NULL;
    if (localization_string_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_localization_string_create_dto = localization_string_create_dto_convertToJSON(localization_string_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_localization_string_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *LocalizationStringsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(LocalizationStringsAPIlocalVarJSON);
    cJSON_Delete(LocalizationStringsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_localization_string_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_localization_string_create_dto);
        localVarSingleItemJSON_localization_string_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
LocalizationStringsAPI_deleteLocalizationStringAsync(apiClient_t *apiClient, char *tenantId, char *localizationStringId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ContentService/LocalizationStrings/{localizationStringId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ContentService/LocalizationStrings/{localizationStringId}");


    // Path Params
    long sizeOfPathParams_localizationStringId = strlen(localizationStringId)+3 + strlen("{ localizationStringId }");
    if(localizationStringId == NULL) {
        goto end;
    }
    char* localVarToReplace_localizationStringId = malloc(sizeOfPathParams_localizationStringId);
    sprintf(localVarToReplace_localizationStringId, "{%s}", "localizationStringId");

    localVarPath = strReplace(localVarPath, localVarToReplace_localizationStringId, localizationStringId);
    if(localizationStringId == NULL) {
        goto end;
    }
    char* localVarToReplace_localizationStringId = malloc(sizeOfPathParams_localizationStringId);
    ...
    free(localVarPath);
    free(localVarToReplace_localizationStringId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
LocalizationStringsAPI_getLocalizationStringByIdAsync(apiClient_t *apiClient, char *tenantId, char *localizationStringId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *LocalizationStringsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    localization_string_dto_envelope_t *elementToReturn = localization_string_dto_envelope_parseFromJSON(LocalizationStringsAPIlocalVarJSON);
    cJSON_Delete(LocalizationStringsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
LocalizationStringsAPI_getLocalizationStringsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, localization_string_dto_collection_query_parameters_t *localization_string_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *LocalizationStringsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    localization_string_dto_list_envelope_t *elementToReturn = localization_string_dto_list_envelope_parseFromJSON(LocalizationStringsAPIlocalVarJSON);
    cJSON_Delete(LocalizationStringsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
LocalizationStringsAPI_updateLocalizationStringAsync(apiClient_t *apiClient, char *tenantId, char *localizationStringId, localization_string_update_dto_t *localization_string_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_localization_string_update_dto = NULL;
    if (localization_string_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_localization_string_update_dto = localization_string_update_dto_convertToJSON(localization_string_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_localization_string_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_localization_string_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_localization_string_update_dto);
        localVarSingleItemJSON_localization_string_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
