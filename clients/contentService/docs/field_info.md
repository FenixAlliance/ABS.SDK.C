...
**member_type** | **contentservice_field_info_MEMBERTYPE_e** |  | [optional] [readonly] 
**attributes** | **contentservice_field_info_ATTRIBUTES_e** |  | [optional] [readonly] 
**field_type** | [**type_t**](type.md) \* |  | [optional] 
**is_init_only** | **int** |  | [optional] [readonly] 
**is_literal** | **int** |  | [optional] [readonly] 
**is_not_serialized** | **int** |  | [optional] [readonly] 
**is_pinvoke_impl** | **int** |  | [optional] [readonly] 
...
**field_handle** | [**runtime_field_handle_t**](runtime_field_handle.md) \* |  | [optional] 
