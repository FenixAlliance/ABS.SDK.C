...
//
int32_envelope_t* WebComponentsAPI_countWebComponentsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
//
web_component_dto_list_envelope_t* WebComponentsAPI_getWebComponentsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
