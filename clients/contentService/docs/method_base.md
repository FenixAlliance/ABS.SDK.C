...
------------ | ------------- | ------------- | -------------
**member_type** | **contentservice_method_base_MEMBERTYPE_e** |  | [optional] [readonly] 
...
**attributes** | **contentservice_method_base_ATTRIBUTES_e** |  | [optional] [readonly] 
**method_implementation_flags** | **contentservice_method_base_METHODIMPLEMENTATIONFLAGS_e** |  | [optional] [readonly] 
**calling_convention** | **contentservice_method_base_CALLINGCONVENTION_e** |  | [optional] [readonly] 
