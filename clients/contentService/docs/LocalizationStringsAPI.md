...
//
int32_envelope_t* LocalizationStringsAPI_countLocalizationStringsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, localization_string_dto_collection_query_parameters_t *localization_string_dto_collection_query_parameters);
```
...
**localization_string_dto_collection_query_parameters** | **[localization_string_dto_collection_query_parameters_t](localization_string_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
localization_string_dto_list_envelope_t* LocalizationStringsAPI_getLocalizationStringsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, localization_string_dto_collection_query_parameters_t *localization_string_dto_collection_query_parameters);
```
