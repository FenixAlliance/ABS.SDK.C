...
//
empty_envelope_t* WebContentsAPI_patchWebContentAsync(apiClient_t *apiClient, char *tenantId, char *webContentId, char *api_version, char *x_api_version, list_t *operation);
```
