...
//
empty_envelope_t* BlogPostTagsAPI_patchBlogPostTagAsync(apiClient_t *apiClient, char *tenantId, char *blogPostTagId, char *api_version, char *x_api_version, list_t *operation);
```
