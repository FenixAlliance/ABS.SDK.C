...
//
website_theme_dto_list_envelope_t* WebsiteThemesAPI_getWebsiteThemesAsync(apiClient_t *apiClient, char *tenantId, website_theme_dto_o_data_query_options_t *oDataQueryOptions, char *api_version, char *x_api_version);
```
...
**apiClient** | **apiClient_t \*** | context containing the client configuration |
**tenantId** | **char \*** |  | 
**oDataQueryOptions** | **[website_theme_dto_o_data_query_options_t](.md) \*** |  | [optional] 
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
...
//
int32_envelope_t* WebsiteThemesAPI_getWebsiteThemesCountAsync(apiClient_t *apiClient, char *tenantId, website_theme_dto_o_data_query_options_t *oDataQueryOptions, char *api_version, char *x_api_version);
```
