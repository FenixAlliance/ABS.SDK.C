...
//
website_theme_dto_list_envelope_t* WebsiteThemesAPI_getWebsiteThemesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, website_theme_dto_collection_query_parameters_t *website_theme_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**website_theme_dto_collection_query_parameters** | **[website_theme_dto_collection_query_parameters_t](website_theme_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* WebsiteThemesAPI_getWebsiteThemesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, website_theme_dto_collection_query_parameters_t *website_theme_dto_collection_query_parameters);
```
...
//
void WebsiteThemesAPI_patchWebsiteThemeAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *patch_operation);
```
