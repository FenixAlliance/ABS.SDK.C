...
------------- | ------------- | -------------
[**WebPageCategoriesAPI_countWebPageCategoriesAsync**](WebPageCategoriesAPI.md#WebPageCategoriesAPI_countWebPageCategoriesAsync) | **GET** /api/v2/ContentService/WebPageCategories/Count | Count web page categories
...
# **WebPageCategoriesAPI_countWebPageCategoriesAsync**
```c
