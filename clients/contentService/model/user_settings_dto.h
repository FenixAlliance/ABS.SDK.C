...
typedef enum  { contentservice_user_settings_dto_SITETHEME_NULL = 0, contentservice_user_settings_dto_SITETHEME_System, contentservice_user_settings_dto_SITETHEME_Light, contentservice_user_settings_dto_SITETHEME_Dark } contentservice_user_settings_dto_SITETHEME_e;

char* user_settings_dto_site_theme_ToString(contentservice_user_settings_dto_SITETHEME_e site_theme);

contentservice_user_settings_dto_SITETHEME_e user_settings_dto_site_theme_FromString(char* site_theme);
...
typedef struct user_settings_dto_t {
    ...
    contentservice_user_settings_dto_SITETHEME_e site_theme; //enum
...
user_settings_dto_t *user_settings_dto_create(
    ...
    contentservice_user_settings_dto_SITETHEME_e site_theme
);
