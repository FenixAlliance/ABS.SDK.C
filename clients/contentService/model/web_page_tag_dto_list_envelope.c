...
web_page_tag_dto_list_envelope_t *web_page_tag_dto_list_envelope_create(
    ...
    web_page_tag_dto_list_envelope_local_var->http_status = http_status;
    web_page_tag_dto_list_envelope_local_var->error_code = error_code;
    web_page_tag_dto_list_envelope_local_var->validation_details = validation_details;
...
void web_page_tag_dto_list_envelope_free(web_page_tag_dto_list_envelope_t *web_page_tag_dto_list_envelope) {
    ...
    if (web_page_tag_dto_list_envelope->error_code) {
        free(web_page_tag_dto_list_envelope->error_code);
        web_page_tag_dto_list_envelope->error_code = NULL;
    }
    if (web_page_tag_dto_list_envelope->validation_details) {
        list_ForEach(listEntry, web_page_tag_dto_list_envelope->validation_details) {
            keyValuePair_t *localKeyValue = (keyValuePair_t*) listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_freeList(web_page_tag_dto_list_envelope->validation_details);
        web_page_tag_dto_list_envelope->validation_details = NULL;
    }
...
cJSON *web_page_tag_dto_list_envelope_convertToJSON(web_page_tag_dto_list_envelope_t *web_page_tag_dto_list_envelope) {
    ...
    // web_page_tag_dto_list_envelope->http_status
    if(web_page_tag_dto_list_envelope->http_status) {
    if(cJSON_AddNumberToObject(item, "httpStatus", web_page_tag_dto_list_envelope->http_status) == NULL) {
    goto fail; //Numeric
    }
    }


    // web_page_tag_dto_list_envelope->error_code
    if(web_page_tag_dto_list_envelope->error_code) {
    if(cJSON_AddStringToObject(item, "errorCode", web_page_tag_dto_list_envelope->error_code) == NULL) {
    goto fail; //String
    }
    }


    // web_page_tag_dto_list_envelope->validation_details
    if(web_page_tag_dto_list_envelope->validation_details) {
    ...
    if (web_page_tag_dto_list_envelope->validation_details) {
    list_ForEach(validation_detailsListEntry, web_page_tag_dto_list_envelope->validation_details) {
...
web_page_tag_dto_list_envelope_t *web_page_tag_dto_list_envelope_parseFromJSON(cJSON *web_page_tag_dto_list_envelopeJSON){
    ...
    // define the local map for web_page_tag_dto_list_envelope->validation_details
    ...
    // web_page_tag_dto_list_envelope->http_status
    cJSON *http_status = cJSON_GetObjectItemCaseSensitive(web_page_tag_dto_list_envelopeJSON, "httpStatus");
    if (http_status) { 
    ...
    // web_page_tag_dto_list_envelope->error_code
    cJSON *error_code = cJSON_GetObjectItemCaseSensitive(web_page_tag_dto_list_envelopeJSON, "errorCode");
    if (error_code) { 
    ...
    // web_page_tag_dto_list_envelope->validation_details
    cJSON *validation_details = cJSON_GetObjectItemCaseSensitive(web_page_tag_dto_list_envelopeJSON, "validationDetails");
