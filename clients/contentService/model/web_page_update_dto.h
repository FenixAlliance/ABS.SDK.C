/*
 * web_page_update_dto.h
 *
 * 
 */

#ifndef _web_page_update_dto_H_
#define _web_page_update_dto_H_
...
typedef struct web_page_update_dto_t web_page_update_dto_t;


// Enum CODETYPE for web_page_update_dto

typedef enum  { contentservice_web_page_update_dto_CODETYPE_NULL = 0, contentservice_web_page_update_dto_CODETYPE_Razor, contentservice_web_page_update_dto_CODETYPE_CSharp, contentservice_web_page_update_dto_CODETYPE_CSHtml, contentservice_web_page_update_dto_CODETYPE_Liquid, contentservice_web_page_update_dto_CODETYPE_Html5, contentservice_web_page_update_dto_CODETYPE_Markdown, contentservice_web_page_update_dto_CODETYPE_Markup } contentservice_web_page_update_dto_CODETYPE_e;
...
typedef struct web_page_update_dto_t {
    int order; //numeric
    char *slug; // string
    char *name; // string
    char *title; // string
    ...
    contentservice_web_page_update_dto_CODETYPE_e code_type; //enum
