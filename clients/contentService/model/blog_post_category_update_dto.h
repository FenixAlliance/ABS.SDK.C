/*
 * blog_post_category_update_dto.h
 *
 * 
 */

#ifndef _blog_post_category_update_dto_H_
#define _blog_post_category_update_dto_H_
...
typedef struct blog_post_category_update_dto_t blog_post_category_update_dto_t;




typedef struct blog_post_category_update_dto_t {
    char *slug; // string
    char *type; // string
    char *title; // string
...
} blog_post_category_update_dto_t;
...
#endif /* _blog_post_category_update_dto_H_ */
