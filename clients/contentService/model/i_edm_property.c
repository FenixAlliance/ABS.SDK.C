...
cJSON *i_edm_property_convertToJSON(i_edm_property_t *i_edm_property) {
    ...
    if(i_edm_property->property_kind != contentservice_i_edm_property_PROPERTYKIND_NULL) {
...
i_edm_property_t *i_edm_property_parseFromJSON(cJSON *i_edm_propertyJSON){
    ...
    contentservice_i_edm_property_PROPERTYKIND_e property_kindVariable;
    if (property_kind) { 
    ...
    i_edm_property_local_var = i_edm_property_create (
        ...
        property_kind ? property_kindVariable : contentservice_i_edm_property_PROPERTYKIND_NULL,
