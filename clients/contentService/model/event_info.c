...
cJSON *event_info_convertToJSON(event_info_t *event_info) {
    ...
    if(event_info->member_type != contentservice_event_info_MEMBERTYPE_NULL) {
    ...
    if(event_info->attributes != contentservice_event_info_ATTRIBUTES_NULL) {
...
event_info_t *event_info_parseFromJSON(cJSON *event_infoJSON){
    ...
    contentservice_event_info_MEMBERTYPE_e member_typeVariable;
    if (member_type) { 
    ...
    contentservice_event_info_ATTRIBUTES_e attributesVariable;
    if (attributes) { 
    ...
    event_info_local_var = event_info_create (
        ...
        member_type ? member_typeVariable : contentservice_event_info_MEMBERTYPE_NULL,
        attributes ? attributesVariable : contentservice_event_info_ATTRIBUTES_NULL,
