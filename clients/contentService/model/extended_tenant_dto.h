...
typedef enum  { contentservice_extended_tenant_dto_KIND_NULL = 0, contentservice_extended_tenant_dto_KIND_Organization, contentservice_extended_tenant_dto_KIND_Individual } contentservice_extended_tenant_dto_KIND_e;

char* extended_tenant_dto_kind_ToString(contentservice_extended_tenant_dto_KIND_e kind);

contentservice_extended_tenant_dto_KIND_e extended_tenant_dto_kind_FromString(char* kind);
...
typedef struct extended_tenant_dto_t {
    ...
    contentservice_extended_tenant_dto_KIND_e kind; //enum
    char *tax_id; // string
    char *about; // string
...
extended_tenant_dto_t *extended_tenant_dto_create(
    ...
    char *timestamp,
    char *qualified_name,
    contentservice_extended_tenant_dto_KIND_e kind,
    char *tax_id,
    char *about,
    char *wallet_id,
    char *social_feed_id,
