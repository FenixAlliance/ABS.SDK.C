...
typedef enum  { contentservice_social_profile_dto_TYPE_NULL = 0, contentservice_social_profile_dto_TYPE_User, contentservice_social_profile_dto_TYPE_Tenant, contentservice_social_profile_dto_TYPE_Contact } contentservice_social_profile_dto_TYPE_e;

char* social_profile_dto_type_ToString(contentservice_social_profile_dto_TYPE_e type);

contentservice_social_profile_dto_TYPE_e social_profile_dto_type_FromString(char* type);
...
typedef struct social_profile_dto_t {
    ...
    contentservice_social_profile_dto_TYPE_e type; //enum
...
social_profile_dto_t *social_profile_dto_create(
    ...
    contentservice_social_profile_dto_TYPE_e type,
    char *social_feed_id,
    char *twitter_url,
    char *facebook_url,
    char *linked_in_url,
