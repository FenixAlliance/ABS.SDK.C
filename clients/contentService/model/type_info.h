...
typedef enum  { contentservice_type_info_MEMBERTYPE_NULL = 0, contentservice_type_info_MEMBERTYPE_Constructor, contentservice_type_info_MEMBERTYPE_Event, contentservice_type_info_MEMBERTYPE_Field, contentservice_type_info_MEMBERTYPE_Method, contentservice_type_info_MEMBERTYPE_Property, contentservice_type_info_MEMBERTYPE_TypeInfo, contentservice_type_info_MEMBERTYPE_Custom, contentservice_type_info_MEMBERTYPE_NestedType, contentservice_type_info_MEMBERTYPE_All } contentservice_type_info_MEMBERTYPE_e;
...
typedef enum  { contentservice_type_info_GENERICPARAMETERATTRIBUTES_NULL = 0, contentservice_type_info_GENERICPARAMETERATTRIBUTES_None, contentservice_type_info_GENERICPARAMETERATTRIBUTES_Covariant, contentservice_type_info_GENERICPARAMETERATTRIBUTES_Contravariant, contentservice_type_info_GENERICPARAMETERATTRIBUTES_VarianceMask, contentservice_type_info_GENERICPARAMETERATTRIBUTES_ReferenceTypeConstraint, contentservice_type_info_GENERICPARAMETERATTRIBUTES_NotNullableValueTypeConstraint, contentservice_type_info_GENERICPARAMETERATTRIBUTES_DefaultConstructorConstraint, contentservice_type_info_GENERICPARAMETERATTRIBUTES_SpecialConstraintMask, contentservice_type_info_GENERICPARAMETERATTRIBUTES_AllowByRefLike } contentservice_type_info_GENERICPARAMETERATTRIBUTES_e;
...
typedef enum  { contentservice_type_info_ATTRIBUTES_NULL = 0, contentservice_type_info_ATTRIBUTES_NotPublic, contentservice_type_info_ATTRIBUTES__Public, contentservice_type_info_ATTRIBUTES_NestedPublic, contentservice_type_info_ATTRIBUTES_NestedPrivate, contentservice_type_info_ATTRIBUTES_NestedFamily, contentservice_type_info_ATTRIBUTES_NestedAssembly, contentservice_type_info_ATTRIBUTES_NestedFamANDAssem, contentservice_type_info_ATTRIBUTES_VisibilityMask, contentservice_type_info_ATTRIBUTES_SequentialLayout, contentservice_type_info_ATTRIBUTES_ExplicitLayout, contentservice_type_info_ATTRIBUTES_LayoutMask, contentservice_type_info_ATTRIBUTES_Interface, contentservice_type_info_ATTRIBUTES_Abstract, contentservice_type_info_ATTRIBUTES_Sealed, contentservice_type_info_ATTRIBUTES_SpecialName, contentservice_type_info_ATTRIBUTES_RTSpecialName, contentservice_type_info_ATTRIBUTES_Import, contentservice_type_info_ATTRIBUTES_Serializable, contentservice_type_info_ATTRIBUTES_WindowsRuntime, contentservice_type_info_ATTRIBUTES_UnicodeClass, contentservice_type_info_ATTRIBUTES_AutoClass, contentservice_type_info_ATTRIBUTES_StringFormatMask, contentservice_type_info_ATTRIBUTES_HasSecurity, contentservice_type_info_ATTRIBUTES_ReservedMask, contentservice_type_info_ATTRIBUTES_BeforeFieldInit, contentservice_type_info_ATTRIBUTES_CustomFormatMask } contentservice_type_info_ATTRIBUTES_e;
...
typedef struct type_info_t {
    ...
    contentservice_type_info_MEMBERTYPE_e member_type; //enum
    ...
    contentservice_type_info_GENERICPARAMETERATTRIBUTES_e generic_parameter_attributes; //enum
    contentservice_type_info_ATTRIBUTES_e attributes; //enum
