/*
 * blog_post_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _blog_post_dto_collection_query_parameters_H_
#define _blog_post_dto_collection_query_parameters_H_
...
typedef struct blog_post_dto_collection_query_parameters_t blog_post_dto_collection_query_parameters_t;




typedef struct blog_post_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} blog_post_dto_collection_query_parameters_t;
...
#endif /* _blog_post_dto_collection_query_parameters_H_ */
