/*
 * web_component_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _web_component_dto_collection_query_parameters_H_
#define _web_component_dto_collection_query_parameters_H_
...
typedef struct web_component_dto_collection_query_parameters_t web_component_dto_collection_query_parameters_t;




typedef struct web_component_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} web_component_dto_collection_query_parameters_t;
...
#endif /* _web_component_dto_collection_query_parameters_H_ */
