...
web_page_category_create_dto_t *web_page_category_create_dto_create(
    ...
    web_page_category_create_dto_local_var->business_profile_record_id = business_profile_record_id;
...
void web_page_category_create_dto_free(web_page_category_create_dto_t *web_page_category_create_dto) {
    ...
    if (web_page_category_create_dto->business_profile_record_id) {
        free(web_page_category_create_dto->business_profile_record_id);
        web_page_category_create_dto->business_profile_record_id = NULL;
    }
...
cJSON *web_page_category_create_dto_convertToJSON(web_page_category_create_dto_t *web_page_category_create_dto) {
    ...
    // web_page_category_create_dto->business_profile_record_id
    if(web_page_category_create_dto->business_profile_record_id) {
    if(cJSON_AddStringToObject(item, "businessProfileRecordID", web_page_category_create_dto->business_profile_record_id) == NULL) {
    goto fail; //String
    }
    }
...
web_page_category_create_dto_t *web_page_category_create_dto_parseFromJSON(cJSON *web_page_category_create_dtoJSON){
    ...
    // web_page_category_create_dto->business_profile_record_id
    cJSON *business_profile_record_id = cJSON_GetObjectItemCaseSensitive(web_page_category_create_dtoJSON, "businessProfileRecordID");
