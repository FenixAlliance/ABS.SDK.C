/*
 * localization_string_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _localization_string_dto_collection_query_parameters_H_
#define _localization_string_dto_collection_query_parameters_H_
...
typedef struct localization_string_dto_collection_query_parameters_t localization_string_dto_collection_query_parameters_t;




typedef struct localization_string_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} localization_string_dto_collection_query_parameters_t;
...
#endif /* _localization_string_dto_collection_query_parameters_H_ */
