...
cJSON *i_edm_expression_convertToJSON(i_edm_expression_t *i_edm_expression) {
    ...
    if(i_edm_expression->expression_kind != contentservice_i_edm_expression_EXPRESSIONKIND_NULL) {
...
i_edm_expression_t *i_edm_expression_parseFromJSON(cJSON *i_edm_expressionJSON){
    ...
    contentservice_i_edm_expression_EXPRESSIONKIND_e expression_kindVariable;
    if (expression_kind) { 
    ...
    i_edm_expression_local_var = i_edm_expression_create (
        expression_kind ? expression_kindVariable : contentservice_i_edm_expression_EXPRESSIONKIND_NULL
        );
