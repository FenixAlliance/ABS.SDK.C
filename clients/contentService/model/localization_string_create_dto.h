/*
 * localization_string_create_dto.h
 *
 * 
 */

#ifndef _localization_string_create_dto_H_
#define _localization_string_create_dto_H_
...
typedef struct localization_string_create_dto_t localization_string_create_dto_t;




typedef struct localization_string_create_dto_t {
    char *id; // string
...
} localization_string_create_dto_t;
...
#endif /* _localization_string_create_dto_H_ */
