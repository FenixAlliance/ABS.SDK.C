/*
 * web_template_dto_envelope.h
 *
 * 
 */

#ifndef _web_template_dto_envelope_H_
#define _web_template_dto_envelope_H_
...
typedef struct web_template_dto_envelope_t web_template_dto_envelope_t;

#include "web_template_dto.h"



typedef struct web_template_dto_envelope_t {
    int is_success; //boolean
    char *error_message; // string
    char *correlation_id; // string
    char *timestamp; //date time
    char *activity_id; // string
    struct web_template_dto_t *result; //model
...
#endif /* _web_template_dto_envelope_H_ */
