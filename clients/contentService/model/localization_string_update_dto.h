/*
 * localization_string_update_dto.h
 *
 * 
 */

#ifndef _localization_string_update_dto_H_
#define _localization_string_update_dto_H_
...
typedef struct localization_string_update_dto_t localization_string_update_dto_t;




typedef struct localization_string_update_dto_t {
    char *base; // string
    char *comments; // string
    char *country_language_id; // string

} localization_string_update_dto_t;
...
#endif /* _localization_string_update_dto_H_ */
