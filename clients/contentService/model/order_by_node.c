...
cJSON *order_by_node_convertToJSON(order_by_node_t *order_by_node) {
    ...
    if(order_by_node->direction != contentservice_order_by_node_DIRECTION_NULL) {
...
order_by_node_t *order_by_node_parseFromJSON(cJSON *order_by_nodeJSON){
    ...
    contentservice_order_by_node_DIRECTION_e directionVariable;
    if (direction) { 
    ...
    order_by_node_local_var = order_by_node_create (
        direction ? directionVariable : contentservice_order_by_node_DIRECTION_NULL
        );
