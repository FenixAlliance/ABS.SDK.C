...
typedef enum  { contentservice_i_edm_entity_type_TYPEKIND_NULL = 0, contentservice_i_edm_entity_type_TYPEKIND_None, contentservice_i_edm_entity_type_TYPEKIND_Primitive, contentservice_i_edm_entity_type_TYPEKIND_Entity, contentservice_i_edm_entity_type_TYPEKIND_Complex, contentservice_i_edm_entity_type_TYPEKIND_Collection, contentservice_i_edm_entity_type_TYPEKIND_EntityReference, contentservice_i_edm_entity_type_TYPEKIND__Enum, contentservice_i_edm_entity_type_TYPEKIND_TypeDefinition, contentservice_i_edm_entity_type_TYPEKIND_Untyped, contentservice_i_edm_entity_type_TYPEKIND_Path } contentservice_i_edm_entity_type_TYPEKIND_e;
...
typedef enum  { contentservice_i_edm_entity_type_SCHEMAELEMENTKIND_NULL = 0, contentservice_i_edm_entity_type_SCHEMAELEMENTKIND_None, contentservice_i_edm_entity_type_SCHEMAELEMENTKIND_TypeDefinition, contentservice_i_edm_entity_type_SCHEMAELEMENTKIND_Term, contentservice_i_edm_entity_type_SCHEMAELEMENTKIND_Action, contentservice_i_edm_entity_type_SCHEMAELEMENTKIND_EntityContainer, contentservice_i_edm_entity_type_SCHEMAELEMENTKIND_Function } contentservice_i_edm_entity_type_SCHEMAELEMENTKIND_e;
...
typedef struct i_edm_entity_type_t {
    contentservice_i_edm_entity_type_TYPEKIND_e type_kind; //enum
    char *name; // string
    int is_abstract; //boolean
    int is_open; //boolean
    struct i_edm_structured_type_t *base_type; //model
    list_t *declared_properties; //nonprimitive container
    contentservice_i_edm_entity_type_SCHEMAELEMENTKIND_e schema_element_kind; //enum
