...
cJSON *i_edm_term_convertToJSON(i_edm_term_t *i_edm_term) {
    ...
    if(i_edm_term->schema_element_kind != contentservice_i_edm_term_SCHEMAELEMENTKIND_NULL) {
...
i_edm_term_t *i_edm_term_parseFromJSON(cJSON *i_edm_termJSON){
    ...
    contentservice_i_edm_term_SCHEMAELEMENTKIND_e schema_element_kindVariable;
    ...
    i_edm_term_local_var = i_edm_term_create (
        ...
        schema_element_kind ? schema_element_kindVariable : contentservice_i_edm_term_SCHEMAELEMENTKIND_NULL,
