/*
 * blog_post_tag_dto_envelope.h
 *
 * 
 */

#ifndef _blog_post_tag_dto_envelope_H_
#define _blog_post_tag_dto_envelope_H_
...
typedef struct blog_post_tag_dto_envelope_t blog_post_tag_dto_envelope_t;

#include "blog_post_tag_dto.h"



typedef struct blog_post_tag_dto_envelope_t {
    int is_success; //boolean
    char *error_message; // string
    char *correlation_id; // string
    char *timestamp; //date time
    char *activity_id; // string
    struct blog_post_tag_dto_t *result; //model
...
#endif /* _blog_post_tag_dto_envelope_H_ */
