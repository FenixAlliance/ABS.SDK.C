...
cJSON *auth_result_convertToJSON(auth_result_t *auth_result) {
    ...
    // auth_result->run_as
    if(auth_result->run_as != contentservice_auth_result_RUNAS_NULL) {
    ...
    if(auth_result->principal_kind != contentservice_auth_result_PRINCIPALKIND_NULL) {
...
auth_result_t *auth_result_parseFromJSON(cJSON *auth_resultJSON){
    ...
    contentservice_auth_result_RUNAS_e run_asVariable;
    if (run_as) { 
    ...
    contentservice_auth_result_PRINCIPALKIND_e principal_kindVariable;
    if (principal_kind) { 
    ...
    auth_result_local_var = auth_result_create (
        ...
        run_as ? run_asVariable : contentservice_auth_result_RUNAS_NULL,
        principal_kind ? principal_kindVariable : contentservice_auth_result_PRINCIPALKIND_NULL,
