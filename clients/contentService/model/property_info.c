...
cJSON *property_info_convertToJSON(property_info_t *property_info) {
    ...
    if(property_info->member_type != contentservice_property_info_MEMBERTYPE_NULL) {
    ...
    if(property_info->attributes != contentservice_property_info_ATTRIBUTES_NULL) {
...
property_info_t *property_info_parseFromJSON(cJSON *property_infoJSON){
    ...
    contentservice_property_info_MEMBERTYPE_e member_typeVariable;
    if (member_type) { 
    ...
    contentservice_property_info_ATTRIBUTES_e attributesVariable;
    if (attributes) { 
    ...
    property_info_local_var = property_info_create (
        ...
        member_type ? member_typeVariable : contentservice_property_info_MEMBERTYPE_NULL,
        property_type ? property_type_local_nonprim : NULL,
        attributes ? attributesVariable : contentservice_property_info_ATTRIBUTES_NULL,
