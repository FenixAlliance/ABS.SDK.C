...
web_page_create_dto_t *web_page_create_dto_create(
    ...
    web_page_create_dto_local_var->html_content = html_content;
...
void web_page_create_dto_free(web_page_create_dto_t *web_page_create_dto) {
    ...
    if (web_page_create_dto->html_content) {
        free(web_page_create_dto->html_content);
        web_page_create_dto->html_content = NULL;
    }
...
cJSON *web_page_create_dto_convertToJSON(web_page_create_dto_t *web_page_create_dto) {
    ...
    // web_page_create_dto->html_content
    if(web_page_create_dto->html_content) {
    if(cJSON_AddStringToObject(item, "htmlContent", web_page_create_dto->html_content) == NULL) {
    goto fail; //String
    }
    }
...
web_page_create_dto_t *web_page_create_dto_parseFromJSON(cJSON *web_page_create_dtoJSON){
    ...
    // web_page_create_dto->html_content
    cJSON *html_content = cJSON_GetObjectItemCaseSensitive(web_page_create_dtoJSON, "htmlContent");
    if (html_content) { 
