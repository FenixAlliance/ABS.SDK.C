...
cJSON *i_edm_entity_container_element_convertToJSON(i_edm_entity_container_element_t *i_edm_entity_container_element) {
    ...
    if(i_edm_entity_container_element->container_element_kind != contentservice_i_edm_entity_container_element_CONTAINERELEMENTKIND_NULL) {
...
i_edm_entity_container_element_t *i_edm_entity_container_element_parseFromJSON(cJSON *i_edm_entity_container_elementJSON){
    ...
    contentservice_i_edm_entity_container_element_CONTAINERELEMENTKIND_e container_element_kindVariable;
    ...
    i_edm_entity_container_element_local_var = i_edm_entity_container_element_create (
        ...
        container_element_kind ? container_element_kindVariable : contentservice_i_edm_entity_container_element_CONTAINERELEMENTKIND_NULL,
