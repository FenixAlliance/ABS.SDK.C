...
typedef enum  { contentservice_tenant_dto_KIND_NULL = 0, contentservice_tenant_dto_KIND_Organization, contentservice_tenant_dto_KIND_Individual } contentservice_tenant_dto_KIND_e;

char* tenant_dto_kind_ToString(contentservice_tenant_dto_KIND_e kind);

contentservice_tenant_dto_KIND_e tenant_dto_kind_FromString(char* kind);
...
typedef struct tenant_dto_t {
    ...
    contentservice_tenant_dto_KIND_e kind; //enum
    char *tax_id; // string
    char *about; // string
...
tenant_dto_t *tenant_dto_create(
    ...
    char *timestamp,
    char *qualified_name,
    contentservice_tenant_dto_KIND_e kind,
    char *tax_id,
    char *about,
    char *wallet_id,
    char *social_feed_id,
