...
typedef enum  { contentservice_i_edm_entity_container_SCHEMAELEMENTKIND_NULL = 0, contentservice_i_edm_entity_container_SCHEMAELEMENTKIND_None, contentservice_i_edm_entity_container_SCHEMAELEMENTKIND_TypeDefinition, contentservice_i_edm_entity_container_SCHEMAELEMENTKIND_Term, contentservice_i_edm_entity_container_SCHEMAELEMENTKIND_Action, contentservice_i_edm_entity_container_SCHEMAELEMENTKIND_EntityContainer, contentservice_i_edm_entity_container_SCHEMAELEMENTKIND_Function } contentservice_i_edm_entity_container_SCHEMAELEMENTKIND_e;
...
typedef struct i_edm_entity_container_t {
    char *name; // string
    contentservice_i_edm_entity_container_SCHEMAELEMENTKIND_e schema_element_kind; //enum
