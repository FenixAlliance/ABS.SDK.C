/*
 * blog_post_update_dto.h
 *
 * 
 */

#ifndef _blog_post_update_dto_H_
#define _blog_post_update_dto_H_
...
typedef struct blog_post_update_dto_t blog_post_update_dto_t;
...
typedef struct blog_post_update_dto_t {
    int order; //numeric
    char *slug; // string
    char *name; // string
    char *title; // string
    ...
    contentservice_blog_post_update_dto_CODETYPE_e code_type; //enum
...
#endif /* _blog_post_update_dto_H_ */
