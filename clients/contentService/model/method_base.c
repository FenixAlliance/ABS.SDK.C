...
cJSON *method_base_convertToJSON(method_base_t *method_base) {
    ...
    if(method_base->member_type != contentservice_method_base_MEMBERTYPE_NULL) {
    ...
    if(method_base->attributes != contentservice_method_base_ATTRIBUTES_NULL) {
    ...
    if(method_base->method_implementation_flags != contentservice_method_base_METHODIMPLEMENTATIONFLAGS_NULL) {
    ...
    if(method_base->calling_convention != contentservice_method_base_CALLINGCONVENTION_NULL) {
...
method_base_t *method_base_parseFromJSON(cJSON *method_baseJSON){
    ...
    contentservice_method_base_MEMBERTYPE_e member_typeVariable;
    if (member_type) { 
    ...
    contentservice_method_base_ATTRIBUTES_e attributesVariable;
    if (attributes) { 
    ...
    contentservice_method_base_METHODIMPLEMENTATIONFLAGS_e method_implementation_flagsVariable;
    ...
    contentservice_method_base_CALLINGCONVENTION_e calling_conventionVariable;
    ...
    method_base_local_var = method_base_create (
        member_type ? member_typeVariable : contentservice_method_base_MEMBERTYPE_NULL,
        ...
        attributes ? attributesVariable : contentservice_method_base_ATTRIBUTES_NULL,
        method_implementation_flags ? method_implementation_flagsVariable : contentservice_method_base_METHODIMPLEMENTATIONFLAGS_NULL,
        calling_convention ? calling_conventionVariable : contentservice_method_base_CALLINGCONVENTION_NULL,
