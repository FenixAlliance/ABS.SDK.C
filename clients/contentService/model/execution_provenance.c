...
cJSON *execution_provenance_convertToJSON(execution_provenance_t *execution_provenance) {
    ...
    if(execution_provenance->initiation != contentservice_execution_provenance_INITIATION_NULL) {
    ...
    if(execution_provenance->on_behalf_of_actor_kind != contentservice_execution_provenance_ONBEHALFOFACTORKIND_NULL) {
...
execution_provenance_t *execution_provenance_parseFromJSON(cJSON *execution_provenanceJSON){
    ...
    contentservice_execution_provenance_INITIATION_e initiationVariable;
    if (initiation) { 
    ...
    contentservice_execution_provenance_ONBEHALFOFACTORKIND_e on_behalf_of_actor_kindVariable;
    ...
    execution_provenance_local_var = execution_provenance_create (
        initiation ? initiationVariable : contentservice_execution_provenance_INITIATION_NULL,
        on_behalf_of_actor_id ? on_behalf_of_actor_id_local_object : NULL,
        on_behalf_of_actor_kind ? on_behalf_of_actor_kindVariable : contentservice_execution_provenance_ONBEHALFOFACTORKIND_NULL,
