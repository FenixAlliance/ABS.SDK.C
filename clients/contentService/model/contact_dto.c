...
cJSON *contact_dto_convertToJSON(contact_dto_t *contact_dto) {
    ...
    // contact_dto->type
    if(contact_dto->type != contentservice_contact_dto_TYPE_NULL) {
...
contact_dto_t *contact_dto_parseFromJSON(cJSON *contact_dtoJSON){
    ...
    contentservice_contact_dto_TYPE_e typeVariable;
    if (type) { 
    ...
    contact_dto_local_var = contact_dto_create (
        ...
        type ? typeVariable : contentservice_contact_dto_TYPE_NULL,
