...
cJSON *user_settings_dto_convertToJSON(user_settings_dto_t *user_settings_dto) {
    ...
    if(user_settings_dto->site_theme != contentservice_user_settings_dto_SITETHEME_NULL) {
...
user_settings_dto_t *user_settings_dto_parseFromJSON(cJSON *user_settings_dtoJSON){
    ...
    contentservice_user_settings_dto_SITETHEME_e site_themeVariable;
    if (site_theme) { 
    ...
    user_settings_dto_local_var = user_settings_dto_create (
        ...
        site_theme ? site_themeVariable : contentservice_user_settings_dto_SITETHEME_NULL
        );
