...
cJSON *extended_user_dto_convertToJSON(extended_user_dto_t *extended_user_dto) {
    ...
    if(extended_user_dto->gender != contentservice_extended_user_dto_GENDER_NULL) {
    ...
    if(extended_user_dto->availability != contentservice_extended_user_dto_AVAILABILITY_NULL) {
    ...
    if(extended_user_dto->site_theme != contentservice_extended_user_dto_SITETHEME_NULL) {
...
extended_user_dto_t *extended_user_dto_parseFromJSON(cJSON *extended_user_dtoJSON){
    ...
    contentservice_extended_user_dto_GENDER_e genderVariable;
    if (gender) { 
    ...
    contentservice_extended_user_dto_AVAILABILITY_e availabilityVariable;
    if (availability) { 
    ...
    contentservice_extended_user_dto_SITETHEME_e site_themeVariable;
    if (site_theme) { 
    ...
    extended_user_dto_local_var = extended_user_dto_create (
        ...
        gender ? genderVariable : contentservice_extended_user_dto_GENDER_NULL,
        ...
        availability ? availabilityVariable : contentservice_extended_user_dto_AVAILABILITY_NULL,
        ...
        site_theme ? site_themeVariable : contentservice_extended_user_dto_SITETHEME_NULL,
