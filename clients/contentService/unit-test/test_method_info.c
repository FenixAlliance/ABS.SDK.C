...
method_info_t* instantiate_method_info(int include_optional) {
  ...
  if (include_optional) {
    method_info = method_info_create(
      ...
      1,
      56,
      contentservice_method_info_ATTRIBUTES_PrivateScope,
      contentservice_method_info_METHODIMPLEMENTATIONFLAGS_IL,
      contentservice_method_info_CALLINGCONVENTION_Standard,
      1,
      1,
      1,
      1,
      ...
      1,
      1,
      contentservice_method_info_MEMBERTYPE_Constructor,
       // false, not to have infinite recursion
