...
constructor_info_t* instantiate_constructor_info(int include_optional) {
  ...
  if (include_optional) {
    constructor_info = constructor_info_create(
      ...
      1,
      56,
      contentservice_constructor_info_ATTRIBUTES_PrivateScope,
      contentservice_constructor_info_METHODIMPLEMENTATIONFLAGS_IL,
      contentservice_constructor_info_CALLINGCONVENTION_Standard,
      1,
      1,
      1,
      1,
      ...
      1,
      1,
      contentservice_constructor_info_MEMBERTYPE_Constructor
    );
  } else {
    constructor_info = constructor_info_create(
      "0",
