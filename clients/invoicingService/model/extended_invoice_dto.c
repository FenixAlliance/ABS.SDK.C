...
extended_invoice_dto_t *extended_invoice_dto_create(
    ...
    extended_invoice_dto_local_var->forex_rates_snapshot = forex_rates_snapshot;
...
void extended_invoice_dto_free(extended_invoice_dto_t *extended_invoice_dto) {
    ...
    if (extended_invoice_dto->forex_rates_snapshot) {
        free(extended_invoice_dto->forex_rates_snapshot);
        extended_invoice_dto->forex_rates_snapshot = NULL;
    }
...
cJSON *extended_invoice_dto_convertToJSON(extended_invoice_dto_t *extended_invoice_dto) {
    ...
    // extended_invoice_dto->forex_rates_snapshot
    if(extended_invoice_dto->forex_rates_snapshot) {
    if(cJSON_AddStringToObject(item, "forexRatesSnapshot", extended_invoice_dto->forex_rates_snapshot) == NULL) {
    goto fail; //String
    }
    }
...
extended_invoice_dto_t *extended_invoice_dto_parseFromJSON(cJSON *extended_invoice_dtoJSON){
    ...
    // extended_invoice_dto->forex_rates_snapshot
    cJSON *forex_rates_snapshot = cJSON_GetObjectItemCaseSensitive(extended_invoice_dtoJSON, "forexRatesSnapshot");
