...
invoice_line_dto_t *invoice_line_dto_create(
    ...
    invoice_line_dto_local_var->forex_rates = forex_rates;
    ...
    invoice_line_dto_local_var->currency = currency;
    ...
    invoice_line_dto_local_var->total_detail_amount = total_detail_amount;
    ...
    invoice_line_dto_local_var->total_profit_amount = total_profit_amount;
    ...
    invoice_line_dto_local_var->total_discounts_amount = total_discounts_amount;
    ...
    invoice_line_dto_local_var->total_surcharges_amount = total_surcharges_amount;
    ...
    invoice_line_dto_local_var->total_tax_base_amount = total_tax_base_amount;
    ...
    invoice_line_dto_local_var->total_taxes_amount = total_taxes_amount;
    ...
    invoice_line_dto_local_var->total_shipping_cost_amount = total_shipping_cost_amount;
    ...
    invoice_line_dto_local_var->total_shipping_tax_amount = total_shipping_tax_amount;
    ...
    invoice_line_dto_local_var->total_withheld_tax_amount = total_withheld_tax_amount;
    ...
    invoice_line_dto_local_var->total_global_discounts_amount = total_global_discounts_amount;
    ...
    invoice_line_dto_local_var->total_global_surcharges_amount = total_global_surcharges_amount;
    invoice_line_dto_local_var->total = total;
    invoice_line_dto_local_var->total_currency_id = total_currency_id;
    invoice_line_dto_local_var->total_amount = total_amount;
...
void invoice_line_dto_free(invoice_line_dto_t *invoice_line_dto) {
    ...
    if (invoice_line_dto->forex_rates) {
        forex_rates_free(invoice_line_dto->forex_rates);
        invoice_line_dto->forex_rates = NULL;
    }
    ...
    if (invoice_line_dto->currency) {
        currency_id_free(invoice_line_dto->currency);
        invoice_line_dto->currency = NULL;
    }
    ...
    if (invoice_line_dto->total_detail_amount) {
        money_free(invoice_line_dto->total_detail_amount);
        invoice_line_dto->total_detail_amount = NULL;
    }
    ...
    if (invoice_line_dto->total_profit_amount) {
        money_free(invoice_line_dto->total_profit_amount);
        invoice_line_dto->total_profit_amount = NULL;
    }
    ...
    if (invoice_line_dto->total_discounts_amount) {
        money_free(invoice_line_dto->total_discounts_amount);
        invoice_line_dto->total_discounts_amount = NULL;
    }
    ...
    if (invoice_line_dto->total_surcharges_amount) {
        money_free(invoice_line_dto->total_surcharges_amount);
        invoice_line_dto->total_surcharges_amount = NULL;
    }
    ...
    if (invoice_line_dto->total_tax_base_amount) {
        money_free(invoice_line_dto->total_tax_base_amount);
        invoice_line_dto->total_tax_base_amount = NULL;
    }
    ...
    if (invoice_line_dto->total_taxes_amount) {
        money_free(invoice_line_dto->total_taxes_amount);
        invoice_line_dto->total_taxes_amount = NULL;
    }
    ...
    if (invoice_line_dto->total_shipping_cost_amount) {
        money_free(invoice_line_dto->total_shipping_cost_amount);
        invoice_line_dto->total_shipping_cost_amount = NULL;
    }
    ...
    if (invoice_line_dto->total_shipping_tax_amount) {
        money_free(invoice_line_dto->total_shipping_tax_amount);
        invoice_line_dto->total_shipping_tax_amount = NULL;
    }
    ...
    if (invoice_line_dto->total_withheld_tax_amount) {
        money_free(invoice_line_dto->total_withheld_tax_amount);
        invoice_line_dto->total_withheld_tax_amount = NULL;
    }
    ...
    if (invoice_line_dto->total_global_discounts_amount) {
        money_free(invoice_line_dto->total_global_discounts_amount);
        invoice_line_dto->total_global_discounts_amount = NULL;
    }
    ...
    if (invoice_line_dto->total_global_surcharges_amount) {
        money_free(invoice_line_dto->total_global_surcharges_amount);
        invoice_line_dto->total_global_surcharges_amount = NULL;
    }
    if (invoice_line_dto->total_currency_id) {
        free(invoice_line_dto->total_currency_id);
        invoice_line_dto->total_currency_id = NULL;
    }
    if (invoice_line_dto->total_amount) {
        money_free(invoice_line_dto->total_amount);
        invoice_line_dto->total_amount = NULL;
    }
...
cJSON *invoice_line_dto_convertToJSON(invoice_line_dto_t *invoice_line_dto) {
    ...
    // invoice_line_dto->forex_rates
    if(invoice_line_dto->forex_rates) {
    cJSON *forex_rates_local_JSON = forex_rates_convertToJSON(invoice_line_dto->forex_rates);
    ...
    // invoice_line_dto->currency
    if(invoice_line_dto->currency) {
    cJSON *currency_local_JSON = currency_id_convertToJSON(invoice_line_dto->currency);
    ...
    // invoice_line_dto->total_detail_amount
    if(invoice_line_dto->total_detail_amount) {
    cJSON *total_detail_amount_local_JSON = money_convertToJSON(invoice_line_dto->total_detail_amount);
    ...
    // invoice_line_dto->total_profit_amount
    if(invoice_line_dto->total_profit_amount) {
    cJSON *total_profit_amount_local_JSON = money_convertToJSON(invoice_line_dto->total_profit_amount);
    ...
    // invoice_line_dto->total_discounts_amount
    if(invoice_line_dto->total_discounts_amount) {
    cJSON *total_discounts_amount_local_JSON = money_convertToJSON(invoice_line_dto->total_discounts_amount);
    ...
    // invoice_line_dto->total_surcharges_amount
    if(invoice_line_dto->total_surcharges_amount) {
    cJSON *total_surcharges_amount_local_JSON = money_convertToJSON(invoice_line_dto->total_surcharges_amount);
    ...
    // invoice_line_dto->total_tax_base_amount
    if(invoice_line_dto->total_tax_base_amount) {
    cJSON *total_tax_base_amount_local_JSON = money_convertToJSON(invoice_line_dto->total_tax_base_amount);
    ...
    // invoice_line_dto->total_taxes_amount
    if(invoice_line_dto->total_taxes_amount) {
    cJSON *total_taxes_amount_local_JSON = money_convertToJSON(invoice_line_dto->total_taxes_amount);
    ...
    // invoice_line_dto->total_shipping_cost_amount
    if(invoice_line_dto->total_shipping_cost_amount) {
    cJSON *total_shipping_cost_amount_local_JSON = money_convertToJSON(invoice_line_dto->total_shipping_cost_amount);
    ...
    // invoice_line_dto->total_shipping_tax_amount
    if(invoice_line_dto->total_shipping_tax_amount) {
    cJSON *total_shipping_tax_amount_local_JSON = money_convertToJSON(invoice_line_dto->total_shipping_tax_amount);
    ...
    // invoice_line_dto->total_withheld_tax_amount
    if(invoice_line_dto->total_withheld_tax_amount) {
    cJSON *total_withheld_tax_amount_local_JSON = money_convertToJSON(invoice_line_dto->total_withheld_tax_amount);
    ...
    // invoice_line_dto->total_global_discounts_amount
    if(invoice_line_dto->total_global_discounts_amount) {
    cJSON *total_global_discounts_amount_local_JSON = money_convertToJSON(invoice_line_dto->total_global_discounts_amount);
    ...
    // invoice_line_dto->total_global_surcharges_amount
    if(invoice_line_dto->total_global_surcharges_amount) {
    cJSON *total_global_surcharges_amount_local_JSON = money_convertToJSON(invoice_line_dto->total_global_surcharges_amount);
    ...
    // invoice_line_dto->total_amount
    if(invoice_line_dto->total_amount) {
    cJSON *total_amount_local_JSON = money_convertToJSON(invoice_line_dto->total_amount);
...
invoice_line_dto_t *invoice_line_dto_parseFromJSON(cJSON *invoice_line_dtoJSON){
    ...
    // define the local variable for invoice_line_dto->forex_rates
    forex_rates_t *forex_rates_local_nonprim = NULL;

    // define the local variable for invoice_line_dto->currency
    currency_id_t *currency_local_nonprim = NULL;

    // define the local variable for invoice_line_dto->total_detail_amount
    money_t *total_detail_amount_local_nonprim = NULL;

    // define the local variable for invoice_line_dto->total_profit_amount
    money_t *total_profit_amount_local_nonprim = NULL;

    // define the local variable for invoice_line_dto->total_discounts_amount
    money_t *total_discounts_amount_local_nonprim = NULL;

    // define the local variable for invoice_line_dto->total_surcharges_amount
    money_t *total_surcharges_amount_local_nonprim = NULL;

    // define the local variable for invoice_line_dto->total_tax_base_amount
    money_t *total_tax_base_amount_local_nonprim = NULL;

    // define the local variable for invoice_line_dto->total_taxes_amount
    money_t *total_taxes_amount_local_nonprim = NULL;

    // define the local variable for invoice_line_dto->total_shipping_cost_amount
    money_t *total_shipping_cost_amount_local_nonprim = NULL;

    // define the local variable for invoice_line_dto->total_shipping_tax_amount
    money_t *total_shipping_tax_amount_local_nonprim = NULL;

    // define the local variable for invoice_line_dto->total_withheld_tax_amount
    money_t *total_withheld_tax_amount_local_nonprim = NULL;

    // define the local variable for invoice_line_dto->total_global_discounts_amount
    money_t *total_global_discounts_amount_local_nonprim = NULL;

    // define the local variable for invoice_line_dto->total_global_surcharges_amount
    money_t *total_global_surcharges_amount_local_nonprim = NULL;

    // define the local variable for invoice_line_dto->total_amount
    ...
    // invoice_line_dto->forex_rates
    cJSON *forex_rates = cJSON_GetObjectItemCaseSensitive(invoice_line_dtoJSON, "forexRates");
    if (forex_rates) { 
    ...
    // invoice_line_dto->currency
    cJSON *currency = cJSON_GetObjectItemCaseSensitive(invoice_line_dtoJSON, "currency");
    if (currency) { 
    ...
    // invoice_line_dto->total_detail_amount
    cJSON *total_detail_amount = cJSON_GetObjectItemCaseSensitive(invoice_line_dtoJSON, "totalDetailAmount");
    ...
    // invoice_line_dto->total_profit_amount
    cJSON *total_profit_amount = cJSON_GetObjectItemCaseSensitive(invoice_line_dtoJSON, "totalProfitAmount");
    ...
    // invoice_line_dto->total_discounts_amount
    cJSON *total_discounts_amount = cJSON_GetObjectItemCaseSensitive(invoice_line_dtoJSON, "totalDiscountsAmount");
    ...
    // invoice_line_dto->total_surcharges_amount
    cJSON *total_surcharges_amount = cJSON_GetObjectItemCaseSensitive(invoice_line_dtoJSON, "totalSurchargesAmount");
    ...
    // invoice_line_dto->total_tax_base_amount
    cJSON *total_tax_base_amount = cJSON_GetObjectItemCaseSensitive(invoice_line_dtoJSON, "totalTaxBaseAmount");
    ...
    // invoice_line_dto->total_taxes_amount
    cJSON *total_taxes_amount = cJSON_GetObjectItemCaseSensitive(invoice_line_dtoJSON, "totalTaxesAmount");
    ...
    // invoice_line_dto->total_shipping_cost_amount
    cJSON *total_shipping_cost_amount = cJSON_GetObjectItemCaseSensitive(invoice_line_dtoJSON, "totalShippingCostAmount");
    ...
    // invoice_line_dto->total_shipping_tax_amount
    cJSON *total_shipping_tax_amount = cJSON_GetObjectItemCaseSensitive(invoice_line_dtoJSON, "totalShippingTaxAmount");
    ...
    // invoice_line_dto->total_withheld_tax_amount
    cJSON *total_withheld_tax_amount = cJSON_GetObjectItemCaseSensitive(invoice_line_dtoJSON, "totalWithheldTaxAmount");
    ...
    // invoice_line_dto->total_global_discounts_amount
    cJSON *total_global_discounts_amount = cJSON_GetObjectItemCaseSensitive(invoice_line_dtoJSON, "totalGlobalDiscountsAmount");
    ...
    // invoice_line_dto->total_global_surcharges_amount
    cJSON *total_global_surcharges_amount = cJSON_GetObjectItemCaseSensitive(invoice_line_dtoJSON, "totalGlobalSurchargesAmount");
    ...
    // invoice_line_dto->total_amount
    cJSON *total_amount = cJSON_GetObjectItemCaseSensitive(invoice_line_dtoJSON, "totalAmount");
    if (total_amount) { 
