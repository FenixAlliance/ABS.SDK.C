/*
 * invoice_update_dto.h
 *
 * 
 */

#ifndef _invoice_update_dto_H_
#define _invoice_update_dto_H_
...
typedef struct invoice_update_dto_t invoice_update_dto_t;

#include "invoice_adjustment_create_dto.h"
#include "invoice_line_create_dto.h"
#include "invoice_reference_create_dto.h"

// Enum COSTCALCULATIONMETHOD for invoice_update_dto

typedef enum  { invoicingservice_invoice_update_dto_COSTCALCULATIONMETHOD_NULL = 0, invoicingservice_invoice_update_dto_COSTCALCULATIONMETHOD_Automatic, invoicingservice_invoice_update_dto_COSTCALCULATIONMETHOD_Custom } invoicingservice_invoice_update_dto_COSTCALCULATIONMETHOD_e;
...
// Enum TAXCALCULATIONMETHOD for invoice_update_dto

typedef enum  { invoicingservice_invoice_update_dto_TAXCALCULATIONMETHOD_NULL = 0, invoicingservice_invoice_update_dto_TAXCALCULATIONMETHOD_Included, invoicingservice_invoice_update_dto_TAXCALCULATIONMETHOD_Excluded } invoicingservice_invoice_update_dto_TAXCALCULATIONMETHOD_e;
...
// Enum INVOICETYPE for invoice_update_dto

typedef enum  { invoicingservice_invoice_update_dto_INVOICETYPE_NULL = 0, invoicingservice_invoice_update_dto_INVOICETYPE_PurchaseInvoice, invoicingservice_invoice_update_dto_INVOICETYPE_SalesInvoice, invoicingservice_invoice_update_dto_INVOICETYPE_CreditNote, invoicingservice_invoice_update_dto_INVOICETYPE_DebitNote } invoicingservice_invoice_update_dto_INVOICETYPE_e;
...
// Enum DOCUMENTTYPE for invoice_update_dto

typedef enum  { invoicingservice_invoice_update_dto_DOCUMENTTYPE_NULL = 0, invoicingservice_invoice_update_dto_DOCUMENTTYPE_Standard, invoicingservice_invoice_update_dto_DOCUMENTTYPE_DebitNote, invoicingservice_invoice_update_dto_DOCUMENTTYPE_CreditNote } invoicingservice_invoice_update_dto_DOCUMENTTYPE_e;
...
// Enum INVOICESTATUS for invoice_update_dto

typedef enum  { invoicingservice_invoice_update_dto_INVOICESTATUS_NULL = 0, invoicingservice_invoice_update_dto_INVOICESTATUS_Draft, invoicingservice_invoice_update_dto_INVOICESTATUS_Closed, invoicingservice_invoice_update_dto_INVOICESTATUS__Signed, invoicingservice_invoice_update_dto_INVOICESTATUS_Expired, invoicingservice_invoice_update_dto_INVOICESTATUS_Paid } invoicingservice_invoice_update_dto_INVOICESTATUS_e;
...
typedef struct invoice_update_dto_t {
    int closed; //boolean
    char *title; // string
    char *user_id; // string
    ...
    invoicingservice_invoice_update_dto_COSTCALCULATIONMETHOD_e cost_calculation_method; //enum
    invoicingservice_invoice_update_dto_TAXCALCULATIONMETHOD_e tax_calculation_method; //enum
    int paid; //boolean
    int number; //numeric
    char *notes; // string
    ...
    invoicingservice_invoice_update_dto_INVOICETYPE_e invoice_type; //enum
    invoicingservice_invoice_update_dto_DOCUMENTTYPE_e document_type; //enum
    invoicingservice_invoice_update_dto_INVOICESTATUS_e invoice_status; //enum
