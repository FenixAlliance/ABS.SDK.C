...
cJSON *email_dispatch_request_convertToJSON(email_dispatch_request_t *email_dispatch_request) {
    ...
    if(email_dispatch_request->alert_type != invoicingservice_email_dispatch_request_ALERTTYPE_NULL) {
...
email_dispatch_request_t *email_dispatch_request_parseFromJSON(cJSON *email_dispatch_requestJSON){
    ...
    invoicingservice_email_dispatch_request_ALERTTYPE_e alert_typeVariable;
    if (alert_type) { 
    ...
    email_dispatch_request_local_var = email_dispatch_request_create (
        ...
        alert_type ? alert_typeVariable : invoicingservice_email_dispatch_request_ALERTTYPE_NULL,
