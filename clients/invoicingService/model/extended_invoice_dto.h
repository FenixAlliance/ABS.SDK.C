/*
 * extended_invoice_dto.h
 *
 * 
 */

#ifndef _extended_invoice_dto_H_
#define _extended_invoice_dto_H_
...
typedef struct extended_invoice_dto_t extended_invoice_dto_t;
...
// Enum TAXCALCULATIONMETHOD for extended_invoice_dto

typedef enum  { invoicingservice_extended_invoice_dto_TAXCALCULATIONMETHOD_NULL = 0, invoicingservice_extended_invoice_dto_TAXCALCULATIONMETHOD_Included, invoicingservice_extended_invoice_dto_TAXCALCULATIONMETHOD_Excluded } invoicingservice_extended_invoice_dto_TAXCALCULATIONMETHOD_e;
...
// Enum COSTCALCULATIONMETHOD for extended_invoice_dto

typedef enum  { invoicingservice_extended_invoice_dto_COSTCALCULATIONMETHOD_NULL = 0, invoicingservice_extended_invoice_dto_COSTCALCULATIONMETHOD_Automatic, invoicingservice_extended_invoice_dto_COSTCALCULATIONMETHOD_Custom } invoicingservice_extended_invoice_dto_COSTCALCULATIONMETHOD_e;
...
// Enum INVOICETYPE for extended_invoice_dto

typedef enum  { invoicingservice_extended_invoice_dto_INVOICETYPE_NULL = 0, invoicingservice_extended_invoice_dto_INVOICETYPE_PurchaseInvoice, invoicingservice_extended_invoice_dto_INVOICETYPE_SalesInvoice, invoicingservice_extended_invoice_dto_INVOICETYPE_CreditNote, invoicingservice_extended_invoice_dto_INVOICETYPE_DebitNote } invoicingservice_extended_invoice_dto_INVOICETYPE_e;
...
// Enum DOCUMENTTYPE for extended_invoice_dto

typedef enum  { invoicingservice_extended_invoice_dto_DOCUMENTTYPE_NULL = 0, invoicingservice_extended_invoice_dto_DOCUMENTTYPE_Standard, invoicingservice_extended_invoice_dto_DOCUMENTTYPE_DebitNote, invoicingservice_extended_invoice_dto_DOCUMENTTYPE_CreditNote } invoicingservice_extended_invoice_dto_DOCUMENTTYPE_e;
...
// Enum INVOICESTATUS for extended_invoice_dto

typedef enum  { invoicingservice_extended_invoice_dto_INVOICESTATUS_NULL = 0, invoicingservice_extended_invoice_dto_INVOICESTATUS_Draft, invoicingservice_extended_invoice_dto_INVOICESTATUS_Closed, invoicingservice_extended_invoice_dto_INVOICESTATUS__Signed, invoicingservice_extended_invoice_dto_INVOICESTATUS_Expired, invoicingservice_extended_invoice_dto_INVOICESTATUS_Paid } invoicingservice_extended_invoice_dto_INVOICESTATUS_e;
...
typedef struct extended_invoice_dto_t {
    char *id; // string
    ...
    invoicingservice_extended_invoice_dto_TAXCALCULATIONMETHOD_e tax_calculation_method; //enum
    invoicingservice_extended_invoice_dto_COSTCALCULATIONMETHOD_e cost_calculation_method; //enum
    ...
    invoicingservice_extended_invoice_dto_INVOICETYPE_e invoice_type; //enum
    invoicingservice_extended_invoice_dto_DOCUMENTTYPE_e document_type; //enum
    invoicingservice_extended_invoice_dto_INVOICESTATUS_e invoice_status; //enum
    struct tenant_dto_t *tenant; //model
    struct simple_user_dto_t *user; //model
    struct tenant_dto_t *receiver_tenant; //model
    struct simple_contact_dto_t *individual; //model
    struct simple_contact_dto_t *organization; //model
    struct simple_tenant_enrollment_dto_t *enrollment; //model
...
#endif /* _extended_invoice_dto_H_ */
