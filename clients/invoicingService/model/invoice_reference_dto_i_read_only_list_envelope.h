/*
 * invoice_reference_dto_i_read_only_list_envelope.h
 *
 * 
 */

#ifndef _invoice_reference_dto_i_read_only_list_envelope_H_
#define _invoice_reference_dto_i_read_only_list_envelope_H_
...
typedef struct invoice_reference_dto_i_read_only_list_envelope_t invoice_reference_dto_i_read_only_list_envelope_t;

#include "invoice_reference_dto.h"



typedef struct invoice_reference_dto_i_read_only_list_envelope_t {
...
#endif /* _invoice_reference_dto_i_read_only_list_envelope_H_ */
