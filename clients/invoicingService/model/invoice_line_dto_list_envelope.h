/*
 * invoice_line_dto_list_envelope.h
 *
 * 
 */

#ifndef _invoice_line_dto_list_envelope_H_
#define _invoice_line_dto_list_envelope_H_
...
typedef struct invoice_line_dto_list_envelope_t invoice_line_dto_list_envelope_t;

#include "invoice_line_dto.h"



typedef struct invoice_line_dto_list_envelope_t {
...
#endif /* _invoice_line_dto_list_envelope_H_ */
