...
typedef enum  { invoicingservice_email_dispatch_request_ALERTTYPE_NULL = 0, invoicingservice_email_dispatch_request_ALERTTYPE_None, invoicingservice_email_dispatch_request_ALERTTYPE_Info, invoicingservice_email_dispatch_request_ALERTTYPE_Error, invoicingservice_email_dispatch_request_ALERTTYPE_Warning, invoicingservice_email_dispatch_request_ALERTTYPE_Success, invoicingservice_email_dispatch_request_ALERTTYPE_Action, invoicingservice_email_dispatch_request_ALERTTYPE_Alert } invoicingservice_email_dispatch_request_ALERTTYPE_e;

char* email_dispatch_request_alert_type_ToString(invoicingservice_email_dispatch_request_ALERTTYPE_e alert_type);

invoicingservice_email_dispatch_request_ALERTTYPE_e email_dispatch_request_alert_type_FromString(char* alert_type);
...
typedef struct email_dispatch_request_t {
    ...
    invoicingservice_email_dispatch_request_ALERTTYPE_e alert_type; //enum
    char *culture; // string
...
email_dispatch_request_t *email_dispatch_request_create(
    ...
    char *button_text,
    char *alert_message,
    invoicingservice_email_dispatch_request_ALERTTYPE_e alert_type,
    char *culture,
    char *ui_culture,
    list_t *recipients,
    list_t *contact_ids,
