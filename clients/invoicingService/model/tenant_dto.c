...
cJSON *tenant_dto_convertToJSON(tenant_dto_t *tenant_dto) {
    ...
    // tenant_dto->kind
    if(tenant_dto->kind != invoicingservice_tenant_dto_KIND_NULL) {
...
tenant_dto_t *tenant_dto_parseFromJSON(cJSON *tenant_dtoJSON){
    ...
    invoicingservice_tenant_dto_KIND_e kindVariable;
    if (kind) { 
    ...
    tenant_dto_local_var = tenant_dto_create (
        ...
        kind ? kindVariable : invoicingservice_tenant_dto_KIND_NULL,
