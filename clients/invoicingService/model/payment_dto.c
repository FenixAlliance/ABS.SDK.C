...
cJSON *payment_dto_convertToJSON(payment_dto_t *payment_dto) {
    ...
    if(payment_dto->on_behalf_of != invoicingservice_payment_dto_ONBEHALFOF_NULL) {
    ...
    if(payment_dto->payment_type != invoicingservice_payment_dto_PAYMENTTYPE_NULL) {
    ...
    if(payment_dto->payment_status != invoicingservice_payment_dto_PAYMENTSTATUS_NULL) {
...
payment_dto_t *payment_dto_parseFromJSON(cJSON *payment_dtoJSON){
    ...
    invoicingservice_payment_dto_ONBEHALFOF_e on_behalf_ofVariable;
    if (on_behalf_of) { 
    ...
    invoicingservice_payment_dto_PAYMENTTYPE_e payment_typeVariable;
    if (payment_type) { 
    ...
    invoicingservice_payment_dto_PAYMENTSTATUS_e payment_statusVariable;
    if (payment_status) { 
    ...
    payment_dto_local_var = payment_dto_create (
        ...
        on_behalf_of ? on_behalf_ofVariable : invoicingservice_payment_dto_ONBEHALFOF_NULL,
        payment_type ? payment_typeVariable : invoicingservice_payment_dto_PAYMENTTYPE_NULL,
        payment_status ? payment_statusVariable : invoicingservice_payment_dto_PAYMENTSTATUS_NULL,
