...
#ifndef _invoice_line_dto_H_
#define _invoice_line_dto_H_
...
typedef struct invoice_line_dto_t invoice_line_dto_t;

#include "currency_id.h"
#include "forex_rates.h"
#include "money.h"

// Enum TAXCALCULATIONMETHOD for invoice_line_dto

typedef enum  { invoicingservice_invoice_line_dto_TAXCALCULATIONMETHOD_NULL = 0, invoicingservice_invoice_line_dto_TAXCALCULATIONMETHOD_Included, invoicingservice_invoice_line_dto_TAXCALCULATIONMETHOD_Excluded } invoicingservice_invoice_line_dto_TAXCALCULATIONMETHOD_e;
...
// Enum COSTCALCULATIONMETHOD for invoice_line_dto

typedef enum  { invoicingservice_invoice_line_dto_COSTCALCULATIONMETHOD_NULL = 0, invoicingservice_invoice_line_dto_COSTCALCULATIONMETHOD_Automatic, invoicingservice_invoice_line_dto_COSTCALCULATIONMETHOD_Custom } invoicingservice_invoice_line_dto_COSTCALCULATIONMETHOD_e;
...
typedef struct invoice_line_dto_t {
    char *id; // string
    ...
    invoicingservice_invoice_line_dto_TAXCALCULATIONMETHOD_e tax_calculation_method; //enum
    invoicingservice_invoice_line_dto_COSTCALCULATIONMETHOD_e cost_calculation_method; //enum
