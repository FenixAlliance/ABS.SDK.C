...
// Enum COSTCALCULATIONMETHOD for invoice_line_update_dto

typedef enum  { invoicingservice_invoice_line_update_dto_COSTCALCULATIONMETHOD_NULL = 0, invoicingservice_invoice_line_update_dto_COSTCALCULATIONMETHOD_Automatic, invoicingservice_invoice_line_update_dto_COSTCALCULATIONMETHOD_Custom } invoicingservice_invoice_line_update_dto_COSTCALCULATIONMETHOD_e;
...
// Enum TAXCALCULATIONMETHOD for invoice_line_update_dto

typedef enum  { invoicingservice_invoice_line_update_dto_TAXCALCULATIONMETHOD_NULL = 0, invoicingservice_invoice_line_update_dto_TAXCALCULATIONMETHOD_Included, invoicingservice_invoice_line_update_dto_TAXCALCULATIONMETHOD_Excluded } invoicingservice_invoice_line_update_dto_TAXCALCULATIONMETHOD_e;
...
typedef struct invoice_line_update_dto_t {
    ...
    invoicingservice_invoice_line_update_dto_COSTCALCULATIONMETHOD_e cost_calculation_method; //enum
    invoicingservice_invoice_line_update_dto_TAXCALCULATIONMETHOD_e tax_calculation_method; //enum
