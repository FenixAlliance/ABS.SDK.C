/*
 * extended_invoice_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _extended_invoice_dto_collection_query_parameters_H_
#define _extended_invoice_dto_collection_query_parameters_H_
...
typedef struct extended_invoice_dto_collection_query_parameters_t extended_invoice_dto_collection_query_parameters_t;




typedef struct extended_invoice_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} extended_invoice_dto_collection_query_parameters_t;
...
#endif /* _extended_invoice_dto_collection_query_parameters_H_ */
