/*
 * invoice_adjustment_update_dto.h
 *
 * 
 */

#ifndef _invoice_adjustment_update_dto_H_
#define _invoice_adjustment_update_dto_H_
...
typedef struct invoice_adjustment_update_dto_t invoice_adjustment_update_dto_t;


// Enum TYPE for invoice_adjustment_update_dto

typedef enum  { invoicingservice_invoice_adjustment_update_dto_TYPE_NULL = 0, invoicingservice_invoice_adjustment_update_dto_TYPE_Discount, invoicingservice_invoice_adjustment_update_dto_TYPE_Surcharge } invoicingservice_invoice_adjustment_update_dto_TYPE_e;
...
typedef struct invoice_adjustment_update_dto_t {
    ...
    invoicingservice_invoice_adjustment_update_dto_TYPE_e type; //enum

} invoice_adjustment_update_dto_t;
...
#endif /* _invoice_adjustment_update_dto_H_ */
