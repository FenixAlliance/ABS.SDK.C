...
invoice_dto_t* instantiate_invoice_dto(int include_optional) {
  ...
  if (include_optional) {
    invoice_dto = invoice_dto_create(
      ...
      "0",
      "0",
      invoicingservice_invoice_dto_TAXCALCULATIONMETHOD_Included,
      invoicingservice_invoice_dto_COSTCALCULATIONMETHOD_Automatic,
      1.337,
      "0",
      1.337,
      "0",
      ...
      "0",
      "2013-10-20T19:20:30+01:00",
      invoicingservice_invoice_dto_INVOICETYPE_PurchaseInvoice,
      invoicingservice_invoice_dto_DOCUMENTTYPE_Standard,
      invoicingservice_invoice_dto_INVOICESTATUS_Draft
    );
  } else {
    invoice_dto = invoice_dto_create(
      "0",
