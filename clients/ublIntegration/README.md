# C API client for ublintegration
...
-l library name
```bash
gcc main.c -L. -lublintegration -o main
```
...
------------ | ------------- | ------------- | -------------
*CreditNotesAPI* | [**CreditNotesAPI_apiV2UblServiceCreditNotesInvoiceIdGet**](docs/CreditNotesAPI.md#CreditNotesAPI_apiV2UblServiceCreditNotesInvoiceIdGet) | **GET** /api/v2/UblService/CreditNotes/{invoiceId} | 
*DebitNotesAPI* | [**DebitNotesAPI_apiV2UblServiceDebitNotesInvoiceIdGet**](docs/DebitNotesAPI.md#DebitNotesAPI_apiV2UblServiceDebitNotesInvoiceIdGet) | **GET** /api/v2/UblService/DebitNotes/{invoiceId} | 
*DespatchAdvicesAPI* | [**DespatchAdvicesAPI_apiV2UblServiceDespatchAdvicesShipmentIdGet**](docs/DespatchAdvicesAPI.md#DespatchAdvicesAPI_apiV2UblServiceDespatchAdvicesShipmentIdGet) | **GET** /api/v2/UblService/DespatchAdvices/{shipmentId} | 
...
*InvoicesAPI* | [**InvoicesAPI_apiV2UblServiceInvoicesInvoiceIdGet**](docs/InvoicesAPI.md#InvoicesAPI_apiV2UblServiceInvoicesInvoiceIdGet) | **GET** /api/v2/UblService/Invoices/{invoiceId} | 
*ReceiptAdvicesAPI* | [**ReceiptAdvicesAPI_apiV2UblServiceReceiptAdvicesItemRestockIdGet**](docs/ReceiptAdvicesAPI.md#ReceiptAdvicesAPI_apiV2UblServiceReceiptAdvicesItemRestockIdGet) | **GET** /api/v2/UblService/ReceiptAdvices/{itemRestockId} | 
*ReceiptAdvicesAPI* | [**ReceiptAdvicesAPI_apiV2UblServiceReceiptAdvicesItemRestockIdPartitionsGet**](docs/ReceiptAdvicesAPI.md#ReceiptAdvicesAPI_apiV2UblServiceReceiptAdvicesItemRestockIdPartitionsGet) | **GET** /api/v2/UblService/ReceiptAdvices/{itemRestockId}/partitions | 
