...
// Functions for enum PROFILE for CreditNotesAPI_apiV2UblServiceCreditNotesInvoiceIdGet

static char* apiV2UblServiceCreditNotesInvoiceIdGet_PROFILE_ToString(ublintegration_apiV2UblServiceCreditNotesInvoiceIdGet_profile_e PROFILE){
    char *PROFILEArray[] =  { "NULL", "Generic", "Dian" };
    return PROFILEArray[PROFILE];
}

static ublintegration_apiV2UblServiceCreditNotesInvoiceIdGet_profile_e apiV2UblServiceCreditNotesInvoiceIdGet_PROFILE_FromString(char* PROFILE){
...
/*
// Function apiV2UblServiceCreditNotesInvoiceIdGet_PROFILE_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *apiV2UblServiceCreditNotesInvoiceIdGet_PROFILE_convertToJSON(ublintegration_apiV2UblServiceCreditNotesInvoiceIdGet_profile_e PROFILE) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "profile", apiV2UblServiceCreditNotesInvoiceIdGet_PROFILE_ToString(PROFILE)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function apiV2UblServiceCreditNotesInvoiceIdGet_PROFILE_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ublintegration_apiV2UblServiceCreditNotesInvoiceIdGet_profile_e apiV2UblServiceCreditNotesInvoiceIdGet_PROFILE_parseFromJSON(cJSON* PROFILEJSON) {
    ublintegration_apiV2UblServiceCreditNotesInvoiceIdGet_profile_e PROFILEVariable = 0;
    ...
    PROFILEVariable = apiV2UblServiceCreditNotesInvoiceIdGet_PROFILE_FromString(PROFILEVar->valuestring);
...
CreditNotesAPI_apiV2UblServiceCreditNotesInvoiceIdGet(apiClient_t *apiClient, char *tenantId, char *invoiceId, ublintegration_apiV2UblServiceCreditNotesInvoiceIdGet_profile_e profile, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/UblService/CreditNotes/{invoiceId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/UblService/CreditNotes/{invoiceId}");
    ...
    ublintegration_apiV2UblServiceCreditNotesInvoiceIdGet_profile_e valueQuery_profile ;
    keyValuePair_t *keyPairQuery_profile = 0;
    if (profile)
    {
        keyQuery_profile = strdup("profile");
        valueQuery_profile = (profile);
        keyPairQuery_profile = keyValuePair_create(keyQuery_profile, (void *)strdup(apiV2UblServiceCreditNotesInvoiceIdGet_PROFILE_ToString(
        valueQuery_profile)));
