...
// Functions for enum PROFILE for DebitNotesAPI_apiV2UblServiceDebitNotesInvoiceIdGet

static char* apiV2UblServiceDebitNotesInvoiceIdGet_PROFILE_ToString(ublintegration_apiV2UblServiceDebitNotesInvoiceIdGet_profile_e PROFILE){
    char *PROFILEArray[] =  { "NULL", "Generic", "Dian" };
    return PROFILEArray[PROFILE];
}

static ublintegration_apiV2UblServiceDebitNotesInvoiceIdGet_profile_e apiV2UblServiceDebitNotesInvoiceIdGet_PROFILE_FromString(char* PROFILE){
...
/*
// Function apiV2UblServiceDebitNotesInvoiceIdGet_PROFILE_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *apiV2UblServiceDebitNotesInvoiceIdGet_PROFILE_convertToJSON(ublintegration_apiV2UblServiceDebitNotesInvoiceIdGet_profile_e PROFILE) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "profile", apiV2UblServiceDebitNotesInvoiceIdGet_PROFILE_ToString(PROFILE)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function apiV2UblServiceDebitNotesInvoiceIdGet_PROFILE_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ublintegration_apiV2UblServiceDebitNotesInvoiceIdGet_profile_e apiV2UblServiceDebitNotesInvoiceIdGet_PROFILE_parseFromJSON(cJSON* PROFILEJSON) {
    ublintegration_apiV2UblServiceDebitNotesInvoiceIdGet_profile_e PROFILEVariable = 0;
    ...
    PROFILEVariable = apiV2UblServiceDebitNotesInvoiceIdGet_PROFILE_FromString(PROFILEVar->valuestring);
...
DebitNotesAPI_apiV2UblServiceDebitNotesInvoiceIdGet(apiClient_t *apiClient, char *tenantId, char *invoiceId, ublintegration_apiV2UblServiceDebitNotesInvoiceIdGet_profile_e profile, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/UblService/DebitNotes/{invoiceId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/UblService/DebitNotes/{invoiceId}");
    ...
    ublintegration_apiV2UblServiceDebitNotesInvoiceIdGet_profile_e valueQuery_profile ;
    keyValuePair_t *keyPairQuery_profile = 0;
    if (profile)
    {
        keyQuery_profile = strdup("profile");
        valueQuery_profile = (profile);
        keyPairQuery_profile = keyValuePair_create(keyQuery_profile, (void *)strdup(apiV2UblServiceDebitNotesInvoiceIdGet_PROFILE_ToString(
        valueQuery_profile)));
