...
typedef enum  { crmservice_simple_contact_dto_TYPE_NULL = 0, crmservice_simple_contact_dto_TYPE_Individual, crmservice_simple_contact_dto_TYPE_Organization } crmservice_simple_contact_dto_TYPE_e;

char* simple_contact_dto_type_ToString(crmservice_simple_contact_dto_TYPE_e type);

crmservice_simple_contact_dto_TYPE_e simple_contact_dto_type_FromString(char* type);
...
typedef struct simple_contact_dto_t {
    ...
    crmservice_simple_contact_dto_TYPE_e type; //enum
    char *email; // string
    char *phone; // string
...
simple_contact_dto_t *simple_contact_dto_create(
    ...
    char *qualified_name,
    char *tenant_id,
    crmservice_simple_contact_dto_TYPE_e type,
    char *email,
    char *phone,
    char *public_name,
    char *first_name,
