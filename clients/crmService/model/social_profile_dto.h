...
typedef enum  { crmservice_social_profile_dto_TYPE_NULL = 0, crmservice_social_profile_dto_TYPE_User, crmservice_social_profile_dto_TYPE_Tenant, crmservice_social_profile_dto_TYPE_Contact } crmservice_social_profile_dto_TYPE_e;

char* social_profile_dto_type_ToString(crmservice_social_profile_dto_TYPE_e type);

crmservice_social_profile_dto_TYPE_e social_profile_dto_type_FromString(char* type);
...
typedef struct social_profile_dto_t {
    ...
    crmservice_social_profile_dto_TYPE_e type; //enum
...
social_profile_dto_t *social_profile_dto_create(
    ...
    crmservice_social_profile_dto_TYPE_e type,
    char *social_feed_id,
    char *twitter_url,
    char *facebook_url,
    char *linked_in_url,
