/*
 * contact_relation_type_create_dto.h
 *
 * 
 */

#ifndef _contact_relation_type_create_dto_H_
#define _contact_relation_type_create_dto_H_
...
typedef struct contact_relation_type_create_dto_t contact_relation_type_create_dto_t;




typedef struct contact_relation_type_create_dto_t {
    char *id; // string
...
} contact_relation_type_create_dto_t;
...
#endif /* _contact_relation_type_create_dto_H_ */
