...
typedef enum  { crmservice_email_dispatch_request_ALERTTYPE_NULL = 0, crmservice_email_dispatch_request_ALERTTYPE_None, crmservice_email_dispatch_request_ALERTTYPE_Info, crmservice_email_dispatch_request_ALERTTYPE_Error, crmservice_email_dispatch_request_ALERTTYPE_Warning, crmservice_email_dispatch_request_ALERTTYPE_Success, crmservice_email_dispatch_request_ALERTTYPE_Action, crmservice_email_dispatch_request_ALERTTYPE_Alert } crmservice_email_dispatch_request_ALERTTYPE_e;
...
typedef struct email_dispatch_request_t {
    ...
    crmservice_email_dispatch_request_ALERTTYPE_e alert_type; //enum
    char *culture; // string
