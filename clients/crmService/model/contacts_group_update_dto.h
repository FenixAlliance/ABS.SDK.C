/*
 * contacts_group_update_dto.h
 *
 * 
 */

#ifndef _contacts_group_update_dto_H_
#define _contacts_group_update_dto_H_
...
typedef struct contacts_group_update_dto_t contacts_group_update_dto_t;




typedef struct contacts_group_update_dto_t {
    char *name; // string
    char *description; // string

} contacts_group_update_dto_t;
...
#endif /* _contacts_group_update_dto_H_ */
