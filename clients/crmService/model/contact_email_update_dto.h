/*
 * contact_email_update_dto.h
 *
 * 
 */

#ifndef _contact_email_update_dto_H_
#define _contact_email_update_dto_H_
...
typedef struct contact_email_update_dto_t contact_email_update_dto_t;




typedef struct contact_email_update_dto_t {
    char *address; // string
    char *label; // string
    int is_primary; //boolean

} contact_email_update_dto_t;
...
#endif /* _contact_email_update_dto_H_ */
