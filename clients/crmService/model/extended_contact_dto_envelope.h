/*
 * extended_contact_dto_envelope.h
 *
 * 
 */

#ifndef _extended_contact_dto_envelope_H_
#define _extended_contact_dto_envelope_H_
...
typedef struct extended_contact_dto_envelope_t extended_contact_dto_envelope_t;

#include "extended_contact_dto.h"



typedef struct extended_contact_dto_envelope_t {
    int is_success; //boolean
    char *error_message; // string
    char *correlation_id; // string
    char *timestamp; //date time
    char *activity_id; // string
    struct extended_contact_dto_t *result; //model
...
#endif /* _extended_contact_dto_envelope_H_ */
