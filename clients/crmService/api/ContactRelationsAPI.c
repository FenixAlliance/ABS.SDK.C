...
ContactRelationsAPI_createContactRelationAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, contact_relation_create_dto_t *contact_relation_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/ContactRelations")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/ContactRelations");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contact_relation_create_dto = NULL;
    if (contact_relation_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_contact_relation_create_dto = contact_relation_create_dto_convertToJSON(contact_relation_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contact_relation_create_dto);
    }
    ...
    if (localVarSingleItemJSON_contact_relation_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_contact_relation_create_dto);
        localVarSingleItemJSON_contact_relation_create_dto = NULL;
    }
...
ContactRelationsAPI_deleteContactRelationAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/ContactRelations/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/ContactRelations/{id}");
...
ContactRelationsAPI_getContactRelationByIdAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    cJSON *ContactRelationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    contact_relation_dto_t *elementToReturn = contact_relation_dto_parseFromJSON(ContactRelationsAPIlocalVarJSON);
    cJSON_Delete(ContactRelationsAPIlocalVarJSON);
...
ContactRelationsAPI_getContactRelationsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, contact_relation_dto_collection_query_parameters_t *contact_relation_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contact_relation_dto_collection_query_parameters = NULL;
    if (contact_relation_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_contact_relation_dto_collection_query_parameters = contact_relation_dto_collection_query_parameters_convertToJSON(contact_relation_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contact_relation_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ContactRelationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    contact_relation_dto_list_envelope_t *elementToReturn = contact_relation_dto_list_envelope_parseFromJSON(ContactRelationsAPIlocalVarJSON);
    cJSON_Delete(ContactRelationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_contact_relation_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_contact_relation_dto_collection_query_parameters);
        localVarSingleItemJSON_contact_relation_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ContactRelationsAPI_getContactRelationsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, contact_relation_dto_collection_query_parameters_t *contact_relation_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/ContactRelations/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/ContactRelations/Count");
    ...
    //nonprimitive not container
    cJSON *ContactRelationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ContactRelationsAPIlocalVarJSON);
    cJSON_Delete(ContactRelationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ContactRelationsAPI_patchContactRelationAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *ContactRelationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ContactRelationsAPIlocalVarJSON);
    cJSON_Delete(ContactRelationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ContactRelationsAPI_updateContactRelationAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, contact_relation_update_dto_t *contact_relation_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contact_relation_update_dto = NULL;
    if (contact_relation_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_contact_relation_update_dto = contact_relation_update_dto_convertToJSON(contact_relation_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contact_relation_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_contact_relation_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_contact_relation_update_dto);
        localVarSingleItemJSON_contact_relation_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
