...
ContactsAPI_createContactAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, contact_create_dto_t *contact_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contact_create_dto = NULL;
    if (contact_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_contact_create_dto = contact_create_dto_convertToJSON(contact_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contact_create_dto);
    }
    ...
    cJSON *ContactsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ContactsAPIlocalVarJSON);
    cJSON_Delete(ContactsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_contact_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_contact_create_dto);
        localVarSingleItemJSON_contact_create_dto = NULL;
    }
...
ContactsAPI_createContactEmailAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *api_version, char *x_api_version, contact_email_create_dto_t *contact_email_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/{contactId}/Emails/Addresses")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/{contactId}/Emails/Addresses");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contact_email_create_dto = NULL;
    if (contact_email_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_contact_email_create_dto = contact_email_create_dto_convertToJSON(contact_email_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contact_email_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_contact_email_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_contact_email_create_dto);
        localVarSingleItemJSON_contact_email_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ContactsAPI_createProfileForContactAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *api_version, char *x_api_version, contact_profile_create_dto_t *contact_profile_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/{contactId}/Profiles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/{contactId}/Profiles");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contact_profile_create_dto = NULL;
    if (contact_profile_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_contact_profile_create_dto = contact_profile_create_dto_convertToJSON(contact_profile_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contact_profile_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_contact_profile_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_contact_profile_create_dto);
        localVarSingleItemJSON_contact_profile_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ContactsAPI_deleteContactAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/{contactId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/{contactId}");
...
ContactsAPI_deleteContactEmailAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *emailId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/{contactId}/Emails/{emailId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/{contactId}/Emails/{emailId}");


    // Path Params
    long sizeOfPathParams_contactId = strlen(contactId)+3 + strlen(emailId)+3 + strlen("{ contactId }");
    if(contactId == NULL) {
        goto end;
    }
    char* localVarToReplace_contactId = malloc(sizeOfPathParams_contactId);
    ...
    // Path Params
    long sizeOfPathParams_emailId = strlen(contactId)+3 + strlen(emailId)+3 + strlen("{ emailId }");
    if(emailId == NULL) {
        goto end;
    }
    char* localVarToReplace_emailId = malloc(sizeOfPathParams_emailId);
    sprintf(localVarToReplace_emailId, "{%s}", "emailId");

    localVarPath = strReplace(localVarPath, localVarToReplace_emailId, emailId);
    if(emailId == NULL) {
        goto end;
    }
    char* localVarToReplace_emailId = malloc(sizeOfPathParams_emailId);
    ...
    free(localVarPath);
    free(localVarToReplace_contactId);
    free(localVarToReplace_emailId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
ContactsAPI_deleteProfileForContactAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *profileId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/{contactId}/Profiles/{profileId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/{contactId}/Profiles/{profileId}");


    // Path Params
    long sizeOfPathParams_contactId = strlen(contactId)+3 + strlen(profileId)+3 + strlen("{ contactId }");
    if(contactId == NULL) {
        goto end;
    }
    char* localVarToReplace_contactId = malloc(sizeOfPathParams_contactId);
    ...
    // Path Params
    long sizeOfPathParams_profileId = strlen(contactId)+3 + strlen(profileId)+3 + strlen("{ profileId }");
    if(profileId == NULL) {
        goto end;
    }
    char* localVarToReplace_profileId = malloc(sizeOfPathParams_profileId);
    sprintf(localVarToReplace_profileId, "{%s}", "profileId");

    localVarPath = strReplace(localVarPath, localVarToReplace_profileId, profileId);
    if(profileId == NULL) {
        goto end;
    }
    char* localVarToReplace_profileId = malloc(sizeOfPathParams_profileId);
    ...
    free(localVarPath);
    free(localVarToReplace_contactId);
    free(localVarToReplace_profileId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
ContactsAPI_getBusinessOwnedIndividualAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/Individuals/{contactId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/Individuals/{contactId}");
    ...
    //nonprimitive not container
    cJSON *ContactsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    contact_dto_envelope_t *elementToReturn = contact_dto_envelope_parseFromJSON(ContactsAPIlocalVarJSON);
    cJSON_Delete(ContactsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ContactsAPI_getBusinessOwnedIndividualsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, contact_dto_collection_query_parameters_t *contact_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/Individuals")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/Individuals");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contact_dto_collection_query_parameters = NULL;
    if (contact_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_contact_dto_collection_query_parameters = contact_dto_collection_query_parameters_convertToJSON(contact_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contact_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ContactsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    contact_dto_list_envelope_t *elementToReturn = contact_dto_list_envelope_parseFromJSON(ContactsAPIlocalVarJSON);
    cJSON_Delete(ContactsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_contact_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_contact_dto_collection_query_parameters);
        localVarSingleItemJSON_contact_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ContactsAPI_getBusinessOwnedIndividualsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, contact_dto_collection_query_parameters_t *contact_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/Individuals/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/Individuals/Count");
...
ContactsAPI_getBusinessOwnedOrganizationAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/Organizations/{contactId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/Organizations/{contactId}");
...
ContactsAPI_getBusinessOwnedOrganizationsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, contact_dto_collection_query_parameters_t *contact_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/Organizations")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/Organizations");
    ...
    //}
    cJSON *ContactsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(ContactsAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, ContactsAPIlocalVarJSON)
    {
...
ContactsAPI_getBusinessOwnedOrganizationsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, contact_dto_collection_query_parameters_t *contact_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/Organizations/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/Organizations/Count");
...
ContactsAPI_getContactAvatarAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/{contactId}/Avatar")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/{contactId}/Avatar");
...
ContactsAPI_getContactCartAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/{contactId}/Cart")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/{contactId}/Cart");
    ...
    //nonprimitive not container
    cJSON *ContactsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    cart_dto_envelope_t *elementToReturn = cart_dto_envelope_parseFromJSON(ContactsAPIlocalVarJSON);
    cJSON_Delete(ContactsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ContactsAPI_getContactEmailsAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *api_version, char *x_api_version, contact_email_dto_collection_query_parameters_t *contact_email_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/{contactId}/Emails")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/{contactId}/Emails");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contact_email_dto_collection_query_parameters = NULL;
    if (contact_email_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_contact_email_dto_collection_query_parameters = contact_email_dto_collection_query_parameters_convertToJSON(contact_email_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contact_email_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ContactsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    contact_email_dto_list_envelope_t *elementToReturn = contact_email_dto_list_envelope_parseFromJSON(ContactsAPIlocalVarJSON);
    cJSON_Delete(ContactsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_contact_email_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_contact_email_dto_collection_query_parameters);
        localVarSingleItemJSON_contact_email_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ContactsAPI_getContactEmailsCountAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *api_version, char *x_api_version, contact_email_dto_collection_query_parameters_t *contact_email_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/{contactId}/Emails/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/{contactId}/Emails/Count");
    ...
    //nonprimitive not container
    cJSON *ContactsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ContactsAPIlocalVarJSON);
    cJSON_Delete(ContactsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ContactsAPI_getContactSocialProfileAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/{contactId}/SocialProfile")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/{contactId}/SocialProfile");
    ...
    //nonprimitive not container
    cJSON *ContactsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    social_profile_dto_envelope_t *elementToReturn = social_profile_dto_envelope_parseFromJSON(ContactsAPIlocalVarJSON);
    cJSON_Delete(ContactsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ContactsAPI_getContactWalletAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/{contactId}/Wallet")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/{contactId}/Wallet");
    ...
    //nonprimitive not container
    cJSON *ContactsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    wallet_dto_envelope_t *elementToReturn = wallet_dto_envelope_parseFromJSON(ContactsAPIlocalVarJSON);
    cJSON_Delete(ContactsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ContactsAPI_getContactsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, contact_dto_collection_query_parameters_t *contact_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/Count");
...
ContactsAPI_getExtendedBusinessOwnedIndividualsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, extended_contact_dto_collection_query_parameters_t *extended_contact_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/Individuals/Extended")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/Individuals/Extended");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_extended_contact_dto_collection_query_parameters = NULL;
    if (extended_contact_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_extended_contact_dto_collection_query_parameters = extended_contact_dto_collection_query_parameters_convertToJSON(extended_contact_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_extended_contact_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ContactsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    extended_contact_dto_list_envelope_t *elementToReturn = extended_contact_dto_list_envelope_parseFromJSON(ContactsAPIlocalVarJSON);
    cJSON_Delete(ContactsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_extended_contact_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_extended_contact_dto_collection_query_parameters);
        localVarSingleItemJSON_extended_contact_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ContactsAPI_getExtendedBusinessOwnedOrganizationsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, extended_contact_dto_collection_query_parameters_t *extended_contact_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/Organizations/Extended")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/Organizations/Extended");
...
ContactsAPI_getExtendedContactAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/{contactId}/Extended")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/{contactId}/Extended");
    ...
    //nonprimitive not container
    cJSON *ContactsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    extended_contact_dto_envelope_t *elementToReturn = extended_contact_dto_envelope_parseFromJSON(ContactsAPIlocalVarJSON);
    cJSON_Delete(ContactsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ContactsAPI_getExtendedContactsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, extended_contact_dto_collection_query_parameters_t *extended_contact_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/Extended")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/Extended");
...
ContactsAPI_getIndividualRelatedIndividualsAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/Individuals/{contactId}/Individuals")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/Individuals/{contactId}/Individuals");
...
ContactsAPI_getIndividualRelatedOrganizationsAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/Individuals/{contactId}/Organizations")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/Individuals/{contactId}/Organizations");
...
ContactsAPI_getOrganizationRelatedIndividualsAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/Organizations/{contactId}/Individuals")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/Organizations/{contactId}/Individuals");
...
ContactsAPI_getOrganizationRelatedOrganizationsAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/Organizations/{contactId}/Organizations")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/Organizations/{contactId}/Organizations");
...
ContactsAPI_getProfilesForContactAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ContactsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    contact_profile_dto_list_envelope_t *elementToReturn = contact_profile_dto_list_envelope_parseFromJSON(ContactsAPIlocalVarJSON);
    cJSON_Delete(ContactsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ContactsAPI_getProfilesForContactCountAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *api_version, char *x_api_version, contact_profile_dto_collection_query_parameters_t *contact_profile_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/{contactId}/Profiles/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/{contactId}/Profiles/Count");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contact_profile_dto_collection_query_parameters = NULL;
    if (contact_profile_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_contact_profile_dto_collection_query_parameters = contact_profile_dto_collection_query_parameters_convertToJSON(contact_profile_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contact_profile_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_contact_profile_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_contact_profile_dto_collection_query_parameters);
        localVarSingleItemJSON_contact_profile_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ContactsAPI_previewContactEmailTemplate(apiClient_t *apiClient, char *contactId, char *api_version, char *x_api_version, email_dispatch_request_t *email_dispatch_request)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/{contactId}/Emails/Preview")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/{contactId}/Emails/Preview");
...
ContactsAPI_sendContactEmail(apiClient_t *apiClient, char *contactId, char *api_version, char *x_api_version, email_dispatch_request_t *email_dispatch_request)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/{contactId}/Emails/Send")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/{contactId}/Emails/Send");
...
ContactsAPI_updateContactAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *api_version, char *x_api_version, contact_update_dto_t *contact_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contact_update_dto = NULL;
    if (contact_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_contact_update_dto = contact_update_dto_convertToJSON(contact_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contact_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_contact_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_contact_update_dto);
        localVarSingleItemJSON_contact_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ContactsAPI_updateContactEmailAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *emailId, char *api_version, char *x_api_version, contact_email_update_dto_t *contact_email_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contact_email_update_dto = NULL;
    if (contact_email_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_contact_email_update_dto = contact_email_update_dto_convertToJSON(contact_email_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contact_email_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_contact_email_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_contact_email_update_dto);
        localVarSingleItemJSON_contact_email_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ContactsAPI_updateProfileForContactAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *profileId, char *api_version, char *x_api_version, contact_profile_update_dto_t *contact_profile_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contact_profile_update_dto = NULL;
    if (contact_profile_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_contact_profile_update_dto = contact_profile_update_dto_convertToJSON(contact_profile_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contact_profile_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_contact_profile_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_contact_profile_update_dto);
        localVarSingleItemJSON_contact_profile_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ContactsAPI_upsertTenantOntoAnotherTenantContactListAsync(apiClient_t *apiClient, char *tenantId, char *relatedTenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/Organizations/Upsert")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/Organizations/Upsert");
...
ContactsAPI_upsertUserOntoAnotherTenantContactListAsync(apiClient_t *apiClient, char *tenantId, char *relatedUserId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/Individuals/Upsert")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/Individuals/Upsert");
...
ContactsAPI_verifyContactEmailAsync(apiClient_t *apiClient, char *tenantId, char *contactId, char *emailId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/Contacts/{contactId}/Emails/{emailId}/Verify")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/Contacts/{contactId}/Emails/{emailId}/Verify");
