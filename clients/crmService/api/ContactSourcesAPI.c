...
ContactSourcesAPI_createContactSourceAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, contact_source_create_dto_t *contact_source_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/ContactSources")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/ContactSources");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contact_source_create_dto = NULL;
    if (contact_source_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_contact_source_create_dto = contact_source_create_dto_convertToJSON(contact_source_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contact_source_create_dto);
    }
    ...
    if (localVarSingleItemJSON_contact_source_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_contact_source_create_dto);
        localVarSingleItemJSON_contact_source_create_dto = NULL;
    }
...
ContactSourcesAPI_deleteContactSourceAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/ContactSources/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/ContactSources/{id}");
...
ContactSourcesAPI_getContactSourceByIdAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    cJSON *ContactSourcesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    contact_source_dto_t *elementToReturn = contact_source_dto_parseFromJSON(ContactSourcesAPIlocalVarJSON);
    cJSON_Delete(ContactSourcesAPIlocalVarJSON);
...
ContactSourcesAPI_getContactSourcesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, contact_source_dto_collection_query_parameters_t *contact_source_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contact_source_dto_collection_query_parameters = NULL;
    if (contact_source_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_contact_source_dto_collection_query_parameters = contact_source_dto_collection_query_parameters_convertToJSON(contact_source_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contact_source_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ContactSourcesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    contact_source_dto_list_envelope_t *elementToReturn = contact_source_dto_list_envelope_parseFromJSON(ContactSourcesAPIlocalVarJSON);
    cJSON_Delete(ContactSourcesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_contact_source_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_contact_source_dto_collection_query_parameters);
        localVarSingleItemJSON_contact_source_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ContactSourcesAPI_getContactSourcesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, contact_source_dto_collection_query_parameters_t *contact_source_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/ContactSources/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/ContactSources/Count");
    ...
    //nonprimitive not container
    cJSON *ContactSourcesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ContactSourcesAPIlocalVarJSON);
    cJSON_Delete(ContactSourcesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ContactSourcesAPI_patchContactSourceAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *ContactSourcesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ContactSourcesAPIlocalVarJSON);
    cJSON_Delete(ContactSourcesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ContactSourcesAPI_updateContactSourceAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, contact_source_update_dto_t *contact_source_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contact_source_update_dto = NULL;
    if (contact_source_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_contact_source_update_dto = contact_source_update_dto_convertToJSON(contact_source_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contact_source_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_contact_source_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_contact_source_update_dto);
        localVarSingleItemJSON_contact_source_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
