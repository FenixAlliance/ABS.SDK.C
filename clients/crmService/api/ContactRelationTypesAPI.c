...
#include <stdio.h>
#include <ctype.h>
#include "ContactRelationTypesAPI.h"
...
ContactRelationTypesAPI_createContactRelationTypeAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, contact_relation_type_create_dto_t *contact_relation_type_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/ContactRelationTypes")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/ContactRelationTypes");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contact_relation_type_create_dto = NULL;
    if (contact_relation_type_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_contact_relation_type_create_dto = contact_relation_type_create_dto_convertToJSON(contact_relation_type_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contact_relation_type_create_dto);
    }
    ...
    if (localVarSingleItemJSON_contact_relation_type_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_contact_relation_type_create_dto);
        localVarSingleItemJSON_contact_relation_type_create_dto = NULL;
    }
...
ContactRelationTypesAPI_deleteContactRelationTypeAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/ContactRelationTypes/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/ContactRelationTypes/{id}");
...
ContactRelationTypesAPI_getContactRelationTypeByIdAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    cJSON *ContactRelationTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    contact_relation_type_dto_t *elementToReturn = contact_relation_type_dto_parseFromJSON(ContactRelationTypesAPIlocalVarJSON);
    cJSON_Delete(ContactRelationTypesAPIlocalVarJSON);
...
ContactRelationTypesAPI_getContactRelationTypesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, contact_relation_type_dto_collection_query_parameters_t *contact_relation_type_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contact_relation_type_dto_collection_query_parameters = NULL;
    if (contact_relation_type_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_contact_relation_type_dto_collection_query_parameters = contact_relation_type_dto_collection_query_parameters_convertToJSON(contact_relation_type_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contact_relation_type_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ContactRelationTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    contact_relation_type_dto_list_envelope_t *elementToReturn = contact_relation_type_dto_list_envelope_parseFromJSON(ContactRelationTypesAPIlocalVarJSON);
    cJSON_Delete(ContactRelationTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_contact_relation_type_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_contact_relation_type_dto_collection_query_parameters);
        localVarSingleItemJSON_contact_relation_type_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ContactRelationTypesAPI_getContactRelationTypesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, contact_relation_type_dto_collection_query_parameters_t *contact_relation_type_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/ContactRelationTypes/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/ContactRelationTypes/Count");
    ...
    //nonprimitive not container
    cJSON *ContactRelationTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ContactRelationTypesAPIlocalVarJSON);
    cJSON_Delete(ContactRelationTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ContactRelationTypesAPI_patchContactRelationTypeAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *ContactRelationTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ContactRelationTypesAPIlocalVarJSON);
    cJSON_Delete(ContactRelationTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ContactRelationTypesAPI_updateContactRelationTypeAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, contact_relation_type_update_dto_t *contact_relation_type_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contact_relation_type_update_dto = NULL;
    if (contact_relation_type_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_contact_relation_type_update_dto = contact_relation_type_update_dto_convertToJSON(contact_relation_type_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contact_relation_type_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_contact_relation_type_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_contact_relation_type_update_dto);
        localVarSingleItemJSON_contact_relation_type_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
