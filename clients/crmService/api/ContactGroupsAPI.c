...
ContactGroupsAPI_createContactGroupAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, contacts_group_create_dto_t *contacts_group_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/ContactGroups")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/ContactGroups");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contacts_group_create_dto = NULL;
    if (contacts_group_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_contacts_group_create_dto = contacts_group_create_dto_convertToJSON(contacts_group_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contacts_group_create_dto);
    }
    ...
    if (localVarSingleItemJSON_contacts_group_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_contacts_group_create_dto);
        localVarSingleItemJSON_contacts_group_create_dto = NULL;
    }
...
ContactGroupsAPI_deleteContactGroupAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/ContactGroups/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/ContactGroups/{id}");
...
ContactGroupsAPI_getContactGroupByIdAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    cJSON *ContactGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    contacts_group_dto_t *elementToReturn = contacts_group_dto_parseFromJSON(ContactGroupsAPIlocalVarJSON);
    cJSON_Delete(ContactGroupsAPIlocalVarJSON);
...
ContactGroupsAPI_getContactGroupsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, contacts_group_dto_collection_query_parameters_t *contacts_group_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contacts_group_dto_collection_query_parameters = NULL;
    if (contacts_group_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_contacts_group_dto_collection_query_parameters = contacts_group_dto_collection_query_parameters_convertToJSON(contacts_group_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contacts_group_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ContactGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    contacts_group_dto_list_envelope_t *elementToReturn = contacts_group_dto_list_envelope_parseFromJSON(ContactGroupsAPIlocalVarJSON);
    cJSON_Delete(ContactGroupsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_contacts_group_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_contacts_group_dto_collection_query_parameters);
        localVarSingleItemJSON_contacts_group_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ContactGroupsAPI_getContactGroupsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, contacts_group_dto_collection_query_parameters_t *contacts_group_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CrmService/ContactGroups/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CrmService/ContactGroups/Count");
    ...
    //nonprimitive not container
    cJSON *ContactGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ContactGroupsAPIlocalVarJSON);
    cJSON_Delete(ContactGroupsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ContactGroupsAPI_patchContactGroupAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *ContactGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ContactGroupsAPIlocalVarJSON);
    cJSON_Delete(ContactGroupsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ContactGroupsAPI_updateContactGroupAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, contacts_group_update_dto_t *contacts_group_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_contacts_group_update_dto = NULL;
    if (contacts_group_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_contacts_group_update_dto = contacts_group_update_dto_convertToJSON(contacts_group_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_contacts_group_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_contacts_group_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_contacts_group_update_dto);
        localVarSingleItemJSON_contacts_group_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
