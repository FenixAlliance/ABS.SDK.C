...
//
contact_source_dto_list_envelope_t* ContactSourcesAPI_getContactSourcesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
//
int32_envelope_t* ContactSourcesAPI_getContactSourcesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
// Patch a contact source
//
empty_envelope_t* ContactSourcesAPI_patchContactSourceAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *operation);
```
