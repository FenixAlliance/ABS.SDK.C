...
//
contact_relation_type_dto_list_envelope_t* ContactRelationTypesAPI_getContactRelationTypesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
//
int32_envelope_t* ContactRelationTypesAPI_getContactRelationTypesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
// Patch a contact relation type
//
empty_envelope_t* ContactRelationTypesAPI_patchContactRelationTypeAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *operation);
```
