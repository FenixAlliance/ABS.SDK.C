...
------------- | ------------- | -------------
[**SalesLiteraturesAPI_countSalesLiteraturesAsync**](SalesLiteraturesAPI.md#SalesLiteraturesAPI_countSalesLiteraturesAsync) | **GET** /api/v2/SalesService/SalesLiteratures/Count | Get sales literatures count
[**SalesLiteraturesAPI_createSalesLiteratureAsync**](SalesLiteraturesAPI.md#SalesLiteraturesAPI_createSalesLiteratureAsync) | **POST** /api/v2/SalesService/SalesLiteratures | Create a sales literature
[**SalesLiteraturesAPI_deleteSalesLiteratureAsync**](SalesLiteraturesAPI.md#SalesLiteraturesAPI_deleteSalesLiteratureAsync) | **DELETE** /api/v2/SalesService/SalesLiteratures/{salesLiteratureId} | Delete a sales literature
