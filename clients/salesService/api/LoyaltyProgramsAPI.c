...
LoyaltyProgramsAPI_countLoyaltyProgramsAsync(apiClient_t *apiClient, char *tenantId, loyalty_program_dto_collection_query_parameters_t *loyalty_program_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_loyalty_program_dto_collection_query_parameters = NULL;
    if (loyalty_program_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_loyalty_program_dto_collection_query_parameters = loyalty_program_dto_collection_query_parameters_convertToJSON(loyalty_program_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_loyalty_program_dto_collection_query_parameters);
    }
    ...
    free(localVarPath);
    if (localVarSingleItemJSON_loyalty_program_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_loyalty_program_dto_collection_query_parameters);
        localVarSingleItemJSON_loyalty_program_dto_collection_query_parameters = NULL;
    }
