...
SalesLiteraturesAPI_countSalesLiteraturesAsync(apiClient_t *apiClient, char *tenantId)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SalesService/SalesLiteratures/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SalesService/SalesLiteratures/Count");
...
SalesLiteraturesAPI_createSalesLiteratureAsync(apiClient_t *apiClient, char *tenantId, sales_literature_create_dto_t *sales_literature_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SalesService/SalesLiteratures")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SalesService/SalesLiteratures");
...
SalesLiteraturesAPI_deleteSalesLiteratureAsync(apiClient_t *apiClient, char *tenantId, char *salesLiteratureId)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SalesService/SalesLiteratures/{salesLiteratureId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SalesService/SalesLiteratures/{salesLiteratureId}");
...
SalesLiteraturesAPI_getExtendedSalesLiteraturesAsync(apiClient_t *apiClient, char *tenantId)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SalesService/SalesLiteratures/Extended")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SalesService/SalesLiteratures/Extended");
