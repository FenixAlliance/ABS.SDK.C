...
license_attribute_dto_list_envelope_t *license_attribute_dto_list_envelope_create(
    ...
    license_attribute_dto_list_envelope_local_var->http_status = http_status;
    license_attribute_dto_list_envelope_local_var->error_code = error_code;
    license_attribute_dto_list_envelope_local_var->validation_details = validation_details;
...
void license_attribute_dto_list_envelope_free(license_attribute_dto_list_envelope_t *license_attribute_dto_list_envelope) {
    ...
    if (license_attribute_dto_list_envelope->error_code) {
        free(license_attribute_dto_list_envelope->error_code);
        license_attribute_dto_list_envelope->error_code = NULL;
    }
    if (license_attribute_dto_list_envelope->validation_details) {
        list_ForEach(listEntry, license_attribute_dto_list_envelope->validation_details) {
            keyValuePair_t *localKeyValue = (keyValuePair_t*) listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_freeList(license_attribute_dto_list_envelope->validation_details);
        license_attribute_dto_list_envelope->validation_details = NULL;
    }
...
cJSON *license_attribute_dto_list_envelope_convertToJSON(license_attribute_dto_list_envelope_t *license_attribute_dto_list_envelope) {
    ...
    // license_attribute_dto_list_envelope->http_status
    if(license_attribute_dto_list_envelope->http_status) {
    if(cJSON_AddNumberToObject(item, "httpStatus", license_attribute_dto_list_envelope->http_status) == NULL) {
    goto fail; //Numeric
    }
    }


    // license_attribute_dto_list_envelope->error_code
    if(license_attribute_dto_list_envelope->error_code) {
    if(cJSON_AddStringToObject(item, "errorCode", license_attribute_dto_list_envelope->error_code) == NULL) {
    goto fail; //String
    }
    }


    // license_attribute_dto_list_envelope->validation_details
    if(license_attribute_dto_list_envelope->validation_details) {
    ...
    if (license_attribute_dto_list_envelope->validation_details) {
    list_ForEach(validation_detailsListEntry, license_attribute_dto_list_envelope->validation_details) {
...
license_attribute_dto_list_envelope_t *license_attribute_dto_list_envelope_parseFromJSON(cJSON *license_attribute_dto_list_envelopeJSON){
    ...
    // define the local map for license_attribute_dto_list_envelope->validation_details
    ...
    // license_attribute_dto_list_envelope->http_status
    cJSON *http_status = cJSON_GetObjectItemCaseSensitive(license_attribute_dto_list_envelopeJSON, "httpStatus");
    if (http_status) { 
    ...
    // license_attribute_dto_list_envelope->error_code
    cJSON *error_code = cJSON_GetObjectItemCaseSensitive(license_attribute_dto_list_envelopeJSON, "errorCode");
    if (error_code) { 
    ...
    // license_attribute_dto_list_envelope->validation_details
    cJSON *validation_details = cJSON_GetObjectItemCaseSensitive(license_attribute_dto_list_envelopeJSON, "validationDetails");
