...
licensing_certificate_dto_list_envelope_t *licensing_certificate_dto_list_envelope_create(
    ...
    licensing_certificate_dto_list_envelope_local_var->http_status = http_status;
    licensing_certificate_dto_list_envelope_local_var->error_code = error_code;
    licensing_certificate_dto_list_envelope_local_var->validation_details = validation_details;
...
void licensing_certificate_dto_list_envelope_free(licensing_certificate_dto_list_envelope_t *licensing_certificate_dto_list_envelope) {
    ...
    if (licensing_certificate_dto_list_envelope->error_code) {
        free(licensing_certificate_dto_list_envelope->error_code);
        licensing_certificate_dto_list_envelope->error_code = NULL;
    }
    if (licensing_certificate_dto_list_envelope->validation_details) {
        list_ForEach(listEntry, licensing_certificate_dto_list_envelope->validation_details) {
            keyValuePair_t *localKeyValue = (keyValuePair_t*) listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_freeList(licensing_certificate_dto_list_envelope->validation_details);
        licensing_certificate_dto_list_envelope->validation_details = NULL;
    }
...
cJSON *licensing_certificate_dto_list_envelope_convertToJSON(licensing_certificate_dto_list_envelope_t *licensing_certificate_dto_list_envelope) {
    ...
    // licensing_certificate_dto_list_envelope->http_status
    if(licensing_certificate_dto_list_envelope->http_status) {
    if(cJSON_AddNumberToObject(item, "httpStatus", licensing_certificate_dto_list_envelope->http_status) == NULL) {
    goto fail; //Numeric
    }
    }


    // licensing_certificate_dto_list_envelope->error_code
    if(licensing_certificate_dto_list_envelope->error_code) {
    if(cJSON_AddStringToObject(item, "errorCode", licensing_certificate_dto_list_envelope->error_code) == NULL) {
    goto fail; //String
    }
    }


    // licensing_certificate_dto_list_envelope->validation_details
    if(licensing_certificate_dto_list_envelope->validation_details) {
    ...
    if (licensing_certificate_dto_list_envelope->validation_details) {
    list_ForEach(validation_detailsListEntry, licensing_certificate_dto_list_envelope->validation_details) {
...
licensing_certificate_dto_list_envelope_t *licensing_certificate_dto_list_envelope_parseFromJSON(cJSON *licensing_certificate_dto_list_envelopeJSON){
    ...
    // define the local map for licensing_certificate_dto_list_envelope->validation_details
    ...
    // licensing_certificate_dto_list_envelope->http_status
    cJSON *http_status = cJSON_GetObjectItemCaseSensitive(licensing_certificate_dto_list_envelopeJSON, "httpStatus");
    if (http_status) { 
    ...
    // licensing_certificate_dto_list_envelope->error_code
    cJSON *error_code = cJSON_GetObjectItemCaseSensitive(licensing_certificate_dto_list_envelopeJSON, "errorCode");
    if (error_code) { 
    ...
    // licensing_certificate_dto_list_envelope->validation_details
    cJSON *validation_details = cJSON_GetObjectItemCaseSensitive(licensing_certificate_dto_list_envelopeJSON, "validationDetails");
