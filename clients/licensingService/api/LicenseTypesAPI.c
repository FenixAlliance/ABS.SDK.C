...
LicenseTypesAPI_createLicenseTypeAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, license_type_create_dto_t *license_type_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LicensingService/LicenseTypes")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LicensingService/LicenseTypes");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_license_type_create_dto = NULL;
    if (license_type_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_license_type_create_dto = license_type_create_dto_convertToJSON(license_type_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_license_type_create_dto);
    }
    ...
    if (localVarSingleItemJSON_license_type_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_license_type_create_dto);
        localVarSingleItemJSON_license_type_create_dto = NULL;
    }
...
LicenseTypesAPI_deleteLicenseTypeAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LicensingService/LicenseTypes/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LicensingService/LicenseTypes/{id}");
...
LicenseTypesAPI_getLicenseTypeByIdAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    cJSON *LicenseTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    license_type_dto_t *elementToReturn = license_type_dto_parseFromJSON(LicenseTypesAPIlocalVarJSON);
    cJSON_Delete(LicenseTypesAPIlocalVarJSON);
...
LicenseTypesAPI_getLicenseTypesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *LicenseTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    license_type_dto_list_envelope_t *elementToReturn = license_type_dto_list_envelope_parseFromJSON(LicenseTypesAPIlocalVarJSON);
    cJSON_Delete(LicenseTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
LicenseTypesAPI_getLicenseTypesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LicensingService/LicenseTypes/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LicensingService/LicenseTypes/Count");
    ...
    //nonprimitive not container
    cJSON *LicenseTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(LicenseTypesAPIlocalVarJSON);
    cJSON_Delete(LicenseTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
LicenseTypesAPI_patchLicenseTypeAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *operation)
{
    ...
    //nonprimitive not container
    cJSON *LicenseTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(LicenseTypesAPIlocalVarJSON);
    cJSON_Delete(LicenseTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
LicenseTypesAPI_updateLicenseTypeAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, license_type_update_dto_t *license_type_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_license_type_update_dto = NULL;
    if (license_type_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_license_type_update_dto = license_type_update_dto_convertToJSON(license_type_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_license_type_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_license_type_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_license_type_update_dto);
        localVarSingleItemJSON_license_type_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
