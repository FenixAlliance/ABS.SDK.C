...
LicenseFeaturesAPI_createLicenseFeatureAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, license_feature_create_dto_t *license_feature_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LicensingService/LicenseFeatures")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LicensingService/LicenseFeatures");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_license_feature_create_dto = NULL;
    if (license_feature_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_license_feature_create_dto = license_feature_create_dto_convertToJSON(license_feature_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_license_feature_create_dto);
    }
    ...
    if (localVarSingleItemJSON_license_feature_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_license_feature_create_dto);
        localVarSingleItemJSON_license_feature_create_dto = NULL;
    }
...
LicenseFeaturesAPI_deleteLicenseFeatureAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LicensingService/LicenseFeatures/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LicensingService/LicenseFeatures/{id}");
...
LicenseFeaturesAPI_getLicenseFeatureByIdAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    cJSON *LicenseFeaturesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    license_feature_dto_t *elementToReturn = license_feature_dto_parseFromJSON(LicenseFeaturesAPIlocalVarJSON);
    cJSON_Delete(LicenseFeaturesAPIlocalVarJSON);
...
LicenseFeaturesAPI_getLicenseFeaturesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, license_feature_dto_collection_query_parameters_t *license_feature_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_license_feature_dto_collection_query_parameters = NULL;
    if (license_feature_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_license_feature_dto_collection_query_parameters = license_feature_dto_collection_query_parameters_convertToJSON(license_feature_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_license_feature_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *LicenseFeaturesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    license_feature_dto_list_envelope_t *elementToReturn = license_feature_dto_list_envelope_parseFromJSON(LicenseFeaturesAPIlocalVarJSON);
    cJSON_Delete(LicenseFeaturesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_license_feature_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_license_feature_dto_collection_query_parameters);
        localVarSingleItemJSON_license_feature_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
LicenseFeaturesAPI_getLicenseFeaturesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, license_feature_dto_collection_query_parameters_t *license_feature_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LicensingService/LicenseFeatures/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LicensingService/LicenseFeatures/Count");
    ...
    //nonprimitive not container
    cJSON *LicenseFeaturesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(LicenseFeaturesAPIlocalVarJSON);
    cJSON_Delete(LicenseFeaturesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
LicenseFeaturesAPI_patchLicenseFeatureAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *LicenseFeaturesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(LicenseFeaturesAPIlocalVarJSON);
    cJSON_Delete(LicenseFeaturesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
LicenseFeaturesAPI_updateLicenseFeatureAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, license_feature_update_dto_t *license_feature_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_license_feature_update_dto = NULL;
    if (license_feature_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_license_feature_update_dto = license_feature_update_dto_convertToJSON(license_feature_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_license_feature_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_license_feature_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_license_feature_update_dto);
        localVarSingleItemJSON_license_feature_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
