...
#include <stdio.h>
#include <ctype.h>
#include "LicenseAttributesAPI.h"
...
LicenseAttributesAPI_createLicenseAttributeAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, license_attribute_create_dto_t *license_attribute_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LicensingService/LicenseAttributes")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LicensingService/LicenseAttributes");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_license_attribute_create_dto = NULL;
    if (license_attribute_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_license_attribute_create_dto = license_attribute_create_dto_convertToJSON(license_attribute_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_license_attribute_create_dto);
    }
    ...
    if (localVarSingleItemJSON_license_attribute_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_license_attribute_create_dto);
        localVarSingleItemJSON_license_attribute_create_dto = NULL;
    }
...
LicenseAttributesAPI_deleteLicenseAttributeAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LicensingService/LicenseAttributes/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LicensingService/LicenseAttributes/{id}");
...
LicenseAttributesAPI_getLicenseAttributeByIdAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    cJSON *LicenseAttributesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    license_attribute_dto_t *elementToReturn = license_attribute_dto_parseFromJSON(LicenseAttributesAPIlocalVarJSON);
    cJSON_Delete(LicenseAttributesAPIlocalVarJSON);
...
LicenseAttributesAPI_getLicenseAttributesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, license_attribute_dto_collection_query_parameters_t *license_attribute_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_license_attribute_dto_collection_query_parameters = NULL;
    if (license_attribute_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_license_attribute_dto_collection_query_parameters = license_attribute_dto_collection_query_parameters_convertToJSON(license_attribute_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_license_attribute_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *LicenseAttributesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    license_attribute_dto_list_envelope_t *elementToReturn = license_attribute_dto_list_envelope_parseFromJSON(LicenseAttributesAPIlocalVarJSON);
    cJSON_Delete(LicenseAttributesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_license_attribute_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_license_attribute_dto_collection_query_parameters);
        localVarSingleItemJSON_license_attribute_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
LicenseAttributesAPI_getLicenseAttributesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, license_attribute_dto_collection_query_parameters_t *license_attribute_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LicensingService/LicenseAttributes/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LicensingService/LicenseAttributes/Count");
    ...
    //nonprimitive not container
    cJSON *LicenseAttributesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(LicenseAttributesAPIlocalVarJSON);
    cJSON_Delete(LicenseAttributesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
LicenseAttributesAPI_patchLicenseAttributeAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *LicenseAttributesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(LicenseAttributesAPIlocalVarJSON);
    cJSON_Delete(LicenseAttributesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
LicenseAttributesAPI_updateLicenseAttributeAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, license_attribute_update_dto_t *license_attribute_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_license_attribute_update_dto = NULL;
    if (license_attribute_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_license_attribute_update_dto = license_attribute_update_dto_convertToJSON(license_attribute_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_license_attribute_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_license_attribute_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_license_attribute_update_dto);
        localVarSingleItemJSON_license_attribute_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
