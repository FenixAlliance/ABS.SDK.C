...
LicensingCertificatesAPI_getLicensingCertificatesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, licensing_certificate_dto_collection_query_parameters_t *licensing_certificate_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_licensing_certificate_dto_collection_query_parameters = NULL;
    if (licensing_certificate_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_licensing_certificate_dto_collection_query_parameters = licensing_certificate_dto_collection_query_parameters_convertToJSON(licensing_certificate_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_licensing_certificate_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_licensing_certificate_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_licensing_certificate_dto_collection_query_parameters);
        localVarSingleItemJSON_licensing_certificate_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
