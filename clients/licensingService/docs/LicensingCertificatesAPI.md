...
//
licensing_certificate_dto_list_envelope_t* LicensingCertificatesAPI_getLicensingCertificatesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
//
int32_envelope_t* LicensingCertificatesAPI_getLicensingCertificatesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
//
empty_envelope_t* LicensingCertificatesAPI_patchLicensingCertificateAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *operation);
```
