...
//
license_attribute_dto_list_envelope_t* LicenseAttributesAPI_getLicenseAttributesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, license_attribute_dto_collection_query_parameters_t *license_attribute_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**license_attribute_dto_collection_query_parameters** | **[license_attribute_dto_collection_query_parameters_t](license_attribute_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* LicenseAttributesAPI_getLicenseAttributesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, license_attribute_dto_collection_query_parameters_t *license_attribute_dto_collection_query_parameters);
```
...
//
empty_envelope_t* LicenseAttributesAPI_patchLicenseAttributeAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *patch_operation);
```
