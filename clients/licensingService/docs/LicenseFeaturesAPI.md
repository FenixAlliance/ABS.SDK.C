...
//
license_feature_dto_list_envelope_t* LicenseFeaturesAPI_getLicenseFeaturesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
//
int32_envelope_t* LicenseFeaturesAPI_getLicenseFeaturesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
//
empty_envelope_t* LicenseFeaturesAPI_patchLicenseFeatureAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *operation);
```
