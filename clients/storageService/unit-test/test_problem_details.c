...
void test_problem_details(int include_optional) {
    problem_details_t* problem_details_1 = instantiate_problem_details(include_optional);

	cJSON* jsonproblem_details_1 = problem_details_convertToJSON(problem_details_1);
	printf("problem_details :\n%s\n", cJSON_Print(jsonproblem_details_1));
	problem_details_t* problem_details_2 = problem_details_parseFromJSON(jsonproblem_details_1);
	cJSON* jsonproblem_details_2 = problem_details_convertToJSON(problem_details_2);
