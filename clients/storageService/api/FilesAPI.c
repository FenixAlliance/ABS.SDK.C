...
// Functions for enum PUBLICACCESSTYPE for FilesAPI_createFileAsync

static char* createFileAsync_PUBLICACCESSTYPE_ToString(storageservice_createFileAsync_publicAccessType_e PUBLICACCESSTYPE){
    char *PUBLICACCESSTYPEArray[] =  { "NULL", "false", "Container", "Blob", "Unknown" };
    return PUBLICACCESSTYPEArray[PUBLICACCESSTYPE];
}

static storageservice_createFileAsync_publicAccessType_e createFileAsync_PUBLICACCESSTYPE_FromString(char* PUBLICACCESSTYPE){
...
/*
// Function createFileAsync_PUBLICACCESSTYPE_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *createFileAsync_PUBLICACCESSTYPE_convertToJSON(storageservice_createFileAsync_publicAccessType_e PUBLICACCESSTYPE) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "publicAccessType", createFileAsync_PUBLICACCESSTYPE_ToString(PUBLICACCESSTYPE)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function createFileAsync_PUBLICACCESSTYPE_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static storageservice_createFileAsync_publicAccessType_e createFileAsync_PUBLICACCESSTYPE_parseFromJSON(cJSON* PUBLICACCESSTYPEJSON) {
    storageservice_createFileAsync_publicAccessType_e PUBLICACCESSTYPEVariable = 0;
    ...
    PUBLICACCESSTYPEVariable = createFileAsync_PUBLICACCESSTYPE_FromString(PUBLICACCESSTYPEVar->valuestring);
...
// Functions for enum PURPOSE for FilesAPI_createFileAsync

static char* createFileAsync_PURPOSE_ToString(storageservice_createFileAsync_purpose_e PURPOSE){
...
static storageservice_createFileAsync_purpose_e createFileAsync_PURPOSE_FromString(char* PURPOSE){
    int stringToReturn = 0;
    char *PURPOSEArray[] =  { "NULL", "Unknown", "IdentityAvatar", "IdentityBanner", "ProfileAsset", "EngagementInline", "EngagementAttachment", "MessageAttachment", "SocialPost", "RecordAttachment", "AiGenerated", "SystemArtifact", "Temporary" };
...
/*
// Function createFileAsync_PURPOSE_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *createFileAsync_PURPOSE_convertToJSON(storageservice_createFileAsync_purpose_e PURPOSE) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "purpose", createFileAsync_PURPOSE_ToString(PURPOSE)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function createFileAsync_PURPOSE_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static storageservice_createFileAsync_purpose_e createFileAsync_PURPOSE_parseFromJSON(cJSON* PURPOSEJSON) {
    storageservice_createFileAsync_purpose_e PURPOSEVariable = 0;
    ...
    PURPOSEVariable = createFileAsync_PURPOSE_FromString(PURPOSEVar->valuestring);
...
// Functions for enum APPFILESOURCE for FilesAPI_createFileAsync

static char* createFileAsync_APPFILESOURCE_ToString(storageservice_createFileAsync_appFile.source_e APPFILESOURCE){
...
static storageservice_createFileAsync_appFile.source_e createFileAsync_APPFILESOURCE_FromString(char* APPFILESOURCE){
    int stringToReturn = 0;
    char *APPFILESOURCEArray[] =  { "NULL", "Unknown", "HttpUpload", "Integration", "InternalProcess", "ApiClient", "WorkflowEngine" };
...
/*
// Function createFileAsync_APPFILESOURCE_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *createFileAsync_APPFILESOURCE_convertToJSON(storageservice_createFileAsync_appFile.source_e APPFILESOURCE) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "appFile.source", createFileAsync_APPFILESOURCE_ToString(APPFILESOURCE)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function createFileAsync_APPFILESOURCE_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static storageservice_createFileAsync_appFile.source_e createFileAsync_APPFILESOURCE_parseFromJSON(cJSON* APPFILESOURCEJSON) {
    storageservice_createFileAsync_appFile.source_e APPFILESOURCEVariable = 0;
    ...
    APPFILESOURCEVariable = createFileAsync_APPFILESOURCE_FromString(APPFILESOURCEVar->valuestring);
...
// Functions for enum APPFILESOURCE for FilesAPI_updateFileAsync

static char* updateFileAsync_APPFILESOURCE_ToString(storageservice_updateFileAsync_appFile.source_e APPFILESOURCE){
    char *APPFILESOURCEArray[] =  { "NULL", "Unknown", "HttpUpload", "Integration", "InternalProcess", "ApiClient", "WorkflowEngine" };
    return APPFILESOURCEArray[APPFILESOURCE];
}

static storageservice_updateFileAsync_appFile.source_e updateFileAsync_APPFILESOURCE_FromString(char* APPFILESOURCE){
    int stringToReturn = 0;
    char *APPFILESOURCEArray[] =  { "NULL", "Unknown", "HttpUpload", "Integration", "InternalProcess", "ApiClient", "WorkflowEngine" };
    size_t sizeofArray = sizeof(APPFILESOURCEArray) / sizeof(APPFILESOURCEArray[0]);
    while(stringToReturn < sizeofArray) {
...
/*
// Function updateFileAsync_APPFILESOURCE_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *updateFileAsync_APPFILESOURCE_convertToJSON(storageservice_updateFileAsync_appFile.source_e APPFILESOURCE) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "appFile.source", updateFileAsync_APPFILESOURCE_ToString(APPFILESOURCE)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function updateFileAsync_APPFILESOURCE_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static storageservice_updateFileAsync_appFile.source_e updateFileAsync_APPFILESOURCE_parseFromJSON(cJSON* APPFILESOURCEJSON) {
    storageservice_updateFileAsync_appFile.source_e APPFILESOURCEVariable = 0;
    cJSON *APPFILESOURCEVar = cJSON_GetObjectItemCaseSensitive(APPFILESOURCEJSON, "appFile.source");
    if(!cJSON_IsString(APPFILESOURCEVar) || (APPFILESOURCEVar->valuestring == NULL))
    {
        goto end;
    }
    APPFILESOURCEVariable = updateFileAsync_APPFILESOURCE_FromString(APPFILESOURCEVar->valuestring);
    return APPFILESOURCEVariable;
end:
    return 0;
}
...
FilesAPI_createFileAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, binary_t* file, char *notes, char *title, char *author, int *isFolder, char *fileName, char *abstract, char *keyWords, int *validResponse, char *parentFileUploadId, char *filePath, storageservice_createFileAsync_publicAccessType_e publicAccessType, storageservice_createFileAsync_purpose_e purpose, char *socialProfileId.value, char *appFile.content, char *appFile.sha256, char appFile.createdAtUtc, char *appFile.userId.value, char *appFile.tenantId.value, char *appFile.enrollmentId.value, storageservice_createFileAsync_appFile.source_e appFile.source, long appFile.length, char *appFile.name, char *appFile.fileName, char appFile.lastModified, long appFile.size, char *appFile.contentType, char *appFile.contentDisposition, list_t* appFile.headers, char *id, char timestamp)
{
    ...
    storageservice_createFileAsync_publicAccessType_e valueForm_publicAccessType = 0;
    ...
    storageservice_createFileAsync_purpose_e valueForm_purpose = 0;
    ...
    storageservice_createFileAsync_appFile.source_e valueForm_appFile.source = 0;
...
FilesAPI_getFileThumbnailAsync(apiClient_t *apiClient, char *fileId, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/StorageService/Files/{fileId}/Thumbnail")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/StorageService/Files/{fileId}/Thumbnail");
...
FilesAPI_getFilesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/StorageService/Files/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/StorageService/Files/Count");
    ...
    //}
    //primitive return type simple
    long* elementToReturn =  strdup((long*)apiClient->dataReceived);
...
FilesAPI_updateFileAsync(apiClient_t *apiClient, char *fileId, char *tenantId, char *api_version, char *x_api_version, binary_t* file, char *notes, char *metadata, char *title, char *author, int *isFolder, char *fileName, char *abstract, char *keyWords, int *validResponse, char *parentFileUploadID, char *filePath, char *appFile.content, char *appFile.sha256, char appFile.createdAtUtc, char *appFile.userId.value, char *appFile.tenantId.value, char *appFile.enrollmentId.value, storageservice_updateFileAsync_appFile.source_e appFile.source, long appFile.length, char *appFile.name, char *appFile.fileName, char appFile.lastModified, long appFile.size, char *appFile.contentType, char *appFile.contentDisposition, list_t* appFile.headers)
{
    ...
    // form parameters
    char *keyForm_appFile.source = NULL;
    storageservice_updateFileAsync_appFile.source_e valueForm_appFile.source = 0;
    keyValuePair_t *keyPairForm_appFile.source = 0;
    if (appFile.source != NULL)
    {
        keyForm_appFile.source = strdup("appFile.source");
