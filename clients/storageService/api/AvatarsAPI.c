...
AvatarsAPI_getAvatar(apiClient_t *apiClient, char *socialProfileId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/StorageService/Avatars/{socialProfileId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/StorageService/Avatars/{socialProfileId}");
    ...
    cJSON_Delete(AvatarsAPIlocalVarJSON);
...
AvatarsAPI_getContactAvatar(apiClient_t *apiClient, char *contactId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/StorageService/Avatars/Contact/{contactId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/StorageService/Avatars/Contact/{contactId}");
...
AvatarsAPI_getCurrentUserAvatar(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/StorageService/Avatars/User")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/StorageService/Avatars/User");
...
AvatarsAPI_getTenantAvatar(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/StorageService/Avatars/Tenant/{tenantId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/StorageService/Avatars/Tenant/{tenantId}");
...
AvatarsAPI_getUserAvatar(apiClient_t *apiClient, char *userId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/StorageService/Avatars/User/{userId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/StorageService/Avatars/User/{userId}");
...
AvatarsAPI_updateContactAvatar(apiClient_t *apiClient, char *contactId, char *tenantId, char *api_version, char *x_api_version, binary_t* avatar)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/StorageService/Avatars/Contacts/{contactId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/StorageService/Avatars/Contacts/{contactId}");
