...
PaymentTermsAPI_createPaymentTermAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, payment_term_create_dto_t *payment_term_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/PaymentsService/PaymentTerms")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/PaymentsService/PaymentTerms");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_payment_term_create_dto = NULL;
    if (payment_term_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_payment_term_create_dto = payment_term_create_dto_convertToJSON(payment_term_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_payment_term_create_dto);
    }
    ...
    cJSON *PaymentTermsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(PaymentTermsAPIlocalVarJSON);
    cJSON_Delete(PaymentTermsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_payment_term_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_payment_term_create_dto);
        localVarSingleItemJSON_payment_term_create_dto = NULL;
    }
...
PaymentTermsAPI_deletePaymentTermAsync(apiClient_t *apiClient, char *tenantId, char *paymentTermId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/PaymentsService/PaymentTerms/{paymentTermId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/PaymentsService/PaymentTerms/{paymentTermId}");


    // Path Params
    long sizeOfPathParams_paymentTermId = strlen(paymentTermId)+3 + strlen("{ paymentTermId }");
    if(paymentTermId == NULL) {
        goto end;
    }
    char* localVarToReplace_paymentTermId = malloc(sizeOfPathParams_paymentTermId);
    sprintf(localVarToReplace_paymentTermId, "{%s}", "paymentTermId");

    localVarPath = strReplace(localVarPath, localVarToReplace_paymentTermId, paymentTermId);
    if(paymentTermId == NULL) {
        goto end;
    }
    char* localVarToReplace_paymentTermId = malloc(sizeOfPathParams_paymentTermId);
    ...
    free(localVarPath);
    free(localVarToReplace_paymentTermId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
PaymentTermsAPI_getPaymentTermDetailsAsync(apiClient_t *apiClient, char *tenantId, char *paymentTermId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *PaymentTermsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    payment_term_dto_envelope_t *elementToReturn = payment_term_dto_envelope_parseFromJSON(PaymentTermsAPIlocalVarJSON);
    cJSON_Delete(PaymentTermsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
PaymentTermsAPI_getPaymentTermsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, payment_term_dto_collection_query_parameters_t *payment_term_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_payment_term_dto_collection_query_parameters = NULL;
    if (payment_term_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_payment_term_dto_collection_query_parameters = payment_term_dto_collection_query_parameters_convertToJSON(payment_term_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_payment_term_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *PaymentTermsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    payment_term_dto_i_read_only_list_envelope_t *elementToReturn = payment_term_dto_i_read_only_list_envelope_parseFromJSON(PaymentTermsAPIlocalVarJSON);
    cJSON_Delete(PaymentTermsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_payment_term_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_payment_term_dto_collection_query_parameters);
        localVarSingleItemJSON_payment_term_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
PaymentTermsAPI_getPaymentTermsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, payment_term_dto_collection_query_parameters_t *payment_term_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/PaymentsService/PaymentTerms/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/PaymentsService/PaymentTerms/Count");
    ...
    //nonprimitive not container
    cJSON *PaymentTermsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(PaymentTermsAPIlocalVarJSON);
    cJSON_Delete(PaymentTermsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
PaymentTermsAPI_updatePaymentTermAsync(apiClient_t *apiClient, char *tenantId, char *paymentTermId, char *api_version, char *x_api_version, payment_term_update_dto_t *payment_term_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_payment_term_update_dto = NULL;
    if (payment_term_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_payment_term_update_dto = payment_term_update_dto_convertToJSON(payment_term_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_payment_term_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_payment_term_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_payment_term_update_dto);
        localVarSingleItemJSON_payment_term_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
