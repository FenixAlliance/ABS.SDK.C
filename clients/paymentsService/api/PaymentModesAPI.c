...
PaymentModesAPI_createPaymentModeAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, payment_mode_create_dto_t *payment_mode_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/PaymentsService/PaymentModes")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/PaymentsService/PaymentModes");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_payment_mode_create_dto = NULL;
    if (payment_mode_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_payment_mode_create_dto = payment_mode_create_dto_convertToJSON(payment_mode_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_payment_mode_create_dto);
    }
    ...
    cJSON *PaymentModesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(PaymentModesAPIlocalVarJSON);
    cJSON_Delete(PaymentModesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_payment_mode_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_payment_mode_create_dto);
        localVarSingleItemJSON_payment_mode_create_dto = NULL;
    }
...
PaymentModesAPI_deletePaymentModeAsync(apiClient_t *apiClient, char *tenantId, char *paymentModeId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/PaymentsService/PaymentModes/{paymentModeId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/PaymentsService/PaymentModes/{paymentModeId}");


    // Path Params
    long sizeOfPathParams_paymentModeId = strlen(paymentModeId)+3 + strlen("{ paymentModeId }");
    if(paymentModeId == NULL) {
        goto end;
    }
    char* localVarToReplace_paymentModeId = malloc(sizeOfPathParams_paymentModeId);
    sprintf(localVarToReplace_paymentModeId, "{%s}", "paymentModeId");

    localVarPath = strReplace(localVarPath, localVarToReplace_paymentModeId, paymentModeId);
    if(paymentModeId == NULL) {
        goto end;
    }
    char* localVarToReplace_paymentModeId = malloc(sizeOfPathParams_paymentModeId);
    ...
    free(localVarPath);
    free(localVarToReplace_paymentModeId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
PaymentModesAPI_getPaymentModeDetailsAsync(apiClient_t *apiClient, char *tenantId, char *paymentModeId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *PaymentModesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    payment_mode_dto_envelope_t *elementToReturn = payment_mode_dto_envelope_parseFromJSON(PaymentModesAPIlocalVarJSON);
    cJSON_Delete(PaymentModesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
PaymentModesAPI_getPaymentModesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, payment_mode_dto_collection_query_parameters_t *payment_mode_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_payment_mode_dto_collection_query_parameters = NULL;
    if (payment_mode_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_payment_mode_dto_collection_query_parameters = payment_mode_dto_collection_query_parameters_convertToJSON(payment_mode_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_payment_mode_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *PaymentModesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    payment_mode_dto_i_read_only_list_envelope_t *elementToReturn = payment_mode_dto_i_read_only_list_envelope_parseFromJSON(PaymentModesAPIlocalVarJSON);
    cJSON_Delete(PaymentModesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_payment_mode_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_payment_mode_dto_collection_query_parameters);
        localVarSingleItemJSON_payment_mode_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
PaymentModesAPI_getPaymentModesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, payment_mode_dto_collection_query_parameters_t *payment_mode_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/PaymentsService/PaymentModes/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/PaymentsService/PaymentModes/Count");
    ...
    //nonprimitive not container
    cJSON *PaymentModesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(PaymentModesAPIlocalVarJSON);
    cJSON_Delete(PaymentModesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
PaymentModesAPI_updatePaymentModeAsync(apiClient_t *apiClient, char *tenantId, char *paymentModeId, char *api_version, char *x_api_version, payment_mode_update_dto_t *payment_mode_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_payment_mode_update_dto = NULL;
    if (payment_mode_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_payment_mode_update_dto = payment_mode_update_dto_convertToJSON(payment_mode_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_payment_mode_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_payment_mode_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_payment_mode_update_dto);
        localVarSingleItemJSON_payment_mode_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
