...
#ifndef _payment_term_dto_H_
#define _payment_term_dto_H_
...
typedef struct payment_term_dto_t payment_term_dto_t;




typedef struct payment_term_dto_t {
    char *id; // string
