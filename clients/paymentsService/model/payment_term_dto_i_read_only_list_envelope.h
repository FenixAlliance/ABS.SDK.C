/*
 * payment_term_dto_i_read_only_list_envelope.h
 *
 * 
 */

#ifndef _payment_term_dto_i_read_only_list_envelope_H_
#define _payment_term_dto_i_read_only_list_envelope_H_
...
typedef struct payment_term_dto_i_read_only_list_envelope_t payment_term_dto_i_read_only_list_envelope_t;

#include "payment_term_dto.h"



typedef struct payment_term_dto_i_read_only_list_envelope_t {
...
#endif /* _payment_term_dto_i_read_only_list_envelope_H_ */
