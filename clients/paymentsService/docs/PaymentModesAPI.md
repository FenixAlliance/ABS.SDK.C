...
// Patch a payment mode
//
empty_envelope_t* PaymentModesAPI_patchPaymentModeAsync(apiClient_t *apiClient, char *tenantId, char *paymentModeId, char *api_version, char *x_api_version, list_t *operation);
```
