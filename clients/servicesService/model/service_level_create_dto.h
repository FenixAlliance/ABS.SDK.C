/*
 * service_level_create_dto.h
 *
 * 
 */

#ifndef _service_level_create_dto_H_
#define _service_level_create_dto_H_
...
typedef struct service_level_create_dto_t service_level_create_dto_t;




typedef struct service_level_create_dto_t {
    char *id; // string
...
#endif /* _service_level_create_dto_H_ */
