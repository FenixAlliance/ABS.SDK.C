/*
 * service_create_dto.h
 *
 * 
 */

#ifndef _service_create_dto_H_
#define _service_create_dto_H_
...
typedef struct service_create_dto_t service_create_dto_t;




typedef struct service_create_dto_t {
    char *id; // string
