...
#ifndef _service_case_dto_H_
#define _service_case_dto_H_
...
typedef struct service_case_dto_t service_case_dto_t;




typedef struct service_case_dto_t {
    char *id; // string
