/*
 * service_level_update_dto.h
 *
 * 
 */

#ifndef _service_level_update_dto_H_
#define _service_level_update_dto_H_
...
typedef struct service_level_update_dto_t service_level_update_dto_t;




typedef struct service_level_update_dto_t {
    int hot; //boolean
    char *sku; // string
    char *upc; // string
    char *ean; // string
...
#endif /* _service_level_update_dto_H_ */
