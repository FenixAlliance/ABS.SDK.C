/*
 * service_case_type_dto.h
 *
 * 
 */

#ifndef _service_case_type_dto_H_
#define _service_case_type_dto_H_
...
typedef struct service_case_type_dto_t service_case_type_dto_t;




typedef struct service_case_type_dto_t {
    char *id; // string
    char *timestamp; //date time
    char *title; // string
    char *description; // string

} service_case_type_dto_t;
...
#endif /* _service_case_type_dto_H_ */
