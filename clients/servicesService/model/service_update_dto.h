/*
 * service_update_dto.h
 *
 * 
 */

#ifndef _service_update_dto_H_
#define _service_update_dto_H_
...
typedef struct service_update_dto_t service_update_dto_t;




typedef struct service_update_dto_t {
    int hot; //boolean
    char *sku; // string
    char *upc; // string
    char *ean; // string
    ...
    char *service_plan_id; // string

} service_update_dto_t;
