...
service_dto_i_read_only_list_envelope_t *service_dto_i_read_only_list_envelope_create(
    ...
    service_dto_i_read_only_list_envelope_local_var->http_status = http_status;
    service_dto_i_read_only_list_envelope_local_var->error_code = error_code;
    service_dto_i_read_only_list_envelope_local_var->validation_details = validation_details;
...
void service_dto_i_read_only_list_envelope_free(service_dto_i_read_only_list_envelope_t *service_dto_i_read_only_list_envelope) {
    ...
    if (service_dto_i_read_only_list_envelope->error_code) {
        free(service_dto_i_read_only_list_envelope->error_code);
        service_dto_i_read_only_list_envelope->error_code = NULL;
    }
    if (service_dto_i_read_only_list_envelope->validation_details) {
        list_ForEach(listEntry, service_dto_i_read_only_list_envelope->validation_details) {
            keyValuePair_t *localKeyValue = (keyValuePair_t*) listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_freeList(service_dto_i_read_only_list_envelope->validation_details);
        service_dto_i_read_only_list_envelope->validation_details = NULL;
    }
...
cJSON *service_dto_i_read_only_list_envelope_convertToJSON(service_dto_i_read_only_list_envelope_t *service_dto_i_read_only_list_envelope) {
    ...
    // service_dto_i_read_only_list_envelope->http_status
    if(service_dto_i_read_only_list_envelope->http_status) {
    if(cJSON_AddNumberToObject(item, "httpStatus", service_dto_i_read_only_list_envelope->http_status) == NULL) {
    goto fail; //Numeric
    }
    }


    // service_dto_i_read_only_list_envelope->error_code
    if(service_dto_i_read_only_list_envelope->error_code) {
    if(cJSON_AddStringToObject(item, "errorCode", service_dto_i_read_only_list_envelope->error_code) == NULL) {
    goto fail; //String
    }
    }


    // service_dto_i_read_only_list_envelope->validation_details
    if(service_dto_i_read_only_list_envelope->validation_details) {
    ...
    if (service_dto_i_read_only_list_envelope->validation_details) {
    list_ForEach(validation_detailsListEntry, service_dto_i_read_only_list_envelope->validation_details) {
...
service_dto_i_read_only_list_envelope_t *service_dto_i_read_only_list_envelope_parseFromJSON(cJSON *service_dto_i_read_only_list_envelopeJSON){
    ...
    // define the local map for service_dto_i_read_only_list_envelope->validation_details
    ...
    // service_dto_i_read_only_list_envelope->http_status
    cJSON *http_status = cJSON_GetObjectItemCaseSensitive(service_dto_i_read_only_list_envelopeJSON, "httpStatus");
    if (http_status) { 
    ...
    // service_dto_i_read_only_list_envelope->error_code
    cJSON *error_code = cJSON_GetObjectItemCaseSensitive(service_dto_i_read_only_list_envelopeJSON, "errorCode");
    if (error_code) { 
    ...
    // service_dto_i_read_only_list_envelope->validation_details
    cJSON *validation_details = cJSON_GetObjectItemCaseSensitive(service_dto_i_read_only_list_envelopeJSON, "validationDetails");
