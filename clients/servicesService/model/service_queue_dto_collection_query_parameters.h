/*
 * service_queue_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _service_queue_dto_collection_query_parameters_H_
#define _service_queue_dto_collection_query_parameters_H_
...
typedef struct service_queue_dto_collection_query_parameters_t service_queue_dto_collection_query_parameters_t;




typedef struct service_queue_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} service_queue_dto_collection_query_parameters_t;
...
#endif /* _service_queue_dto_collection_query_parameters_H_ */
