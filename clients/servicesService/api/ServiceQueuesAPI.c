...
ServiceQueuesAPI_createServiceQueueAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, service_queue_create_dto_t *service_queue_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ServicesService/ServiceQueues")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ServicesService/ServiceQueues");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_service_queue_create_dto = NULL;
    if (service_queue_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_service_queue_create_dto = service_queue_create_dto_convertToJSON(service_queue_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_service_queue_create_dto);
    }
    ...
    cJSON *ServiceQueuesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    envelope_t *elementToReturn = envelope_parseFromJSON(ServiceQueuesAPIlocalVarJSON);
    cJSON_Delete(ServiceQueuesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_service_queue_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_service_queue_create_dto);
        localVarSingleItemJSON_service_queue_create_dto = NULL;
    }
...
ServiceQueuesAPI_deleteServiceQueueAsync(apiClient_t *apiClient, char *tenantId, char *serviceQueueId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ServicesService/ServiceQueues/{serviceQueueId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ServicesService/ServiceQueues/{serviceQueueId}");


    // Path Params
    long sizeOfPathParams_serviceQueueId = strlen(serviceQueueId)+3 + strlen("{ serviceQueueId }");
    if(serviceQueueId == NULL) {
        goto end;
    }
    char* localVarToReplace_serviceQueueId = malloc(sizeOfPathParams_serviceQueueId);
    sprintf(localVarToReplace_serviceQueueId, "{%s}", "serviceQueueId");

    localVarPath = strReplace(localVarPath, localVarToReplace_serviceQueueId, serviceQueueId);
    if(serviceQueueId == NULL) {
        goto end;
    }
    char* localVarToReplace_serviceQueueId = malloc(sizeOfPathParams_serviceQueueId);
    ...
    free(localVarPath);
    free(localVarToReplace_serviceQueueId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
ServiceQueuesAPI_getServiceQueueByIdAsync(apiClient_t *apiClient, char *tenantId, char *serviceQueueId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ServiceQueuesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    service_queue_dto_envelope_t *elementToReturn = service_queue_dto_envelope_parseFromJSON(ServiceQueuesAPIlocalVarJSON);
    cJSON_Delete(ServiceQueuesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ServiceQueuesAPI_getServiceQueuesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, service_queue_dto_collection_query_parameters_t *service_queue_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_service_queue_dto_collection_query_parameters = NULL;
    if (service_queue_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_service_queue_dto_collection_query_parameters = service_queue_dto_collection_query_parameters_convertToJSON(service_queue_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_service_queue_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ServiceQueuesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    service_queue_dto_i_read_only_list_envelope_t *elementToReturn = service_queue_dto_i_read_only_list_envelope_parseFromJSON(ServiceQueuesAPIlocalVarJSON);
    cJSON_Delete(ServiceQueuesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_service_queue_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_service_queue_dto_collection_query_parameters);
        localVarSingleItemJSON_service_queue_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ServiceQueuesAPI_getServiceQueuesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, service_queue_dto_collection_query_parameters_t *service_queue_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ServicesService/ServiceQueues/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ServicesService/ServiceQueues/Count");
    ...
    //nonprimitive not container
    cJSON *ServiceQueuesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ServiceQueuesAPIlocalVarJSON);
    cJSON_Delete(ServiceQueuesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ServiceQueuesAPI_updateServiceQueueAsync(apiClient_t *apiClient, char *tenantId, char *serviceQueueId, char *api_version, char *x_api_version, service_queue_update_dto_t *service_queue_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_service_queue_update_dto = NULL;
    if (service_queue_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_service_queue_update_dto = service_queue_update_dto_convertToJSON(service_queue_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_service_queue_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_service_queue_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_service_queue_update_dto);
        localVarSingleItemJSON_service_queue_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
