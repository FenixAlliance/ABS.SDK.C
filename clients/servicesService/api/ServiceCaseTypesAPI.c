...
ServiceCaseTypesAPI_createServiceCaseTypeAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, service_case_type_create_dto_t *service_case_type_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ServicesService/ServiceCaseTypes")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ServicesService/ServiceCaseTypes");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_service_case_type_create_dto = NULL;
    if (service_case_type_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_service_case_type_create_dto = service_case_type_create_dto_convertToJSON(service_case_type_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_service_case_type_create_dto);
    }
    ...
    cJSON *ServiceCaseTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    envelope_t *elementToReturn = envelope_parseFromJSON(ServiceCaseTypesAPIlocalVarJSON);
    cJSON_Delete(ServiceCaseTypesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_service_case_type_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_service_case_type_create_dto);
        localVarSingleItemJSON_service_case_type_create_dto = NULL;
    }
...
ServiceCaseTypesAPI_deleteServiceCaseTypeAsync(apiClient_t *apiClient, char *tenantId, char *serviceCaseTypeId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ServicesService/ServiceCaseTypes/{serviceCaseTypeId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ServicesService/ServiceCaseTypes/{serviceCaseTypeId}");


    // Path Params
    long sizeOfPathParams_serviceCaseTypeId = strlen(serviceCaseTypeId)+3 + strlen("{ serviceCaseTypeId }");
    if(serviceCaseTypeId == NULL) {
        goto end;
    }
    char* localVarToReplace_serviceCaseTypeId = malloc(sizeOfPathParams_serviceCaseTypeId);
    sprintf(localVarToReplace_serviceCaseTypeId, "{%s}", "serviceCaseTypeId");

    localVarPath = strReplace(localVarPath, localVarToReplace_serviceCaseTypeId, serviceCaseTypeId);
    if(serviceCaseTypeId == NULL) {
        goto end;
    }
    char* localVarToReplace_serviceCaseTypeId = malloc(sizeOfPathParams_serviceCaseTypeId);
    ...
    free(localVarPath);
    free(localVarToReplace_serviceCaseTypeId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
ServiceCaseTypesAPI_getServiceCaseTypeByIdAsync(apiClient_t *apiClient, char *tenantId, char *serviceCaseTypeId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ServiceCaseTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    service_case_type_dto_envelope_t *elementToReturn = service_case_type_dto_envelope_parseFromJSON(ServiceCaseTypesAPIlocalVarJSON);
    cJSON_Delete(ServiceCaseTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ServiceCaseTypesAPI_getServiceCaseTypesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, service_case_type_dto_collection_query_parameters_t *service_case_type_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_service_case_type_dto_collection_query_parameters = NULL;
    if (service_case_type_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_service_case_type_dto_collection_query_parameters = service_case_type_dto_collection_query_parameters_convertToJSON(service_case_type_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_service_case_type_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ServiceCaseTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    service_case_type_dto_i_read_only_list_envelope_t *elementToReturn = service_case_type_dto_i_read_only_list_envelope_parseFromJSON(ServiceCaseTypesAPIlocalVarJSON);
    cJSON_Delete(ServiceCaseTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_service_case_type_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_service_case_type_dto_collection_query_parameters);
        localVarSingleItemJSON_service_case_type_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ServiceCaseTypesAPI_getServiceCaseTypesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, service_case_type_dto_collection_query_parameters_t *service_case_type_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ServicesService/ServiceCaseTypes/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ServicesService/ServiceCaseTypes/Count");
    ...
    //nonprimitive not container
    cJSON *ServiceCaseTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ServiceCaseTypesAPIlocalVarJSON);
    cJSON_Delete(ServiceCaseTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ServiceCaseTypesAPI_updateServiceCaseTypeAsync(apiClient_t *apiClient, char *tenantId, char *serviceCaseTypeId, char *api_version, char *x_api_version, service_case_type_update_dto_t *service_case_type_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_service_case_type_update_dto = NULL;
    if (service_case_type_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_service_case_type_update_dto = service_case_type_update_dto_convertToJSON(service_case_type_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_service_case_type_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_service_case_type_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_service_case_type_update_dto);
        localVarSingleItemJSON_service_case_type_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
