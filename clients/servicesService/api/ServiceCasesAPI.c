...
ServiceCasesAPI_createServiceCaseAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, service_case_create_dto_t *service_case_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ServicesService/ServiceCases")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ServicesService/ServiceCases");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_service_case_create_dto = NULL;
    if (service_case_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_service_case_create_dto = service_case_create_dto_convertToJSON(service_case_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_service_case_create_dto);
    }
    ...
    cJSON *ServiceCasesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    envelope_t *elementToReturn = envelope_parseFromJSON(ServiceCasesAPIlocalVarJSON);
    cJSON_Delete(ServiceCasesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_service_case_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_service_case_create_dto);
        localVarSingleItemJSON_service_case_create_dto = NULL;
    }
...
ServiceCasesAPI_deleteServiceCaseAsync(apiClient_t *apiClient, char *tenantId, char *serviceCaseId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ServicesService/ServiceCases/{serviceCaseId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ServicesService/ServiceCases/{serviceCaseId}");


    // Path Params
    long sizeOfPathParams_serviceCaseId = strlen(serviceCaseId)+3 + strlen("{ serviceCaseId }");
    if(serviceCaseId == NULL) {
        goto end;
    }
    char* localVarToReplace_serviceCaseId = malloc(sizeOfPathParams_serviceCaseId);
    sprintf(localVarToReplace_serviceCaseId, "{%s}", "serviceCaseId");

    localVarPath = strReplace(localVarPath, localVarToReplace_serviceCaseId, serviceCaseId);
    if(serviceCaseId == NULL) {
        goto end;
    }
    char* localVarToReplace_serviceCaseId = malloc(sizeOfPathParams_serviceCaseId);
    ...
    free(localVarPath);
    free(localVarToReplace_serviceCaseId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
ServiceCasesAPI_getServiceCaseByIdAsync(apiClient_t *apiClient, char *tenantId, char *serviceCaseId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ServiceCasesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    service_case_dto_envelope_t *elementToReturn = service_case_dto_envelope_parseFromJSON(ServiceCasesAPIlocalVarJSON);
    cJSON_Delete(ServiceCasesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ServiceCasesAPI_getServiceCasesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, service_case_dto_collection_query_parameters_t *service_case_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_service_case_dto_collection_query_parameters = NULL;
    if (service_case_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_service_case_dto_collection_query_parameters = service_case_dto_collection_query_parameters_convertToJSON(service_case_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_service_case_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ServiceCasesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    service_case_dto_i_read_only_list_envelope_t *elementToReturn = service_case_dto_i_read_only_list_envelope_parseFromJSON(ServiceCasesAPIlocalVarJSON);
    cJSON_Delete(ServiceCasesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_service_case_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_service_case_dto_collection_query_parameters);
        localVarSingleItemJSON_service_case_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ServiceCasesAPI_getServiceCasesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, service_case_dto_collection_query_parameters_t *service_case_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ServicesService/ServiceCases/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ServicesService/ServiceCases/Count");
    ...
    //nonprimitive not container
    cJSON *ServiceCasesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ServiceCasesAPIlocalVarJSON);
    cJSON_Delete(ServiceCasesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ServiceCasesAPI_updateServiceCaseAsync(apiClient_t *apiClient, char *tenantId, char *serviceCaseId, char *api_version, char *x_api_version, service_case_update_dto_t *service_case_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_service_case_update_dto = NULL;
    if (service_case_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_service_case_update_dto = service_case_update_dto_convertToJSON(service_case_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_service_case_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_service_case_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_service_case_update_dto);
        localVarSingleItemJSON_service_case_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
