...
ServicesAPI_createServiceAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, service_create_dto_t *service_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ServicesService/Services")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ServicesService/Services");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_service_create_dto = NULL;
    if (service_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_service_create_dto = service_create_dto_convertToJSON(service_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_service_create_dto);
    }
    ...
    envelope_t *elementToReturn = envelope_parseFromJSON(ServicesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_service_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_service_create_dto);
        localVarSingleItemJSON_service_create_dto = NULL;
    }
...
ServicesAPI_deleteServiceAsync(apiClient_t *apiClient, char *tenantId, char *serviceId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ServicesService/Services/{serviceId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ServicesService/Services/{serviceId}");
...
ServicesAPI_getServiceByIdAsync(apiClient_t *apiClient, char *tenantId, char *serviceId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ServicesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    service_dto_envelope_t *elementToReturn = service_dto_envelope_parseFromJSON(ServicesAPIlocalVarJSON);
    cJSON_Delete(ServicesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ServicesAPI_getServicesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, service_dto_collection_query_parameters_t *service_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_service_dto_collection_query_parameters = NULL;
    if (service_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_service_dto_collection_query_parameters = service_dto_collection_query_parameters_convertToJSON(service_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_service_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ServicesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    service_dto_i_read_only_list_envelope_t *elementToReturn = service_dto_i_read_only_list_envelope_parseFromJSON(ServicesAPIlocalVarJSON);
    cJSON_Delete(ServicesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_service_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_service_dto_collection_query_parameters);
        localVarSingleItemJSON_service_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ServicesAPI_getServicesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, service_dto_collection_query_parameters_t *service_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ServicesService/Services/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ServicesService/Services/Count");
    ...
    //nonprimitive not container
    cJSON *ServicesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ServicesAPIlocalVarJSON);
    cJSON_Delete(ServicesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ServicesAPI_updateServiceAsync(apiClient_t *apiClient, char *tenantId, char *serviceId, char *api_version, char *x_api_version, service_update_dto_t *service_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_service_update_dto = NULL;
    if (service_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_service_update_dto = service_update_dto_convertToJSON(service_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_service_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_service_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_service_update_dto);
        localVarSingleItemJSON_service_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
