...
ServiceLevelsAPI_countAllServiceLevelsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ServicesService/ServiceLevels/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ServicesService/ServiceLevels/Count");
    ...
    cJSON *ServiceLevelsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ServiceLevelsAPIlocalVarJSON);
    cJSON_Delete(ServiceLevelsAPIlocalVarJSON);
...
ServiceLevelsAPI_createServiceLevelAsync(apiClient_t *apiClient, char *tenantId, char *serviceId, char *api_version, char *x_api_version, service_level_create_dto_t *service_level_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ServicesService/Services/{serviceId}/ServiceLevels")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ServicesService/Services/{serviceId}/ServiceLevels");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_service_level_create_dto = NULL;
    if (service_level_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_service_level_create_dto = service_level_create_dto_convertToJSON(service_level_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_service_level_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    ...
    //nonprimitive not container
    cJSON *ServiceLevelsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    envelope_t *elementToReturn = envelope_parseFromJSON(ServiceLevelsAPIlocalVarJSON);
    cJSON_Delete(ServiceLevelsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_service_level_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_service_level_create_dto);
        localVarSingleItemJSON_service_level_create_dto = NULL;
    }
...
ServiceLevelsAPI_deleteServiceLevelAsync(apiClient_t *apiClient, char *tenantId, char *serviceId, char *serviceLevelId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ServicesService/Services/{serviceId}/ServiceLevels/{serviceLevelId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ServicesService/Services/{serviceId}/ServiceLevels/{serviceLevelId}");


    // Path Params
    long sizeOfPathParams_serviceId = strlen(serviceId)+3 + strlen(serviceLevelId)+3 + strlen("{ serviceId }");
    if(serviceId == NULL) {
        goto end;
    }
    char* localVarToReplace_serviceId = malloc(sizeOfPathParams_serviceId);
    ...
    // Path Params
    long sizeOfPathParams_serviceLevelId = strlen(serviceId)+3 + strlen(serviceLevelId)+3 + strlen("{ serviceLevelId }");
    if(serviceLevelId == NULL) {
        goto end;
    }
    char* localVarToReplace_serviceLevelId = malloc(sizeOfPathParams_serviceLevelId);
    sprintf(localVarToReplace_serviceLevelId, "{%s}", "serviceLevelId");

    localVarPath = strReplace(localVarPath, localVarToReplace_serviceLevelId, serviceLevelId);
    if(serviceLevelId == NULL) {
        goto end;
    }
    char* localVarToReplace_serviceLevelId = malloc(sizeOfPathParams_serviceLevelId);
    ...
    free(localVarPath);
    free(localVarToReplace_serviceId);
    free(localVarToReplace_serviceLevelId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
ServiceLevelsAPI_getAllServiceLevelsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ServicesService/ServiceLevels")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ServicesService/ServiceLevels");
    ...
    //nonprimitive not container
    cJSON *ServiceLevelsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    service_level_dto_i_read_only_list_envelope_t *elementToReturn = service_level_dto_i_read_only_list_envelope_parseFromJSON(ServiceLevelsAPIlocalVarJSON);
    cJSON_Delete(ServiceLevelsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ServiceLevelsAPI_getServiceLevelByIdAsync(apiClient_t *apiClient, char *tenantId, char *serviceId, char *serviceLevelId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ServiceLevelsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    service_level_dto_envelope_t *elementToReturn = service_level_dto_envelope_parseFromJSON(ServiceLevelsAPIlocalVarJSON);
    cJSON_Delete(ServiceLevelsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ServiceLevelsAPI_getServiceLevelsCountAsync(apiClient_t *apiClient, char *tenantId, char *serviceId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ServicesService/Services/{serviceId}/ServiceLevels/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ServicesService/Services/{serviceId}/ServiceLevels/Count");
...
ServiceLevelsAPI_updateServiceLevelAsync(apiClient_t *apiClient, char *tenantId, char *serviceId, char *serviceLevelId, char *api_version, char *x_api_version, service_level_update_dto_t *service_level_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_service_level_update_dto = NULL;
    if (service_level_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_service_level_update_dto = service_level_update_dto_convertToJSON(service_level_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_service_level_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_service_level_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_service_level_update_dto);
        localVarSingleItemJSON_service_level_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
