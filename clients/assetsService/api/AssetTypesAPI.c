...
AssetTypesAPI_getAssetTypes(apiClient_t *apiClient, char *tenantId, asset_type_dto_collection_query_parameters_t *asset_type_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_asset_type_dto_collection_query_parameters = NULL;
    if (asset_type_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_asset_type_dto_collection_query_parameters = asset_type_dto_collection_query_parameters_convertToJSON(asset_type_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_asset_type_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    list_freeList(localVarContentType);
    free(localVarPath);
    if (localVarSingleItemJSON_asset_type_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_asset_type_dto_collection_query_parameters);
        localVarSingleItemJSON_asset_type_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
