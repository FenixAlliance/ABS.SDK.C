/*
 * asset_category_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _asset_category_dto_collection_query_parameters_H_
#define _asset_category_dto_collection_query_parameters_H_
...
typedef struct asset_category_dto_collection_query_parameters_t asset_category_dto_collection_query_parameters_t;




typedef struct asset_category_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} asset_category_dto_collection_query_parameters_t;
...
#endif /* _asset_category_dto_collection_query_parameters_H_ */
