/*
 * delivery_note_create_dto.h
 *
 * 
 */

#ifndef _delivery_note_create_dto_H_
#define _delivery_note_create_dto_H_
...
typedef struct delivery_note_create_dto_t delivery_note_create_dto_t;




typedef struct delivery_note_create_dto_t {
    char *id; // string
...
#endif /* _delivery_note_create_dto_H_ */
