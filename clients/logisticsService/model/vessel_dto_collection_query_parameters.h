/*
 * vessel_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _vessel_dto_collection_query_parameters_H_
#define _vessel_dto_collection_query_parameters_H_
...
typedef struct vessel_dto_collection_query_parameters_t vessel_dto_collection_query_parameters_t;




typedef struct vessel_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} vessel_dto_collection_query_parameters_t;
...
#endif /* _vessel_dto_collection_query_parameters_H_ */
