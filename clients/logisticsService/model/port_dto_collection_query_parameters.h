/*
 * port_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _port_dto_collection_query_parameters_H_
#define _port_dto_collection_query_parameters_H_
...
typedef struct port_dto_collection_query_parameters_t port_dto_collection_query_parameters_t;




typedef struct port_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} port_dto_collection_query_parameters_t;
...
#endif /* _port_dto_collection_query_parameters_H_ */
