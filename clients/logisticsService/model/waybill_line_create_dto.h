/*
 * waybill_line_create_dto.h
 *
 * 
 */

#ifndef _waybill_line_create_dto_H_
#define _waybill_line_create_dto_H_
...
typedef struct waybill_line_create_dto_t waybill_line_create_dto_t;




typedef struct waybill_line_create_dto_t {
    char *id; // string
...
#endif /* _waybill_line_create_dto_H_ */
