...
typedef enum  { logisticsservice_contact_dto_TYPE_NULL = 0, logisticsservice_contact_dto_TYPE_Individual, logisticsservice_contact_dto_TYPE_Organization } logisticsservice_contact_dto_TYPE_e;

char* contact_dto_type_ToString(logisticsservice_contact_dto_TYPE_e type);

logisticsservice_contact_dto_TYPE_e contact_dto_type_FromString(char* type);
...
typedef struct contact_dto_t {
    ...
    logisticsservice_contact_dto_TYPE_e type; //enum
    char *email; // string
    char *phone; // string
...
contact_dto_t *contact_dto_create(
    ...
    char *qualified_name,
    char *tenant_id,
    logisticsservice_contact_dto_TYPE_e type,
    char *email,
    char *phone,
    char *public_name,
    char *first_name,
