...
typedef enum  { logisticsservice_contact_create_dto_TYPE_NULL = 0, logisticsservice_contact_create_dto_TYPE_Individual, logisticsservice_contact_create_dto_TYPE_Organization } logisticsservice_contact_create_dto_TYPE_e;

char* contact_create_dto_type_ToString(logisticsservice_contact_create_dto_TYPE_e type);

logisticsservice_contact_create_dto_TYPE_e contact_create_dto_type_FromString(char* type);
...
typedef struct contact_create_dto_t {
    ...
    logisticsservice_contact_create_dto_TYPE_e type; //enum
...
contact_create_dto_t *contact_create_dto_create(
    char *id,
    char *timestamp,
    logisticsservice_contact_create_dto_TYPE_e type,
    char *first_name,
    char *last_name,
    char *email,
    char *tax_id,
