...
#ifndef _truck_create_dto_H_
#define _truck_create_dto_H_
...
typedef struct truck_create_dto_t truck_create_dto_t;




typedef struct truck_create_dto_t {
    char *id; // string
