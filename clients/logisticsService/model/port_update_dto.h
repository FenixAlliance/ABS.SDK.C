...
#ifndef _port_update_dto_H_
#define _port_update_dto_H_
...
typedef struct port_update_dto_t port_update_dto_t;




typedef struct port_update_dto_t {
    char *title; // string
    char *company; // string
    char *email; // string
