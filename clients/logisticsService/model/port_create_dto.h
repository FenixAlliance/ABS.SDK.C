...
#ifndef _port_create_dto_H_
#define _port_create_dto_H_
...
typedef struct port_create_dto_t port_create_dto_t;




typedef struct port_create_dto_t {
    char *id; // string
