/*
 * warehouse_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _warehouse_dto_collection_query_parameters_H_
#define _warehouse_dto_collection_query_parameters_H_
...
typedef struct warehouse_dto_collection_query_parameters_t warehouse_dto_collection_query_parameters_t;




typedef struct warehouse_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} warehouse_dto_collection_query_parameters_t;
...
#endif /* _warehouse_dto_collection_query_parameters_H_ */
