/*
 * proof_of_delivery_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _proof_of_delivery_dto_collection_query_parameters_H_
#define _proof_of_delivery_dto_collection_query_parameters_H_
...
typedef struct proof_of_delivery_dto_collection_query_parameters_t proof_of_delivery_dto_collection_query_parameters_t;




typedef struct proof_of_delivery_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} proof_of_delivery_dto_collection_query_parameters_t;
...
#endif /* _proof_of_delivery_dto_collection_query_parameters_H_ */
