/*
 * item_restock_update_dto.h
 *
 * 
 */

#ifndef _item_restock_update_dto_H_
#define _item_restock_update_dto_H_
...
typedef struct item_restock_update_dto_t item_restock_update_dto_t;




typedef struct item_restock_update_dto_t {
    char *name; // string
    char *description; // string

} item_restock_update_dto_t;
...
#endif /* _item_restock_update_dto_H_ */
