...
WarehousesAPI_createWarehouseAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, warehouse_create_dto_t *warehouse_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/Warehouses")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/Warehouses");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_warehouse_create_dto = NULL;
    if (warehouse_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_warehouse_create_dto = warehouse_create_dto_convertToJSON(warehouse_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_warehouse_create_dto);
    }
    ...
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(WarehousesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_warehouse_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_warehouse_create_dto);
        localVarSingleItemJSON_warehouse_create_dto = NULL;
    }
...
WarehousesAPI_deleteWarehouseAsync(apiClient_t *apiClient, char *tenantId, char *warehouseId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/Warehouses/{warehouseId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/Warehouses/{warehouseId}");


    // Path Params
    long sizeOfPathParams_warehouseId = strlen(warehouseId)+3 + strlen("{ warehouseId }");
    if(warehouseId == NULL) {
        goto end;
    }
    char* localVarToReplace_warehouseId = malloc(sizeOfPathParams_warehouseId);
    sprintf(localVarToReplace_warehouseId, "{%s}", "warehouseId");

    localVarPath = strReplace(localVarPath, localVarToReplace_warehouseId, warehouseId);
    if(warehouseId == NULL) {
        goto end;
    }
    char* localVarToReplace_warehouseId = malloc(sizeOfPathParams_warehouseId);
    ...
    free(localVarPath);
    free(localVarToReplace_warehouseId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
WarehousesAPI_getWarehouseByIdAsync(apiClient_t *apiClient, char *tenantId, char *warehouseId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *WarehousesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    warehouse_dto_envelope_t *elementToReturn = warehouse_dto_envelope_parseFromJSON(WarehousesAPIlocalVarJSON);
    cJSON_Delete(WarehousesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
WarehousesAPI_getWarehousesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, warehouse_dto_collection_query_parameters_t *warehouse_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_warehouse_dto_collection_query_parameters = NULL;
    if (warehouse_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_warehouse_dto_collection_query_parameters = warehouse_dto_collection_query_parameters_convertToJSON(warehouse_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_warehouse_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *WarehousesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    warehouse_dto_list_envelope_t *elementToReturn = warehouse_dto_list_envelope_parseFromJSON(WarehousesAPIlocalVarJSON);
    cJSON_Delete(WarehousesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_warehouse_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_warehouse_dto_collection_query_parameters);
        localVarSingleItemJSON_warehouse_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
WarehousesAPI_getWarehousesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, warehouse_dto_collection_query_parameters_t *warehouse_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/Warehouses/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/Warehouses/Count");
    ...
    //nonprimitive not container
    cJSON *WarehousesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(WarehousesAPIlocalVarJSON);
    cJSON_Delete(WarehousesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
WarehousesAPI_updateWarehouseAsync(apiClient_t *apiClient, char *tenantId, char *warehouseId, char *api_version, char *x_api_version, warehouse_update_dto_t *warehouse_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_warehouse_update_dto = NULL;
    if (warehouse_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_warehouse_update_dto = warehouse_update_dto_convertToJSON(warehouse_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_warehouse_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_warehouse_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_warehouse_update_dto);
        localVarSingleItemJSON_warehouse_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
