...
SeawayBillsAPI_addSeawayBillLineAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version, waybill_line_create_dto_t *waybill_line_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/SeawayBills/{billId}/Lines")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/SeawayBills/{billId}/Lines");
    ...
    cJSON *SeawayBillsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SeawayBillsAPIlocalVarJSON);
    cJSON_Delete(SeawayBillsAPIlocalVarJSON);
...
SeawayBillsAPI_cancelSeawayBillAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/SeawayBills/{billId}/Cancel")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/SeawayBills/{billId}/Cancel");
...
SeawayBillsAPI_createSeawayBillAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, seaway_bill_create_dto_t *seaway_bill_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/SeawayBills")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/SeawayBills");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_seaway_bill_create_dto = NULL;
    if (seaway_bill_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_seaway_bill_create_dto = seaway_bill_create_dto_convertToJSON(seaway_bill_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_seaway_bill_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_seaway_bill_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_seaway_bill_create_dto);
        localVarSingleItemJSON_seaway_bill_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SeawayBillsAPI_deleteSeawayBillAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/SeawayBills/{billId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/SeawayBills/{billId}");
...
SeawayBillsAPI_getSeawayBillByIdAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SeawayBillsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    seaway_bill_dto_envelope_t *elementToReturn = seaway_bill_dto_envelope_parseFromJSON(SeawayBillsAPIlocalVarJSON);
    cJSON_Delete(SeawayBillsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SeawayBillsAPI_getSeawayBillLinesAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SeawayBillsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    waybill_line_dto_list_envelope_t *elementToReturn = waybill_line_dto_list_envelope_parseFromJSON(SeawayBillsAPIlocalVarJSON);
    cJSON_Delete(SeawayBillsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SeawayBillsAPI_getSeawayBillLinesCountAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/SeawayBills/{billId}/Lines/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/SeawayBills/{billId}/Lines/Count");
    ...
    //nonprimitive not container
    cJSON *SeawayBillsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SeawayBillsAPIlocalVarJSON);
    cJSON_Delete(SeawayBillsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SeawayBillsAPI_getSeawayBillsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SeawayBillsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    seaway_bill_dto_list_envelope_t *elementToReturn = seaway_bill_dto_list_envelope_parseFromJSON(SeawayBillsAPIlocalVarJSON);
    cJSON_Delete(SeawayBillsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SeawayBillsAPI_getSeawayBillsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/SeawayBills/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/SeawayBills/Count");
...
SeawayBillsAPI_issueSeawayBillAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/SeawayBills/{billId}/Issue")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/SeawayBills/{billId}/Issue");
...
SeawayBillsAPI_markSeawayBillArrivedAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/SeawayBills/{billId}/MarkArrived")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/SeawayBills/{billId}/MarkArrived");
...
SeawayBillsAPI_markSeawayBillInTransitAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/SeawayBills/{billId}/MarkInTransit")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/SeawayBills/{billId}/MarkInTransit");
...
SeawayBillsAPI_releaseSeawayBillAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/SeawayBills/{billId}/Release")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/SeawayBills/{billId}/Release");
...
SeawayBillsAPI_removeSeawayBillLineAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *lineId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/SeawayBills/{billId}/Lines/{lineId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/SeawayBills/{billId}/Lines/{lineId}");
...
SeawayBillsAPI_updateSeawayBillAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version, seaway_bill_update_dto_t *seaway_bill_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_seaway_bill_update_dto = NULL;
    if (seaway_bill_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_seaway_bill_update_dto = seaway_bill_update_dto_convertToJSON(seaway_bill_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_seaway_bill_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_seaway_bill_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_seaway_bill_update_dto);
        localVarSingleItemJSON_seaway_bill_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
