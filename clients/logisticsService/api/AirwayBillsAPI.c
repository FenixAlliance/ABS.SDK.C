...
AirwayBillsAPI_addAirwayBillLineAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version, waybill_line_create_dto_t *waybill_line_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/AirwayBills/{billId}/Lines")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/AirwayBills/{billId}/Lines");


    // Path Params
    long sizeOfPathParams_billId = strlen(billId)+3 + strlen("{ billId }");
    if(billId == NULL) {
        goto end;
    }
    char* localVarToReplace_billId = malloc(sizeOfPathParams_billId);
    sprintf(localVarToReplace_billId, "{%s}", "billId");

    localVarPath = strReplace(localVarPath, localVarToReplace_billId, billId);
    if(billId == NULL) {
        goto end;
    }
    char* localVarToReplace_billId = malloc(sizeOfPathParams_billId);
    ...
    cJSON *AirwayBillsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(AirwayBillsAPIlocalVarJSON);
    cJSON_Delete(AirwayBillsAPIlocalVarJSON);
...
AirwayBillsAPI_cancelAirwayBillAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/AirwayBills/{billId}/Cancel")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/AirwayBills/{billId}/Cancel");
...
AirwayBillsAPI_createAirwayBillAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, airway_bill_create_dto_t *airway_bill_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/AirwayBills")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/AirwayBills");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_airway_bill_create_dto = NULL;
    if (airway_bill_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_airway_bill_create_dto = airway_bill_create_dto_convertToJSON(airway_bill_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_airway_bill_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_airway_bill_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_airway_bill_create_dto);
        localVarSingleItemJSON_airway_bill_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
AirwayBillsAPI_deleteAirwayBillAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/AirwayBills/{billId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/AirwayBills/{billId}");
...
AirwayBillsAPI_getAirwayBillByIdAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *AirwayBillsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    airway_bill_dto_envelope_t *elementToReturn = airway_bill_dto_envelope_parseFromJSON(AirwayBillsAPIlocalVarJSON);
    cJSON_Delete(AirwayBillsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AirwayBillsAPI_getAirwayBillLinesAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *AirwayBillsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    waybill_line_dto_list_envelope_t *elementToReturn = waybill_line_dto_list_envelope_parseFromJSON(AirwayBillsAPIlocalVarJSON);
    cJSON_Delete(AirwayBillsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AirwayBillsAPI_getAirwayBillLinesCountAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/AirwayBills/{billId}/Lines/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/AirwayBills/{billId}/Lines/Count");
    ...
    //nonprimitive not container
    cJSON *AirwayBillsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(AirwayBillsAPIlocalVarJSON);
    cJSON_Delete(AirwayBillsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AirwayBillsAPI_getAirwayBillsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *AirwayBillsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    airway_bill_dto_list_envelope_t *elementToReturn = airway_bill_dto_list_envelope_parseFromJSON(AirwayBillsAPIlocalVarJSON);
    cJSON_Delete(AirwayBillsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AirwayBillsAPI_getAirwayBillsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/AirwayBills/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/AirwayBills/Count");
...
AirwayBillsAPI_issueAirwayBillAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/AirwayBills/{billId}/Issue")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/AirwayBills/{billId}/Issue");
...
AirwayBillsAPI_markAirwayBillArrivedAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/AirwayBills/{billId}/MarkArrived")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/AirwayBills/{billId}/MarkArrived");
...
AirwayBillsAPI_markAirwayBillDeliveredAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/AirwayBills/{billId}/MarkDelivered")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/AirwayBills/{billId}/MarkDelivered");
...
AirwayBillsAPI_markAirwayBillInTransitAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/AirwayBills/{billId}/MarkInTransit")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/AirwayBills/{billId}/MarkInTransit");
...
AirwayBillsAPI_removeAirwayBillLineAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *lineId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/AirwayBills/{billId}/Lines/{lineId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/AirwayBills/{billId}/Lines/{lineId}");


    // Path Params
    long sizeOfPathParams_billId = strlen(billId)+3 + strlen(lineId)+3 + strlen("{ billId }");
    if(billId == NULL) {
        goto end;
    }
    char* localVarToReplace_billId = malloc(sizeOfPathParams_billId);
    ...
    // Path Params
    long sizeOfPathParams_lineId = strlen(billId)+3 + strlen(lineId)+3 + strlen("{ lineId }");
    if(lineId == NULL) {
        goto end;
    }
...
AirwayBillsAPI_updateAirwayBillAsync(apiClient_t *apiClient, char *tenantId, char *billId, char *api_version, char *x_api_version, airway_bill_update_dto_t *airway_bill_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_airway_bill_update_dto = NULL;
    if (airway_bill_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_airway_bill_update_dto = airway_bill_update_dto_convertToJSON(airway_bill_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_airway_bill_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_airway_bill_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_airway_bill_update_dto);
        localVarSingleItemJSON_airway_bill_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
