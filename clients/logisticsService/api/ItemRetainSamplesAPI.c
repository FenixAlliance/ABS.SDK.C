...
#include <stdio.h>
#include <ctype.h>
#include "ItemRetainSamplesAPI.h"
...
ItemRetainSamplesAPI_createItemRetainSampleAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_retain_sample_create_dto_t *item_retain_sample_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/ItemRetainSamples")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/ItemRetainSamples");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_retain_sample_create_dto = NULL;
    if (item_retain_sample_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_retain_sample_create_dto = item_retain_sample_create_dto_convertToJSON(item_retain_sample_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_retain_sample_create_dto);
    }
    ...
    cJSON *ItemRetainSamplesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ItemRetainSamplesAPIlocalVarJSON);
    cJSON_Delete(ItemRetainSamplesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_item_retain_sample_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_retain_sample_create_dto);
        localVarSingleItemJSON_item_retain_sample_create_dto = NULL;
    }
...
ItemRetainSamplesAPI_deleteItemRetainSampleAsync(apiClient_t *apiClient, char *tenantId, char *retainSampleId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/ItemRetainSamples/{retainSampleId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/ItemRetainSamples/{retainSampleId}");


    // Path Params
    long sizeOfPathParams_retainSampleId = strlen(retainSampleId)+3 + strlen("{ retainSampleId }");
    if(retainSampleId == NULL) {
        goto end;
    }
    char* localVarToReplace_retainSampleId = malloc(sizeOfPathParams_retainSampleId);
    sprintf(localVarToReplace_retainSampleId, "{%s}", "retainSampleId");

    localVarPath = strReplace(localVarPath, localVarToReplace_retainSampleId, retainSampleId);
    if(retainSampleId == NULL) {
        goto end;
    }
    char* localVarToReplace_retainSampleId = malloc(sizeOfPathParams_retainSampleId);
    ...
    free(localVarPath);
    free(localVarToReplace_retainSampleId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
ItemRetainSamplesAPI_getItemRetainSampleByIdAsync(apiClient_t *apiClient, char *tenantId, char *retainSampleId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ItemRetainSamplesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_retain_sample_dto_envelope_t *elementToReturn = item_retain_sample_dto_envelope_parseFromJSON(ItemRetainSamplesAPIlocalVarJSON);
    cJSON_Delete(ItemRetainSamplesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemRetainSamplesAPI_getItemRetainSamplesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_retain_sample_dto_collection_query_parameters_t *item_retain_sample_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_retain_sample_dto_collection_query_parameters = NULL;
    if (item_retain_sample_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_item_retain_sample_dto_collection_query_parameters = item_retain_sample_dto_collection_query_parameters_convertToJSON(item_retain_sample_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_retain_sample_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ItemRetainSamplesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_retain_sample_dto_list_envelope_t *elementToReturn = item_retain_sample_dto_list_envelope_parseFromJSON(ItemRetainSamplesAPIlocalVarJSON);
    cJSON_Delete(ItemRetainSamplesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_item_retain_sample_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_item_retain_sample_dto_collection_query_parameters);
        localVarSingleItemJSON_item_retain_sample_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ItemRetainSamplesAPI_getItemRetainSamplesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_retain_sample_dto_collection_query_parameters_t *item_retain_sample_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/ItemRetainSamples/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/ItemRetainSamples/Count");
    ...
    //nonprimitive not container
    cJSON *ItemRetainSamplesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ItemRetainSamplesAPIlocalVarJSON);
    cJSON_Delete(ItemRetainSamplesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemRetainSamplesAPI_updateItemRetainSampleAsync(apiClient_t *apiClient, char *tenantId, char *retainSampleId, char *api_version, char *x_api_version, item_retain_sample_update_dto_t *item_retain_sample_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_retain_sample_update_dto = NULL;
    if (item_retain_sample_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_retain_sample_update_dto = item_retain_sample_update_dto_convertToJSON(item_retain_sample_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_retain_sample_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_item_retain_sample_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_retain_sample_update_dto);
        localVarSingleItemJSON_item_retain_sample_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
