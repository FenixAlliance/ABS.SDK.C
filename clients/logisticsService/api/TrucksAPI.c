...
TrucksAPI_arriveTripAsync(apiClient_t *apiClient, char *tenantId, char *truckId, char *tripId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/Trucks/{truckId}/Trips/{tripId}/Arrive")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/Trucks/{truckId}/Trips/{tripId}/Arrive");


    // Path Params
    long sizeOfPathParams_truckId = strlen(truckId)+3 + strlen(tripId)+3 + strlen("{ truckId }");
    if(truckId == NULL) {
        goto end;
    }
    char* localVarToReplace_truckId = malloc(sizeOfPathParams_truckId);
    sprintf(localVarToReplace_truckId, "{%s}", "truckId");

    localVarPath = strReplace(localVarPath, localVarToReplace_truckId, truckId);
    if(truckId == NULL) {
        goto end;
    }
    char* localVarToReplace_truckId = malloc(sizeOfPathParams_truckId);
    ...
    // Path Params
    long sizeOfPathParams_tripId = strlen(truckId)+3 + strlen(tripId)+3 + strlen("{ tripId }");
    if(tripId == NULL) {
        goto end;
    }
    char* localVarToReplace_tripId = malloc(sizeOfPathParams_tripId);
    sprintf(localVarToReplace_tripId, "{%s}", "tripId");

    localVarPath = strReplace(localVarPath, localVarToReplace_tripId, tripId);
    if(tripId == NULL) {
        goto end;
    }
    char* localVarToReplace_tripId = malloc(sizeOfPathParams_tripId);
    ...
    cJSON *TrucksAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(TrucksAPIlocalVarJSON);
    cJSON_Delete(TrucksAPIlocalVarJSON);
...
TrucksAPI_cancelTripAsync(apiClient_t *apiClient, char *tenantId, char *truckId, char *tripId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/Trucks/{truckId}/Trips/{tripId}/Cancel")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/Trucks/{truckId}/Trips/{tripId}/Cancel");
...
TrucksAPI_createTruckAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, truck_create_dto_t *truck_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/Trucks")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/Trucks");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_truck_create_dto = NULL;
    if (truck_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_truck_create_dto = truck_create_dto_convertToJSON(truck_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_truck_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_truck_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_truck_create_dto);
        localVarSingleItemJSON_truck_create_dto = NULL;
    }
...
TrucksAPI_createTruckTripAsync(apiClient_t *apiClient, char *tenantId, char *truckId, char *api_version, char *x_api_version, truck_trip_create_dto_t *truck_trip_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/Trucks/{truckId}/Trips")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/Trucks/{truckId}/Trips");


    // Path Params
    long sizeOfPathParams_truckId = strlen(truckId)+3 + strlen("{ truckId }");
    if(truckId == NULL) {
        goto end;
    }
    char* localVarToReplace_truckId = malloc(sizeOfPathParams_truckId);
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_truck_trip_create_dto = NULL;
    if (truck_trip_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_truck_trip_create_dto = truck_trip_create_dto_convertToJSON(truck_trip_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_truck_trip_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_truck_trip_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_truck_trip_create_dto);
        localVarSingleItemJSON_truck_trip_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
TrucksAPI_deleteTruckAsync(apiClient_t *apiClient, char *tenantId, char *truckId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/Trucks/{truckId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/Trucks/{truckId}");
...
TrucksAPI_deleteTruckTripAsync(apiClient_t *apiClient, char *tenantId, char *truckId, char *tripId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/Trucks/{truckId}/Trips/{tripId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/Trucks/{truckId}/Trips/{tripId}");
...
TrucksAPI_deliverTripAsync(apiClient_t *apiClient, char *tenantId, char *truckId, char *tripId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/Trucks/{truckId}/Trips/{tripId}/Deliver")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/Trucks/{truckId}/Trips/{tripId}/Deliver");
...
TrucksAPI_departTripAsync(apiClient_t *apiClient, char *tenantId, char *truckId, char *tripId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/Trucks/{truckId}/Trips/{tripId}/Depart")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/Trucks/{truckId}/Trips/{tripId}/Depart");
...
TrucksAPI_dispatchTripAsync(apiClient_t *apiClient, char *tenantId, char *truckId, char *tripId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/Trucks/{truckId}/Trips/{tripId}/Dispatch")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/Trucks/{truckId}/Trips/{tripId}/Dispatch");
...
TrucksAPI_getTruckByIdAsync(apiClient_t *apiClient, char *tenantId, char *truckId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *TrucksAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    truck_dto_envelope_t *elementToReturn = truck_dto_envelope_parseFromJSON(TrucksAPIlocalVarJSON);
    cJSON_Delete(TrucksAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TrucksAPI_getTruckTripsAsync(apiClient_t *apiClient, char *tenantId, char *truckId, char *api_version, char *x_api_version, truck_trip_dto_collection_query_parameters_t *truck_trip_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *TrucksAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    truck_trip_dto_list_envelope_t *elementToReturn = truck_trip_dto_list_envelope_parseFromJSON(TrucksAPIlocalVarJSON);
    cJSON_Delete(TrucksAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TrucksAPI_getTruckTripsCountAsync(apiClient_t *apiClient, char *tenantId, char *truckId, char *api_version, char *x_api_version, truck_trip_dto_collection_query_parameters_t *truck_trip_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/Trucks/{truckId}/Trips/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/Trucks/{truckId}/Trips/Count");
    ...
    //nonprimitive not container
    cJSON *TrucksAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(TrucksAPIlocalVarJSON);
    cJSON_Delete(TrucksAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TrucksAPI_getTrucksAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, truck_dto_collection_query_parameters_t *truck_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *TrucksAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    truck_dto_list_envelope_t *elementToReturn = truck_dto_list_envelope_parseFromJSON(TrucksAPIlocalVarJSON);
    cJSON_Delete(TrucksAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TrucksAPI_getTrucksCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, truck_dto_collection_query_parameters_t *truck_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/Trucks/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/Trucks/Count");
...
TrucksAPI_updateTruckAsync(apiClient_t *apiClient, char *tenantId, char *truckId, char *api_version, char *x_api_version, truck_update_dto_t *truck_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_truck_update_dto = NULL;
    if (truck_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_truck_update_dto = truck_update_dto_convertToJSON(truck_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_truck_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_truck_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_truck_update_dto);
        localVarSingleItemJSON_truck_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
TrucksAPI_updateTruckTripAsync(apiClient_t *apiClient, char *tenantId, char *truckId, char *tripId, char *api_version, char *x_api_version, truck_trip_update_dto_t *truck_trip_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_truck_trip_update_dto = NULL;
    if (truck_trip_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_truck_trip_update_dto = truck_trip_update_dto_convertToJSON(truck_trip_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_truck_trip_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_truck_trip_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_truck_trip_update_dto);
        localVarSingleItemJSON_truck_trip_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
