...
TruckDriversAPI_activateTruckDriverAsync(apiClient_t *apiClient, char *tenantId, char *driverId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/TruckDrivers/{driverId}/Activate")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/TruckDrivers/{driverId}/Activate");


    // Path Params
    long sizeOfPathParams_driverId = strlen(driverId)+3 + strlen("{ driverId }");
    if(driverId == NULL) {
        goto end;
    }
    char* localVarToReplace_driverId = malloc(sizeOfPathParams_driverId);
    sprintf(localVarToReplace_driverId, "{%s}", "driverId");

    localVarPath = strReplace(localVarPath, localVarToReplace_driverId, driverId);
    if(driverId == NULL) {
        goto end;
    }
    char* localVarToReplace_driverId = malloc(sizeOfPathParams_driverId);
    ...
    cJSON *TruckDriversAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(TruckDriversAPIlocalVarJSON);
    cJSON_Delete(TruckDriversAPIlocalVarJSON);
...
TruckDriversAPI_createTruckDriverAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, truck_driver_create_dto_t *truck_driver_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/TruckDrivers")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/TruckDrivers");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_truck_driver_create_dto = NULL;
    if (truck_driver_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_truck_driver_create_dto = truck_driver_create_dto_convertToJSON(truck_driver_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_truck_driver_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_truck_driver_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_truck_driver_create_dto);
        localVarSingleItemJSON_truck_driver_create_dto = NULL;
    }
...
TruckDriversAPI_deactivateTruckDriverAsync(apiClient_t *apiClient, char *tenantId, char *driverId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/TruckDrivers/{driverId}/Deactivate")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/TruckDrivers/{driverId}/Deactivate");
...
TruckDriversAPI_deleteTruckDriverAsync(apiClient_t *apiClient, char *tenantId, char *driverId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/TruckDrivers/{driverId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/TruckDrivers/{driverId}");
...
TruckDriversAPI_getTruckDriverByIdAsync(apiClient_t *apiClient, char *tenantId, char *driverId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *TruckDriversAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    truck_driver_dto_envelope_t *elementToReturn = truck_driver_dto_envelope_parseFromJSON(TruckDriversAPIlocalVarJSON);
    cJSON_Delete(TruckDriversAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TruckDriversAPI_getTruckDriversAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, truck_driver_dto_collection_query_parameters_t *truck_driver_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_truck_driver_dto_collection_query_parameters = NULL;
    if (truck_driver_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_truck_driver_dto_collection_query_parameters = truck_driver_dto_collection_query_parameters_convertToJSON(truck_driver_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_truck_driver_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *TruckDriversAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    truck_driver_dto_list_envelope_t *elementToReturn = truck_driver_dto_list_envelope_parseFromJSON(TruckDriversAPIlocalVarJSON);
    cJSON_Delete(TruckDriversAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_truck_driver_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_truck_driver_dto_collection_query_parameters);
        localVarSingleItemJSON_truck_driver_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
TruckDriversAPI_getTruckDriversCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, truck_driver_dto_collection_query_parameters_t *truck_driver_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/TruckDrivers/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/TruckDrivers/Count");
    ...
    //nonprimitive not container
    cJSON *TruckDriversAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(TruckDriversAPIlocalVarJSON);
    cJSON_Delete(TruckDriversAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TruckDriversAPI_updateTruckDriverAsync(apiClient_t *apiClient, char *tenantId, char *driverId, char *api_version, char *x_api_version, truck_driver_update_dto_t *truck_driver_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_truck_driver_update_dto = NULL;
    if (truck_driver_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_truck_driver_update_dto = truck_driver_update_dto_convertToJSON(truck_driver_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_truck_driver_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_truck_driver_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_truck_driver_update_dto);
        localVarSingleItemJSON_truck_driver_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
