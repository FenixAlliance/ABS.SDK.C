...
VesselsAPI_createVesselAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, vessel_create_dto_t *vessel_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/Vessels")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/Vessels");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_vessel_create_dto = NULL;
    if (vessel_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_vessel_create_dto = vessel_create_dto_convertToJSON(vessel_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_vessel_create_dto);
    }
    ...
    cJSON *VesselsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(VesselsAPIlocalVarJSON);
    cJSON_Delete(VesselsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_vessel_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_vessel_create_dto);
        localVarSingleItemJSON_vessel_create_dto = NULL;
    }
...
VesselsAPI_deleteVesselAsync(apiClient_t *apiClient, char *tenantId, char *vesselId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/Vessels/{vesselId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/Vessels/{vesselId}");


    // Path Params
    long sizeOfPathParams_vesselId = strlen(vesselId)+3 + strlen("{ vesselId }");
    if(vesselId == NULL) {
        goto end;
    }
    char* localVarToReplace_vesselId = malloc(sizeOfPathParams_vesselId);
    sprintf(localVarToReplace_vesselId, "{%s}", "vesselId");

    localVarPath = strReplace(localVarPath, localVarToReplace_vesselId, vesselId);
    if(vesselId == NULL) {
        goto end;
    }
    char* localVarToReplace_vesselId = malloc(sizeOfPathParams_vesselId);
    ...
    free(localVarPath);
    free(localVarToReplace_vesselId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
VesselsAPI_getVesselByIdAsync(apiClient_t *apiClient, char *tenantId, char *vesselId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *VesselsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    vessel_dto_envelope_t *elementToReturn = vessel_dto_envelope_parseFromJSON(VesselsAPIlocalVarJSON);
    cJSON_Delete(VesselsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
VesselsAPI_getVesselsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, vessel_dto_collection_query_parameters_t *vessel_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_vessel_dto_collection_query_parameters = NULL;
    if (vessel_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_vessel_dto_collection_query_parameters = vessel_dto_collection_query_parameters_convertToJSON(vessel_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_vessel_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *VesselsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    vessel_dto_list_envelope_t *elementToReturn = vessel_dto_list_envelope_parseFromJSON(VesselsAPIlocalVarJSON);
    cJSON_Delete(VesselsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_vessel_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_vessel_dto_collection_query_parameters);
        localVarSingleItemJSON_vessel_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
VesselsAPI_getVesselsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, vessel_dto_collection_query_parameters_t *vessel_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/Vessels/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/Vessels/Count");
    ...
    //nonprimitive not container
    cJSON *VesselsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(VesselsAPIlocalVarJSON);
    cJSON_Delete(VesselsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
VesselsAPI_updateVesselAsync(apiClient_t *apiClient, char *tenantId, char *vesselId, char *api_version, char *x_api_version, vessel_update_dto_t *vessel_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_vessel_update_dto = NULL;
    if (vessel_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_vessel_update_dto = vessel_update_dto_convertToJSON(vessel_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_vessel_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_vessel_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_vessel_update_dto);
        localVarSingleItemJSON_vessel_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
