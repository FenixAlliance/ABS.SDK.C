...
SupplierProfilesAPI_createSupplierProfileAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, supplier_profile_create_dto_t *supplier_profile_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/SupplierProfiles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/SupplierProfiles");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_supplier_profile_create_dto = NULL;
    if (supplier_profile_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_supplier_profile_create_dto = supplier_profile_create_dto_convertToJSON(supplier_profile_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_supplier_profile_create_dto);
    }
    ...
    cJSON *SupplierProfilesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SupplierProfilesAPIlocalVarJSON);
    cJSON_Delete(SupplierProfilesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_supplier_profile_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_supplier_profile_create_dto);
        localVarSingleItemJSON_supplier_profile_create_dto = NULL;
    }
...
SupplierProfilesAPI_deleteSupplierProfileAsync(apiClient_t *apiClient, char *tenantId, char *supplierProfileId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/SupplierProfiles/{supplierProfileId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/SupplierProfiles/{supplierProfileId}");


    // Path Params
    long sizeOfPathParams_supplierProfileId = strlen(supplierProfileId)+3 + strlen("{ supplierProfileId }");
    if(supplierProfileId == NULL) {
        goto end;
    }
    char* localVarToReplace_supplierProfileId = malloc(sizeOfPathParams_supplierProfileId);
    sprintf(localVarToReplace_supplierProfileId, "{%s}", "supplierProfileId");

    localVarPath = strReplace(localVarPath, localVarToReplace_supplierProfileId, supplierProfileId);
    if(supplierProfileId == NULL) {
        goto end;
    }
    char* localVarToReplace_supplierProfileId = malloc(sizeOfPathParams_supplierProfileId);
    ...
    free(localVarPath);
    free(localVarToReplace_supplierProfileId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
SupplierProfilesAPI_getSupplierProfileByIdAsync(apiClient_t *apiClient, char *tenantId, char *supplierProfileId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SupplierProfilesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    supplier_profile_dto_envelope_t *elementToReturn = supplier_profile_dto_envelope_parseFromJSON(SupplierProfilesAPIlocalVarJSON);
    cJSON_Delete(SupplierProfilesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SupplierProfilesAPI_getSupplierProfilesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, supplier_profile_dto_collection_query_parameters_t *supplier_profile_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_supplier_profile_dto_collection_query_parameters = NULL;
    if (supplier_profile_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_supplier_profile_dto_collection_query_parameters = supplier_profile_dto_collection_query_parameters_convertToJSON(supplier_profile_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_supplier_profile_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *SupplierProfilesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    supplier_profile_dto_list_envelope_t *elementToReturn = supplier_profile_dto_list_envelope_parseFromJSON(SupplierProfilesAPIlocalVarJSON);
    cJSON_Delete(SupplierProfilesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_supplier_profile_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_supplier_profile_dto_collection_query_parameters);
        localVarSingleItemJSON_supplier_profile_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SupplierProfilesAPI_getSupplierProfilesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, supplier_profile_dto_collection_query_parameters_t *supplier_profile_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/SupplierProfiles/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/SupplierProfiles/Count");
    ...
    //nonprimitive not container
    cJSON *SupplierProfilesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SupplierProfilesAPIlocalVarJSON);
    cJSON_Delete(SupplierProfilesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SupplierProfilesAPI_updateSupplierProfileAsync(apiClient_t *apiClient, char *tenantId, char *supplierProfileId, char *api_version, char *x_api_version, supplier_profile_update_dto_t *supplier_profile_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_supplier_profile_update_dto = NULL;
    if (supplier_profile_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_supplier_profile_update_dto = supplier_profile_update_dto_convertToJSON(supplier_profile_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_supplier_profile_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_supplier_profile_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_supplier_profile_update_dto);
        localVarSingleItemJSON_supplier_profile_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
