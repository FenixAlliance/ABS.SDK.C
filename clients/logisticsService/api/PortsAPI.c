...
PortsAPI_createPortAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, port_create_dto_t *port_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/Ports")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/Ports");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_port_create_dto = NULL;
    if (port_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_port_create_dto = port_create_dto_convertToJSON(port_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_port_create_dto);
    }
    ...
    cJSON *PortsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(PortsAPIlocalVarJSON);
    cJSON_Delete(PortsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_port_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_port_create_dto);
        localVarSingleItemJSON_port_create_dto = NULL;
    }
...
PortsAPI_deletePortAsync(apiClient_t *apiClient, char *tenantId, char *portId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/Ports/{portId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/Ports/{portId}");


    // Path Params
    long sizeOfPathParams_portId = strlen(portId)+3 + strlen("{ portId }");
    if(portId == NULL) {
        goto end;
    }
    char* localVarToReplace_portId = malloc(sizeOfPathParams_portId);
    sprintf(localVarToReplace_portId, "{%s}", "portId");

    localVarPath = strReplace(localVarPath, localVarToReplace_portId, portId);
    if(portId == NULL) {
        goto end;
    }
    char* localVarToReplace_portId = malloc(sizeOfPathParams_portId);
...
PortsAPI_getPortByIdAsync(apiClient_t *apiClient, char *tenantId, char *portId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *PortsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    port_dto_envelope_t *elementToReturn = port_dto_envelope_parseFromJSON(PortsAPIlocalVarJSON);
    cJSON_Delete(PortsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
PortsAPI_getPortsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, port_dto_collection_query_parameters_t *port_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_port_dto_collection_query_parameters = NULL;
    if (port_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_port_dto_collection_query_parameters = port_dto_collection_query_parameters_convertToJSON(port_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_port_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *PortsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    port_dto_list_envelope_t *elementToReturn = port_dto_list_envelope_parseFromJSON(PortsAPIlocalVarJSON);
    cJSON_Delete(PortsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_port_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_port_dto_collection_query_parameters);
        localVarSingleItemJSON_port_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
PortsAPI_getPortsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, port_dto_collection_query_parameters_t *port_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LogisticsService/Ports/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LogisticsService/Ports/Count");
    ...
    //nonprimitive not container
    cJSON *PortsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(PortsAPIlocalVarJSON);
    cJSON_Delete(PortsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
PortsAPI_updatePortAsync(apiClient_t *apiClient, char *tenantId, char *portId, char *api_version, char *x_api_version, port_update_dto_t *port_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_port_update_dto = NULL;
    if (port_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_port_update_dto = port_update_dto_convertToJSON(port_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_port_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_port_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_port_update_dto);
        localVarSingleItemJSON_port_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
