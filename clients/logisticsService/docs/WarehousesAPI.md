...
//
warehouse_dto_list_envelope_t* WarehousesAPI_getWarehousesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, warehouse_dto_collection_query_parameters_t *warehouse_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**warehouse_dto_collection_query_parameters** | **[warehouse_dto_collection_query_parameters_t](warehouse_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* WarehousesAPI_getWarehousesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, warehouse_dto_collection_query_parameters_t *warehouse_dto_collection_query_parameters);
```
...
//
empty_envelope_t* WarehousesAPI_patchWarehouseAsync(apiClient_t *apiClient, char *tenantId, char *warehouseId, char *api_version, char *x_api_version, list_t *patch_operation);
```
