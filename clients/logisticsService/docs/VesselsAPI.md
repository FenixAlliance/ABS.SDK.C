...
//
vessel_dto_list_envelope_t* VesselsAPI_getVesselsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, vessel_dto_collection_query_parameters_t *vessel_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**vessel_dto_collection_query_parameters** | **[vessel_dto_collection_query_parameters_t](vessel_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* VesselsAPI_getVesselsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, vessel_dto_collection_query_parameters_t *vessel_dto_collection_query_parameters);
```
...
//
empty_envelope_t* VesselsAPI_patchVesselAsync(apiClient_t *apiClient, char *tenantId, char *vesselId, char *api_version, char *x_api_version, list_t *patch_operation);
```
