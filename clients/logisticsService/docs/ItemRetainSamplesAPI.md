...
//
item_retain_sample_dto_list_envelope_t* ItemRetainSamplesAPI_getItemRetainSamplesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_retain_sample_dto_collection_query_parameters_t *item_retain_sample_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**item_retain_sample_dto_collection_query_parameters** | **[item_retain_sample_dto_collection_query_parameters_t](item_retain_sample_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* ItemRetainSamplesAPI_getItemRetainSamplesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_retain_sample_dto_collection_query_parameters_t *item_retain_sample_dto_collection_query_parameters);
```
...
//
empty_envelope_t* ItemRetainSamplesAPI_patchItemRetainSampleAsync(apiClient_t *apiClient, char *tenantId, char *retainSampleId, char *api_version, char *x_api_version, list_t *patch_operation);
```
