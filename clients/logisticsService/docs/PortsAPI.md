...
[**PortsAPI_patchPortAsync**](PortsAPI.md#PortsAPI_patchPortAsync) | **PATCH** /api/v2/LogisticsService/Ports/{portId} | Patch a port
...
//
port_dto_list_envelope_t* PortsAPI_getPortsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, port_dto_collection_query_parameters_t *port_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**port_dto_collection_query_parameters** | **[port_dto_collection_query_parameters_t](port_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* PortsAPI_getPortsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, port_dto_collection_query_parameters_t *port_dto_collection_query_parameters);
```
...
# **PortsAPI_patchPortAsync**
```c
// Patch a port
//
// Partially updates an existing port using JSON Patch.
//
empty_envelope_t* PortsAPI_patchPortAsync(apiClient_t *apiClient, char *tenantId, char *portId, char *api_version, char *x_api_version, list_t *patch_operation);
```
