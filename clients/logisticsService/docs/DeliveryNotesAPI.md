...
//
delivery_note_dto_list_envelope_t* DeliveryNotesAPI_getDeliveryNotesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
//
int32_envelope_t* DeliveryNotesAPI_getDeliveryNotesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
