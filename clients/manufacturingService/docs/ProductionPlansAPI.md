...
//
production_plan_dto_list_envelope_t* ProductionPlansAPI_getProductionPlansAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
//
int32_envelope_t* ProductionPlansAPI_getProductionPlansCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
// Patch a production plan
//
empty_envelope_t* ProductionPlansAPI_patchProductionPlanAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *operation);
```
