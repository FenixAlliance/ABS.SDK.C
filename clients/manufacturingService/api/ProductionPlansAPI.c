...
ProductionPlansAPI_createProductionPlanAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, production_plan_create_dto_t *production_plan_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ManufacturingService/ProductionPlans")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ManufacturingService/ProductionPlans");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_production_plan_create_dto = NULL;
    if (production_plan_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_production_plan_create_dto = production_plan_create_dto_convertToJSON(production_plan_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_production_plan_create_dto);
    }
    ...
    if (localVarSingleItemJSON_production_plan_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_production_plan_create_dto);
        localVarSingleItemJSON_production_plan_create_dto = NULL;
    }
...
ProductionPlansAPI_deleteProductionPlanAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ManufacturingService/ProductionPlans/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ManufacturingService/ProductionPlans/{id}");
...
ProductionPlansAPI_getProductionPlanByIdAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    cJSON *ProductionPlansAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    production_plan_dto_t *elementToReturn = production_plan_dto_parseFromJSON(ProductionPlansAPIlocalVarJSON);
    cJSON_Delete(ProductionPlansAPIlocalVarJSON);
...
ProductionPlansAPI_getProductionPlansAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, production_plan_dto_collection_query_parameters_t *production_plan_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_production_plan_dto_collection_query_parameters = NULL;
    if (production_plan_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_production_plan_dto_collection_query_parameters = production_plan_dto_collection_query_parameters_convertToJSON(production_plan_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_production_plan_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ProductionPlansAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    production_plan_dto_list_envelope_t *elementToReturn = production_plan_dto_list_envelope_parseFromJSON(ProductionPlansAPIlocalVarJSON);
    cJSON_Delete(ProductionPlansAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_production_plan_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_production_plan_dto_collection_query_parameters);
        localVarSingleItemJSON_production_plan_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ProductionPlansAPI_getProductionPlansCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, production_plan_dto_collection_query_parameters_t *production_plan_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ManufacturingService/ProductionPlans/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ManufacturingService/ProductionPlans/Count");
    ...
    //nonprimitive not container
    cJSON *ProductionPlansAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ProductionPlansAPIlocalVarJSON);
    cJSON_Delete(ProductionPlansAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ProductionPlansAPI_patchProductionPlanAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *ProductionPlansAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ProductionPlansAPIlocalVarJSON);
    cJSON_Delete(ProductionPlansAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ProductionPlansAPI_updateProductionPlanAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, production_plan_update_dto_t *production_plan_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_production_plan_update_dto = NULL;
    if (production_plan_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_production_plan_update_dto = production_plan_update_dto_convertToJSON(production_plan_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_production_plan_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_production_plan_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_production_plan_update_dto);
        localVarSingleItemJSON_production_plan_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
