...
WorkstationsAPI_createWorkstationAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, workstation_create_dto_t *workstation_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ManufacturingService/Workstations")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ManufacturingService/Workstations");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_workstation_create_dto = NULL;
    if (workstation_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_workstation_create_dto = workstation_create_dto_convertToJSON(workstation_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_workstation_create_dto);
    }
    ...
    if (localVarSingleItemJSON_workstation_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_workstation_create_dto);
        localVarSingleItemJSON_workstation_create_dto = NULL;
    }
...
WorkstationsAPI_deleteWorkstationAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ManufacturingService/Workstations/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ManufacturingService/Workstations/{id}");
...
WorkstationsAPI_getWorkstationByIdAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    cJSON *WorkstationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    workstation_dto_t *elementToReturn = workstation_dto_parseFromJSON(WorkstationsAPIlocalVarJSON);
    cJSON_Delete(WorkstationsAPIlocalVarJSON);
...
WorkstationsAPI_getWorkstationsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, workstation_dto_collection_query_parameters_t *workstation_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_workstation_dto_collection_query_parameters = NULL;
    if (workstation_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_workstation_dto_collection_query_parameters = workstation_dto_collection_query_parameters_convertToJSON(workstation_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_workstation_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *WorkstationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    workstation_dto_list_envelope_t *elementToReturn = workstation_dto_list_envelope_parseFromJSON(WorkstationsAPIlocalVarJSON);
    cJSON_Delete(WorkstationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_workstation_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_workstation_dto_collection_query_parameters);
        localVarSingleItemJSON_workstation_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
WorkstationsAPI_getWorkstationsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, workstation_dto_collection_query_parameters_t *workstation_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ManufacturingService/Workstations/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ManufacturingService/Workstations/Count");
    ...
    //nonprimitive not container
    cJSON *WorkstationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(WorkstationsAPIlocalVarJSON);
    cJSON_Delete(WorkstationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
WorkstationsAPI_patchWorkstationAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *WorkstationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(WorkstationsAPIlocalVarJSON);
    cJSON_Delete(WorkstationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
WorkstationsAPI_updateWorkstationAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, workstation_update_dto_t *workstation_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_workstation_update_dto = NULL;
    if (workstation_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_workstation_update_dto = workstation_update_dto_convertToJSON(workstation_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_workstation_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_workstation_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_workstation_update_dto);
        localVarSingleItemJSON_workstation_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
