...
WorkOrdersAPI_createWorkOrderAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, work_order_create_dto_t *work_order_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ManufacturingService/WorkOrders")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ManufacturingService/WorkOrders");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_work_order_create_dto = NULL;
    if (work_order_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_work_order_create_dto = work_order_create_dto_convertToJSON(work_order_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_work_order_create_dto);
    }
    ...
    if (localVarSingleItemJSON_work_order_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_work_order_create_dto);
        localVarSingleItemJSON_work_order_create_dto = NULL;
    }
...
WorkOrdersAPI_deleteWorkOrderAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ManufacturingService/WorkOrders/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ManufacturingService/WorkOrders/{id}");
...
WorkOrdersAPI_getWorkOrderByIdAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    cJSON *WorkOrdersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    work_order_dto_t *elementToReturn = work_order_dto_parseFromJSON(WorkOrdersAPIlocalVarJSON);
    cJSON_Delete(WorkOrdersAPIlocalVarJSON);
...
WorkOrdersAPI_getWorkOrdersAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, work_order_dto_collection_query_parameters_t *work_order_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_work_order_dto_collection_query_parameters = NULL;
    if (work_order_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_work_order_dto_collection_query_parameters = work_order_dto_collection_query_parameters_convertToJSON(work_order_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_work_order_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *WorkOrdersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    work_order_dto_list_envelope_t *elementToReturn = work_order_dto_list_envelope_parseFromJSON(WorkOrdersAPIlocalVarJSON);
    cJSON_Delete(WorkOrdersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_work_order_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_work_order_dto_collection_query_parameters);
        localVarSingleItemJSON_work_order_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
WorkOrdersAPI_getWorkOrdersCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, work_order_dto_collection_query_parameters_t *work_order_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/ManufacturingService/WorkOrders/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/ManufacturingService/WorkOrders/Count");
    ...
    //nonprimitive not container
    cJSON *WorkOrdersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(WorkOrdersAPIlocalVarJSON);
    cJSON_Delete(WorkOrdersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
WorkOrdersAPI_patchWorkOrderAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *WorkOrdersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(WorkOrdersAPIlocalVarJSON);
    cJSON_Delete(WorkOrdersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
WorkOrdersAPI_updateWorkOrderAsync(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, work_order_update_dto_t *work_order_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_work_order_update_dto = NULL;
    if (work_order_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_work_order_update_dto = work_order_update_dto_convertToJSON(work_order_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_work_order_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_work_order_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_work_order_update_dto);
        localVarSingleItemJSON_work_order_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
