...
cJSON *project_time_log_dto_convertToJSON(project_time_log_dto_t *project_time_log_dto) {
    ...
    if(project_time_log_dto->record_type != timetrackerservice_project_time_log_dto_RECORDTYPE_NULL) {
...
project_time_log_dto_t *project_time_log_dto_parseFromJSON(cJSON *project_time_log_dtoJSON){
    ...
    timetrackerservice_project_time_log_dto_RECORDTYPE_e record_typeVariable;
    if (record_type) { 
    ...
    project_time_log_dto_local_var = project_time_log_dto_create (
        ...
        record_type ? record_typeVariable : timetrackerservice_project_time_log_dto_RECORDTYPE_NULL,
