...
#include <stdio.h>
#include <ctype.h>
#include "OAuthApplicationsAPI.h"
...
OAuthApplicationsAPI_createOAuthApplicationAsync(apiClient_t *apiClient, char *tenantId, o_auth_application_create_dto_t *o_auth_application_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/OAuthApplications")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/OAuthApplications");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_o_auth_application_create_dto = NULL;
    if (o_auth_application_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_o_auth_application_create_dto = o_auth_application_create_dto_convertToJSON(o_auth_application_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_o_auth_application_create_dto);
    }
    ...
    cJSON *OAuthApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(OAuthApplicationsAPIlocalVarJSON);
    cJSON_Delete(OAuthApplicationsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_o_auth_application_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_o_auth_application_create_dto);
        localVarSingleItemJSON_o_auth_application_create_dto = NULL;
    }
...
OAuthApplicationsAPI_deleteOAuthApplicationAsync(apiClient_t *apiClient, char *tenantId, char *applicationId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/OAuthApplications/{applicationId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/OAuthApplications/{applicationId}");
...
OAuthApplicationsAPI_getOAuthApplicationByIdAsync(apiClient_t *apiClient, char *tenantId, char *applicationId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *OAuthApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    o_auth_application_dto_envelope_t *elementToReturn = o_auth_application_dto_envelope_parseFromJSON(OAuthApplicationsAPIlocalVarJSON);
    cJSON_Delete(OAuthApplicationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
OAuthApplicationsAPI_getOAuthApplicationsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *OAuthApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    o_auth_application_dto_list_envelope_t *elementToReturn = o_auth_application_dto_list_envelope_parseFromJSON(OAuthApplicationsAPIlocalVarJSON);
    cJSON_Delete(OAuthApplicationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
OAuthApplicationsAPI_getOAuthApplicationsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/OAuthApplications/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/OAuthApplications/Count");
    ...
    //nonprimitive not container
    cJSON *OAuthApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(OAuthApplicationsAPIlocalVarJSON);
    cJSON_Delete(OAuthApplicationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
OAuthApplicationsAPI_getOAuthAuthorizationByIdAsync(apiClient_t *apiClient, char *tenantId, char *authorizationId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/OAuthApplications/Authorizations/{authorizationId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/OAuthApplications/Authorizations/{authorizationId}");


    // Path Params
    long sizeOfPathParams_authorizationId = strlen(authorizationId)+3 + strlen("{ authorizationId }");
    if(authorizationId == NULL) {
        goto end;
    }
    char* localVarToReplace_authorizationId = malloc(sizeOfPathParams_authorizationId);
    sprintf(localVarToReplace_authorizationId, "{%s}", "authorizationId");

    localVarPath = strReplace(localVarPath, localVarToReplace_authorizationId, authorizationId);
    ...
    //nonprimitive not container
    cJSON *OAuthApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    o_auth_authorization_dto_envelope_t *elementToReturn = o_auth_authorization_dto_envelope_parseFromJSON(OAuthApplicationsAPIlocalVarJSON);
    cJSON_Delete(OAuthApplicationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(localVarPath);
    free(localVarToReplace_authorizationId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
OAuthApplicationsAPI_getOAuthAuthorizationsAsync(apiClient_t *apiClient, char *tenantId, char *userId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/OAuthApplications/Authorizations")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/OAuthApplications/Authorizations");
    ...
    //nonprimitive not container
    cJSON *OAuthApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    o_auth_authorization_dto_list_envelope_t *elementToReturn = o_auth_authorization_dto_list_envelope_parseFromJSON(OAuthApplicationsAPIlocalVarJSON);
    cJSON_Delete(OAuthApplicationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
OAuthApplicationsAPI_getOAuthAuthorizationsCountAsync(apiClient_t *apiClient, char *tenantId, char *userId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/OAuthApplications/Authorizations/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/OAuthApplications/Authorizations/Count");
...
OAuthApplicationsAPI_updateOAuthApplicationAsync(apiClient_t *apiClient, char *tenantId, char *applicationId, o_auth_application_update_dto_t *o_auth_application_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_o_auth_application_update_dto = NULL;
    if (o_auth_application_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_o_auth_application_update_dto = o_auth_application_update_dto_convertToJSON(o_auth_application_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_o_auth_application_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_o_auth_application_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_o_auth_application_update_dto);
        localVarSingleItemJSON_o_auth_application_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
