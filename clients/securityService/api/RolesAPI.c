...
RolesAPI_assignPermissionToRoleAsync(apiClient_t *apiClient, char *tenantId, char *securityRoleId, char *securityPermissionId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Roles/{securityRoleId}/Permissions/{securityPermissionId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Roles/{securityRoleId}/Permissions/{securityPermissionId}");


    // Path Params
    long sizeOfPathParams_securityRoleId = strlen(securityRoleId)+3 + strlen(securityPermissionId)+3 + strlen("{ securityRoleId }");
    ...
    // Path Params
    long sizeOfPathParams_securityPermissionId = strlen(securityRoleId)+3 + strlen(securityPermissionId)+3 + strlen("{ securityPermissionId }");
    ...
    cJSON *RolesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(RolesAPIlocalVarJSON);
    cJSON_Delete(RolesAPIlocalVarJSON);
...
RolesAPI_assignRoleToBusinessApplicationAsync(apiClient_t *apiClient, char *tenantId, char *securityRoleId, char *applicationId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Roles/{securityRoleId}/Applications/{applicationId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Roles/{securityRoleId}/Applications/{applicationId}");


    // Path Params
    long sizeOfPathParams_securityRoleId = strlen(securityRoleId)+3 + strlen(applicationId)+3 + strlen("{ securityRoleId }");
    if(securityRoleId == NULL) {
        goto end;
    }
    char* localVarToReplace_securityRoleId = malloc(sizeOfPathParams_securityRoleId);
    ...
    // Path Params
    long sizeOfPathParams_applicationId = strlen(securityRoleId)+3 + strlen(applicationId)+3 + strlen("{ applicationId }");
...
RolesAPI_assignRoleToEnrollmentAsync(apiClient_t *apiClient, char *tenantId, char *securityRoleId, char *enrollmentId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Roles/{securityRoleId}/Enrollments/{enrollmentId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Roles/{securityRoleId}/Enrollments/{enrollmentId}");


    // Path Params
    long sizeOfPathParams_securityRoleId = strlen(securityRoleId)+3 + strlen(enrollmentId)+3 + strlen("{ securityRoleId }");
    if(securityRoleId == NULL) {
        goto end;
    }
    char* localVarToReplace_securityRoleId = malloc(sizeOfPathParams_securityRoleId);
    ...
    // Path Params
    long sizeOfPathParams_enrollmentId = strlen(securityRoleId)+3 + strlen(enrollmentId)+3 + strlen("{ enrollmentId }");
...
RolesAPI_createRoleAsync(apiClient_t *apiClient, char *tenantId, security_role_create_dto_t *security_role_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Roles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Roles");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_security_role_create_dto = NULL;
    if (security_role_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_security_role_create_dto = security_role_create_dto_convertToJSON(security_role_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_security_role_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_security_role_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_security_role_create_dto);
        localVarSingleItemJSON_security_role_create_dto = NULL;
    }
...
RolesAPI_deleteRoleAsync(apiClient_t *apiClient, char *tenantId, char *securityRoleId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Roles/{securityRoleId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Roles/{securityRoleId}");


    // Path Params
    long sizeOfPathParams_securityRoleId = strlen(securityRoleId)+3 + strlen("{ securityRoleId }");
    if(securityRoleId == NULL) {
        goto end;
    }
    char* localVarToReplace_securityRoleId = malloc(sizeOfPathParams_securityRoleId);
...
RolesAPI_getApplicationsByRoleAsync(apiClient_t *apiClient, char *tenantId, char *securityRoleId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Roles/{securityRoleId}/Applications")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Roles/{securityRoleId}/Applications");
    ...
    //nonprimitive not container
    cJSON *RolesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    business_application_simple_dto_list_envelope_t *elementToReturn = business_application_simple_dto_list_envelope_parseFromJSON(RolesAPIlocalVarJSON);
    cJSON_Delete(RolesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RolesAPI_getEnrollmentsByRoleAsync(apiClient_t *apiClient, char *tenantId, char *securityRoleId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Roles/{securityRoleId}/Enrollments")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Roles/{securityRoleId}/Enrollments");
    ...
    //nonprimitive not container
    cJSON *RolesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_enrollment_dto_list_envelope_t *elementToReturn = tenant_enrollment_dto_list_envelope_parseFromJSON(RolesAPIlocalVarJSON);
    cJSON_Delete(RolesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RolesAPI_getRoleAsync(apiClient_t *apiClient, char *tenantId, char *securityRoleId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *RolesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    security_role_dto_envelope_t *elementToReturn = security_role_dto_envelope_parseFromJSON(RolesAPIlocalVarJSON);
    cJSON_Delete(RolesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RolesAPI_getRolePermissionsAsync(apiClient_t *apiClient, char *tenantId, char *securityRoleId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Roles/{securityRoleId}/Permissions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Roles/{securityRoleId}/Permissions");
    ...
    //nonprimitive not container
    cJSON *RolesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    security_permission_dto_list_envelope_t *elementToReturn = security_permission_dto_list_envelope_parseFromJSON(RolesAPIlocalVarJSON);
    cJSON_Delete(RolesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RolesAPI_getRolesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, security_role_dto_collection_query_parameters_t *security_role_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_security_role_dto_collection_query_parameters = NULL;
    if (security_role_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_security_role_dto_collection_query_parameters = security_role_dto_collection_query_parameters_convertToJSON(security_role_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_security_role_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *RolesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    security_role_dto_list_envelope_t *elementToReturn = security_role_dto_list_envelope_parseFromJSON(RolesAPIlocalVarJSON);
    cJSON_Delete(RolesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_security_role_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_security_role_dto_collection_query_parameters);
        localVarSingleItemJSON_security_role_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
RolesAPI_getRolesByEnrollmentAsync(apiClient_t *apiClient, char *tenantId, char *enrollmentId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Roles/ByEnrollment/{enrollmentId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Roles/ByEnrollment/{enrollmentId}");
...
RolesAPI_getRolesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, security_role_dto_collection_query_parameters_t *security_role_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Roles/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Roles/Count");
    ...
    //nonprimitive not container
    cJSON *RolesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(RolesAPIlocalVarJSON);
    cJSON_Delete(RolesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RolesAPI_updateRoleAsync(apiClient_t *apiClient, char *tenantId, char *securityRoleId, security_role_update_dto_t *security_role_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_security_role_update_dto = NULL;
    if (security_role_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_security_role_update_dto = security_role_update_dto_convertToJSON(security_role_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_security_role_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_security_role_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_security_role_update_dto);
        localVarSingleItemJSON_security_role_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
