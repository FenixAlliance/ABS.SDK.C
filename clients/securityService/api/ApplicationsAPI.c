...
ApplicationsAPI_createBusinessApplicationAsync(apiClient_t *apiClient, char *tenantId, business_application_create_dto_t *business_application_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Applications")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Applications");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_business_application_create_dto = NULL;
    if (business_application_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_business_application_create_dto = business_application_create_dto_convertToJSON(business_application_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_business_application_create_dto);
    }
    ...
    cJSON *ApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ApplicationsAPIlocalVarJSON);
    cJSON_Delete(ApplicationsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_business_application_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_business_application_create_dto);
        localVarSingleItemJSON_business_application_create_dto = NULL;
    }
...
ApplicationsAPI_deleteBusinessApplicationAsync(apiClient_t *apiClient, char *tenantId, char *applicationId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Applications/{applicationId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Applications/{applicationId}");
...
ApplicationsAPI_getBusinessApplicationByIdAsync(apiClient_t *apiClient, char *tenantId, char *applicationId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    business_application_dto_envelope_t *elementToReturn = business_application_dto_envelope_parseFromJSON(ApplicationsAPIlocalVarJSON);
    cJSON_Delete(ApplicationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ApplicationsAPI_getBusinessApplicationsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, business_application_dto_collection_query_parameters_t *business_application_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_business_application_dto_collection_query_parameters = NULL;
    if (business_application_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_business_application_dto_collection_query_parameters = business_application_dto_collection_query_parameters_convertToJSON(business_application_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_business_application_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    business_application_dto_list_envelope_t *elementToReturn = business_application_dto_list_envelope_parseFromJSON(ApplicationsAPIlocalVarJSON);
    cJSON_Delete(ApplicationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_business_application_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_business_application_dto_collection_query_parameters);
        localVarSingleItemJSON_business_application_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ApplicationsAPI_getBusinessApplicationsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, business_application_dto_collection_query_parameters_t *business_application_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Applications/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Applications/Count");
    ...
    //nonprimitive not container
    cJSON *ApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ApplicationsAPIlocalVarJSON);
    cJSON_Delete(ApplicationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ApplicationsAPI_getPermissionsByApplicationAsync(apiClient_t *apiClient, char *tenantId, char *applicationId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Applications/{applicationId}/Permissions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Applications/{applicationId}/Permissions");
    ...
    //nonprimitive not container
    cJSON *ApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    security_permission_dto_list_envelope_t *elementToReturn = security_permission_dto_list_envelope_parseFromJSON(ApplicationsAPIlocalVarJSON);
    cJSON_Delete(ApplicationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ApplicationsAPI_getRolesByApplicationAsync(apiClient_t *apiClient, char *tenantId, char *applicationId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Applications/{applicationId}/Roles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Applications/{applicationId}/Roles");
    ...
    //nonprimitive not container
    cJSON *ApplicationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    security_role_dto_list_envelope_t *elementToReturn = security_role_dto_list_envelope_parseFromJSON(ApplicationsAPIlocalVarJSON);
    cJSON_Delete(ApplicationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ApplicationsAPI_updateBusinessApplicationAsync(apiClient_t *apiClient, char *tenantId, char *applicationId, business_application_update_dto_t *business_application_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_business_application_update_dto = NULL;
    if (business_application_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_business_application_update_dto = business_application_update_dto_convertToJSON(business_application_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_business_application_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_business_application_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_business_application_update_dto);
        localVarSingleItemJSON_business_application_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
