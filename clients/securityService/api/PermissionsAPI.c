...
PermissionsAPI_assignPermissionToBusinessApplicationAsync(apiClient_t *apiClient, char *tenantId, char *securityPermissionId, char *applicationId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Permissions/{securityPermissionId}/Applications/{applicationId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Permissions/{securityPermissionId}/Applications/{applicationId}");


    // Path Params
    long sizeOfPathParams_securityPermissionId = strlen(securityPermissionId)+3 + strlen(applicationId)+3 + strlen("{ securityPermissionId }");
    if(securityPermissionId == NULL) {
        goto end;
    }
    char* localVarToReplace_securityPermissionId = malloc(sizeOfPathParams_securityPermissionId);
    sprintf(localVarToReplace_securityPermissionId, "{%s}", "securityPermissionId");

    localVarPath = strReplace(localVarPath, localVarToReplace_securityPermissionId, securityPermissionId);

    // Path Params
    long sizeOfPathParams_applicationId = strlen(securityPermissionId)+3 + strlen(applicationId)+3 + strlen("{ applicationId }");
    if(applicationId == NULL) {
        goto end;
    }
    char* localVarToReplace_applicationId = malloc(sizeOfPathParams_applicationId);
    sprintf(localVarToReplace_applicationId, "{%s}", "applicationId");

    localVarPath = strReplace(localVarPath, localVarToReplace_applicationId, applicationId);
    ...
    cJSON *PermissionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(PermissionsAPIlocalVarJSON);
    cJSON_Delete(PermissionsAPIlocalVarJSON);
    ...
    free(localVarPath);
    free(localVarToReplace_securityPermissionId);
    free(localVarToReplace_applicationId);
...
PermissionsAPI_assignPermissionToEnrollmentAsync(apiClient_t *apiClient, char *tenantId, char *securityPermissionId, char *enrollmentId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Permissions/{securityPermissionId}/Enrollments/{enrollmentId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Permissions/{securityPermissionId}/Enrollments/{enrollmentId}");


    // Path Params
    long sizeOfPathParams_securityPermissionId = strlen(securityPermissionId)+3 + strlen(enrollmentId)+3 + strlen("{ securityPermissionId }");
    if(securityPermissionId == NULL) {
        goto end;
    }
    char* localVarToReplace_securityPermissionId = malloc(sizeOfPathParams_securityPermissionId);
    ...
    // Path Params
    long sizeOfPathParams_enrollmentId = strlen(securityPermissionId)+3 + strlen(enrollmentId)+3 + strlen("{ enrollmentId }");
...
PermissionsAPI_assignRoleToPermissionAsync(apiClient_t *apiClient, char *tenantId, char *securityPermissionId, char *securityRoleId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Permissions/{securityPermissionId}/Roles/{securityRoleId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Permissions/{securityPermissionId}/Roles/{securityRoleId}");


    // Path Params
    long sizeOfPathParams_securityPermissionId = strlen(securityPermissionId)+3 + strlen(securityRoleId)+3 + strlen("{ securityPermissionId }");
    if(securityPermissionId == NULL) {
        goto end;
    }
    char* localVarToReplace_securityPermissionId = malloc(sizeOfPathParams_securityPermissionId);
    ...
    // Path Params
    long sizeOfPathParams_securityRoleId = strlen(securityPermissionId)+3 + strlen(securityRoleId)+3 + strlen("{ securityRoleId }");
    if(securityRoleId == NULL) {
        goto end;
    }
    char* localVarToReplace_securityRoleId = malloc(sizeOfPathParams_securityRoleId);
    sprintf(localVarToReplace_securityRoleId, "{%s}", "securityRoleId");

    localVarPath = strReplace(localVarPath, localVarToReplace_securityRoleId, securityRoleId);
    ...
    free(localVarPath);
    free(localVarToReplace_securityPermissionId);
    free(localVarToReplace_securityRoleId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
PermissionsAPI_createPermissionAsync(apiClient_t *apiClient, char *tenantId, security_permission_create_dto_t *security_permission_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Permissions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Permissions");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_security_permission_create_dto = NULL;
    if (security_permission_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_security_permission_create_dto = security_permission_create_dto_convertToJSON(security_permission_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_security_permission_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_security_permission_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_security_permission_create_dto);
        localVarSingleItemJSON_security_permission_create_dto = NULL;
    }
...
PermissionsAPI_deletePermissionAsync(apiClient_t *apiClient, char *tenantId, char *securityPermissionId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Permissions/{securityPermissionId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Permissions/{securityPermissionId}");


    // Path Params
    long sizeOfPathParams_securityPermissionId = strlen(securityPermissionId)+3 + strlen("{ securityPermissionId }");
    if(securityPermissionId == NULL) {
        goto end;
    }
    char* localVarToReplace_securityPermissionId = malloc(sizeOfPathParams_securityPermissionId);
...
PermissionsAPI_getApplicationsByPermissionAsync(apiClient_t *apiClient, char *tenantId, char *securityPermissionId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Permissions/{securityPermissionId}/Applications")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Permissions/{securityPermissionId}/Applications");
    ...
    //nonprimitive not container
    cJSON *PermissionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    business_application_simple_dto_list_envelope_t *elementToReturn = business_application_simple_dto_list_envelope_parseFromJSON(PermissionsAPIlocalVarJSON);
    cJSON_Delete(PermissionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
PermissionsAPI_getEnrollmentsByPermissionAsync(apiClient_t *apiClient, char *tenantId, char *securityPermissionId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Permissions/{securityPermissionId}/Enrollments")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Permissions/{securityPermissionId}/Enrollments");
    ...
    //nonprimitive not container
    cJSON *PermissionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_enrollment_dto_list_envelope_t *elementToReturn = tenant_enrollment_dto_list_envelope_parseFromJSON(PermissionsAPIlocalVarJSON);
    cJSON_Delete(PermissionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
PermissionsAPI_getPermissionAsync(apiClient_t *apiClient, char *tenantId, char *securityPermissionId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *PermissionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    security_permission_dto_envelope_t *elementToReturn = security_permission_dto_envelope_parseFromJSON(PermissionsAPIlocalVarJSON);
    cJSON_Delete(PermissionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
PermissionsAPI_getPermissionsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, security_permission_dto_collection_query_parameters_t *security_permission_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_security_permission_dto_collection_query_parameters = NULL;
    if (security_permission_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_security_permission_dto_collection_query_parameters = security_permission_dto_collection_query_parameters_convertToJSON(security_permission_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_security_permission_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *PermissionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    security_permission_dto_list_envelope_t *elementToReturn = security_permission_dto_list_envelope_parseFromJSON(PermissionsAPIlocalVarJSON);
    cJSON_Delete(PermissionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_security_permission_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_security_permission_dto_collection_query_parameters);
        localVarSingleItemJSON_security_permission_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
PermissionsAPI_getPermissionsByEnrollmentAsync(apiClient_t *apiClient, char *tenantId, char *enrollmentId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Permissions/ByEnrollment/{enrollmentId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Permissions/ByEnrollment/{enrollmentId}");


    // Path Params
    long sizeOfPathParams_enrollmentId = strlen(enrollmentId)+3 + strlen("{ enrollmentId }");
    if(enrollmentId == NULL) {
        goto end;
    }
    char* localVarToReplace_enrollmentId = malloc(sizeOfPathParams_enrollmentId);
...
PermissionsAPI_getPermissionsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, security_permission_dto_collection_query_parameters_t *security_permission_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Permissions/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Permissions/Count");
    ...
    //nonprimitive not container
    cJSON *PermissionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(PermissionsAPIlocalVarJSON);
    cJSON_Delete(PermissionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
PermissionsAPI_getRolesByPermissionAsync(apiClient_t *apiClient, char *tenantId, char *securityPermissionId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Permissions/{securityPermissionId}/Roles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Permissions/{securityPermissionId}/Roles");
    ...
    //nonprimitive not container
    cJSON *PermissionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    security_role_dto_list_envelope_t *elementToReturn = security_role_dto_list_envelope_parseFromJSON(PermissionsAPIlocalVarJSON);
    cJSON_Delete(PermissionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
PermissionsAPI_updatePermissionAsync(apiClient_t *apiClient, char *tenantId, char *securityPermissionId, security_permission_update_dto_t *security_permission_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_security_permission_update_dto = NULL;
    if (security_permission_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_security_permission_update_dto = security_permission_update_dto_convertToJSON(security_permission_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_security_permission_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_security_permission_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_security_permission_update_dto);
        localVarSingleItemJSON_security_permission_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
