...
WebhooksAPI_getWebhookRequestsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, webhook_request_dto_collection_query_parameters_t *webhook_request_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Webhooks")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Webhooks");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_webhook_request_dto_collection_query_parameters = NULL;
    if (webhook_request_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_webhook_request_dto_collection_query_parameters = webhook_request_dto_collection_query_parameters_convertToJSON(webhook_request_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_webhook_request_dto_collection_query_parameters);
    }
    ...
    webhook_request_dto_list_envelope_t *elementToReturn = webhook_request_dto_list_envelope_parseFromJSON(WebhooksAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_webhook_request_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_webhook_request_dto_collection_query_parameters);
        localVarSingleItemJSON_webhook_request_dto_collection_query_parameters = NULL;
    }
...
WebhooksAPI_getWebhookRequestsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, webhook_request_dto_collection_query_parameters_t *webhook_request_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Webhooks/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Webhooks/Count");
    ...
    //nonprimitive not container
    cJSON *WebhooksAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(WebhooksAPIlocalVarJSON);
    cJSON_Delete(WebhooksAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
