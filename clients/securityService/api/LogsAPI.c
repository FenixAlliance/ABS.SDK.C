...
LogsAPI_getLogsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Logs")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Logs");
    ...
    cJSON *LogsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    log_dto_list_envelope_t *elementToReturn = log_dto_list_envelope_parseFromJSON(LogsAPIlocalVarJSON);
    cJSON_Delete(LogsAPIlocalVarJSON);
...
LogsAPI_getLogsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/SecurityService/Logs/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/SecurityService/Logs/Count");
    ...
    //nonprimitive not container
    cJSON *LogsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(LogsAPIlocalVarJSON);
    cJSON_Delete(LogsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
