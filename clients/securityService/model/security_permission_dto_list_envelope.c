...
security_permission_dto_list_envelope_t *security_permission_dto_list_envelope_create(
    ...
    security_permission_dto_list_envelope_local_var->http_status = http_status;
    security_permission_dto_list_envelope_local_var->error_code = error_code;
    security_permission_dto_list_envelope_local_var->validation_details = validation_details;
...
void security_permission_dto_list_envelope_free(security_permission_dto_list_envelope_t *security_permission_dto_list_envelope) {
    ...
    if (security_permission_dto_list_envelope->error_code) {
        free(security_permission_dto_list_envelope->error_code);
        security_permission_dto_list_envelope->error_code = NULL;
    }
    if (security_permission_dto_list_envelope->validation_details) {
        list_ForEach(listEntry, security_permission_dto_list_envelope->validation_details) {
            keyValuePair_t *localKeyValue = (keyValuePair_t*) listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_freeList(security_permission_dto_list_envelope->validation_details);
        security_permission_dto_list_envelope->validation_details = NULL;
    }
...
cJSON *security_permission_dto_list_envelope_convertToJSON(security_permission_dto_list_envelope_t *security_permission_dto_list_envelope) {
    ...
    // security_permission_dto_list_envelope->http_status
    if(security_permission_dto_list_envelope->http_status) {
    if(cJSON_AddNumberToObject(item, "httpStatus", security_permission_dto_list_envelope->http_status) == NULL) {
    goto fail; //Numeric
    }
    }


    // security_permission_dto_list_envelope->error_code
    if(security_permission_dto_list_envelope->error_code) {
    if(cJSON_AddStringToObject(item, "errorCode", security_permission_dto_list_envelope->error_code) == NULL) {
    goto fail; //String
    }
    }


    // security_permission_dto_list_envelope->validation_details
    if(security_permission_dto_list_envelope->validation_details) {
    ...
    if (security_permission_dto_list_envelope->validation_details) {
    list_ForEach(validation_detailsListEntry, security_permission_dto_list_envelope->validation_details) {
...
security_permission_dto_list_envelope_t *security_permission_dto_list_envelope_parseFromJSON(cJSON *security_permission_dto_list_envelopeJSON){
    ...
    // define the local map for security_permission_dto_list_envelope->validation_details
    ...
    // security_permission_dto_list_envelope->http_status
    cJSON *http_status = cJSON_GetObjectItemCaseSensitive(security_permission_dto_list_envelopeJSON, "httpStatus");
    if (http_status) { 
    ...
    // security_permission_dto_list_envelope->error_code
    cJSON *error_code = cJSON_GetObjectItemCaseSensitive(security_permission_dto_list_envelopeJSON, "errorCode");
    if (error_code) { 
    ...
    // security_permission_dto_list_envelope->validation_details
    cJSON *validation_details = cJSON_GetObjectItemCaseSensitive(security_permission_dto_list_envelopeJSON, "validationDetails");
