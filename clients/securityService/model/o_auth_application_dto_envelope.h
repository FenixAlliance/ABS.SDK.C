/*
 * o_auth_application_dto_envelope.h
 *
 * 
 */

#ifndef _o_auth_application_dto_envelope_H_
#define _o_auth_application_dto_envelope_H_
...
typedef struct o_auth_application_dto_envelope_t o_auth_application_dto_envelope_t;

#include "o_auth_application_dto.h"



typedef struct o_auth_application_dto_envelope_t {
    int is_success; //boolean
    char *error_message; // string
    char *correlation_id; // string
    char *timestamp; //date time
    char *activity_id; // string
    struct o_auth_application_dto_t *result; //model
...
#endif /* _o_auth_application_dto_envelope_H_ */
