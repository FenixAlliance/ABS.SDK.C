...
typedef enum  { securityservice_application_principal_dto_PRINCIPALKIND_NULL = 0, securityservice_application_principal_dto_PRINCIPALKIND_Human, securityservice_application_principal_dto_PRINCIPALKIND_Agent, securityservice_application_principal_dto_PRINCIPALKIND_Application, securityservice_application_principal_dto_PRINCIPALKIND_Service, securityservice_application_principal_dto_PRINCIPALKIND_System } securityservice_application_principal_dto_PRINCIPALKIND_e;
...
typedef enum  { securityservice_application_principal_dto_PRINCIPALSTATUS_NULL = 0, securityservice_application_principal_dto_PRINCIPALSTATUS_Active, securityservice_application_principal_dto_PRINCIPALSTATUS_Suspended, securityservice_application_principal_dto_PRINCIPALSTATUS_Disabled } securityservice_application_principal_dto_PRINCIPALSTATUS_e;
...
typedef struct application_principal_dto_t {
    ...
    securityservice_application_principal_dto_PRINCIPALKIND_e principal_kind; //enum
    securityservice_application_principal_dto_PRINCIPALSTATUS_e principal_status; //enum
