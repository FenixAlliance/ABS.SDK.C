...
business_security_log_dto_list_envelope_t *business_security_log_dto_list_envelope_create(
    ...
    business_security_log_dto_list_envelope_local_var->http_status = http_status;
    business_security_log_dto_list_envelope_local_var->error_code = error_code;
    business_security_log_dto_list_envelope_local_var->validation_details = validation_details;
...
void business_security_log_dto_list_envelope_free(business_security_log_dto_list_envelope_t *business_security_log_dto_list_envelope) {
    ...
    if (business_security_log_dto_list_envelope->error_code) {
        free(business_security_log_dto_list_envelope->error_code);
        business_security_log_dto_list_envelope->error_code = NULL;
    }
    if (business_security_log_dto_list_envelope->validation_details) {
        list_ForEach(listEntry, business_security_log_dto_list_envelope->validation_details) {
            keyValuePair_t *localKeyValue = (keyValuePair_t*) listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_freeList(business_security_log_dto_list_envelope->validation_details);
        business_security_log_dto_list_envelope->validation_details = NULL;
    }
...
cJSON *business_security_log_dto_list_envelope_convertToJSON(business_security_log_dto_list_envelope_t *business_security_log_dto_list_envelope) {
    ...
    // business_security_log_dto_list_envelope->http_status
    if(business_security_log_dto_list_envelope->http_status) {
    if(cJSON_AddNumberToObject(item, "httpStatus", business_security_log_dto_list_envelope->http_status) == NULL) {
    goto fail; //Numeric
    }
    }


    // business_security_log_dto_list_envelope->error_code
    if(business_security_log_dto_list_envelope->error_code) {
    if(cJSON_AddStringToObject(item, "errorCode", business_security_log_dto_list_envelope->error_code) == NULL) {
    goto fail; //String
    }
    }


    // business_security_log_dto_list_envelope->validation_details
    if(business_security_log_dto_list_envelope->validation_details) {
    ...
    if (business_security_log_dto_list_envelope->validation_details) {
    list_ForEach(validation_detailsListEntry, business_security_log_dto_list_envelope->validation_details) {
...
business_security_log_dto_list_envelope_t *business_security_log_dto_list_envelope_parseFromJSON(cJSON *business_security_log_dto_list_envelopeJSON){
    ...
    // define the local map for business_security_log_dto_list_envelope->validation_details
    ...
    // business_security_log_dto_list_envelope->http_status
    cJSON *http_status = cJSON_GetObjectItemCaseSensitive(business_security_log_dto_list_envelopeJSON, "httpStatus");
    if (http_status) { 
    ...
    // business_security_log_dto_list_envelope->error_code
    cJSON *error_code = cJSON_GetObjectItemCaseSensitive(business_security_log_dto_list_envelopeJSON, "errorCode");
    if (error_code) { 
    ...
    // business_security_log_dto_list_envelope->validation_details
    cJSON *validation_details = cJSON_GetObjectItemCaseSensitive(business_security_log_dto_list_envelopeJSON, "validationDetails");
