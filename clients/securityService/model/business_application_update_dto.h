/*
 * business_application_update_dto.h
 *
 * 
 */

#ifndef _business_application_update_dto_H_
#define _business_application_update_dto_H_
...
typedef struct business_application_update_dto_t business_application_update_dto_t;




typedef struct business_application_update_dto_t {
    char *name; // string
    ...
    int marked_for_publish; //boolean

} business_application_update_dto_t;
...
#endif /* _business_application_update_dto_H_ */
