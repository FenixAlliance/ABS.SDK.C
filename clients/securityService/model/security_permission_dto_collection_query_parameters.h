/*
 * security_permission_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _security_permission_dto_collection_query_parameters_H_
#define _security_permission_dto_collection_query_parameters_H_
...
typedef struct security_permission_dto_collection_query_parameters_t security_permission_dto_collection_query_parameters_t;




typedef struct security_permission_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} security_permission_dto_collection_query_parameters_t;
...
#endif /* _security_permission_dto_collection_query_parameters_H_ */
