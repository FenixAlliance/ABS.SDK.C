...
cJSON *application_principal_detail_dto_convertToJSON(application_principal_detail_dto_t *application_principal_detail_dto) {
    ...
    if(application_principal_detail_dto->principal_kind != securityservice_application_principal_detail_dto_PRINCIPALKIND_NULL) {
    ...
    if(application_principal_detail_dto->principal_status != securityservice_application_principal_detail_dto_PRINCIPALSTATUS_NULL) {
...
application_principal_detail_dto_t *application_principal_detail_dto_parseFromJSON(cJSON *application_principal_detail_dtoJSON){
    ...
    securityservice_application_principal_detail_dto_PRINCIPALKIND_e principal_kindVariable;
    if (principal_kind) { 
    ...
    securityservice_application_principal_detail_dto_PRINCIPALSTATUS_e principal_statusVariable;
    if (principal_status) { 
    ...
    application_principal_detail_dto_local_var = application_principal_detail_dto_create (
        ...
        principal_kind ? principal_kindVariable : securityservice_application_principal_detail_dto_PRINCIPALKIND_NULL,
        principal_status ? principal_statusVariable : securityservice_application_principal_detail_dto_PRINCIPALSTATUS_NULL,
