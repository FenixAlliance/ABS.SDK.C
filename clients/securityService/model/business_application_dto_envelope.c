...
business_application_dto_envelope_t *business_application_dto_envelope_create(
    ...
    business_application_dto_envelope_local_var->http_status = http_status;
    business_application_dto_envelope_local_var->error_code = error_code;
    business_application_dto_envelope_local_var->validation_details = validation_details;
...
void business_application_dto_envelope_free(business_application_dto_envelope_t *business_application_dto_envelope) {
    ...
    if (business_application_dto_envelope->error_code) {
        free(business_application_dto_envelope->error_code);
        business_application_dto_envelope->error_code = NULL;
    }
    if (business_application_dto_envelope->validation_details) {
        list_ForEach(listEntry, business_application_dto_envelope->validation_details) {
            keyValuePair_t *localKeyValue = (keyValuePair_t*) listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_freeList(business_application_dto_envelope->validation_details);
        business_application_dto_envelope->validation_details = NULL;
    }
...
cJSON *business_application_dto_envelope_convertToJSON(business_application_dto_envelope_t *business_application_dto_envelope) {
    ...
    // business_application_dto_envelope->http_status
    if(business_application_dto_envelope->http_status) {
    if(cJSON_AddNumberToObject(item, "httpStatus", business_application_dto_envelope->http_status) == NULL) {
    goto fail; //Numeric
    }
    }


    // business_application_dto_envelope->error_code
    if(business_application_dto_envelope->error_code) {
    if(cJSON_AddStringToObject(item, "errorCode", business_application_dto_envelope->error_code) == NULL) {
    goto fail; //String
    }
    }


    // business_application_dto_envelope->validation_details
    if(business_application_dto_envelope->validation_details) {
    ...
    if (business_application_dto_envelope->validation_details) {
    list_ForEach(validation_detailsListEntry, business_application_dto_envelope->validation_details) {
...
business_application_dto_envelope_t *business_application_dto_envelope_parseFromJSON(cJSON *business_application_dto_envelopeJSON){
    ...
    // define the local map for business_application_dto_envelope->validation_details
    ...
    // business_application_dto_envelope->http_status
    cJSON *http_status = cJSON_GetObjectItemCaseSensitive(business_application_dto_envelopeJSON, "httpStatus");
    if (http_status) { 
    ...
    // business_application_dto_envelope->error_code
    cJSON *error_code = cJSON_GetObjectItemCaseSensitive(business_application_dto_envelopeJSON, "errorCode");
    if (error_code) { 
    ...
    // business_application_dto_envelope->validation_details
    cJSON *validation_details = cJSON_GetObjectItemCaseSensitive(business_application_dto_envelopeJSON, "validationDetails");
