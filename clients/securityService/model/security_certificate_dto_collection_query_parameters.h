/*
 * security_certificate_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _security_certificate_dto_collection_query_parameters_H_
#define _security_certificate_dto_collection_query_parameters_H_
...
typedef struct security_certificate_dto_collection_query_parameters_t security_certificate_dto_collection_query_parameters_t;




typedef struct security_certificate_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} security_certificate_dto_collection_query_parameters_t;
...
#endif /* _security_certificate_dto_collection_query_parameters_H_ */
