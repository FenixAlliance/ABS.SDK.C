/*
 * business_security_log_dto_list_envelope.h
 *
 * 
 */

#ifndef _business_security_log_dto_list_envelope_H_
#define _business_security_log_dto_list_envelope_H_
...
typedef struct business_security_log_dto_list_envelope_t business_security_log_dto_list_envelope_t;

#include "business_security_log_dto.h"



typedef struct business_security_log_dto_list_envelope_t {
...
#endif /* _business_security_log_dto_list_envelope_H_ */
