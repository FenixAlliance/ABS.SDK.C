/*
 * business_application_dto_envelope.h
 *
 * 
 */

#ifndef _business_application_dto_envelope_H_
#define _business_application_dto_envelope_H_
...
typedef struct business_application_dto_envelope_t business_application_dto_envelope_t;

#include "business_application_dto.h"



typedef struct business_application_dto_envelope_t {
    int is_success; //boolean
    char *error_message; // string
    char *correlation_id; // string
    char *timestamp; //date time
    char *activity_id; // string
    struct business_application_dto_t *result; //model
...
#endif /* _business_application_dto_envelope_H_ */
