/*
 * security_permission_dto_list_envelope.h
 *
 * 
 */

#ifndef _security_permission_dto_list_envelope_H_
#define _security_permission_dto_list_envelope_H_
...
typedef struct security_permission_dto_list_envelope_t security_permission_dto_list_envelope_t;

#include "security_permission_dto.h"



typedef struct security_permission_dto_list_envelope_t {
...
#endif /* _security_permission_dto_list_envelope_H_ */
