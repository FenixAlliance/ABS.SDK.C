...
BudgetsAPI_createBudgetAccountEntryAsync(apiClient_t *apiClient, char *tenantId, char *budgetId, budget_account_entry_create_dto_t *budget_account_entry_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Budgets/{budgetId}/AccountEntries")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Budgets/{budgetId}/AccountEntries");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_budget_account_entry_create_dto = NULL;
    if (budget_account_entry_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_budget_account_entry_create_dto = budget_account_entry_create_dto_convertToJSON(budget_account_entry_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_budget_account_entry_create_dto);
    }
    ...
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(BudgetsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_budget_account_entry_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_budget_account_entry_create_dto);
        localVarSingleItemJSON_budget_account_entry_create_dto = NULL;
    }
...
BudgetsAPI_createBudgetAsync(apiClient_t *apiClient, char *tenantId, budget_create_dto_t *budget_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Budgets")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Budgets");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_budget_create_dto = NULL;
    if (budget_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_budget_create_dto = budget_create_dto_convertToJSON(budget_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_budget_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_budget_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_budget_create_dto);
        localVarSingleItemJSON_budget_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
BudgetsAPI_deleteBudgetAccountEntryAsync(apiClient_t *apiClient, char *tenantId, char *budgetId, char *entryId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Budgets/{budgetId}/AccountEntries/{entryId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Budgets/{budgetId}/AccountEntries/{entryId}");


    // Path Params
    long sizeOfPathParams_budgetId = strlen(budgetId)+3 + strlen(entryId)+3 + strlen("{ budgetId }");
    if(budgetId == NULL) {
        goto end;
    }
    char* localVarToReplace_budgetId = malloc(sizeOfPathParams_budgetId);
    ...
    // Path Params
    long sizeOfPathParams_entryId = strlen(budgetId)+3 + strlen(entryId)+3 + strlen("{ entryId }");
    if(entryId == NULL) {
        goto end;
    }
...
BudgetsAPI_deleteBudgetAsync(apiClient_t *apiClient, char *tenantId, char *budgetId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Budgets/{budgetId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Budgets/{budgetId}");
...
BudgetsAPI_getBudgetAccountEntriesCollectionAsync(apiClient_t *apiClient, char *tenantId, char *budgetId, char *api_version, char *x_api_version, budget_account_entry_dto_collection_query_parameters_t *budget_account_entry_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_budget_account_entry_dto_collection_query_parameters = NULL;
    if (budget_account_entry_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_budget_account_entry_dto_collection_query_parameters = budget_account_entry_dto_collection_query_parameters_convertToJSON(budget_account_entry_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_budget_account_entry_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *BudgetsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    budget_account_entry_dto_i_read_only_list_envelope_t *elementToReturn = budget_account_entry_dto_i_read_only_list_envelope_parseFromJSON(BudgetsAPIlocalVarJSON);
    cJSON_Delete(BudgetsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_budget_account_entry_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_budget_account_entry_dto_collection_query_parameters);
        localVarSingleItemJSON_budget_account_entry_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
BudgetsAPI_getBudgetAccountEntryAsync(apiClient_t *apiClient, char *tenantId, char *budgetId, char *entryId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *BudgetsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    budget_account_entry_dto_envelope_t *elementToReturn = budget_account_entry_dto_envelope_parseFromJSON(BudgetsAPIlocalVarJSON);
    cJSON_Delete(BudgetsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BudgetsAPI_getBudgetDetailsAsync(apiClient_t *apiClient, char *tenantId, char *budgetId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *BudgetsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    budget_dto_envelope_t *elementToReturn = budget_dto_envelope_parseFromJSON(BudgetsAPIlocalVarJSON);
    cJSON_Delete(BudgetsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BudgetsAPI_getBudgetsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, budget_dto_collection_query_parameters_t *budget_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_budget_dto_collection_query_parameters = NULL;
    if (budget_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_budget_dto_collection_query_parameters = budget_dto_collection_query_parameters_convertToJSON(budget_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_budget_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *BudgetsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    budget_dto_i_read_only_list_envelope_t *elementToReturn = budget_dto_i_read_only_list_envelope_parseFromJSON(BudgetsAPIlocalVarJSON);
    cJSON_Delete(BudgetsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_budget_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_budget_dto_collection_query_parameters);
        localVarSingleItemJSON_budget_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
BudgetsAPI_getBudgetsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, budget_dto_collection_query_parameters_t *budget_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Budgets/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Budgets/Count");
    ...
    //nonprimitive not container
    cJSON *BudgetsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(BudgetsAPIlocalVarJSON);
    cJSON_Delete(BudgetsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BudgetsAPI_updateBudgetAccountEntryAsync(apiClient_t *apiClient, char *tenantId, char *budgetId, char *entryId, budget_account_entry_update_dto_t *budget_account_entry_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_budget_account_entry_update_dto = NULL;
    if (budget_account_entry_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_budget_account_entry_update_dto = budget_account_entry_update_dto_convertToJSON(budget_account_entry_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_budget_account_entry_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_budget_account_entry_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_budget_account_entry_update_dto);
        localVarSingleItemJSON_budget_account_entry_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
BudgetsAPI_updateBudgetAsync(apiClient_t *apiClient, char *tenantId, char *budgetId, budget_update_dto_t *budget_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_budget_update_dto = NULL;
    if (budget_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_budget_update_dto = budget_update_dto_convertToJSON(budget_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_budget_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_budget_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_budget_update_dto);
        localVarSingleItemJSON_budget_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
