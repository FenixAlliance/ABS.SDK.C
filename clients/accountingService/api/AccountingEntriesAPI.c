...
#include <stdio.h>
#include <ctype.h>
#include "AccountingEntriesAPI.h"
...
AccountingEntriesAPI_getCreditsSumAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/AccountingEntries/Credits/Sum")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/AccountingEntries/Credits/Sum");
    ...
    cJSON *AccountingEntriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    decimal_envelope_t *elementToReturn = decimal_envelope_parseFromJSON(AccountingEntriesAPIlocalVarJSON);
    cJSON_Delete(AccountingEntriesAPIlocalVarJSON);
...
AccountingEntriesAPI_getDebitsSumAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/AccountingEntries/Debits/Sum")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/AccountingEntries/Debits/Sum");
