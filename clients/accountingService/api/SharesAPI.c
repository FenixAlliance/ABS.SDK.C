...
SharesAPI_createShareClass(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, share_class_create_dto_t *share_class_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Shares/Classes")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Shares/Classes");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_share_class_create_dto = NULL;
    if (share_class_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_share_class_create_dto = share_class_create_dto_convertToJSON(share_class_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_share_class_create_dto);
    }
    ...
    cJSON *SharesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    share_class_dto_envelope_t *elementToReturn = share_class_dto_envelope_parseFromJSON(SharesAPIlocalVarJSON);
    cJSON_Delete(SharesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_share_class_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_share_class_create_dto);
        localVarSingleItemJSON_share_class_create_dto = NULL;
    }
...
SharesAPI_createShareIssuance(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, share_issuance_create_dto_t *share_issuance_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Shares/Issuances")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Shares/Issuances");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_share_issuance_create_dto = NULL;
    if (share_issuance_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_share_issuance_create_dto = share_issuance_create_dto_convertToJSON(share_issuance_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_share_issuance_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *SharesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    share_issuance_dto_envelope_t *elementToReturn = share_issuance_dto_envelope_parseFromJSON(SharesAPIlocalVarJSON);
    cJSON_Delete(SharesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_share_issuance_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_share_issuance_create_dto);
        localVarSingleItemJSON_share_issuance_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SharesAPI_createShareTransfer(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, share_transfer_create_dto_t *share_transfer_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Shares/Transfers")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Shares/Transfers");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_share_transfer_create_dto = NULL;
    if (share_transfer_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_share_transfer_create_dto = share_transfer_create_dto_convertToJSON(share_transfer_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_share_transfer_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *SharesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    share_transfer_dto_envelope_t *elementToReturn = share_transfer_dto_envelope_parseFromJSON(SharesAPIlocalVarJSON);
    cJSON_Delete(SharesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_share_transfer_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_share_transfer_create_dto);
        localVarSingleItemJSON_share_transfer_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SharesAPI_createShareTransferReason(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, share_transfer_reason_create_dto_t *share_transfer_reason_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Shares/TransferReasons")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Shares/TransferReasons");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_share_transfer_reason_create_dto = NULL;
    if (share_transfer_reason_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_share_transfer_reason_create_dto = share_transfer_reason_create_dto_convertToJSON(share_transfer_reason_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_share_transfer_reason_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *SharesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    share_transfer_reason_dto_envelope_t *elementToReturn = share_transfer_reason_dto_envelope_parseFromJSON(SharesAPIlocalVarJSON);
    cJSON_Delete(SharesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_share_transfer_reason_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_share_transfer_reason_create_dto);
        localVarSingleItemJSON_share_transfer_reason_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SharesAPI_deleteShareClass(apiClient_t *apiClient, char *tenantId, char *shareClassId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Shares/Classes/{shareClassId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Shares/Classes/{shareClassId}");


    // Path Params
    long sizeOfPathParams_shareClassId = strlen(shareClassId)+3 + strlen("{ shareClassId }");
    if(shareClassId == NULL) {
        goto end;
    }
    char* localVarToReplace_shareClassId = malloc(sizeOfPathParams_shareClassId);
    sprintf(localVarToReplace_shareClassId, "{%s}", "shareClassId");

    localVarPath = strReplace(localVarPath, localVarToReplace_shareClassId, shareClassId);
    if(shareClassId == NULL) {
        goto end;
    }
    char* localVarToReplace_shareClassId = malloc(sizeOfPathParams_shareClassId);
    ...
    free(localVarPath);
    free(localVarToReplace_shareClassId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
SharesAPI_deleteShareIssuance(apiClient_t *apiClient, char *tenantId, char *issuanceId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Shares/Issuances/{issuanceId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Shares/Issuances/{issuanceId}");


    // Path Params
    long sizeOfPathParams_issuanceId = strlen(issuanceId)+3 + strlen("{ issuanceId }");
    if(issuanceId == NULL) {
        goto end;
    }
    char* localVarToReplace_issuanceId = malloc(sizeOfPathParams_issuanceId);
    sprintf(localVarToReplace_issuanceId, "{%s}", "issuanceId");

    localVarPath = strReplace(localVarPath, localVarToReplace_issuanceId, issuanceId);
    if(issuanceId == NULL) {
        goto end;
    }
    char* localVarToReplace_issuanceId = malloc(sizeOfPathParams_issuanceId);
    ...
    free(localVarPath);
    free(localVarToReplace_issuanceId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
SharesAPI_deleteShareTransfer(apiClient_t *apiClient, char *tenantId, char *transferId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Shares/Transfers/{transferId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Shares/Transfers/{transferId}");
...
SharesAPI_deleteShareTransferReason(apiClient_t *apiClient, char *tenantId, char *reasonId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Shares/TransferReasons/{reasonId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Shares/TransferReasons/{reasonId}");


    // Path Params
    long sizeOfPathParams_reasonId = strlen(reasonId)+3 + strlen("{ reasonId }");
    if(reasonId == NULL) {
        goto end;
    }
    char* localVarToReplace_reasonId = malloc(sizeOfPathParams_reasonId);
    sprintf(localVarToReplace_reasonId, "{%s}", "reasonId");

    localVarPath = strReplace(localVarPath, localVarToReplace_reasonId, reasonId);
    if(reasonId == NULL) {
        goto end;
    }
    char* localVarToReplace_reasonId = malloc(sizeOfPathParams_reasonId);
    ...
    free(localVarPath);
    free(localVarToReplace_reasonId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
SharesAPI_getShareClasses(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, share_class_dto_collection_query_parameters_t *share_class_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *SharesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    share_class_dto_list_envelope_t *elementToReturn = share_class_dto_list_envelope_parseFromJSON(SharesAPIlocalVarJSON);
    cJSON_Delete(SharesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SharesAPI_getShareClassesCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, share_class_dto_collection_query_parameters_t *share_class_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Shares/Classes/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Shares/Classes/Count");
    ...
    //nonprimitive not container
    cJSON *SharesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SharesAPIlocalVarJSON);
    cJSON_Delete(SharesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SharesAPI_getShareIssuances(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, share_issuance_dto_collection_query_parameters_t *share_issuance_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *SharesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    share_issuance_dto_list_envelope_t *elementToReturn = share_issuance_dto_list_envelope_parseFromJSON(SharesAPIlocalVarJSON);
    cJSON_Delete(SharesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SharesAPI_getShareIssuancesCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, share_issuance_dto_collection_query_parameters_t *share_issuance_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Shares/Issuances/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Shares/Issuances/Count");
...
SharesAPI_getShareIssuancesSum(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, share_issuance_dto_collection_query_parameters_t *share_issuance_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Shares/Issuances/Sum")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Shares/Issuances/Sum");
    ...
    //nonprimitive not container
    cJSON *SharesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    decimal_envelope_t *elementToReturn = decimal_envelope_parseFromJSON(SharesAPIlocalVarJSON);
    cJSON_Delete(SharesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SharesAPI_getShareTransferReasons(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, share_transfer_reason_dto_collection_query_parameters_t *share_transfer_reason_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *SharesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    share_transfer_reason_dto_list_envelope_t *elementToReturn = share_transfer_reason_dto_list_envelope_parseFromJSON(SharesAPIlocalVarJSON);
    cJSON_Delete(SharesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SharesAPI_getShareTransferReasonsCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, share_transfer_reason_dto_collection_query_parameters_t *share_transfer_reason_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Shares/TransferReasons/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Shares/TransferReasons/Count");
...
SharesAPI_getShareTransfers(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, share_transfer_dto_collection_query_parameters_t *share_transfer_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *SharesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    share_transfer_dto_list_envelope_t *elementToReturn = share_transfer_dto_list_envelope_parseFromJSON(SharesAPIlocalVarJSON);
    cJSON_Delete(SharesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SharesAPI_getShareTransfersCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, share_transfer_dto_collection_query_parameters_t *share_transfer_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Shares/Transfers/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Shares/Transfers/Count");
...
SharesAPI_patchShareClass(apiClient_t *apiClient, char *tenantId, char *shareClassId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *SharesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SharesAPIlocalVarJSON);
    cJSON_Delete(SharesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SharesAPI_updateShareClass(apiClient_t *apiClient, char *tenantId, char *shareClassId, char *api_version, char *x_api_version, share_class_update_dto_t *share_class_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_share_class_update_dto = NULL;
    if (share_class_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_share_class_update_dto = share_class_update_dto_convertToJSON(share_class_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_share_class_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_share_class_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_share_class_update_dto);
        localVarSingleItemJSON_share_class_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SharesAPI_updateShareIssuance(apiClient_t *apiClient, char *tenantId, char *issuanceId, char *api_version, char *x_api_version, share_issuance_update_dto_t *share_issuance_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_share_issuance_update_dto = NULL;
    if (share_issuance_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_share_issuance_update_dto = share_issuance_update_dto_convertToJSON(share_issuance_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_share_issuance_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_share_issuance_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_share_issuance_update_dto);
        localVarSingleItemJSON_share_issuance_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SharesAPI_updateShareTransfer(apiClient_t *apiClient, char *tenantId, char *transferId, char *api_version, char *x_api_version, share_transfer_update_dto_t *share_transfer_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_share_transfer_update_dto = NULL;
    if (share_transfer_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_share_transfer_update_dto = share_transfer_update_dto_convertToJSON(share_transfer_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_share_transfer_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_share_transfer_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_share_transfer_update_dto);
        localVarSingleItemJSON_share_transfer_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SharesAPI_updateShareTransferReason(apiClient_t *apiClient, char *tenantId, char *reasonId, char *api_version, char *x_api_version, share_transfer_reason_update_dto_t *share_transfer_reason_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_share_transfer_reason_update_dto = NULL;
    if (share_transfer_reason_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_share_transfer_reason_update_dto = share_transfer_reason_update_dto_convertToJSON(share_transfer_reason_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_share_transfer_reason_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_share_transfer_reason_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_share_transfer_reason_update_dto);
        localVarSingleItemJSON_share_transfer_reason_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
