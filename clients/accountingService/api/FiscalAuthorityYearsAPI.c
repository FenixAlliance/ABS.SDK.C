...
#include <stdio.h>
#include <ctype.h>
#include "FiscalAuthorityYearsAPI.h"
...
FiscalAuthorityYearsAPI_createFiscalYear(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, fiscal_year_create_dto_t *fiscal_year_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Fiscals/Authorities/FiscalYears")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Fiscals/Authorities/FiscalYears");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_fiscal_year_create_dto = NULL;
    if (fiscal_year_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_fiscal_year_create_dto = fiscal_year_create_dto_convertToJSON(fiscal_year_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_fiscal_year_create_dto);
    }
    ...
    cJSON *FiscalAuthorityYearsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(FiscalAuthorityYearsAPIlocalVarJSON);
    cJSON_Delete(FiscalAuthorityYearsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_fiscal_year_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_fiscal_year_create_dto);
        localVarSingleItemJSON_fiscal_year_create_dto = NULL;
    }
...
FiscalAuthorityYearsAPI_deleteFiscalYear(apiClient_t *apiClient, char *tenantId, char *fiscalYearId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Fiscals/Authorities/FiscalYears/{fiscalYearId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Fiscals/Authorities/FiscalYears/{fiscalYearId}");


    // Path Params
    long sizeOfPathParams_fiscalYearId = strlen(fiscalYearId)+3 + strlen("{ fiscalYearId }");
...
FiscalAuthorityYearsAPI_getFiscalYear(apiClient_t *apiClient, char *tenantId, char *fiscalAuthorityId, char *fiscalYearId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Fiscals/Authorities/{fiscalAuthorityId}/FiscalYears/{fiscalYearId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Fiscals/Authorities/{fiscalAuthorityId}/FiscalYears/{fiscalYearId}");
    ...
    //nonprimitive not container
    cJSON *FiscalAuthorityYearsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    fiscal_year_dto_envelope_t *elementToReturn = fiscal_year_dto_envelope_parseFromJSON(FiscalAuthorityYearsAPIlocalVarJSON);
    cJSON_Delete(FiscalAuthorityYearsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FiscalAuthorityYearsAPI_getFiscalYears(apiClient_t *apiClient, char *tenantId, char *fiscalAuthorityId, char *authorityId, char *api_version, char *x_api_version, fiscal_year_dto_collection_query_parameters_t *fiscal_year_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Fiscals/Authorities/{authorityId}/FiscalYears")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Fiscals/Authorities/{authorityId}/FiscalYears");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_fiscal_year_dto_collection_query_parameters = NULL;
    if (fiscal_year_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_fiscal_year_dto_collection_query_parameters = fiscal_year_dto_collection_query_parameters_convertToJSON(fiscal_year_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_fiscal_year_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *FiscalAuthorityYearsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    fiscal_year_dto_list_envelope_t *elementToReturn = fiscal_year_dto_list_envelope_parseFromJSON(FiscalAuthorityYearsAPIlocalVarJSON);
    cJSON_Delete(FiscalAuthorityYearsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_fiscal_year_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_fiscal_year_dto_collection_query_parameters);
        localVarSingleItemJSON_fiscal_year_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
FiscalAuthorityYearsAPI_getFiscalYearsCount(apiClient_t *apiClient, char *tenantId, char *fiscalAuthorityId, char *api_version, char *x_api_version, fiscal_year_dto_collection_query_parameters_t *fiscal_year_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Fiscals/Authorities/{fiscalAuthorityId}/FiscalYears/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Fiscals/Authorities/{fiscalAuthorityId}/FiscalYears/Count");
    ...
    //nonprimitive not container
    cJSON *FiscalAuthorityYearsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(FiscalAuthorityYearsAPIlocalVarJSON);
    cJSON_Delete(FiscalAuthorityYearsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FiscalAuthorityYearsAPI_updateFiscalYear(apiClient_t *apiClient, char *tenantId, char *fiscalYearId, char *api_version, char *x_api_version, fiscal_year_update_dto_t *fiscal_year_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_fiscal_year_update_dto = NULL;
    if (fiscal_year_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_fiscal_year_update_dto = fiscal_year_update_dto_convertToJSON(fiscal_year_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_fiscal_year_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_fiscal_year_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_fiscal_year_update_dto);
        localVarSingleItemJSON_fiscal_year_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
