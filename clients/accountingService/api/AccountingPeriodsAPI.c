...
#include <stdio.h>
#include <ctype.h>
#include "AccountingPeriodsAPI.h"
...
AccountingPeriodsAPI_createAccountingPeriod(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, accounting_period_create_dto_t *accounting_period_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/AccountingPeriods")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/AccountingPeriods");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_accounting_period_create_dto = NULL;
    if (accounting_period_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_accounting_period_create_dto = accounting_period_create_dto_convertToJSON(accounting_period_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_accounting_period_create_dto);
    }
    ...
    cJSON *AccountingPeriodsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(AccountingPeriodsAPIlocalVarJSON);
    cJSON_Delete(AccountingPeriodsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_accounting_period_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_accounting_period_create_dto);
        localVarSingleItemJSON_accounting_period_create_dto = NULL;
    }
...
AccountingPeriodsAPI_deleteAccountingPeriod(apiClient_t *apiClient, char *tenantId, char *accountingPeriodId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/AccountingPeriods/{accountingPeriodId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/AccountingPeriods/{accountingPeriodId}");


    // Path Params
    long sizeOfPathParams_accountingPeriodId = strlen(accountingPeriodId)+3 + strlen("{ accountingPeriodId }");
    if(accountingPeriodId == NULL) {
        goto end;
    }
    char* localVarToReplace_accountingPeriodId = malloc(sizeOfPathParams_accountingPeriodId);
    sprintf(localVarToReplace_accountingPeriodId, "{%s}", "accountingPeriodId");

    localVarPath = strReplace(localVarPath, localVarToReplace_accountingPeriodId, accountingPeriodId);
    if(accountingPeriodId == NULL) {
        goto end;
    }
    char* localVarToReplace_accountingPeriodId = malloc(sizeOfPathParams_accountingPeriodId);
    ...
    free(localVarPath);
    free(localVarToReplace_accountingPeriodId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
AccountingPeriodsAPI_getAccountingPeriod(apiClient_t *apiClient, char *tenantId, char *accountingPeriodId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *AccountingPeriodsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    accounting_period_dto_envelope_t *elementToReturn = accounting_period_dto_envelope_parseFromJSON(AccountingPeriodsAPIlocalVarJSON);
    cJSON_Delete(AccountingPeriodsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AccountingPeriodsAPI_getAccountingPeriods(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, accounting_period_dto_collection_query_parameters_t *accounting_period_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_accounting_period_dto_collection_query_parameters = NULL;
    if (accounting_period_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_accounting_period_dto_collection_query_parameters = accounting_period_dto_collection_query_parameters_convertToJSON(accounting_period_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_accounting_period_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *AccountingPeriodsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    accounting_period_dto_list_envelope_t *elementToReturn = accounting_period_dto_list_envelope_parseFromJSON(AccountingPeriodsAPIlocalVarJSON);
    cJSON_Delete(AccountingPeriodsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_accounting_period_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_accounting_period_dto_collection_query_parameters);
        localVarSingleItemJSON_accounting_period_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
AccountingPeriodsAPI_getAccountingPeriodsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, accounting_period_dto_collection_query_parameters_t *accounting_period_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/AccountingPeriods/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/AccountingPeriods/Count");
    ...
    //nonprimitive not container
    cJSON *AccountingPeriodsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(AccountingPeriodsAPIlocalVarJSON);
    cJSON_Delete(AccountingPeriodsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AccountingPeriodsAPI_updateAccountingPeriod(apiClient_t *apiClient, char *tenantId, char *accountingPeriodId, char *api_version, char *x_api_version, accounting_period_update_dto_t *accounting_period_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_accounting_period_update_dto = NULL;
    if (accounting_period_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_accounting_period_update_dto = accounting_period_update_dto_convertToJSON(accounting_period_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_accounting_period_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_accounting_period_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_accounting_period_update_dto);
        localVarSingleItemJSON_accounting_period_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
