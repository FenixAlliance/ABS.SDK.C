...
ExpenseTypesAPI_createExpenseType(apiClient_t *apiClient, char *tenantId, expense_type_create_dto_t *expense_type_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/ExpenseTypes")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/ExpenseTypes");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_expense_type_create_dto = NULL;
    if (expense_type_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_expense_type_create_dto = expense_type_create_dto_convertToJSON(expense_type_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_expense_type_create_dto);
    }
    ...
    cJSON *ExpenseTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ExpenseTypesAPIlocalVarJSON);
    cJSON_Delete(ExpenseTypesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_expense_type_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_expense_type_create_dto);
        localVarSingleItemJSON_expense_type_create_dto = NULL;
    }
...
ExpenseTypesAPI_deleteExpenseType(apiClient_t *apiClient, char *tenantId, char *expenseTypeId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/ExpenseTypes/{expenseTypeId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/ExpenseTypes/{expenseTypeId}");


    // Path Params
    long sizeOfPathParams_expenseTypeId = strlen(expenseTypeId)+3 + strlen("{ expenseTypeId }");
    if(expenseTypeId == NULL) {
        goto end;
    }
    char* localVarToReplace_expenseTypeId = malloc(sizeOfPathParams_expenseTypeId);
    sprintf(localVarToReplace_expenseTypeId, "{%s}", "expenseTypeId");

    localVarPath = strReplace(localVarPath, localVarToReplace_expenseTypeId, expenseTypeId);
    if(expenseTypeId == NULL) {
        goto end;
    }
    char* localVarToReplace_expenseTypeId = malloc(sizeOfPathParams_expenseTypeId);
    ...
    free(localVarPath);
    free(localVarToReplace_expenseTypeId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
ExpenseTypesAPI_getExpenseType(apiClient_t *apiClient, char *tenantId, char *expenseTypeId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ExpenseTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    expense_type_dto_envelope_t *elementToReturn = expense_type_dto_envelope_parseFromJSON(ExpenseTypesAPIlocalVarJSON);
    cJSON_Delete(ExpenseTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ExpenseTypesAPI_getExpenseTypes(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, expense_type_dto_collection_query_parameters_t *expense_type_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_expense_type_dto_collection_query_parameters = NULL;
    if (expense_type_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_expense_type_dto_collection_query_parameters = expense_type_dto_collection_query_parameters_convertToJSON(expense_type_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_expense_type_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ExpenseTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    expense_type_dto_list_envelope_t *elementToReturn = expense_type_dto_list_envelope_parseFromJSON(ExpenseTypesAPIlocalVarJSON);
    cJSON_Delete(ExpenseTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_expense_type_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_expense_type_dto_collection_query_parameters);
        localVarSingleItemJSON_expense_type_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ExpenseTypesAPI_getExpenseTypesCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, expense_type_dto_collection_query_parameters_t *expense_type_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/ExpenseTypes/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/ExpenseTypes/Count");
    ...
    //nonprimitive not container
    cJSON *ExpenseTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ExpenseTypesAPIlocalVarJSON);
    cJSON_Delete(ExpenseTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ExpenseTypesAPI_updateExpenseType(apiClient_t *apiClient, char *tenantId, char *expenseTypeId, expense_type_update_dto_t *expense_type_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_expense_type_update_dto = NULL;
    if (expense_type_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_expense_type_update_dto = expense_type_update_dto_convertToJSON(expense_type_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_expense_type_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_expense_type_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_expense_type_update_dto);
        localVarSingleItemJSON_expense_type_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
