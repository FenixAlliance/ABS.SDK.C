...
BankingAPI_createBank(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, bank_create_dto_t *bank_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Banking")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Banking");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_bank_create_dto = NULL;
    if (bank_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_bank_create_dto = bank_create_dto_convertToJSON(bank_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_bank_create_dto);
    }
    ...
    bank_dto_envelope_t *elementToReturn = bank_dto_envelope_parseFromJSON(BankingAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_bank_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_bank_create_dto);
        localVarSingleItemJSON_bank_create_dto = NULL;
    }
...
BankingAPI_createBankAccount(apiClient_t *apiClient, char *tenantId, char *bankId, char *api_version, char *x_api_version, bank_account_create_dto_t *bank_account_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Banking/{bankId}/Accounts")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Banking/{bankId}/Accounts");


    // Path Params
    long sizeOfPathParams_bankId = strlen(bankId)+3 + strlen("{ bankId }");
    if(bankId == NULL) {
        goto end;
    }
    char* localVarToReplace_bankId = malloc(sizeOfPathParams_bankId);
    sprintf(localVarToReplace_bankId, "{%s}", "bankId");

    localVarPath = strReplace(localVarPath, localVarToReplace_bankId, bankId);
    if(bankId == NULL) {
        goto end;
    }
    char* localVarToReplace_bankId = malloc(sizeOfPathParams_bankId);
    ...
    //nonprimitive not container
    cJSON *BankingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    bank_account_dto_envelope_t *elementToReturn = bank_account_dto_envelope_parseFromJSON(BankingAPIlocalVarJSON);
    cJSON_Delete(BankingAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BankingAPI_createBankGuarantee(apiClient_t *apiClient, char *tenantId, char *bankId, char *api_version, char *x_api_version, bank_guarantee_create_dto_t *bank_guarantee_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Banking/{bankId}/Guarantees")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Banking/{bankId}/Guarantees");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_bank_guarantee_create_dto = NULL;
    if (bank_guarantee_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_bank_guarantee_create_dto = bank_guarantee_create_dto_convertToJSON(bank_guarantee_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_bank_guarantee_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *BankingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    bank_guarantee_dto_envelope_t *elementToReturn = bank_guarantee_dto_envelope_parseFromJSON(BankingAPIlocalVarJSON);
    cJSON_Delete(BankingAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_bank_guarantee_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_bank_guarantee_create_dto);
        localVarSingleItemJSON_bank_guarantee_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
BankingAPI_createBankTransaction(apiClient_t *apiClient, char *tenantId, char *bankId, char *api_version, char *x_api_version, bank_transaction_create_dto_t *bank_transaction_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Banking/{bankId}/Transactions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Banking/{bankId}/Transactions");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_bank_transaction_create_dto = NULL;
    if (bank_transaction_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_bank_transaction_create_dto = bank_transaction_create_dto_convertToJSON(bank_transaction_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_bank_transaction_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *BankingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    bank_transaction_dto_envelope_t *elementToReturn = bank_transaction_dto_envelope_parseFromJSON(BankingAPIlocalVarJSON);
    cJSON_Delete(BankingAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_bank_transaction_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_bank_transaction_create_dto);
        localVarSingleItemJSON_bank_transaction_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
BankingAPI_deleteBank(apiClient_t *apiClient, char *tenantId, char *bankId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Banking/{bankId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Banking/{bankId}");
...
BankingAPI_deleteBankAccount(apiClient_t *apiClient, char *tenantId, char *bankId, char *accountId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Banking/{bankId}/Accounts/{accountId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Banking/{bankId}/Accounts/{accountId}");


    // Path Params
    long sizeOfPathParams_bankId = strlen(bankId)+3 + strlen(accountId)+3 + strlen("{ bankId }");
    if(bankId == NULL) {
        goto end;
    }
    char* localVarToReplace_bankId = malloc(sizeOfPathParams_bankId);
    ...
    // Path Params
    long sizeOfPathParams_accountId = strlen(bankId)+3 + strlen(accountId)+3 + strlen("{ accountId }");
    if(accountId == NULL) {
        goto end;
    }
...
BankingAPI_deleteBankGuarantee(apiClient_t *apiClient, char *tenantId, char *bankId, char *guaranteeId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Banking/{bankId}/Guarantees/{guaranteeId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Banking/{bankId}/Guarantees/{guaranteeId}");


    // Path Params
    long sizeOfPathParams_bankId = strlen(bankId)+3 + strlen(guaranteeId)+3 + strlen("{ bankId }");
    if(bankId == NULL) {
        goto end;
    }
    char* localVarToReplace_bankId = malloc(sizeOfPathParams_bankId);
    ...
    // Path Params
    long sizeOfPathParams_guaranteeId = strlen(bankId)+3 + strlen(guaranteeId)+3 + strlen("{ guaranteeId }");
    if(guaranteeId == NULL) {
        goto end;
    }
    char* localVarToReplace_guaranteeId = malloc(sizeOfPathParams_guaranteeId);
    sprintf(localVarToReplace_guaranteeId, "{%s}", "guaranteeId");

    localVarPath = strReplace(localVarPath, localVarToReplace_guaranteeId, guaranteeId);
    if(guaranteeId == NULL) {
        goto end;
    }
    char* localVarToReplace_guaranteeId = malloc(sizeOfPathParams_guaranteeId);
    ...
    free(localVarPath);
    free(localVarToReplace_bankId);
    free(localVarToReplace_guaranteeId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
BankingAPI_deleteBankTransaction(apiClient_t *apiClient, char *tenantId, char *bankId, char *transactionId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Banking/{bankId}/Transactions/{transactionId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Banking/{bankId}/Transactions/{transactionId}");


    // Path Params
    long sizeOfPathParams_bankId = strlen(bankId)+3 + strlen(transactionId)+3 + strlen("{ bankId }");
    if(bankId == NULL) {
        goto end;
    }
    char* localVarToReplace_bankId = malloc(sizeOfPathParams_bankId);
    ...
    // Path Params
    long sizeOfPathParams_transactionId = strlen(bankId)+3 + strlen(transactionId)+3 + strlen("{ transactionId }");
...
BankingAPI_getBankAccounts(apiClient_t *apiClient, char *tenantId, char *bankId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *BankingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    bank_account_dto_list_envelope_t *elementToReturn = bank_account_dto_list_envelope_parseFromJSON(BankingAPIlocalVarJSON);
    cJSON_Delete(BankingAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BankingAPI_getBankAccountsCount(apiClient_t *apiClient, char *tenantId, char *bankId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Banking/{bankId}/Accounts/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Banking/{bankId}/Accounts/Count");
    ...
    //nonprimitive not container
    cJSON *BankingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(BankingAPIlocalVarJSON);
    cJSON_Delete(BankingAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BankingAPI_getBankGuarantees(apiClient_t *apiClient, char *tenantId, char *bankId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *BankingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    bank_guarantee_dto_list_envelope_t *elementToReturn = bank_guarantee_dto_list_envelope_parseFromJSON(BankingAPIlocalVarJSON);
    cJSON_Delete(BankingAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BankingAPI_getBankGuaranteesCount(apiClient_t *apiClient, char *tenantId, char *bankId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Banking/{bankId}/Guarantees/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Banking/{bankId}/Guarantees/Count");
...
BankingAPI_getBankTransactions(apiClient_t *apiClient, char *tenantId, char *bankId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *BankingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    bank_transaction_dto_list_envelope_t *elementToReturn = bank_transaction_dto_list_envelope_parseFromJSON(BankingAPIlocalVarJSON);
    cJSON_Delete(BankingAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BankingAPI_getBankTransactionsCount(apiClient_t *apiClient, char *tenantId, char *bankId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Banking/{bankId}/Transactions/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Banking/{bankId}/Transactions/Count");
...
BankingAPI_getBanks(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *BankingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    bank_dto_list_envelope_t *elementToReturn = bank_dto_list_envelope_parseFromJSON(BankingAPIlocalVarJSON);
    cJSON_Delete(BankingAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BankingAPI_getBanksCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Banking/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Banking/Count");
...
BankingAPI_patchBank(apiClient_t *apiClient, char *tenantId, char *bankId, char *api_version, char *x_api_version, list_t *operation)
{
    ...
    //nonprimitive not container
    cJSON *BankingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(BankingAPIlocalVarJSON);
    cJSON_Delete(BankingAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BankingAPI_updateBank(apiClient_t *apiClient, char *tenantId, char *bankId, char *api_version, char *x_api_version, bank_update_dto_t *bank_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_bank_update_dto = NULL;
    if (bank_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_bank_update_dto = bank_update_dto_convertToJSON(bank_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_bank_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_bank_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_bank_update_dto);
        localVarSingleItemJSON_bank_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
BankingAPI_updateBankGuarantee(apiClient_t *apiClient, char *tenantId, char *bankId, char *guaranteeId, char *api_version, char *x_api_version, bank_guarantee_update_dto_t *bank_guarantee_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_bank_guarantee_update_dto = NULL;
    if (bank_guarantee_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_bank_guarantee_update_dto = bank_guarantee_update_dto_convertToJSON(bank_guarantee_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_bank_guarantee_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_bank_guarantee_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_bank_guarantee_update_dto);
        localVarSingleItemJSON_bank_guarantee_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
BankingAPI_updateBankTransaction(apiClient_t *apiClient, char *tenantId, char *bankId, char *transactionId, char *api_version, char *x_api_version, bank_transaction_update_dto_t *bank_transaction_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_bank_transaction_update_dto = NULL;
    if (bank_transaction_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_bank_transaction_update_dto = bank_transaction_update_dto_convertToJSON(bank_transaction_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_bank_transaction_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_bank_transaction_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_bank_transaction_update_dto);
        localVarSingleItemJSON_bank_transaction_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
