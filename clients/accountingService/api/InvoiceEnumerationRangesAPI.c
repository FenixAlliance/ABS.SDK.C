...
#include <stdio.h>
#include <ctype.h>
#include "InvoiceEnumerationRangesAPI.h"
...
InvoiceEnumerationRangesAPI_createInvoiceEnumerationRangeAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, invoice_enumeration_range_create_dto_t *invoice_enumeration_range_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/InvoiceEnumerationRanges")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/InvoiceEnumerationRanges");
    ...
    cJSON *InvoiceEnumerationRangesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(InvoiceEnumerationRangesAPIlocalVarJSON);
    cJSON_Delete(InvoiceEnumerationRangesAPIlocalVarJSON);
...
InvoiceEnumerationRangesAPI_deleteInvoiceEnumerationRangeAsync(apiClient_t *apiClient, char *tenantId, char *rangeId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/InvoiceEnumerationRanges/{rangeId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/InvoiceEnumerationRanges/{rangeId}");


    // Path Params
    long sizeOfPathParams_rangeId = strlen(rangeId)+3 + strlen("{ rangeId }");
    if(rangeId == NULL) {
        goto end;
    }
    char* localVarToReplace_rangeId = malloc(sizeOfPathParams_rangeId);
    sprintf(localVarToReplace_rangeId, "{%s}", "rangeId");

    localVarPath = strReplace(localVarPath, localVarToReplace_rangeId, rangeId);
    if(rangeId == NULL) {
        goto end;
    }
    char* localVarToReplace_rangeId = malloc(sizeOfPathParams_rangeId);
    ...
    free(localVarPath);
    free(localVarToReplace_rangeId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
InvoiceEnumerationRangesAPI_getInvoiceEnumerationRangeDetailsAsync(apiClient_t *apiClient, char *tenantId, char *rangeId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *InvoiceEnumerationRangesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    invoice_enumeration_range_dto_envelope_t *elementToReturn = invoice_enumeration_range_dto_envelope_parseFromJSON(InvoiceEnumerationRangesAPIlocalVarJSON);
    cJSON_Delete(InvoiceEnumerationRangesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
InvoiceEnumerationRangesAPI_getInvoiceEnumerationRangesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, invoice_enumeration_range_dto_collection_query_parameters_t *invoice_enumeration_range_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *InvoiceEnumerationRangesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    invoice_enumeration_range_dto_list_envelope_t *elementToReturn = invoice_enumeration_range_dto_list_envelope_parseFromJSON(InvoiceEnumerationRangesAPIlocalVarJSON);
    cJSON_Delete(InvoiceEnumerationRangesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
