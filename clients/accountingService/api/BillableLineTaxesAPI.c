...
#include <stdio.h>
#include <ctype.h>
#include "BillableLineTaxesAPI.h"
...
BillableLineTaxesAPI_createBillableLineTax(apiClient_t *apiClient, char *tenantId, char *billableLineId, char *api_version, char *x_api_version, applied_item_tax_record_create_dto_t *applied_item_tax_record_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/BillableLines/{billableLineId}/Taxes")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/BillableLines/{billableLineId}/Taxes");


    // Path Params
    long sizeOfPathParams_billableLineId = strlen(billableLineId)+3 + strlen("{ billableLineId }");
    if(billableLineId == NULL) {
        goto end;
    }
    char* localVarToReplace_billableLineId = malloc(sizeOfPathParams_billableLineId);
    sprintf(localVarToReplace_billableLineId, "{%s}", "billableLineId");

    localVarPath = strReplace(localVarPath, localVarToReplace_billableLineId, billableLineId);
    if(billableLineId == NULL) {
        goto end;
    }
    char* localVarToReplace_billableLineId = malloc(sizeOfPathParams_billableLineId);
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_applied_item_tax_record_create_dto = NULL;
    if (applied_item_tax_record_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_applied_item_tax_record_create_dto = applied_item_tax_record_create_dto_convertToJSON(applied_item_tax_record_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_applied_item_tax_record_create_dto);
    }
    ...
    cJSON *BillableLineTaxesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(BillableLineTaxesAPIlocalVarJSON);
    cJSON_Delete(BillableLineTaxesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_applied_item_tax_record_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_applied_item_tax_record_create_dto);
        localVarSingleItemJSON_applied_item_tax_record_create_dto = NULL;
    }
...
BillableLineTaxesAPI_deleteBillableLineTax(apiClient_t *apiClient, char *tenantId, char *billableLineId, char *taxId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/BillableLines/{billableLineId}/Taxes/{taxId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/BillableLines/{billableLineId}/Taxes/{taxId}");


    // Path Params
    long sizeOfPathParams_billableLineId = strlen(billableLineId)+3 + strlen(taxId)+3 + strlen("{ billableLineId }");
    if(billableLineId == NULL) {
        goto end;
    }
    char* localVarToReplace_billableLineId = malloc(sizeOfPathParams_billableLineId);
    ...
    // Path Params
    long sizeOfPathParams_taxId = strlen(billableLineId)+3 + strlen(taxId)+3 + strlen("{ taxId }");
    if(taxId == NULL) {
        goto end;
    }
    char* localVarToReplace_taxId = malloc(sizeOfPathParams_taxId);
    sprintf(localVarToReplace_taxId, "{%s}", "taxId");

    localVarPath = strReplace(localVarPath, localVarToReplace_taxId, taxId);
    if(taxId == NULL) {
        goto end;
    }
    char* localVarToReplace_taxId = malloc(sizeOfPathParams_taxId);
...
BillableLineTaxesAPI_getBillableLineTaxes(apiClient_t *apiClient, char *tenantId, char *billableLineId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *BillableLineTaxesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    applied_item_tax_record_dto_i_read_only_list_envelope_t *elementToReturn = applied_item_tax_record_dto_i_read_only_list_envelope_parseFromJSON(BillableLineTaxesAPIlocalVarJSON);
    cJSON_Delete(BillableLineTaxesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BillableLineTaxesAPI_getBillableLineTaxesCount(apiClient_t *apiClient, char *tenantId, char *billableLineId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/BillableLines/{billableLineId}/Taxes/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/BillableLines/{billableLineId}/Taxes/Count");
    ...
    //nonprimitive not container
    cJSON *BillableLineTaxesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(BillableLineTaxesAPIlocalVarJSON);
    cJSON_Delete(BillableLineTaxesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BillableLineTaxesAPI_updateBillableLineTax(apiClient_t *apiClient, char *tenantId, char *billableLineId, char *taxId, char *api_version, char *x_api_version, applied_item_tax_record_update_dto_t *applied_item_tax_record_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_applied_item_tax_record_update_dto = NULL;
    if (applied_item_tax_record_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_applied_item_tax_record_update_dto = applied_item_tax_record_update_dto_convertToJSON(applied_item_tax_record_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_applied_item_tax_record_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_applied_item_tax_record_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_applied_item_tax_record_update_dto);
        localVarSingleItemJSON_applied_item_tax_record_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
