...
LedgerTypesAPI_createLedgerTypeAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, ledger_type_create_dto_t *ledger_type_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/LedgerTypes")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/LedgerTypes");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_ledger_type_create_dto = NULL;
    if (ledger_type_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_ledger_type_create_dto = ledger_type_create_dto_convertToJSON(ledger_type_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_ledger_type_create_dto);
    }
    ...
    cJSON *LedgerTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(LedgerTypesAPIlocalVarJSON);
    cJSON_Delete(LedgerTypesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_ledger_type_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_ledger_type_create_dto);
        localVarSingleItemJSON_ledger_type_create_dto = NULL;
    }
...
LedgerTypesAPI_deleteLedgerTypeAsync(apiClient_t *apiClient, char *tenantId, char *ledgerTypeId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/LedgerTypes/{ledgerTypeId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/LedgerTypes/{ledgerTypeId}");


    // Path Params
    long sizeOfPathParams_ledgerTypeId = strlen(ledgerTypeId)+3 + strlen("{ ledgerTypeId }");
    if(ledgerTypeId == NULL) {
        goto end;
    }
    char* localVarToReplace_ledgerTypeId = malloc(sizeOfPathParams_ledgerTypeId);
    sprintf(localVarToReplace_ledgerTypeId, "{%s}", "ledgerTypeId");

    localVarPath = strReplace(localVarPath, localVarToReplace_ledgerTypeId, ledgerTypeId);
    if(ledgerTypeId == NULL) {
        goto end;
    }
    char* localVarToReplace_ledgerTypeId = malloc(sizeOfPathParams_ledgerTypeId);
    ...
    free(localVarPath);
    free(localVarToReplace_ledgerTypeId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
LedgerTypesAPI_getLedgerTypeDetailsAsync(apiClient_t *apiClient, char *tenantId, char *ledgerTypeId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *LedgerTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ledger_type_dto_envelope_t *elementToReturn = ledger_type_dto_envelope_parseFromJSON(LedgerTypesAPIlocalVarJSON);
    cJSON_Delete(LedgerTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
LedgerTypesAPI_getLedgerTypesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, ledger_type_dto_collection_query_parameters_t *ledger_type_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_ledger_type_dto_collection_query_parameters = NULL;
    if (ledger_type_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_ledger_type_dto_collection_query_parameters = ledger_type_dto_collection_query_parameters_convertToJSON(ledger_type_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_ledger_type_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *LedgerTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ledger_type_dto_i_read_only_list_envelope_t *elementToReturn = ledger_type_dto_i_read_only_list_envelope_parseFromJSON(LedgerTypesAPIlocalVarJSON);
    cJSON_Delete(LedgerTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_ledger_type_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_ledger_type_dto_collection_query_parameters);
        localVarSingleItemJSON_ledger_type_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
LedgerTypesAPI_getLedgerTypesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, ledger_type_dto_collection_query_parameters_t *ledger_type_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/LedgerTypes/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/LedgerTypes/Count");
    ...
    //nonprimitive not container
    cJSON *LedgerTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(LedgerTypesAPIlocalVarJSON);
    cJSON_Delete(LedgerTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
LedgerTypesAPI_updateLedgerTypeAsync(apiClient_t *apiClient, char *tenantId, char *ledgerTypeId, char *api_version, char *x_api_version, ledger_type_update_dto_t *ledger_type_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_ledger_type_update_dto = NULL;
    if (ledger_type_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_ledger_type_update_dto = ledger_type_update_dto_convertToJSON(ledger_type_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_ledger_type_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_ledger_type_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_ledger_type_update_dto);
        localVarSingleItemJSON_ledger_type_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
