...
FiscalResponsibilityRecordsAPI_getFiscalResponsibilityRecords(apiClient_t *apiClient, char *tenantId, char *fiscalAuthorityId, char *fiscalResponsibilityId, char *api_version, char *x_api_version, fiscal_responsibility_record_dto_collection_query_parameters_t *fiscal_responsibility_record_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_fiscal_responsibility_record_dto_collection_query_parameters = NULL;
    if (fiscal_responsibility_record_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_fiscal_responsibility_record_dto_collection_query_parameters = fiscal_responsibility_record_dto_collection_query_parameters_convertToJSON(fiscal_responsibility_record_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_fiscal_responsibility_record_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_fiscal_responsibility_record_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_fiscal_responsibility_record_dto_collection_query_parameters);
        localVarSingleItemJSON_fiscal_responsibility_record_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
