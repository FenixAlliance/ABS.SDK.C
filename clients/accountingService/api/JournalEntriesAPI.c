...
JournalEntriesAPI_getExpensesSumAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/JournalEntries/Expenses/Sum")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/JournalEntries/Expenses/Sum");
    ...
    cJSON *JournalEntriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    decimal_envelope_t *elementToReturn = decimal_envelope_parseFromJSON(JournalEntriesAPIlocalVarJSON);
    cJSON_Delete(JournalEntriesAPIlocalVarJSON);
...
JournalEntriesAPI_getIncomesSumAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/JournalEntries/Incomes/Sum")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/JournalEntries/Incomes/Sum");
