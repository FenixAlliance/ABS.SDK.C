...
ExpenseClaimsAPI_createExpenseClaim(apiClient_t *apiClient, char *tenantId, expense_claim_create_dto_t *expense_claim_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/ExpenseClaims")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/ExpenseClaims");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_expense_claim_create_dto = NULL;
    if (expense_claim_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_expense_claim_create_dto = expense_claim_create_dto_convertToJSON(expense_claim_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_expense_claim_create_dto);
    }
    ...
    cJSON *ExpenseClaimsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ExpenseClaimsAPIlocalVarJSON);
    cJSON_Delete(ExpenseClaimsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_expense_claim_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_expense_claim_create_dto);
        localVarSingleItemJSON_expense_claim_create_dto = NULL;
    }
...
ExpenseClaimsAPI_deleteExpenseClaim(apiClient_t *apiClient, char *tenantId, char *expenseClaimId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/ExpenseClaims/{expenseClaimId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/ExpenseClaims/{expenseClaimId}");


    // Path Params
    long sizeOfPathParams_expenseClaimId = strlen(expenseClaimId)+3 + strlen("{ expenseClaimId }");
    if(expenseClaimId == NULL) {
        goto end;
    }
    char* localVarToReplace_expenseClaimId = malloc(sizeOfPathParams_expenseClaimId);
    sprintf(localVarToReplace_expenseClaimId, "{%s}", "expenseClaimId");

    localVarPath = strReplace(localVarPath, localVarToReplace_expenseClaimId, expenseClaimId);
    if(expenseClaimId == NULL) {
        goto end;
    }
    char* localVarToReplace_expenseClaimId = malloc(sizeOfPathParams_expenseClaimId);
    ...
    free(localVarPath);
    free(localVarToReplace_expenseClaimId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
ExpenseClaimsAPI_getExpenseClaim(apiClient_t *apiClient, char *tenantId, char *expenseClaimId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ExpenseClaimsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    expense_claim_dto_envelope_t *elementToReturn = expense_claim_dto_envelope_parseFromJSON(ExpenseClaimsAPIlocalVarJSON);
    cJSON_Delete(ExpenseClaimsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ExpenseClaimsAPI_getExpenseClaims(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, expense_claim_dto_collection_query_parameters_t *expense_claim_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_expense_claim_dto_collection_query_parameters = NULL;
    if (expense_claim_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_expense_claim_dto_collection_query_parameters = expense_claim_dto_collection_query_parameters_convertToJSON(expense_claim_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_expense_claim_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ExpenseClaimsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    expense_claim_dto_list_envelope_t *elementToReturn = expense_claim_dto_list_envelope_parseFromJSON(ExpenseClaimsAPIlocalVarJSON);
    cJSON_Delete(ExpenseClaimsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_expense_claim_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_expense_claim_dto_collection_query_parameters);
        localVarSingleItemJSON_expense_claim_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ExpenseClaimsAPI_getExpenseClaimsCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, expense_claim_dto_collection_query_parameters_t *expense_claim_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/ExpenseClaims/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/ExpenseClaims/Count");
    ...
    //nonprimitive not container
    cJSON *ExpenseClaimsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ExpenseClaimsAPIlocalVarJSON);
    cJSON_Delete(ExpenseClaimsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ExpenseClaimsAPI_updateExpenseClaim(apiClient_t *apiClient, char *tenantId, char *expenseClaimId, expense_claim_update_dto_t *expense_claim_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_expense_claim_update_dto = NULL;
    if (expense_claim_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_expense_claim_update_dto = expense_claim_update_dto_convertToJSON(expense_claim_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_expense_claim_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_expense_claim_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_expense_claim_update_dto);
        localVarSingleItemJSON_expense_claim_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
