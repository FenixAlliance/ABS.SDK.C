...
AccountsAPI_balanceAccountAsync(apiClient_t *apiClient, char *tenantId, char *accountId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Accounts/{accountId}/Balance")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Accounts/{accountId}/Balance");
    ...
    //nonprimitive not container
    cJSON *AccountsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    account_dto_envelope_t *elementToReturn = account_dto_envelope_parseFromJSON(AccountsAPIlocalVarJSON);
    cJSON_Delete(AccountsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AccountsAPI_balanceRootAccountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Accounts/Root/Balance")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Accounts/Root/Balance");
    ...
    //nonprimitive not container
    cJSON *AccountsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    account_dto_list_envelope_t *elementToReturn = account_dto_list_envelope_parseFromJSON(AccountsAPIlocalVarJSON);
    cJSON_Delete(AccountsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AccountsAPI_createAccountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, account_create_dto_t *account_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Accounts")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Accounts");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_account_create_dto = NULL;
    if (account_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_account_create_dto = account_create_dto_convertToJSON(account_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_account_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_account_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_account_create_dto);
        localVarSingleItemJSON_account_create_dto = NULL;
    }
...
AccountsAPI_createAccountCreditAsync(apiClient_t *apiClient, char *tenantId, char *accountId, char *api_version, char *x_api_version, accounting_entry_create_dto_t *accounting_entry_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Accounts/{accountId}/Credits")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Accounts/{accountId}/Credits");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_accounting_entry_create_dto = NULL;
    if (accounting_entry_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_accounting_entry_create_dto = accounting_entry_create_dto_convertToJSON(accounting_entry_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_accounting_entry_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *AccountsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    accounting_entry_dto_list_envelope_t *elementToReturn = accounting_entry_dto_list_envelope_parseFromJSON(AccountsAPIlocalVarJSON);
    cJSON_Delete(AccountsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_accounting_entry_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_accounting_entry_create_dto);
        localVarSingleItemJSON_accounting_entry_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
AccountsAPI_createAccountDebitAsync(apiClient_t *apiClient, char *tenantId, char *accountId, char *api_version, char *x_api_version, accounting_entry_create_dto_t *accounting_entry_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Accounts/{accountId}/Debits")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Accounts/{accountId}/Debits");
...
AccountsAPI_createAccountEntryAsync(apiClient_t *apiClient, char *tenantId, char *accountId, char *api_version, char *x_api_version, accounting_entry_create_dto_t *accounting_entry_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Accounts/{accountId}/Entries")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Accounts/{accountId}/Entries");
    ...
    //nonprimitive not container
    cJSON *AccountsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    accounting_entry_dto_envelope_t *elementToReturn = accounting_entry_dto_envelope_parseFromJSON(AccountsAPIlocalVarJSON);
    cJSON_Delete(AccountsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AccountsAPI_createAccountRelationAsync(apiClient_t *apiClient, char *tenantId, char *accountId, char *api_version, char *x_api_version, account_relation_create_dto_t *account_relation_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Accounts/Relations")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Accounts/Relations");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_account_relation_create_dto = NULL;
    if (account_relation_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_account_relation_create_dto = account_relation_create_dto_convertToJSON(account_relation_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_account_relation_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_account_relation_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_account_relation_create_dto);
        localVarSingleItemJSON_account_relation_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
AccountsAPI_createAccountTypeAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, account_type_create_dto_t *account_type_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Accounts/Types")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Accounts/Types");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_account_type_create_dto = NULL;
    if (account_type_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_account_type_create_dto = account_type_create_dto_convertToJSON(account_type_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_account_type_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_account_type_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_account_type_create_dto);
        localVarSingleItemJSON_account_type_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
AccountsAPI_deleteAccountAsync(apiClient_t *apiClient, char *tenantId, char *accountId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Accounts/{accountId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Accounts/{accountId}");
...
AccountsAPI_getAccountAggregateAsync(apiClient_t *apiClient, char *tenantId, char *currencyId, char *api_version, char *x_api_version, list_t *account_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Accounts/Aggregate")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Accounts/Aggregate");
    ...
    // Body Param
    //notstring
    cJSON *localVar_account_dto = NULL;
    cJSON *localVarItemJSON_account_dto = NULL;
    cJSON *localVarSingleItemJSON_account_dto = NULL;
    if (account_dto != NULL)
    {
        localVarItemJSON_account_dto = cJSON_CreateObject();
        localVarSingleItemJSON_account_dto = cJSON_AddArrayToObject(localVarItemJSON_account_dto, "account_dto");
        if (localVarSingleItemJSON_account_dto == NULL)
        {
    ...
    listEntry_t *account_dtoBodyListEntry;
    list_ForEach(account_dtoBodyListEntry, account_dto)
    {
        localVar_account_dto = account_dto_convertToJSON(account_dtoBodyListEntry->data);
        if(localVar_account_dto == NULL)
        {
            goto end;
        }
        cJSON_AddItemToArray(localVarSingleItemJSON_account_dto, localVar_account_dto);
        localVarBodyParameters = cJSON_Print(localVarItemJSON_account_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarItemJSON_account_dto) {
        cJSON_Delete(localVarItemJSON_account_dto);
        localVarItemJSON_account_dto = NULL;
    }
    if (localVarSingleItemJSON_account_dto) {
        cJSON_Delete(localVarSingleItemJSON_account_dto);
        localVarSingleItemJSON_account_dto = NULL;
    }
    if (localVar_account_dto) {
        cJSON_Delete(localVar_account_dto);
        localVar_account_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
AccountsAPI_getAccountCreditsCountAsync(apiClient_t *apiClient, char *tenantId, char *accountId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Accounts/{accountId}/Credits/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Accounts/{accountId}/Credits/Count");
    ...
    //nonprimitive not container
    cJSON *AccountsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(AccountsAPIlocalVarJSON);
    cJSON_Delete(AccountsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AccountsAPI_getAccountDebitsCountAsync(apiClient_t *apiClient, char *tenantId, char *accountId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Accounts/{accountId}/Debits/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Accounts/{accountId}/Debits/Count");
...
AccountsAPI_getAccountRelationsAsync(apiClient_t *apiClient, char *tenantId, char *accountId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *AccountsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    account_relation_dto_list_envelope_t *elementToReturn = account_relation_dto_list_envelope_parseFromJSON(AccountsAPIlocalVarJSON);
    cJSON_Delete(AccountsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AccountsAPI_getAccountRelationsCountAsync(apiClient_t *apiClient, char *tenantId, char *accountId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Accounts/Relations/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Accounts/Relations/Count");
...
AccountsAPI_getAccountTypesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *AccountsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    account_type_dto_list_envelope_t *elementToReturn = account_type_dto_list_envelope_parseFromJSON(AccountsAPIlocalVarJSON);
    cJSON_Delete(AccountsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AccountsAPI_getAccountTypesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Accounts/Types/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Accounts/Types/Count");
...
AccountsAPI_getAccountsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Accounts/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Accounts/Count");
...
AccountsAPI_getChildAccountsAsync(apiClient_t *apiClient, char *tenantId, char *accountId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Accounts/{accountId}/Children")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Accounts/{accountId}/Children");
...
AccountsAPI_getCreditAccountEntriesAsync(apiClient_t *apiClient, char *tenantId, char *accountId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Accounts/{accountId}/Entries/Credit")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Accounts/{accountId}/Entries/Credit");
...
AccountsAPI_getDebitAccountEntriesAsync(apiClient_t *apiClient, char *tenantId, char *accountId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Accounts/{accountId}/Entries/Debit")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Accounts/{accountId}/Entries/Debit");
...
AccountsAPI_getRootAccountsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Accounts/Root")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Accounts/Root");
...
AccountsAPI_updateAccountAsync(apiClient_t *apiClient, char *tenantId, char *accountId, char *api_version, char *x_api_version, account_update_dto_t *account_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_account_update_dto = NULL;
    if (account_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_account_update_dto = account_update_dto_convertToJSON(account_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_account_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_account_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_account_update_dto);
        localVarSingleItemJSON_account_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
AccountsAPI_updateAccountEntryAsync(apiClient_t *apiClient, char *tenantId, char *accountId, char *entryId, char *api_version, char *x_api_version, accounting_entry_update_dto_t *accounting_entry_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_accounting_entry_update_dto = NULL;
    if (accounting_entry_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_accounting_entry_update_dto = accounting_entry_update_dto_convertToJSON(accounting_entry_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_accounting_entry_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_accounting_entry_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_accounting_entry_update_dto);
        localVarSingleItemJSON_accounting_entry_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
AccountsAPI_updateAccountRelationAsync(apiClient_t *apiClient, char *tenantId, char *accountRelationId, char *accountId, char *api_version, char *x_api_version, account_relation_update_dto_t *account_relation_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_account_relation_update_dto = NULL;
    if (account_relation_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_account_relation_update_dto = account_relation_update_dto_convertToJSON(account_relation_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_account_relation_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_account_relation_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_account_relation_update_dto);
        localVarSingleItemJSON_account_relation_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
AccountsAPI_updateAccountTypeAsync(apiClient_t *apiClient, char *tenantId, char *accountTypeId, char *api_version, char *x_api_version, account_type_update_dto_t *account_type_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_account_type_update_dto = NULL;
    if (account_type_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_account_type_update_dto = account_type_update_dto_convertToJSON(account_type_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_account_type_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_account_type_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_account_type_update_dto);
        localVarSingleItemJSON_account_type_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
