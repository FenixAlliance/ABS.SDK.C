...
LoansAPI_createLoanApplicationAsync(apiClient_t *apiClient, char *tenantId, loan_application_create_dto_t *loan_application_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Loans/Applications")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Loans/Applications");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_loan_application_create_dto = NULL;
    if (loan_application_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_loan_application_create_dto = loan_application_create_dto_convertToJSON(loan_application_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_loan_application_create_dto);
    }
    ...
    if (localVarSingleItemJSON_loan_application_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_loan_application_create_dto);
        localVarSingleItemJSON_loan_application_create_dto = NULL;
    }
...
LoansAPI_createLoanAsync(apiClient_t *apiClient, char *tenantId, loan_create_dto_t *loan_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Loans")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Loans");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_loan_create_dto = NULL;
    if (loan_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_loan_create_dto = loan_create_dto_convertToJSON(loan_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_loan_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_loan_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_loan_create_dto);
        localVarSingleItemJSON_loan_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
LoansAPI_deleteLoanApplicationAsync(apiClient_t *apiClient, char *tenantId, char *applicationId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Loans/Applications/{applicationId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Loans/Applications/{applicationId}");


    // Path Params
    long sizeOfPathParams_applicationId = strlen(applicationId)+3 + strlen("{ applicationId }");
...
LoansAPI_deleteLoanAsync(apiClient_t *apiClient, char *tenantId, char *loanId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Loans/{loanId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Loans/{loanId}");


    // Path Params
    long sizeOfPathParams_loanId = strlen(loanId)+3 + strlen("{ loanId }");
    if(loanId == NULL) {
        goto end;
    }
    char* localVarToReplace_loanId = malloc(sizeOfPathParams_loanId);
    sprintf(localVarToReplace_loanId, "{%s}", "loanId");

    localVarPath = strReplace(localVarPath, localVarToReplace_loanId, loanId);
    if(loanId == NULL) {
        goto end;
    }
    char* localVarToReplace_loanId = malloc(sizeOfPathParams_loanId);
...
LoansAPI_getLoanApplicationDetailsAsync(apiClient_t *apiClient, char *tenantId, char *applicationId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *LoansAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    loan_application_dto_envelope_t *elementToReturn = loan_application_dto_envelope_parseFromJSON(LoansAPIlocalVarJSON);
    cJSON_Delete(LoansAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
LoansAPI_getLoanApplicationsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, loan_application_dto_collection_query_parameters_t *loan_application_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_loan_application_dto_collection_query_parameters = NULL;
    if (loan_application_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_loan_application_dto_collection_query_parameters = loan_application_dto_collection_query_parameters_convertToJSON(loan_application_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_loan_application_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *LoansAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    loan_application_dto_i_read_only_list_envelope_t *elementToReturn = loan_application_dto_i_read_only_list_envelope_parseFromJSON(LoansAPIlocalVarJSON);
    cJSON_Delete(LoansAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_loan_application_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_loan_application_dto_collection_query_parameters);
        localVarSingleItemJSON_loan_application_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
LoansAPI_getLoanApplicationsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, loan_application_dto_collection_query_parameters_t *loan_application_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Loans/Applications/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Loans/Applications/Count");
...
LoansAPI_getLoanDetailsAsync(apiClient_t *apiClient, char *tenantId, char *loanId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *LoansAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    loan_dto_envelope_t *elementToReturn = loan_dto_envelope_parseFromJSON(LoansAPIlocalVarJSON);
    cJSON_Delete(LoansAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
LoansAPI_getLoanTypesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, loan_type_dto_collection_query_parameters_t *loan_type_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_loan_type_dto_collection_query_parameters = NULL;
    if (loan_type_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_loan_type_dto_collection_query_parameters = loan_type_dto_collection_query_parameters_convertToJSON(loan_type_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_loan_type_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_loan_type_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_loan_type_dto_collection_query_parameters);
        localVarSingleItemJSON_loan_type_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
LoansAPI_getLoansAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, loan_dto_collection_query_parameters_t *loan_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_loan_dto_collection_query_parameters = NULL;
    if (loan_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_loan_dto_collection_query_parameters = loan_dto_collection_query_parameters_convertToJSON(loan_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_loan_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *LoansAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    loan_dto_i_read_only_list_envelope_t *elementToReturn = loan_dto_i_read_only_list_envelope_parseFromJSON(LoansAPIlocalVarJSON);
    cJSON_Delete(LoansAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_loan_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_loan_dto_collection_query_parameters);
        localVarSingleItemJSON_loan_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
LoansAPI_getLoansCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, loan_dto_collection_query_parameters_t *loan_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Loans/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Loans/Count");
...
LoansAPI_updateLoanAsync(apiClient_t *apiClient, char *tenantId, char *loanId, loan_update_dto_t *loan_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_loan_update_dto = NULL;
    if (loan_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_loan_update_dto = loan_update_dto_convertToJSON(loan_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_loan_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
