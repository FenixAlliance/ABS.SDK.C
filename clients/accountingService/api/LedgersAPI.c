...
LedgersAPI_createLedgerAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, create_ledger_dto_t *create_ledger_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Ledgers")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Ledgers");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_create_ledger_dto = NULL;
    if (create_ledger_dto != NULL)
    {
        //string
        localVarSingleItemJSON_create_ledger_dto = create_ledger_dto_convertToJSON(create_ledger_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_create_ledger_dto);
    }
    ...
    cJSON *LedgersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(LedgersAPIlocalVarJSON);
    cJSON_Delete(LedgersAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_create_ledger_dto) {
        cJSON_Delete(localVarSingleItemJSON_create_ledger_dto);
        localVarSingleItemJSON_create_ledger_dto = NULL;
    }
...
LedgersAPI_deleteLedgerAsync(apiClient_t *apiClient, char *tenantId, char *ledgerId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Ledgers/{ledgerId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Ledgers/{ledgerId}");


    // Path Params
    long sizeOfPathParams_ledgerId = strlen(ledgerId)+3 + strlen("{ ledgerId }");
    if(ledgerId == NULL) {
        goto end;
    }
    char* localVarToReplace_ledgerId = malloc(sizeOfPathParams_ledgerId);
    sprintf(localVarToReplace_ledgerId, "{%s}", "ledgerId");

    localVarPath = strReplace(localVarPath, localVarToReplace_ledgerId, ledgerId);
    if(ledgerId == NULL) {
        goto end;
    }
    char* localVarToReplace_ledgerId = malloc(sizeOfPathParams_ledgerId);
    ...
    free(localVarPath);
    free(localVarToReplace_ledgerId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
LedgersAPI_getLedgerDetailsAsync(apiClient_t *apiClient, char *tenantId, char *ledgerId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *LedgersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ledger_dto_envelope_t *elementToReturn = ledger_dto_envelope_parseFromJSON(LedgersAPIlocalVarJSON);
    cJSON_Delete(LedgersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
LedgersAPI_getLedgersAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, ledger_dto_collection_query_parameters_t *ledger_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_ledger_dto_collection_query_parameters = NULL;
    if (ledger_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_ledger_dto_collection_query_parameters = ledger_dto_collection_query_parameters_convertToJSON(ledger_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_ledger_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *LedgersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ledger_dto_i_read_only_list_envelope_t *elementToReturn = ledger_dto_i_read_only_list_envelope_parseFromJSON(LedgersAPIlocalVarJSON);
    cJSON_Delete(LedgersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_ledger_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_ledger_dto_collection_query_parameters);
        localVarSingleItemJSON_ledger_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
LedgersAPI_getLedgersCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, ledger_dto_collection_query_parameters_t *ledger_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Ledgers/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Ledgers/Count");
    ...
    //nonprimitive not container
    cJSON *LedgersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(LedgersAPIlocalVarJSON);
    cJSON_Delete(LedgersAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
LedgersAPI_updateLedgerAsync(apiClient_t *apiClient, char *tenantId, char *ledgerId, char *api_version, char *x_api_version, update_ledger_dto_t *update_ledger_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_update_ledger_dto = NULL;
    if (update_ledger_dto != NULL)
    {
        //string
        localVarSingleItemJSON_update_ledger_dto = update_ledger_dto_convertToJSON(update_ledger_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_update_ledger_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_update_ledger_dto) {
        cJSON_Delete(localVarSingleItemJSON_update_ledger_dto);
        localVarSingleItemJSON_update_ledger_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
