...
#include <stdio.h>
#include <ctype.h>
#include "FiscalAuthoritiesAPI.h"
...
FiscalAuthoritiesAPI_createFiscalAuthority(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, fiscal_authority_create_dto_t *fiscal_authority_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Fiscals/Authorities")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Fiscals/Authorities");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_fiscal_authority_create_dto = NULL;
    if (fiscal_authority_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_fiscal_authority_create_dto = fiscal_authority_create_dto_convertToJSON(fiscal_authority_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_fiscal_authority_create_dto);
    }
    ...
    cJSON *FiscalAuthoritiesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(FiscalAuthoritiesAPIlocalVarJSON);
    cJSON_Delete(FiscalAuthoritiesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_fiscal_authority_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_fiscal_authority_create_dto);
        localVarSingleItemJSON_fiscal_authority_create_dto = NULL;
    }
...
FiscalAuthoritiesAPI_deleteFiscalAuthority(apiClient_t *apiClient, char *tenantId, char *authorityId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Fiscals/Authorities/{authorityId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Fiscals/Authorities/{authorityId}");
...
FiscalAuthoritiesAPI_getFiscalAuthorities(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, fiscal_authority_dto_collection_query_parameters_t *fiscal_authority_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_fiscal_authority_dto_collection_query_parameters = NULL;
    if (fiscal_authority_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_fiscal_authority_dto_collection_query_parameters = fiscal_authority_dto_collection_query_parameters_convertToJSON(fiscal_authority_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_fiscal_authority_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *FiscalAuthoritiesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    fiscal_authority_dto_list_envelope_t *elementToReturn = fiscal_authority_dto_list_envelope_parseFromJSON(FiscalAuthoritiesAPIlocalVarJSON);
    cJSON_Delete(FiscalAuthoritiesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_fiscal_authority_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_fiscal_authority_dto_collection_query_parameters);
        localVarSingleItemJSON_fiscal_authority_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
FiscalAuthoritiesAPI_getFiscalAuthoritiesCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, fiscal_authority_dto_collection_query_parameters_t *fiscal_authority_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Fiscals/Authorities/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Fiscals/Authorities/Count");
    ...
    //nonprimitive not container
    cJSON *FiscalAuthoritiesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(FiscalAuthoritiesAPIlocalVarJSON);
    cJSON_Delete(FiscalAuthoritiesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FiscalAuthoritiesAPI_getFiscalAuthority(apiClient_t *apiClient, char *tenantId, char *authorityId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *FiscalAuthoritiesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    fiscal_authority_dto_envelope_t *elementToReturn = fiscal_authority_dto_envelope_parseFromJSON(FiscalAuthoritiesAPIlocalVarJSON);
    cJSON_Delete(FiscalAuthoritiesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FiscalAuthoritiesAPI_updateFiscalAuthority(apiClient_t *apiClient, char *tenantId, char *authorityId, char *api_version, char *x_api_version, fiscal_authority_update_dto_t *fiscal_authority_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_fiscal_authority_update_dto = NULL;
    if (fiscal_authority_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_fiscal_authority_update_dto = fiscal_authority_update_dto_convertToJSON(fiscal_authority_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_fiscal_authority_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_fiscal_authority_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_fiscal_authority_update_dto);
        localVarSingleItemJSON_fiscal_authority_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
