...
FinancialBooksAPI_createFinancialBookAsync(apiClient_t *apiClient, char *tenantId, financial_book_create_dto_t *financial_book_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/FinancialBooks")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/FinancialBooks");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_financial_book_create_dto = NULL;
    if (financial_book_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_financial_book_create_dto = financial_book_create_dto_convertToJSON(financial_book_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_financial_book_create_dto);
    }
    ...
    cJSON *FinancialBooksAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(FinancialBooksAPIlocalVarJSON);
    cJSON_Delete(FinancialBooksAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_financial_book_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_financial_book_create_dto);
        localVarSingleItemJSON_financial_book_create_dto = NULL;
    }
...
FinancialBooksAPI_deleteFinancialBookAsync(apiClient_t *apiClient, char *tenantId, char *financialBookId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/FinancialBooks/{financialBookId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/FinancialBooks/{financialBookId}");


    // Path Params
    long sizeOfPathParams_financialBookId = strlen(financialBookId)+3 + strlen("{ financialBookId }");
    if(financialBookId == NULL) {
        goto end;
    }
    char* localVarToReplace_financialBookId = malloc(sizeOfPathParams_financialBookId);
    sprintf(localVarToReplace_financialBookId, "{%s}", "financialBookId");

    localVarPath = strReplace(localVarPath, localVarToReplace_financialBookId, financialBookId);
    if(financialBookId == NULL) {
        goto end;
    }
    char* localVarToReplace_financialBookId = malloc(sizeOfPathParams_financialBookId);
    ...
    free(localVarPath);
    free(localVarToReplace_financialBookId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
FinancialBooksAPI_getFinancialBookDetailsAsync(apiClient_t *apiClient, char *tenantId, char *financialBookId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *FinancialBooksAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    financial_book_dto_envelope_t *elementToReturn = financial_book_dto_envelope_parseFromJSON(FinancialBooksAPIlocalVarJSON);
    cJSON_Delete(FinancialBooksAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FinancialBooksAPI_getFinancialBooksAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, financial_book_dto_collection_query_parameters_t *financial_book_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_financial_book_dto_collection_query_parameters = NULL;
    if (financial_book_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_financial_book_dto_collection_query_parameters = financial_book_dto_collection_query_parameters_convertToJSON(financial_book_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_financial_book_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *FinancialBooksAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    financial_book_dto_list_envelope_t *elementToReturn = financial_book_dto_list_envelope_parseFromJSON(FinancialBooksAPIlocalVarJSON);
    cJSON_Delete(FinancialBooksAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_financial_book_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_financial_book_dto_collection_query_parameters);
        localVarSingleItemJSON_financial_book_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
FinancialBooksAPI_getFinancialBooksCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, financial_book_dto_collection_query_parameters_t *financial_book_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/FinancialBooks/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/FinancialBooks/Count");
    ...
    //nonprimitive not container
    cJSON *FinancialBooksAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(FinancialBooksAPIlocalVarJSON);
    cJSON_Delete(FinancialBooksAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FinancialBooksAPI_updateFinancialBookAsync(apiClient_t *apiClient, char *tenantId, char *financialBookId, financial_book_update_dto_t *financial_book_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_financial_book_update_dto = NULL;
    if (financial_book_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_financial_book_update_dto = financial_book_update_dto_convertToJSON(financial_book_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_financial_book_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_financial_book_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_financial_book_update_dto);
        localVarSingleItemJSON_financial_book_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
