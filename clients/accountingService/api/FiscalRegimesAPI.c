...
FiscalRegimesAPI_createFiscalRegime(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, fiscal_regime_create_dto_t *fiscal_regime_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Fiscals/Authorities/FiscalRegimes")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Fiscals/Authorities/FiscalRegimes");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_fiscal_regime_create_dto = NULL;
    if (fiscal_regime_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_fiscal_regime_create_dto = fiscal_regime_create_dto_convertToJSON(fiscal_regime_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_fiscal_regime_create_dto);
    }
    ...
    cJSON *FiscalRegimesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(FiscalRegimesAPIlocalVarJSON);
    cJSON_Delete(FiscalRegimesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_fiscal_regime_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_fiscal_regime_create_dto);
        localVarSingleItemJSON_fiscal_regime_create_dto = NULL;
    }
...
FiscalRegimesAPI_deleteFiscalRegime(apiClient_t *apiClient, char *tenantId, char *regimeId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Fiscals/Authorities/FiscalRegimes/{regimeId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Fiscals/Authorities/FiscalRegimes/{regimeId}");


    // Path Params
    long sizeOfPathParams_regimeId = strlen(regimeId)+3 + strlen("{ regimeId }");
    if(regimeId == NULL) {
        goto end;
    }
    char* localVarToReplace_regimeId = malloc(sizeOfPathParams_regimeId);
    sprintf(localVarToReplace_regimeId, "{%s}", "regimeId");

    localVarPath = strReplace(localVarPath, localVarToReplace_regimeId, regimeId);
    if(regimeId == NULL) {
        goto end;
    }
    char* localVarToReplace_regimeId = malloc(sizeOfPathParams_regimeId);
    ...
    free(localVarPath);
    free(localVarToReplace_regimeId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
FiscalRegimesAPI_getFiscalRegime(apiClient_t *apiClient, char *tenantId, char *fiscalAuthorityId, char *regimeId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Fiscals/Authorities/{fiscalAuthorityId}/FiscalRegimes/{regimeId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Fiscals/Authorities/{fiscalAuthorityId}/FiscalRegimes/{regimeId}");


    // Path Params
    long sizeOfPathParams_fiscalAuthorityId = strlen(fiscalAuthorityId)+3 + strlen(regimeId)+3 + strlen("{ fiscalAuthorityId }");
    ...
    // Path Params
    long sizeOfPathParams_regimeId = strlen(fiscalAuthorityId)+3 + strlen(regimeId)+3 + strlen("{ regimeId }");
    if(regimeId == NULL) {
        goto end;
    }
    char* localVarToReplace_regimeId = malloc(sizeOfPathParams_regimeId);
    ...
    //nonprimitive not container
    cJSON *FiscalRegimesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    fiscal_regime_dto_envelope_t *elementToReturn = fiscal_regime_dto_envelope_parseFromJSON(FiscalRegimesAPIlocalVarJSON);
    cJSON_Delete(FiscalRegimesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FiscalRegimesAPI_getFiscalRegimes(apiClient_t *apiClient, char *tenantId, char *fiscalAuthorityId, char *authorityId, char *api_version, char *x_api_version, fiscal_regime_dto_collection_query_parameters_t *fiscal_regime_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Fiscals/Authorities/{authorityId}/FiscalRegimes")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Fiscals/Authorities/{authorityId}/FiscalRegimes");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_fiscal_regime_dto_collection_query_parameters = NULL;
    if (fiscal_regime_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_fiscal_regime_dto_collection_query_parameters = fiscal_regime_dto_collection_query_parameters_convertToJSON(fiscal_regime_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_fiscal_regime_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *FiscalRegimesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    fiscal_regime_dto_list_envelope_t *elementToReturn = fiscal_regime_dto_list_envelope_parseFromJSON(FiscalRegimesAPIlocalVarJSON);
    cJSON_Delete(FiscalRegimesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_fiscal_regime_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_fiscal_regime_dto_collection_query_parameters);
        localVarSingleItemJSON_fiscal_regime_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
FiscalRegimesAPI_getFiscalRegimesCount(apiClient_t *apiClient, char *tenantId, char *fiscalAuthorityId, char *api_version, char *x_api_version, fiscal_regime_dto_collection_query_parameters_t *fiscal_regime_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Fiscals/Authorities/{fiscalAuthorityId}/FiscalRegimes/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Fiscals/Authorities/{fiscalAuthorityId}/FiscalRegimes/Count");
    ...
    //nonprimitive not container
    cJSON *FiscalRegimesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(FiscalRegimesAPIlocalVarJSON);
    cJSON_Delete(FiscalRegimesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FiscalRegimesAPI_updateFiscalRegime(apiClient_t *apiClient, char *tenantId, char *regimeId, char *api_version, char *x_api_version, fiscal_regime_update_dto_t *fiscal_regime_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_fiscal_regime_update_dto = NULL;
    if (fiscal_regime_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_fiscal_regime_update_dto = fiscal_regime_update_dto_convertToJSON(fiscal_regime_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_fiscal_regime_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_fiscal_regime_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_fiscal_regime_update_dto);
        localVarSingleItemJSON_fiscal_regime_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
