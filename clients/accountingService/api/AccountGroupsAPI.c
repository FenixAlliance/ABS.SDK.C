...
AccountGroupsAPI_createAccountGroup(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, account_group_create_dto_t *account_group_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/AccountGroups")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/AccountGroups");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_account_group_create_dto = NULL;
    if (account_group_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_account_group_create_dto = account_group_create_dto_convertToJSON(account_group_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_account_group_create_dto);
    }
    ...
    cJSON *AccountGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    account_group_dto_envelope_t *elementToReturn = account_group_dto_envelope_parseFromJSON(AccountGroupsAPIlocalVarJSON);
    cJSON_Delete(AccountGroupsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_account_group_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_account_group_create_dto);
        localVarSingleItemJSON_account_group_create_dto = NULL;
    }
...
AccountGroupsAPI_deleteAccountGroup(apiClient_t *apiClient, char *tenantId, char *accountGroupId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/AccountGroups/{accountGroupId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/AccountGroups/{accountGroupId}");


    // Path Params
    long sizeOfPathParams_accountGroupId = strlen(accountGroupId)+3 + strlen("{ accountGroupId }");
    if(accountGroupId == NULL) {
        goto end;
    }
    char* localVarToReplace_accountGroupId = malloc(sizeOfPathParams_accountGroupId);
    sprintf(localVarToReplace_accountGroupId, "{%s}", "accountGroupId");

    localVarPath = strReplace(localVarPath, localVarToReplace_accountGroupId, accountGroupId);
    if(accountGroupId == NULL) {
        goto end;
    }
    char* localVarToReplace_accountGroupId = malloc(sizeOfPathParams_accountGroupId);
    ...
    free(localVarPath);
    free(localVarToReplace_accountGroupId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
AccountGroupsAPI_getAccountGroups(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, account_group_dto_collection_query_parameters_t *account_group_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *AccountGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    account_group_dto_list_envelope_t *elementToReturn = account_group_dto_list_envelope_parseFromJSON(AccountGroupsAPIlocalVarJSON);
    cJSON_Delete(AccountGroupsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AccountGroupsAPI_getAccountGroupsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, account_group_dto_collection_query_parameters_t *account_group_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/AccountGroups/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/AccountGroups/Count");
    ...
    //nonprimitive not container
    cJSON *AccountGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(AccountGroupsAPIlocalVarJSON);
    cJSON_Delete(AccountGroupsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AccountGroupsAPI_patchAccountGroupAsync(apiClient_t *apiClient, char *tenantId, char *accountGroupId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *AccountGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(AccountGroupsAPIlocalVarJSON);
    cJSON_Delete(AccountGroupsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AccountGroupsAPI_updateAccountGroup(apiClient_t *apiClient, char *tenantId, char *accountGroupId, char *api_version, char *x_api_version, account_group_update_dto_t *account_group_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_account_group_update_dto = NULL;
    if (account_group_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_account_group_update_dto = account_group_update_dto_convertToJSON(account_group_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_account_group_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_account_group_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_account_group_update_dto);
        localVarSingleItemJSON_account_group_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
