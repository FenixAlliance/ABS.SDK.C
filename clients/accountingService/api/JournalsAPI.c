...
JournalsAPI_aggregateJournalEntryCreditsAsync(apiClient_t *apiClient, char *tenantId, char *journalId, char *currencyId, char *api_version, char *x_api_version, journal_entry_dto_collection_query_parameters_t *journal_entry_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Journals/{journalId}/Entries/Aggregate/Credits")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Journals/{journalId}/Entries/Aggregate/Credits");


    // Path Params
    long sizeOfPathParams_journalId = strlen(journalId)+3 + strlen("{ journalId }");
    if(journalId == NULL) {
        goto end;
    }
    char* localVarToReplace_journalId = malloc(sizeOfPathParams_journalId);
    sprintf(localVarToReplace_journalId, "{%s}", "journalId");

    localVarPath = strReplace(localVarPath, localVarToReplace_journalId, journalId);
    if(journalId == NULL) {
        goto end;
    }
    char* localVarToReplace_journalId = malloc(sizeOfPathParams_journalId);
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_journal_entry_dto_collection_query_parameters = NULL;
    if (journal_entry_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_journal_entry_dto_collection_query_parameters = journal_entry_dto_collection_query_parameters_convertToJSON(journal_entry_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_journal_entry_dto_collection_query_parameters);
    }
    ...
    cJSON *JournalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    money_envelope_t *elementToReturn = money_envelope_parseFromJSON(JournalsAPIlocalVarJSON);
    cJSON_Delete(JournalsAPIlocalVarJSON);
    ...
    free(localVarPath);
    free(localVarToReplace_journalId);
    ...
    if (localVarSingleItemJSON_journal_entry_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_journal_entry_dto_collection_query_parameters);
        localVarSingleItemJSON_journal_entry_dto_collection_query_parameters = NULL;
    }
...
JournalsAPI_aggregateJournalEntryDebitsAsync(apiClient_t *apiClient, char *tenantId, char *journalId, char *currencyId, char *api_version, char *x_api_version, journal_entry_dto_collection_query_parameters_t *journal_entry_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Journals/{journalId}/Entries/Aggregate/Debits")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Journals/{journalId}/Entries/Aggregate/Debits");
...
JournalsAPI_assignJournalToBookAsync(apiClient_t *apiClient, char *tenantId, char *journalId, char *api_version, char *x_api_version, assign_journal_to_book_request_t *assign_journal_to_book_request)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Journals/{journalId}/AssignToBook")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Journals/{journalId}/AssignToBook");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_assign_journal_to_book_request = NULL;
    if (assign_journal_to_book_request != NULL)
    {
        //string
        localVarSingleItemJSON_assign_journal_to_book_request = assign_journal_to_book_request_convertToJSON(assign_journal_to_book_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_assign_journal_to_book_request);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *JournalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(JournalsAPIlocalVarJSON);
    cJSON_Delete(JournalsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_assign_journal_to_book_request) {
        cJSON_Delete(localVarSingleItemJSON_assign_journal_to_book_request);
        localVarSingleItemJSON_assign_journal_to_book_request = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
JournalsAPI_countJournalsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, journal_dto_collection_query_parameters_t *journal_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Journals/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Journals/Count");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_journal_dto_collection_query_parameters = NULL;
    if (journal_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_journal_dto_collection_query_parameters = journal_dto_collection_query_parameters_convertToJSON(journal_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_journal_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *JournalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(JournalsAPIlocalVarJSON);
    cJSON_Delete(JournalsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_journal_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_journal_dto_collection_query_parameters);
        localVarSingleItemJSON_journal_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
JournalsAPI_createJournalAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, journal_create_dto_t *journal_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Journals")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Journals");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_journal_create_dto = NULL;
    if (journal_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_journal_create_dto = journal_create_dto_convertToJSON(journal_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_journal_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_journal_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_journal_create_dto);
        localVarSingleItemJSON_journal_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
JournalsAPI_createJournalEntryAsync(apiClient_t *apiClient, char *tenantId, char *journalId, char *api_version, char *x_api_version, journal_entry_create_dto_t *journal_entry_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Journals/{journalId}/Entries")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Journals/{journalId}/Entries");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_journal_entry_create_dto = NULL;
    if (journal_entry_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_journal_entry_create_dto = journal_entry_create_dto_convertToJSON(journal_entry_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_journal_entry_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_journal_entry_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_journal_entry_create_dto);
        localVarSingleItemJSON_journal_entry_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
JournalsAPI_deleteJournalAsync(apiClient_t *apiClient, char *tenantId, char *journalId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Journals/{journalId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Journals/{journalId}");
...
JournalsAPI_deleteJournalEntryAsync(apiClient_t *apiClient, char *tenantId, char *journalId, char *entryId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Journals/{journalId}/Entries/{entryId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Journals/{journalId}/Entries/{entryId}");


    // Path Params
    long sizeOfPathParams_journalId = strlen(journalId)+3 + strlen(entryId)+3 + strlen("{ journalId }");
    if(journalId == NULL) {
        goto end;
    }
    char* localVarToReplace_journalId = malloc(sizeOfPathParams_journalId);
    ...
    // Path Params
    long sizeOfPathParams_entryId = strlen(journalId)+3 + strlen(entryId)+3 + strlen("{ entryId }");
    if(entryId == NULL) {
        goto end;
    }
...
JournalsAPI_getJournalDetailsAsync(apiClient_t *apiClient, char *tenantId, char *journalId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *JournalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    journal_dto_envelope_t *elementToReturn = journal_dto_envelope_parseFromJSON(JournalsAPIlocalVarJSON);
    cJSON_Delete(JournalsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
JournalsAPI_getJournalEntriesAsync(apiClient_t *apiClient, char *tenantId, char *journalId, char *api_version, char *x_api_version, journal_entry_dto_collection_query_parameters_t *journal_entry_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *JournalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    journal_entry_dto_i_read_only_list_envelope_t *elementToReturn = journal_entry_dto_i_read_only_list_envelope_parseFromJSON(JournalsAPIlocalVarJSON);
    cJSON_Delete(JournalsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
JournalsAPI_getJournalEntriesCountAsync(apiClient_t *apiClient, char *tenantId, char *journalId, char *api_version, char *x_api_version, journal_entry_dto_collection_query_parameters_t *journal_entry_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Journals/{journalId}/Entries/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Journals/{journalId}/Entries/Count");
...
JournalsAPI_getJournalEntryDetailsAsync(apiClient_t *apiClient, char *tenantId, char *journalId, char *entryId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *JournalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    journal_entry_dto_envelope_t *elementToReturn = journal_entry_dto_envelope_parseFromJSON(JournalsAPIlocalVarJSON);
    cJSON_Delete(JournalsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
JournalsAPI_getJournalsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, journal_dto_collection_query_parameters_t *journal_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *JournalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    journal_dto_i_read_only_list_envelope_t *elementToReturn = journal_dto_i_read_only_list_envelope_parseFromJSON(JournalsAPIlocalVarJSON);
    cJSON_Delete(JournalsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
JournalsAPI_postJournalEntryAsync(apiClient_t *apiClient, char *tenantId, char *journalId, char *entryId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Journals/{journalId}/Entries/{entryId}/Post")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Journals/{journalId}/Entries/{entryId}/Post");
...
JournalsAPI_reverseJournalEntryAsync(apiClient_t *apiClient, char *tenantId, char *journalId, char *entryId, char *api_version, char *x_api_version, reverse_journal_entry_request_t *reverse_journal_entry_request)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/Journals/{journalId}/Entries/{entryId}/Reverse")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/Journals/{journalId}/Entries/{entryId}/Reverse");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_reverse_journal_entry_request = NULL;
    if (reverse_journal_entry_request != NULL)
    {
        //string
        localVarSingleItemJSON_reverse_journal_entry_request = reverse_journal_entry_request_convertToJSON(reverse_journal_entry_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_reverse_journal_entry_request);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_reverse_journal_entry_request) {
        cJSON_Delete(localVarSingleItemJSON_reverse_journal_entry_request);
        localVarSingleItemJSON_reverse_journal_entry_request = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
JournalsAPI_updateJournalAsync(apiClient_t *apiClient, char *tenantId, char *journalId, char *api_version, char *x_api_version, journal_update_dto_t *journal_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_journal_update_dto = NULL;
    if (journal_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_journal_update_dto = journal_update_dto_convertToJSON(journal_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_journal_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_journal_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_journal_update_dto);
        localVarSingleItemJSON_journal_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
JournalsAPI_updateJournalEntryAsync(apiClient_t *apiClient, char *tenantId, char *journalId, char *entryId, char *api_version, char *x_api_version, journal_entry_update_dto_t *journal_entry_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_journal_entry_update_dto = NULL;
    if (journal_entry_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_journal_entry_update_dto = journal_entry_update_dto_convertToJSON(journal_entry_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_journal_entry_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_journal_entry_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_journal_entry_update_dto);
        localVarSingleItemJSON_journal_entry_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
