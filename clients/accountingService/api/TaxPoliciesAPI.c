...
TaxPoliciesAPI_createAppliedTaxPolicyRecord(apiClient_t *apiClient, char *tenantId, char *taxPolicyId, char *api_version, char *x_api_version, applied_tax_policy_record_create_dto_t *applied_tax_policy_record_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/TaxPolicies/{taxPolicyId}/AppliedTaxPolicyRecords")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/TaxPolicies/{taxPolicyId}/AppliedTaxPolicyRecords");


    // Path Params
    long sizeOfPathParams_taxPolicyId = strlen(taxPolicyId)+3 + strlen("{ taxPolicyId }");
    if(taxPolicyId == NULL) {
        goto end;
    }
    char* localVarToReplace_taxPolicyId = malloc(sizeOfPathParams_taxPolicyId);
    sprintf(localVarToReplace_taxPolicyId, "{%s}", "taxPolicyId");

    localVarPath = strReplace(localVarPath, localVarToReplace_taxPolicyId, taxPolicyId);
    if(taxPolicyId == NULL) {
        goto end;
    }
    char* localVarToReplace_taxPolicyId = malloc(sizeOfPathParams_taxPolicyId);
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_applied_tax_policy_record_create_dto = NULL;
    if (applied_tax_policy_record_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_applied_tax_policy_record_create_dto = applied_tax_policy_record_create_dto_convertToJSON(applied_tax_policy_record_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_applied_tax_policy_record_create_dto);
    }
    ...
    cJSON *TaxPoliciesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(TaxPoliciesAPIlocalVarJSON);
    cJSON_Delete(TaxPoliciesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_applied_tax_policy_record_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_applied_tax_policy_record_create_dto);
        localVarSingleItemJSON_applied_tax_policy_record_create_dto = NULL;
    }
...
TaxPoliciesAPI_createItemTaxPolicyRecord(apiClient_t *apiClient, char *tenantId, char *taxPolicyId, char *api_version, char *x_api_version, item_tax_policy_record_create_dto_t *item_tax_policy_record_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/TaxPolicies/{taxPolicyId}/ItemTaxPolicyRecords")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/TaxPolicies/{taxPolicyId}/ItemTaxPolicyRecords");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_tax_policy_record_create_dto = NULL;
    if (item_tax_policy_record_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_tax_policy_record_create_dto = item_tax_policy_record_create_dto_convertToJSON(item_tax_policy_record_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_tax_policy_record_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_item_tax_policy_record_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_tax_policy_record_create_dto);
        localVarSingleItemJSON_item_tax_policy_record_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
TaxPoliciesAPI_createTaxPolicy(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tax_policy_create_dto_t *tax_policy_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/TaxPolicies")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/TaxPolicies");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tax_policy_create_dto = NULL;
    if (tax_policy_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tax_policy_create_dto = tax_policy_create_dto_convertToJSON(tax_policy_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tax_policy_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tax_policy_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_tax_policy_create_dto);
        localVarSingleItemJSON_tax_policy_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
TaxPoliciesAPI_deleteAppliedTaxPolicyRecord(apiClient_t *apiClient, char *tenantId, char *taxPolicyId, char *appliedTaxPolicyRecordId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/TaxPolicies/{taxPolicyId}/AppliedTaxPolicyRecords/{appliedTaxPolicyRecordId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/TaxPolicies/{taxPolicyId}/AppliedTaxPolicyRecords/{appliedTaxPolicyRecordId}");


    // Path Params
    long sizeOfPathParams_taxPolicyId = strlen(taxPolicyId)+3 + strlen(appliedTaxPolicyRecordId)+3 + strlen("{ taxPolicyId }");
    if(taxPolicyId == NULL) {
        goto end;
    }
    char* localVarToReplace_taxPolicyId = malloc(sizeOfPathParams_taxPolicyId);
    ...
    // Path Params
    long sizeOfPathParams_appliedTaxPolicyRecordId = strlen(taxPolicyId)+3 + strlen(appliedTaxPolicyRecordId)+3 + strlen("{ appliedTaxPolicyRecordId }");
    if(appliedTaxPolicyRecordId == NULL) {
        goto end;
    }
    char* localVarToReplace_appliedTaxPolicyRecordId = malloc(sizeOfPathParams_appliedTaxPolicyRecordId);
    sprintf(localVarToReplace_appliedTaxPolicyRecordId, "{%s}", "appliedTaxPolicyRecordId");

    localVarPath = strReplace(localVarPath, localVarToReplace_appliedTaxPolicyRecordId, appliedTaxPolicyRecordId);
    if(appliedTaxPolicyRecordId == NULL) {
        goto end;
    }
    char* localVarToReplace_appliedTaxPolicyRecordId = malloc(sizeOfPathParams_appliedTaxPolicyRecordId);
    ...
    free(localVarPath);
    free(localVarToReplace_taxPolicyId);
    free(localVarToReplace_appliedTaxPolicyRecordId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
TaxPoliciesAPI_deleteItemTaxPolicyRecord(apiClient_t *apiClient, char *tenantId, char *taxPolicyId, char *itemTaxPolicyRecordId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/TaxPolicies/{taxPolicyId}/ItemTaxPolicyRecords/{itemTaxPolicyRecordId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/TaxPolicies/{taxPolicyId}/ItemTaxPolicyRecords/{itemTaxPolicyRecordId}");


    // Path Params
    long sizeOfPathParams_taxPolicyId = strlen(taxPolicyId)+3 + strlen(itemTaxPolicyRecordId)+3 + strlen("{ taxPolicyId }");
    if(taxPolicyId == NULL) {
        goto end;
    }
    char* localVarToReplace_taxPolicyId = malloc(sizeOfPathParams_taxPolicyId);
    ...
    // Path Params
    long sizeOfPathParams_itemTaxPolicyRecordId = strlen(taxPolicyId)+3 + strlen(itemTaxPolicyRecordId)+3 + strlen("{ itemTaxPolicyRecordId }");
    if(itemTaxPolicyRecordId == NULL) {
        goto end;
    }
    char* localVarToReplace_itemTaxPolicyRecordId = malloc(sizeOfPathParams_itemTaxPolicyRecordId);
    sprintf(localVarToReplace_itemTaxPolicyRecordId, "{%s}", "itemTaxPolicyRecordId");

    localVarPath = strReplace(localVarPath, localVarToReplace_itemTaxPolicyRecordId, itemTaxPolicyRecordId);
    if(itemTaxPolicyRecordId == NULL) {
        goto end;
    }
    char* localVarToReplace_itemTaxPolicyRecordId = malloc(sizeOfPathParams_itemTaxPolicyRecordId);
    ...
    free(localVarPath);
    free(localVarToReplace_taxPolicyId);
    free(localVarToReplace_itemTaxPolicyRecordId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
TaxPoliciesAPI_deleteTaxPolicy(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/TaxPolicies/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/TaxPolicies/{id}");
...
TaxPoliciesAPI_getAppliedTaxPolicyRecord(apiClient_t *apiClient, char *tenantId, char *taxPolicyId, char *appliedTaxPolicyRecordId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *TaxPoliciesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    applied_tax_policy_record_dto_envelope_t *elementToReturn = applied_tax_policy_record_dto_envelope_parseFromJSON(TaxPoliciesAPIlocalVarJSON);
    cJSON_Delete(TaxPoliciesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TaxPoliciesAPI_getAppliedTaxPolicyRecords(apiClient_t *apiClient, char *tenantId, char *taxPolicyId, char *api_version, char *x_api_version, applied_tax_policy_record_dto_collection_query_parameters_t *applied_tax_policy_record_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *TaxPoliciesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    applied_tax_policy_record_dto_list_envelope_t *elementToReturn = applied_tax_policy_record_dto_list_envelope_parseFromJSON(TaxPoliciesAPIlocalVarJSON);
    cJSON_Delete(TaxPoliciesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TaxPoliciesAPI_getAppliedTaxPolicyRecordsCount(apiClient_t *apiClient, char *tenantId, char *taxPolicyId, char *api_version, char *x_api_version, applied_tax_policy_record_dto_collection_query_parameters_t *applied_tax_policy_record_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/TaxPolicies/{taxPolicyId}/AppliedTaxPolicyRecords/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/TaxPolicies/{taxPolicyId}/AppliedTaxPolicyRecords/Count");
    ...
    //nonprimitive not container
    cJSON *TaxPoliciesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(TaxPoliciesAPIlocalVarJSON);
    cJSON_Delete(TaxPoliciesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TaxPoliciesAPI_getItemTaxPolicyRecord(apiClient_t *apiClient, char *tenantId, char *taxPolicyId, char *itemTaxPolicyRecordId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *TaxPoliciesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_tax_policy_record_dto_envelope_t *elementToReturn = item_tax_policy_record_dto_envelope_parseFromJSON(TaxPoliciesAPIlocalVarJSON);
    cJSON_Delete(TaxPoliciesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TaxPoliciesAPI_getItemTaxPolicyRecords(apiClient_t *apiClient, char *tenantId, char *taxPolicyId, char *api_version, char *x_api_version, item_tax_policy_record_dto_collection_query_parameters_t *item_tax_policy_record_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *TaxPoliciesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_tax_policy_record_dto_list_envelope_t *elementToReturn = item_tax_policy_record_dto_list_envelope_parseFromJSON(TaxPoliciesAPIlocalVarJSON);
    cJSON_Delete(TaxPoliciesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TaxPoliciesAPI_getTaxPolicies(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tax_policy_dto_collection_query_parameters_t *tax_policy_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *TaxPoliciesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tax_policy_dto_list_envelope_t *elementToReturn = tax_policy_dto_list_envelope_parseFromJSON(TaxPoliciesAPIlocalVarJSON);
    cJSON_Delete(TaxPoliciesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TaxPoliciesAPI_getTaxPoliciesByAuthority(apiClient_t *apiClient, char *tenantId, char *authorityId, char *api_version, char *x_api_version, tax_policy_dto_collection_query_parameters_t *tax_policy_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/TaxPolicies/ByAuthority/{authorityId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/TaxPolicies/ByAuthority/{authorityId}");
...
TaxPoliciesAPI_getTaxPoliciesCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tax_policy_dto_collection_query_parameters_t *tax_policy_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/TaxPolicies/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/TaxPolicies/Count");
...
TaxPoliciesAPI_getTaxPolicy(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *TaxPoliciesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tax_policy_dto_envelope_t *elementToReturn = tax_policy_dto_envelope_parseFromJSON(TaxPoliciesAPIlocalVarJSON);
    cJSON_Delete(TaxPoliciesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TaxPoliciesAPI_updateAppliedTaxPolicyRecord(apiClient_t *apiClient, char *tenantId, char *taxPolicyId, char *appliedTaxPolicyRecordId, char *api_version, char *x_api_version, applied_tax_policy_record_update_dto_t *applied_tax_policy_record_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_applied_tax_policy_record_update_dto = NULL;
    if (applied_tax_policy_record_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_applied_tax_policy_record_update_dto = applied_tax_policy_record_update_dto_convertToJSON(applied_tax_policy_record_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_applied_tax_policy_record_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_applied_tax_policy_record_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_applied_tax_policy_record_update_dto);
        localVarSingleItemJSON_applied_tax_policy_record_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
TaxPoliciesAPI_updateItemTaxPolicyRecord(apiClient_t *apiClient, char *tenantId, char *taxPolicyId, char *itemTaxPolicyRecordId, char *api_version, char *x_api_version, item_tax_policy_record_update_dto_t *item_tax_policy_record_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_tax_policy_record_update_dto = NULL;
    if (item_tax_policy_record_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_tax_policy_record_update_dto = item_tax_policy_record_update_dto_convertToJSON(item_tax_policy_record_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_tax_policy_record_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_item_tax_policy_record_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_tax_policy_record_update_dto);
        localVarSingleItemJSON_item_tax_policy_record_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
TaxPoliciesAPI_updateTaxPolicy(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, tax_policy_update_dto_t *tax_policy_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tax_policy_update_dto = NULL;
    if (tax_policy_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tax_policy_update_dto = tax_policy_update_dto_convertToJSON(tax_policy_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tax_policy_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tax_policy_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_tax_policy_update_dto);
        localVarSingleItemJSON_tax_policy_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
