...
#include <stdio.h>
#include <ctype.h>
#include "PostingExecutionsAPI.h"
...
PostingExecutionsAPI_countPostingExecutionsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, posting_execution_dto_collection_query_parameters_t *posting_execution_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/PostingExecutions/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/PostingExecutions/Count");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_posting_execution_dto_collection_query_parameters = NULL;
    if (posting_execution_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_posting_execution_dto_collection_query_parameters = posting_execution_dto_collection_query_parameters_convertToJSON(posting_execution_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_posting_execution_dto_collection_query_parameters);
    }
    ...
    cJSON *PostingExecutionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(PostingExecutionsAPIlocalVarJSON);
    cJSON_Delete(PostingExecutionsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_posting_execution_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_posting_execution_dto_collection_query_parameters);
        localVarSingleItemJSON_posting_execution_dto_collection_query_parameters = NULL;
    }
...
PostingExecutionsAPI_getPostingExecutionsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, posting_execution_dto_collection_query_parameters_t *posting_execution_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/PostingExecutions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/PostingExecutions");
    ...
    //nonprimitive not container
    cJSON *PostingExecutionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    posting_execution_dto_i_read_only_list_envelope_t *elementToReturn = posting_execution_dto_i_read_only_list_envelope_parseFromJSON(PostingExecutionsAPIlocalVarJSON);
    cJSON_Delete(PostingExecutionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
