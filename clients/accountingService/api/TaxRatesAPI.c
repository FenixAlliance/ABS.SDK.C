...
TaxRatesAPI_createTaxRate(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tax_rate_create_dto_t *tax_rate_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/TaxRates")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/TaxRates");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tax_rate_create_dto = NULL;
    if (tax_rate_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tax_rate_create_dto = tax_rate_create_dto_convertToJSON(tax_rate_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tax_rate_create_dto);
    }
    ...
    cJSON *TaxRatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(TaxRatesAPIlocalVarJSON);
    cJSON_Delete(TaxRatesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_tax_rate_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_tax_rate_create_dto);
        localVarSingleItemJSON_tax_rate_create_dto = NULL;
    }
...
TaxRatesAPI_deleteTaxRate(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/TaxRates/{id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/TaxRates/{id}");
...
TaxRatesAPI_getTaxRate(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *TaxRatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tax_rate_dto_envelope_t *elementToReturn = tax_rate_dto_envelope_parseFromJSON(TaxRatesAPIlocalVarJSON);
    cJSON_Delete(TaxRatesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TaxRatesAPI_getTaxRates(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tax_rate_dto_collection_query_parameters_t *tax_rate_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tax_rate_dto_collection_query_parameters = NULL;
    if (tax_rate_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_tax_rate_dto_collection_query_parameters = tax_rate_dto_collection_query_parameters_convertToJSON(tax_rate_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tax_rate_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *TaxRatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tax_rate_dto_list_envelope_t *elementToReturn = tax_rate_dto_list_envelope_parseFromJSON(TaxRatesAPIlocalVarJSON);
    cJSON_Delete(TaxRatesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tax_rate_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_tax_rate_dto_collection_query_parameters);
        localVarSingleItemJSON_tax_rate_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
TaxRatesAPI_getTaxRatesCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tax_rate_dto_collection_query_parameters_t *tax_rate_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/TaxRates/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/TaxRates/Count");
    ...
    //nonprimitive not container
    cJSON *TaxRatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(TaxRatesAPIlocalVarJSON);
    cJSON_Delete(TaxRatesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TaxRatesAPI_updateTaxRate(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, tax_rate_update_dto_t *tax_rate_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tax_rate_update_dto = NULL;
    if (tax_rate_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tax_rate_update_dto = tax_rate_update_dto_convertToJSON(tax_rate_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tax_rate_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tax_rate_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_tax_rate_update_dto);
        localVarSingleItemJSON_tax_rate_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
