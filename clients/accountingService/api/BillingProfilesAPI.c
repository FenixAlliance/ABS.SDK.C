...
BillingProfilesAPI_createBillingProfileAsync(apiClient_t *apiClient, char *tenantId, billing_profile_create_dto_t *billing_profile_create_dto, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/BillingProfiles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/BillingProfiles");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_billing_profile_create_dto = NULL;
    if (billing_profile_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_billing_profile_create_dto = billing_profile_create_dto_convertToJSON(billing_profile_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_billing_profile_create_dto);
    }
    ...
    cJSON *BillingProfilesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(BillingProfilesAPIlocalVarJSON);
    cJSON_Delete(BillingProfilesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_billing_profile_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_billing_profile_create_dto);
        localVarSingleItemJSON_billing_profile_create_dto = NULL;
    }
...
BillingProfilesAPI_deleteBillingProfileAsync(apiClient_t *apiClient, char *tenantId, char *billingProfileId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/BillingProfiles/{billingProfileId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/BillingProfiles/{billingProfileId}");


    // Path Params
    long sizeOfPathParams_billingProfileId = strlen(billingProfileId)+3 + strlen("{ billingProfileId }");
    if(billingProfileId == NULL) {
        goto end;
    }
    char* localVarToReplace_billingProfileId = malloc(sizeOfPathParams_billingProfileId);
    sprintf(localVarToReplace_billingProfileId, "{%s}", "billingProfileId");

    localVarPath = strReplace(localVarPath, localVarToReplace_billingProfileId, billingProfileId);
    if(billingProfileId == NULL) {
        goto end;
    }
    char* localVarToReplace_billingProfileId = malloc(sizeOfPathParams_billingProfileId);
    ...
    free(localVarPath);
    free(localVarToReplace_billingProfileId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
BillingProfilesAPI_getBillingProfileByIdAsync(apiClient_t *apiClient, char *tenantId, char *billingProfileId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *BillingProfilesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    billing_profile_dto_envelope_t *elementToReturn = billing_profile_dto_envelope_parseFromJSON(BillingProfilesAPIlocalVarJSON);
    cJSON_Delete(BillingProfilesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BillingProfilesAPI_getBillingProfilesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, billing_profile_dto_collection_query_parameters_t *billing_profile_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_billing_profile_dto_collection_query_parameters = NULL;
    if (billing_profile_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_billing_profile_dto_collection_query_parameters = billing_profile_dto_collection_query_parameters_convertToJSON(billing_profile_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_billing_profile_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *BillingProfilesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    billing_profile_dto_i_read_only_list_envelope_t *elementToReturn = billing_profile_dto_i_read_only_list_envelope_parseFromJSON(BillingProfilesAPIlocalVarJSON);
    cJSON_Delete(BillingProfilesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_billing_profile_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_billing_profile_dto_collection_query_parameters);
        localVarSingleItemJSON_billing_profile_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
BillingProfilesAPI_getBillingProfilesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, billing_profile_dto_collection_query_parameters_t *billing_profile_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/AccountingService/BillingProfiles/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/AccountingService/BillingProfiles/Count");
    ...
    //nonprimitive not container
    cJSON *BillingProfilesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(BillingProfilesAPIlocalVarJSON);
    cJSON_Delete(BillingProfilesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BillingProfilesAPI_updateBillingProfileAsync(apiClient_t *apiClient, char *tenantId, char *billingProfileId, billing_profile_update_dto_t *billing_profile_update_dto, char *api_version, char *x_api_version)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_billing_profile_update_dto = NULL;
    if (billing_profile_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_billing_profile_update_dto = billing_profile_update_dto_convertToJSON(billing_profile_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_billing_profile_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_billing_profile_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_billing_profile_update_dto);
        localVarSingleItemJSON_billing_profile_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
