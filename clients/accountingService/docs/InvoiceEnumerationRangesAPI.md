...
//
invoice_enumeration_range_dto_list_envelope_t* InvoiceEnumerationRangesAPI_getInvoiceEnumerationRangesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, invoice_enumeration_range_dto_collection_query_parameters_t *invoice_enumeration_range_dto_collection_query_parameters);
```
...
//
empty_envelope_t* InvoiceEnumerationRangesAPI_patchInvoiceEnumerationRangeAsync(apiClient_t *apiClient, char *tenantId, char *rangeId, char *api_version, char *x_api_version, list_t *patch_operation);
```
