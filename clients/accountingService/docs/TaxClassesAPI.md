...
//
tax_class_dto_list_envelope_t* TaxClassesAPI_getTaxClasses(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tax_class_dto_collection_query_parameters_t *tax_class_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**tax_class_dto_collection_query_parameters** | **[tax_class_dto_collection_query_parameters_t](tax_class_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* TaxClassesAPI_getTaxClassesCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tax_class_dto_collection_query_parameters_t *tax_class_dto_collection_query_parameters);
```
...
//
empty_envelope_t* TaxClassesAPI_patchTaxClass(apiClient_t *apiClient, char *tenantId, char *id, char *api_version, char *x_api_version, list_t *patch_operation);
```
