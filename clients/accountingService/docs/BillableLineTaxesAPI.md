...
[**BillableLineTaxesAPI_patchBillableLineTaxAsync**](BillableLineTaxesAPI.md#BillableLineTaxesAPI_patchBillableLineTaxAsync) | **PATCH** /api/v2/AccountingService/BillableLines/{billableLineId}/Taxes/{taxId} | Patch a billable line tax
...
# **BillableLineTaxesAPI_patchBillableLineTaxAsync**
```c
