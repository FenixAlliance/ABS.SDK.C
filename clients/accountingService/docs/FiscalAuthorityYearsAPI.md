...
//
fiscal_year_dto_list_envelope_t* FiscalAuthorityYearsAPI_getFiscalYears(apiClient_t *apiClient, char *tenantId, char *fiscalAuthorityId, char *authorityId, char *api_version, char *x_api_version, fiscal_year_dto_collection_query_parameters_t *fiscal_year_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**fiscal_year_dto_collection_query_parameters** | **[fiscal_year_dto_collection_query_parameters_t](fiscal_year_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* FiscalAuthorityYearsAPI_getFiscalYearsCount(apiClient_t *apiClient, char *tenantId, char *fiscalAuthorityId, char *api_version, char *x_api_version, fiscal_year_dto_collection_query_parameters_t *fiscal_year_dto_collection_query_parameters);
```
...
//
empty_envelope_t* FiscalAuthorityYearsAPI_patchFiscalAuthorityYearAsync(apiClient_t *apiClient, char *tenantId, char *fiscalYearId, char *api_version, char *x_api_version, list_t *patch_operation);
```
