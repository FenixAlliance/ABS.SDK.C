...
//
financial_book_dto_list_envelope_t* FinancialBooksAPI_getFinancialBooksAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, financial_book_dto_collection_query_parameters_t *financial_book_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**financial_book_dto_collection_query_parameters** | **[financial_book_dto_collection_query_parameters_t](financial_book_dto_collection_query_parameters.md) \*** |  | [optional] 
...
// Get the count of financial books.
//
int32_envelope_t* FinancialBooksAPI_getFinancialBooksCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, financial_book_dto_collection_query_parameters_t *financial_book_dto_collection_query_parameters);
```
...
//
empty_envelope_t* FinancialBooksAPI_patchFinancialBookAsync(apiClient_t *apiClient, char *tenantId, char *financialBookId, char *api_version, char *x_api_version, list_t *patch_operation);
```
