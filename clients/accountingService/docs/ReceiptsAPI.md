...
//
receipt_dto_i_read_only_list_envelope_t* ReceiptsAPI_getReceiptsAsync(apiClient_t *apiClient, char *tenantId, receipt_dto_collection_query_parameters_t *receipt_dto_collection_query_parameters);
```
...
**apiClient** | **apiClient_t \*** | context containing the client configuration |
**tenantId** | **char \*** |  | 
**receipt_dto_collection_query_parameters** | **[receipt_dto_collection_query_parameters_t](receipt_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* ReceiptsAPI_getReceiptsCountAsync(apiClient_t *apiClient, char *tenantId, receipt_dto_collection_query_parameters_t *receipt_dto_collection_query_parameters);
```
...
//
empty_envelope_t* ReceiptsAPI_patchReceiptAsync(apiClient_t *apiClient, char *tenantId, char *receiptId, list_t *patch_operation);
```
