...
//
fiscal_year_dto_i_read_only_list_envelope_t* FiscalYearsAPI_getFiscalYearsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, fiscal_year_dto_collection_query_parameters_t *fiscal_year_dto_collection_query_parameters);
```
...
//
int32_envelope_t* FiscalYearsAPI_getFiscalYearsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, fiscal_year_dto_collection_query_parameters_t *fiscal_year_dto_collection_query_parameters);
```
...
//
empty_envelope_t* FiscalYearsAPI_patchFiscalYearAsync(apiClient_t *apiClient, char *tenantId, char *fiscalYearId, char *api_version, char *x_api_version, list_t *patch_operation);
```
