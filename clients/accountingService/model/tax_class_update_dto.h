/*
 * tax_class_update_dto.h
 *
 * 
 */

#ifndef _tax_class_update_dto_H_
#define _tax_class_update_dto_H_
...
typedef struct tax_class_update_dto_t tax_class_update_dto_t;


// Enum TYPE for tax_class_update_dto

typedef enum  { accountingservice_tax_class_update_dto_TYPE_NULL = 0, accountingservice_tax_class_update_dto_TYPE_Tax, accountingservice_tax_class_update_dto_TYPE_Withholding } accountingservice_tax_class_update_dto_TYPE_e;
...
typedef struct tax_class_update_dto_t {
    char *name; // string
    accountingservice_tax_class_update_dto_TYPE_e type; //enum
    char *fiscal_authority_id; // string

} tax_class_update_dto_t;
...
#endif /* _tax_class_update_dto_H_ */
