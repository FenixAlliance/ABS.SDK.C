/*
 * transaction_category_create_dto.h
 *
 * 
 */

#ifndef _transaction_category_create_dto_H_
#define _transaction_category_create_dto_H_
...
typedef struct transaction_category_create_dto_t transaction_category_create_dto_t;




typedef struct transaction_category_create_dto_t {
    char *id; // string
...
#endif /* _transaction_category_create_dto_H_ */
