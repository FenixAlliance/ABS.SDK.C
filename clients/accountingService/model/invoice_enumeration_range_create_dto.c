...
invoice_enumeration_range_create_dto_t *invoice_enumeration_range_create_dto_create(
    ...
    invoice_enumeration_range_create_dto_local_var->tenant_id = tenant_id;
    invoice_enumeration_range_create_dto_local_var->enrollment_id = enrollment_id;
...
void invoice_enumeration_range_create_dto_free(invoice_enumeration_range_create_dto_t *invoice_enumeration_range_create_dto) {
    ...
    if (invoice_enumeration_range_create_dto->tenant_id) {
        free(invoice_enumeration_range_create_dto->tenant_id);
        invoice_enumeration_range_create_dto->tenant_id = NULL;
    }
    if (invoice_enumeration_range_create_dto->enrollment_id) {
        free(invoice_enumeration_range_create_dto->enrollment_id);
        invoice_enumeration_range_create_dto->enrollment_id = NULL;
    }
...
cJSON *invoice_enumeration_range_create_dto_convertToJSON(invoice_enumeration_range_create_dto_t *invoice_enumeration_range_create_dto) {
    ...
    // invoice_enumeration_range_create_dto->tenant_id
    if(invoice_enumeration_range_create_dto->tenant_id) {
    if(cJSON_AddStringToObject(item, "tenantId", invoice_enumeration_range_create_dto->tenant_id) == NULL) {
    goto fail; //String
    }
    }


    // invoice_enumeration_range_create_dto->enrollment_id
    if(invoice_enumeration_range_create_dto->enrollment_id) {
    if(cJSON_AddStringToObject(item, "enrollmentId", invoice_enumeration_range_create_dto->enrollment_id) == NULL) {
    goto fail; //String
    }
    }
...
invoice_enumeration_range_create_dto_t *invoice_enumeration_range_create_dto_parseFromJSON(cJSON *invoice_enumeration_range_create_dtoJSON){
    ...
    // invoice_enumeration_range_create_dto->tenant_id
    cJSON *tenant_id = cJSON_GetObjectItemCaseSensitive(invoice_enumeration_range_create_dtoJSON, "tenantId");
    if (tenant_id) { 
    ...
    // invoice_enumeration_range_create_dto->enrollment_id
    cJSON *enrollment_id = cJSON_GetObjectItemCaseSensitive(invoice_enumeration_range_create_dtoJSON, "enrollmentId");
    if (enrollment_id) { 
