/*
 * invoice_enumeration_range_create_dto.h
 *
 * 
 */

#ifndef _invoice_enumeration_range_create_dto_H_
#define _invoice_enumeration_range_create_dto_H_
...
typedef struct invoice_enumeration_range_create_dto_t invoice_enumeration_range_create_dto_t;


// Enum DOCUMENTTYPE for invoice_enumeration_range_create_dto

typedef enum  { accountingservice_invoice_enumeration_range_create_dto_DOCUMENTTYPE_NULL = 0, accountingservice_invoice_enumeration_range_create_dto_DOCUMENTTYPE_Standard, accountingservice_invoice_enumeration_range_create_dto_DOCUMENTTYPE_DebitNote, accountingservice_invoice_enumeration_range_create_dto_DOCUMENTTYPE_CreditNote } accountingservice_invoice_enumeration_range_create_dto_DOCUMENTTYPE_e;
...
typedef struct invoice_enumeration_range_create_dto_t {
    char *id; // string
    ...
    accountingservice_invoice_enumeration_range_create_dto_DOCUMENTTYPE_e document_type; //enum

} invoice_enumeration_range_create_dto_t;
...
#endif /* _invoice_enumeration_range_create_dto_H_ */
