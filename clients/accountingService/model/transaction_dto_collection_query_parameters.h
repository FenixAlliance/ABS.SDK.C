/*
 * transaction_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _transaction_dto_collection_query_parameters_H_
#define _transaction_dto_collection_query_parameters_H_
...
typedef struct transaction_dto_collection_query_parameters_t transaction_dto_collection_query_parameters_t;




typedef struct transaction_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} transaction_dto_collection_query_parameters_t;
...
#endif /* _transaction_dto_collection_query_parameters_H_ */
