...
typedef enum  { accountingservice_ledger_type_create_dto_LEDGERCLASS_NULL = 0, accountingservice_ledger_type_create_dto_LEDGERCLASS_Assets, accountingservice_ledger_type_create_dto_LEDGERCLASS_Equity, accountingservice_ledger_type_create_dto_LEDGERCLASS_Revenue, accountingservice_ledger_type_create_dto_LEDGERCLASS_Expense, accountingservice_ledger_type_create_dto_LEDGERCLASS_Liabilities } accountingservice_ledger_type_create_dto_LEDGERCLASS_e;
