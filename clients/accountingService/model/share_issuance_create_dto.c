...
share_issuance_create_dto_t *share_issuance_create_dto_create(
    ...
    share_issuance_create_dto_local_var->tenant_id = tenant_id;
    share_issuance_create_dto_local_var->enrollment_id = enrollment_id;
...
void share_issuance_create_dto_free(share_issuance_create_dto_t *share_issuance_create_dto) {
    ...
    if (share_issuance_create_dto->tenant_id) {
        free(share_issuance_create_dto->tenant_id);
        share_issuance_create_dto->tenant_id = NULL;
    }
    if (share_issuance_create_dto->enrollment_id) {
        free(share_issuance_create_dto->enrollment_id);
        share_issuance_create_dto->enrollment_id = NULL;
    }
...
cJSON *share_issuance_create_dto_convertToJSON(share_issuance_create_dto_t *share_issuance_create_dto) {
    ...
    // share_issuance_create_dto->tenant_id
    if(share_issuance_create_dto->tenant_id) {
    if(cJSON_AddStringToObject(item, "tenantId", share_issuance_create_dto->tenant_id) == NULL) {
    goto fail; //String
    }
    }


    // share_issuance_create_dto->enrollment_id
    if(share_issuance_create_dto->enrollment_id) {
    if(cJSON_AddStringToObject(item, "enrollmentId", share_issuance_create_dto->enrollment_id) == NULL) {
    goto fail; //String
    }
    }
...
share_issuance_create_dto_t *share_issuance_create_dto_parseFromJSON(cJSON *share_issuance_create_dtoJSON){
    ...
    // share_issuance_create_dto->tenant_id
    cJSON *tenant_id = cJSON_GetObjectItemCaseSensitive(share_issuance_create_dtoJSON, "tenantId");
    if (tenant_id) { 
    ...
    // share_issuance_create_dto->enrollment_id
    cJSON *enrollment_id = cJSON_GetObjectItemCaseSensitive(share_issuance_create_dtoJSON, "enrollmentId");
    if (enrollment_id) { 
