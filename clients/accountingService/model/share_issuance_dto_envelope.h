/*
 * share_issuance_dto_envelope.h
 *
 * 
 */

#ifndef _share_issuance_dto_envelope_H_
#define _share_issuance_dto_envelope_H_
...
typedef struct share_issuance_dto_envelope_t share_issuance_dto_envelope_t;

#include "share_issuance_dto.h"



typedef struct share_issuance_dto_envelope_t {
    int is_success; //boolean
    char *error_message; // string
    char *correlation_id; // string
    char *timestamp; //date time
    char *activity_id; // string
    struct share_issuance_dto_t *result; //model
...
#endif /* _share_issuance_dto_envelope_H_ */
