...
tax_rate_create_dto_t *tax_rate_create_dto_create(
    ...
    tax_rate_create_dto_local_var->tenant_id = tenant_id;
    ...
    tax_rate_create_dto_local_var->enrollment_id = enrollment_id;
...
void tax_rate_create_dto_free(tax_rate_create_dto_t *tax_rate_create_dto) {
    ...
    if (tax_rate_create_dto->tenant_id) {
        free(tax_rate_create_dto->tenant_id);
        tax_rate_create_dto->tenant_id = NULL;
    }
    ...
    if (tax_rate_create_dto->enrollment_id) {
        free(tax_rate_create_dto->enrollment_id);
        tax_rate_create_dto->enrollment_id = NULL;
    }
...
cJSON *tax_rate_create_dto_convertToJSON(tax_rate_create_dto_t *tax_rate_create_dto) {
    ...
    // tax_rate_create_dto->tenant_id
    if(tax_rate_create_dto->tenant_id) {
    if(cJSON_AddStringToObject(item, "tenantId", tax_rate_create_dto->tenant_id) == NULL) {
    goto fail; //String
    }
    }
    ...
    // tax_rate_create_dto->enrollment_id
    if(tax_rate_create_dto->enrollment_id) {
    if(cJSON_AddStringToObject(item, "enrollmentId", tax_rate_create_dto->enrollment_id) == NULL) {
    goto fail; //String
    }
    }
...
tax_rate_create_dto_t *tax_rate_create_dto_parseFromJSON(cJSON *tax_rate_create_dtoJSON){
    ...
    // tax_rate_create_dto->tenant_id
    cJSON *tenant_id = cJSON_GetObjectItemCaseSensitive(tax_rate_create_dtoJSON, "tenantId");
    if (tenant_id) { 
    ...
    // tax_rate_create_dto->enrollment_id
    cJSON *enrollment_id = cJSON_GetObjectItemCaseSensitive(tax_rate_create_dtoJSON, "enrollmentId");
    if (enrollment_id) { 
