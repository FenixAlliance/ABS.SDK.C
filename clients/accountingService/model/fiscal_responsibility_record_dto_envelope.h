/*
 * fiscal_responsibility_record_dto_envelope.h
 *
 * 
 */

#ifndef _fiscal_responsibility_record_dto_envelope_H_
#define _fiscal_responsibility_record_dto_envelope_H_
...
typedef struct fiscal_responsibility_record_dto_envelope_t fiscal_responsibility_record_dto_envelope_t;

#include "fiscal_responsibility_record_dto.h"



typedef struct fiscal_responsibility_record_dto_envelope_t {
    int is_success; //boolean
    char *error_message; // string
    char *correlation_id; // string
    char *timestamp; //date time
    char *activity_id; // string
    struct fiscal_responsibility_record_dto_t *result; //model
...
#endif /* _fiscal_responsibility_record_dto_envelope_H_ */
