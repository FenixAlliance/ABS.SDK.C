/*
 * bank_transaction_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _bank_transaction_dto_collection_query_parameters_H_
#define _bank_transaction_dto_collection_query_parameters_H_
...
typedef struct bank_transaction_dto_collection_query_parameters_t bank_transaction_dto_collection_query_parameters_t;




typedef struct bank_transaction_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} bank_transaction_dto_collection_query_parameters_t;
...
#endif /* _bank_transaction_dto_collection_query_parameters_H_ */
