...
// Enum TAXPAYERTYPE for billing_profile_update_dto

typedef enum  { accountingservice_billing_profile_update_dto_TAXPAYERTYPE_NULL = 0, accountingservice_billing_profile_update_dto_TAXPAYERTYPE_Individual, accountingservice_billing_profile_update_dto_TAXPAYERTYPE_Business } accountingservice_billing_profile_update_dto_TAXPAYERTYPE_e;
...
typedef struct billing_profile_update_dto_t {
    ...
    accountingservice_billing_profile_update_dto_TAXPAYERTYPE_e tax_payer_type; //enum
