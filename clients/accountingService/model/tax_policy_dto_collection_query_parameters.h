/*
 * tax_policy_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _tax_policy_dto_collection_query_parameters_H_
#define _tax_policy_dto_collection_query_parameters_H_
...
typedef struct tax_policy_dto_collection_query_parameters_t tax_policy_dto_collection_query_parameters_t;




typedef struct tax_policy_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} tax_policy_dto_collection_query_parameters_t;
...
#endif /* _tax_policy_dto_collection_query_parameters_H_ */
