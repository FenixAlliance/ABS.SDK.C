...
billing_profile_dto_i_read_only_list_envelope_t *billing_profile_dto_i_read_only_list_envelope_create(
    ...
    billing_profile_dto_i_read_only_list_envelope_local_var->http_status = http_status;
    billing_profile_dto_i_read_only_list_envelope_local_var->error_code = error_code;
    billing_profile_dto_i_read_only_list_envelope_local_var->validation_details = validation_details;
...
void billing_profile_dto_i_read_only_list_envelope_free(billing_profile_dto_i_read_only_list_envelope_t *billing_profile_dto_i_read_only_list_envelope) {
    ...
    if (billing_profile_dto_i_read_only_list_envelope->error_code) {
        free(billing_profile_dto_i_read_only_list_envelope->error_code);
        billing_profile_dto_i_read_only_list_envelope->error_code = NULL;
    }
    if (billing_profile_dto_i_read_only_list_envelope->validation_details) {
        list_ForEach(listEntry, billing_profile_dto_i_read_only_list_envelope->validation_details) {
            keyValuePair_t *localKeyValue = (keyValuePair_t*) listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_freeList(billing_profile_dto_i_read_only_list_envelope->validation_details);
        billing_profile_dto_i_read_only_list_envelope->validation_details = NULL;
    }
...
cJSON *billing_profile_dto_i_read_only_list_envelope_convertToJSON(billing_profile_dto_i_read_only_list_envelope_t *billing_profile_dto_i_read_only_list_envelope) {
    ...
    // billing_profile_dto_i_read_only_list_envelope->http_status
    if(billing_profile_dto_i_read_only_list_envelope->http_status) {
    if(cJSON_AddNumberToObject(item, "httpStatus", billing_profile_dto_i_read_only_list_envelope->http_status) == NULL) {
    goto fail; //Numeric
    }
    }


    // billing_profile_dto_i_read_only_list_envelope->error_code
    if(billing_profile_dto_i_read_only_list_envelope->error_code) {
    if(cJSON_AddStringToObject(item, "errorCode", billing_profile_dto_i_read_only_list_envelope->error_code) == NULL) {
    goto fail; //String
    }
    }


    // billing_profile_dto_i_read_only_list_envelope->validation_details
    if(billing_profile_dto_i_read_only_list_envelope->validation_details) {
    ...
    if (billing_profile_dto_i_read_only_list_envelope->validation_details) {
    list_ForEach(validation_detailsListEntry, billing_profile_dto_i_read_only_list_envelope->validation_details) {
...
billing_profile_dto_i_read_only_list_envelope_t *billing_profile_dto_i_read_only_list_envelope_parseFromJSON(cJSON *billing_profile_dto_i_read_only_list_envelopeJSON){
    ...
    // define the local map for billing_profile_dto_i_read_only_list_envelope->validation_details
    ...
    // billing_profile_dto_i_read_only_list_envelope->http_status
    cJSON *http_status = cJSON_GetObjectItemCaseSensitive(billing_profile_dto_i_read_only_list_envelopeJSON, "httpStatus");
    if (http_status) { 
    ...
    // billing_profile_dto_i_read_only_list_envelope->error_code
    cJSON *error_code = cJSON_GetObjectItemCaseSensitive(billing_profile_dto_i_read_only_list_envelopeJSON, "errorCode");
    if (error_code) { 
    ...
    // billing_profile_dto_i_read_only_list_envelope->validation_details
    cJSON *validation_details = cJSON_GetObjectItemCaseSensitive(billing_profile_dto_i_read_only_list_envelopeJSON, "validationDetails");
