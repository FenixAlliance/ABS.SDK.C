/*
 * journal_type_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _journal_type_dto_collection_query_parameters_H_
#define _journal_type_dto_collection_query_parameters_H_
...
typedef struct journal_type_dto_collection_query_parameters_t journal_type_dto_collection_query_parameters_t;




typedef struct journal_type_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} journal_type_dto_collection_query_parameters_t;
...
#endif /* _journal_type_dto_collection_query_parameters_H_ */
