/*
 * loan_application_dto.h
 *
 * 
 */

#ifndef _loan_application_dto_H_
#define _loan_application_dto_H_
...
typedef struct loan_application_dto_t loan_application_dto_t;




typedef struct loan_application_dto_t {
    char *id; // string
    char *timestamp; //date time
    char *tenant_id; // string
    char *enrollment_id; // string

} loan_application_dto_t;
...
#endif /* _loan_application_dto_H_ */
