/*
 * receipt_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _receipt_dto_collection_query_parameters_H_
#define _receipt_dto_collection_query_parameters_H_
...
typedef struct receipt_dto_collection_query_parameters_t receipt_dto_collection_query_parameters_t;




typedef struct receipt_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} receipt_dto_collection_query_parameters_t;
...
#endif /* _receipt_dto_collection_query_parameters_H_ */
