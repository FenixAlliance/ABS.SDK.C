/*
 * tax_rate_update_dto.h
 *
 * 
 */

#ifndef _tax_rate_update_dto_H_
#define _tax_rate_update_dto_H_
...
typedef struct tax_rate_update_dto_t tax_rate_update_dto_t;




typedef struct tax_rate_update_dto_t {
    char *name; // string
    double rate; //numeric
