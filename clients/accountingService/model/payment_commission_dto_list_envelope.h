/*
 * payment_commission_dto_list_envelope.h
 *
 * 
 */

#ifndef _payment_commission_dto_list_envelope_H_
#define _payment_commission_dto_list_envelope_H_
...
typedef struct payment_commission_dto_list_envelope_t payment_commission_dto_list_envelope_t;

#include "payment_commission_dto.h"



typedef struct payment_commission_dto_list_envelope_t {
...
#endif /* _payment_commission_dto_list_envelope_H_ */
