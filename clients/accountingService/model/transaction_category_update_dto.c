...
transaction_category_update_dto_t *transaction_category_update_dto_create(
    ...
    transaction_category_update_dto_local_var->enrollment_id = enrollment_id;
    transaction_category_update_dto_local_var->tenant_id = tenant_id;
...
void transaction_category_update_dto_free(transaction_category_update_dto_t *transaction_category_update_dto) {
    ...
    if (transaction_category_update_dto->enrollment_id) {
        free(transaction_category_update_dto->enrollment_id);
        transaction_category_update_dto->enrollment_id = NULL;
    }
    if (transaction_category_update_dto->tenant_id) {
        free(transaction_category_update_dto->tenant_id);
        transaction_category_update_dto->tenant_id = NULL;
    }
...
cJSON *transaction_category_update_dto_convertToJSON(transaction_category_update_dto_t *transaction_category_update_dto) {
    ...
    // transaction_category_update_dto->enrollment_id
    if(transaction_category_update_dto->enrollment_id) {
    if(cJSON_AddStringToObject(item, "enrollmentId", transaction_category_update_dto->enrollment_id) == NULL) {
    goto fail; //String
    }
    }


    // transaction_category_update_dto->tenant_id
    if(transaction_category_update_dto->tenant_id) {
    if(cJSON_AddStringToObject(item, "tenantId", transaction_category_update_dto->tenant_id) == NULL) {
    goto fail; //String
    }
    }
...
transaction_category_update_dto_t *transaction_category_update_dto_parseFromJSON(cJSON *transaction_category_update_dtoJSON){
    ...
    // transaction_category_update_dto->enrollment_id
    cJSON *enrollment_id = cJSON_GetObjectItemCaseSensitive(transaction_category_update_dtoJSON, "enrollmentId");
    if (enrollment_id) { 
    ...
    // transaction_category_update_dto->tenant_id
    cJSON *tenant_id = cJSON_GetObjectItemCaseSensitive(transaction_category_update_dtoJSON, "tenantId");
    if (tenant_id) { 
