...
#ifndef _account_group_dto_H_
#define _account_group_dto_H_
...
typedef struct account_group_dto_t account_group_dto_t;




typedef struct account_group_dto_t {
    char *id; // string
