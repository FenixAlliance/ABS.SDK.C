/*
 * loan_type_create_dto.h
 *
 * 
 */

#ifndef _loan_type_create_dto_H_
#define _loan_type_create_dto_H_
...
typedef struct loan_type_create_dto_t loan_type_create_dto_t;




typedef struct loan_type_create_dto_t {
    char *id; // string
    char *timestamp; //date time
    char *name; // string
    char *description; // string

} loan_type_create_dto_t;
...
#endif /* _loan_type_create_dto_H_ */
