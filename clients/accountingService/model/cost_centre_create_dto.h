/*
 * cost_centre_create_dto.h
 *
 * 
 */

#ifndef _cost_centre_create_dto_H_
#define _cost_centre_create_dto_H_
...
typedef struct cost_centre_create_dto_t cost_centre_create_dto_t;


// Enum COSTCENTRETYPE for cost_centre_create_dto

typedef enum  { accountingservice_cost_centre_create_dto_COSTCENTRETYPE_NULL = 0, accountingservice_cost_centre_create_dto_COSTCENTRETYPE_Service, accountingservice_cost_centre_create_dto_COSTCENTRETYPE_Production } accountingservice_cost_centre_create_dto_COSTCENTRETYPE_e;
...
typedef struct cost_centre_create_dto_t {
    char *id; // string
    char *timestamp; //date time
    char *name; // string
    int disabled; //boolean
    char *description; // string
    accountingservice_cost_centre_create_dto_COSTCENTRETYPE_e cost_centre_type; //enum
    char *tenant_id; // string
    char *cost_centres_group_id; // string
    char *parent_cost_centre_id; // string

} cost_centre_create_dto_t;
...
#endif /* _cost_centre_create_dto_H_ */
