/*
 * budget_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _budget_dto_collection_query_parameters_H_
#define _budget_dto_collection_query_parameters_H_
...
typedef struct budget_dto_collection_query_parameters_t budget_dto_collection_query_parameters_t;




typedef struct budget_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} budget_dto_collection_query_parameters_t;
...
#endif /* _budget_dto_collection_query_parameters_H_ */
