/*
 * accounting_entry_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _accounting_entry_dto_collection_query_parameters_H_
#define _accounting_entry_dto_collection_query_parameters_H_
...
typedef struct accounting_entry_dto_collection_query_parameters_t accounting_entry_dto_collection_query_parameters_t;




typedef struct accounting_entry_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} accounting_entry_dto_collection_query_parameters_t;
...
#endif /* _accounting_entry_dto_collection_query_parameters_H_ */
