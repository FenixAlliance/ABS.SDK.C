...
#ifndef _fiscal_regime_dto_H_
#define _fiscal_regime_dto_H_
...
typedef struct fiscal_regime_dto_t fiscal_regime_dto_t;




typedef struct fiscal_regime_dto_t {
    char *id; // string
