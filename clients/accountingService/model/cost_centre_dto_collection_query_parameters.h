/*
 * cost_centre_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _cost_centre_dto_collection_query_parameters_H_
#define _cost_centre_dto_collection_query_parameters_H_
...
typedef struct cost_centre_dto_collection_query_parameters_t cost_centre_dto_collection_query_parameters_t;




typedef struct cost_centre_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} cost_centre_dto_collection_query_parameters_t;
...
#endif /* _cost_centre_dto_collection_query_parameters_H_ */
