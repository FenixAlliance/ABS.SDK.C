/*
 * share_issuance_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _share_issuance_dto_collection_query_parameters_H_
#define _share_issuance_dto_collection_query_parameters_H_
...
typedef struct share_issuance_dto_collection_query_parameters_t share_issuance_dto_collection_query_parameters_t;




typedef struct share_issuance_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} share_issuance_dto_collection_query_parameters_t;
...
#endif /* _share_issuance_dto_collection_query_parameters_H_ */
