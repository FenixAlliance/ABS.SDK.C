/*
 * bank_transaction_dto.h
 *
 * 
 */

#ifndef _bank_transaction_dto_H_
#define _bank_transaction_dto_H_
...
typedef struct bank_transaction_dto_t bank_transaction_dto_t;




typedef struct bank_transaction_dto_t {
    char *id; // string
...
#endif /* _bank_transaction_dto_H_ */
