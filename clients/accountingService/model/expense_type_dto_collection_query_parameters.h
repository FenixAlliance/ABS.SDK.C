/*
 * expense_type_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _expense_type_dto_collection_query_parameters_H_
#define _expense_type_dto_collection_query_parameters_H_
...
typedef struct expense_type_dto_collection_query_parameters_t expense_type_dto_collection_query_parameters_t;




typedef struct expense_type_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} expense_type_dto_collection_query_parameters_t;
...
#endif /* _expense_type_dto_collection_query_parameters_H_ */
