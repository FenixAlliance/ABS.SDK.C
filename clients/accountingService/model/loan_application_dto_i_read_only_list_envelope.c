...
loan_application_dto_i_read_only_list_envelope_t *loan_application_dto_i_read_only_list_envelope_create(
    ...
    loan_application_dto_i_read_only_list_envelope_local_var->http_status = http_status;
    loan_application_dto_i_read_only_list_envelope_local_var->error_code = error_code;
    loan_application_dto_i_read_only_list_envelope_local_var->validation_details = validation_details;
...
void loan_application_dto_i_read_only_list_envelope_free(loan_application_dto_i_read_only_list_envelope_t *loan_application_dto_i_read_only_list_envelope) {
    ...
    if (loan_application_dto_i_read_only_list_envelope->error_code) {
        free(loan_application_dto_i_read_only_list_envelope->error_code);
        loan_application_dto_i_read_only_list_envelope->error_code = NULL;
    }
    if (loan_application_dto_i_read_only_list_envelope->validation_details) {
        list_ForEach(listEntry, loan_application_dto_i_read_only_list_envelope->validation_details) {
            keyValuePair_t *localKeyValue = (keyValuePair_t*) listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_freeList(loan_application_dto_i_read_only_list_envelope->validation_details);
        loan_application_dto_i_read_only_list_envelope->validation_details = NULL;
    }
...
cJSON *loan_application_dto_i_read_only_list_envelope_convertToJSON(loan_application_dto_i_read_only_list_envelope_t *loan_application_dto_i_read_only_list_envelope) {
    ...
    // loan_application_dto_i_read_only_list_envelope->http_status
    if(loan_application_dto_i_read_only_list_envelope->http_status) {
    if(cJSON_AddNumberToObject(item, "httpStatus", loan_application_dto_i_read_only_list_envelope->http_status) == NULL) {
    goto fail; //Numeric
    }
    }


    // loan_application_dto_i_read_only_list_envelope->error_code
    if(loan_application_dto_i_read_only_list_envelope->error_code) {
    if(cJSON_AddStringToObject(item, "errorCode", loan_application_dto_i_read_only_list_envelope->error_code) == NULL) {
    goto fail; //String
    }
    }


    // loan_application_dto_i_read_only_list_envelope->validation_details
    if(loan_application_dto_i_read_only_list_envelope->validation_details) {
    ...
    if (loan_application_dto_i_read_only_list_envelope->validation_details) {
    list_ForEach(validation_detailsListEntry, loan_application_dto_i_read_only_list_envelope->validation_details) {
...
loan_application_dto_i_read_only_list_envelope_t *loan_application_dto_i_read_only_list_envelope_parseFromJSON(cJSON *loan_application_dto_i_read_only_list_envelopeJSON){
    ...
    // define the local map for loan_application_dto_i_read_only_list_envelope->validation_details
    ...
    // loan_application_dto_i_read_only_list_envelope->http_status
    cJSON *http_status = cJSON_GetObjectItemCaseSensitive(loan_application_dto_i_read_only_list_envelopeJSON, "httpStatus");
    if (http_status) { 
    ...
    // loan_application_dto_i_read_only_list_envelope->error_code
    cJSON *error_code = cJSON_GetObjectItemCaseSensitive(loan_application_dto_i_read_only_list_envelopeJSON, "errorCode");
    if (error_code) { 
    ...
    // loan_application_dto_i_read_only_list_envelope->validation_details
    cJSON *validation_details = cJSON_GetObjectItemCaseSensitive(loan_application_dto_i_read_only_list_envelopeJSON, "validationDetails");
