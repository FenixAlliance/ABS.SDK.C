/*
 * payment_commission_dto.h
 *
 * 
 */

#ifndef _payment_commission_dto_H_
#define _payment_commission_dto_H_
...
typedef struct payment_commission_dto_t payment_commission_dto_t;




typedef struct payment_commission_dto_t {
    char *id; // string
...
#endif /* _payment_commission_dto_H_ */
