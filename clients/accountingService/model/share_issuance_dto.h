/*
 * share_issuance_dto.h
 *
 * 
 */

#ifndef _share_issuance_dto_H_
#define _share_issuance_dto_H_
...
typedef struct share_issuance_dto_t share_issuance_dto_t;




typedef struct share_issuance_dto_t {
    char *id; // string
