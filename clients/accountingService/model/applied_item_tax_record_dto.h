/*
 * applied_item_tax_record_dto.h
 *
 * 
 */

#ifndef _applied_item_tax_record_dto_H_
#define _applied_item_tax_record_dto_H_
...
typedef struct applied_item_tax_record_dto_t applied_item_tax_record_dto_t;




typedef struct applied_item_tax_record_dto_t {
    char *id; // string
...
#endif /* _applied_item_tax_record_dto_H_ */
