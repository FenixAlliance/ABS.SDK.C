/*
 * transaction_category_dto_list_envelope.h
 *
 * 
 */

#ifndef _transaction_category_dto_list_envelope_H_
#define _transaction_category_dto_list_envelope_H_
...
typedef struct transaction_category_dto_list_envelope_t transaction_category_dto_list_envelope_t;

#include "transaction_category_dto.h"



typedef struct transaction_category_dto_list_envelope_t {
...
#endif /* _transaction_category_dto_list_envelope_H_ */
