/*
 * journal_dto_envelope.h
 *
 * 
 */

#ifndef _journal_dto_envelope_H_
#define _journal_dto_envelope_H_
...
typedef struct journal_dto_envelope_t journal_dto_envelope_t;

#include "journal_dto.h"



typedef struct journal_dto_envelope_t {
    int is_success; //boolean
    char *error_message; // string
    char *correlation_id; // string
    char *timestamp; //date time
    char *activity_id; // string
    struct journal_dto_t *result; //model
...
#endif /* _journal_dto_envelope_H_ */
