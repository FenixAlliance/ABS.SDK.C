/*
 * payment_commission_create_dto.h
 *
 * 
 */

#ifndef _payment_commission_create_dto_H_
#define _payment_commission_create_dto_H_
...
typedef struct payment_commission_create_dto_t payment_commission_create_dto_t;




typedef struct payment_commission_create_dto_t {
    char *id; // string
    char *timestamp; //date time
    char *payment_id; // string

} payment_commission_create_dto_t;
...
#endif /* _payment_commission_create_dto_H_ */
