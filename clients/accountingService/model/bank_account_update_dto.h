...
// Enum ACCOUNTCATEGORY for bank_account_update_dto

typedef enum  { accountingservice_bank_account_update_dto_ACCOUNTCATEGORY_NULL = 0, accountingservice_bank_account_update_dto_ACCOUNTCATEGORY_Assets, accountingservice_bank_account_update_dto_ACCOUNTCATEGORY_Equity, accountingservice_bank_account_update_dto_ACCOUNTCATEGORY_Revenue, accountingservice_bank_account_update_dto_ACCOUNTCATEGORY_Expense, accountingservice_bank_account_update_dto_ACCOUNTCATEGORY_Liabilities } accountingservice_bank_account_update_dto_ACCOUNTCATEGORY_e;
...
typedef struct bank_account_update_dto_t {
    ...
    accountingservice_bank_account_update_dto_ACCOUNTCATEGORY_e account_category; //enum
    char *iban; // string
    char *swift; // string
