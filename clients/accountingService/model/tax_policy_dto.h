...
#ifndef _tax_policy_dto_H_
#define _tax_policy_dto_H_
...
typedef struct tax_policy_dto_t tax_policy_dto_t;




typedef struct tax_policy_dto_t {
    char *id; // string
