...
fiscal_identification_type_dto_list_envelope_t *fiscal_identification_type_dto_list_envelope_create(
    ...
    fiscal_identification_type_dto_list_envelope_local_var->http_status = http_status;
    fiscal_identification_type_dto_list_envelope_local_var->error_code = error_code;
    fiscal_identification_type_dto_list_envelope_local_var->validation_details = validation_details;
...
void fiscal_identification_type_dto_list_envelope_free(fiscal_identification_type_dto_list_envelope_t *fiscal_identification_type_dto_list_envelope) {
    ...
    if (fiscal_identification_type_dto_list_envelope->error_code) {
        free(fiscal_identification_type_dto_list_envelope->error_code);
        fiscal_identification_type_dto_list_envelope->error_code = NULL;
    }
    if (fiscal_identification_type_dto_list_envelope->validation_details) {
        list_ForEach(listEntry, fiscal_identification_type_dto_list_envelope->validation_details) {
            keyValuePair_t *localKeyValue = (keyValuePair_t*) listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_freeList(fiscal_identification_type_dto_list_envelope->validation_details);
        fiscal_identification_type_dto_list_envelope->validation_details = NULL;
    }
...
cJSON *fiscal_identification_type_dto_list_envelope_convertToJSON(fiscal_identification_type_dto_list_envelope_t *fiscal_identification_type_dto_list_envelope) {
    ...
    // fiscal_identification_type_dto_list_envelope->http_status
    if(fiscal_identification_type_dto_list_envelope->http_status) {
    if(cJSON_AddNumberToObject(item, "httpStatus", fiscal_identification_type_dto_list_envelope->http_status) == NULL) {
    goto fail; //Numeric
    }
    }


    // fiscal_identification_type_dto_list_envelope->error_code
    if(fiscal_identification_type_dto_list_envelope->error_code) {
    if(cJSON_AddStringToObject(item, "errorCode", fiscal_identification_type_dto_list_envelope->error_code) == NULL) {
    goto fail; //String
    }
    }


    // fiscal_identification_type_dto_list_envelope->validation_details
    if(fiscal_identification_type_dto_list_envelope->validation_details) {
    ...
    if (fiscal_identification_type_dto_list_envelope->validation_details) {
    list_ForEach(validation_detailsListEntry, fiscal_identification_type_dto_list_envelope->validation_details) {
...
fiscal_identification_type_dto_list_envelope_t *fiscal_identification_type_dto_list_envelope_parseFromJSON(cJSON *fiscal_identification_type_dto_list_envelopeJSON){
    ...
    // define the local map for fiscal_identification_type_dto_list_envelope->validation_details
    ...
    // fiscal_identification_type_dto_list_envelope->http_status
    cJSON *http_status = cJSON_GetObjectItemCaseSensitive(fiscal_identification_type_dto_list_envelopeJSON, "httpStatus");
    if (http_status) { 
    ...
    // fiscal_identification_type_dto_list_envelope->error_code
    cJSON *error_code = cJSON_GetObjectItemCaseSensitive(fiscal_identification_type_dto_list_envelopeJSON, "errorCode");
    if (error_code) { 
    ...
    // fiscal_identification_type_dto_list_envelope->validation_details
    cJSON *validation_details = cJSON_GetObjectItemCaseSensitive(fiscal_identification_type_dto_list_envelopeJSON, "validationDetails");
