...
tax_policy_dto_envelope_t *tax_policy_dto_envelope_create(
    ...
    tax_policy_dto_envelope_local_var->http_status = http_status;
    tax_policy_dto_envelope_local_var->error_code = error_code;
    tax_policy_dto_envelope_local_var->validation_details = validation_details;
...
void tax_policy_dto_envelope_free(tax_policy_dto_envelope_t *tax_policy_dto_envelope) {
    ...
    if (tax_policy_dto_envelope->error_code) {
        free(tax_policy_dto_envelope->error_code);
        tax_policy_dto_envelope->error_code = NULL;
    }
    if (tax_policy_dto_envelope->validation_details) {
        list_ForEach(listEntry, tax_policy_dto_envelope->validation_details) {
            keyValuePair_t *localKeyValue = (keyValuePair_t*) listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_freeList(tax_policy_dto_envelope->validation_details);
        tax_policy_dto_envelope->validation_details = NULL;
    }
...
cJSON *tax_policy_dto_envelope_convertToJSON(tax_policy_dto_envelope_t *tax_policy_dto_envelope) {
    ...
    // tax_policy_dto_envelope->http_status
    if(tax_policy_dto_envelope->http_status) {
    if(cJSON_AddNumberToObject(item, "httpStatus", tax_policy_dto_envelope->http_status) == NULL) {
    goto fail; //Numeric
    }
    }


    // tax_policy_dto_envelope->error_code
    if(tax_policy_dto_envelope->error_code) {
    if(cJSON_AddStringToObject(item, "errorCode", tax_policy_dto_envelope->error_code) == NULL) {
    goto fail; //String
    }
    }


    // tax_policy_dto_envelope->validation_details
    if(tax_policy_dto_envelope->validation_details) {
    ...
    if (tax_policy_dto_envelope->validation_details) {
    list_ForEach(validation_detailsListEntry, tax_policy_dto_envelope->validation_details) {
...
tax_policy_dto_envelope_t *tax_policy_dto_envelope_parseFromJSON(cJSON *tax_policy_dto_envelopeJSON){
    ...
    // define the local map for tax_policy_dto_envelope->validation_details
    ...
    // tax_policy_dto_envelope->http_status
    cJSON *http_status = cJSON_GetObjectItemCaseSensitive(tax_policy_dto_envelopeJSON, "httpStatus");
    if (http_status) { 
    ...
    // tax_policy_dto_envelope->error_code
    cJSON *error_code = cJSON_GetObjectItemCaseSensitive(tax_policy_dto_envelopeJSON, "errorCode");
    if (error_code) { 
    ...
    // tax_policy_dto_envelope->validation_details
    cJSON *validation_details = cJSON_GetObjectItemCaseSensitive(tax_policy_dto_envelopeJSON, "validationDetails");
