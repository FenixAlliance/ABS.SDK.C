...
#include <stdio.h>
#include <ctype.h>
#include "FenixAlliancePortalsWebsiteAPI.h"
...
FenixAlliancePortalsWebsiteAPI_accountLogoutPost(apiClient_t *apiClient, char *returnUrl)
{
    ...
    // create the path
    long sizeOfPath = strlen("/Account/Logout")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/Account/Logout");




    // form parameters
    char *keyForm_returnUrl = NULL;
    char * valueForm_returnUrl = 0;
    keyValuePair_t *keyPairForm_returnUrl = 0;
    if (returnUrl != NULL)
    {
        keyForm_returnUrl = strdup("returnUrl");
        valueForm_returnUrl = strdup((returnUrl));
        keyPairForm_returnUrl = keyValuePair_create(keyForm_returnUrl,valueForm_returnUrl);
        list_addElement(localVarFormParameters,keyPairForm_returnUrl);
    }
    ...
    free(localVarPath);
    if (keyForm_returnUrl) {
        free(keyForm_returnUrl);
        keyForm_returnUrl = NULL;
    }
    if (valueForm_returnUrl) {
        free(valueForm_returnUrl);
        valueForm_returnUrl = NULL;
    }
    keyValuePair_free(keyPairForm_returnUrl);
...
FenixAlliancePortalsWebsiteAPI_accountManageDownloadPersonalDataPost(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/Account/Manage/DownloadPersonalData")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/Account/Manage/DownloadPersonalData");
...
FenixAlliancePortalsWebsiteAPI_accountManageLinkExternalLoginPost(apiClient_t *apiClient, char *provider)
{
    ...
    // create the path
    long sizeOfPath = strlen("/Account/Manage/LinkExternalLogin")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/Account/Manage/LinkExternalLogin");




    // form parameters
    char *keyForm_provider = NULL;
    char * valueForm_provider = 0;
    keyValuePair_t *keyPairForm_provider = 0;
    if (provider != NULL)
    {
        keyForm_provider = strdup("provider");
        valueForm_provider = strdup((provider));
        keyPairForm_provider = keyValuePair_create(keyForm_provider,valueForm_provider);
        list_addElement(localVarFormParameters,keyPairForm_provider);
    }
    list_addElement(localVarContentType,"multipart/form-data"); //consumes
    list_addElement(localVarContentType,"application/x-www-form-urlencoded"); //consumes
    apiClient_invoke(apiClient,
    ...
    free(localVarPath);
    if (keyForm_provider) {
        free(keyForm_provider);
        keyForm_provider = NULL;
    }
    if (valueForm_provider) {
        free(valueForm_provider);
        valueForm_provider = NULL;
    }
    keyValuePair_free(keyPairForm_provider);
...
FenixAlliancePortalsWebsiteAPI_accountPerformExternalLoginPost(apiClient_t *apiClient, char *provider, char *returnUrl)
{
    ...
    // create the path
    long sizeOfPath = strlen("/Account/PerformExternalLogin")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/Account/PerformExternalLogin");
...
FenixAlliancePortalsWebsiteAPI_loginPost(apiClient_t *apiClient, login_request_t *login_request, int *useCookies, int *useSessionCookies)
{
    ...
    cJSON *FenixAlliancePortalsWebsiteAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    access_token_response_t *elementToReturn = access_token_response_parseFromJSON(FenixAlliancePortalsWebsiteAPIlocalVarJSON);
    cJSON_Delete(FenixAlliancePortalsWebsiteAPIlocalVarJSON);
...
FenixAlliancePortalsWebsiteAPI_manage2faPost(apiClient_t *apiClient, two_factor_request_t *two_factor_request)
{
    ...
    //nonprimitive not container
    cJSON *FenixAlliancePortalsWebsiteAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    two_factor_response_t *elementToReturn = two_factor_response_parseFromJSON(FenixAlliancePortalsWebsiteAPIlocalVarJSON);
    cJSON_Delete(FenixAlliancePortalsWebsiteAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FenixAlliancePortalsWebsiteAPI_manageInfoGet(apiClient_t *apiClient)
{
    ...
    //nonprimitive not container
    cJSON *FenixAlliancePortalsWebsiteAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    info_response_t *elementToReturn = info_response_parseFromJSON(FenixAlliancePortalsWebsiteAPIlocalVarJSON);
    cJSON_Delete(FenixAlliancePortalsWebsiteAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
