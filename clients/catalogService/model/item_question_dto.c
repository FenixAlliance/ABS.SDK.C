...
item_question_dto_t *item_question_dto_create(
    ...
    if (!item_question_dto_local_var) {
        return NULL;
    }
    item_question_dto_local_var->id = id;
    item_question_dto_local_var->timestamp = timestamp;
    item_question_dto_local_var->title = title;
...
void item_question_dto_free(item_question_dto_t *item_question_dto) {
    if(NULL == item_question_dto){
        return ;
    }
    listEntry_t *listEntry;
    if (item_question_dto->id) {
        free(item_question_dto->id);
        item_question_dto->id = NULL;
    }
    if (item_question_dto->timestamp) {
        free(item_question_dto->timestamp);
        item_question_dto->timestamp = NULL;
    }
    if (item_question_dto->title) {
        free(item_question_dto->title);
        item_question_dto->title = NULL;
    }
    if (item_question_dto->question) {
        free(item_question_dto->question);
        item_question_dto->question = NULL;
    }
    ...
    if (item_question_dto->item_id) {
        ...
        item_question_dto->item_id = NULL;
    }
    free(item_question_dto);
}

cJSON *item_question_dto_convertToJSON(item_question_dto_t *item_question_dto) {
    cJSON *item = cJSON_CreateObject();

    // item_question_dto->id
    if(item_question_dto->id) {
    if(cJSON_AddStringToObject(item, "id", item_question_dto->id) == NULL) {
    goto fail; //String
    }
    }


    // item_question_dto->timestamp
    if(item_question_dto->timestamp) {
    if(cJSON_AddStringToObject(item, "timestamp", item_question_dto->timestamp) == NULL) {
    goto fail; //Date-Time
    }
    }


    // item_question_dto->title
    if(item_question_dto->title) {
    if(cJSON_AddStringToObject(item, "title", item_question_dto->title) == NULL) {
    goto fail; //String
    }
    }


    // item_question_dto->needs_revision
    if(item_question_dto->needs_revision) {
    if(cJSON_AddBoolToObject(item, "needsRevision", item_question_dto->needs_revision) == NULL) {
    goto fail; //Bool
    }
    }


    // item_question_dto->question
    if(item_question_dto->question) {
    if(cJSON_AddStringToObject(item, "question", item_question_dto->question) == NULL) {
    goto fail; //String
    }
    }
...
item_question_dto_t *item_question_dto_parseFromJSON(cJSON *item_question_dtoJSON){
    ...
    item_question_dto_t *item_question_dto_local_var = NULL;

    // item_question_dto->id
    cJSON *id = cJSON_GetObjectItemCaseSensitive(item_question_dtoJSON, "id");
    if (id) { 
    ...
    // item_question_dto->timestamp
    cJSON *timestamp = cJSON_GetObjectItemCaseSensitive(item_question_dtoJSON, "timestamp");
    if (timestamp) { 
    ...
    // item_question_dto->title
    cJSON *title = cJSON_GetObjectItemCaseSensitive(item_question_dtoJSON, "title");
    if (title) { 
    ...
    // item_question_dto->needs_revision
    cJSON *needs_revision = cJSON_GetObjectItemCaseSensitive(item_question_dtoJSON, "needsRevision");
    if (needs_revision) { 
    ...
    // item_question_dto->question
    cJSON *question = cJSON_GetObjectItemCaseSensitive(item_question_dtoJSON, "question");
    if (question) { 
    ...
    item_question_dto_local_var = item_question_dto_create (
