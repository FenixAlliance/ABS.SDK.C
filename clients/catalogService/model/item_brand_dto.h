...
#ifndef _item_brand_dto_H_
#define _item_brand_dto_H_
...
typedef struct item_brand_dto_t item_brand_dto_t;




typedef struct item_brand_dto_t {
    char *id; // string
