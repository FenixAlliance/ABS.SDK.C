...
#ifndef _catalog_item_dto_H_
#define _catalog_item_dto_H_
...
typedef struct catalog_item_dto_t catalog_item_dto_t;




typedef struct catalog_item_dto_t {
    char *id; // string
