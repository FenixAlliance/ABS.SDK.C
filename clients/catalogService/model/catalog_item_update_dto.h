/*
 * catalog_item_update_dto.h
 *
 * 
 */

#ifndef _catalog_item_update_dto_H_
#define _catalog_item_update_dto_H_
...
typedef struct catalog_item_update_dto_t catalog_item_update_dto_t;




typedef struct catalog_item_update_dto_t {
    int hot; //boolean
    char *sku; // string
    char *upc; // string
    char *ean; // string
...
#endif /* _catalog_item_update_dto_H_ */
