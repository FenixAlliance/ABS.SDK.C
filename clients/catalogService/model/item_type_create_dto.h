/*
 * item_type_create_dto.h
 *
 * 
 */

#ifndef _item_type_create_dto_H_
#define _item_type_create_dto_H_
...
typedef struct item_type_create_dto_t item_type_create_dto_t;




typedef struct item_type_create_dto_t {
    char *id; // string
...
#endif /* _item_type_create_dto_H_ */
