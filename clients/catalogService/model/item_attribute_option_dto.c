...
item_attribute_option_dto_t *item_attribute_option_dto_create(
    ...
    item_attribute_option_dto_local_var->id = id;
...
void item_attribute_option_dto_free(item_attribute_option_dto_t *item_attribute_option_dto) {
    if(NULL == item_attribute_option_dto){
        return ;
    }
    listEntry_t *listEntry;
    if (item_attribute_option_dto->id) {
        free(item_attribute_option_dto->id);
        item_attribute_option_dto->id = NULL;
    }
    if (item_attribute_option_dto->timestamp) {
        free(item_attribute_option_dto->timestamp);
        item_attribute_option_dto->timestamp = NULL;
    }
    if (item_attribute_option_dto->name) {
        free(item_attribute_option_dto->name);
        item_attribute_option_dto->name = NULL;
    }
...
cJSON *item_attribute_option_dto_convertToJSON(item_attribute_option_dto_t *item_attribute_option_dto) {
    ...
    // item_attribute_option_dto->id
    if(item_attribute_option_dto->id) {
    if(cJSON_AddStringToObject(item, "id", item_attribute_option_dto->id) == NULL) {
    goto fail; //String
    }
    }


    // item_attribute_option_dto->timestamp
    if(item_attribute_option_dto->timestamp) {
    if(cJSON_AddStringToObject(item, "timestamp", item_attribute_option_dto->timestamp) == NULL) {
    goto fail; //Date-Time
    }
    }


    // item_attribute_option_dto->name
    if(item_attribute_option_dto->name) {
    if(cJSON_AddStringToObject(item, "name", item_attribute_option_dto->name) == NULL) {
    goto fail; //String
    }
    }
...
item_attribute_option_dto_t *item_attribute_option_dto_parseFromJSON(cJSON *item_attribute_option_dtoJSON){
    ...
    item_attribute_option_dto_t *item_attribute_option_dto_local_var = NULL;

    // item_attribute_option_dto->id
    cJSON *id = cJSON_GetObjectItemCaseSensitive(item_attribute_option_dtoJSON, "id");
    if (id) { 
    ...
    // item_attribute_option_dto->timestamp
    cJSON *timestamp = cJSON_GetObjectItemCaseSensitive(item_attribute_option_dtoJSON, "timestamp");
    if (timestamp) { 
    ...
    // item_attribute_option_dto->name
    cJSON *name = cJSON_GetObjectItemCaseSensitive(item_attribute_option_dtoJSON, "name");
    if (name) { 
    ...
    // item_attribute_option_dto->description
    cJSON *description = cJSON_GetObjectItemCaseSensitive(item_attribute_option_dtoJSON, "description");
    if (description) { 
    ...
    item_attribute_option_dto_local_var = item_attribute_option_dto_create (
