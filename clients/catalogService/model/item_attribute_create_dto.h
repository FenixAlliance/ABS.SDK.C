/*
 * item_attribute_create_dto.h
 *
 * 
 */

#ifndef _item_attribute_create_dto_H_
#define _item_attribute_create_dto_H_
...
typedef struct item_attribute_create_dto_t item_attribute_create_dto_t;




typedef struct item_attribute_create_dto_t {
    char *id; // string
    char *timestamp; //date time
    char *name; // string
    char *description; // string

} item_attribute_create_dto_t;
...
#endif /* _item_attribute_create_dto_H_ */
