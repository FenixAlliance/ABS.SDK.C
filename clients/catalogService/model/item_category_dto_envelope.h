/*
 * item_category_dto_envelope.h
 *
 * 
 */

#ifndef _item_category_dto_envelope_H_
#define _item_category_dto_envelope_H_
...
typedef struct item_category_dto_envelope_t item_category_dto_envelope_t;

#include "item_category_dto.h"



typedef struct item_category_dto_envelope_t {
    int is_success; //boolean
    char *error_message; // string
    char *correlation_id; // string
    char *timestamp; //date time
    char *activity_id; // string
    struct item_category_dto_t *result; //model
...
#endif /* _item_category_dto_envelope_H_ */
