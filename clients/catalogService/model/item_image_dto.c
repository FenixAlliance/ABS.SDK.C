...
item_image_dto_t *item_image_dto_create(
    ...
    item_image_dto_local_var->metadata = metadata;
    item_image_dto_local_var->file_upload_url = file_upload_url;
    item_image_dto_local_var->file_name = file_name;
    item_image_dto_local_var->title = title;
    item_image_dto_local_var->abstract = abstract;
    item_image_dto_local_var->author = author;
    item_image_dto_local_var->key_words = key_words;
    item_image_dto_local_var->notes = notes;
    item_image_dto_local_var->content_type = content_type;
    item_image_dto_local_var->file_length = file_length;
...
void item_image_dto_free(item_image_dto_t *item_image_dto) {
    if(NULL == item_image_dto){
        return ;
    }
    listEntry_t *listEntry;
    if (item_image_dto->id) {
        free(item_image_dto->id);
        item_image_dto->id = NULL;
    }
    if (item_image_dto->timestamp) {
    ...
    if (item_image_dto->item_id) {
        ...
        item_image_dto->item_id = NULL;
    }
    if (item_image_dto->m_d5_hash) {
        free(item_image_dto->m_d5_hash);
        item_image_dto->m_d5_hash = NULL;
    }
    if (item_image_dto->metadata) {
        free(item_image_dto->metadata);
        item_image_dto->metadata = NULL;
    }
    if (item_image_dto->file_upload_url) {
        free(item_image_dto->file_upload_url);
        item_image_dto->file_upload_url = NULL;
    }
    if (item_image_dto->file_name) {
        free(item_image_dto->file_name);
        item_image_dto->file_name = NULL;
    }
    if (item_image_dto->title) {
        free(item_image_dto->title);
        item_image_dto->title = NULL;
    }
    if (item_image_dto->abstract) {
        free(item_image_dto->abstract);
        item_image_dto->abstract = NULL;
    }
    if (item_image_dto->author) {
        free(item_image_dto->author);
        item_image_dto->author = NULL;
    }
    if (item_image_dto->key_words) {
        free(item_image_dto->key_words);
        item_image_dto->key_words = NULL;
    }
    if (item_image_dto->notes) {
        free(item_image_dto->notes);
        item_image_dto->notes = NULL;
    }
    if (item_image_dto->content_type) {
        free(item_image_dto->content_type);
        item_image_dto->content_type = NULL;
    }
    if (item_image_dto->social_profile_id) {
        free(item_image_dto->social_profile_id);
        item_image_dto->social_profile_id = NULL;
    }
...
cJSON *item_image_dto_convertToJSON(item_image_dto_t *item_image_dto) {
    cJSON *item = cJSON_CreateObject();

    // item_image_dto->id
    if(item_image_dto->id) {
    if(cJSON_AddStringToObject(item, "id", item_image_dto->id) == NULL) {
    goto fail; //String
    }
    }


    // item_image_dto->timestamp
    if(item_image_dto->timestamp) {
    if(cJSON_AddStringToObject(item, "timestamp", item_image_dto->timestamp) == NULL) {
    goto fail; //Date-Time
    }
    }
    ...
    // item_image_dto->is_item_mozaic_bg
    if(item_image_dto->is_item_mozaic_bg) {
    if(cJSON_AddBoolToObject(item, "isItemMozaicBG", item_image_dto->is_item_mozaic_bg) == NULL) {
    goto fail; //Bool
    }
    }


    // item_image_dto->m_d5_hash
    if(item_image_dto->m_d5_hash) {
    if(cJSON_AddStringToObject(item, "mD5Hash", item_image_dto->m_d5_hash) == NULL) {
    goto fail; //String
    }
    }


    // item_image_dto->metadata
    if(item_image_dto->metadata) {
    if(cJSON_AddStringToObject(item, "metadata", item_image_dto->metadata) == NULL) {
    goto fail; //String
    }
    }


    // item_image_dto->file_upload_url
    if(item_image_dto->file_upload_url) {
    if(cJSON_AddStringToObject(item, "fileUploadURL", item_image_dto->file_upload_url) == NULL) {
    goto fail; //String
    }
    }


    // item_image_dto->file_name
    if(item_image_dto->file_name) {
    if(cJSON_AddStringToObject(item, "fileName", item_image_dto->file_name) == NULL) {
    goto fail; //String
    }
    }


    // item_image_dto->title
    if(item_image_dto->title) {
    if(cJSON_AddStringToObject(item, "title", item_image_dto->title) == NULL) {
    goto fail; //String
    }
    }


    // item_image_dto->abstract
    if(item_image_dto->abstract) {
    if(cJSON_AddStringToObject(item, "abstract", item_image_dto->abstract) == NULL) {
    goto fail; //String
    }
    }


    // item_image_dto->author
    if(item_image_dto->author) {
    if(cJSON_AddStringToObject(item, "author", item_image_dto->author) == NULL) {
    goto fail; //String
    }
    }


    // item_image_dto->key_words
    if(item_image_dto->key_words) {
    if(cJSON_AddStringToObject(item, "keyWords", item_image_dto->key_words) == NULL) {
    goto fail; //String
    }
    }


    // item_image_dto->notes
    if(item_image_dto->notes) {
    if(cJSON_AddStringToObject(item, "notes", item_image_dto->notes) == NULL) {
    goto fail; //String
    }
    }


    // item_image_dto->content_type
    if(item_image_dto->content_type) {
    if(cJSON_AddStringToObject(item, "contentType", item_image_dto->content_type) == NULL) {
    goto fail; //String
    }
    }


    // item_image_dto->file_length
    if(item_image_dto->file_length) {
    if(cJSON_AddNumberToObject(item, "fileLength", item_image_dto->file_length) == NULL) {
    goto fail; //Numeric
    }
    }


    // item_image_dto->valid_response
    if(item_image_dto->valid_response) {
    if(cJSON_AddBoolToObject(item, "validResponse", item_image_dto->valid_response) == NULL) {
    goto fail; //Bool
    }
    }
...
item_image_dto_t *item_image_dto_parseFromJSON(cJSON *item_image_dtoJSON){

    item_image_dto_t *item_image_dto_local_var = NULL;

    // item_image_dto->id
    cJSON *id = cJSON_GetObjectItemCaseSensitive(item_image_dtoJSON, "id");
    if (id) { 
    ...
    // item_image_dto->timestamp
    cJSON *timestamp = cJSON_GetObjectItemCaseSensitive(item_image_dtoJSON, "timestamp");
    if (timestamp) { 
    ...
    // item_image_dto->is_item_mozaic_bg
    cJSON *is_item_mozaic_bg = cJSON_GetObjectItemCaseSensitive(item_image_dtoJSON, "isItemMozaicBG");
    ...
    // item_image_dto->m_d5_hash
    cJSON *m_d5_hash = cJSON_GetObjectItemCaseSensitive(item_image_dtoJSON, "mD5Hash");
    if (m_d5_hash) { 
    ...
    // item_image_dto->metadata
    cJSON *metadata = cJSON_GetObjectItemCaseSensitive(item_image_dtoJSON, "metadata");
    if (metadata) { 
    ...
    // item_image_dto->file_upload_url
    cJSON *file_upload_url = cJSON_GetObjectItemCaseSensitive(item_image_dtoJSON, "fileUploadURL");
    if (file_upload_url) { 
    ...
    // item_image_dto->file_name
    cJSON *file_name = cJSON_GetObjectItemCaseSensitive(item_image_dtoJSON, "fileName");
    if (file_name) { 
    ...
    // item_image_dto->title
    cJSON *title = cJSON_GetObjectItemCaseSensitive(item_image_dtoJSON, "title");
    if (title) { 
    ...
    // item_image_dto->abstract
    cJSON *abstract = cJSON_GetObjectItemCaseSensitive(item_image_dtoJSON, "abstract");
    if (abstract) { 
    ...
    // item_image_dto->author
    cJSON *author = cJSON_GetObjectItemCaseSensitive(item_image_dtoJSON, "author");
    if (author) { 
    ...
    // item_image_dto->key_words
    cJSON *key_words = cJSON_GetObjectItemCaseSensitive(item_image_dtoJSON, "keyWords");
    if (key_words) { 
    ...
    // item_image_dto->notes
    cJSON *notes = cJSON_GetObjectItemCaseSensitive(item_image_dtoJSON, "notes");
    if (notes) { 
    ...
    // item_image_dto->content_type
    cJSON *content_type = cJSON_GetObjectItemCaseSensitive(item_image_dtoJSON, "contentType");
    if (content_type) { 
    ...
    // item_image_dto->file_length
    cJSON *file_length = cJSON_GetObjectItemCaseSensitive(item_image_dtoJSON, "fileLength");
    if (file_length) { 
    ...
    // item_image_dto->valid_response
    cJSON *valid_response = cJSON_GetObjectItemCaseSensitive(item_image_dtoJSON, "validResponse");
    if (valid_response) { 
