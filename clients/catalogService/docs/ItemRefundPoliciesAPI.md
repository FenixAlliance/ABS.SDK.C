...
//
int32_envelope_t* ItemRefundPoliciesAPI_countItemRefundPoliciesAsync(apiClient_t *apiClient, char *tenantId, char *itemId, char *api_version, char *x_api_version, item_refund_policy_dto_collection_query_parameters_t *item_refund_policy_dto_collection_query_parameters);
```
...
//
item_refund_policy_dto_list_envelope_t* ItemRefundPoliciesAPI_getItemRefundPoliciesAsync(apiClient_t *apiClient, char *tenantId, char *itemId, char *api_version, char *x_api_version, item_refund_policy_dto_collection_query_parameters_t *item_refund_policy_dto_collection_query_parameters);
```
...
//
item_refund_policy_dto_envelope_t* ItemRefundPoliciesAPI_getItemRefundPolicyByIdAsync(apiClient_t *apiClient, char *itemRefundPolicyId, char *tenantId, char *itemId, char *api_version, char *x_api_version);
```
