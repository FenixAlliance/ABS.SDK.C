...
//
item_bundle_dto_list_envelope_t* ItemBundlesAPI_getItemBundlesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
//
int32_envelope_t* ItemBundlesAPI_getItemBundlesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version);
```
...
//
empty_envelope_t* ItemBundlesAPI_patchItemBundleAsync(apiClient_t *apiClient, char *tenantId, char *itemBundleId, char *api_version, char *x_api_version, list_t *operation);
```
