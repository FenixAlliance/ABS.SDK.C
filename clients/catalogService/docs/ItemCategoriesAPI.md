...
//
int32_envelope_t* ItemCategoriesAPI_countItemCategoriesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_category_dto_collection_query_parameters_t *item_category_dto_collection_query_parameters);
```
...
//
item_category_dto_list_envelope_t* ItemCategoriesAPI_getItemCategoriesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_category_dto_collection_query_parameters_t *item_category_dto_collection_query_parameters);
```
...
//
void ItemCategoriesAPI_patchItemCategoryAsync(apiClient_t *apiClient, char *tenantId, char *itemCategoryId, char *api_version, char *x_api_version, list_t *patch_operation);
```
