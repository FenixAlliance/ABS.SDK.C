...
//
int32_envelope_t* ItemWarrantyPoliciesAPI_countItemWarrantyPoliciesAsync(apiClient_t *apiClient, char *tenantId, char *itemId, char *api_version, char *x_api_version, item_warranty_policy_dto_collection_query_parameters_t *item_warranty_policy_dto_collection_query_parameters);
```
...
//
item_warranty_policy_dto_list_envelope_t* ItemWarrantyPoliciesAPI_getItemWarrantyPoliciesAsync(apiClient_t *apiClient, char *tenantId, char *itemId, char *api_version, char *x_api_version, item_warranty_policy_dto_collection_query_parameters_t *item_warranty_policy_dto_collection_query_parameters);
```
