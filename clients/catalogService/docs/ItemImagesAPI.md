...
//
item_image_dto_envelope_t* ItemImagesAPI_getItemImageByIdAsync(apiClient_t *apiClient, char *itemImageId, char *tenantId, char *api_version, char *x_api_version);
```
...
//
item_image_dto_list_envelope_t* ItemImagesAPI_getItemImagesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_image_dto_collection_query_parameters_t *item_image_dto_collection_query_parameters);
```
...
//
void ItemImagesAPI_patchItemImageAsync(apiClient_t *apiClient, char *tenantId, char *itemImageId, char *api_version, char *x_api_version, list_t *patch_operation);
```
