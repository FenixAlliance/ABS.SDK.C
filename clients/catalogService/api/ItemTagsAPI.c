...
ItemTagsAPI_createItemTagAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_tag_create_dto_t *item_tag_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemTags")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemTags");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_tag_create_dto = NULL;
    if (item_tag_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_tag_create_dto = item_tag_create_dto_convertToJSON(item_tag_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_tag_create_dto);
    }
    ...
    cJSON *ItemTagsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_tag_dto_envelope_t *elementToReturn = item_tag_dto_envelope_parseFromJSON(ItemTagsAPIlocalVarJSON);
    cJSON_Delete(ItemTagsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_item_tag_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_tag_create_dto);
        localVarSingleItemJSON_item_tag_create_dto = NULL;
    }
...
ItemTagsAPI_deleteItemTagAsync(apiClient_t *apiClient, char *tenantId, char *itemTagId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemTags/{itemTagId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemTags/{itemTagId}");


    // Path Params
    long sizeOfPathParams_itemTagId = strlen(itemTagId)+3 + strlen("{ itemTagId }");
    if(itemTagId == NULL) {
        goto end;
    }
...
ItemTagsAPI_getItemTagsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ItemTagsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_tag_dto_list_envelope_t *elementToReturn = item_tag_dto_list_envelope_parseFromJSON(ItemTagsAPIlocalVarJSON);
    cJSON_Delete(ItemTagsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemTagsAPI_updateItemTagAsync(apiClient_t *apiClient, char *tenantId, char *itemTagId, char *api_version, char *x_api_version, item_tag_update_dto_t *item_tag_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_tag_update_dto = NULL;
    if (item_tag_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_tag_update_dto = item_tag_update_dto_convertToJSON(item_tag_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_tag_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_item_tag_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_tag_update_dto);
        localVarSingleItemJSON_item_tag_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
