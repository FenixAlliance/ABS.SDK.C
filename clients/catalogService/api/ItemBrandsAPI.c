...
ItemBrandsAPI_createItemBrandAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_brand_create_dto_t *item_brand_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemBrands")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemBrands");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_brand_create_dto = NULL;
    if (item_brand_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_brand_create_dto = item_brand_create_dto_convertToJSON(item_brand_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_brand_create_dto);
    }
    ...
    cJSON *ItemBrandsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_brand_dto_envelope_t *elementToReturn = item_brand_dto_envelope_parseFromJSON(ItemBrandsAPIlocalVarJSON);
    cJSON_Delete(ItemBrandsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_item_brand_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_brand_create_dto);
        localVarSingleItemJSON_item_brand_create_dto = NULL;
    }
...
ItemBrandsAPI_deleteItemBrandAsync(apiClient_t *apiClient, char *tenantId, char *itemBrandId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemBrands/{itemBrandId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemBrands/{itemBrandId}");


    // Path Params
    long sizeOfPathParams_itemBrandId = strlen(itemBrandId)+3 + strlen("{ itemBrandId }");
    if(itemBrandId == NULL) {
        goto end;
    }
...
ItemBrandsAPI_getItemBrandsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ItemBrandsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_brand_dto_list_envelope_t *elementToReturn = item_brand_dto_list_envelope_parseFromJSON(ItemBrandsAPIlocalVarJSON);
    cJSON_Delete(ItemBrandsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemBrandsAPI_updateItemBrandAsync(apiClient_t *apiClient, char *tenantId, char *itemBrandId, char *api_version, char *x_api_version, item_brand_update_dto_t *item_brand_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_brand_update_dto = NULL;
    if (item_brand_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_brand_update_dto = item_brand_update_dto_convertToJSON(item_brand_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_brand_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_item_brand_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_brand_update_dto);
        localVarSingleItemJSON_item_brand_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
