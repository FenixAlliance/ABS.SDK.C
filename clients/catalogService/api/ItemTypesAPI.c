...
ItemTypesAPI_countItemTypesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_type_dto_collection_query_parameters_t *item_type_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemTypes/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemTypes/Count");
    ...
    cJSON *ItemTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ItemTypesAPIlocalVarJSON);
    cJSON_Delete(ItemTypesAPIlocalVarJSON);
...
ItemTypesAPI_createItemTypeAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_type_create_dto_t *item_type_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemTypes")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemTypes");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_type_create_dto = NULL;
    if (item_type_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_type_create_dto = item_type_create_dto_convertToJSON(item_type_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_type_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ItemTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_type_dto_envelope_t *elementToReturn = item_type_dto_envelope_parseFromJSON(ItemTypesAPIlocalVarJSON);
    cJSON_Delete(ItemTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_item_type_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_type_create_dto);
        localVarSingleItemJSON_item_type_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ItemTypesAPI_deleteItemTypeAsync(apiClient_t *apiClient, char *tenantId, char *itemTypeID, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemTypes/{itemTypeID}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemTypes/{itemTypeID}");


    // Path Params
    long sizeOfPathParams_itemTypeID = strlen(itemTypeID)+3 + strlen("{ itemTypeID }");
    if(itemTypeID == NULL) {
        goto end;
    }
...
ItemTypesAPI_getItemTypesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_type_dto_collection_query_parameters_t *item_type_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *ItemTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_type_dto_list_envelope_t *elementToReturn = item_type_dto_list_envelope_parseFromJSON(ItemTypesAPIlocalVarJSON);
    cJSON_Delete(ItemTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemTypesAPI_updateItemTypeAsync(apiClient_t *apiClient, char *tenantId, char *itemTypeID, char *api_version, char *x_api_version, item_type_update_dto_t *item_type_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_type_update_dto = NULL;
    if (item_type_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_type_update_dto = item_type_update_dto_convertToJSON(item_type_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_type_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_item_type_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_type_update_dto);
        localVarSingleItemJSON_item_type_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
