...
ItemImagesAPI_createItemImageAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_image_create_dto_t *item_image_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemImages")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemImages");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_image_create_dto = NULL;
    if (item_image_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_image_create_dto = item_image_create_dto_convertToJSON(item_image_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_image_create_dto);
    }
    ...
    cJSON *ItemImagesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_image_dto_envelope_t *elementToReturn = item_image_dto_envelope_parseFromJSON(ItemImagesAPIlocalVarJSON);
    cJSON_Delete(ItemImagesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_item_image_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_image_create_dto);
        localVarSingleItemJSON_item_image_create_dto = NULL;
    }
...
ItemImagesAPI_deleteItemImageAsync(apiClient_t *apiClient, char *tenantId, char *itemImageId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemImages/{itemImageId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemImages/{itemImageId}");


    // Path Params
    long sizeOfPathParams_itemImageId = strlen(itemImageId)+3 + strlen("{ itemImageId }");
    if(itemImageId == NULL) {
        goto end;
    }
...
ItemImagesAPI_getItemImagesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ItemImagesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_image_dto_list_envelope_t *elementToReturn = item_image_dto_list_envelope_parseFromJSON(ItemImagesAPIlocalVarJSON);
    cJSON_Delete(ItemImagesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemImagesAPI_updateItemImageAsync(apiClient_t *apiClient, char *tenantId, char *itemImageId, char *api_version, char *x_api_version, item_image_update_dto_t *item_image_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_image_update_dto = NULL;
    if (item_image_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_image_update_dto = item_image_update_dto_convertToJSON(item_image_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_image_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_item_image_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_image_update_dto);
        localVarSingleItemJSON_item_image_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
