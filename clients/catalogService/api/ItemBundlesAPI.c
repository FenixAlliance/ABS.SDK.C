...
ItemBundlesAPI_createItemBundleAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_bundle_create_dto_t *item_bundle_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemBundles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemBundles");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_bundle_create_dto = NULL;
    if (item_bundle_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_bundle_create_dto = item_bundle_create_dto_convertToJSON(item_bundle_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_bundle_create_dto);
    }
    ...
    cJSON *ItemBundlesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_bundle_dto_envelope_t *elementToReturn = item_bundle_dto_envelope_parseFromJSON(ItemBundlesAPIlocalVarJSON);
    cJSON_Delete(ItemBundlesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_item_bundle_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_bundle_create_dto);
        localVarSingleItemJSON_item_bundle_create_dto = NULL;
    }
...
ItemBundlesAPI_deleteItemBundleAsync(apiClient_t *apiClient, char *tenantId, char *itemBundleId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemBundles/{itemBundleId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemBundles/{itemBundleId}");


    // Path Params
    long sizeOfPathParams_itemBundleId = strlen(itemBundleId)+3 + strlen("{ itemBundleId }");
    if(itemBundleId == NULL) {
        goto end;
    }
    char* localVarToReplace_itemBundleId = malloc(sizeOfPathParams_itemBundleId);
    sprintf(localVarToReplace_itemBundleId, "{%s}", "itemBundleId");

    localVarPath = strReplace(localVarPath, localVarToReplace_itemBundleId, itemBundleId);
    if(itemBundleId == NULL) {
        goto end;
    }
    char* localVarToReplace_itemBundleId = malloc(sizeOfPathParams_itemBundleId);
    ...
    free(localVarPath);
    free(localVarToReplace_itemBundleId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
ItemBundlesAPI_getItemBundlesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_bundle_dto_collection_query_parameters_t *item_bundle_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *ItemBundlesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_bundle_dto_list_envelope_t *elementToReturn = item_bundle_dto_list_envelope_parseFromJSON(ItemBundlesAPIlocalVarJSON);
    cJSON_Delete(ItemBundlesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemBundlesAPI_getItemBundlesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_bundle_dto_collection_query_parameters_t *item_bundle_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemBundles/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemBundles/Count");
    ...
    //nonprimitive not container
    cJSON *ItemBundlesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ItemBundlesAPIlocalVarJSON);
    cJSON_Delete(ItemBundlesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemBundlesAPI_patchItemBundleAsync(apiClient_t *apiClient, char *tenantId, char *itemBundleId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *ItemBundlesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ItemBundlesAPIlocalVarJSON);
    cJSON_Delete(ItemBundlesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemBundlesAPI_updateItemBundleAsync(apiClient_t *apiClient, char *tenantId, char *itemBundleId, char *api_version, char *x_api_version, item_bundle_update_dto_t *item_bundle_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_bundle_update_dto = NULL;
    if (item_bundle_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_bundle_update_dto = item_bundle_update_dto_convertToJSON(item_bundle_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_bundle_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_item_bundle_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_bundle_update_dto);
        localVarSingleItemJSON_item_bundle_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
