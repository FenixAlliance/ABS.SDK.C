...
ItemQuestionsAPI_createItemQuestionAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_question_create_dto_t *item_question_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemQuestions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemQuestions");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_question_create_dto = NULL;
    if (item_question_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_question_create_dto = item_question_create_dto_convertToJSON(item_question_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_question_create_dto);
    }
    ...
    cJSON *ItemQuestionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_question_dto_envelope_t *elementToReturn = item_question_dto_envelope_parseFromJSON(ItemQuestionsAPIlocalVarJSON);
    cJSON_Delete(ItemQuestionsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_item_question_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_question_create_dto);
        localVarSingleItemJSON_item_question_create_dto = NULL;
    }
...
ItemQuestionsAPI_deleteItemQuestionAsync(apiClient_t *apiClient, char *tenantId, char *itemQuestionId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemQuestions/{itemQuestionId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemQuestions/{itemQuestionId}");


    // Path Params
    long sizeOfPathParams_itemQuestionId = strlen(itemQuestionId)+3 + strlen("{ itemQuestionId }");
...
ItemQuestionsAPI_getItemQuestionsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_question_dto_collection_query_parameters_t *item_question_dto_collection_query_parameters)
{
    ...
    //nonprimitive not container
    cJSON *ItemQuestionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_question_dto_list_envelope_t *elementToReturn = item_question_dto_list_envelope_parseFromJSON(ItemQuestionsAPIlocalVarJSON);
    cJSON_Delete(ItemQuestionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemQuestionsAPI_updateItemQuestionAsync(apiClient_t *apiClient, char *tenantId, char *itemQuestionId, char *api_version, char *x_api_version, item_question_update_dto_t *item_question_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_question_update_dto = NULL;
    if (item_question_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_question_update_dto = item_question_update_dto_convertToJSON(item_question_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_question_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_item_question_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_question_update_dto);
        localVarSingleItemJSON_item_question_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
