...
MerchantsAPI_getMerchantById(apiClient_t *apiClient, char *merchantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/Merchants/{merchantId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/Merchants/{merchantId}");


    // Path Params
    long sizeOfPathParams_merchantId = strlen(merchantId)+3 + strlen("{ merchantId }");
    if(merchantId == NULL) {
        goto end;
    }
    char* localVarToReplace_merchantId = malloc(sizeOfPathParams_merchantId);
    sprintf(localVarToReplace_merchantId, "{%s}", "merchantId");

    localVarPath = strReplace(localVarPath, localVarToReplace_merchantId, merchantId);
    if(merchantId == NULL) {
        goto end;
    }
    char* localVarToReplace_merchantId = malloc(sizeOfPathParams_merchantId);
    ...
    cJSON *MerchantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    merchant_dto_envelope_t *elementToReturn = merchant_dto_envelope_parseFromJSON(MerchantsAPIlocalVarJSON);
    cJSON_Delete(MerchantsAPIlocalVarJSON);
    ...
    free(localVarPath);
    free(localVarToReplace_merchantId);
...
MerchantsAPI_getMerchants(apiClient_t *apiClient, char *api_version, char *x_api_version, merchant_dto_collection_query_parameters_t *merchant_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/Merchants")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/Merchants");
    ...
    //nonprimitive not container
    cJSON *MerchantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    merchant_dto_list_envelope_t *elementToReturn = merchant_dto_list_envelope_parseFromJSON(MerchantsAPIlocalVarJSON);
    cJSON_Delete(MerchantsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
MerchantsAPI_getMerchantsCount(apiClient_t *apiClient, char *api_version, char *x_api_version, merchant_dto_collection_query_parameters_t *merchant_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/Merchants/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/Merchants/Count");
    ...
    //nonprimitive not container
    cJSON *MerchantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(MerchantsAPIlocalVarJSON);
    cJSON_Delete(MerchantsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
