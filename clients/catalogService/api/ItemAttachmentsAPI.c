...
ItemAttachmentsAPI_createItemAttachmentAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_attachment_create_dto_t *item_attachment_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemAttachments")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemAttachments");
    ...
    cJSON *ItemAttachmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_attachment_dto_envelope_t *elementToReturn = item_attachment_dto_envelope_parseFromJSON(ItemAttachmentsAPIlocalVarJSON);
    cJSON_Delete(ItemAttachmentsAPIlocalVarJSON);
...
ItemAttachmentsAPI_deleteItemAttachmentAsync(apiClient_t *apiClient, char *tenantId, char *itemAttachmentId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemAttachments/{itemAttachmentId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemAttachments/{itemAttachmentId}");


    // Path Params
    long sizeOfPathParams_itemAttachmentId = strlen(itemAttachmentId)+3 + strlen("{ itemAttachmentId }");
    ...
    //nonprimitive not container
    cJSON *ItemAttachmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ItemAttachmentsAPIlocalVarJSON);
    cJSON_Delete(ItemAttachmentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemAttachmentsAPI_getItemAttachmentsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ItemAttachmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_attachment_dto_list_envelope_t *elementToReturn = item_attachment_dto_list_envelope_parseFromJSON(ItemAttachmentsAPIlocalVarJSON);
    cJSON_Delete(ItemAttachmentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemAttachmentsAPI_updateItemAttachmentAsync(apiClient_t *apiClient, char *tenantId, char *itemAttachmentId, char *api_version, char *x_api_version, item_attachment_update_dto_t *item_attachment_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_attachment_update_dto = NULL;
    if (item_attachment_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_attachment_update_dto = item_attachment_update_dto_convertToJSON(item_attachment_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_attachment_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_item_attachment_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_attachment_update_dto);
        localVarSingleItemJSON_item_attachment_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
