...
ItemFamiliesAPI_createItemFamilyAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_family_create_dto_t *item_family_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemFamilies")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemFamilies");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_family_create_dto = NULL;
    if (item_family_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_family_create_dto = item_family_create_dto_convertToJSON(item_family_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_family_create_dto);
    }
    ...
    cJSON *ItemFamiliesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_family_dto_envelope_t *elementToReturn = item_family_dto_envelope_parseFromJSON(ItemFamiliesAPIlocalVarJSON);
    cJSON_Delete(ItemFamiliesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_item_family_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_family_create_dto);
        localVarSingleItemJSON_item_family_create_dto = NULL;
    }
...
ItemFamiliesAPI_deleteItemFamilyAsync(apiClient_t *apiClient, char *tenantId, char *itemFamilyId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemFamilies/{itemFamilyId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemFamilies/{itemFamilyId}");


    // Path Params
    long sizeOfPathParams_itemFamilyId = strlen(itemFamilyId)+3 + strlen("{ itemFamilyId }");
    if(itemFamilyId == NULL) {
        goto end;
    }
    char* localVarToReplace_itemFamilyId = malloc(sizeOfPathParams_itemFamilyId);
    sprintf(localVarToReplace_itemFamilyId, "{%s}", "itemFamilyId");

    localVarPath = strReplace(localVarPath, localVarToReplace_itemFamilyId, itemFamilyId);
    if(itemFamilyId == NULL) {
        goto end;
    }
    char* localVarToReplace_itemFamilyId = malloc(sizeOfPathParams_itemFamilyId);
    ...
    free(localVarPath);
    free(localVarToReplace_itemFamilyId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
ItemFamiliesAPI_getItemFamiliesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_family_dto_collection_query_parameters_t *item_family_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_family_dto_collection_query_parameters = NULL;
    if (item_family_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_item_family_dto_collection_query_parameters = item_family_dto_collection_query_parameters_convertToJSON(item_family_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_family_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ItemFamiliesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_family_dto_list_envelope_t *elementToReturn = item_family_dto_list_envelope_parseFromJSON(ItemFamiliesAPIlocalVarJSON);
    cJSON_Delete(ItemFamiliesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_item_family_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_item_family_dto_collection_query_parameters);
        localVarSingleItemJSON_item_family_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ItemFamiliesAPI_getItemFamiliesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_family_dto_collection_query_parameters_t *item_family_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemFamilies/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemFamilies/Count");
    ...
    //nonprimitive not container
    cJSON *ItemFamiliesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ItemFamiliesAPIlocalVarJSON);
    cJSON_Delete(ItemFamiliesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemFamiliesAPI_patchItemFamilyAsync(apiClient_t *apiClient, char *tenantId, char *itemFamilyId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *ItemFamiliesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ItemFamiliesAPIlocalVarJSON);
    cJSON_Delete(ItemFamiliesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemFamiliesAPI_updateItemFamilyAsync(apiClient_t *apiClient, char *tenantId, char *itemFamilyId, char *api_version, char *x_api_version, item_family_update_dto_t *item_family_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_family_update_dto = NULL;
    if (item_family_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_family_update_dto = item_family_update_dto_convertToJSON(item_family_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_family_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_item_family_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_family_update_dto);
        localVarSingleItemJSON_item_family_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
