...
#include <stdio.h>
#include <ctype.h>
#include "ItemGoogleCategoriesAPI.h"
...
ItemGoogleCategoriesAPI_getAllItemGoogleCategoriesAsync(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemGoogleCategories/All")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemGoogleCategories/All");
    ...
    cJSON *ItemGoogleCategoriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_google_category_dto_list_envelope_t *elementToReturn = item_google_category_dto_list_envelope_parseFromJSON(ItemGoogleCategoriesAPIlocalVarJSON);
    cJSON_Delete(ItemGoogleCategoriesAPIlocalVarJSON);
...
ItemGoogleCategoriesAPI_getChildrenItemGoogleCategoriesByIdAsync(apiClient_t *apiClient, char *itemCategoryId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemGoogleCategories/{itemCategoryId}/Children")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemGoogleCategories/{itemCategoryId}/Children");
...
ItemGoogleCategoriesAPI_getItemGoogleCategoriesAsync(apiClient_t *apiClient, char *api_version, char *x_api_version, item_google_category_dto_collection_query_parameters_t *item_google_category_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemGoogleCategories")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemGoogleCategories");
...
ItemGoogleCategoriesAPI_getItemGoogleCategoriesCountAsync(apiClient_t *apiClient, char *api_version, char *x_api_version, item_google_category_dto_collection_query_parameters_t *item_google_category_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemGoogleCategories/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemGoogleCategories/Count");
    ...
    //nonprimitive not container
    cJSON *ItemGoogleCategoriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ItemGoogleCategoriesAPIlocalVarJSON);
    cJSON_Delete(ItemGoogleCategoriesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemGoogleCategoriesAPI_getItemGoogleCategoriesTreeAsync(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemGoogleCategories/tree")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemGoogleCategories/tree");
...
ItemGoogleCategoriesAPI_getItemGoogleCategoryByIdAsync(apiClient_t *apiClient, char *itemCategoryId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemGoogleCategories/{itemCategoryId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemGoogleCategories/{itemCategoryId}");
    ...
    //nonprimitive not container
    cJSON *ItemGoogleCategoriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_google_category_dto_envelope_t *elementToReturn = item_google_category_dto_envelope_parseFromJSON(ItemGoogleCategoriesAPIlocalVarJSON);
    cJSON_Delete(ItemGoogleCategoriesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemGoogleCategoriesAPI_getRootItemGoogleCategoriesAsync(apiClient_t *apiClient, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemGoogleCategories/Primary")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemGoogleCategories/Primary");
