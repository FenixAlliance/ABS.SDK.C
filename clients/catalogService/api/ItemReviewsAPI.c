...
ItemReviewsAPI_createItemReviewAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_review_create_dto_t *item_review_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemReviews")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemReviews");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_review_create_dto = NULL;
    if (item_review_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_review_create_dto = item_review_create_dto_convertToJSON(item_review_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_review_create_dto);
    }
    ...
    cJSON *ItemReviewsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_review_dto_envelope_t *elementToReturn = item_review_dto_envelope_parseFromJSON(ItemReviewsAPIlocalVarJSON);
    cJSON_Delete(ItemReviewsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_item_review_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_review_create_dto);
        localVarSingleItemJSON_item_review_create_dto = NULL;
    }
...
ItemReviewsAPI_deleteItemReviewAsync(apiClient_t *apiClient, char *tenantId, char *itemReviewId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemReviews/{itemReviewId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemReviews/{itemReviewId}");


    // Path Params
    long sizeOfPathParams_itemReviewId = strlen(itemReviewId)+3 + strlen("{ itemReviewId }");
...
ItemReviewsAPI_getItemReviewsAsync(apiClient_t *apiClient, char *itemId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ItemReviewsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_review_dto_list_envelope_t *elementToReturn = item_review_dto_list_envelope_parseFromJSON(ItemReviewsAPIlocalVarJSON);
    cJSON_Delete(ItemReviewsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemReviewsAPI_updateItemReviewAsync(apiClient_t *apiClient, char *tenantId, char *itemReviewId, char *api_version, char *x_api_version, item_review_update_dto_t *item_review_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_review_update_dto = NULL;
    if (item_review_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_review_update_dto = item_review_update_dto_convertToJSON(item_review_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_review_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_item_review_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_review_update_dto);
        localVarSingleItemJSON_item_review_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
