...
#include <stdio.h>
#include <ctype.h>
#include "ItemAttributeOptionsAPI.h"
...
ItemAttributeOptionsAPI_createItemAttributeOptionAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_attribute_option_create_dto_t *item_attribute_option_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemAttributeOptions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemAttributeOptions");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_attribute_option_create_dto = NULL;
    if (item_attribute_option_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_attribute_option_create_dto = item_attribute_option_create_dto_convertToJSON(item_attribute_option_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_attribute_option_create_dto);
    }
    ...
    cJSON *ItemAttributeOptionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_attribute_option_dto_envelope_t *elementToReturn = item_attribute_option_dto_envelope_parseFromJSON(ItemAttributeOptionsAPIlocalVarJSON);
    cJSON_Delete(ItemAttributeOptionsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_item_attribute_option_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_attribute_option_create_dto);
        localVarSingleItemJSON_item_attribute_option_create_dto = NULL;
    }
...
ItemAttributeOptionsAPI_deleteItemAttributeOptionAsync(apiClient_t *apiClient, char *tenantId, char *itemAttributeOptionId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemAttributeOptions/{itemAttributeOptionId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemAttributeOptions/{itemAttributeOptionId}");


    // Path Params
    long sizeOfPathParams_itemAttributeOptionId = strlen(itemAttributeOptionId)+3 + strlen("{ itemAttributeOptionId }");
...
ItemAttributeOptionsAPI_getItemAttributeOptionsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_attribute_option_dto_collection_query_parameters_t *item_attribute_option_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_attribute_option_dto_collection_query_parameters = NULL;
    if (item_attribute_option_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_item_attribute_option_dto_collection_query_parameters = item_attribute_option_dto_collection_query_parameters_convertToJSON(item_attribute_option_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_attribute_option_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *ItemAttributeOptionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_attribute_option_dto_list_envelope_t *elementToReturn = item_attribute_option_dto_list_envelope_parseFromJSON(ItemAttributeOptionsAPIlocalVarJSON);
    cJSON_Delete(ItemAttributeOptionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_item_attribute_option_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_item_attribute_option_dto_collection_query_parameters);
        localVarSingleItemJSON_item_attribute_option_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
ItemAttributeOptionsAPI_getItemAttributeOptionsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_attribute_option_dto_collection_query_parameters_t *item_attribute_option_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemAttributeOptions/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemAttributeOptions/Count");
    ...
    //nonprimitive not container
    cJSON *ItemAttributeOptionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ItemAttributeOptionsAPIlocalVarJSON);
    cJSON_Delete(ItemAttributeOptionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemAttributeOptionsAPI_patchItemAttributeOptionAsync(apiClient_t *apiClient, char *tenantId, char *itemAttributeOptionId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *ItemAttributeOptionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(ItemAttributeOptionsAPIlocalVarJSON);
    cJSON_Delete(ItemAttributeOptionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemAttributeOptionsAPI_updateItemAttributeOptionAsync(apiClient_t *apiClient, char *tenantId, char *itemAttributeOptionId, char *api_version, char *x_api_version, item_attribute_option_update_dto_t *item_attribute_option_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_attribute_option_update_dto = NULL;
    if (item_attribute_option_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_attribute_option_update_dto = item_attribute_option_update_dto_convertToJSON(item_attribute_option_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_attribute_option_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_item_attribute_option_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_attribute_option_update_dto);
        localVarSingleItemJSON_item_attribute_option_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
