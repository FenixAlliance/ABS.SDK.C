...
ItemCategoriesAPI_countItemCategoriesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemCategories/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemCategories/Count");
    ...
    cJSON *ItemCategoriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(ItemCategoriesAPIlocalVarJSON);
    cJSON_Delete(ItemCategoriesAPIlocalVarJSON);
...
ItemCategoriesAPI_createItemCategoryAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, item_category_create_dto_t *item_category_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemCategories")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemCategories");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_category_create_dto = NULL;
    if (item_category_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_category_create_dto = item_category_create_dto_convertToJSON(item_category_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_category_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    ...
    //nonprimitive not container
    cJSON *ItemCategoriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_category_dto_envelope_t *elementToReturn = item_category_dto_envelope_parseFromJSON(ItemCategoriesAPIlocalVarJSON);
    cJSON_Delete(ItemCategoriesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_item_category_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_category_create_dto);
        localVarSingleItemJSON_item_category_create_dto = NULL;
    }
...
ItemCategoriesAPI_deleteItemCategoryAsync(apiClient_t *apiClient, char *tenantId, char *itemCategoryId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CatalogService/ItemCategories/{itemCategoryId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CatalogService/ItemCategories/{itemCategoryId}");


    // Path Params
    long sizeOfPathParams_itemCategoryId = strlen(itemCategoryId)+3 + strlen("{ itemCategoryId }");
...
ItemCategoriesAPI_getItemCategoriesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *ItemCategoriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_category_dto_list_envelope_t *elementToReturn = item_category_dto_list_envelope_parseFromJSON(ItemCategoriesAPIlocalVarJSON);
    cJSON_Delete(ItemCategoriesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ItemCategoriesAPI_updateItemCategoryAsync(apiClient_t *apiClient, char *tenantId, char *itemCategoryId, char *api_version, char *x_api_version, item_category_update_dto_t *item_category_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_item_category_update_dto = NULL;
    if (item_category_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_item_category_update_dto = item_category_update_dto_convertToJSON(item_category_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_item_category_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_item_category_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_item_category_update_dto);
        localVarSingleItemJSON_item_category_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
