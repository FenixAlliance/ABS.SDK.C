/*
 * course_unit_component_update_dto.h
 *
 * 
 */

#ifndef _course_unit_component_update_dto_H_
#define _course_unit_component_update_dto_H_
...
typedef struct course_unit_component_update_dto_t course_unit_component_update_dto_t;




typedef struct course_unit_component_update_dto_t {
    char *title; // string
...
} course_unit_component_update_dto_t;
...
#endif /* _course_unit_component_update_dto_H_ */
