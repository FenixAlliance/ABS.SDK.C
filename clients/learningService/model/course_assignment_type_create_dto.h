/*
 * course_assignment_type_create_dto.h
 *
 * 
 */

#ifndef _course_assignment_type_create_dto_H_
#define _course_assignment_type_create_dto_H_
...
typedef struct course_assignment_type_create_dto_t course_assignment_type_create_dto_t;




typedef struct course_assignment_type_create_dto_t {
    char *id; // string
...
} course_assignment_type_create_dto_t;
...
#endif /* _course_assignment_type_create_dto_H_ */
