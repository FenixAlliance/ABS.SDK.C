/*
 * course_forum_create_dto.h
 *
 * 
 */

#ifndef _course_forum_create_dto_H_
#define _course_forum_create_dto_H_
...
typedef struct course_forum_create_dto_t course_forum_create_dto_t;




typedef struct course_forum_create_dto_t {
    char *id; // string
...
#endif /* _course_forum_create_dto_H_ */
