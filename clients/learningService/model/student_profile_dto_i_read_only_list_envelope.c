...
student_profile_dto_i_read_only_list_envelope_t *student_profile_dto_i_read_only_list_envelope_create(
    ...
    student_profile_dto_i_read_only_list_envelope_local_var->http_status = http_status;
    student_profile_dto_i_read_only_list_envelope_local_var->error_code = error_code;
    student_profile_dto_i_read_only_list_envelope_local_var->validation_details = validation_details;
...
void student_profile_dto_i_read_only_list_envelope_free(student_profile_dto_i_read_only_list_envelope_t *student_profile_dto_i_read_only_list_envelope) {
    ...
    if (student_profile_dto_i_read_only_list_envelope->error_code) {
        free(student_profile_dto_i_read_only_list_envelope->error_code);
        student_profile_dto_i_read_only_list_envelope->error_code = NULL;
    }
    if (student_profile_dto_i_read_only_list_envelope->validation_details) {
        list_ForEach(listEntry, student_profile_dto_i_read_only_list_envelope->validation_details) {
            keyValuePair_t *localKeyValue = (keyValuePair_t*) listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_freeList(student_profile_dto_i_read_only_list_envelope->validation_details);
        student_profile_dto_i_read_only_list_envelope->validation_details = NULL;
    }
...
cJSON *student_profile_dto_i_read_only_list_envelope_convertToJSON(student_profile_dto_i_read_only_list_envelope_t *student_profile_dto_i_read_only_list_envelope) {
    ...
    // student_profile_dto_i_read_only_list_envelope->http_status
    if(student_profile_dto_i_read_only_list_envelope->http_status) {
    if(cJSON_AddNumberToObject(item, "httpStatus", student_profile_dto_i_read_only_list_envelope->http_status) == NULL) {
    goto fail; //Numeric
    }
    }


    // student_profile_dto_i_read_only_list_envelope->error_code
    if(student_profile_dto_i_read_only_list_envelope->error_code) {
    if(cJSON_AddStringToObject(item, "errorCode", student_profile_dto_i_read_only_list_envelope->error_code) == NULL) {
    goto fail; //String
    }
    }


    // student_profile_dto_i_read_only_list_envelope->validation_details
    if(student_profile_dto_i_read_only_list_envelope->validation_details) {
    ...
    if (student_profile_dto_i_read_only_list_envelope->validation_details) {
    list_ForEach(validation_detailsListEntry, student_profile_dto_i_read_only_list_envelope->validation_details) {
...
student_profile_dto_i_read_only_list_envelope_t *student_profile_dto_i_read_only_list_envelope_parseFromJSON(cJSON *student_profile_dto_i_read_only_list_envelopeJSON){
    ...
    // define the local map for student_profile_dto_i_read_only_list_envelope->validation_details
    ...
    // student_profile_dto_i_read_only_list_envelope->http_status
    cJSON *http_status = cJSON_GetObjectItemCaseSensitive(student_profile_dto_i_read_only_list_envelopeJSON, "httpStatus");
    if (http_status) { 
    ...
    // student_profile_dto_i_read_only_list_envelope->error_code
    cJSON *error_code = cJSON_GetObjectItemCaseSensitive(student_profile_dto_i_read_only_list_envelopeJSON, "errorCode");
    if (error_code) { 
    ...
    // student_profile_dto_i_read_only_list_envelope->validation_details
    cJSON *validation_details = cJSON_GetObjectItemCaseSensitive(student_profile_dto_i_read_only_list_envelopeJSON, "validationDetails");
