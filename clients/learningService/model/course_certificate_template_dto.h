/*
 * course_certificate_template_dto.h
 *
 * 
 */

#ifndef _course_certificate_template_dto_H_
#define _course_certificate_template_dto_H_
...
typedef struct course_certificate_template_dto_t course_certificate_template_dto_t;




typedef struct course_certificate_template_dto_t {
    char *id; // string
...
#endif /* _course_certificate_template_dto_H_ */
