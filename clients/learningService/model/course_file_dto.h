...
#ifndef _course_file_dto_H_
#define _course_file_dto_H_
...
typedef struct course_file_dto_t course_file_dto_t;




typedef struct course_file_dto_t {
    char *id; // string
