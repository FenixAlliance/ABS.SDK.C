/*
 * course_file_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _course_file_dto_collection_query_parameters_H_
#define _course_file_dto_collection_query_parameters_H_
...
typedef struct course_file_dto_collection_query_parameters_t course_file_dto_collection_query_parameters_t;




typedef struct course_file_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} course_file_dto_collection_query_parameters_t;
...
#endif /* _course_file_dto_collection_query_parameters_H_ */
