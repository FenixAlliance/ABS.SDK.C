...
course_article_dto_t *course_article_dto_create(
    ...
    course_article_dto_local_var->enrollment_id = enrollment_id;
...
void course_article_dto_free(course_article_dto_t *course_article_dto) {
    ...
    if (course_article_dto->enrollment_id) {
        free(course_article_dto->enrollment_id);
        course_article_dto->enrollment_id = NULL;
    }
...
cJSON *course_article_dto_convertToJSON(course_article_dto_t *course_article_dto) {
    ...
    // course_article_dto->enrollment_id
    if(course_article_dto->enrollment_id) {
    if(cJSON_AddStringToObject(item, "enrollmentId", course_article_dto->enrollment_id) == NULL) {
    goto fail; //String
    }
    }
...
course_article_dto_t *course_article_dto_parseFromJSON(cJSON *course_article_dtoJSON){
    ...
    // course_article_dto->enrollment_id
    cJSON *enrollment_id = cJSON_GetObjectItemCaseSensitive(course_article_dtoJSON, "enrollmentId");
    if (enrollment_id) { 
