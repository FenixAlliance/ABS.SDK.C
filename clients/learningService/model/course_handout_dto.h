/*
 * course_handout_dto.h
 *
 * 
 */

#ifndef _course_handout_dto_H_
#define _course_handout_dto_H_
...
typedef struct course_handout_dto_t course_handout_dto_t;




typedef struct course_handout_dto_t {
    char *id; // string
