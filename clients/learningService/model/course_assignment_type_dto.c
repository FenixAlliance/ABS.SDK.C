...
course_assignment_type_dto_t *course_assignment_type_dto_create(
    ...
    course_assignment_type_dto_local_var->enrollment_id = enrollment_id;
...
void course_assignment_type_dto_free(course_assignment_type_dto_t *course_assignment_type_dto) {
    ...
    if (course_assignment_type_dto->enrollment_id) {
        free(course_assignment_type_dto->enrollment_id);
        course_assignment_type_dto->enrollment_id = NULL;
    }
...
cJSON *course_assignment_type_dto_convertToJSON(course_assignment_type_dto_t *course_assignment_type_dto) {
    ...
    // course_assignment_type_dto->enrollment_id
    if(course_assignment_type_dto->enrollment_id) {
    if(cJSON_AddStringToObject(item, "enrollmentId", course_assignment_type_dto->enrollment_id) == NULL) {
    goto fail; //String
    }
    }
...
course_assignment_type_dto_t *course_assignment_type_dto_parseFromJSON(cJSON *course_assignment_type_dtoJSON){
    ...
    // course_assignment_type_dto->enrollment_id
    cJSON *enrollment_id = cJSON_GetObjectItemCaseSensitive(course_assignment_type_dtoJSON, "enrollmentId");
    if (enrollment_id) { 
