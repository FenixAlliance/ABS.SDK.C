...
course_grading_rubric_dto_t *course_grading_rubric_dto_create(
    ...
    course_grading_rubric_dto_local_var->enrollment_id = enrollment_id;
...
void course_grading_rubric_dto_free(course_grading_rubric_dto_t *course_grading_rubric_dto) {
    ...
    if (course_grading_rubric_dto->enrollment_id) {
        free(course_grading_rubric_dto->enrollment_id);
        course_grading_rubric_dto->enrollment_id = NULL;
    }
...
cJSON *course_grading_rubric_dto_convertToJSON(course_grading_rubric_dto_t *course_grading_rubric_dto) {
    ...
    // course_grading_rubric_dto->enrollment_id
    if(course_grading_rubric_dto->enrollment_id) {
    if(cJSON_AddStringToObject(item, "enrollmentId", course_grading_rubric_dto->enrollment_id) == NULL) {
    goto fail; //String
    }
    }
...
course_grading_rubric_dto_t *course_grading_rubric_dto_parseFromJSON(cJSON *course_grading_rubric_dtoJSON){
    ...
    // course_grading_rubric_dto->enrollment_id
    cJSON *enrollment_id = cJSON_GetObjectItemCaseSensitive(course_grading_rubric_dtoJSON, "enrollmentId");
    if (enrollment_id) { 
