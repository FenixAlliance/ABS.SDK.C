...
[**CoursePagesAPI_patchCoursePageAsync**](CoursePagesAPI.md#CoursePagesAPI_patchCoursePageAsync) | **PATCH** /api/v2/LearningService/CoursePages/{pageId} | Patch a course page
...
//
list_t* CoursePagesAPI_getCoursePagesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_page_dto_collection_query_parameters_t *course_page_dto_collection_query_parameters);
```
...
//
int* CoursePagesAPI_getCoursePagesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_page_dto_collection_query_parameters_t *course_page_dto_collection_query_parameters);
```
...
# **CoursePagesAPI_patchCoursePageAsync**
```c
// Patch a course page
//
// Partially updates an existing course page for the specified tenant.
//
void CoursePagesAPI_patchCoursePageAsync(apiClient_t *apiClient, char *tenantId, char *pageId, char *api_version, char *x_api_version, list_t *patch_operation);
```
