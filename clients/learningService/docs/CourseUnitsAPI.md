...
[**CourseUnitsAPI_patchCourseUnitAsync**](CourseUnitsAPI.md#CourseUnitsAPI_patchCourseUnitAsync) | **PATCH** /api/v2/LearningService/CourseUnits/{unitId} | Patch a course unit
...
//
list_t* CourseUnitsAPI_getCourseUnitsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_unit_dto_collection_query_parameters_t *course_unit_dto_collection_query_parameters);
```
...
//
int* CourseUnitsAPI_getCourseUnitsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_unit_dto_collection_query_parameters_t *course_unit_dto_collection_query_parameters);
```
...
# **CourseUnitsAPI_patchCourseUnitAsync**
```c
// Patch a course unit
//
// Partially updates a course unit for the specified tenant.
//
empty_envelope_t* CourseUnitsAPI_patchCourseUnitAsync(apiClient_t *apiClient, char *tenantId, char *unitId, char *api_version, char *x_api_version, list_t *patch_operation);
```
