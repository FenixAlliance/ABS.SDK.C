...
//
list_t* CourseAssignmentsAPI_getCourseAssignmentsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_assignment_dto_collection_query_parameters_t *course_assignment_dto_collection_query_parameters);
```
...
//
int* CourseAssignmentsAPI_getCourseAssignmentsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_assignment_dto_collection_query_parameters_t *course_assignment_dto_collection_query_parameters);
```
...
//
empty_envelope_t* CourseAssignmentsAPI_patchCourseAssignmentAsync(apiClient_t *apiClient, char *tenantId, char *assignmentId, char *api_version, char *x_api_version, list_t *patch_operation);
```
