...
//
list_t* CourseUnitComponentsAPI_getCourseUnitComponentsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_unit_component_dto_collection_query_parameters_t *course_unit_component_dto_collection_query_parameters);
```
...
//
int* CourseUnitComponentsAPI_getCourseUnitComponentsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_unit_component_dto_collection_query_parameters_t *course_unit_component_dto_collection_query_parameters);
```
...
//
empty_envelope_t* CourseUnitComponentsAPI_patchCourseUnitComponentAsync(apiClient_t *apiClient, char *tenantId, char *componentId, char *api_version, char *x_api_version, list_t *patch_operation);
```
