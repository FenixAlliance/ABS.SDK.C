...
//
list_t* CourseProblemSetsAPI_getCourseProblemSetsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_problem_set_dto_collection_query_parameters_t *course_problem_set_dto_collection_query_parameters);
```
...
//
int* CourseProblemSetsAPI_getCourseProblemSetsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_problem_set_dto_collection_query_parameters_t *course_problem_set_dto_collection_query_parameters);
```
...
//
empty_envelope_t* CourseProblemSetsAPI_patchCourseProblemSetAsync(apiClient_t *apiClient, char *tenantId, char *problemSetId, char *api_version, char *x_api_version, list_t *patch_operation);
```
