...
//
empty_envelope_t* CourseUpdatesAPI_patchCourseUpdateAsync(apiClient_t *apiClient, char *tenantId, char *updateId, char *api_version, char *x_api_version, list_t *operation);
```
