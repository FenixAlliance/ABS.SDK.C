...
#include <stdio.h>
#include <ctype.h>
#include "CourseAssignmentTypesAPI.h"
...
CourseAssignmentTypesAPI_createCourseAssignmentTypeAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_assignment_type_create_dto_t *course_assignment_type_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseAssignmentTypes")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseAssignmentTypes");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_assignment_type_create_dto = NULL;
    if (course_assignment_type_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_assignment_type_create_dto = course_assignment_type_create_dto_convertToJSON(course_assignment_type_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_assignment_type_create_dto);
    }
    ...
    if (localVarSingleItemJSON_course_assignment_type_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_assignment_type_create_dto);
        localVarSingleItemJSON_course_assignment_type_create_dto = NULL;
    }
...
CourseAssignmentTypesAPI_deleteCourseAssignmentTypeAsync(apiClient_t *apiClient, char *tenantId, char *assignmentTypeId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseAssignmentTypes/{assignmentTypeId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseAssignmentTypes/{assignmentTypeId}");


    // Path Params
    long sizeOfPathParams_assignmentTypeId = strlen(assignmentTypeId)+3 + strlen("{ assignmentTypeId }");
    if(assignmentTypeId == NULL) {
        goto end;
    }
    char* localVarToReplace_assignmentTypeId = malloc(sizeOfPathParams_assignmentTypeId);
    sprintf(localVarToReplace_assignmentTypeId, "{%s}", "assignmentTypeId");

    localVarPath = strReplace(localVarPath, localVarToReplace_assignmentTypeId, assignmentTypeId);
    ...
    free(localVarPath);
    free(localVarToReplace_assignmentTypeId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
CourseAssignmentTypesAPI_getCourseAssignmentTypeByIdAsync(apiClient_t *apiClient, char *assignmentTypeId, char *api_version, char *x_api_version)
{
    ...
    cJSON *CourseAssignmentTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    course_assignment_type_dto_t *elementToReturn = course_assignment_type_dto_parseFromJSON(CourseAssignmentTypesAPIlocalVarJSON);
    cJSON_Delete(CourseAssignmentTypesAPIlocalVarJSON);
...
CourseAssignmentTypesAPI_getCourseAssignmentTypesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_assignment_type_dto_collection_query_parameters_t *course_assignment_type_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_assignment_type_dto_collection_query_parameters = NULL;
    if (course_assignment_type_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_course_assignment_type_dto_collection_query_parameters = course_assignment_type_dto_collection_query_parameters_convertToJSON(course_assignment_type_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_assignment_type_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //}
    cJSON *CourseAssignmentTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(CourseAssignmentTypesAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, CourseAssignmentTypesAPIlocalVarJSON)
    {
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_assignment_type_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_course_assignment_type_dto_collection_query_parameters);
        localVarSingleItemJSON_course_assignment_type_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
CourseAssignmentTypesAPI_getCourseAssignmentTypesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_assignment_type_dto_collection_query_parameters_t *course_assignment_type_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseAssignmentTypes/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseAssignmentTypes/Count");
...
CourseAssignmentTypesAPI_patchCourseAssignmentTypeAsync(apiClient_t *apiClient, char *tenantId, char *assignmentTypeId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *CourseAssignmentTypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(CourseAssignmentTypesAPIlocalVarJSON);
    cJSON_Delete(CourseAssignmentTypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CourseAssignmentTypesAPI_updateCourseAssignmentTypeAsync(apiClient_t *apiClient, char *tenantId, char *assignmentTypeId, char *api_version, char *x_api_version, course_assignment_type_update_dto_t *course_assignment_type_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_assignment_type_update_dto = NULL;
    if (course_assignment_type_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_assignment_type_update_dto = course_assignment_type_update_dto_convertToJSON(course_assignment_type_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_assignment_type_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_assignment_type_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_assignment_type_update_dto);
        localVarSingleItemJSON_course_assignment_type_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
