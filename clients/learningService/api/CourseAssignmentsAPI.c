...
#include <stdio.h>
#include <ctype.h>
#include "CourseAssignmentsAPI.h"
...
CourseAssignmentsAPI_createCourseAssignmentAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_assignment_create_dto_t *course_assignment_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseAssignments")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseAssignments");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_assignment_create_dto = NULL;
    if (course_assignment_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_assignment_create_dto = course_assignment_create_dto_convertToJSON(course_assignment_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_assignment_create_dto);
    }
    ...
    if (localVarSingleItemJSON_course_assignment_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_assignment_create_dto);
        localVarSingleItemJSON_course_assignment_create_dto = NULL;
    }
...
CourseAssignmentsAPI_deleteCourseAssignmentAsync(apiClient_t *apiClient, char *tenantId, char *assignmentId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseAssignments/{assignmentId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseAssignments/{assignmentId}");


    // Path Params
    long sizeOfPathParams_assignmentId = strlen(assignmentId)+3 + strlen("{ assignmentId }");
    if(assignmentId == NULL) {
        goto end;
    }
    char* localVarToReplace_assignmentId = malloc(sizeOfPathParams_assignmentId);
    sprintf(localVarToReplace_assignmentId, "{%s}", "assignmentId");

    localVarPath = strReplace(localVarPath, localVarToReplace_assignmentId, assignmentId);
    ...
    free(localVarPath);
    free(localVarToReplace_assignmentId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
CourseAssignmentsAPI_getCourseAssignmentByIdAsync(apiClient_t *apiClient, char *assignmentId, char *api_version, char *x_api_version)
{
    ...
    cJSON *CourseAssignmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    course_assignment_dto_t *elementToReturn = course_assignment_dto_parseFromJSON(CourseAssignmentsAPIlocalVarJSON);
    cJSON_Delete(CourseAssignmentsAPIlocalVarJSON);
...
CourseAssignmentsAPI_getCourseAssignmentsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_assignment_dto_collection_query_parameters_t *course_assignment_dto_collection_query_parameters)
{
    ...
    //}
    cJSON *CourseAssignmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(CourseAssignmentsAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, CourseAssignmentsAPIlocalVarJSON)
    {
...
CourseAssignmentsAPI_getCourseAssignmentsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_assignment_dto_collection_query_parameters_t *course_assignment_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseAssignments/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseAssignments/Count");
...
CourseAssignmentsAPI_patchCourseAssignmentAsync(apiClient_t *apiClient, char *tenantId, char *assignmentId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *CourseAssignmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(CourseAssignmentsAPIlocalVarJSON);
    cJSON_Delete(CourseAssignmentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CourseAssignmentsAPI_updateCourseAssignmentAsync(apiClient_t *apiClient, char *tenantId, char *assignmentId, char *api_version, char *x_api_version, course_assignment_update_dto_t *course_assignment_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_assignment_update_dto = NULL;
    if (course_assignment_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_assignment_update_dto = course_assignment_update_dto_convertToJSON(course_assignment_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_assignment_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_assignment_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_assignment_update_dto);
        localVarSingleItemJSON_course_assignment_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
