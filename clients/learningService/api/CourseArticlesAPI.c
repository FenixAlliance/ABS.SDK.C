...
CourseArticlesAPI_createCourseArticleAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_article_create_dto_t *course_article_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseArticles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseArticles");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_article_create_dto = NULL;
    if (course_article_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_article_create_dto = course_article_create_dto_convertToJSON(course_article_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_article_create_dto);
    }
    ...
    if (localVarSingleItemJSON_course_article_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_article_create_dto);
        localVarSingleItemJSON_course_article_create_dto = NULL;
    }
...
CourseArticlesAPI_deleteCourseArticleAsync(apiClient_t *apiClient, char *tenantId, char *articleId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseArticles/{articleId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseArticles/{articleId}");


    // Path Params
    long sizeOfPathParams_articleId = strlen(articleId)+3 + strlen("{ articleId }");
    if(articleId == NULL) {
        goto end;
    }
    char* localVarToReplace_articleId = malloc(sizeOfPathParams_articleId);
    sprintf(localVarToReplace_articleId, "{%s}", "articleId");

    localVarPath = strReplace(localVarPath, localVarToReplace_articleId, articleId);
    ...
    free(localVarPath);
    free(localVarToReplace_articleId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
CourseArticlesAPI_getCourseArticleByIdAsync(apiClient_t *apiClient, char *articleId, char *api_version, char *x_api_version)
{
    ...
    cJSON *CourseArticlesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    course_article_dto_t *elementToReturn = course_article_dto_parseFromJSON(CourseArticlesAPIlocalVarJSON);
    cJSON_Delete(CourseArticlesAPIlocalVarJSON);
...
CourseArticlesAPI_getCourseArticlesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //}
    cJSON *CourseArticlesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(CourseArticlesAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, CourseArticlesAPIlocalVarJSON)
    {
...
CourseArticlesAPI_getCourseArticlesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseArticles/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseArticles/Count");
...
CourseArticlesAPI_patchCourseArticleAsync(apiClient_t *apiClient, char *tenantId, char *articleId, char *api_version, char *x_api_version, list_t *operation)
{
    ...
    //nonprimitive not container
    cJSON *CourseArticlesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(CourseArticlesAPIlocalVarJSON);
    cJSON_Delete(CourseArticlesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CourseArticlesAPI_updateCourseArticleAsync(apiClient_t *apiClient, char *tenantId, char *articleId, char *api_version, char *x_api_version, course_article_update_dto_t *course_article_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_article_update_dto = NULL;
    if (course_article_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_article_update_dto = course_article_update_dto_convertToJSON(course_article_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_article_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_article_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_article_update_dto);
        localVarSingleItemJSON_course_article_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
