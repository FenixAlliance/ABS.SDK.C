...
CourseUpdatesAPI_createCourseUpdateAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_news_create_dto_t *course_news_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseUpdates")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseUpdates");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_news_create_dto = NULL;
    if (course_news_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_news_create_dto = course_news_create_dto_convertToJSON(course_news_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_news_create_dto);
    }
    ...
    if (localVarSingleItemJSON_course_news_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_news_create_dto);
        localVarSingleItemJSON_course_news_create_dto = NULL;
    }
...
CourseUpdatesAPI_deleteCourseUpdateAsync(apiClient_t *apiClient, char *tenantId, char *updateId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseUpdates/{updateId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseUpdates/{updateId}");


    // Path Params
    long sizeOfPathParams_updateId = strlen(updateId)+3 + strlen("{ updateId }");
    if(updateId == NULL) {
        goto end;
    }
    char* localVarToReplace_updateId = malloc(sizeOfPathParams_updateId);
    sprintf(localVarToReplace_updateId, "{%s}", "updateId");

    localVarPath = strReplace(localVarPath, localVarToReplace_updateId, updateId);
    ...
    free(localVarPath);
    free(localVarToReplace_updateId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
CourseUpdatesAPI_getCourseUpdateByIdAsync(apiClient_t *apiClient, char *updateId, char *api_version, char *x_api_version)
{
    ...
    cJSON *CourseUpdatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    course_news_dto_t *elementToReturn = course_news_dto_parseFromJSON(CourseUpdatesAPIlocalVarJSON);
    cJSON_Delete(CourseUpdatesAPIlocalVarJSON);
...
CourseUpdatesAPI_getCourseUpdatesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_news_dto_collection_query_parameters_t *course_news_dto_collection_query_parameters)
{
    ...
    //}
    cJSON *CourseUpdatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(CourseUpdatesAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, CourseUpdatesAPIlocalVarJSON)
    {
...
CourseUpdatesAPI_getCourseUpdatesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_news_dto_collection_query_parameters_t *course_news_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseUpdates/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseUpdates/Count");
...
CourseUpdatesAPI_patchCourseUpdateAsync(apiClient_t *apiClient, char *tenantId, char *updateId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *CourseUpdatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(CourseUpdatesAPIlocalVarJSON);
    cJSON_Delete(CourseUpdatesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CourseUpdatesAPI_updateCourseUpdateAsync(apiClient_t *apiClient, char *tenantId, char *updateId, char *api_version, char *x_api_version, course_news_update_dto_t *course_news_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_news_update_dto = NULL;
    if (course_news_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_news_update_dto = course_news_update_dto_convertToJSON(course_news_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_news_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_news_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_news_update_dto);
        localVarSingleItemJSON_course_news_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
