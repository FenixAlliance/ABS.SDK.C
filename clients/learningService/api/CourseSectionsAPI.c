...
CourseSectionsAPI_createCourseSectionAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_section_create_dto_t *course_section_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseSections")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseSections");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_section_create_dto = NULL;
    if (course_section_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_section_create_dto = course_section_create_dto_convertToJSON(course_section_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_section_create_dto);
    }
    ...
    if (localVarSingleItemJSON_course_section_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_section_create_dto);
        localVarSingleItemJSON_course_section_create_dto = NULL;
    }
...
CourseSectionsAPI_deleteCourseSectionAsync(apiClient_t *apiClient, char *tenantId, char *sectionId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseSections/{sectionId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseSections/{sectionId}");


    // Path Params
    long sizeOfPathParams_sectionId = strlen(sectionId)+3 + strlen("{ sectionId }");
    if(sectionId == NULL) {
        goto end;
    }
...
CourseSectionsAPI_getCourseSectionByIdAsync(apiClient_t *apiClient, char *sectionId, char *api_version, char *x_api_version)
{
    ...
    cJSON *CourseSectionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    course_section_dto_t *elementToReturn = course_section_dto_parseFromJSON(CourseSectionsAPIlocalVarJSON);
    cJSON_Delete(CourseSectionsAPIlocalVarJSON);
...
CourseSectionsAPI_getCourseSectionsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_section_dto_collection_query_parameters_t *course_section_dto_collection_query_parameters)
{
    ...
    //}
    cJSON *CourseSectionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(CourseSectionsAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, CourseSectionsAPIlocalVarJSON)
    {
...
CourseSectionsAPI_getCourseSectionsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_section_dto_collection_query_parameters_t *course_section_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseSections/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseSections/Count");
...
CourseSectionsAPI_patchCourseSectionAsync(apiClient_t *apiClient, char *tenantId, char *sectionId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *CourseSectionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(CourseSectionsAPIlocalVarJSON);
    cJSON_Delete(CourseSectionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CourseSectionsAPI_updateCourseSectionAsync(apiClient_t *apiClient, char *tenantId, char *sectionId, char *api_version, char *x_api_version, course_section_update_dto_t *course_section_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_section_update_dto = NULL;
    if (course_section_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_section_update_dto = course_section_update_dto_convertToJSON(course_section_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_section_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_section_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_section_update_dto);
        localVarSingleItemJSON_course_section_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
