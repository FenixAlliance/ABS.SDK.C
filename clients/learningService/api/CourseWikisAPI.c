...
CourseWikisAPI_createCourseWikiAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_wiki_create_dto_t *course_wiki_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseWikis")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseWikis");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_wiki_create_dto = NULL;
    if (course_wiki_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_wiki_create_dto = course_wiki_create_dto_convertToJSON(course_wiki_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_wiki_create_dto);
    }
    ...
    if (localVarSingleItemJSON_course_wiki_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_wiki_create_dto);
        localVarSingleItemJSON_course_wiki_create_dto = NULL;
    }
...
CourseWikisAPI_deleteCourseWikiAsync(apiClient_t *apiClient, char *tenantId, char *wikiId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseWikis/{wikiId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseWikis/{wikiId}");


    // Path Params
    long sizeOfPathParams_wikiId = strlen(wikiId)+3 + strlen("{ wikiId }");
    if(wikiId == NULL) {
        goto end;
    }
...
CourseWikisAPI_getCourseWikiByIdAsync(apiClient_t *apiClient, char *wikiId, char *api_version, char *x_api_version)
{
    ...
    cJSON *CourseWikisAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    course_wiki_dto_t *elementToReturn = course_wiki_dto_parseFromJSON(CourseWikisAPIlocalVarJSON);
    cJSON_Delete(CourseWikisAPIlocalVarJSON);
...
CourseWikisAPI_getCourseWikisAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //}
    cJSON *CourseWikisAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(CourseWikisAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, CourseWikisAPIlocalVarJSON)
    {
...
CourseWikisAPI_getCourseWikisCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseWikis/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseWikis/Count");
...
CourseWikisAPI_patchCourseWikiAsync(apiClient_t *apiClient, char *tenantId, char *wikiId, char *api_version, char *x_api_version, list_t *operation)
{
    ...
    //nonprimitive not container
    cJSON *CourseWikisAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(CourseWikisAPIlocalVarJSON);
    cJSON_Delete(CourseWikisAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CourseWikisAPI_updateCourseWikiAsync(apiClient_t *apiClient, char *tenantId, char *wikiId, char *api_version, char *x_api_version, course_wiki_update_dto_t *course_wiki_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_wiki_update_dto = NULL;
    if (course_wiki_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_wiki_update_dto = course_wiki_update_dto_convertToJSON(course_wiki_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_wiki_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_wiki_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_wiki_update_dto);
        localVarSingleItemJSON_course_wiki_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
