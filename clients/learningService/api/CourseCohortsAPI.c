...
CourseCohortsAPI_createCourseCohortAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_cohort_create_dto_t *course_cohort_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseCohorts")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseCohorts");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_cohort_create_dto = NULL;
    if (course_cohort_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_cohort_create_dto = course_cohort_create_dto_convertToJSON(course_cohort_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_cohort_create_dto);
    }
    ...
    if (localVarSingleItemJSON_course_cohort_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_cohort_create_dto);
        localVarSingleItemJSON_course_cohort_create_dto = NULL;
    }
...
CourseCohortsAPI_deleteCourseCohortAsync(apiClient_t *apiClient, char *tenantId, char *cohortId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseCohorts/{cohortId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseCohorts/{cohortId}");


    // Path Params
    long sizeOfPathParams_cohortId = strlen(cohortId)+3 + strlen("{ cohortId }");
    if(cohortId == NULL) {
        goto end;
    }
    char* localVarToReplace_cohortId = malloc(sizeOfPathParams_cohortId);
    sprintf(localVarToReplace_cohortId, "{%s}", "cohortId");

    localVarPath = strReplace(localVarPath, localVarToReplace_cohortId, cohortId);
    ...
    free(localVarPath);
    free(localVarToReplace_cohortId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
CourseCohortsAPI_getCourseCohortByIdAsync(apiClient_t *apiClient, char *cohortId, char *api_version, char *x_api_version)
{
    ...
    cJSON *CourseCohortsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    course_cohort_dto_t *elementToReturn = course_cohort_dto_parseFromJSON(CourseCohortsAPIlocalVarJSON);
    cJSON_Delete(CourseCohortsAPIlocalVarJSON);
...
CourseCohortsAPI_getCourseCohortsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //}
    cJSON *CourseCohortsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(CourseCohortsAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, CourseCohortsAPIlocalVarJSON)
    {
...
CourseCohortsAPI_getCourseCohortsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseCohorts/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseCohorts/Count");
...
CourseCohortsAPI_patchCourseCohortAsync(apiClient_t *apiClient, char *tenantId, char *cohortId, char *api_version, char *x_api_version, list_t *operation)
{
    ...
    //nonprimitive not container
    cJSON *CourseCohortsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(CourseCohortsAPIlocalVarJSON);
    cJSON_Delete(CourseCohortsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CourseCohortsAPI_updateCourseCohortAsync(apiClient_t *apiClient, char *tenantId, char *cohortId, char *api_version, char *x_api_version, course_cohort_update_dto_t *course_cohort_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_cohort_update_dto = NULL;
    if (course_cohort_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_cohort_update_dto = course_cohort_update_dto_convertToJSON(course_cohort_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_cohort_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_cohort_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_cohort_update_dto);
        localVarSingleItemJSON_course_cohort_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
