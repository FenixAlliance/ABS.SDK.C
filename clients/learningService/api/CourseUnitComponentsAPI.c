...
#include <stdio.h>
#include <ctype.h>
#include "CourseUnitComponentsAPI.h"
...
CourseUnitComponentsAPI_createCourseUnitComponentAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_unit_component_create_dto_t *course_unit_component_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseUnitComponents")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseUnitComponents");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_unit_component_create_dto = NULL;
    if (course_unit_component_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_unit_component_create_dto = course_unit_component_create_dto_convertToJSON(course_unit_component_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_unit_component_create_dto);
    }
    ...
    if (localVarSingleItemJSON_course_unit_component_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_unit_component_create_dto);
        localVarSingleItemJSON_course_unit_component_create_dto = NULL;
    }
...
CourseUnitComponentsAPI_deleteCourseUnitComponentAsync(apiClient_t *apiClient, char *tenantId, char *componentId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseUnitComponents/{componentId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseUnitComponents/{componentId}");
...
CourseUnitComponentsAPI_getCourseUnitComponentByIdAsync(apiClient_t *apiClient, char *componentId, char *api_version, char *x_api_version)
{
    ...
    cJSON *CourseUnitComponentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    course_unit_component_dto_t *elementToReturn = course_unit_component_dto_parseFromJSON(CourseUnitComponentsAPIlocalVarJSON);
    cJSON_Delete(CourseUnitComponentsAPIlocalVarJSON);
...
CourseUnitComponentsAPI_getCourseUnitComponentsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //}
    cJSON *CourseUnitComponentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(CourseUnitComponentsAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, CourseUnitComponentsAPIlocalVarJSON)
    {
...
CourseUnitComponentsAPI_getCourseUnitComponentsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseUnitComponents/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseUnitComponents/Count");
...
CourseUnitComponentsAPI_patchCourseUnitComponentAsync(apiClient_t *apiClient, char *tenantId, char *componentId, char *api_version, char *x_api_version, list_t *operation)
{
    ...
    //nonprimitive not container
    cJSON *CourseUnitComponentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(CourseUnitComponentsAPIlocalVarJSON);
    cJSON_Delete(CourseUnitComponentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CourseUnitComponentsAPI_updateCourseUnitComponentAsync(apiClient_t *apiClient, char *tenantId, char *componentId, char *api_version, char *x_api_version, course_unit_component_update_dto_t *course_unit_component_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_unit_component_update_dto = NULL;
    if (course_unit_component_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_unit_component_update_dto = course_unit_component_update_dto_convertToJSON(course_unit_component_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_unit_component_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_unit_component_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_unit_component_update_dto);
        localVarSingleItemJSON_course_unit_component_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
