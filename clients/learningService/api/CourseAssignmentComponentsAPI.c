...
#include <stdio.h>
#include <ctype.h>
#include "CourseAssignmentComponentsAPI.h"
...
CourseAssignmentComponentsAPI_createCourseAssignmentComponentAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_assignment_component_create_dto_t *course_assignment_component_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseAssignmentComponents")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseAssignmentComponents");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_assignment_component_create_dto = NULL;
    if (course_assignment_component_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_assignment_component_create_dto = course_assignment_component_create_dto_convertToJSON(course_assignment_component_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_assignment_component_create_dto);
    }
    ...
    if (localVarSingleItemJSON_course_assignment_component_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_assignment_component_create_dto);
        localVarSingleItemJSON_course_assignment_component_create_dto = NULL;
    }
...
CourseAssignmentComponentsAPI_deleteCourseAssignmentComponentAsync(apiClient_t *apiClient, char *tenantId, char *componentId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseAssignmentComponents/{componentId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseAssignmentComponents/{componentId}");


    // Path Params
    long sizeOfPathParams_componentId = strlen(componentId)+3 + strlen("{ componentId }");
    if(componentId == NULL) {
        goto end;
    }
    char* localVarToReplace_componentId = malloc(sizeOfPathParams_componentId);
    sprintf(localVarToReplace_componentId, "{%s}", "componentId");

    localVarPath = strReplace(localVarPath, localVarToReplace_componentId, componentId);
    ...
    free(localVarPath);
    free(localVarToReplace_componentId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
CourseAssignmentComponentsAPI_getCourseAssignmentComponentByIdAsync(apiClient_t *apiClient, char *componentId, char *api_version, char *x_api_version)
{
    ...
    cJSON *CourseAssignmentComponentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    course_assignment_component_dto_t *elementToReturn = course_assignment_component_dto_parseFromJSON(CourseAssignmentComponentsAPIlocalVarJSON);
    cJSON_Delete(CourseAssignmentComponentsAPIlocalVarJSON);
...
CourseAssignmentComponentsAPI_getCourseAssignmentComponentsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_assignment_component_dto_collection_query_parameters_t *course_assignment_component_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_assignment_component_dto_collection_query_parameters = NULL;
    if (course_assignment_component_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_course_assignment_component_dto_collection_query_parameters = course_assignment_component_dto_collection_query_parameters_convertToJSON(course_assignment_component_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_assignment_component_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //}
    cJSON *CourseAssignmentComponentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(CourseAssignmentComponentsAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, CourseAssignmentComponentsAPIlocalVarJSON)
    {
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_assignment_component_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_course_assignment_component_dto_collection_query_parameters);
        localVarSingleItemJSON_course_assignment_component_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
CourseAssignmentComponentsAPI_getCourseAssignmentComponentsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_assignment_component_dto_collection_query_parameters_t *course_assignment_component_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseAssignmentComponents/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseAssignmentComponents/Count");
...
CourseAssignmentComponentsAPI_patchCourseAssignmentComponentAsync(apiClient_t *apiClient, char *tenantId, char *componentId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *CourseAssignmentComponentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(CourseAssignmentComponentsAPIlocalVarJSON);
    cJSON_Delete(CourseAssignmentComponentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CourseAssignmentComponentsAPI_updateCourseAssignmentComponentAsync(apiClient_t *apiClient, char *tenantId, char *componentId, char *api_version, char *x_api_version, course_assignment_component_update_dto_t *course_assignment_component_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_assignment_component_update_dto = NULL;
    if (course_assignment_component_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_assignment_component_update_dto = course_assignment_component_update_dto_convertToJSON(course_assignment_component_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_assignment_component_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_assignment_component_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_assignment_component_update_dto);
        localVarSingleItemJSON_course_assignment_component_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
