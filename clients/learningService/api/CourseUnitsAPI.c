...
CourseUnitsAPI_createCourseUnitAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_unit_create_dto_t *course_unit_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseUnits")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseUnits");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_unit_create_dto = NULL;
    if (course_unit_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_unit_create_dto = course_unit_create_dto_convertToJSON(course_unit_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_unit_create_dto);
    }
    ...
    if (localVarSingleItemJSON_course_unit_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_unit_create_dto);
        localVarSingleItemJSON_course_unit_create_dto = NULL;
    }
...
CourseUnitsAPI_deleteCourseUnitAsync(apiClient_t *apiClient, char *tenantId, char *unitId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseUnits/{unitId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseUnits/{unitId}");


    // Path Params
    long sizeOfPathParams_unitId = strlen(unitId)+3 + strlen("{ unitId }");
    if(unitId == NULL) {
        goto end;
    }
...
CourseUnitsAPI_getCourseUnitByIdAsync(apiClient_t *apiClient, char *unitId, char *api_version, char *x_api_version)
{
    ...
    cJSON *CourseUnitsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    course_unit_dto_t *elementToReturn = course_unit_dto_parseFromJSON(CourseUnitsAPIlocalVarJSON);
    cJSON_Delete(CourseUnitsAPIlocalVarJSON);
...
//
list_t*
CourseUnitsAPI_getCourseUnitsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_unit_dto_collection_query_parameters_t *course_unit_dto_collection_query_parameters)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = list_createList();
    list_t    *localVarFormParameters = NULL;
    ...
    //}
    cJSON *CourseUnitsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(CourseUnitsAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, CourseUnitsAPIlocalVarJSON)
    {
...
//
int*
CourseUnitsAPI_getCourseUnitsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_unit_dto_collection_query_parameters_t *course_unit_dto_collection_query_parameters)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = list_createList();
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseUnits/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseUnits/Count");
...
//
empty_envelope_t*
CourseUnitsAPI_patchCourseUnitAsync(apiClient_t *apiClient, char *tenantId, char *unitId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = list_createList();
    list_t    *localVarFormParameters = NULL;
    ...
    //nonprimitive not container
    cJSON *CourseUnitsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(CourseUnitsAPIlocalVarJSON);
    cJSON_Delete(CourseUnitsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CourseUnitsAPI_updateCourseUnitAsync(apiClient_t *apiClient, char *tenantId, char *unitId, char *api_version, char *x_api_version, course_unit_update_dto_t *course_unit_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_unit_update_dto = NULL;
    if (course_unit_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_unit_update_dto = course_unit_update_dto_convertToJSON(course_unit_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_unit_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_unit_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_unit_update_dto);
        localVarSingleItemJSON_course_unit_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
