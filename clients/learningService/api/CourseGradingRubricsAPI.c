...
#include <stdio.h>
#include <ctype.h>
#include "CourseGradingRubricsAPI.h"
...
CourseGradingRubricsAPI_createCourseGradingRubricAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_grading_rubric_create_dto_t *course_grading_rubric_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseGradingRubrics")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseGradingRubrics");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_grading_rubric_create_dto = NULL;
    if (course_grading_rubric_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_grading_rubric_create_dto = course_grading_rubric_create_dto_convertToJSON(course_grading_rubric_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_grading_rubric_create_dto);
    }
    ...
    if (localVarSingleItemJSON_course_grading_rubric_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_grading_rubric_create_dto);
        localVarSingleItemJSON_course_grading_rubric_create_dto = NULL;
    }
...
CourseGradingRubricsAPI_deleteCourseGradingRubricAsync(apiClient_t *apiClient, char *tenantId, char *rubricId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseGradingRubrics/{rubricId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseGradingRubrics/{rubricId}");


    // Path Params
    long sizeOfPathParams_rubricId = strlen(rubricId)+3 + strlen("{ rubricId }");
    if(rubricId == NULL) {
        goto end;
    }
    char* localVarToReplace_rubricId = malloc(sizeOfPathParams_rubricId);
    sprintf(localVarToReplace_rubricId, "{%s}", "rubricId");

    localVarPath = strReplace(localVarPath, localVarToReplace_rubricId, rubricId);
    ...
    free(localVarPath);
    free(localVarToReplace_rubricId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
CourseGradingRubricsAPI_getCourseGradingRubricByIdAsync(apiClient_t *apiClient, char *rubricId, char *api_version, char *x_api_version)
{
    ...
    cJSON *CourseGradingRubricsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    course_grading_rubric_dto_t *elementToReturn = course_grading_rubric_dto_parseFromJSON(CourseGradingRubricsAPIlocalVarJSON);
    cJSON_Delete(CourseGradingRubricsAPIlocalVarJSON);
...
CourseGradingRubricsAPI_getCourseGradingRubricsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_grading_rubric_dto_collection_query_parameters_t *course_grading_rubric_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_grading_rubric_dto_collection_query_parameters = NULL;
    if (course_grading_rubric_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_course_grading_rubric_dto_collection_query_parameters = course_grading_rubric_dto_collection_query_parameters_convertToJSON(course_grading_rubric_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_grading_rubric_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //}
    cJSON *CourseGradingRubricsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(CourseGradingRubricsAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, CourseGradingRubricsAPIlocalVarJSON)
    {
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_grading_rubric_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_course_grading_rubric_dto_collection_query_parameters);
        localVarSingleItemJSON_course_grading_rubric_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
CourseGradingRubricsAPI_getCourseGradingRubricsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_grading_rubric_dto_collection_query_parameters_t *course_grading_rubric_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseGradingRubrics/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseGradingRubrics/Count");
...
CourseGradingRubricsAPI_updateCourseGradingRubricAsync(apiClient_t *apiClient, char *tenantId, char *rubricId, char *api_version, char *x_api_version, course_grading_rubric_update_dto_t *course_grading_rubric_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_grading_rubric_update_dto = NULL;
    if (course_grading_rubric_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_grading_rubric_update_dto = course_grading_rubric_update_dto_convertToJSON(course_grading_rubric_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_grading_rubric_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_grading_rubric_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_grading_rubric_update_dto);
        localVarSingleItemJSON_course_grading_rubric_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
