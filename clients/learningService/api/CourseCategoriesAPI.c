...
CourseCategoriesAPI_createCourseCategoryAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_category_create_dto_t *course_category_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseCategories")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseCategories");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_category_create_dto = NULL;
    if (course_category_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_category_create_dto = course_category_create_dto_convertToJSON(course_category_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_category_create_dto);
    }
    ...
    if (localVarSingleItemJSON_course_category_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_category_create_dto);
        localVarSingleItemJSON_course_category_create_dto = NULL;
    }
...
CourseCategoriesAPI_deleteCourseCategoryAsync(apiClient_t *apiClient, char *tenantId, char *categoryId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseCategories/{categoryId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseCategories/{categoryId}");
...
CourseCategoriesAPI_getCourseCategoriesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //    printf("%s\n","OK");
    //}
    cJSON *CourseCategoriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(CourseCategoriesAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, CourseCategoriesAPIlocalVarJSON)
    {
    ...
    cJSON_Delete( CourseCategoriesAPIlocalVarJSON);
...
CourseCategoriesAPI_getCourseCategoriesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseCategories/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseCategories/Count");
...
CourseCategoriesAPI_getCourseCategoryByIdAsync(apiClient_t *apiClient, char *categoryId, char *api_version, char *x_api_version)
{
    ...
    cJSON *CourseCategoriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    course_category_dto_t *elementToReturn = course_category_dto_parseFromJSON(CourseCategoriesAPIlocalVarJSON);
    cJSON_Delete(CourseCategoriesAPIlocalVarJSON);
...
CourseCategoriesAPI_patchCourseCategoryAsync(apiClient_t *apiClient, char *tenantId, char *categoryId, char *api_version, char *x_api_version, list_t *operation)
{
    ...
    //nonprimitive not container
    cJSON *CourseCategoriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(CourseCategoriesAPIlocalVarJSON);
    cJSON_Delete(CourseCategoriesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CourseCategoriesAPI_updateCourseCategoryAsync(apiClient_t *apiClient, char *tenantId, char *categoryId, char *api_version, char *x_api_version, course_category_update_dto_t *course_category_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_category_update_dto = NULL;
    if (course_category_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_category_update_dto = course_category_update_dto_convertToJSON(course_category_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_category_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_category_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_category_update_dto);
        localVarSingleItemJSON_course_category_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
