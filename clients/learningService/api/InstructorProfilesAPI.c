...
#include <stdio.h>
#include <ctype.h>
#include "InstructorProfilesAPI.h"
...
InstructorProfilesAPI_apiV2LearningServiceInstructorProfilesCountGet(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/InstructorProfiles/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/InstructorProfiles/Count");
...
InstructorProfilesAPI_apiV2LearningServiceInstructorProfilesGet(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/InstructorProfiles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/InstructorProfiles");
    ...
    //    printf("%s\n","OK");
    //}
    cJSON *InstructorProfilesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(InstructorProfilesAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, InstructorProfilesAPIlocalVarJSON)
    {
    ...
    cJSON_Delete( InstructorProfilesAPIlocalVarJSON);
...
InstructorProfilesAPI_apiV2LearningServiceInstructorProfilesInstructorProfileIdDelete(apiClient_t *apiClient, char *tenantId, char *instructorProfileId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/InstructorProfiles/{instructorProfileId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/InstructorProfiles/{instructorProfileId}");


    // Path Params
    long sizeOfPathParams_instructorProfileId = strlen(instructorProfileId)+3 + strlen("{ instructorProfileId }");
    if(instructorProfileId == NULL) {
        goto end;
    }
    char* localVarToReplace_instructorProfileId = malloc(sizeOfPathParams_instructorProfileId);
    sprintf(localVarToReplace_instructorProfileId, "{%s}", "instructorProfileId");

    localVarPath = strReplace(localVarPath, localVarToReplace_instructorProfileId, instructorProfileId);
    if(instructorProfileId == NULL) {
        goto end;
    }
    char* localVarToReplace_instructorProfileId = malloc(sizeOfPathParams_instructorProfileId);
    ...
    free(localVarPath);
    free(localVarToReplace_instructorProfileId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
InstructorProfilesAPI_apiV2LearningServiceInstructorProfilesInstructorProfileIdGet(apiClient_t *apiClient, char *tenantId, char *instructorProfileId, char *api_version, char *x_api_version)
{
    ...
    cJSON *InstructorProfilesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    instructor_profile_dto_t *elementToReturn = instructor_profile_dto_parseFromJSON(InstructorProfilesAPIlocalVarJSON);
    cJSON_Delete(InstructorProfilesAPIlocalVarJSON);
...
InstructorProfilesAPI_apiV2LearningServiceInstructorProfilesInstructorProfileIdPatch(apiClient_t *apiClient, char *tenantId, char *instructorProfileId, char *api_version, char *x_api_version, list_t *operation)
{
    ...
    //nonprimitive not container
    cJSON *InstructorProfilesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(InstructorProfilesAPIlocalVarJSON);
    cJSON_Delete(InstructorProfilesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
InstructorProfilesAPI_apiV2LearningServiceInstructorProfilesInstructorProfileIdPut(apiClient_t *apiClient, char *tenantId, char *instructorProfileId, char *api_version, char *x_api_version, instructor_profile_update_dto_t *instructor_profile_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_instructor_profile_update_dto = NULL;
    if (instructor_profile_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_instructor_profile_update_dto = instructor_profile_update_dto_convertToJSON(instructor_profile_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_instructor_profile_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_instructor_profile_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_instructor_profile_update_dto);
        localVarSingleItemJSON_instructor_profile_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
InstructorProfilesAPI_apiV2LearningServiceInstructorProfilesPost(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, instructor_profile_create_dto_t *instructor_profile_create_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_instructor_profile_create_dto = NULL;
    if (instructor_profile_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_instructor_profile_create_dto = instructor_profile_create_dto_convertToJSON(instructor_profile_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_instructor_profile_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_instructor_profile_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_instructor_profile_create_dto);
        localVarSingleItemJSON_instructor_profile_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
