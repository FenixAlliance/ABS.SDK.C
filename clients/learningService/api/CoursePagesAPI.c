...
CoursePagesAPI_createCoursePageAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_page_create_dto_t *course_page_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CoursePages")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CoursePages");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_page_create_dto = NULL;
    if (course_page_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_page_create_dto = course_page_create_dto_convertToJSON(course_page_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_page_create_dto);
    }
    ...
    if (localVarSingleItemJSON_course_page_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_page_create_dto);
        localVarSingleItemJSON_course_page_create_dto = NULL;
    }
...
CoursePagesAPI_deleteCoursePageAsync(apiClient_t *apiClient, char *tenantId, char *pageId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CoursePages/{pageId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CoursePages/{pageId}");


    // Path Params
    long sizeOfPathParams_pageId = strlen(pageId)+3 + strlen("{ pageId }");
    if(pageId == NULL) {
        goto end;
    }
    char* localVarToReplace_pageId = malloc(sizeOfPathParams_pageId);
    sprintf(localVarToReplace_pageId, "{%s}", "pageId");

    localVarPath = strReplace(localVarPath, localVarToReplace_pageId, pageId);
...
CoursePagesAPI_getCoursePageByIdAsync(apiClient_t *apiClient, char *pageId, char *api_version, char *x_api_version)
{
    ...
    cJSON *CoursePagesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    course_page_dto_t *elementToReturn = course_page_dto_parseFromJSON(CoursePagesAPIlocalVarJSON);
    cJSON_Delete(CoursePagesAPIlocalVarJSON);
...
CoursePagesAPI_getCoursePagesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //}
    cJSON *CoursePagesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(CoursePagesAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, CoursePagesAPIlocalVarJSON)
    {
...
CoursePagesAPI_getCoursePagesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CoursePages/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CoursePages/Count");
...
CoursePagesAPI_updateCoursePageAsync(apiClient_t *apiClient, char *tenantId, char *pageId, char *api_version, char *x_api_version, course_page_update_dto_t *course_page_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_page_update_dto = NULL;
    if (course_page_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_page_update_dto = course_page_update_dto_convertToJSON(course_page_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_page_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_page_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_page_update_dto);
        localVarSingleItemJSON_course_page_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
