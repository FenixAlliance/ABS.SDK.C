...
#include <stdio.h>
#include <ctype.h>
#include "CourseTeamMembershipsAPI.h"
...
CourseTeamMembershipsAPI_createCourseTeamMembershipAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_team_membership_create_dto_t *course_team_membership_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseTeamMemberships")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseTeamMemberships");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_team_membership_create_dto = NULL;
    if (course_team_membership_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_team_membership_create_dto = course_team_membership_create_dto_convertToJSON(course_team_membership_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_team_membership_create_dto);
    }
    ...
    if (localVarSingleItemJSON_course_team_membership_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_team_membership_create_dto);
        localVarSingleItemJSON_course_team_membership_create_dto = NULL;
    }
...
CourseTeamMembershipsAPI_deleteCourseTeamMembershipAsync(apiClient_t *apiClient, char *tenantId, char *membershipId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseTeamMemberships/{membershipId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseTeamMemberships/{membershipId}");


    // Path Params
    long sizeOfPathParams_membershipId = strlen(membershipId)+3 + strlen("{ membershipId }");
    if(membershipId == NULL) {
        goto end;
    }
    char* localVarToReplace_membershipId = malloc(sizeOfPathParams_membershipId);
    sprintf(localVarToReplace_membershipId, "{%s}", "membershipId");

    localVarPath = strReplace(localVarPath, localVarToReplace_membershipId, membershipId);
    ...
    free(localVarPath);
    free(localVarToReplace_membershipId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
CourseTeamMembershipsAPI_getCourseTeamMembershipByIdAsync(apiClient_t *apiClient, char *membershipId, char *api_version, char *x_api_version)
{
    ...
    cJSON *CourseTeamMembershipsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    course_team_membership_dto_t *elementToReturn = course_team_membership_dto_parseFromJSON(CourseTeamMembershipsAPIlocalVarJSON);
    cJSON_Delete(CourseTeamMembershipsAPIlocalVarJSON);
...
CourseTeamMembershipsAPI_getCourseTeamMembershipsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_team_membership_dto_collection_query_parameters_t *course_team_membership_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_team_membership_dto_collection_query_parameters = NULL;
    if (course_team_membership_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_course_team_membership_dto_collection_query_parameters = course_team_membership_dto_collection_query_parameters_convertToJSON(course_team_membership_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_team_membership_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //}
    cJSON *CourseTeamMembershipsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(CourseTeamMembershipsAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, CourseTeamMembershipsAPIlocalVarJSON)
    {
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_team_membership_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_course_team_membership_dto_collection_query_parameters);
        localVarSingleItemJSON_course_team_membership_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
CourseTeamMembershipsAPI_getCourseTeamMembershipsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_team_membership_dto_collection_query_parameters_t *course_team_membership_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseTeamMemberships/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseTeamMemberships/Count");
...
CourseTeamMembershipsAPI_patchCourseTeamMembershipAsync(apiClient_t *apiClient, char *tenantId, char *membershipId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *CourseTeamMembershipsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(CourseTeamMembershipsAPIlocalVarJSON);
    cJSON_Delete(CourseTeamMembershipsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CourseTeamMembershipsAPI_updateCourseTeamMembershipAsync(apiClient_t *apiClient, char *tenantId, char *membershipId, char *api_version, char *x_api_version, course_team_membership_update_dto_t *course_team_membership_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_team_membership_update_dto = NULL;
    if (course_team_membership_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_team_membership_update_dto = course_team_membership_update_dto_convertToJSON(course_team_membership_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_team_membership_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_team_membership_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_team_membership_update_dto);
        localVarSingleItemJSON_course_team_membership_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
