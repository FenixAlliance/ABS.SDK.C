...
#include <stdio.h>
#include <ctype.h>
#include "CourseProblemSetsAPI.h"
...
CourseProblemSetsAPI_createCourseProblemSetAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_problem_set_create_dto_t *course_problem_set_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseProblemSets")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseProblemSets");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_problem_set_create_dto = NULL;
    if (course_problem_set_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_problem_set_create_dto = course_problem_set_create_dto_convertToJSON(course_problem_set_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_problem_set_create_dto);
    }
    ...
    if (localVarSingleItemJSON_course_problem_set_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_problem_set_create_dto);
        localVarSingleItemJSON_course_problem_set_create_dto = NULL;
    }
...
CourseProblemSetsAPI_deleteCourseProblemSetAsync(apiClient_t *apiClient, char *tenantId, char *problemSetId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseProblemSets/{problemSetId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseProblemSets/{problemSetId}");


    // Path Params
    long sizeOfPathParams_problemSetId = strlen(problemSetId)+3 + strlen("{ problemSetId }");
    if(problemSetId == NULL) {
        goto end;
    }
    char* localVarToReplace_problemSetId = malloc(sizeOfPathParams_problemSetId);
    sprintf(localVarToReplace_problemSetId, "{%s}", "problemSetId");

    localVarPath = strReplace(localVarPath, localVarToReplace_problemSetId, problemSetId);
    ...
    free(localVarPath);
    free(localVarToReplace_problemSetId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
CourseProblemSetsAPI_getCourseProblemSetByIdAsync(apiClient_t *apiClient, char *problemSetId, char *api_version, char *x_api_version)
{
    ...
    cJSON *CourseProblemSetsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    course_problem_set_dto_t *elementToReturn = course_problem_set_dto_parseFromJSON(CourseProblemSetsAPIlocalVarJSON);
    cJSON_Delete(CourseProblemSetsAPIlocalVarJSON);
...
CourseProblemSetsAPI_getCourseProblemSetsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //}
    cJSON *CourseProblemSetsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(CourseProblemSetsAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, CourseProblemSetsAPIlocalVarJSON)
    {
...
CourseProblemSetsAPI_getCourseProblemSetsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseProblemSets/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseProblemSets/Count");
...
CourseProblemSetsAPI_patchCourseProblemSetAsync(apiClient_t *apiClient, char *tenantId, char *problemSetId, char *api_version, char *x_api_version, list_t *operation)
{
    ...
    //nonprimitive not container
    cJSON *CourseProblemSetsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(CourseProblemSetsAPIlocalVarJSON);
    cJSON_Delete(CourseProblemSetsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CourseProblemSetsAPI_updateCourseProblemSetAsync(apiClient_t *apiClient, char *tenantId, char *problemSetId, char *api_version, char *x_api_version, course_problem_set_update_dto_t *course_problem_set_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_problem_set_update_dto = NULL;
    if (course_problem_set_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_problem_set_update_dto = course_problem_set_update_dto_convertToJSON(course_problem_set_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_problem_set_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_problem_set_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_problem_set_update_dto);
        localVarSingleItemJSON_course_problem_set_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
