...
#include <stdio.h>
#include <ctype.h>
#include "CourseEnrollmentsAPI.h"
...
CourseEnrollmentsAPI_createCourseEnrollmentAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_enrollment_create_dto_t *course_enrollment_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseEnrollments")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseEnrollments");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_enrollment_create_dto = NULL;
    if (course_enrollment_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_enrollment_create_dto = course_enrollment_create_dto_convertToJSON(course_enrollment_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_enrollment_create_dto);
    }
    ...
    if (localVarSingleItemJSON_course_enrollment_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_enrollment_create_dto);
        localVarSingleItemJSON_course_enrollment_create_dto = NULL;
    }
...
CourseEnrollmentsAPI_deleteCourseEnrollmentAsync(apiClient_t *apiClient, char *tenantId, char *courseEnrollmentId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseEnrollments/{courseEnrollmentId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseEnrollments/{courseEnrollmentId}");


    // Path Params
    long sizeOfPathParams_courseEnrollmentId = strlen(courseEnrollmentId)+3 + strlen("{ courseEnrollmentId }");
    if(courseEnrollmentId == NULL) {
        goto end;
    }
    char* localVarToReplace_courseEnrollmentId = malloc(sizeOfPathParams_courseEnrollmentId);
    sprintf(localVarToReplace_courseEnrollmentId, "{%s}", "courseEnrollmentId");

    localVarPath = strReplace(localVarPath, localVarToReplace_courseEnrollmentId, courseEnrollmentId);
    if(courseEnrollmentId == NULL) {
        goto end;
    }
    char* localVarToReplace_courseEnrollmentId = malloc(sizeOfPathParams_courseEnrollmentId);
    ...
    free(localVarPath);
    free(localVarToReplace_courseEnrollmentId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
CourseEnrollmentsAPI_getCourseEnrollmentAsync(apiClient_t *apiClient, char *tenantId, char *courseEnrollmentId, char *api_version, char *x_api_version)
{
    ...
    cJSON *CourseEnrollmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    course_enrollment_dto_t *elementToReturn = course_enrollment_dto_parseFromJSON(CourseEnrollmentsAPIlocalVarJSON);
    cJSON_Delete(CourseEnrollmentsAPIlocalVarJSON);
...
CourseEnrollmentsAPI_getEnrollmentsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_enrollment_dto_collection_query_parameters_t *course_enrollment_dto_collection_query_parameters)
{
    ...
    //}
    cJSON *CourseEnrollmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(CourseEnrollmentsAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, CourseEnrollmentsAPIlocalVarJSON)
    {
...
CourseEnrollmentsAPI_getEnrollmentsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_enrollment_dto_collection_query_parameters_t *course_enrollment_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseEnrollments/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseEnrollments/Count");
...
CourseEnrollmentsAPI_getStudentCourseEnrollmentsAsync(apiClient_t *apiClient, char *tenantId, char *studentProfileId, char *api_version, char *x_api_version, course_enrollment_dto_collection_query_parameters_t *course_enrollment_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseEnrollments/Student/{studentProfileId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseEnrollments/Student/{studentProfileId}");
...
CourseEnrollmentsAPI_updateCourseEnrollmentAsync(apiClient_t *apiClient, char *tenantId, char *courseEnrollmentId, char *api_version, char *x_api_version, course_enrollment_update_dto_t *course_enrollment_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_enrollment_update_dto = NULL;
    if (course_enrollment_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_enrollment_update_dto = course_enrollment_update_dto_convertToJSON(course_enrollment_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_enrollment_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_enrollment_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_enrollment_update_dto);
        localVarSingleItemJSON_course_enrollment_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
