...
#include <stdio.h>
#include <ctype.h>
#include "CourseCertificatesAPI.h"
...
CourseCertificatesAPI_createCourseCertificateAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_completion_certificate_create_dto_t *course_completion_certificate_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseCertificates")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseCertificates");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_completion_certificate_create_dto = NULL;
    if (course_completion_certificate_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_completion_certificate_create_dto = course_completion_certificate_create_dto_convertToJSON(course_completion_certificate_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_completion_certificate_create_dto);
    }
    ...
    if (localVarSingleItemJSON_course_completion_certificate_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_completion_certificate_create_dto);
        localVarSingleItemJSON_course_completion_certificate_create_dto = NULL;
    }
...
CourseCertificatesAPI_createCourseCertificateTemplateAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, course_certificate_template_create_dto_t *course_certificate_template_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseCertificates/Template")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseCertificates/Template");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_certificate_template_create_dto = NULL;
    if (course_certificate_template_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_certificate_template_create_dto = course_certificate_template_create_dto_convertToJSON(course_certificate_template_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_certificate_template_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_certificate_template_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_certificate_template_create_dto);
        localVarSingleItemJSON_course_certificate_template_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
CourseCertificatesAPI_deleteCourseCertificateAsync(apiClient_t *apiClient, char *tenantId, char *courseCertificateId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseCertificates/{courseCertificateId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseCertificates/{courseCertificateId}");


    // Path Params
    long sizeOfPathParams_courseCertificateId = strlen(courseCertificateId)+3 + strlen("{ courseCertificateId }");
    if(courseCertificateId == NULL) {
        goto end;
    }
    char* localVarToReplace_courseCertificateId = malloc(sizeOfPathParams_courseCertificateId);
    sprintf(localVarToReplace_courseCertificateId, "{%s}", "courseCertificateId");

    localVarPath = strReplace(localVarPath, localVarToReplace_courseCertificateId, courseCertificateId);
    if(courseCertificateId == NULL) {
        goto end;
    }
    char* localVarToReplace_courseCertificateId = malloc(sizeOfPathParams_courseCertificateId);
    ...
    free(localVarPath);
    free(localVarToReplace_courseCertificateId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
CourseCertificatesAPI_deleteCourseCertificateTemplateAsync(apiClient_t *apiClient, char *tenantId, char *courseCertificateTemplateId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseCertificates/Template/{courseCertificateTemplateId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseCertificates/Template/{courseCertificateTemplateId}");


    // Path Params
    long sizeOfPathParams_courseCertificateTemplateId = strlen(courseCertificateTemplateId)+3 + strlen("{ courseCertificateTemplateId }");
    if(courseCertificateTemplateId == NULL) {
        goto end;
    }
    char* localVarToReplace_courseCertificateTemplateId = malloc(sizeOfPathParams_courseCertificateTemplateId);
    sprintf(localVarToReplace_courseCertificateTemplateId, "{%s}", "courseCertificateTemplateId");

    localVarPath = strReplace(localVarPath, localVarToReplace_courseCertificateTemplateId, courseCertificateTemplateId);
    if(courseCertificateTemplateId == NULL) {
        goto end;
    }
    char* localVarToReplace_courseCertificateTemplateId = malloc(sizeOfPathParams_courseCertificateTemplateId);
    ...
    free(localVarPath);
    free(localVarToReplace_courseCertificateTemplateId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
CourseCertificatesAPI_getCourseCertificateAsync(apiClient_t *apiClient, char *tenantId, char *courseCertificateId, char *api_version, char *x_api_version)
{
    ...
    cJSON *CourseCertificatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    course_completion_certificate_dto_t *elementToReturn = course_completion_certificate_dto_parseFromJSON(CourseCertificatesAPIlocalVarJSON);
    cJSON_Delete(CourseCertificatesAPIlocalVarJSON);
...
CourseCertificatesAPI_getCourseCertificateTemplateAsync(apiClient_t *apiClient, char *tenantId, char *courseCertificateTemplateId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *CourseCertificatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    course_certificate_template_dto_t *elementToReturn = course_certificate_template_dto_parseFromJSON(CourseCertificatesAPIlocalVarJSON);
    cJSON_Delete(CourseCertificatesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CourseCertificatesAPI_getCourseCertificateTemplatesAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    //}
    cJSON *CourseCertificatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(CourseCertificatesAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, CourseCertificatesAPIlocalVarJSON)
    {
...
CourseCertificatesAPI_getCourseCertificateTemplatesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseCertificates/Template/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseCertificates/Template/Count");
...
CourseCertificatesAPI_getCourseCertificatesCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/CourseCertificates/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/CourseCertificates/Count");
...
CourseCertificatesAPI_patchCourseCertificateAsync(apiClient_t *apiClient, char *tenantId, char *courseCertificateId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *CourseCertificatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(CourseCertificatesAPIlocalVarJSON);
    cJSON_Delete(CourseCertificatesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CourseCertificatesAPI_updateCourseCertificateAsync(apiClient_t *apiClient, char *tenantId, char *courseCertificateId, char *api_version, char *x_api_version, course_completion_certificate_update_dto_t *course_completion_certificate_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_completion_certificate_update_dto = NULL;
    if (course_completion_certificate_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_completion_certificate_update_dto = course_completion_certificate_update_dto_convertToJSON(course_completion_certificate_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_completion_certificate_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_completion_certificate_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_completion_certificate_update_dto);
        localVarSingleItemJSON_course_completion_certificate_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
CourseCertificatesAPI_updateCourseCertificateTemplateAsync(apiClient_t *apiClient, char *tenantId, char *courseCertificateTemplateId, char *api_version, char *x_api_version, course_certificate_template_update_dto_t *course_certificate_template_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_course_certificate_template_update_dto = NULL;
    if (course_certificate_template_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_course_certificate_template_update_dto = course_certificate_template_update_dto_convertToJSON(course_certificate_template_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_course_certificate_template_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_course_certificate_template_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_course_certificate_template_update_dto);
        localVarSingleItemJSON_course_certificate_template_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
