...
StudentProfilesAPI_apiV2LearningServiceStudentProfilesCountGet(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/StudentProfiles/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/StudentProfiles/Count");
...
StudentProfilesAPI_apiV2LearningServiceStudentProfilesGet(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/StudentProfiles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/StudentProfiles");
    ...
    //    printf("%s\n","OK");
    //}
    cJSON *StudentProfilesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(StudentProfilesAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, StudentProfilesAPIlocalVarJSON)
    {
    ...
    cJSON_Delete( StudentProfilesAPIlocalVarJSON);
...
StudentProfilesAPI_apiV2LearningServiceStudentProfilesPost(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, student_profile_create_dto_t *student_profile_create_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_student_profile_create_dto = NULL;
    if (student_profile_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_student_profile_create_dto = student_profile_create_dto_convertToJSON(student_profile_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_student_profile_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_student_profile_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_student_profile_create_dto);
        localVarSingleItemJSON_student_profile_create_dto = NULL;
    }
...
StudentProfilesAPI_apiV2LearningServiceStudentProfilesStudentProfileIdAverageGet(apiClient_t *apiClient, char *tenantId, char *studentProfileId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/StudentProfiles/{studentProfileId}/Average")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/StudentProfiles/{studentProfileId}/Average");


    // Path Params
    long sizeOfPathParams_studentProfileId = strlen(studentProfileId)+3 + strlen("{ studentProfileId }");
    if(studentProfileId == NULL) {
        goto end;
    }
    char* localVarToReplace_studentProfileId = malloc(sizeOfPathParams_studentProfileId);
    sprintf(localVarToReplace_studentProfileId, "{%s}", "studentProfileId");

    localVarPath = strReplace(localVarPath, localVarToReplace_studentProfileId, studentProfileId);
    if(studentProfileId == NULL) {
        goto end;
    }
    char* localVarToReplace_studentProfileId = malloc(sizeOfPathParams_studentProfileId);
    ...
    cJSON *StudentProfilesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    average_dto_t *elementToReturn = average_dto_parseFromJSON(StudentProfilesAPIlocalVarJSON);
    cJSON_Delete(StudentProfilesAPIlocalVarJSON);
...
StudentProfilesAPI_apiV2LearningServiceStudentProfilesStudentProfileIdDelete(apiClient_t *apiClient, char *tenantId, char *studentProfileId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/StudentProfiles/{studentProfileId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/StudentProfiles/{studentProfileId}");
...
StudentProfilesAPI_apiV2LearningServiceStudentProfilesStudentProfileIdGet(apiClient_t *apiClient, char *tenantId, char *studentProfileId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *StudentProfilesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    student_profile_dto_t *elementToReturn = student_profile_dto_parseFromJSON(StudentProfilesAPIlocalVarJSON);
    cJSON_Delete(StudentProfilesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
StudentProfilesAPI_apiV2LearningServiceStudentProfilesStudentProfileIdHoursCompletedGet(apiClient_t *apiClient, char *tenantId, char *studentProfileId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/LearningService/StudentProfiles/{studentProfileId}/HoursCompleted")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/LearningService/StudentProfiles/{studentProfileId}/HoursCompleted");
    ...
    //nonprimitive not container
    cJSON *StudentProfilesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    count_dto_t *elementToReturn = count_dto_parseFromJSON(StudentProfilesAPIlocalVarJSON);
    cJSON_Delete(StudentProfilesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
StudentProfilesAPI_apiV2LearningServiceStudentProfilesStudentProfileIdPatch(apiClient_t *apiClient, char *tenantId, char *studentProfileId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    ...
    //nonprimitive not container
    cJSON *StudentProfilesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(StudentProfilesAPIlocalVarJSON);
    cJSON_Delete(StudentProfilesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
StudentProfilesAPI_apiV2LearningServiceStudentProfilesStudentProfileIdPut(apiClient_t *apiClient, char *tenantId, char *studentProfileId, char *api_version, char *x_api_version, student_profile_update_dto_t *student_profile_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_student_profile_update_dto = NULL;
    if (student_profile_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_student_profile_update_dto = student_profile_update_dto_convertToJSON(student_profile_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_student_profile_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_student_profile_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_student_profile_update_dto);
        localVarSingleItemJSON_student_profile_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
