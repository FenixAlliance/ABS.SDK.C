...
CompareAPI_addItemToCompareTableAsync(apiClient_t *apiClient, char *api_version, char *x_api_version, add_product_to_compare_request_t *add_product_to_compare_request)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CartService/Compare")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CartService/Compare");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_add_product_to_compare_request = NULL;
    if (add_product_to_compare_request != NULL)
    {
        //string
        localVarSingleItemJSON_add_product_to_compare_request = add_product_to_compare_request_convertToJSON(add_product_to_compare_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_add_product_to_compare_request);
    }
    ...
    cJSON *CompareAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_cart_record_dto_t *elementToReturn = item_cart_record_dto_parseFromJSON(CompareAPIlocalVarJSON);
    cJSON_Delete(CompareAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_add_product_to_compare_request) {
        cJSON_Delete(localVarSingleItemJSON_add_product_to_compare_request);
        localVarSingleItemJSON_add_product_to_compare_request = NULL;
    }
...
CompareAPI_getItemToCompareRecord(apiClient_t *apiClient, char *recordId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CartService/Compare/{recordId}/Details")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CartService/Compare/{recordId}/Details");
    ...
    //nonprimitive not container
    cJSON *CompareAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_to_compare_cart_record_dto_envelope_t *elementToReturn = item_to_compare_cart_record_dto_envelope_parseFromJSON(CompareAPIlocalVarJSON);
    cJSON_Delete(CompareAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CompareAPI_getItemToCompareRecords(apiClient_t *apiClient, char *cartId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CartService/Compare/{cartId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CartService/Compare/{cartId}");
    ...
    //nonprimitive not container
    cJSON *CompareAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_to_compare_cart_record_dto_list_envelope_t *elementToReturn = item_to_compare_cart_record_dto_list_envelope_parseFromJSON(CompareAPIlocalVarJSON);
    cJSON_Delete(CompareAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CompareAPI_removeItemFromCompareTable(apiClient_t *apiClient, char *recordId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/CartService/Compare/{recordId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/CartService/Compare/{recordId}");
    ...
    //nonprimitive not container
    cJSON *CompareAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    item_to_compare_cart_record_dto_t *elementToReturn = item_to_compare_cart_record_dto_parseFromJSON(CompareAPIlocalVarJSON);
    cJSON_Delete(CompareAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
