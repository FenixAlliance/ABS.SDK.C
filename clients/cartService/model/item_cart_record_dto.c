...
item_cart_record_dto_t *item_cart_record_dto_create(
    ...
    item_cart_record_dto_local_var->type = type;
    item_cart_record_dto_local_var->title = title;
    item_cart_record_dto_local_var->user_id = user_id;
    item_cart_record_dto_local_var->tenant_id = tenant_id;
    item_cart_record_dto_local_var->description = description;
    item_cart_record_dto_local_var->price_list_id = price_list_id;
    item_cart_record_dto_local_var->enrollment_id = enrollment_id;
    item_cart_record_dto_local_var->individual_id = individual_id;
    item_cart_record_dto_local_var->organization_id = organization_id;
    item_cart_record_dto_local_var->receiver_tenant_id = receiver_tenant_id;
    item_cart_record_dto_local_var->first_name = first_name;
    item_cart_record_dto_local_var->last_name = last_name;
    item_cart_record_dto_local_var->company_name = company_name;
    item_cart_record_dto_local_var->billing_email = billing_email;
    item_cart_record_dto_local_var->address_line1 = address_line1;
    item_cart_record_dto_local_var->address_line2 = address_line2;
    item_cart_record_dto_local_var->postal_code = postal_code;
    item_cart_record_dto_local_var->country_id = country_id;
    item_cart_record_dto_local_var->state_id = state_id;
    item_cart_record_dto_local_var->city_id = city_id;
    item_cart_record_dto_local_var->customer_notes = customer_notes;
    ...
    item_cart_record_dto_local_var->forex_rates_snapshot = forex_rates_snapshot;
...
void item_cart_record_dto_free(item_cart_record_dto_t *item_cart_record_dto) {
    ...
    if (item_cart_record_dto->type) {
        free(item_cart_record_dto->type);
        item_cart_record_dto->type = NULL;
    }
    if (item_cart_record_dto->title) {
        free(item_cart_record_dto->title);
        item_cart_record_dto->title = NULL;
    }
    if (item_cart_record_dto->user_id) {
        free(item_cart_record_dto->user_id);
        item_cart_record_dto->user_id = NULL;
    }
    ...
    if (item_cart_record_dto->price_list_id) {
        free(item_cart_record_dto->price_list_id);
        item_cart_record_dto->price_list_id = NULL;
    }
    if (item_cart_record_dto->enrollment_id) {
        free(item_cart_record_dto->enrollment_id);
        item_cart_record_dto->enrollment_id = NULL;
    }
    if (item_cart_record_dto->individual_id) {
        free(item_cart_record_dto->individual_id);
        item_cart_record_dto->individual_id = NULL;
    }
    if (item_cart_record_dto->organization_id) {
        free(item_cart_record_dto->organization_id);
        item_cart_record_dto->organization_id = NULL;
    }
    if (item_cart_record_dto->receiver_tenant_id) {
        free(item_cart_record_dto->receiver_tenant_id);
        item_cart_record_dto->receiver_tenant_id = NULL;
    }
    if (item_cart_record_dto->first_name) {
        free(item_cart_record_dto->first_name);
        item_cart_record_dto->first_name = NULL;
    }
    if (item_cart_record_dto->last_name) {
        free(item_cart_record_dto->last_name);
        item_cart_record_dto->last_name = NULL;
    }
    if (item_cart_record_dto->company_name) {
        free(item_cart_record_dto->company_name);
        item_cart_record_dto->company_name = NULL;
    }
    if (item_cart_record_dto->billing_email) {
        free(item_cart_record_dto->billing_email);
        item_cart_record_dto->billing_email = NULL;
    }
    if (item_cart_record_dto->address_line1) {
        free(item_cart_record_dto->address_line1);
        item_cart_record_dto->address_line1 = NULL;
    }
    if (item_cart_record_dto->address_line2) {
        free(item_cart_record_dto->address_line2);
        item_cart_record_dto->address_line2 = NULL;
    }
    if (item_cart_record_dto->postal_code) {
        free(item_cart_record_dto->postal_code);
        item_cart_record_dto->postal_code = NULL;
    }
    if (item_cart_record_dto->country_id) {
        free(item_cart_record_dto->country_id);
        item_cart_record_dto->country_id = NULL;
    }
    if (item_cart_record_dto->state_id) {
        free(item_cart_record_dto->state_id);
        item_cart_record_dto->state_id = NULL;
    }
    if (item_cart_record_dto->city_id) {
        free(item_cart_record_dto->city_id);
        item_cart_record_dto->city_id = NULL;
    }
    if (item_cart_record_dto->customer_notes) {
        free(item_cart_record_dto->customer_notes);
        item_cart_record_dto->customer_notes = NULL;
    }
    if (item_cart_record_dto->forex_rates_snapshot) {
        free(item_cart_record_dto->forex_rates_snapshot);
        item_cart_record_dto->forex_rates_snapshot = NULL;
    }
...
cJSON *item_cart_record_dto_convertToJSON(item_cart_record_dto_t *item_cart_record_dto) {
    ...
    // item_cart_record_dto->type
    if(item_cart_record_dto->type) {
    if(cJSON_AddStringToObject(item, "type", item_cart_record_dto->type) == NULL) {
    goto fail; //String
    }
    }


    // item_cart_record_dto->title
    if(item_cart_record_dto->title) {
    if(cJSON_AddStringToObject(item, "title", item_cart_record_dto->title) == NULL) {
    goto fail; //String
    }
    }


    // item_cart_record_dto->user_id
    if(item_cart_record_dto->user_id) {
    if(cJSON_AddStringToObject(item, "userId", item_cart_record_dto->user_id) == NULL) {
    goto fail; //String
    }
    }
    ...
    // item_cart_record_dto->price_list_id
    if(item_cart_record_dto->price_list_id) {
    if(cJSON_AddStringToObject(item, "priceListId", item_cart_record_dto->price_list_id) == NULL) {
    goto fail; //String
    }
    }
    ...
    // item_cart_record_dto->individual_id
    if(item_cart_record_dto->individual_id) {
    if(cJSON_AddStringToObject(item, "individualId", item_cart_record_dto->individual_id) == NULL) {
    goto fail; //String
    }
    }


    // item_cart_record_dto->organization_id
    if(item_cart_record_dto->organization_id) {
    if(cJSON_AddStringToObject(item, "organizationId", item_cart_record_dto->organization_id) == NULL) {
    goto fail; //String
    }
    }


    // item_cart_record_dto->receiver_tenant_id
    if(item_cart_record_dto->receiver_tenant_id) {
    if(cJSON_AddStringToObject(item, "receiverTenantId", item_cart_record_dto->receiver_tenant_id) == NULL) {
    goto fail; //String
    }
    }


    // item_cart_record_dto->first_name
    if(item_cart_record_dto->first_name) {
    if(cJSON_AddStringToObject(item, "firstName", item_cart_record_dto->first_name) == NULL) {
    goto fail; //String
    }
    }


    // item_cart_record_dto->last_name
    if(item_cart_record_dto->last_name) {
    if(cJSON_AddStringToObject(item, "lastName", item_cart_record_dto->last_name) == NULL) {
    goto fail; //String
    }
    }


    // item_cart_record_dto->company_name
    if(item_cart_record_dto->company_name) {
    if(cJSON_AddStringToObject(item, "companyName", item_cart_record_dto->company_name) == NULL) {
    goto fail; //String
    }
    }


    // item_cart_record_dto->billing_email
    if(item_cart_record_dto->billing_email) {
    if(cJSON_AddStringToObject(item, "billingEmail", item_cart_record_dto->billing_email) == NULL) {
    goto fail; //String
    }
    }


    // item_cart_record_dto->address_line1
    if(item_cart_record_dto->address_line1) {
    if(cJSON_AddStringToObject(item, "addressLine1", item_cart_record_dto->address_line1) == NULL) {
    goto fail; //String
    }
    }


    // item_cart_record_dto->address_line2
    if(item_cart_record_dto->address_line2) {
    if(cJSON_AddStringToObject(item, "addressLine2", item_cart_record_dto->address_line2) == NULL) {
    goto fail; //String
    }
    }


    // item_cart_record_dto->postal_code
    if(item_cart_record_dto->postal_code) {
    if(cJSON_AddStringToObject(item, "postalCode", item_cart_record_dto->postal_code) == NULL) {
    goto fail; //String
    }
    }


    // item_cart_record_dto->country_id
    if(item_cart_record_dto->country_id) {
    if(cJSON_AddStringToObject(item, "countryId", item_cart_record_dto->country_id) == NULL) {
    goto fail; //String
    }
    }


    // item_cart_record_dto->state_id
    if(item_cart_record_dto->state_id) {
    if(cJSON_AddStringToObject(item, "stateId", item_cart_record_dto->state_id) == NULL) {
    goto fail; //String
    }
    }


    // item_cart_record_dto->city_id
    if(item_cart_record_dto->city_id) {
    if(cJSON_AddStringToObject(item, "cityId", item_cart_record_dto->city_id) == NULL) {
    goto fail; //String
    }
    }


    // item_cart_record_dto->customer_notes
    if(item_cart_record_dto->customer_notes) {
    if(cJSON_AddStringToObject(item, "customerNotes", item_cart_record_dto->customer_notes) == NULL) {
    goto fail; //String
    }
    }
    ...
    // item_cart_record_dto->forex_rates_snapshot
    if(item_cart_record_dto->forex_rates_snapshot) {
    if(cJSON_AddStringToObject(item, "forexRatesSnapshot", item_cart_record_dto->forex_rates_snapshot) == NULL) {
    goto fail; //String
    }
    }
...
item_cart_record_dto_t *item_cart_record_dto_parseFromJSON(cJSON *item_cart_record_dtoJSON){
    ...
    // item_cart_record_dto->type
    cJSON *type = cJSON_GetObjectItemCaseSensitive(item_cart_record_dtoJSON, "type");
    if (type) { 
    ...
    // item_cart_record_dto->title
    cJSON *title = cJSON_GetObjectItemCaseSensitive(item_cart_record_dtoJSON, "title");
    if (title) { 
    ...
    // item_cart_record_dto->user_id
    cJSON *user_id = cJSON_GetObjectItemCaseSensitive(item_cart_record_dtoJSON, "userId");
    if (user_id) { 
    ...
    // item_cart_record_dto->price_list_id
    cJSON *price_list_id = cJSON_GetObjectItemCaseSensitive(item_cart_record_dtoJSON, "priceListId");
    if (price_list_id) { 
    ...
    // item_cart_record_dto->individual_id
    cJSON *individual_id = cJSON_GetObjectItemCaseSensitive(item_cart_record_dtoJSON, "individualId");
    if (individual_id) { 
    ...
    // item_cart_record_dto->organization_id
    cJSON *organization_id = cJSON_GetObjectItemCaseSensitive(item_cart_record_dtoJSON, "organizationId");
    if (organization_id) { 
    ...
    // item_cart_record_dto->receiver_tenant_id
    cJSON *receiver_tenant_id = cJSON_GetObjectItemCaseSensitive(item_cart_record_dtoJSON, "receiverTenantId");
    ...
    // item_cart_record_dto->first_name
    cJSON *first_name = cJSON_GetObjectItemCaseSensitive(item_cart_record_dtoJSON, "firstName");
    if (first_name) { 
    ...
    // item_cart_record_dto->last_name
    cJSON *last_name = cJSON_GetObjectItemCaseSensitive(item_cart_record_dtoJSON, "lastName");
    if (last_name) { 
    ...
    // item_cart_record_dto->company_name
    cJSON *company_name = cJSON_GetObjectItemCaseSensitive(item_cart_record_dtoJSON, "companyName");
    if (company_name) { 
    ...
    // item_cart_record_dto->billing_email
    cJSON *billing_email = cJSON_GetObjectItemCaseSensitive(item_cart_record_dtoJSON, "billingEmail");
    if (billing_email) { 
    ...
    // item_cart_record_dto->address_line1
    cJSON *address_line1 = cJSON_GetObjectItemCaseSensitive(item_cart_record_dtoJSON, "addressLine1");
    if (address_line1) { 
    ...
    // item_cart_record_dto->address_line2
    cJSON *address_line2 = cJSON_GetObjectItemCaseSensitive(item_cart_record_dtoJSON, "addressLine2");
    if (address_line2) { 
    ...
    // item_cart_record_dto->postal_code
    cJSON *postal_code = cJSON_GetObjectItemCaseSensitive(item_cart_record_dtoJSON, "postalCode");
    if (postal_code) { 
    ...
    // item_cart_record_dto->country_id
    cJSON *country_id = cJSON_GetObjectItemCaseSensitive(item_cart_record_dtoJSON, "countryId");
    if (country_id) { 
    ...
    // item_cart_record_dto->state_id
    cJSON *state_id = cJSON_GetObjectItemCaseSensitive(item_cart_record_dtoJSON, "stateId");
    if (state_id) { 
    ...
    // item_cart_record_dto->city_id
    cJSON *city_id = cJSON_GetObjectItemCaseSensitive(item_cart_record_dtoJSON, "cityId");
    if (city_id) { 
    ...
    // item_cart_record_dto->customer_notes
    cJSON *customer_notes = cJSON_GetObjectItemCaseSensitive(item_cart_record_dtoJSON, "customerNotes");
    if (customer_notes) { 
    ...
    // item_cart_record_dto->forex_rates_snapshot
    cJSON *forex_rates_snapshot = cJSON_GetObjectItemCaseSensitive(item_cart_record_dtoJSON, "forexRatesSnapshot");
