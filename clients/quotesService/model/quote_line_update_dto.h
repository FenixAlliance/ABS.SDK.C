/*
 * quote_line_update_dto.h
 *
 * 
 */

#ifndef _quote_line_update_dto_H_
#define _quote_line_update_dto_H_
...
typedef struct quote_line_update_dto_t quote_line_update_dto_t;


// Enum TAXCALCULATIONMETHOD for quote_line_update_dto

typedef enum  { quotesservice_quote_line_update_dto_TAXCALCULATIONMETHOD_NULL = 0, quotesservice_quote_line_update_dto_TAXCALCULATIONMETHOD_Included, quotesservice_quote_line_update_dto_TAXCALCULATIONMETHOD_Excluded } quotesservice_quote_line_update_dto_TAXCALCULATIONMETHOD_e;
...
// Enum COSTCALCULATIONMETHOD for quote_line_update_dto

typedef enum  { quotesservice_quote_line_update_dto_COSTCALCULATIONMETHOD_NULL = 0, quotesservice_quote_line_update_dto_COSTCALCULATIONMETHOD_Automatic, quotesservice_quote_line_update_dto_COSTCALCULATIONMETHOD_Custom } quotesservice_quote_line_update_dto_COSTCALCULATIONMETHOD_e;
...
typedef struct quote_line_update_dto_t {
    int closed; //boolean
    char *item_id; // string
    ...
    quotesservice_quote_line_update_dto_TAXCALCULATIONMETHOD_e tax_calculation_method; //enum
    quotesservice_quote_line_update_dto_COSTCALCULATIONMETHOD_e cost_calculation_method; //enum
...
#endif /* _quote_line_update_dto_H_ */
