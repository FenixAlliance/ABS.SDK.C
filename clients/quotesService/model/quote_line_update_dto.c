...
quote_line_update_dto_t *quote_line_update_dto_create(
    ...
    quote_line_update_dto_local_var->title = title;
    quote_line_update_dto_local_var->user_id = user_id;
    quote_line_update_dto_local_var->price_list_id = price_list_id;
    quote_line_update_dto_local_var->description = description;
    quote_line_update_dto_local_var->individual_id = individual_id;
    quote_line_update_dto_local_var->payment_term_id = payment_term_id;
    quote_line_update_dto_local_var->organization_id = organization_id;
    quote_line_update_dto_local_var->receiver_tenant_id = receiver_tenant_id;
    quote_line_update_dto_local_var->first_name = first_name;
    quote_line_update_dto_local_var->last_name = last_name;
    quote_line_update_dto_local_var->company_name = company_name;
    quote_line_update_dto_local_var->billing_email = billing_email;
    quote_line_update_dto_local_var->address_line1 = address_line1;
    quote_line_update_dto_local_var->address_line2 = address_line2;
    quote_line_update_dto_local_var->postal_code = postal_code;
    quote_line_update_dto_local_var->country_id = country_id;
    quote_line_update_dto_local_var->state_id = state_id;
    quote_line_update_dto_local_var->city_id = city_id;
    quote_line_update_dto_local_var->billing_location_id = billing_location_id;
    quote_line_update_dto_local_var->shipping_location_id = shipping_location_id;
    quote_line_update_dto_local_var->shipping_method_id = shipping_method_id;
...
void quote_line_update_dto_free(quote_line_update_dto_t *quote_line_update_dto) {
    ...
    if (quote_line_update_dto->title) {
        free(quote_line_update_dto->title);
        quote_line_update_dto->title = NULL;
    }
    if (quote_line_update_dto->user_id) {
        free(quote_line_update_dto->user_id);
        quote_line_update_dto->user_id = NULL;
    }
    if (quote_line_update_dto->price_list_id) {
        free(quote_line_update_dto->price_list_id);
        quote_line_update_dto->price_list_id = NULL;
    }
    if (quote_line_update_dto->description) {
        free(quote_line_update_dto->description);
        quote_line_update_dto->description = NULL;
    }
    if (quote_line_update_dto->individual_id) {
        free(quote_line_update_dto->individual_id);
        quote_line_update_dto->individual_id = NULL;
    }
    if (quote_line_update_dto->payment_term_id) {
        free(quote_line_update_dto->payment_term_id);
        quote_line_update_dto->payment_term_id = NULL;
    }
    if (quote_line_update_dto->organization_id) {
        free(quote_line_update_dto->organization_id);
        quote_line_update_dto->organization_id = NULL;
    }
    if (quote_line_update_dto->receiver_tenant_id) {
        free(quote_line_update_dto->receiver_tenant_id);
        quote_line_update_dto->receiver_tenant_id = NULL;
    }
    if (quote_line_update_dto->first_name) {
        free(quote_line_update_dto->first_name);
        quote_line_update_dto->first_name = NULL;
    }
    if (quote_line_update_dto->last_name) {
        free(quote_line_update_dto->last_name);
        quote_line_update_dto->last_name = NULL;
    }
    if (quote_line_update_dto->company_name) {
        free(quote_line_update_dto->company_name);
        quote_line_update_dto->company_name = NULL;
    }
    if (quote_line_update_dto->billing_email) {
        free(quote_line_update_dto->billing_email);
        quote_line_update_dto->billing_email = NULL;
    }
    if (quote_line_update_dto->address_line1) {
        free(quote_line_update_dto->address_line1);
        quote_line_update_dto->address_line1 = NULL;
    }
    if (quote_line_update_dto->address_line2) {
        free(quote_line_update_dto->address_line2);
        quote_line_update_dto->address_line2 = NULL;
    }
    if (quote_line_update_dto->postal_code) {
        free(quote_line_update_dto->postal_code);
        quote_line_update_dto->postal_code = NULL;
    }
    if (quote_line_update_dto->country_id) {
        free(quote_line_update_dto->country_id);
        quote_line_update_dto->country_id = NULL;
    }
    if (quote_line_update_dto->state_id) {
        free(quote_line_update_dto->state_id);
        quote_line_update_dto->state_id = NULL;
    }
    if (quote_line_update_dto->city_id) {
        free(quote_line_update_dto->city_id);
        quote_line_update_dto->city_id = NULL;
    }
    if (quote_line_update_dto->billing_location_id) {
        free(quote_line_update_dto->billing_location_id);
        quote_line_update_dto->billing_location_id = NULL;
    }
    ...
    if (quote_line_update_dto->shipping_method_id) {
        free(quote_line_update_dto->shipping_method_id);
        quote_line_update_dto->shipping_method_id = NULL;
    }
...
cJSON *quote_line_update_dto_convertToJSON(quote_line_update_dto_t *quote_line_update_dto) {
    ...
    // quote_line_update_dto->title
    if(quote_line_update_dto->title) {
    if(cJSON_AddStringToObject(item, "title", quote_line_update_dto->title) == NULL) {
    goto fail; //String
    }
    }


    // quote_line_update_dto->user_id
    if(quote_line_update_dto->user_id) {
    if(cJSON_AddStringToObject(item, "userId", quote_line_update_dto->user_id) == NULL) {
    goto fail; //String
    }
    }


    // quote_line_update_dto->price_list_id
    if(quote_line_update_dto->price_list_id) {
    if(cJSON_AddStringToObject(item, "priceListId", quote_line_update_dto->price_list_id) == NULL) {
    goto fail; //String
    }
    }
    ...
    // quote_line_update_dto->individual_id
    if(quote_line_update_dto->individual_id) {
    if(cJSON_AddStringToObject(item, "individualId", quote_line_update_dto->individual_id) == NULL) {
    goto fail; //String
    }
    }


    // quote_line_update_dto->payment_term_id
    if(quote_line_update_dto->payment_term_id) {
    if(cJSON_AddStringToObject(item, "paymentTermId", quote_line_update_dto->payment_term_id) == NULL) {
    goto fail; //String
    }
    }


    // quote_line_update_dto->organization_id
    if(quote_line_update_dto->organization_id) {
    if(cJSON_AddStringToObject(item, "organizationId", quote_line_update_dto->organization_id) == NULL) {
    goto fail; //String
    }
    }


    // quote_line_update_dto->receiver_tenant_id
    if(quote_line_update_dto->receiver_tenant_id) {
    if(cJSON_AddStringToObject(item, "receiverTenantId", quote_line_update_dto->receiver_tenant_id) == NULL) {
    goto fail; //String
    }
    }


    // quote_line_update_dto->first_name
    if(quote_line_update_dto->first_name) {
    if(cJSON_AddStringToObject(item, "firstName", quote_line_update_dto->first_name) == NULL) {
    goto fail; //String
    }
    }


    // quote_line_update_dto->last_name
    if(quote_line_update_dto->last_name) {
    if(cJSON_AddStringToObject(item, "lastName", quote_line_update_dto->last_name) == NULL) {
    goto fail; //String
    }
    }


    // quote_line_update_dto->company_name
    if(quote_line_update_dto->company_name) {
    if(cJSON_AddStringToObject(item, "companyName", quote_line_update_dto->company_name) == NULL) {
    goto fail; //String
    }
    }


    // quote_line_update_dto->billing_email
    if(quote_line_update_dto->billing_email) {
    if(cJSON_AddStringToObject(item, "billingEmail", quote_line_update_dto->billing_email) == NULL) {
    goto fail; //String
    }
    }


    // quote_line_update_dto->address_line1
    if(quote_line_update_dto->address_line1) {
    if(cJSON_AddStringToObject(item, "addressLine1", quote_line_update_dto->address_line1) == NULL) {
    goto fail; //String
    }
    }


    // quote_line_update_dto->address_line2
    if(quote_line_update_dto->address_line2) {
    if(cJSON_AddStringToObject(item, "addressLine2", quote_line_update_dto->address_line2) == NULL) {
    goto fail; //String
    }
    }


    // quote_line_update_dto->postal_code
    if(quote_line_update_dto->postal_code) {
    if(cJSON_AddStringToObject(item, "postalCode", quote_line_update_dto->postal_code) == NULL) {
    goto fail; //String
    }
    }


    // quote_line_update_dto->country_id
    if(quote_line_update_dto->country_id) {
    if(cJSON_AddStringToObject(item, "countryId", quote_line_update_dto->country_id) == NULL) {
    goto fail; //String
    }
    }


    // quote_line_update_dto->state_id
    if(quote_line_update_dto->state_id) {
    if(cJSON_AddStringToObject(item, "stateId", quote_line_update_dto->state_id) == NULL) {
    goto fail; //String
    }
    }


    // quote_line_update_dto->city_id
    if(quote_line_update_dto->city_id) {
    if(cJSON_AddStringToObject(item, "cityId", quote_line_update_dto->city_id) == NULL) {
    goto fail; //String
    }
    }


    // quote_line_update_dto->billing_location_id
    if(quote_line_update_dto->billing_location_id) {
    if(cJSON_AddStringToObject(item, "billingLocationId", quote_line_update_dto->billing_location_id) == NULL) {
    goto fail; //String
    }
    }
    ...
    // quote_line_update_dto->shipping_method_id
    if(quote_line_update_dto->shipping_method_id) {
    if(cJSON_AddStringToObject(item, "shippingMethodId", quote_line_update_dto->shipping_method_id) == NULL) {
    goto fail; //String
    }
    }
...
quote_line_update_dto_t *quote_line_update_dto_parseFromJSON(cJSON *quote_line_update_dtoJSON){
    ...
    // quote_line_update_dto->title
    cJSON *title = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "title");
    if (title) { 
    ...
    // quote_line_update_dto->user_id
    cJSON *user_id = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "userId");
    if (user_id) { 
    ...
    // quote_line_update_dto->price_list_id
    cJSON *price_list_id = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "priceListId");
    if (price_list_id) { 
    ...
    // quote_line_update_dto->individual_id
    cJSON *individual_id = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "individualId");
    if (individual_id) { 
    ...
    // quote_line_update_dto->payment_term_id
    cJSON *payment_term_id = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "paymentTermId");
    if (payment_term_id) { 
    ...
    // quote_line_update_dto->organization_id
    cJSON *organization_id = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "organizationId");
    if (organization_id) { 
    ...
    // quote_line_update_dto->receiver_tenant_id
    cJSON *receiver_tenant_id = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "receiverTenantId");
    ...
    // quote_line_update_dto->first_name
    cJSON *first_name = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "firstName");
    if (first_name) { 
    ...
    // quote_line_update_dto->last_name
    cJSON *last_name = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "lastName");
    if (last_name) { 
    ...
    // quote_line_update_dto->company_name
    cJSON *company_name = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "companyName");
    if (company_name) { 
    ...
    // quote_line_update_dto->billing_email
    cJSON *billing_email = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "billingEmail");
    if (billing_email) { 
    ...
    // quote_line_update_dto->address_line1
    cJSON *address_line1 = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "addressLine1");
    if (address_line1) { 
    ...
    // quote_line_update_dto->address_line2
    cJSON *address_line2 = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "addressLine2");
    if (address_line2) { 
    ...
    // quote_line_update_dto->postal_code
    cJSON *postal_code = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "postalCode");
    if (postal_code) { 
    ...
    // quote_line_update_dto->country_id
    cJSON *country_id = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "countryId");
    if (country_id) { 
    ...
    // quote_line_update_dto->state_id
    cJSON *state_id = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "stateId");
    if (state_id) { 
    ...
    // quote_line_update_dto->city_id
    cJSON *city_id = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "cityId");
    if (city_id) { 
    ...
    // quote_line_update_dto->billing_location_id
    cJSON *billing_location_id = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "billingLocationId");
    ...
    // quote_line_update_dto->shipping_method_id
    cJSON *shipping_method_id = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "shippingMethodId");
