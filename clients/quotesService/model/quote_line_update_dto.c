...
quote_line_update_dto_t *quote_line_update_dto_create(
    ...
    quote_line_update_dto_local_var->tenant_id = tenant_id;
    quote_line_update_dto_local_var->enrollment_id = enrollment_id;
    ...
    quote_line_update_dto_local_var->business_profile_record_id = business_profile_record_id;
...
void quote_line_update_dto_free(quote_line_update_dto_t *quote_line_update_dto) {
    ...
    if (quote_line_update_dto->tenant_id) {
        free(quote_line_update_dto->tenant_id);
        quote_line_update_dto->tenant_id = NULL;
    }
    if (quote_line_update_dto->enrollment_id) {
        free(quote_line_update_dto->enrollment_id);
        quote_line_update_dto->enrollment_id = NULL;
    }
    ...
    if (quote_line_update_dto->business_profile_record_id) {
        free(quote_line_update_dto->business_profile_record_id);
        quote_line_update_dto->business_profile_record_id = NULL;
    }
...
cJSON *quote_line_update_dto_convertToJSON(quote_line_update_dto_t *quote_line_update_dto) {
    ...
    // quote_line_update_dto->tenant_id
    if(quote_line_update_dto->tenant_id) {
    if(cJSON_AddStringToObject(item, "tenantId", quote_line_update_dto->tenant_id) == NULL) {
    goto fail; //String
    }
    }


    // quote_line_update_dto->enrollment_id
    if(quote_line_update_dto->enrollment_id) {
    if(cJSON_AddStringToObject(item, "enrollmentId", quote_line_update_dto->enrollment_id) == NULL) {
    goto fail; //String
    }
    }
    ...
    // quote_line_update_dto->business_profile_record_id
    if(quote_line_update_dto->business_profile_record_id) {
    if(cJSON_AddStringToObject(item, "businessProfileRecordId", quote_line_update_dto->business_profile_record_id) == NULL) {
    goto fail; //String
    }
    }
...
quote_line_update_dto_t *quote_line_update_dto_parseFromJSON(cJSON *quote_line_update_dtoJSON){
    ...
    // quote_line_update_dto->tenant_id
    cJSON *tenant_id = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "tenantId");
    if (tenant_id) { 
    ...
    // quote_line_update_dto->enrollment_id
    cJSON *enrollment_id = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "enrollmentId");
    if (enrollment_id) { 
    ...
    // quote_line_update_dto->business_profile_record_id
    cJSON *business_profile_record_id = cJSON_GetObjectItemCaseSensitive(quote_line_update_dtoJSON, "businessProfileRecordId");
