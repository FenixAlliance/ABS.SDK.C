...
extended_quote_dto_t *extended_quote_dto_create(
    ...
    extended_quote_dto_local_var->forex_rates_snapshot = forex_rates_snapshot;
...
void extended_quote_dto_free(extended_quote_dto_t *extended_quote_dto) {
    ...
    if (extended_quote_dto->forex_rates_snapshot) {
        free(extended_quote_dto->forex_rates_snapshot);
        extended_quote_dto->forex_rates_snapshot = NULL;
    }
...
cJSON *extended_quote_dto_convertToJSON(extended_quote_dto_t *extended_quote_dto) {
    ...
    // extended_quote_dto->forex_rates_snapshot
    if(extended_quote_dto->forex_rates_snapshot) {
    if(cJSON_AddStringToObject(item, "forexRatesSnapshot", extended_quote_dto->forex_rates_snapshot) == NULL) {
    goto fail; //String
    }
    }
...
extended_quote_dto_t *extended_quote_dto_parseFromJSON(cJSON *extended_quote_dtoJSON){
    ...
    // extended_quote_dto->forex_rates_snapshot
    cJSON *forex_rates_snapshot = cJSON_GetObjectItemCaseSensitive(extended_quote_dtoJSON, "forexRatesSnapshot");
