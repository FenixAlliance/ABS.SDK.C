...
typedef enum  { quotesservice_email_dispatch_request_ALERTTYPE_NULL = 0, quotesservice_email_dispatch_request_ALERTTYPE_None, quotesservice_email_dispatch_request_ALERTTYPE_Info, quotesservice_email_dispatch_request_ALERTTYPE_Error, quotesservice_email_dispatch_request_ALERTTYPE_Warning, quotesservice_email_dispatch_request_ALERTTYPE_Success, quotesservice_email_dispatch_request_ALERTTYPE_Action, quotesservice_email_dispatch_request_ALERTTYPE_Alert } quotesservice_email_dispatch_request_ALERTTYPE_e;

char* email_dispatch_request_alert_type_ToString(quotesservice_email_dispatch_request_ALERTTYPE_e alert_type);

quotesservice_email_dispatch_request_ALERTTYPE_e email_dispatch_request_alert_type_FromString(char* alert_type);
...
typedef struct email_dispatch_request_t {
    ...
    quotesservice_email_dispatch_request_ALERTTYPE_e alert_type; //enum
    char *culture; // string
...
email_dispatch_request_t *email_dispatch_request_create(
    ...
    char *button_text,
    char *alert_message,
    quotesservice_email_dispatch_request_ALERTTYPE_e alert_type,
    char *culture,
    char *ui_culture,
    list_t *recipients,
    list_t *contact_ids,
