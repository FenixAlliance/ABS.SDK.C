/*
 * quote_line_create_dto.h
 *
 * 
 */

#ifndef _quote_line_create_dto_H_
#define _quote_line_create_dto_H_
...
typedef struct quote_line_create_dto_t quote_line_create_dto_t;


// Enum TAXCALCULATIONMETHOD for quote_line_create_dto

typedef enum  { quotesservice_quote_line_create_dto_TAXCALCULATIONMETHOD_NULL = 0, quotesservice_quote_line_create_dto_TAXCALCULATIONMETHOD_Included, quotesservice_quote_line_create_dto_TAXCALCULATIONMETHOD_Excluded } quotesservice_quote_line_create_dto_TAXCALCULATIONMETHOD_e;
...
// Enum COSTCALCULATIONMETHOD for quote_line_create_dto

typedef enum  { quotesservice_quote_line_create_dto_COSTCALCULATIONMETHOD_NULL = 0, quotesservice_quote_line_create_dto_COSTCALCULATIONMETHOD_Automatic, quotesservice_quote_line_create_dto_COSTCALCULATIONMETHOD_Custom } quotesservice_quote_line_create_dto_COSTCALCULATIONMETHOD_e;
...
typedef struct quote_line_create_dto_t {
    char *id; // string
    ...
    quotesservice_quote_line_create_dto_TAXCALCULATIONMETHOD_e tax_calculation_method; //enum
    quotesservice_quote_line_create_dto_COSTCALCULATIONMETHOD_e cost_calculation_method; //enum
...
#endif /* _quote_line_create_dto_H_ */
