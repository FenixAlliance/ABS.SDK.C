/*
 * quote_line_dto_envelope.h
 *
 * 
 */

#ifndef _quote_line_dto_envelope_H_
#define _quote_line_dto_envelope_H_
...
typedef struct quote_line_dto_envelope_t quote_line_dto_envelope_t;

#include "quote_line_dto.h"



typedef struct quote_line_dto_envelope_t {
    int is_success; //boolean
    char *error_message; // string
    char *correlation_id; // string
    char *timestamp; //date time
    char *activity_id; // string
    struct quote_line_dto_t *result; //model
...
#endif /* _quote_line_dto_envelope_H_ */
