/*
 * extended_quote_dto.h
 *
 * 
 */

#ifndef _extended_quote_dto_H_
#define _extended_quote_dto_H_
...
typedef struct extended_quote_dto_t extended_quote_dto_t;
...
// Enum TAXCALCULATIONMETHOD for extended_quote_dto

typedef enum  { quotesservice_extended_quote_dto_TAXCALCULATIONMETHOD_NULL = 0, quotesservice_extended_quote_dto_TAXCALCULATIONMETHOD_Included, quotesservice_extended_quote_dto_TAXCALCULATIONMETHOD_Excluded } quotesservice_extended_quote_dto_TAXCALCULATIONMETHOD_e;
...
// Enum COSTCALCULATIONMETHOD for extended_quote_dto

typedef enum  { quotesservice_extended_quote_dto_COSTCALCULATIONMETHOD_NULL = 0, quotesservice_extended_quote_dto_COSTCALCULATIONMETHOD_Automatic, quotesservice_extended_quote_dto_COSTCALCULATIONMETHOD_Custom } quotesservice_extended_quote_dto_COSTCALCULATIONMETHOD_e;
...
// Enum QUOTESTATUS for extended_quote_dto

typedef enum  { quotesservice_extended_quote_dto_QUOTESTATUS_NULL = 0, quotesservice_extended_quote_dto_QUOTESTATUS_Draft, quotesservice_extended_quote_dto_QUOTESTATUS__New, quotesservice_extended_quote_dto_QUOTESTATUS_Accepted, quotesservice_extended_quote_dto_QUOTESTATUS_Declined, quotesservice_extended_quote_dto_QUOTESTATUS_Expired } quotesservice_extended_quote_dto_QUOTESTATUS_e;
...
// Enum FREIGHTTERMS for extended_quote_dto

typedef enum  { quotesservice_extended_quote_dto_FREIGHTTERMS_NULL = 0, quotesservice_extended_quote_dto_FREIGHTTERMS_FOB, quotesservice_extended_quote_dto_FREIGHTTERMS_NoCharge } quotesservice_extended_quote_dto_FREIGHTTERMS_e;
...
typedef struct extended_quote_dto_t {
    char *id; // string
    ...
    quotesservice_extended_quote_dto_QUOTESTATUS_e quote_status; //enum
    quotesservice_extended_quote_dto_FREIGHTTERMS_e freight_terms; //enum
