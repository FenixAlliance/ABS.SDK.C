...
#ifndef _quote_line_dto_H_
#define _quote_line_dto_H_
...
typedef enum  { quotesservice_quote_line_dto_TAXCALCULATIONMETHOD_NULL = 0, quotesservice_quote_line_dto_TAXCALCULATIONMETHOD_Included, quotesservice_quote_line_dto_TAXCALCULATIONMETHOD_Excluded } quotesservice_quote_line_dto_TAXCALCULATIONMETHOD_e;
...
// Enum COSTCALCULATIONMETHOD for quote_line_dto

typedef enum  { quotesservice_quote_line_dto_COSTCALCULATIONMETHOD_NULL = 0, quotesservice_quote_line_dto_COSTCALCULATIONMETHOD_Automatic, quotesservice_quote_line_dto_COSTCALCULATIONMETHOD_Custom } quotesservice_quote_line_dto_COSTCALCULATIONMETHOD_e;
...
typedef struct quote_line_dto_t {
    char *id; // string
