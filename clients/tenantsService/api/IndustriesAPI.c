...
IndustriesAPI_createTenantIndustry(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_industry_create_dto_t *tenant_industry_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Industries")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Industries");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_industry_create_dto = NULL;
    if (tenant_industry_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_industry_create_dto = tenant_industry_create_dto_convertToJSON(tenant_industry_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_industry_create_dto);
    }
    ...
    cJSON *IndustriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(IndustriesAPIlocalVarJSON);
    cJSON_Delete(IndustriesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_tenant_industry_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_tenant_industry_create_dto);
        localVarSingleItemJSON_tenant_industry_create_dto = NULL;
    }
...
IndustriesAPI_deleteTenantIndustry(apiClient_t *apiClient, char *tenantId, char *tenantIndustryId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Industries/{tenantIndustryId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Industries/{tenantIndustryId}");


    // Path Params
    long sizeOfPathParams_tenantIndustryId = strlen(tenantIndustryId)+3 + strlen("{ tenantIndustryId }");
    if(tenantIndustryId == NULL) {
        goto end;
    }
    char* localVarToReplace_tenantIndustryId = malloc(sizeOfPathParams_tenantIndustryId);
    sprintf(localVarToReplace_tenantIndustryId, "{%s}", "tenantIndustryId");

    localVarPath = strReplace(localVarPath, localVarToReplace_tenantIndustryId, tenantIndustryId);
    if(tenantIndustryId == NULL) {
        goto end;
    }
    char* localVarToReplace_tenantIndustryId = malloc(sizeOfPathParams_tenantIndustryId);
    ...
    free(localVarPath);
    free(localVarToReplace_tenantIndustryId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
IndustriesAPI_getTenantIndustries(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_industry_dto_collection_query_parameters_t *tenant_industry_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_industry_dto_collection_query_parameters = NULL;
    if (tenant_industry_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_industry_dto_collection_query_parameters = tenant_industry_dto_collection_query_parameters_convertToJSON(tenant_industry_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_industry_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *IndustriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_industry_dto_list_envelope_t *elementToReturn = tenant_industry_dto_list_envelope_parseFromJSON(IndustriesAPIlocalVarJSON);
    cJSON_Delete(IndustriesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tenant_industry_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_tenant_industry_dto_collection_query_parameters);
        localVarSingleItemJSON_tenant_industry_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
IndustriesAPI_getTenantIndustriesCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_industry_dto_collection_query_parameters_t *tenant_industry_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Industries/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Industries/Count");
    ...
    //nonprimitive not container
    cJSON *IndustriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(IndustriesAPIlocalVarJSON);
    cJSON_Delete(IndustriesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
IndustriesAPI_getTenantIndustryById(apiClient_t *apiClient, char *tenantId, char *tenantIndustryId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *IndustriesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_industry_dto_envelope_t *elementToReturn = tenant_industry_dto_envelope_parseFromJSON(IndustriesAPIlocalVarJSON);
    cJSON_Delete(IndustriesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
IndustriesAPI_updateTenantIndustry(apiClient_t *apiClient, char *tenantId, char *tenantIndustryId, char *api_version, char *x_api_version, tenant_industry_update_dto_t *tenant_industry_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_industry_update_dto = NULL;
    if (tenant_industry_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_industry_update_dto = tenant_industry_update_dto_convertToJSON(tenant_industry_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_industry_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tenant_industry_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_tenant_industry_update_dto);
        localVarSingleItemJSON_tenant_industry_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
