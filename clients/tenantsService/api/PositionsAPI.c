...
PositionsAPI_createTenantPosition(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_position_create_dto_t *tenant_position_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Positions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Positions");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_position_create_dto = NULL;
    if (tenant_position_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_position_create_dto = tenant_position_create_dto_convertToJSON(tenant_position_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_position_create_dto);
    }
    ...
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(PositionsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_tenant_position_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_tenant_position_create_dto);
        localVarSingleItemJSON_tenant_position_create_dto = NULL;
    }
...
PositionsAPI_deleteTenantPosition(apiClient_t *apiClient, char *tenantId, char *tenantPositionId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Positions/{tenantPositionId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Positions/{tenantPositionId}");


    // Path Params
    long sizeOfPathParams_tenantPositionId = strlen(tenantPositionId)+3 + strlen("{ tenantPositionId }");
    if(tenantPositionId == NULL) {
        goto end;
    }
    char* localVarToReplace_tenantPositionId = malloc(sizeOfPathParams_tenantPositionId);
    sprintf(localVarToReplace_tenantPositionId, "{%s}", "tenantPositionId");

    localVarPath = strReplace(localVarPath, localVarToReplace_tenantPositionId, tenantPositionId);
    if(tenantPositionId == NULL) {
        goto end;
    }
    char* localVarToReplace_tenantPositionId = malloc(sizeOfPathParams_tenantPositionId);
    ...
    free(localVarPath);
    free(localVarToReplace_tenantPositionId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
PositionsAPI_getTenantPositionById(apiClient_t *apiClient, char *tenantId, char *tenantPositionId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *PositionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_position_dto_envelope_t *elementToReturn = tenant_position_dto_envelope_parseFromJSON(PositionsAPIlocalVarJSON);
    cJSON_Delete(PositionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
PositionsAPI_getTenantPositions(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_position_dto_collection_query_parameters_t *tenant_position_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_position_dto_collection_query_parameters = NULL;
    if (tenant_position_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_position_dto_collection_query_parameters = tenant_position_dto_collection_query_parameters_convertToJSON(tenant_position_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_position_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *PositionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_position_dto_list_envelope_t *elementToReturn = tenant_position_dto_list_envelope_parseFromJSON(PositionsAPIlocalVarJSON);
    cJSON_Delete(PositionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tenant_position_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_tenant_position_dto_collection_query_parameters);
        localVarSingleItemJSON_tenant_position_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
PositionsAPI_getTenantPositionsCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_position_dto_collection_query_parameters_t *tenant_position_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Positions/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Positions/Count");
    ...
    //nonprimitive not container
    cJSON *PositionsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(PositionsAPIlocalVarJSON);
    cJSON_Delete(PositionsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
PositionsAPI_updateTenantPosition(apiClient_t *apiClient, char *tenantId, char *tenantPositionId, char *api_version, char *x_api_version, tenant_position_update_dto_t *tenant_position_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_position_update_dto = NULL;
    if (tenant_position_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_position_update_dto = tenant_position_update_dto_convertToJSON(tenant_position_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_position_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tenant_position_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_tenant_position_update_dto);
        localVarSingleItemJSON_tenant_position_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
