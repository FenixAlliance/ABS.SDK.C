...
InvitationsAPI_acceptTenantInvitation(apiClient_t *apiClient, char *invitationId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Invitations/{invitationId}/Accept")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Invitations/{invitationId}/Accept");


    // Path Params
    long sizeOfPathParams_invitationId = strlen(invitationId)+3 + strlen("{ invitationId }");
    if(invitationId == NULL) {
        goto end;
    }
    char* localVarToReplace_invitationId = malloc(sizeOfPathParams_invitationId);
    sprintf(localVarToReplace_invitationId, "{%s}", "invitationId");

    localVarPath = strReplace(localVarPath, localVarToReplace_invitationId, invitationId);
    if(invitationId == NULL) {
        goto end;
    }
    char* localVarToReplace_invitationId = malloc(sizeOfPathParams_invitationId);
    ...
    cJSON *InvitationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(InvitationsAPIlocalVarJSON);
    cJSON_Delete(InvitationsAPIlocalVarJSON);
    ...
    free(localVarPath);
    free(localVarToReplace_invitationId);
...
InvitationsAPI_declineTenantInvitation(apiClient_t *apiClient, char *invitationId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Invitations/{invitationId}/Decline")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Invitations/{invitationId}/Decline");
...
InvitationsAPI_deleteTenantInvitation(apiClient_t *apiClient, char *tenantId, char *invitationId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Invitations/{invitationId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Invitations/{invitationId}");
...
InvitationsAPI_getTenantInvitationById(apiClient_t *apiClient, char *tenantId, char *invitationId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *InvitationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_invitation_dto_envelope_t *elementToReturn = tenant_invitation_dto_envelope_parseFromJSON(InvitationsAPIlocalVarJSON);
    cJSON_Delete(InvitationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
InvitationsAPI_getTenantInvitations(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_invitation_dto_collection_query_parameters_t *tenant_invitation_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Invitations")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Invitations");
    ...
    //nonprimitive not container
    cJSON *InvitationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_invitation_dto_list_envelope_t *elementToReturn = tenant_invitation_dto_list_envelope_parseFromJSON(InvitationsAPIlocalVarJSON);
    cJSON_Delete(InvitationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
InvitationsAPI_getTenantInvitationsCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_invitation_dto_collection_query_parameters_t *tenant_invitation_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Invitations/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Invitations/Count");
    ...
    //nonprimitive not container
    cJSON *InvitationsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(InvitationsAPIlocalVarJSON);
    cJSON_Delete(InvitationsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
InvitationsAPI_sendTenantInvitation(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_invitation_create_dto_t *tenant_invitation_create_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_invitation_create_dto = NULL;
    if (tenant_invitation_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_invitation_create_dto = tenant_invitation_create_dto_convertToJSON(tenant_invitation_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_invitation_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tenant_invitation_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_tenant_invitation_create_dto);
        localVarSingleItemJSON_tenant_invitation_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
