...
EnrollmentsAPI_createTenantEnrollment(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_enrollment_create_dto_t *tenant_enrollment_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Enrollments")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Enrollments");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_enrollment_create_dto = NULL;
    if (tenant_enrollment_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_enrollment_create_dto = tenant_enrollment_create_dto_convertToJSON(tenant_enrollment_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_enrollment_create_dto);
    }
    ...
    cJSON *EnrollmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(EnrollmentsAPIlocalVarJSON);
    cJSON_Delete(EnrollmentsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_tenant_enrollment_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_tenant_enrollment_create_dto);
        localVarSingleItemJSON_tenant_enrollment_create_dto = NULL;
    }
...
EnrollmentsAPI_deleteTenantEnrollment(apiClient_t *apiClient, char *tenantId, char *enrollmentId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Enrollments/{enrollmentId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Enrollments/{enrollmentId}");
...
EnrollmentsAPI_getExtendedTenantEnrollments(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, extended_tenant_enrollment_dto_collection_query_parameters_t *extended_tenant_enrollment_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Enrollments/Extended")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Enrollments/Extended");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_extended_tenant_enrollment_dto_collection_query_parameters = NULL;
    if (extended_tenant_enrollment_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_extended_tenant_enrollment_dto_collection_query_parameters = extended_tenant_enrollment_dto_collection_query_parameters_convertToJSON(extended_tenant_enrollment_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_extended_tenant_enrollment_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *EnrollmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_enrollment_dto_list_envelope_t *elementToReturn = tenant_enrollment_dto_list_envelope_parseFromJSON(EnrollmentsAPIlocalVarJSON);
    cJSON_Delete(EnrollmentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_extended_tenant_enrollment_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_extended_tenant_enrollment_dto_collection_query_parameters);
        localVarSingleItemJSON_extended_tenant_enrollment_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
EnrollmentsAPI_getExtendedTenantEnrollmentsCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, extended_tenant_enrollment_dto_collection_query_parameters_t *extended_tenant_enrollment_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Enrollments/Extended/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Enrollments/Extended/Count");
    ...
    //nonprimitive not container
    cJSON *EnrollmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(EnrollmentsAPIlocalVarJSON);
    cJSON_Delete(EnrollmentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
EnrollmentsAPI_getTenantEnrollmentById(apiClient_t *apiClient, char *tenantId, char *enrollmentId, char *userId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *EnrollmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_enrollment_dto_envelope_t *elementToReturn = tenant_enrollment_dto_envelope_parseFromJSON(EnrollmentsAPIlocalVarJSON);
    cJSON_Delete(EnrollmentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
EnrollmentsAPI_getTenantEnrollments(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_enrollment_dto_collection_query_parameters_t *tenant_enrollment_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_enrollment_dto_collection_query_parameters = NULL;
    if (tenant_enrollment_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_enrollment_dto_collection_query_parameters = tenant_enrollment_dto_collection_query_parameters_convertToJSON(tenant_enrollment_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_enrollment_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tenant_enrollment_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_tenant_enrollment_dto_collection_query_parameters);
        localVarSingleItemJSON_tenant_enrollment_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
EnrollmentsAPI_getTenantEnrollmentsCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_enrollment_dto_collection_query_parameters_t *tenant_enrollment_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Enrollments/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Enrollments/Count");
...
EnrollmentsAPI_updateTenantEnrollment(apiClient_t *apiClient, char *tenantId, char *enrollmentId, char *api_version, char *x_api_version, tenant_enrollment_update_dto_t *tenant_enrollment_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_enrollment_update_dto = NULL;
    if (tenant_enrollment_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_enrollment_update_dto = tenant_enrollment_update_dto_convertToJSON(tenant_enrollment_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_enrollment_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tenant_enrollment_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_tenant_enrollment_update_dto);
        localVarSingleItemJSON_tenant_enrollment_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
