...
TypesAPI_createTenantType(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_type_create_dto_t *tenant_type_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Types")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Types");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_type_create_dto = NULL;
    if (tenant_type_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_type_create_dto = tenant_type_create_dto_convertToJSON(tenant_type_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_type_create_dto);
    }
    ...
    cJSON *TypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(TypesAPIlocalVarJSON);
    cJSON_Delete(TypesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_tenant_type_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_tenant_type_create_dto);
        localVarSingleItemJSON_tenant_type_create_dto = NULL;
    }
...
TypesAPI_deleteTenantType(apiClient_t *apiClient, char *tenantId, char *tenantTypeId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Types/{tenantTypeId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Types/{tenantTypeId}");


    // Path Params
    long sizeOfPathParams_tenantTypeId = strlen(tenantTypeId)+3 + strlen("{ tenantTypeId }");
    if(tenantTypeId == NULL) {
        goto end;
    }
    char* localVarToReplace_tenantTypeId = malloc(sizeOfPathParams_tenantTypeId);
    sprintf(localVarToReplace_tenantTypeId, "{%s}", "tenantTypeId");

    localVarPath = strReplace(localVarPath, localVarToReplace_tenantTypeId, tenantTypeId);
    if(tenantTypeId == NULL) {
        goto end;
    }
    char* localVarToReplace_tenantTypeId = malloc(sizeOfPathParams_tenantTypeId);
    ...
    free(localVarPath);
    free(localVarToReplace_tenantTypeId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
TypesAPI_getTenantTypeById(apiClient_t *apiClient, char *tenantId, char *tenantTypeId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *TypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_type_dto_envelope_t *elementToReturn = tenant_type_dto_envelope_parseFromJSON(TypesAPIlocalVarJSON);
    cJSON_Delete(TypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TypesAPI_getTenantTypes(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_type_dto_collection_query_parameters_t *tenant_type_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_type_dto_collection_query_parameters = NULL;
    if (tenant_type_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_type_dto_collection_query_parameters = tenant_type_dto_collection_query_parameters_convertToJSON(tenant_type_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_type_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *TypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_type_dto_list_envelope_t *elementToReturn = tenant_type_dto_list_envelope_parseFromJSON(TypesAPIlocalVarJSON);
    cJSON_Delete(TypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tenant_type_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_tenant_type_dto_collection_query_parameters);
        localVarSingleItemJSON_tenant_type_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
TypesAPI_getTenantTypesCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_type_dto_collection_query_parameters_t *tenant_type_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Types/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Types/Count");
    ...
    //nonprimitive not container
    cJSON *TypesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(TypesAPIlocalVarJSON);
    cJSON_Delete(TypesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
TypesAPI_updateTenantType(apiClient_t *apiClient, char *tenantId, char *tenantTypeId, char *api_version, char *x_api_version, tenant_type_update_dto_t *tenant_type_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_type_update_dto = NULL;
    if (tenant_type_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_type_update_dto = tenant_type_update_dto_convertToJSON(tenant_type_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_type_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tenant_type_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_tenant_type_update_dto);
        localVarSingleItemJSON_tenant_type_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
