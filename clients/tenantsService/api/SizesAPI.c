...
SizesAPI_createTenantSize(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_size_create_dto_t *tenant_size_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Sizes")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Sizes");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_size_create_dto = NULL;
    if (tenant_size_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_size_create_dto = tenant_size_create_dto_convertToJSON(tenant_size_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_size_create_dto);
    }
    ...
    cJSON *SizesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SizesAPIlocalVarJSON);
    cJSON_Delete(SizesAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_tenant_size_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_tenant_size_create_dto);
        localVarSingleItemJSON_tenant_size_create_dto = NULL;
    }
...
SizesAPI_deleteTenantSize(apiClient_t *apiClient, char *tenantId, char *tenantSizeId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Sizes/{tenantSizeId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Sizes/{tenantSizeId}");


    // Path Params
    long sizeOfPathParams_tenantSizeId = strlen(tenantSizeId)+3 + strlen("{ tenantSizeId }");
    if(tenantSizeId == NULL) {
        goto end;
    }
    char* localVarToReplace_tenantSizeId = malloc(sizeOfPathParams_tenantSizeId);
    sprintf(localVarToReplace_tenantSizeId, "{%s}", "tenantSizeId");

    localVarPath = strReplace(localVarPath, localVarToReplace_tenantSizeId, tenantSizeId);
    if(tenantSizeId == NULL) {
        goto end;
    }
    char* localVarToReplace_tenantSizeId = malloc(sizeOfPathParams_tenantSizeId);
    ...
    free(localVarPath);
    free(localVarToReplace_tenantSizeId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
SizesAPI_getTenantSizeById(apiClient_t *apiClient, char *tenantId, char *tenantSizeId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SizesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_size_dto_envelope_t *elementToReturn = tenant_size_dto_envelope_parseFromJSON(SizesAPIlocalVarJSON);
    cJSON_Delete(SizesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SizesAPI_getTenantSizes(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_size_dto_collection_query_parameters_t *tenant_size_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_size_dto_collection_query_parameters = NULL;
    if (tenant_size_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_size_dto_collection_query_parameters = tenant_size_dto_collection_query_parameters_convertToJSON(tenant_size_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_size_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *SizesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_size_dto_list_envelope_t *elementToReturn = tenant_size_dto_list_envelope_parseFromJSON(SizesAPIlocalVarJSON);
    cJSON_Delete(SizesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tenant_size_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_tenant_size_dto_collection_query_parameters);
        localVarSingleItemJSON_tenant_size_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SizesAPI_getTenantSizesCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_size_dto_collection_query_parameters_t *tenant_size_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Sizes/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Sizes/Count");
    ...
    //nonprimitive not container
    cJSON *SizesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SizesAPIlocalVarJSON);
    cJSON_Delete(SizesAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SizesAPI_updateTenantSize(apiClient_t *apiClient, char *tenantId, char *tenantSizeId, char *api_version, char *x_api_version, tenant_size_update_dto_t *tenant_size_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_size_update_dto = NULL;
    if (tenant_size_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_size_update_dto = tenant_size_update_dto_convertToJSON(tenant_size_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_size_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tenant_size_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_tenant_size_update_dto);
        localVarSingleItemJSON_tenant_size_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
