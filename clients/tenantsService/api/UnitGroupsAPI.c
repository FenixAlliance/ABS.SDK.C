...
UnitGroupsAPI_createUnitAsync(apiClient_t *apiClient, char *tenantId, char *unitGroupId, char *api_version, char *x_api_version, unit_create_dto_t *unit_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/UnitGroups/{unitGroupId}/Units")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/UnitGroups/{unitGroupId}/Units");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_unit_create_dto = NULL;
    if (unit_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_unit_create_dto = unit_create_dto_convertToJSON(unit_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_unit_create_dto);
    }
    ...
    cJSON *UnitGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(UnitGroupsAPIlocalVarJSON);
    cJSON_Delete(UnitGroupsAPIlocalVarJSON);
    ...
    free(localVarPath);
    free(localVarToReplace_unitGroupId);
    ...
    if (localVarSingleItemJSON_unit_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_unit_create_dto);
        localVarSingleItemJSON_unit_create_dto = NULL;
    }
...
UnitGroupsAPI_createUnitGroupAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, unit_group_create_dto_t *unit_group_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/UnitGroups")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/UnitGroups");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_unit_group_create_dto = NULL;
    if (unit_group_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_unit_group_create_dto = unit_group_create_dto_convertToJSON(unit_group_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_unit_group_create_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_unit_group_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_unit_group_create_dto);
        localVarSingleItemJSON_unit_group_create_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
UnitGroupsAPI_deleteUnitAsync(apiClient_t *apiClient, char *tenantId, char *unitGroupId, char *unitId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/UnitGroups/{unitGroupId}/Units/{unitId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/UnitGroups/{unitGroupId}/Units/{unitId}");


    // Path Params
    long sizeOfPathParams_unitGroupId = strlen(unitGroupId)+3 + strlen(unitId)+3 + strlen("{ unitGroupId }");
    if(unitGroupId == NULL) {
        goto end;
    }
    char* localVarToReplace_unitGroupId = malloc(sizeOfPathParams_unitGroupId);
...
UnitGroupsAPI_deleteUnitGroupAsync(apiClient_t *apiClient, char *tenantId, char *unitGroupId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/UnitGroups/{unitGroupId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/UnitGroups/{unitGroupId}");
...
UnitGroupsAPI_getUnitAsync(apiClient_t *apiClient, char *tenantId, char *unitGroupId, char *unitId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *UnitGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    unit_dto_envelope_t *elementToReturn = unit_dto_envelope_parseFromJSON(UnitGroupsAPIlocalVarJSON);
    cJSON_Delete(UnitGroupsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
UnitGroupsAPI_getUnitGroupAsync(apiClient_t *apiClient, char *tenantId, char *unitGroupId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *UnitGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    unit_group_dto_envelope_t *elementToReturn = unit_group_dto_envelope_parseFromJSON(UnitGroupsAPIlocalVarJSON);
    cJSON_Delete(UnitGroupsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
UnitGroupsAPI_getUnitGroupsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, unit_group_dto_collection_query_parameters_t *unit_group_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_unit_group_dto_collection_query_parameters = NULL;
    if (unit_group_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_unit_group_dto_collection_query_parameters = unit_group_dto_collection_query_parameters_convertToJSON(unit_group_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_unit_group_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *UnitGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    unit_group_dto_list_envelope_t *elementToReturn = unit_group_dto_list_envelope_parseFromJSON(UnitGroupsAPIlocalVarJSON);
    cJSON_Delete(UnitGroupsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_unit_group_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_unit_group_dto_collection_query_parameters);
        localVarSingleItemJSON_unit_group_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
UnitGroupsAPI_getUnitGroupsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, unit_group_dto_collection_query_parameters_t *unit_group_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/UnitGroups/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/UnitGroups/Count");
    ...
    //nonprimitive not container
    cJSON *UnitGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(UnitGroupsAPIlocalVarJSON);
    cJSON_Delete(UnitGroupsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
UnitGroupsAPI_getUnitsAsync(apiClient_t *apiClient, char *tenantId, char *unitGroupId, char *api_version, char *x_api_version, unit_dto_collection_query_parameters_t *unit_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_unit_dto_collection_query_parameters = NULL;
    if (unit_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_unit_dto_collection_query_parameters = unit_dto_collection_query_parameters_convertToJSON(unit_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_unit_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *UnitGroupsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    unit_dto_list_envelope_t *elementToReturn = unit_dto_list_envelope_parseFromJSON(UnitGroupsAPIlocalVarJSON);
    cJSON_Delete(UnitGroupsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_unit_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_unit_dto_collection_query_parameters);
        localVarSingleItemJSON_unit_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
UnitGroupsAPI_getUnitsCountAsync(apiClient_t *apiClient, char *tenantId, char *unitGroupId, char *api_version, char *x_api_version, unit_dto_collection_query_parameters_t *unit_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/UnitGroups/{unitGroupId}/Units/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/UnitGroups/{unitGroupId}/Units/Count");
...
UnitGroupsAPI_updateUnitAsync(apiClient_t *apiClient, char *tenantId, char *unitGroupId, char *unitId, char *api_version, char *x_api_version, unit_update_dto_t *unit_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_unit_update_dto = NULL;
    if (unit_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_unit_update_dto = unit_update_dto_convertToJSON(unit_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_unit_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_unit_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_unit_update_dto);
        localVarSingleItemJSON_unit_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
UnitGroupsAPI_updateUnitGroupAsync(apiClient_t *apiClient, char *tenantId, char *unitGroupId, char *api_version, char *x_api_version, unit_group_update_dto_t *unit_group_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_unit_group_update_dto = NULL;
    if (unit_group_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_unit_group_update_dto = unit_group_update_dto_convertToJSON(unit_group_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_unit_group_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_unit_group_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_unit_group_update_dto);
        localVarSingleItemJSON_unit_group_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
