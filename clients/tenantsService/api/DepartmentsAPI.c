...
DepartmentsAPI_createTenantDepartment(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_department_create_dto_t *tenant_department_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Departments")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Departments");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_department_create_dto = NULL;
    if (tenant_department_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_department_create_dto = tenant_department_create_dto_convertToJSON(tenant_department_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_department_create_dto);
    }
    ...
    cJSON *DepartmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(DepartmentsAPIlocalVarJSON);
    cJSON_Delete(DepartmentsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_tenant_department_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_tenant_department_create_dto);
        localVarSingleItemJSON_tenant_department_create_dto = NULL;
    }
...
DepartmentsAPI_deleteTenantDepartment(apiClient_t *apiClient, char *tenantId, char *tenantDepartmentId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Departments/{tenantDepartmentId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Departments/{tenantDepartmentId}");


    // Path Params
    long sizeOfPathParams_tenantDepartmentId = strlen(tenantDepartmentId)+3 + strlen("{ tenantDepartmentId }");
    if(tenantDepartmentId == NULL) {
        goto end;
    }
    char* localVarToReplace_tenantDepartmentId = malloc(sizeOfPathParams_tenantDepartmentId);
    sprintf(localVarToReplace_tenantDepartmentId, "{%s}", "tenantDepartmentId");

    localVarPath = strReplace(localVarPath, localVarToReplace_tenantDepartmentId, tenantDepartmentId);
    if(tenantDepartmentId == NULL) {
        goto end;
    }
    char* localVarToReplace_tenantDepartmentId = malloc(sizeOfPathParams_tenantDepartmentId);
    ...
    free(localVarPath);
    free(localVarToReplace_tenantDepartmentId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
DepartmentsAPI_getTenantDepartmentById(apiClient_t *apiClient, char *tenantId, char *tenantDepartmentId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *DepartmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_department_dto_envelope_t *elementToReturn = tenant_department_dto_envelope_parseFromJSON(DepartmentsAPIlocalVarJSON);
    cJSON_Delete(DepartmentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
DepartmentsAPI_getTenantDepartments(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_department_dto_collection_query_parameters_t *tenant_department_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_department_dto_collection_query_parameters = NULL;
    if (tenant_department_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_department_dto_collection_query_parameters = tenant_department_dto_collection_query_parameters_convertToJSON(tenant_department_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_department_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *DepartmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_department_dto_list_envelope_t *elementToReturn = tenant_department_dto_list_envelope_parseFromJSON(DepartmentsAPIlocalVarJSON);
    cJSON_Delete(DepartmentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tenant_department_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_tenant_department_dto_collection_query_parameters);
        localVarSingleItemJSON_tenant_department_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
DepartmentsAPI_getTenantDepartmentsCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_department_dto_collection_query_parameters_t *tenant_department_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Departments/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Departments/Count");
    ...
    //nonprimitive not container
    cJSON *DepartmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(DepartmentsAPIlocalVarJSON);
    cJSON_Delete(DepartmentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
DepartmentsAPI_updateTenantDepartment(apiClient_t *apiClient, char *tenantId, char *tenantDepartmentId, char *api_version, char *x_api_version, tenant_department_update_dto_t *tenant_department_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_department_update_dto = NULL;
    if (tenant_department_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_department_update_dto = tenant_department_update_dto_convertToJSON(tenant_department_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_department_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tenant_department_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_tenant_department_update_dto);
        localVarSingleItemJSON_tenant_department_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
