...
OptionsAPI_createTenantOption(apiClient_t *apiClient, char *tenantId, char *key, char *portalId, char *api_version, char *x_api_version, option_create_dto_t *option_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Options")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Options");
...
OptionsAPI_deleteTenantOption(apiClient_t *apiClient, char *tenantId, char *optionId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Options/{optionId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Options/{optionId}");


    // Path Params
    long sizeOfPathParams_optionId = strlen(optionId)+3 + strlen("{ optionId }");
    if(optionId == NULL) {
        goto end;
    }
...
OptionsAPI_getTenantOptionByKey(apiClient_t *apiClient, char *tenantId, char *key, char *portalId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Options/Key/{key}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Options/Key/{key}");
...
OptionsAPI_getTenantOptionsCount(apiClient_t *apiClient, char *tenantId, char *portalId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Options/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Options/Count");
...
OptionsAPI_upsertTenantOption(apiClient_t *apiClient, char *tenantId, char *key, char *portalId, char *api_version, char *x_api_version, option_update_dto_t *option_update_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Options/Upsert/{key}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Options/Upsert/{key}");
