...
SegmentsAPI_createTenantSegment(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_segment_create_dto_t *tenant_segment_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Segments")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Segments");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_segment_create_dto = NULL;
    if (tenant_segment_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_segment_create_dto = tenant_segment_create_dto_convertToJSON(tenant_segment_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_segment_create_dto);
    }
    ...
    cJSON *SegmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(SegmentsAPIlocalVarJSON);
    cJSON_Delete(SegmentsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_tenant_segment_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_tenant_segment_create_dto);
        localVarSingleItemJSON_tenant_segment_create_dto = NULL;
    }
...
SegmentsAPI_deleteTenantSegment(apiClient_t *apiClient, char *tenantId, char *tenantSegmentId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Segments/{tenantSegmentId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Segments/{tenantSegmentId}");


    // Path Params
    long sizeOfPathParams_tenantSegmentId = strlen(tenantSegmentId)+3 + strlen("{ tenantSegmentId }");
    if(tenantSegmentId == NULL) {
        goto end;
    }
    char* localVarToReplace_tenantSegmentId = malloc(sizeOfPathParams_tenantSegmentId);
    sprintf(localVarToReplace_tenantSegmentId, "{%s}", "tenantSegmentId");

    localVarPath = strReplace(localVarPath, localVarToReplace_tenantSegmentId, tenantSegmentId);
    if(tenantSegmentId == NULL) {
        goto end;
    }
    char* localVarToReplace_tenantSegmentId = malloc(sizeOfPathParams_tenantSegmentId);
    ...
    free(localVarPath);
    free(localVarToReplace_tenantSegmentId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
SegmentsAPI_getTenantSegmentById(apiClient_t *apiClient, char *tenantId, char *tenantSegmentId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *SegmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_segment_dto_envelope_t *elementToReturn = tenant_segment_dto_envelope_parseFromJSON(SegmentsAPIlocalVarJSON);
    cJSON_Delete(SegmentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SegmentsAPI_getTenantSegments(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_segment_dto_collection_query_parameters_t *tenant_segment_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_segment_dto_collection_query_parameters = NULL;
    if (tenant_segment_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_segment_dto_collection_query_parameters = tenant_segment_dto_collection_query_parameters_convertToJSON(tenant_segment_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_segment_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *SegmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_segment_dto_list_envelope_t *elementToReturn = tenant_segment_dto_list_envelope_parseFromJSON(SegmentsAPIlocalVarJSON);
    cJSON_Delete(SegmentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tenant_segment_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_tenant_segment_dto_collection_query_parameters);
        localVarSingleItemJSON_tenant_segment_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
SegmentsAPI_getTenantSegmentsCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_segment_dto_collection_query_parameters_t *tenant_segment_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Segments/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Segments/Count");
    ...
    //nonprimitive not container
    cJSON *SegmentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(SegmentsAPIlocalVarJSON);
    cJSON_Delete(SegmentsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SegmentsAPI_updateTenantSegment(apiClient_t *apiClient, char *tenantId, char *tenantSegmentId, char *api_version, char *x_api_version, tenant_segment_update_dto_t *tenant_segment_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_segment_update_dto = NULL;
    if (tenant_segment_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_segment_update_dto = tenant_segment_update_dto_convertToJSON(tenant_segment_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_segment_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tenant_segment_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_tenant_segment_update_dto);
        localVarSingleItemJSON_tenant_segment_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
