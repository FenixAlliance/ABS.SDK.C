...
UnitsAPI_createTenantUnit(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_unit_create_dto_t *tenant_unit_create_dto)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Units")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Units");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_unit_create_dto = NULL;
    if (tenant_unit_create_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_unit_create_dto = tenant_unit_create_dto_convertToJSON(tenant_unit_create_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_unit_create_dto);
    }
    ...
    cJSON *UnitsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    empty_envelope_t *elementToReturn = empty_envelope_parseFromJSON(UnitsAPIlocalVarJSON);
    cJSON_Delete(UnitsAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_tenant_unit_create_dto) {
        cJSON_Delete(localVarSingleItemJSON_tenant_unit_create_dto);
        localVarSingleItemJSON_tenant_unit_create_dto = NULL;
    }
...
UnitsAPI_deleteTenantUnit(apiClient_t *apiClient, char *tenantId, char *tenantUnitId, char *api_version, char *x_api_version)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Units/{tenantUnitId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Units/{tenantUnitId}");


    // Path Params
    long sizeOfPathParams_tenantUnitId = strlen(tenantUnitId)+3 + strlen("{ tenantUnitId }");
    if(tenantUnitId == NULL) {
        goto end;
    }
    char* localVarToReplace_tenantUnitId = malloc(sizeOfPathParams_tenantUnitId);
    sprintf(localVarToReplace_tenantUnitId, "{%s}", "tenantUnitId");

    localVarPath = strReplace(localVarPath, localVarToReplace_tenantUnitId, tenantUnitId);
    if(tenantUnitId == NULL) {
        goto end;
    }
    char* localVarToReplace_tenantUnitId = malloc(sizeOfPathParams_tenantUnitId);
    ...
    free(localVarPath);
    free(localVarToReplace_tenantUnitId);
    if (keyHeader_x_api_version) {
        free(keyHeader_x_api_version);
        keyHeader_x_api_version = NULL;
    }
...
UnitsAPI_getTenantUnitById(apiClient_t *apiClient, char *tenantId, char *tenantUnitId, char *api_version, char *x_api_version)
{
    ...
    //nonprimitive not container
    cJSON *UnitsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_unit_dto_envelope_t *elementToReturn = tenant_unit_dto_envelope_parseFromJSON(UnitsAPIlocalVarJSON);
    cJSON_Delete(UnitsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
UnitsAPI_getTenantUnits(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_unit_dto_collection_query_parameters_t *tenant_unit_dto_collection_query_parameters)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_unit_dto_collection_query_parameters = NULL;
    if (tenant_unit_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_unit_dto_collection_query_parameters = tenant_unit_dto_collection_query_parameters_convertToJSON(tenant_unit_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_unit_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *UnitsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    tenant_unit_dto_list_envelope_t *elementToReturn = tenant_unit_dto_list_envelope_parseFromJSON(UnitsAPIlocalVarJSON);
    cJSON_Delete(UnitsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tenant_unit_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_tenant_unit_dto_collection_query_parameters);
        localVarSingleItemJSON_tenant_unit_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
UnitsAPI_getTenantUnitsCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_unit_dto_collection_query_parameters_t *tenant_unit_dto_collection_query_parameters)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/TenantsService/Units/Count")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/TenantsService/Units/Count");
    ...
    //nonprimitive not container
    cJSON *UnitsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    int32_envelope_t *elementToReturn = int32_envelope_parseFromJSON(UnitsAPIlocalVarJSON);
    cJSON_Delete(UnitsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
UnitsAPI_updateTenantUnit(apiClient_t *apiClient, char *tenantId, char *tenantUnitId, char *api_version, char *x_api_version, tenant_unit_update_dto_t *tenant_unit_update_dto)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_unit_update_dto = NULL;
    if (tenant_unit_update_dto != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_unit_update_dto = tenant_unit_update_dto_convertToJSON(tenant_unit_update_dto);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_unit_update_dto);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tenant_unit_update_dto) {
        cJSON_Delete(localVarSingleItemJSON_tenant_unit_update_dto);
        localVarSingleItemJSON_tenant_unit_update_dto = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
