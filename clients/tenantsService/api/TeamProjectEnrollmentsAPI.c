...
TeamProjectEnrollmentsAPI_getTenantTeamProjectEnrollments(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_team_project_enrollment_dto_collection_query_parameters_t *tenant_team_project_enrollment_dto_collection_query_parameters)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = list_createList();
    list_t    *localVarFormParameters = NULL;
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_tenant_team_project_enrollment_dto_collection_query_parameters = NULL;
    if (tenant_team_project_enrollment_dto_collection_query_parameters != NULL)
    {
        //string
        localVarSingleItemJSON_tenant_team_project_enrollment_dto_collection_query_parameters = tenant_team_project_enrollment_dto_collection_query_parameters_convertToJSON(tenant_team_project_enrollment_dto_collection_query_parameters);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_tenant_team_project_enrollment_dto_collection_query_parameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/xml"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    free(keyPairHeader_x_api_version);
    if (localVarSingleItemJSON_tenant_team_project_enrollment_dto_collection_query_parameters) {
        cJSON_Delete(localVarSingleItemJSON_tenant_team_project_enrollment_dto_collection_query_parameters);
        localVarSingleItemJSON_tenant_team_project_enrollment_dto_collection_query_parameters = NULL;
    }
    free(localVarBodyParameters);
    if(keyQuery_tenantId){
        free(keyQuery_tenantId);
...
//
int32_envelope_t*
TeamProjectEnrollmentsAPI_getTenantTeamProjectEnrollmentsCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_team_project_enrollment_dto_collection_query_parameters_t *tenant_team_project_enrollment_dto_collection_query_parameters)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = list_createList();
    list_t    *localVarFormParameters = NULL;
...
//
empty_envelope_t*
TeamProjectEnrollmentsAPI_patchTenantTeamProjectEnrollment(apiClient_t *apiClient, char *tenantId, char *tenantTeamProjectEnrollmentId, char *api_version, char *x_api_version, list_t *patch_operation)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = list_createList();
    list_t    *localVarFormParameters = NULL;
