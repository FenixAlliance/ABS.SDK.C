/*
 * option_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _option_dto_collection_query_parameters_H_
#define _option_dto_collection_query_parameters_H_
...
typedef struct option_dto_collection_query_parameters_t option_dto_collection_query_parameters_t;




typedef struct option_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} option_dto_collection_query_parameters_t;
...
#endif /* _option_dto_collection_query_parameters_H_ */
