...
#include <string.h>
#include <stdio.h>
#include "tenant_team_update_dto.h"
...
tenant_team_update_dto_t *tenant_team_update_dto_create(
    ...
    tenant_team_update_dto_t *tenant_team_update_dto_local_var = malloc(sizeof(tenant_team_update_dto_t));
    ...
    tenant_team_update_dto_local_var->business_id = business_id;
    tenant_team_update_dto_local_var->business_profile_record_id = business_profile_record_id;
    ...
    tenant_team_update_dto_local_var->is_public = is_public;
    tenant_team_update_dto_local_var->business_unit_id = business_unit_id;
    tenant_team_update_dto_local_var->organization_profile_id = organization_profile_id;

    return tenant_team_update_dto_local_var;
}


void tenant_team_update_dto_free(tenant_team_update_dto_t *tenant_team_update_dto) {
    if(NULL == tenant_team_update_dto){
        return ;
    }
    ...
    if (tenant_team_update_dto->business_id) {
        free(tenant_team_update_dto->business_id);
        tenant_team_update_dto->business_id = NULL;
    }
    if (tenant_team_update_dto->business_profile_record_id) {
        free(tenant_team_update_dto->business_profile_record_id);
        tenant_team_update_dto->business_profile_record_id = NULL;
    }
    if (tenant_team_update_dto->name) {
        free(tenant_team_update_dto->name);
        tenant_team_update_dto->name = NULL;
    }
    if (tenant_team_update_dto->description) {
        free(tenant_team_update_dto->description);
        tenant_team_update_dto->description = NULL;
    }
    if (tenant_team_update_dto->avatar_url) {
        free(tenant_team_update_dto->avatar_url);
        tenant_team_update_dto->avatar_url = NULL;
    }
    if (tenant_team_update_dto->business_unit_id) {
        free(tenant_team_update_dto->business_unit_id);
        tenant_team_update_dto->business_unit_id = NULL;
    }
    if (tenant_team_update_dto->organization_profile_id) {
        free(tenant_team_update_dto->organization_profile_id);
        tenant_team_update_dto->organization_profile_id = NULL;
    }
    free(tenant_team_update_dto);
}
...
cJSON *tenant_team_update_dto_convertToJSON(tenant_team_update_dto_t *tenant_team_update_dto) {
    ...
    // tenant_team_update_dto->business_id
    if(tenant_team_update_dto->business_id) {
    if(cJSON_AddStringToObject(item, "businessID", tenant_team_update_dto->business_id) == NULL) {
    goto fail; //String
    }
    }


    // tenant_team_update_dto->business_profile_record_id
    if(tenant_team_update_dto->business_profile_record_id) {
    if(cJSON_AddStringToObject(item, "businessProfileRecordID", tenant_team_update_dto->business_profile_record_id) == NULL) {
    goto fail; //String
    }
    }
    ...
    // tenant_team_update_dto->description
    if(tenant_team_update_dto->description) {
    if(cJSON_AddStringToObject(item, "description", tenant_team_update_dto->description) == NULL) {
    goto fail; //String
    }
    }
    ...
    // tenant_team_update_dto->is_public
    if(tenant_team_update_dto->is_public) {
    if(cJSON_AddBoolToObject(item, "isPublic", tenant_team_update_dto->is_public) == NULL) {
    goto fail; //Bool
    }
    }
...
tenant_team_update_dto_t *tenant_team_update_dto_parseFromJSON(cJSON *tenant_team_update_dtoJSON){
    ...
    // tenant_team_update_dto->business_id
    cJSON *business_id = cJSON_GetObjectItemCaseSensitive(tenant_team_update_dtoJSON, "businessID");
    if (business_id) { 
    ...
    // tenant_team_update_dto->business_profile_record_id
    cJSON *business_profile_record_id = cJSON_GetObjectItemCaseSensitive(tenant_team_update_dtoJSON, "businessProfileRecordID");
    ...
    // tenant_team_update_dto->description
    cJSON *description = cJSON_GetObjectItemCaseSensitive(tenant_team_update_dtoJSON, "description");
    if (description) { 
    ...
    // tenant_team_update_dto->is_public
    cJSON *is_public = cJSON_GetObjectItemCaseSensitive(tenant_team_update_dtoJSON, "isPublic");
    if (is_public) { 
