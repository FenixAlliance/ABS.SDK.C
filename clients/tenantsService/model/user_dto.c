...
cJSON *user_dto_convertToJSON(user_dto_t *user_dto) {
    ...
    // user_dto->gender
    if(user_dto->gender != tenantsservice_user_dto_GENDER_NULL) {
    ...
    if(user_dto->availability != tenantsservice_user_dto_AVAILABILITY_NULL) {
    ...
    // user_dto->site_theme
    if(user_dto->site_theme != tenantsservice_user_dto_SITETHEME_NULL) {
...
user_dto_t *user_dto_parseFromJSON(cJSON *user_dtoJSON){
    ...
    tenantsservice_user_dto_GENDER_e genderVariable;
    if (gender) { 
    ...
    tenantsservice_user_dto_AVAILABILITY_e availabilityVariable;
    if (availability) { 
    ...
    tenantsservice_user_dto_SITETHEME_e site_themeVariable;
    if (site_theme) { 
    ...
    user_dto_local_var = user_dto_create (
        ...
        gender ? genderVariable : tenantsservice_user_dto_GENDER_NULL,
        ...
        availability ? availabilityVariable : tenantsservice_user_dto_AVAILABILITY_NULL,
        ...
        site_theme ? site_themeVariable : tenantsservice_user_dto_SITETHEME_NULL
        );
