...
#ifndef _tenant_unit_dto_H_
#define _tenant_unit_dto_H_
...
typedef struct tenant_unit_dto_t tenant_unit_dto_t;




typedef struct tenant_unit_dto_t {
    char *id; // string
