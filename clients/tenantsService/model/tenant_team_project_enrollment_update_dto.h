/*
 * tenant_team_project_enrollment_update_dto.h
 *
 * 
 */

#ifndef _tenant_team_project_enrollment_update_dto_H_
#define _tenant_team_project_enrollment_update_dto_H_
...
typedef struct tenant_team_project_enrollment_update_dto_t tenant_team_project_enrollment_update_dto_t;




typedef struct tenant_team_project_enrollment_update_dto_t {
    char *business_team_id; // string
    char *project_id; // string

} tenant_team_project_enrollment_update_dto_t;
...
#endif /* _tenant_team_project_enrollment_update_dto_H_ */
