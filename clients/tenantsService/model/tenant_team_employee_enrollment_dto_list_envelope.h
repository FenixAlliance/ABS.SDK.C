/*
 * tenant_team_employee_enrollment_dto_list_envelope.h
 *
 * 
 */

#ifndef _tenant_team_employee_enrollment_dto_list_envelope_H_
#define _tenant_team_employee_enrollment_dto_list_envelope_H_
...
typedef struct tenant_team_employee_enrollment_dto_list_envelope_t tenant_team_employee_enrollment_dto_list_envelope_t;

#include "tenant_team_employee_enrollment_dto.h"



typedef struct tenant_team_employee_enrollment_dto_list_envelope_t {
...
#endif /* _tenant_team_employee_enrollment_dto_list_envelope_H_ */
