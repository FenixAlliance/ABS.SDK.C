...
#include <string.h>
#include <stdio.h>
#include "tenant_territory_update_dto.h"
...
void tenant_territory_update_dto_free(tenant_territory_update_dto_t *tenant_territory_update_dto) {
    if(NULL == tenant_territory_update_dto){
        return ;
    }
    listEntry_t *listEntry;
    if (tenant_territory_update_dto->name) {
        free(tenant_territory_update_dto->name);
        tenant_territory_update_dto->name = NULL;
    }
...
cJSON *tenant_territory_update_dto_convertToJSON(tenant_territory_update_dto_t *tenant_territory_update_dto) {
    ...
    // tenant_territory_update_dto->name
    if(tenant_territory_update_dto->name) {
    if(cJSON_AddStringToObject(item, "name", tenant_territory_update_dto->name) == NULL) {
    goto fail; //String
    }
    }
...
tenant_territory_update_dto_t *tenant_territory_update_dto_parseFromJSON(cJSON *tenant_territory_update_dtoJSON){
    ...
    tenant_territory_update_dto_t *tenant_territory_update_dto_local_var = NULL;

    // tenant_territory_update_dto->name
    cJSON *name = cJSON_GetObjectItemCaseSensitive(tenant_territory_update_dtoJSON, "name");
    if (name) { 
    ...
    // tenant_territory_update_dto->description
    cJSON *description = cJSON_GetObjectItemCaseSensitive(tenant_territory_update_dtoJSON, "description");
    if (description) { 
