/*
 * tenant_invitation_dto_collection_query_parameters.h
 *
 * 
 */

#ifndef _tenant_invitation_dto_collection_query_parameters_H_
#define _tenant_invitation_dto_collection_query_parameters_H_
...
typedef struct tenant_invitation_dto_collection_query_parameters_t tenant_invitation_dto_collection_query_parameters_t;




typedef struct tenant_invitation_dto_collection_query_parameters_t {
    int top; //numeric
    int skip; //numeric
    int count; //boolean
    char *filter; // string
...
} tenant_invitation_dto_collection_query_parameters_t;
...
#endif /* _tenant_invitation_dto_collection_query_parameters_H_ */
