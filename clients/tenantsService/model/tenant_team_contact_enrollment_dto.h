/*
 * tenant_team_contact_enrollment_dto.h
 *
 * 
 */

#ifndef _tenant_team_contact_enrollment_dto_H_
#define _tenant_team_contact_enrollment_dto_H_
...
typedef struct tenant_team_contact_enrollment_dto_t tenant_team_contact_enrollment_dto_t;




typedef struct tenant_team_contact_enrollment_dto_t {
    char *id; // string
...
} tenant_team_contact_enrollment_dto_t;
...
#endif /* _tenant_team_contact_enrollment_dto_H_ */
