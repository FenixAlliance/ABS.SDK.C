...
typedef enum  { tenantsservice_social_profile_dto_TYPE_NULL = 0, tenantsservice_social_profile_dto_TYPE_User, tenantsservice_social_profile_dto_TYPE_Tenant, tenantsservice_social_profile_dto_TYPE_Contact } tenantsservice_social_profile_dto_TYPE_e;

char* social_profile_dto_type_ToString(tenantsservice_social_profile_dto_TYPE_e type);

tenantsservice_social_profile_dto_TYPE_e social_profile_dto_type_FromString(char* type);
...
typedef struct social_profile_dto_t {
    ...
    tenantsservice_social_profile_dto_TYPE_e type; //enum
...
social_profile_dto_t *social_profile_dto_create(
    ...
    tenantsservice_social_profile_dto_TYPE_e type,
    char *social_feed_id,
    char *twitter_url,
    char *facebook_url,
    char *linked_in_url,
