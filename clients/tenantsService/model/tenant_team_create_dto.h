/*
 * tenant_team_create_dto.h
 *
 * 
 */

#ifndef _tenant_team_create_dto_H_
#define _tenant_team_create_dto_H_
...
typedef struct tenant_team_create_dto_t tenant_team_create_dto_t;




typedef struct tenant_team_create_dto_t {
    char *id; // string
...
#endif /* _tenant_team_create_dto_H_ */
