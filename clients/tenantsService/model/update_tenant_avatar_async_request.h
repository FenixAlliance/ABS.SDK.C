/*
 * update_tenant_avatar_async_request.h
 *
 * 
 */

#ifndef _update_tenant_avatar_async_request_H_
#define _update_tenant_avatar_async_request_H_
...
typedef struct update_tenant_avatar_async_request_t update_tenant_avatar_async_request_t;




typedef struct update_tenant_avatar_async_request_t {
    binary_t* avatar; //binary

} update_tenant_avatar_async_request_t;
...
#endif /* _update_tenant_avatar_async_request_H_ */
