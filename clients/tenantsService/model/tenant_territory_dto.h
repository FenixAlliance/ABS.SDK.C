/*
 * tenant_territory_dto.h
 *
 * 
 */

#ifndef _tenant_territory_dto_H_
#define _tenant_territory_dto_H_
...
typedef struct tenant_territory_dto_t tenant_territory_dto_t;




typedef struct tenant_territory_dto_t {
    char *id; // string
...
#endif /* _tenant_territory_dto_H_ */
