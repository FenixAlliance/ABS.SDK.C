/*
 * tenant_segment_dto.h
 *
 * 
 */

#ifndef _tenant_segment_dto_H_
#define _tenant_segment_dto_H_
...
typedef struct tenant_segment_dto_t tenant_segment_dto_t;




typedef struct tenant_segment_dto_t {
    char *id; // string
