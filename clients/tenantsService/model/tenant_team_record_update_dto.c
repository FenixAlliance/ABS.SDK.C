...
tenant_team_record_update_dto_t *tenant_team_record_update_dto_create(
    ...
    tenant_team_record_update_dto_local_var->business_id = business_id;
    tenant_team_record_update_dto_local_var->business_profile_record_id = business_profile_record_id;
...
void tenant_team_record_update_dto_free(tenant_team_record_update_dto_t *tenant_team_record_update_dto) {
    ...
    if (tenant_team_record_update_dto->business_id) {
        free(tenant_team_record_update_dto->business_id);
        tenant_team_record_update_dto->business_id = NULL;
    }
    if (tenant_team_record_update_dto->business_profile_record_id) {
        free(tenant_team_record_update_dto->business_profile_record_id);
        tenant_team_record_update_dto->business_profile_record_id = NULL;
    }
...
cJSON *tenant_team_record_update_dto_convertToJSON(tenant_team_record_update_dto_t *tenant_team_record_update_dto) {
    ...
    // tenant_team_record_update_dto->business_id
    if(tenant_team_record_update_dto->business_id) {
    if(cJSON_AddStringToObject(item, "businessID", tenant_team_record_update_dto->business_id) == NULL) {
    goto fail; //String
    }
    }


    // tenant_team_record_update_dto->business_profile_record_id
    if(tenant_team_record_update_dto->business_profile_record_id) {
    if(cJSON_AddStringToObject(item, "businessProfileRecordID", tenant_team_record_update_dto->business_profile_record_id) == NULL) {
    goto fail; //String
    }
    }
...
tenant_team_record_update_dto_t *tenant_team_record_update_dto_parseFromJSON(cJSON *tenant_team_record_update_dtoJSON){
    ...
    // tenant_team_record_update_dto->business_id
    cJSON *business_id = cJSON_GetObjectItemCaseSensitive(tenant_team_record_update_dtoJSON, "businessID");
    if (business_id) { 
    ...
    // tenant_team_record_update_dto->business_profile_record_id
    cJSON *business_profile_record_id = cJSON_GetObjectItemCaseSensitive(tenant_team_record_update_dtoJSON, "businessProfileRecordID");
