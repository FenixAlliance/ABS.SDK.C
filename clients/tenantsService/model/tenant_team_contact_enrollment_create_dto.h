/*
 * tenant_team_contact_enrollment_create_dto.h
 *
 * 
 */

#ifndef _tenant_team_contact_enrollment_create_dto_H_
#define _tenant_team_contact_enrollment_create_dto_H_
...
typedef struct tenant_team_contact_enrollment_create_dto_t tenant_team_contact_enrollment_create_dto_t;




typedef struct tenant_team_contact_enrollment_create_dto_t {
    char *id; // string
    char *timestamp; //date time
    char *business_team_id; // string
    char *contact_id; // string

} tenant_team_contact_enrollment_create_dto_t;
...
#endif /* _tenant_team_contact_enrollment_create_dto_H_ */
