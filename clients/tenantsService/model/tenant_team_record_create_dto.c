...
#include <string.h>
#include <stdio.h>
#include "tenant_team_record_create_dto.h"
...
tenant_team_record_create_dto_t *tenant_team_record_create_dto_create(
    ...
    if (!tenant_team_record_create_dto_local_var) {
        return NULL;
    }
...
void tenant_team_record_create_dto_free(tenant_team_record_create_dto_t *tenant_team_record_create_dto) {
    if(NULL == tenant_team_record_create_dto){
        return ;
    }
    listEntry_t *listEntry;
    if (tenant_team_record_create_dto->id) {
        free(tenant_team_record_create_dto->id);
        tenant_team_record_create_dto->id = NULL;
    }
    ...
    if (tenant_team_record_create_dto->business_team_id) {
        ...
        tenant_team_record_create_dto->business_team_id = NULL;
    }
    free(tenant_team_record_create_dto);
}

cJSON *tenant_team_record_create_dto_convertToJSON(tenant_team_record_create_dto_t *tenant_team_record_create_dto) {
    cJSON *item = cJSON_CreateObject();

    // tenant_team_record_create_dto->id
    if(tenant_team_record_create_dto->id) {
    if(cJSON_AddStringToObject(item, "id", tenant_team_record_create_dto->id) == NULL) {
    goto fail; //String
    }
    }


    // tenant_team_record_create_dto->timestamp
    if(tenant_team_record_create_dto->timestamp) {
...
tenant_team_record_create_dto_t *tenant_team_record_create_dto_parseFromJSON(cJSON *tenant_team_record_create_dtoJSON){
    ...
    tenant_team_record_create_dto_t *tenant_team_record_create_dto_local_var = NULL;

    // tenant_team_record_create_dto->id
    cJSON *id = cJSON_GetObjectItemCaseSensitive(tenant_team_record_create_dtoJSON, "id");
    if (id) { 
    ...
    // tenant_team_record_create_dto->timestamp
    cJSON *timestamp = cJSON_GetObjectItemCaseSensitive(tenant_team_record_create_dtoJSON, "timestamp");
    if (timestamp) { 
