...
[**SegmentsAPI_patchTenantSegment**](SegmentsAPI.md#SegmentsAPI_patchTenantSegment) | **PATCH** /api/v2/TenantsService/Segments/{tenantSegmentId} | Patch a tenant segment
...
// Retrieve a list of tenant segments
//
tenant_segment_dto_list_envelope_t* SegmentsAPI_getTenantSegments(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_segment_dto_collection_query_parameters_t *tenant_segment_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**tenant_segment_dto_collection_query_parameters** | **[tenant_segment_dto_collection_query_parameters_t](tenant_segment_dto_collection_query_parameters.md) \*** |  | [optional] 
...
// Get the count of tenant segments
//
int32_envelope_t* SegmentsAPI_getTenantSegmentsCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_segment_dto_collection_query_parameters_t *tenant_segment_dto_collection_query_parameters);
```
...
# **SegmentsAPI_patchTenantSegment**
```c
// Patch a tenant segment
//
// Patch a tenant segment
//
empty_envelope_t* SegmentsAPI_patchTenantSegment(apiClient_t *apiClient, char *tenantId, char *tenantSegmentId, char *api_version, char *x_api_version, list_t *patch_operation);
```
