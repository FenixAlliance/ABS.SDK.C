...
// Patch a tenant segment
//
empty_envelope_t* SegmentsAPI_patchTenantSegment(apiClient_t *apiClient, char *tenantId, char *tenantSegmentId, char *api_version, char *x_api_version, list_t *operation);
```
