...
//
business_relationship_dto_list_envelope_t* BusinessRelationshipsAPI_getBusinessRelationshipsAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, business_relationship_dto_collection_query_parameters_t *business_relationship_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**business_relationship_dto_collection_query_parameters** | **[business_relationship_dto_collection_query_parameters_t](business_relationship_dto_collection_query_parameters.md) \*** |  | [optional] 
...
//
int32_envelope_t* BusinessRelationshipsAPI_getBusinessRelationshipsCountAsync(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, business_relationship_dto_collection_query_parameters_t *business_relationship_dto_collection_query_parameters);
```
