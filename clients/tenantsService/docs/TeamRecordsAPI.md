...
// Patch a tenant team record
//
empty_envelope_t* TeamRecordsAPI_patchTenantTeamRecord(apiClient_t *apiClient, char *tenantId, char *tenantTeamRecordId, char *api_version, char *x_api_version, list_t *operation);
```
