...
[**TypesAPI_patchTenantType**](TypesAPI.md#TypesAPI_patchTenantType) | **PATCH** /api/v2/TenantsService/Types/{tenantTypeId} | Patch a tenant type
...
// Retrieve a list of tenant types
//
tenant_type_dto_list_envelope_t* TypesAPI_getTenantTypes(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_type_dto_collection_query_parameters_t *tenant_type_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**tenant_type_dto_collection_query_parameters** | **[tenant_type_dto_collection_query_parameters_t](tenant_type_dto_collection_query_parameters.md) \*** |  | [optional] 
...
// Get the count of tenant types
//
int32_envelope_t* TypesAPI_getTenantTypesCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_type_dto_collection_query_parameters_t *tenant_type_dto_collection_query_parameters);
```
...
# **TypesAPI_patchTenantType**
```c
// Patch a tenant type
//
// Patch a tenant type
//
empty_envelope_t* TypesAPI_patchTenantType(apiClient_t *apiClient, char *tenantId, char *tenantTypeId, char *api_version, char *x_api_version, list_t *patch_operation);
```
