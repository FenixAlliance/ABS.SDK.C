...
// Retrieve a list of tenant employee enrollments
//
tenant_team_employee_enrollment_dto_list_envelope_t* EmployeeEnrollmentsAPI_getTenantEmployeeEnrollments(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_team_employee_enrollment_dto_collection_query_parameters_t *tenant_team_employee_enrollment_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**tenant_team_employee_enrollment_dto_collection_query_parameters** | **[tenant_team_employee_enrollment_dto_collection_query_parameters_t](tenant_team_employee_enrollment_dto_collection_query_parameters.md) \*** |  | [optional] 
...
// Get the count of tenant employee enrollments
//
int32_envelope_t* EmployeeEnrollmentsAPI_getTenantEmployeeEnrollmentsCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_team_employee_enrollment_dto_collection_query_parameters_t *tenant_team_employee_enrollment_dto_collection_query_parameters);
```
...
// Patch a tenant employee enrollment
//
empty_envelope_t* EmployeeEnrollmentsAPI_patchTenantEmployeeEnrollmentAsync(apiClient_t *apiClient, char *tenantId, char *tenantEmployeeEnrollmentId, char *api_version, char *x_api_version, list_t *patch_operation);
```
