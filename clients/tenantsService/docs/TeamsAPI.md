...
[**TeamsAPI_patchTenantTeam**](TeamsAPI.md#TeamsAPI_patchTenantTeam) | **PATCH** /api/v2/TenantsService/Teams/{tenantTeamId} | Patch a tenant team
...
// Retrieve a list of tenant teams
//
tenant_team_dto_list_envelope_t* TeamsAPI_getTenantTeams(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_team_dto_collection_query_parameters_t *tenant_team_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**tenant_team_dto_collection_query_parameters** | **[tenant_team_dto_collection_query_parameters_t](tenant_team_dto_collection_query_parameters.md) \*** |  | [optional] 
...
// Get the count of tenant teams
//
int32_envelope_t* TeamsAPI_getTenantTeamsCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_team_dto_collection_query_parameters_t *tenant_team_dto_collection_query_parameters);
```
...
# **TeamsAPI_patchTenantTeam**
```c
// Patch a tenant team
//
// Patch a tenant team
//
empty_envelope_t* TeamsAPI_patchTenantTeam(apiClient_t *apiClient, char *tenantId, char *tenantTeamId, char *api_version, char *x_api_version, list_t *patch_operation);
```
