...
// Retrieve a list of tenant departments
//
tenant_department_dto_list_envelope_t* DepartmentsAPI_getTenantDepartments(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_department_dto_collection_query_parameters_t *tenant_department_dto_collection_query_parameters);
```
...
**api_version** | **char \*** |  | [optional] 
**x_api_version** | **char \*** |  | [optional] 
**tenant_department_dto_collection_query_parameters** | **[tenant_department_dto_collection_query_parameters_t](tenant_department_dto_collection_query_parameters.md) \*** |  | [optional] 
...
// Get the count of tenant departments
//
int32_envelope_t* DepartmentsAPI_getTenantDepartmentsCount(apiClient_t *apiClient, char *tenantId, char *api_version, char *x_api_version, tenant_department_dto_collection_query_parameters_t *tenant_department_dto_collection_query_parameters);
```
...
// Patch a tenant department
//
empty_envelope_t* DepartmentsAPI_patchTenantDepartmentAsync(apiClient_t *apiClient, char *tenantId, char *tenantDepartmentId, char *api_version, char *x_api_version, list_t *patch_operation);
```
